---
title: Linux 仮想マシンの概要 | Microsoft Docs
...
Azure Linux 仮想マシンでは、Red Hat、Ubuntu、または好みの Linux ディストリビューションを使用して、セキュリティで保護された高スケールな仮想化インフラストラクチャをオンデマンドで構築できます。 Microsoft が提供するクイック スタート、チュートリアル、サンプルを使用して、Linux VM の作成、構成、管理、スケーリングを行う方法を確認してください。

## <a name="5-minute-quickstarts"></a>5 分間のクイック スタート

Ubuntu を実行している仮想マシン内で NGINX Web サーバーをデプロイする方法について説明します。
...
- [Linux VM の作成と管理](/azure/virtual-machines/linux/tutorial-manage-vm)
- [VM ディスクの作成と管理](/azure/virtual-machines/linux/tutorial-manage-disks)
- [VM 構成の自動化](/azure/virtual-machines/linux/tutorial-automate-vm-deployment)
- [カスタム VM イメージを作成する](/azure/virtual-machines/linux/tutorial-custom-images)
- [高可用性 VM の作成](/azure/virtual-machines/linux/tutorial-availability-sets)
- [VM スケール セットの作成](/azure/virtual-machines/linux/tutorial-create-vmss)
- [VM の負荷分散](/azure/virtual-machines/linux/tutorial-load-balancer)
- [VM と仮想ネットワークの管理](/azure/virtual-machines/linux/tutorial-virtual-network)
...
- [ドキュメントを参照して詳細を確認する](/azure/virtual-machines/linux/index)
