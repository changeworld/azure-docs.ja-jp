...
## キャッシュのスケーリング
キャッシュをスケーリングするには、[プレビュー ポータル](https://portal.azure.com)で[キャッシュに移動](cache-configure.md#configure-redis-cache-settings)して、**[Redis Cache]** ブレードで、**[Standard レベル]** または **[Basic レベル]** をクリックします。
