...
> [!IMPORTANT]
> [[Redis メトリック]](#enable-cache-diagnostics) ブレードに次のメッセージが表示された場合は、「**キャッシュ診断の有効化**」セクションの手順に従ってキャッシュ診断を有効にします。
> 
...
> [!NOTE]
> **[メトリック]** ブレードで **[アラートの追加]** をクリックしてアラート ルールを作成すると、そのブレードのグラフに表示されるメトリックのみが **[メトリック]** ドロップダウンに表示されます。**[アラート ルール]** ブレードで **[アラートの追加]** をクリックしてアラート ルールを作成すると、すべてのメトリックを **[メトリック]** ドロップダウンから選択できます。
> 
> 
