---
title: Azure Policy の JSON サンプル - 許可されている Express Route の SKU | Microsoft Docs
description: この JSON サンプル ポリシーは、承認された SKU が Express Route で使用されていることが要件です。
...
ms.locfileid: "34604762"
---
# <a name="allowed-express-route-skus"></a>許可されている Express Route の SKU

このポリシーは、承認された SKU が Express Route で使用されていることが要件です。 許可された SKU の配列を指定します。
