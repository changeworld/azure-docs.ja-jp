---
title: Azure Policy の JSON サンプル - ストレージ アカウントのクール アクセス層の拒否 | Microsoft Docs
description: この JSON サンプル ポリシーは、BLOB ストレージ アカウントにクール アクセス層の使用を禁止します。
