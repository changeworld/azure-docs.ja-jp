---
title: Azure Policy の JSON サンプル - 許可されている SQL DB SKU | Microsoft Docs
description: この JSON サンプル ポリシーは、SQL データベースが適切な SKU を使用することが要件です。
...
ms.locfileid: "34603181"
---
# <a name="allowed-sql-db-skus"></a>許可されている SQL DB の SKU
