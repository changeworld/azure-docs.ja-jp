---
title: Azure Policy の JSON サンプル - VM ネットワーク インターフェイスへの承認された vNet の使用 | Microsoft Docs
description: この JSON サンプル ポリシーは、承認された仮想ネットワークがネットワーク インターフェイスで使用されていることが要件です。
