---
title: Azure Policy の JSON サンプル - リソース グループのカスタム VM イメージの許可 | Microsoft Docs
description: この JSON サンプル ポリシーでは、カスタム イメージを承認されているリソース グループにのみ許可します。
...
この JSON サンプル ポリシーでは、カスタム イメージを承認されているリソース グループにのみ許可します。 承認されたリソース グループの名前を指定します。
...
その他の Azure Policy テンプレート サンプルは、Azure Policy のドキュメントを参照してください。
