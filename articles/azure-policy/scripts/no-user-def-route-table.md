---
title: Azure Policy の JSON サンプル - ユーザー定義ルート テーブルがない | Microsoft Docs
description: この JSON サンプル ポリシーは、仮想ネットワークがユーザー定義のルート テーブルを使ってデプロイされることを禁止します。
