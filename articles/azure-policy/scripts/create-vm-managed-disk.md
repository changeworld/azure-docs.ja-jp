---
title: Azure Policy の JSON サンプル - 管理ディスクを使用していない VM の監査 | Microsoft Docs
description: この JSON サンプルでは、管理ディスクを使用しない仮想マシンが作成されたときに監査が行われます。
...
ms.locfileid: "34601209"
---
# <a name="audit-when-vm-does-not-use-managed-disk"></a>VM が管理ディスクを使用していない場合の監査

管理ディスクを使用していない仮想マシンが作成されたときに監査が行われます。
