---
title: Azure Policy の JSON サンプル - すべての NIC 上の NSG X | Microsoft Docs
description: この JSON サンプル ポリシーは、特定のネットワーク セキュリティ グループで、すべての仮想ネットワーク インターフェイスが使用されていることが要件です。
