...
- Resource Manager、REST、Azure CLI、または Azure PowerShell を介した割り当てで、リソースがスコープにデプロイされる。 このシナリオでは、効果イベント (追加、監査、拒否、デプロイ) およびコンプライアンス状態情報が 15 分後にポータルおよび SDK で利用可能になります。
