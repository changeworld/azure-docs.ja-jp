...
ms.locfileid: "34602613"
---
# <a name="azure-policy-samples"></a>Azure Policy のサンプル

次の表に、Azure Policy の JSON サンプルへのリンクを示します。 これらのサンプルは、[Azure Policy のサンプル リポジトリ](https://github.com/Azure/azure-policy)にもあります。
...
- 「[Understanding policy effects](policy-effects.md)」(ポリシーの効果を理解する) を確認します。