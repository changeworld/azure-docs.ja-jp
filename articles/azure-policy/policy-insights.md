...
1. 次のコマンドを実行して、ポリシー割り当て ID を入手します。
  ...
  ポリシー割り当て ID の入手方法の詳細については、「[Get-AzureRMPolicyAssignment](https://docs.microsoft.com/powershell/module/azurerm.resources/Get-AzureRmPolicyAssignment)」を参照してください。
...
コマンドレットの詳細については、「[Set-AzureRmPolicyAssignment](/powershell/module/azurerm.resources/Set-AzureRmPolicyAssignment)」を参照してください。
