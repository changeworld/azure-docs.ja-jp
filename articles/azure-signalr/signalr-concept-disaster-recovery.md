...
この記事では、SignalR Service に回復性を持たせるためのアプリケーションの構成方法について説明しました。 SignalR Service における接続のルーティングとサーバー/クライアント接続の詳細については、SignalR Service の内部について説明した[こちらの記事](signalr-concept-internals.md)を参照してください。