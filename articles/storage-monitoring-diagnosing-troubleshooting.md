...
この資料の作成時点では、Application Insights はプレビュー段階です。詳細については、MSDN の「[Application Insights for Visual Studio Online][Application Insights for Visual Studio Online]」を参照してください。
  ...
  [Storage Analytics Metrics のテーブル スキーマ]: http://msdn.microsoft.com/en-us/library/azure/hh343264.aspx
  ...
  [REST API の一般的なエラー コード]: http://msdn.microsoft.com/en-us/library/azure/dd179357.aspx
  [BLOB サービスのエラー コード]: http://msdn.microsoft.com/en-us/library/azure/dd179439.aspx
  [キュー サービスのエラー コード]: http://msdn.microsoft.com/en-us/library/azure/dd179446.aspx
  [テーブル サービスのエラー コード]: http://msdn.microsoft.com/en-us/library/azure/dd179438.aspx
  ...
  [デバッグ、トレース、およびプロファイリング]: http://msdn.microsoft.com/en-us/library/7fe0dd2y(v=vs.110).aspx
  ...
  [共有アクセス署名を使用したアクセスの委任]: http://msdn.microsoft.com/en-us/library/azure/ee395415.aspx
  ...
  [Azure ストレージ サービスでのクロス オリジン リソース共有 (CORS) のサポート]: http://msdn.microsoft.com/en-us/library/windowsazure/dn535601.aspx
  ...
  [ストレージ エミュレーターと Azure ストレージ サービスとの違い]: http://msdn.microsoft.com/en-us/library/gg433135.aspx
  [コマンド ライン ツールを使用してストレージ エミュレーターを初期化する]: http://msdn.microsoft.com/en-us/library/gg433132.aspx
  ...
  [PEF-WebProxy Provider (PEF-WebProxy プロバイダー)]: http://technet.microsoft.com/en-us/library/jj674814.aspx
  ...
  [PEF-NDIS-PacketCapture Provider (PEF-NDIS-PacketCapture プロバイダー)]: http://technet.microsoft.com/en-us/library/jj659264.aspx
  [Storage Analytics のログの形式]: http://msdn.microsoft.com/en-us/library/hh343259.aspx
