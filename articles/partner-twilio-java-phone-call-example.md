<properties urlDisplayName="How to Make a Phone Call from Twilio in Java" pageTitle="Twilio を使用して通話する方法 (Java) - Azure" metaKeywords="Azure Twilio 通話, Twilio 通話 Web サイト, Azure Twilio Java" description="Learn how to make a phone call from a web page using Twilio in a Java application on Azure." metaCanonical="" services="" documentationCenter="Java" title="How to Make a Phone Call Using Twilio in a Java Application on Azure" authors="MicrosoftHelp@twilio.com; robmcm" videoId="" scriptId="" solutions="" manager="twilio" editor="mollybos" />
