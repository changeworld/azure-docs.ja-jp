...
## <a name="a-namesubnetsa2-add-additional-address-space-and-create-subnets"></a><a name="subnets"></a>2.アドレス空間の追加とサブネットの作成
...
## <a name="a-namefaqavnettovnet-faq"></a><a name="faq"></a>VNet 間接続に関してよく寄せられる質問
