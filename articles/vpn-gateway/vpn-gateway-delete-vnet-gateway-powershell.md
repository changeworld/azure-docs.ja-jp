---
title: "仮想ネットワーク ゲートウェイを削除する方法: PowerShell: Azure Resource Manager | Microsoft Docs"
...
###<a name="10-delete-the-gateway-subnet"></a>10.ゲートウェイ サブネットを削除します。
...
###<a name="9-delete-the-gateway-subnet"></a>9.ゲートウェイ サブネットを削除します。
