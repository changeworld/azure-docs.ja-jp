...
| フェーズ 2 のセキュリティ アソシエーション (SA) の有効期間 (時間) | 3,600 秒 | - | | フェーズ 2 のセキュリティ アソシエーション (SA) の有効期間 (スループット) | 102,400,000 KB | - | | IPsec SA 暗号化および認証のプラン (優先度順) | 1.ESP-AES256 2.ESP-AES128 3.ESP-3DES 4.N/A | *ルート ベース ゲートウェイ IPsec セキュリティ アソシエーション (SA) のプラン*を参照 (下記) | | Perfect Forward Secrecy (PFS) | なし | あり (DH Group1、2、5、14、24) | | Dead Peer Detection | サポートなし | サポートあり |
