<properties
   pageTitle="Azure Resource Manager と PowerShell を使用して Azure VPN ゲートウェイで BGP を構成する方法 | Microsoft Azure"
...
# Azure Resource Manager と PowerShell を使用して Azure VPN ゲートウェイで BGP を構成する方法
...
### 手順 2 - BGP パラメーターを指定して TestVNet1 の VPN ゲートウェイを作成する
