...
- 使用する VPN デバイスが、クロスプレミスの仮想ネットワーク接続を作成するための要件を満たしていることを確認します。詳細については、「[Virtual Netowrk に使用する VPN デバイスについて](http://go.microsoft.com/fwlink/p/?LinkId=615099)」を参照してください。
...
次に、セキュリティで保護されたサイト間 VPN 接続を作成するために**Virtual Network ゲートウェイ**を構成します。詳細については、「[管理ポータルでのVirtual Network ゲートウェイの構成](vpn-gateway-configure-vpn-gateway-mp.md)」を参照してください。
