---
title: クラシック ポータルを使用した Azure Virtual Network へのポイント対サイト VPN ゲートウェイ接続の構成 | Microsoft Docs
...
## <a name="about-creating-a-point-to-site-connection"></a>ポイント対サイト接続の作成について
...
## <a name="<a-name="vnetvpn"></a>section-1---create-a-virtual-network-and-a-vpn-gateway"></a><a name="vnetvpn"></a>セクション 1 - 仮想ネットワークと VPN ゲートウェイの作成
...
## <a name="<a-name="generate"></a>section-2---generate-and-upload-certificates"></a><a name="generate"></a>セクション 2 - 証明書の生成とアップロード
...
### <a name="<a-name="root"></a>part-1:-obtain-the-.cer-file-for-the-root-certificate"></a><a name="root"></a>パート 1: ルート証明書の .cer ファイルの取得
...
### <a name="<a-name="upload"></a>part-2:-upload-the-root-certificate-.cer-file-to-the-azure-classic-portal"></a><a name="upload"></a>パート 2: Azure クラシック ポータルへのルート証明書 .cer ファイルのアップロード
...
### <a name="<a-name="createclientcert"></a>part-3:-generate-a-client-certificate"></a><a name="createclientcert"></a>パート 3: クライアント証明書の生成
...
## <a name="<a-name="installclientcert"></a>section-3---export-and-install-the-client-certificate"></a><a name="installclientcert"></a>セクション 3 - クライアント証明書のエクスポートとインストール
...
## <a name="<a-name="vpnclientconfig"></a>section-4---configure-your-vpn-client"></a><a name="vpnclientconfig"></a>セクション 4 - VPN クライアントの構成
