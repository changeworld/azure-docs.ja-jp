...
次のサンプルでは、[Windows イベント](../agents/data-sources-windows-events.md)のコレクションを既存のワークスペースに追加します。
...
次のサンプルでは、[syslog イベント](../agents/data-sources-syslog.md)のコレクションを既存のワークスペースに追加します。
...
次のサンプルでは、[Windows パフォーマンス カウンター](../agents/data-sources-performance-counters.md)のコレクションを既存のワークスペースに追加します。
...
次のサンプルでは、[Linux パフォーマンス カウンター](../agents/data-sources-performance-counters.md)のコレクションを既存のワークスペースに追加します。
...
次のサンプルでは、[カスタム ログ](../agents/data-sources-custom-logs.md)のコレクションを既存のワークスペースに追加します。
...
次のサンプルでは、[IIS ログ](../agents/data-sources-iis-logs.md)のコレクションを既存のワークスペースに追加します。
