...
Windows イベント ログは、[Log Analytics の [設定] の [データ] メニュー](agent-data-sources.md#configuring-data-sources)から構成します。
...
* [カスタム フィールド](../../log-analytics/log-analytics-custom-fields.md) を使用し、イベント レコードを個別のフィールドに解析します。
