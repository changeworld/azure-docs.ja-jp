...
これらの IP アドレスへの変更に関する更新情報を受け取るには、アクション グループ サービスに関する情報の通知を監視する[サービス正常性アラート](./../../monitoring-and-diagnostics/monitoring-service-notifications.md)を構成することをお勧めします。
