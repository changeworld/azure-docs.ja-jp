...
> [!NOTE]
> **Azure Cost Management と課金**ハブの **[コスト管理]** を使用することは、監視コストを幅広く理解するための推奨アプローチです。  **Log Analytics** および [Application Insights](https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage#understand-your-usage-and-estimate-costs) の [[使用量と推定コスト]](https://docs.microsoft.com/azure/azure-monitor/app/pricing#understand-your-usage-and-estimate-costs) エクスペリエンスでは、Azure Monitor のこれらの各部分のより深い分析情報が提供されます。
