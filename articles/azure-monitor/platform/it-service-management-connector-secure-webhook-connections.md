...
2. バージョンに応じた手順に従ってください。
   ...
   * [ニューヨーク](https://docs.servicenow.com/bundle/paris-it-operations-management/page/product/event-management/concept/azure-integration.html)
