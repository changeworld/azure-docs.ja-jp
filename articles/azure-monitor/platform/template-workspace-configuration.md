...
3. 保存された関数を作成します。 関数をオーバーライドしてべき等を維持するには、eTag を追加する必要があります。
4. コンピューター グループの作成
...
10. Azure Diagnostics によってストレージ アカウントに書き込まれた IIS ログとWindows イベント ログの収集
11. Windows コンピューターからのカスタム ログの収集
