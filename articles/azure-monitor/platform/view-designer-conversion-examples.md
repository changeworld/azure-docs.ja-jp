...
ms.locfileid: "77658729"
---
# <a name="view-designer-conversion-examples"></a>ビュー デザイナーの変換の例

ビュー デザイナーをタブ付きブックにレプリケートするには、次のコードをコピーし、詳細エディターに貼り付けます (ツール バーの </> 記号をクリックして示された場所)

![詳細エディターのツール バー](media/view-designer-conversion-examples/toolbar.png)

ユーザーは、クエリの設定とサブスクリプションを自分のアクセス可能なリソースに更新する必要があります
