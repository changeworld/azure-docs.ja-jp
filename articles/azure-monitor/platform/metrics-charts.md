...
3. グラフをプロットするときに含めるディメンション値を選択します。 次の例では、成功したストレージ トランザクションをフィルターで除外します。

   ![フィルター処理された成功したストレージ トランザクションを示すスクリーンショット。](./media/metrics-charts/029.png)

4. **フィルター セレクター** の外側を選択して閉じます。 これで、グラフには、失敗したストレージ トランザクションの数が表示されます。

   ![失敗したストレージ トランザクションの数を示すスクリーンショット。](./media/metrics-charts/030.png)

これらの手順を繰り返して、同じグラフに複数のフィルターを適用できます。
...
2. グラフをセグメント化するディメンションを選択します。
   ...
   ![各ディメンションのセグメントの線を示すスクリーンショット。](./media/metrics-charts/032.png)

3. **グループ セレクター** の外側を選択して閉じます。
