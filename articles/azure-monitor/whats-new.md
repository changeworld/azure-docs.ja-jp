...
- [任意の場所での Java アプリケーションの監視](./app/java-standalone-config.md) - 新しい記事
- [任意の環境での Java アプリケーションの監視](./app/java-in-process-agent.md) - 新しい記事
...
- [お使いの Azure Red Hat OpenShift v3 クラスターの監視を停止する方法](./insights/container-insights-optout-openshift-v3.md) - 新しい記事新しい記事
- [お使いのハイブリッド Kubernetes クラスターの監視を停止する方法](./insights/container-insights-optout-hybrid.md) - 新しい記事

### <a name="insights"></a>洞察

- [Azure Monitor for Key Vaults を使用した Azure Key Vault の監視 (プレビュー)](./insights/key-vault-insights-overview.md) - 新しい記事
