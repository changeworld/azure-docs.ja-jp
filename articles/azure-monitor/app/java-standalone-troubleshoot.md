...
既定では、Application Insights Java 3.x によって、`applicationinsights-agent-3.1.1.jar` ファイルが保持されているディレクトリに `applicationinsights.log` という名前のログ ファイルが生成されます。
