...
![Azure Monitor ビュー デザイナーの [クエリのリスト] 視覚化パーツのスクリーンショット。](media/view-designer-parts/view-list-queries.png)
...
![Azure Monitor ビュー デザイナーの [Number and list] \(数値とリスト\) 視覚化パーツのスクリーンショット。](media/view-designer-parts/view-number-list.png)
