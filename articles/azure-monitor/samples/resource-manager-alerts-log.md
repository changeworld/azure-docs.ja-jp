...
次のサンプルでは、[結果の数のアラート ルール](../platform/alerts-unified-log.md#count-of-the-results-table-rows)を作成します。
...
次のサンプルでは、[メトリック測定のアラート ルール](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)を作成します。
