                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        <h3>ユーザー動作分析</h3>
                                                        <p>
                                                            <a href="./app/usage-overview.md">概要</a><br>
                                                            <a href="./app/usage-send-user-context.md">ユーザー コンテキスト ID の送信</a><br>
                                                            <a href="./app/usage-segmentation.md">ユーザー、セッション、およびイベント</a><br>
                                                            <a href="./app/usage-funnels.md">ファネル</a><br>
                                                            <a href="./app/usage-cohorts.md">コーホート</a><br>
                                                            <a href="./app/usage-impact.md">影響</a><br>
                                                            <a href="./app/usage-retention.md">保持</a><br>
                                                            <a href="./app/usage-flows.md">ユーザー フロー</a>
                                                        </p>
                                                        <br><br>
                                                        ...
                                                        <p>
                                                            ...
                                                            <a href="../monitoring-and-diagnostics/resource-group-insights.md">リソース グループ レベルの監視</a><br>
                                                            <a href="./app/usage-workbooks.md">対話型のレポート</a><br>
                                                            <a href="./app/export-power-bi.md">Power BI 統合</a><br>
                                                            <a href="https://docs.microsoft.com/azure/monitoring-and-diagnostics/monitoring-metric-charts">メトリックの調査</a>
                                                        </p>
                                                        <br><br>
