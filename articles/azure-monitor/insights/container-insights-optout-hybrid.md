...
ms.locfileid: "82195726"
---
# <a name="how-to-stop-monitoring-your-hybrid-cluster"></a>お使いのハイブリッド クラスターの監視を停止する方法

Azure Stack またはオンプレミスで実行しているお使いの Kubernetes クラスターの監視を有効にした後、Azure Monitor for containers でクラスターを監視する必要がなくなった場合は、それでの監視を停止することができます。 この記事では、これを行う方法について説明します。  
