<properties
	pageTitle="Android アプリの認証されたユーザーへのプッシュ通知の送信 (.NET バックエンド)"
	description="Android アプリの特定の認証済みユーザーに対して、.NET バックエンドでモバイル サービスを使用してプッシュ通知を送信する方法について説明します。"
...
このチュートリアルの対象は、.NET バックエンドで Mobile Service を使用する Android アプリです。
