<properties 
	...
	description="Azure Mobile Services から、ユニバーサル Windows JavaScript アプリの特定のユーザーにプッシュ通知を送信する方法について説明します。" 
...
<!-- URLs. -->
[アプリに認証を追加する]: mobile-services-windows-store-javascript-get-started-users.md
[アプリケーションにプッシュ通知を追加する]: mobile-services-javascript-backend-windows-store-javascript-get-started-push.md
