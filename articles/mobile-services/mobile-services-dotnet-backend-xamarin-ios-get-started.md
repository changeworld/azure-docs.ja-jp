---
title: Xamarin iOS アプリケーション用 Mobile Services の使用 | Microsoft Docs
...
> [!NOTE]
> モバイル サービスにアクセスして QSTodoService.cs C# ファイルにあるデータをクエリおよび挿入するコードを確認できます。
> 
> 
