...
---
title: プッシュ通知の使用 (Android JavaScript) | Microsoft Docs
...
[!INCLUDE [Play サービスの追加](../../includes/mobile-services-add-google-play-services.md)]
...
[!INCLUDE [SDK の確認](../../includes/mobile-services-verify-android-sdk-version.md)]
