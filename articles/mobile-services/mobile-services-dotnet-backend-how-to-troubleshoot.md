---
title: Mobile Services .NET バックエンドのトラブルシューティング | Microsoft Docs
...
> [!NOTE]
> Mobile Services は、現在 ASP.NET 5.1 のみに対応しています。現時点で ASP.NET 5.2 はサポートされていません。お使いの ASP.NET NuGet パッケージを 5.2.* にアップグレードすると、デプロイ後にエラーが発生する可能性があります。
> 
> 
