---
title: Windows ユニバーサル アプリ向けの Mobile Services の使用 | Microsoft Docs
...
> [!NOTE]
> モバイル サービスにアクセスして MainPage.xaml.cs ファイルにあるデータをクエリおよび挿入するコードを確認できます。
> 
> 
