...
1. **[送信元]** に「*」と入力します。 
1. **[宛先アドレス]** に、ファイアウォールのパブリック IP アドレスを入力します。 
1. **[宛先ポート]** に「**3389**」と入力します。 
1. **[Translated Address] (変換されたアドレス)** に、Srv-Workload 仮想マシンのプライベート IP アドレスを入力します。 
1. **[Translated port] (変換されたポート)** に「**3389**」と入力します。 
1. **[追加]** を選択します。 これが完了するまでに数分かかります。
