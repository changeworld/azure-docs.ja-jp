...
3. **[追加]** > **[Windows Server]** > **[Windows Server 2016 Datacenter]** > **[作成]** の順にクリックします。
...
5. ユーザー名とパスワードを入力します。
6. **[サブスクリプション]** で、ご使用のサブスクリプションを選択します。
7. **[リソース グループ]** で、**[既存のものを使用]** > **[Test-FW-RG]** の順にクリックします。
8. **[場所]** で、以前使用したのと同じ場所を選択します。
9. Click **OK**.
...
3. **[アプリケーション ルール コレクションの追加]** をクリックします。
4. **[名前]** に「**App-Coll01**」と入力します。
5. **[優先度]** に「**200**」と入力します。
6. **[アクション]** で、**[許可]** を選択します。
7. **[ルール]** の **[名前]** に「**AllowGH**」と入力します。
8. **[ソース アドレス]** に「**10.0.2.0/24**」と入力します。
9. **[プロトコル:ポート]** に「**http, https**」と入力します。
10. **[ターゲットの FQDN]** に「**github.com**」と入力します
11. **[追加]** をクリックします。
