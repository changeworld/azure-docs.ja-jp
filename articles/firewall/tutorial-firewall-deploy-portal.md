...
> * ファイアウォールをデプロイする
> * 既定のルートを作成する
> * msn.com へのアクセスを許可するようにアプリケーションを構成する
...
6. 概要を確認し、**[作成]** をクリックしてファイアウォールを作成します。
   ...
   デプロイが完了するまでに数分かかります。
7. デプロイが完了したら、**Test-FW-RG** リソース グループに移動し、**Test-FW01** ファイアウォールをクリックします。
...
これは、msn.com へのアウトバウンド アクセスを許可するアプリケーション ルールです。
...
11. **[ターゲットの FQDN]** に「**msn.com**」と入力します
12. **[追加]** をクリックします。
