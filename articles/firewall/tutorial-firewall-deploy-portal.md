...
Azure Firewall ルール処理ロジックの詳細については、「[Azure Firewall ルール処理ロジック](rule-processing.md)」を参照してください。
...
7. **[リソース グループ]** で **[既存のものを使用]** を選択し、**[Test-FW-RG]** を選択します。
