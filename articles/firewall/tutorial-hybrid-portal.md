...
2. **次へ:[次へ: IP アドレス]** を選択します。
3. **[IPv4 アドレス空間]** に「 **10.5.0.0/16** 」と入力します。
6. **[サブネット名]** で、 **[default]\(既定\)** を選択します。
7. **[名前]** に「 **AzureFirewallSubnet** 」と入力します。 ファイアウォールはこのサブネットに配置されます。サブネット名は AzureFirewallSubnet **でなければなりません** 。
8. **[アドレス範囲]** に「 **10.5.0.0/26** 」と入力します。 
9. **[保存]** を選択します。
...
4. **[IPv4 アドレス空間]** に「 **10.6.0.0/16** 」と入力します。
6. **[サブネット名]** で、 **[default]\(既定\)** を選択します。
7. **[名前]** に「 **SN-Workload** 」と入力します。
8. **[アドレス範囲]** に「 **10.6.0.0/24** 」と入力します。 
9. **[保存]** を選択します。
10. **[Review + create]\(レビュー + 作成\)** を選択します。
11. **［作成］** を選択します
...
2. **[リージョン]** で **[(米国) 米国東部]** を選択します。
3. **[次へ :IP アドレス]** を選択します
4. **[IPv4 アドレス空間]** に「 **192.168.0.0/16** 」と入力します。
5. **[サブネット名]** で、 **[default]\(既定\)** を選択します。
7. **[名前]** に「 **SN-Corp** 」と入力します。
8. **[アドレス範囲]** に「 **192.168.1.0/24** 」と入力します。 
9. **[保存]** を選択します。
10. **[Review + create]\(レビュー + 作成\)** を選択します。
11. **［作成］** を選択します
...
11. **[送信先アドレス]** に「 **10.6.0.0/16** 」と入力します
12. **[宛先ポート]** に「 **80** 」と入力します。
...
5. **[送信先の種類]** として **[IP アドレス]** を選択します。
6. **[送信先アドレス]** に「 **10.6.0.0/16** 」と入力します
7. **[宛先ポート]** に「 **3389** 」と入力します。
8. **[追加]** を選択します。
