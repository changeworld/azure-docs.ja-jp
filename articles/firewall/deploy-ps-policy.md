---
title: Azure PowerShell を使用して Azure Firewall ポリシーのデプロイと構成を行う
description: この記事では、Azure PowerShell を使用して Azure Firewall ポリシーをデプロイおよび構成する方法を学習します。
services: firewall
author: vhorne
ms.service: firewall
ms.date: 05/03/2021
...
ms.locfileid: "108777041"
---
# <a name="deploy-and-configure-azure-firewall-policy-using-azure-powershell"></a>Azure PowerShell を使用して Azure Firewall ポリシーのデプロイと構成を行う
...
好みに応じて、[Azure portal](tutorial-firewall-deploy-portal-policy.md) を使ってこの手順を行うこともできます。
...
```
## <a name="configure-a-firewall-policy-application-rule"></a>ファイアウォール ポリシーのアプリケーション ルールを構成する
...
## <a name="configure-a-firewall-policy-network-rule"></a>ファイアウォール ポリシーのネットワーク ルールを構成する
