...
2. 左側のメイン メニューから、**[リソースの作成]** (一覧の先頭にあります) を選択し、**[Developer tools]** をポイントし、**[Lab Services (プレビュー)]** をクリックします。
...
1. **Lab Account\(ラボ アカウント\)** ページで、**アクセス制御 (IAM)** を選び、ツール バーの **+ 追加** をクリックします。 
