...
[自動シャットダウン設定を使用したコスト制御の最大化](cost-management-guide.md#maximize-cost-control-with-auto-shutdown-settings)に関するセクションで、自動シャットダウンの詳細を確認するようにしてください。
