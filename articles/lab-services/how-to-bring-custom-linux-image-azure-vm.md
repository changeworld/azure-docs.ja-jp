...
上記の手順は、PowerShell を使用して自動化することもできます。  詳細については、次のスクリプトと付属の ReadMe を参照してください。
- [Bring image to a shared image gallery script (イメージを共有イメージ ギャラリー スクリプトに取り込む)](https://github.com/Azure/azure-devtestlab/tree/master/samples/ClassroomLabs/Scripts/BringImageToSharedImageGallery/)
