...
PowerShell スクリプト ファイル ImportVirtualMachines.ps1 を [Azure DevTest Lab の Git リポジトリ](https://github.com/Azure/azure-devtestlab/tree/master/Scripts/ImportVirtualMachines)からローカル ドライブにダウンロードします。 
