...
![障害の選択](./media/app-insights-asp-net-exception-mvc/012-start.png)

一覧にある失敗した要求の種類を 1 つクリックし、障害の個別発生を表示します。そこからさらにクリックし、例外またはそれに関連付けられているトレース データを表示します。

![失敗した要求のインスタンスを選択し、例外の詳細で、例外のインスタンスを表示します。](./media/app-insights-asp-net-exception-mvc/030-req-drill.png)


**あるいは、**[障害] ブレードのさらに下にある例外の一覧から開始できます。個別の例外が表示されるまでクリックしてください。


![ドリル スルー](./media/app-insights-asp-net-exception-mvc/040-exception-drill.png)
...
![ドリル スルー](./media/app-insights-asp-net-exception-mvc/050-exception-properties.png)
...
![ドリル スルー](./media/app-insights-asp-net-exception-mvc/viewCustomEvents.png)
...
![ドリル スルー](./media/app-insights-asp-net-exception-mvc/060-req-related.png)
