...
この操作をまだ行っていない場合は、[Application Insights をアプリ プロジェクトに追加][platforms]して再発行ください。
...
![クラッシュのグラフから、[アラート ルール]、[アラートの追加] の順にクリックします](./media/app-insights-crashes/appinsights-d023-alert.png)
