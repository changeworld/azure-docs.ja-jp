...
## <a name="<a-name="q01"></a>no-'add-application-insights'-option-in-visual-studio"></a><a name="q01"></a>No 'Add Application Insights' option in Visual Studio
...
## <a name="<a-name="q02"></a>adding-application-insights-failed"></a><a name="q02"></a>Adding Application Insights failed
...
## <a name="<a-name="emptykey"></a>i-get-an-error-"instrumentation-key-cannot-be-empty""></a><a name="emptykey"></a>I get an error "Instrumentation key cannot be empty"
...
##<a name="<a-name="nugetbuild"></a>-"nuget-package(s)-are-missing"-on-my-build-server"></a><a name="NuGetBuild"></a> "NuGet package(s) are missing" on my build server
...
## <a name="<a-name="q03"></a>-no-server-data-(or-no-data-at-all)"></a><a name="q03"></a> No server data (or no data at all)
...
## <a name="<a-name="q04"></a>no-data-on-page-views,-browsers,-usage"></a><a name="q04"></a>No data on Page Views, Browsers, Usage
...
## <a name="i-don't-see-all-the-data-i'm-expecting"></a>I don't see all the data I'm expecting
