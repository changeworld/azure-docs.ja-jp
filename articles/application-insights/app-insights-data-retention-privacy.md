...
* 要求、クラッシュなどをレポートするために SDK モジュールによって送信されるテレメトリ項目。
...
3.	要求名やページの URL などの標準プロパティは、1 週間あたりの 1,000 の一意な値に制限されます。一意の値が 1,000 個を超えると、追加の値は "その他の値" としてマークされます。元の値は、全文テキスト検索とフィルタリングに引き続き使用できます。
