...
![アプリでの Application Insights のインストルメンテーションは、Azure ポータルの Application Insights リソースにテレメトリを送信します。](./media/app-service-app-insights-get-started/01-scheme.png)
...
![概要ブレード](./media/app-service-app-insights-get-started/01-find.png)
...
![サーバー ブレード](./media/app-service-app-insights-get-started/04.png)
...
![グラフの編集](./media/app-service-app-insights-get-started/05.png)
...
![インスタンスの検索](./media/app-service-app-insights-get-started/06.png)

[フィルター] を使用して、特定の種類のイベントと選択したプロパティの値を検索します。

![プロパティのフィルター処理](./media/app-service-app-insights-get-started/07.png)

[...] をクリックして、プロパティの完全な一覧を表示するか、同じ要求に関連付けられているその他のイベントを開きます。この例では、失敗した要求には、例外レポートが関連付けられています。

![関連項目とプロパティの詳細](./media/app-service-app-insights-get-started/08.png)

イベント (この例では関連する例外) を開き、作業項目を作成できます (Visual Studio Team Services を使用してタスクを追跡している場合)。
 
![作業項目の作成](./media/app-service-app-insights-get-started/09.png)
...
![ダッシュボード](./media/app-service-app-insights-get-started/12.png)
