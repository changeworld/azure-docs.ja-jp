...
![新しいグラフを追加するか、グラフを選択し、[カスタム] でメトリックを選択する](./media/app-insights-custom-events-metrics-api/03-track-custom.png)
...
![概要ブレードの使用状況レンズ](./media/app-insights-custom-events-metrics-api/appinsights-47usage-2.png)
