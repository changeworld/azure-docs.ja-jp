---
title: PowerShell を使用した Application Insights リソースの作成
...
1. [Azure リソース マネージャー](https://resources.azure.com/)を開きます。サブスクリプション、resourceGroups、コンポーネントを通り抜けて、アプリ リソースまで下方向に移動します。
