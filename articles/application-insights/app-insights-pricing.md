...
* 毎月、アプリケーションは、指定された量のテレメトリを Application Insights に送ることができます。無料の価格レベルのクォータは現在 500 万データ ポイント/月で、他のスキームのクォータはそれをはるかに上回ります。クォータの上限に達したら追加購入することができます。実際の数値については、「[料金プラン][pricing]」をご確認ください。 
...
調整が発生した場合、この状況が発生したことを通知する警告が表示されます。
