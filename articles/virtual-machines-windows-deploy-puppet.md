<properties title="Puppet と Azure Virtual Machines について" pageTitle="Puppet と Azure Virtual Machines について" description="Azure の VM での Puppet のインストールと構成について説明します。" metaKeywords="" services="virtual machines" solutions="" documentationCenter="" authors="kathydav" manager="timlt" videoId="" scriptId="" />
