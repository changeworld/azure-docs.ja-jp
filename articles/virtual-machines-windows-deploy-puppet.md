<properties pageTitle="Puppet と Azure Virtual Machines について" description="Azure の VM での Puppet のインストールと構成について説明します。" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
