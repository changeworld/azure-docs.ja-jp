...
| パラメーター | 必須 | type | 説明 | 
| --------- | -------- | ---- | ----------- | 
| <*expression1*>, <*expression2*>, ... | [はい] | ブール | 調べる式 | 
||||| 

| 戻り値 | type | 説明 | 
| ------------ | -----| ----------- | 
| true または false | ブール | すべての式が true の場合は true を返します。 少なくとも 1 つの式が false の場合は false を返します。 | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 指定した値のブール値バージョン | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 項目が見つかった場合は true を返します。 見つからなかった場合は false を返します。 |
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | コレクションが空の場合は true を返します。 空でない場合は false を返します。 | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false  | ブール | 末尾の部分文字列が見つかった場合は true を返します。 見つからなかった場合は false を返します。 | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 両方が等しい場合は true を返します。 等しくない場合は false を返します。 | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 1 番目の値が 2 番目の値より大きい場合は true を返します。 1 番目の値が 2 番目の値以下の場合は false を返します。 | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 1 番目の値が 2 番目の値より大きいか等しい場合は true を返します。 1 番目の値が 2 番目より小さい場合は false を返します。 | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 1 番目の値の方が 2 番目より小さい場合は true を返します。 1 番目の値が 2 番目の値以上の場合は false を返します。 | 
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false  | ブール | 1 番目の値が 2 番目の値より小さいか等しい場合は true を返します。 1 番目の値が 2 番目の値より大きい場合は false を返します。 |  
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 式が false の場合は true を返します。 式が true の場合は false を返します。 |  
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false | ブール | 少なくとも 1 つの式が true の場合は true を返します。 すべての式が false の場合は false を返します。 |  
|||| 
...
| 戻り値 | type | 説明 | 
| ------------ | ---- | ----------- | 
| true または false  | ブール | 先頭の部分文字列が見つかった場合は true を返します。 見つからなかった場合は false を返します。 | 
|||| 
