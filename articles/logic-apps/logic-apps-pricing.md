...
従量制プランに含まれている統合アカウントに加えて、標準の統合アカウントを作成することもできます。このアカウントには上記の制限がなく、標準の Logic Apps SLA が適用されます。 詳しくは、[Azure の価格](https://azure.microsoft.com/pricing/details/logic-apps)に関するページをご覧ください。
