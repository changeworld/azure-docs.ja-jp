---
title: ロジック アプリ テンプレートをデプロイする - Azure Logic Apps
...
特定の Azure リソース グループにデプロイするには、次のコマンドを使用します。
...
Azure Pipelines と Azure Resource Manager テンプレートの継続的インテグレーションおよび継続的配置 (CI/CD) の詳細については、以下のトピックを参照してください。
