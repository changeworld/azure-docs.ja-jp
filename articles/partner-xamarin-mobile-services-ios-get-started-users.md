<properties urlDisplayName="Get Started with Authentication (Xamarin.iOS)" pageTitle="認証の使用 (Xamarin.iOS) - Mobile Services" metaKeywords="アプリケーションを登録する Azure, Azure 認証, アプリケーション認証, モバイル サービスの認証, Mobile Services Xamarin.iOS" description="Learn how to use authentication in your Azure Mobile Services app for Xamarin.iOS." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile"  services="mobile-services" title="Get started with authentication in Mobile Services" manager="dwrede" authors="donnam" />
