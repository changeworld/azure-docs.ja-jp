...
* Azure ExpressRoute - ExpressRoute パートナーを通してプライベート接続を構成します。 
...
パブリック IP アドレス使用時のセキュリティを強化するため、ネットワーク セキュリティ グループを使用して、ポート 22 経由では着信アクセスのみを許可します。
