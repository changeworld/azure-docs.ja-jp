...
このページの使用についての詳細は、Avere クラスター構成ガイドの[DNS 設定](<http://library.averesystems.com/ops_guide/4_7/gui_admin_network.html#gui-dns>)に関するページをお読みください。
