---
title: Web アプリケーション ファイアウォールで Web トラフィックを制限する - Azure CLI
...
---
# <a name="tutorial-restrict-web-traffic-with-a-web-application-firewall-using-the-azure-cli"></a>チュートリアル: Azure CLI を使用して、Web アプリケーション ファイアウォールで Web トラフィックを制限する
