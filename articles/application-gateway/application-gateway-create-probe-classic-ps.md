---
title: クラシック デプロイ モデルで PowerShell を使用して Application Gateway のカスタム プローブを作成する | Microsoft Docs
...
[Resource Manager モデルを使用してこれらの手順を実行する](application-gateway-create-probe-ps.md)方法を確認してください。
