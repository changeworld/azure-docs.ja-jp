...
### <a name="step-2"></a>手順 2.
"pool01" および "pool02" という名前のバックエンド IP アドレス プールを構成します。"pool01" には IP アドレス "10.0.1.100, 10.0.1.101,10.0.1.102" を使用し、"pool02" には IP アドレス "10.0.1.103, 10.0.1.104, 10.0.1.105" を使用します。
