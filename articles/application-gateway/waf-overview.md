...
現在の WAF パブリック プレビュー SKU には、次の機能が含まれます。
...
WAF のパブリック プレビューについて詳しくは、「[Web アプリケーション ファイアウォール要求サイズ制限と除外リスト (パブリック プレビュー)](application-gateway-waf-configuration.md)」をご覧ください。
