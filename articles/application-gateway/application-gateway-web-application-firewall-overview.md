...
|**[REQUEST-912-DOS-PROTECTION](application-gateway-crs-rulegroups-rules.md#crs912)**| サービス拒否 (DoS) 攻撃から保護するための規則が含まれています。|
