...
この問題を解決するには、FQDN を使用して Application Gateway にアクセスする必要があります。 たとえば、[http://website.com](http://website.com/) または [http://appgw.website.com](http://appgw.website.com/) を使用します。
