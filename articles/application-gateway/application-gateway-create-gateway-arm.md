---
title: "Azure Resource Manager を使用した Application Gateway の作成、起動、または削除 | Microsoft Docs"
...
> * [Azure App Service で Java Web アプリ](application-gateway-create-gateway-portal.md)
...
## <a name="create-a-public-ip-address-for-the-frontend-configuration"></a>フロントエンド構成のパブリック IP アドレスの作成
...
## <a name="create-an-application-gateway-by-using-newazurermapplicationgateway"></a>New-AzureRmApplicationGateway を使用した Application Gateway の作成
