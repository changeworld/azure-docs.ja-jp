...
![[Web Application Firewall の追加] ページのスクリーンショット。 [既存のソリューションの使用] の下にアプリケーション ゲートウェイが表示されます。][4]
...
![[アプリケーションの保護を完了する] ページのスクリーンショット。アプリケーションが 1 つ表示されいます。 テキストには、アプリケーションを保護するための手順が説明されています。][5]
