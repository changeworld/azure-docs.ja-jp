---
title: Azure リソース マネージャーを使用した SSL オフロード用の Application Gateway の構成 | Microsoft Docs
...
## <a name="create-a-virtual-network-and-a-subnet-for-the-application-gateway"></a>Application Gateway の仮想ネットワークとサブネットの作成
