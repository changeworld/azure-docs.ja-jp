...
Application Gateway の Web アプリケーション ファイアウォール (WAF) のトラブルシューティングについては、「[Azure Application Gateway の Web アプリケーション ファイアウォール (WAF) のトラブルシューティング](../web-application-firewall/ag/web-application-firewall-troubleshoot.md)」を参照してください。