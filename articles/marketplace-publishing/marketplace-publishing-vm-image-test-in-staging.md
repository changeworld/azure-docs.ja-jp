...
4. 前の手順で示されている上記のいずれかの Azure サブスクリプションを使用して、[Azure プレビュー ポータル](http://portal.azure.com)にサインインします。
...
> データ センター全体をレプリケーションするには、最大 48 時間かかります。レプリケーションが完了した後、プランが [Azure Marketplace](http://azure.microsoft.com/marketplace) に一覧表示されます。
