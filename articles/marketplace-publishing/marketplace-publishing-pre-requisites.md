...
> 販売者の登録作業で問題が発生した場合は、次の手順でサポート チケットにログインしてください。 1. [サポート](http://go.microsoft.com/fwlink?LinkId=272975)に問い合わせる 2. [**販売者ダッシュ ボードの登録とお客様のアカウント**] を選択する 3. [**開発者アカウントに登録する**] を選択する 4. 連絡**方法**を選択する
