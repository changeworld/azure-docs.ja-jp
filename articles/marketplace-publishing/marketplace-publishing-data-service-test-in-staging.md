<properties
   pageTitle="Marketplace のデータ サービス プランのテスト | Microsoft Azure"
...
> [AZURE.NOTE]必ず先頭に表示されるサービスの説明テキストを確認してください。プランが複数のサービス呼び出しで構成されている場合、一番下のタブをクリックして、次のサービスに移動してレビューおよびテストできます。
