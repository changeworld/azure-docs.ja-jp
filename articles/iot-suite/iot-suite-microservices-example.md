...
![Postman に表示された Alive and Well メッセージ](media/iot-suite-microservices-example/postman-alive-well.png)
...
![成功した Docker イメージ](media/iot-suite-microservices-example/successful-docker-image.png)
...
![Docker Hub の Docker イメージ](media/iot-suite-microservices-example/docker-image-in-docker-hub.png)
...
![Postman に表示された New Edits Made Here メッセージ](media/iot-suite-microservices-example/new-postman-message.png)
...
次に、[リモート監視ソリューションのデバイス シミュレーター マイクロサービスをカスタマイズ](iot-suite-remote-monitoring-test.md)してみてください
