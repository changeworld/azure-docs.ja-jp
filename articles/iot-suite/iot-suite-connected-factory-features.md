...
![コネクテッド ファクトリ ソリューションのダッシュボード](media/iot-suite-connected-factory-features/dashboard.png)
...
[しきい値に基づくアラート ルールを構成](iot-suite-connected-factory-configure.md)します。
...
- ソリューションを[カスタマイズ](iot-suite-v1-guidance-on-customizing-preconfigured-solutions.md)して、独自のビジネス要件を満たします。
