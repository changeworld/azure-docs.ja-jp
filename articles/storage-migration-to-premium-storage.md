...
|**STANDARD_DS14**|16|50,000|512 MB/秒|
...
OS イメージまたは OS ディスクを登録したら、新しい DS シリーズ Azure VM インスタンスを作成できます。登録したオペレーティング システム イメージまたはオペレーティング システム ディスクの名前を使用します。Premium Storage レベルから VM の種類を選択します。次の例では、"Standard_DS2" という VM サイズを使用します。
