<properties
	pageTitle="Apache Storm チュートリアル: Storm Starter サンプルをお試しください | Microsoft Azure"
	description="HDInsight の Storm Starter サンプルを実行して Apache Storm を使用したビッグ データ分析の概要Apache Storm を使用してデータをリアルタイムに処理する方法について説明します。"
	services="hdinsight"
	documentationCenter=""
	authors="Blackmist"
	manager="paulettm"
...
# HDInsight の Apache Storm チュートリアル: Storm Starter サンプルを使用したビッグ データ分析の概要 
...
2. 左下隅にある **[新規]** をクリックし、**[データ サービス]**、**[ストレージ]**、**[簡易作成]** の順にクリックします。
	...
	![簡易作成を使用して新しいストレージ アカウントを設定できる Azure ポータル。](./media/hdinsight-storm-getting-started/HDI.StorageAccount.QuickCreate.png)
...
3. 2 番目の列にある HDInsight アイコンをクリックし、**[STORM]** を選択します。
	...
	![簡易作成](./media/hdinsight-storm-getting-started/quickcreate.png)
...
![Storm ダッシュボードのリンクを使用した Azure ポータル](./media/hdinsight-storm-getting-started/dashboard-link.png)
...
![送信トポロジ フォームを使用した Storm ダッシュボード](./media/hdinsight-storm-getting-started/submit.png)
...
1. **[Jar ファイル]** ドロップダウンから **[StormStarter - WordCount]** を選択します。これで、このサンプル用のパラメーターが **[クラス名]** と **[追加のパラメーター]** フィールドに入力されます。
	...
	![選択した WordCount を使用した Storm ダッシュボード](./media/hdinsight-storm-getting-started/submit.png)
...
2. **[送信]** ボタンをクリックします。しばらくすると、 **[結果]** フィールドにジョブの送信に使用したコマンドとコマンドの結果が表示されます。**[エラー]** フィールドには、トポロジの送信で発生したエラーが表示されます。
	...
	![送信ボタンと結果](./media/hdinsight-storm-getting-started/submit-results.png)
...
1. Storm ダッシュボードの上部で、**[Storm UI]** を選択します。クラスターの情報と実行中のすべてのトポロジに関する概要情報が表示されます。
	...
	![トポロジの概要を表示する storm ui](./media/hdinsight-storm-getting-started/stormui.png)
