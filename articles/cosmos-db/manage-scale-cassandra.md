...
## <a id="use-azure-portal"></a>Azure portal を使用する
...
## <a id="use-control-plane"></a>コントロール プレーンを使用する
...
## <a id="use-cql-queries"></a>特定の SDK で CQL クエリを使用する
...
## <a id="use-autopilot"></a>オートパイロットを使用する
