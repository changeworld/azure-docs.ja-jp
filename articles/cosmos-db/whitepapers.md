...
| **ホワイトペーパー** | **説明** |
| --- | --- |
| [Total Cost of Ownership of a NoSQL Database Cloud Service (NoSQL Database Cloud Service の総保有コスト)](https://aka.ms/cosmosdb-tco-paper) |このホワイト ペーパーでは、オンプレミス データベースやクラウド インフラストラクチャを使ったデータベースなど、各種のデプロイ構成におけるソフトウェアの運営コストや保有コストの総額を比較しています。 また、使用タイプ (高、低、中) ごとの総保有コストの見積もりも示されています |
