...
description: リリース日、提供終了日、各バージョン間で行われた変更など、Azure Cosmos DB Table API for .NET に関するすべてについて説明します。
author: sakash279
ms.author: akshanka
...
Azure Cosmos DB Table API の詳細については、「[Introduction to Azure Cosmos DB Table API (Azure Cosmos DB Table API の概要)](introduction.md)」を参照してください。 
