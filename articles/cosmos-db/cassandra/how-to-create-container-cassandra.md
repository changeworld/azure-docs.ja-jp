...
この記事では、Azure Cosmos DB Cassandra API でコンテナーを作成するさまざまな方法について説明します。 異なる API を使用している場合は、[MongoDB 用の API](../mongodb/how-to-create-container-mongodb.md)、[Cassandra API](../how-to-create-container-gremlin.md)、[Table API](../table/how-to-create-container.md)、[SQL API](../how-to-create-container.md) に関する記事を参照してコンテナーを作成してください。
...
1. [新しい Azure Cosmos アカウントを作成する](manage-data-dotnet.md#create-a-database-account)か、既存のアカウントを選択します。
