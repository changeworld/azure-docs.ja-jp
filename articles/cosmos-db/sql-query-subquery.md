...
この記事では、Azure Cosmos DB の SQL サブクエリとその一般的なユース ケースについて説明します。 このドキュメントのサンプル クエリはすべて[サンプル栄養データセット](https://github.com/AzureCosmosDB/labs/blob/master/dotnet/setup/NutritionData.json)に対して実行できます。
