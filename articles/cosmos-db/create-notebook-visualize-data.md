---
title: Azure Cosmos DB でデータを分析して視覚化するノートブックを作成する
description: 組み込みの Jupyter ノートブックを使用して、Azure Cosmos DB へのデータのインポート、データの分析、出力の視覚化を行う方法について説明します。
author: deborahc
ms.topic: tutorial
...
ms.locfileid: "72023848"
---
# <a name="create-a-notebook-in-azure-cosmos-db-to-analyze-and-visualize-the-data"></a>Azure Cosmos DB でデータを分析して視覚化するノートブックを作成する
