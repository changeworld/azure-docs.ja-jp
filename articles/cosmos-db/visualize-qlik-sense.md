---
title: Qlik Sense を Azure Cosmos DB に接続してデータを可視化する | Microsoft Docs
...
> [!NOTE]
> Azure Cosmos DB と Qlik Sense との接続は現在、Azure Cosmos DB SQL API アカウントでのみサポートされています。
