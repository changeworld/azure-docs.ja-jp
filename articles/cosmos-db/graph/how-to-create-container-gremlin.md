...
この記事では、Azure Cosmos DB Gremlin API にコンテナーを作成するいくつかの方法について説明します。 別の API を使用している場合、コンテナーを作成するには、[MongoDB の API](../mongodb/how-to-create-container-mongodb.md)、[Cassandra API](../cassandra/how-to-create-container-cassandra.md)、[Table API](../table/how-to-create-container.md)、[SQL API](../how-to-create-container.md) に関する記事を参照してください。
