...
:::image type="content" source="./media/use-regional-endpoints/get-end-point-portal.png " alt-text="ポータルから Cosmos DB Graph アカウントのリージョンを取得する":::
