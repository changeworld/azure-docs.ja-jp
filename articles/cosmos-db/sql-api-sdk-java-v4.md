...
|**API ドキュメント** | [Java API リファレンス ドキュメント](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-cosmos/latest/index.html) |
...
> * 4\.7.0 リリース - 4.7.0 以降のバージョンを使用することを強くお勧めします。
