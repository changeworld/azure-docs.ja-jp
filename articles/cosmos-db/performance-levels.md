...
ご使用のコレクションのパフォーマンス レベルを変更するもう 1 つの方法は、Azure Cosmos DB SDK を使用する方法です。 ここでは、[DocumentDB .NET API](documentdb-sdk-dotnet.md) を使用してコレクションのパフォーマンス レベルを変更する手順を説明しますが、この手順は他の SDK の場合にもほぼ当てはまります。
