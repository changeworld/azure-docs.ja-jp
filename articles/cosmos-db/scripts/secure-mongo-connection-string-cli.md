...
このサンプルでは、Azure CLI を使用して MongoDB 用の Azure Cosmos DB 接続文字列を取得します。
...
| [az cosmosdb list-connection-strings](/cli/azure/cosmosdb#az-cosmosdb-list-connection-strings) | アカウント用の接続文字列を取得します。|
