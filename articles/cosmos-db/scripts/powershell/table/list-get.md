...
| [Get-AzCosmosDBTable](/powershell/module/az.cosmosdb/get-azcosmosdbtable) | アカウントに存在する Table API テーブルを一覧表示します。または、指定された Table API テーブルをアカウントから取得します。 |
|**Azure リソース グループ**| |
