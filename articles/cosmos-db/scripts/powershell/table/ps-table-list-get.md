...
| [Get-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbtable) | アカウントに存在する Cosmos DB Table API テーブルを一覧表示します。または、指定された Cosmos DB Table API テーブルをアカウントから取得します。 |
|**Azure リソース グループ**| |
