...
|---|---|
|**Azure Cosmos DB**| |
| [Get-AzCosmosDBTableThroughput](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbtablethroughput) | 指定された Table API テーブルのスループット値を取得します。 |
|**Azure リソース グループ**| |
