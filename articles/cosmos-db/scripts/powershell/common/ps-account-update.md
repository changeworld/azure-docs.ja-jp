...
ms.locfileid: "71154737"
---
# <a name="update-an-azure-cosmos-account-or-add-modify-regions-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントを更新したりリージョンを追加変更したりする
