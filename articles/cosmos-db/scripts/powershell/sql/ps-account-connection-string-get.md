---
title: Azure PowerShell スクリプト - Azure Cosmos アカウントの接続文字列を取得する
description: Azure PowerShell サンプル スクリプト - Azure Cosmos アカウントの接続文字列を取得する
author: markjbrown
...
ms.locfileid: "65080575"
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントの接続文字列を取得する
