---
title: Azure PowerShell スクリプト - Azure Cosmos アカウントにコンテナーを作成する
description: Azure PowerShell サンプル スクリプト - Azure Cosmos アカウントにコンテナーを作成する
author: markjbrown
...
ms.locfileid: "65080547"
---
# <a name="create-a-container-in-an-azure-cosmos-account-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントにコンテナーを作成する
