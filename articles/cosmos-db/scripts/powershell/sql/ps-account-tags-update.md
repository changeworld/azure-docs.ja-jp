---
title: Azure PowerShell スクリプト - Azure Cosmos アカウントのタグを更新する
description: Azure PowerShell サンプル スクリプト - Azure Cosmos アカウントのタグを更新する
author: markjbrown
...
ms.locfileid: "65080561"
---
# <a name="update-tags-for-an-azure-cosmos-account-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントのタグを更新する
