---
title: Azure PowerShell スクリプト - Azure Cosmos アカウントのコンテナーを削除する
description: Azure PowerShell サンプル スクリプト - Azure Cosmos アカウントのコンテナーを削除する
author: markjbrown
...
ms.locfileid: "65080545"
---
# <a name="delete-a-container-in-an-azure-cosmos-account-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントのコンテナーを削除する
