---
title: Azure PowerShell スクリプト - Azure Cosmos アカウントを削除する
description: Azure PowerShell サンプル スクリプト - Azure Cosmos アカウントを削除する
author: markjbrown
...
ms.locfileid: "65080571"
---
# <a name="delete-an-azure-cosmos-account-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントを削除する
