---
title: Azure PowerShell スクリプト - Azure Cosmos アカウントのキーを再生成する
description: Azure PowerShell サンプル スクリプト - Azure Cosmos アカウントのキーを再生成する
author: markjbrown
...
ms.locfileid: "65080563"
---
# <a name="regenerate-keys-for-an-azure-cosmos-account-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントのキーを再生成する
