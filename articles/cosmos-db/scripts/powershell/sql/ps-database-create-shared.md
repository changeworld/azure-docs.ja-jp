---
title: Azure PowerShell スクリプト - 共有スループットで Azure Cosmos データベースを作成する
description: Azure PowerShell サンプル スクリプト - 共有スループットで Azure Cosmos データベースを作成する
author: markjbrown
...
ms.locfileid: "65080477"
---
# <a name="create-an-azure-cosmos-database-with-shared-throughput-using-powershell"></a>PowerShell を使用して共有スループットで Azure Cosmos データベースを作成する
