---
title: Azure PowerShell スクリプト - Azure Cosmos アカウントのキーを取得する
description: Azure PowerShell サンプル スクリプト - Azure Cosmos アカウントのキーを取得する
author: markjbrown
...
ms.locfileid: "65080569"
---
# <a name="get-keys-for-an-azure-cosmos-account-using-powershell"></a>PowerShell を使用して Azure Cosmos アカウントのキーを取得する
