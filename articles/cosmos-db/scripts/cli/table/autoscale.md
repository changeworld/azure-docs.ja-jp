---
title: Azure Cosmos DB 用の自動スケーリングを使用する Table API テーブルを作成する
description: Azure Cosmos DB 用の自動スケーリングを使用する Table API テーブルを作成する
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107789071"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-with-autoscale-using-azure-cli"></a>Azure CLI を使用して自動スケーリングを使用する Azure Cosmos Table API のアカウントとテーブルを作成する
