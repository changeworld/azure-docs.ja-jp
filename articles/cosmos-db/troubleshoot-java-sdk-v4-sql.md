...
| 408 | はい | [要求がタイムアウトしました](troubleshoot-request-timeout-java-sdk-v4-sql.md) |
...
| 503 | はい | [サービスを利用できません](troubleshoot-service-unavailable-java-sdk-v4-sql.md) |
