---
title: Azure Cosmos DB Gremlin API のパーティション分割 | Microsoft Docs
...
- Azure Cosmos DB Gremlin API コンテナーのバックエンドに、**頂点とエッジの両方が JSON ドキュメントとして格納されます**。
...
この記事では、Azure Cosmos DB Gremlin API を使ったパーティション分割の概念とベスト プラクティスについて概説しました。 
