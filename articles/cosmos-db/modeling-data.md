---
title: NoSQL データベースのドキュメント データのモデル化
...
確かに、作者名が変更された場合や、作者が写真を更新したい場合は、これまでに発行されたすべての書籍に対して更新を行う必要がありましたが、このアプリケーションでは、作者名は頻繁には変更されないという前提に基づいて、この設計が仕様を満たしていると判断しています。  
