...
データベース上のプロビジョニングされたスループットは、そのデータベース内のコンテナーで共有できます。 データベース上のプロビジョニングされたスループットは、最大 25 個のコンテナーで共有できます。 25 個を超えるコンテナーでは、そのデータベース内に新しいコンテナーが作成されるたびに、データベースのスループットの一部を、データベース内の既に使用できる他のコレクションと共有できます。 共有できるスループットの量は、データベースにプロビジョニングされているコンテナー数によって変わります。 

ワークロードでデータベース内のすべてのコレクションを削除および再作成する必要がある場合は、空のデータベースを削除し、コレクションの作成前に新しいデータベースを再作成することをお勧めします。
