...
.NET のオープン ソース Gremlin ドライバーである Gremlin.Net を使用することをお勧めします。 使い始める方法については、[Azure Cosmos DB: .NET と Graph API を使用したグラフ アプリの作成](create-graph-dotnet.md)に関するページを参照してください。
