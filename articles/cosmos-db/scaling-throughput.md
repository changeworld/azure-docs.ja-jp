...
ms.locfileid: "91397353"
---
# <a name="how-does-azure-cosmos-db-globally-scale-the-provisioned-throughput"></a>Azure Cosmos DB では、プロビジョニングされたスループットがどのようにグローバルでスケーリングされますか。
