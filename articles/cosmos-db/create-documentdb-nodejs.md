...
このクイック スタートでは、Azure Portal を使用して、Azure Cosmos DB アカウント、ドキュメント データベース、コレクションを作成する方法を説明します。 さらに、[DocumentDB Node.js API](../documentdb/documentdb-sdk-node.md) に基づいたコンソール アプリを構築して実行します。
