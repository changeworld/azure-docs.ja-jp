...
<<<<<<< HEAD:articles/cosmos-db/create-sql-api-spring-data.md
> [Azure Cosmos DB へのデータのインポート](import-data.md)
=======
> [Azure Cosmos DB へのデータのインポート](../import-data.md)
>>>>>>> repo_sync_working_branch:articles/cosmos-db/sql/create-sql-api-spring-data.md
