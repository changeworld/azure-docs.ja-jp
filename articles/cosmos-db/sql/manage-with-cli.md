...
他の API の Azure CLI サンプルについては、[CLI Samples for Cassandra](../cassandra/cli-samples.md)、[CLI Samples for MongoDB API](../mongodb/cli-samples.md)、[CLI Samples for Gremlin](../graph/cli-samples.md)、[CLI Samples for Table](../table/cli-samples.md) を参照してください。
