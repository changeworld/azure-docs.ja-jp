...
> [!NOTE]
> 最新の [.NET SDK バージョン](https://www.nuget.org/packages/Microsoft.Azure.Cosmos/3.20.1)を使用することをお勧めします。
...
- **ユーザー定義関数の拡張関数**: スタブ メソッド [CosmosLinq.InvokeUserDefinedFunction](/dotnet/api/microsoft.azure.cosmos.linq.cosmoslinq.invokeuserdefinedfunction?view=azure-dotnet&preserve-view=true) から、対応する[ユーザー定義関数](sql-query-udfs.md)への変換をサポートします。
