...
| 添付ファイル |添付ファイルは、外部の BLOB またはメディアに対する参照や関連するメタデータを含んだ特殊なドキュメントです。 開発者は、BLOB を Cosmos DB の管理下におくか、外部の Blob service プロバイダー (OneDrive、Dropbox など) を使って保存するかを選択できます。 |
