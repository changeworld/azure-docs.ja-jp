...
Azure Cosmos DB の MongoDB API の学習を開始するにあたり、次のトピックとリソースは必ず読む必要があります。
...
- ビデオ: [Node.js + Angular](tutorial-develop-mongodb-nodejs.md)
- ビデオ: [Node.js + React](tutorial-develop-mongodb-react.md)

### <a name="migrate-mongodb-data"></a>MongoDB データに移行する

- [MongoDB データをインポートする](mongodb-migrate.md)

### <a name="work-with-data"></a>データの処理

- [MongoDB シェルのクエリ](tutorial-query-mongodb.md)
- [データのグローバル配布](tutorial-global-distribution-mongodb.md)
