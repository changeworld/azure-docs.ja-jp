...
|---------|---------|---------|---------|
|1|単一または複数の書き込みリージョン|任意の整合性レベル|240 分未満|
|>1|単一の書き込みリージョン|セッション、一貫性のあるプレフィックス、最終的|15 分未満|
|>1|単一の書き込みリージョン|Bounded Staleness|*K* & *T*|
|>1|単一の書き込みリージョン|Strong|0|
|>1|複数の書き込みリージョン|セッション、一貫性のあるプレフィックス、最終的|15 分未満|
|>1|複数の書き込みリージョン|Bounded Staleness|*K* & *T*|
