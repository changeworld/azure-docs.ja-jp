...
## <a name="default-policy-for-an-sgx-enclave-with-policyformattext"></a>SGX エンクレーブの既定のポリシー (PolicyFormat=Text)
...
## <a name="default-policy-for-vbs-enclave"></a>VBS エンクレーブの既定のポリシー

VBS エンクレーブには既定のポリシーがありません。
