<properties title="How to scale a website" pageTitle="Web サイトの規模の変更方法" description="Learn how to scale your hosting plan in Azure." authors="stepsic" manager="kamrani" />
