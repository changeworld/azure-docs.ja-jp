---
title: "PowerShell を使用して Azure サービスの逆引き DNS レコードを管理する | Microsoft Docs"
...
---
# <a name="how-to-manage-reverse-dns-records-for-your-azure-services-using-azure-powershell"></a>Azure PowerShell を使用して Azure サービスの逆引き DNS レコードを管理する方法
