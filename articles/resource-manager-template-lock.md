...
| name | string | あり | リソース:<br /> {リソース}/Microsoft.Authorization/{ロックの名前}**<br /><br />リソース グループ:<br />**{ロックの名前}**<br /><br />最大 64 文字<br /><、>、%、&、? などの制御文字を含めることはできません。| ロックするリソースおよびロックの名前の両方を指定する値。|
...
| プロパティ | オブジェクト | あり | (下記参照) | ロックの種類を識別するオブジェクト、およびロックに関するメモ。| 
