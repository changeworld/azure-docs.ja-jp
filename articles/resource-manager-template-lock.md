...
管理ロックを作成または削除するには、**Microsoft.Authorization/*** または **Microsoft.Authorization/locks/*** アクションにアクセスできる必要があります。組み込みのロールのうち、**所有者**と**ユーザー アクセスの管理者**にのみこれらのアクションが許可されています。ロール ベースのアクセス制御の詳細については、「[リソースへのアクセスの管理と監査](./azure-portal/resource-group-rbac.md)」を参照してください。
