...
> [AZURE.NOTE] 大きなテーブルを作成し直す場合は、SQL Data Warehouse のワークロード管理機能が役立ちます。詳細については、[同時実行][]に関する記事の「ワークロード管理」セクションをご覧ください。
...
分離レベルとトランザクションの制限の詳細については、「[SQL Data Warehouse のトランザクション][]」をご覧ください。ベスト プラクティスの概要については、「[SQL Data Warehouse のベスト プラクティス][]」をご覧ください。
