...
認証とは、データベースへの接続時に ID を証明する方法のことです。SQL Data Warehouse では現在、ユーザー名とパスワードを使用した SQL Server 認証がサポートされています。
...
[SQL Database 監査の使用]: sql-database-auditing-overview.md
