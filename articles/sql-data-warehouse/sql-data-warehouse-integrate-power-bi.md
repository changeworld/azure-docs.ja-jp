...
2.  [ビッグ データ、その他] を選択します。
3.  [ビッグ データ、その他] のページに移動したら、SQL Data Warehouse を選択します。
4.  必要な接続情報を入力します。次に、下の [パラメーターの検索] セクションに、このデータの場所が表示されます。  
5.	データセットにドリル ダウンすることで、データベース内のすべてのテーブルと列を探索できます。列を選択すると、ソースにクエリが送信されて、ビジュアルが動的に作成されます。これらのビジュアルは新しいレポートに保存され、ダッシュボードに固定できます。
