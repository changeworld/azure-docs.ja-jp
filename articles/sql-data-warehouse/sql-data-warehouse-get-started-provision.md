---
title: Azure ポータルでの SQL Data Warehouse の作成 | Microsoft Docs
...
* **Azure SQL サーバー**: 詳細については、[Azure ポータルでの Azure SQL Database 論理サーバーの作成][Azure ポータルでの Azure SQL Database 論理サーバーの作成]に関するセクションを参照してください。
...
> [!NOTE]
> SQL Data Warehouse の既定の照合順序は、SQL\_Latin1\_General\_CP1\_CI\_AS です。別の照合順序が必要な場合は、[T-SQL][T-SQL] を使って別の照合順序のデータベースを作成できます。
> 
> 
...
TRANSACT-SQL を使用して、ファイアウォール規則を構成することもできます。詳細については、[sp\_set\_firewall\_rule][sp\_set\_firewall\_rule] と [sp\_set\_database\_firewall\_rule][sp\_set\_database\_firewall\_rule] を確認してください。
