...
* **Azure SQL サーバー**: 詳細については、[Azure Portal での Azure SQL Database 論理サーバーの作成][Create an Azure SQL Database logical server with the Azure portal]に関するセクションを参照してください。
