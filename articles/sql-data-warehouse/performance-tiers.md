...
| サービス れ辺rう | 同時クエリの最大数 | コンピューティング ノード | コンピューティング ノードごとの配布 | 配布あたりの最大メモリ (MB) | データ ウェアハウスあたりの最大メモリ (GB) |
|:-------------:|:----------------------:|:-------------:|:------------------------------:|:--------------------------------:|:----------------------------------:|
| DW100         | 4                      | 1             | 60                             | 400                              |  24                                |
| DW200         | 8                      | 2             | 30                             | 800                              |  48                                |
...
| サービス れ辺rう | 同時クエリの最大数 | コンピューティング ノード | コンピューティング ノードごとの配布 | 配布あたりの最大メモリ (GB) | データ ウェアハウスあたりの最大メモリ (GB) |
|:-------------:|:----------------------:|:-------------:|:------------------------------:|:--------------------------------:|:----------------------------------:|
...
| サービス れ辺rう | 同時クエリの最大数 | 割り当てられる同時実行スロット数 | smallrc | mediumrc | largerc | xlargerc |
|:-------------:|:--------------------------:|:---------------------------:|:-------:|:--------:|:-------:|:--------:|
| DW100         |  4                         |   4                         | 1       |  1       |  2      |   4      |
| DW200         |  8                         |   8                         | 1       |  2       |  4      |   8      |
| DW300         | 12                         |  12                         | 1       |  2       |  4      |   8      |
