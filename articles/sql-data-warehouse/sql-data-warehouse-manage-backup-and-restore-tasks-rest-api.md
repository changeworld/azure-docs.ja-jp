<properties
   pageTitle="Azure SQL Data Warehouse でのバックアップと復元 (REST) | Microsoft Azure"
...
# Azure SQL Data Warehouse でのデータベースのバックアップと復元 (REST)
...
REST API を使用して SQL Data Warehouse でデータベースをバックアップおよび復元する方法。
