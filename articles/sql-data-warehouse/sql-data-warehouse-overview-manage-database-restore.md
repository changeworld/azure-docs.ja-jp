...
この記事では、Azure SQL Data Warehouse でデータベースを復元するオプションについて説明します。ライブ データ ウェアハウスおよび削除されたデータ ウェアハウスの復元を対象とします。ライブ データ ウェアハウスおよび削除されたデータ ウェアハウスは、すべてのデータ ウェアハウスから作成された自動スナップショットから復元されます。
