...
これで SQL Data Warehouse の概要を押さえたので、次は、[データ ウェアハウスのワークロード]、SQL Data Warehouse を[プロビジョニングする方法]、[サンプル データを読み込む方法]について確認してください。または、次の SQL Data Warehouse リソースも確認できます。
...
[サンプル データを読み込む方法]: ./sql-data-warehouse-get-started-manually-load-samples.md
