...
たとえば、DWU 100 の場合、smallrc リソース クラス内のユーザーはディストリビューションごとに 100 MB のメモリを使用できます。 詳細については、[SQL Data Warehouse でのコンカレンシー](resource-classes-for-workload-management.md)に関する記事を参照してください。
