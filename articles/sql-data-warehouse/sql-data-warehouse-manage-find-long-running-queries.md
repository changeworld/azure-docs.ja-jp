<properties
   pageTitle="Azure SQL Data Warehouse での実行時間の長いユーザー クエリの検索 | Microsoft Azure"
   description="動的管理ビュー (DMV) を使用して、Azure SQL Data Warehouse でワークロードを監視し、実行時間の長いクエリを検索する方法について説明します。"
