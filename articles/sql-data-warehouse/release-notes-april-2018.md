...
## <a name="behavior-changes"></a>動作変更

### <a name="dbcc-commands-do-not-consume-concurrency-slots"></a>DBCC コマンドは同時実行スロットを消費しない
...
### <a name="updated-error-message-for-excessive-literals"></a>過剰なリテラルに対するエラー メッセージの更新
...
### <a name="removed-the-syspdwdatabasemappings-view"></a>SYS.PDW_DATABASE_MAPPINGS ビューの削除
