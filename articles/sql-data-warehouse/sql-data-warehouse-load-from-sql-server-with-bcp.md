...
## 次のステップ
読み込みの概要については、「[Load data into SQL Data Warehouse (SQL Data Warehouse へのデータの読み込み)][Load data into SQL Data Warehouse (SQL Data Warehouse へのデータの読み込み)]」を参照してください。開発に関するその他のヒントについては、「[SQL Data Warehouse development overview (SQL Data Warehouse の開発の概要)][SQL Data Warehouse development overview (SQL Data Warehouse の開発の概要)]」をご覧ください。SQL Data Warehouse でのテーブルの作成の詳細については、[テーブルの概要][テーブルの概要]に関する記事または [CREATE TABLE 構文][CREATE TABLE 構文]に関するページを参照してください。
