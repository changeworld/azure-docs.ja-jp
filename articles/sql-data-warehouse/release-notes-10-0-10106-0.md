...
| ドキュメントの改善 | 詳細 |
| --- | --- |
|新しいワークロード管理のドキュメント |詳細については、[重要度](sql-data-warehouse-workload-importance.md)と[分類](sql-data-warehouse-workload-classification.md)に関するページを参照してください。 |
| | |
