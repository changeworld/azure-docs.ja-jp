<properties
   pageTitle="SQL Data Warehouse の容量仕様 | Microsoft Azure"
   description="SQL Data Warehouse の最大容量および最小容量の仕様"
...
# SQL Data Warehouse の容量仕様

SQL Data Warehouse でのクエリ処理およびシステム ビューに対する制限は、SQL Server の場合とよく似ています。ただし、両者は基になる並列およびスケーラブル アーキテクチャに違いがあるため、一部の制限内容は異なります。ここでは、SQL Data Warehouse に適用される制限の概要について説明します。
