...
| [DWU](sql-data-warehouse-overview-what-is.md) | ディストリビューションあたりの上限 (GiB) | ディストリビューション数 | 最大トランザクション サイズ (GiB) | ディストリビューションあたりの行数 | トランザクションあたりの最大行数 |
| --- | --- | --- | --- | --- | --- |
