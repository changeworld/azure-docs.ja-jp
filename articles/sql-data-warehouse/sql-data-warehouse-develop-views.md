...
> [AZURE.NOTE] この記事では `CREATE VIEW` の構文は説明していません。参考情報については、MSDN の [CREATE VIEW][] に関するページをご覧ください。
...
## 次のステップ
開発に関するその他のヒントについては、[SQL Data Warehouse の開発の概要][]に関するページをご覧ください。`CREATE VIEW` 構文については、[CREATE VIEW][] に関するページをご覧ください。
