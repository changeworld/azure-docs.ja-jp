...
- [Azure Data Factory (ADF)](../data-factory/introduction.md) - ゲートウェイをローカル サーバーにインストールできます。 その後、ローカル サーバーから Azure Storage にデータを移動するためのパイプラインを作成できます。 SQL Analytics で Data Factory を使用する方法については、[SQL Analytics のデータの読み込み](/azure/data-factory/load-azure-sql-data-warehouse)に関する記事を参照してください。
