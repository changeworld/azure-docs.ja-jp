...
データのコピー アクティビティの設定方法については、[Azure Data Factory でのデータのコピー][Azure Data Factory でのデータのコピー]に関するページをご覧ください。
...
## 次のステップ
統合の概要については、「[SQL Data Warehouse integration overview (SQL Data Warehouse の統合の概要)][SQL Data Warehouse integration overview (SQL Data Warehouse の統合の概要)]」をご覧ください。開発に関するその他のヒントについては、「[SQL Data Warehouse development overview (SQL Data Warehouse の開発の概要)][SQL Data Warehouse development overview (SQL Data Warehouse の開発の概要)]」をご覧ください。
