...
ms.locfileid: "56246323"
---
# <a name="upgrade-your-data-warehouse-to-gen2"></a>Gen2 へのデータ ウェアハウスのアップグレード
Microsoft は、Azure SQL Data Warehouse 用に下位コンピューティング レベルを追加することで、要求の厳しいクエリを処理できるデータ ウェアハウスの実行に関するエントリレベルのコスト削減に取り組んでいます。[Gen2 のための下位コンピューティング レベルのサポート](https://azure.microsoft.com/blog/azure-sql-data-warehouse-gen2-now-supports-lower-compute-tiers/)に関するすべてのお知らせを確認できます。 この新しいオファリングは、次の表に記載されているリージョンで既に使用できるようになっています。 サポート対象のリージョンでは、次のいずれかの方法で、既存の Gen1 データ ウェアハウスを Gen2 にアップグレードできます。
...
- **Gen2 へのセルフアップグレード:** アップグレードするタイミングを制御したい場合、Gen2 へのセルフアップグレードを実行できます。 自分のリージョンがまだサポートされていない場合、DW をサポートされているリージョンに移行し、その後、Gen 2 へのセルフアップグレードを実行できます。
...
|:--- |:--- |:--- |
| オーストラリア中部 1 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| オーストラリア中部 2 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| オーストラリア東部 |使用可能 |2019 年 5 月 1 日 |
| オーストラリア南東部 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| ブラジル南部 |\* |\* |
| カナダ中部 |使用可能 |2019 年 5 月 1 日 |
| カナダ東部 |\* |\* |
| 米国中央部 |使用可能 |2019 年 5 月 1 日 |
| 中国 (東部) |\* |\* |
| 中国北部 1 |\* |\* |
| 東アジア |使用可能 |2019 年 5 月 1 日 |
| 米国東部 1 |使用可能 |2019 年 3 月 16 日 |
| 米国東部 2 |使用可能 |2019 年 3 月 16 日 |
| フランス中部 |2019 年 3 月 1 日 |2019 年 5 月 1 日 |
| ドイツ中部 |\* |\* |
| インド中部 |使用可能 |2019 年 5 月 1 日 |
| インド南部 1 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| 東日本 |使用可能 |2019 年 5 月 1 日 |
| 西日本 |使用可能 |2019 年 6 月 15 日 |
| 韓国中部 |2019 年 3 月 1 日 |2019 年 5 月 1 日 |
| 韓国南部 1 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| 米国中北部 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| 北ヨーロッパ |使用可能 |2019 年 3 月 16 日 |
| 米国中南部 |使用可能 |2019 年 5 月 1 日 |
| 東南アジア |使用可能 |2019 年 3 月 16 日 |
| 英国南部 |2019 年 3 月 1 日 |2019 年 5 月 1 日 |
| 英国西部 1 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| 米国中西部 |\* |\* |
| 西ヨーロッパ |使用可能 |2019 年 3 月 16 日 |
| 米国西部 1 |2019 年 3 月 1 日 |2019 年 6 月 15 日 |
| 米国西部 2 |使用可能 |2019 年 3 月 16 日 |

## <a name="automatic-upgrade-process"></a>自動アップグレード プロセス

2019 年 3 月 16 日から、Gen1 インスタンスの自動アップグレードのスケジュール設定を開始します。 データ ウェアハウスが予期せず使用できなくなるのを回避するために、自動アップグレードは、お客様のメンテナンス スケジュール中にスケジュールされます。 スケジュールの詳細については、「[メンテナンス スケジュールを表示する](viewing-maintenance-schedule.md)」を参照してください。

アップグレード プロセスでは、弊社でデータ ウェアハウスを再起動する際に接続が短時間 (約 5 分) 切断されます。  データ ウェアハウスは、再起動後に完全に使用できるようになりますが、アップグレード プロセスによってバックグラウンドで引き続きデータ ファイルがアップグレードされるため、その期間中はパフォーマンスが低下する場合があります。 パフォーマンス低下の合計時間は、ご使用のデータ ファイルのサイズによって異なります。
...
(省略可能) 今すぐアップグレードしたい場合は、既存の Gen1 データ ウェアハウスで次の手順に従うことで、セルフアップグレードを選択できます。 この方法を選択した場合、対象のリージョンで自動アップグレード プロセスが開始される前に、セルフアップグレードを完了する必要があります。 これにより、自動アップグレードが原因で競合が発生するリスクを回避できます。

セルフアップグレードを実行する場合、2 つのオプションがあります。  現在のデータ ウェアハウスをインプレース アップグレードすることも、Gen1 データ ウェアハウスを Gen2 インスタンスに復元することもできます。

- [インプレース アップグレード](upgrade-to-latest-generation.md) - このオプションでは、既存の Gen1 データ ウェアハウスが Gen2 にアップグレードされます。 アップグレード プロセスでは、弊社でデータ ウェアハウスを再起動する際に接続が短時間 (約 5 分) 切断されます。  データ ウェアハウスは、再起動後に完全に使用できるようになります。 何らかの理由で、Gen2 インスタンスから Gen1 に戻す必要がある場合は、[サポート リクエスト](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-get-started-create-support-ticket)をオープンしてください。
