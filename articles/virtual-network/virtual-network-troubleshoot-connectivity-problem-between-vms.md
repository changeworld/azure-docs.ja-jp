...
アクセス制御リスト (ACL) を使用して、仮想マシン エンドポイントのトラフィックを選択的に許可または拒否することができます。 詳細については、「[エンドポイントの ACL の管理](../virtual-machines/windows/classic/setup-endpoints.md#manage-the-acl-on-an-endpoint)」を参照してください。
