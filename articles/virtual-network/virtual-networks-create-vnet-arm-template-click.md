...
---
# <a name="create-a-virtual-network-by-using-an-arm-template"></a>ARM テンプレートを使用した仮想ネットワークの作成
...
このドキュメントでは、リソース マネージャーのデプロイ モデルを使用して VNet を作成する方法を説明します。 [クラシック デプロイ モデルで仮想ネットワークを作成](virtual-networks-create-vnet-classic-pportal.md)することもできます。
