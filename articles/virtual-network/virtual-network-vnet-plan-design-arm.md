...
* Azure で利用できる[接続オプション](../vpn-gateway/vpn-gateway-about-vpngateways.md#site-to-site-and-multi-site)のいずれかを利用し、オンプレミス ネットワークに VNet を接続できます。
...
* **ハイブリッド接続**。 VPN ゲートウェイと ExpressRoute 回線を利用し、VNet を互いに、またはオンプレミスのデータ センターに[接続](../vpn-gateway/vpn-gateway-about-vpngateways.md#site-to-site-and-multi-site)できます。 VPN ゲートウェイと ExpressRoute 回線を利用するには、独自のサブネットを作成する必要があります。
...
* [プレミス間と VNet の接続オプション](../vpn-gateway/vpn-gateway-about-vpngateways.md#site-to-site-and-multi-site)について詳しく学習します。
