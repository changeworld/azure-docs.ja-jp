...
| ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 構成が適用されるレベルのスコープ                                                                                                   | サービス全体 (たとえば、"_すべて_" の SQL Server または "_すべて_" の顧客のストレージ アカウント)                                      | 個々のインスタンス (たとえば、特定の SQL Server インスタンスまたは "_自分_" が所有するストレージ アカウント)                                                                    |
