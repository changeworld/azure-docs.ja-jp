---
title: Azure ポータルを使用した仮想ネットワークの作成 | Microsoft Docs
...
このドキュメントでは、従来のデプロイ モデルを使用して VNet を作成する方法を説明します。[Azure プレビュー ポータルを使用して、リソース マネージャーのデプロイメント モデルで仮想ネットワークを作成](virtual-networks-create-vnet-arm-pportal.md)することもできます。
