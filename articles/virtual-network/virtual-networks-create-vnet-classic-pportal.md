...
このドキュメントでは、従来のデプロイ モデルを使用して VNet を作成する方法を説明します。 [Azure Portal を使用して、Resource Manager のデプロイメント モデルで仮想ネットワークを作成](quick-create-portal.md)することもできます。
