...
![Azure の仮想ネットワーク](../virtual-machines/media/virtual-machines-common-network-overview/vnetoverview.png)
...
[ネットワーク インターフェイス (NIC)](../virtual-network/virtual-network-network-interface.md) とは、VM と仮想ネットワーク (VNet) の間の相互接続です。 VM には少なくとも 1 つの NIC が必要ですが、作成する VM のサイズによっては複数あってもかまいません。 各 VM サイズでサポートされる NIC の数については、[VM のサイズ](../virtual-machines/sizes.md)に関するページを参照してください。
...
| [Azure CLI](../virtual-machines/linux/create-cli-complete.md) | VM を作成し、個々のステップとして構築された Vnet、サブネット、および NIC に接続します。 |
