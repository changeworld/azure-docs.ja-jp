...
- [リソース マネージャーのデプロイメント モデルでルートを作成](../virtual-network-create-udr-arm-template)し、サブネットに関連付ける方法について説明します。 
- [クラシック デプロイメント モデルでルートを作成](../virtual-network-create-udr-classic-ps)し、サブネットに関連付ける方法について説明します。
