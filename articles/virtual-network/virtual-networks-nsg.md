...
|プロパティ|説明|制約|考慮事項|
|---|---|---|---|
|名前|NSG の名前|リージョン内で一意である必要があります。<br/>英字、数字、アンダー スコア、ピリオド、ハイフンを含めることができます。<br/>先頭は英字または数字にする必要があります。<br/>末尾は英字、数字、またはアンダー スコアにする必要があります。<br/>最大 80 字を指定できます。|複数の NSG の作成が必要になることがあるため、NSG の機能が識別しやすくなる名前付け規則を用意してください。|
