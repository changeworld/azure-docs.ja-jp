---
title: Public and private IP addressing (classic) in Azure (Azure でのパブリックおよびプライベート IP アドレス指定 (クラシック)) | Microsoft Docs
...
[Resource Manager デプロイ モデルを使用してこれらの手順を実行する](virtual-network-ip-addresses-overview-arm.md)方法について説明します。
