---
title: "IP アドレス (クラシック) | Microsoft Docs"
...
---
# <a name="ip-addresses-classic-in-azure"></a>Azure の IP アドレス (クラシック)
...
| --- | --- | --- | --- |
| クラウド サービス |はい |あり |はい |
| IaaS VM または PaaS ロール インスタンス |はい |なし |なし |
| VPN Gateway |あり |なし |なし |
| Application Gateway |はい |なし |なし |
...
* [静的プライベート IP アドレスを持つ VM をデプロイ](virtual-networks-static-private-ip-classic-pportal.md) します。
