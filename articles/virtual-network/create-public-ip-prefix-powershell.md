---
title: パブリック IP アドレス プレフィックスを作成する - PowerShell
...
ms.locfileid: "113667319"
---
# <a name="create-a-public-ip-address-prefix-using-powershell"></a>PowerShell を使用してパブリック IP アドレス プレフィックスを作成する
...
- [パブリック IP プレフィックス](public-ip-address-prefix.md)を使用するシナリオとベネフィットについて確認します。
