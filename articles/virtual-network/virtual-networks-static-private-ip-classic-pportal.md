---
title: "Azure Portal を使用してクラシック モードで静的プライベート IP を設定する方法 | Microsoft Docs"
...
---
# <a name="how-to-set-a-static-private-ip-address-classic-in-the-azure-portal"></a>Azure ポータルで静的プライベート IP アドレスを設定する方法 (クラシック)
