...
5. **[ロード バランサーの作成]** ページで、次の情報を入力または選択します。 
    ...
    | Resource group         | **[新規作成]** を選択し、テキスト ボックスに「**TutorPubLBNAT-rg**」と入力します。 </br> **[OK]** を選択します。|
    | **インスタンスの詳細** |   |
    ...
    | パブリック IPv6 アドレスを追加する | このため、 **[いいえ]** を選択します。 </br> IPv6 アドレスとロード バランサーの詳細については、「[Azure Virtual Network の IPv6 の概要](../ipv6-overview.md)」を参照してください。  |
    | ルーティング設定 | 既定値の **[Microsoft ネットワーク]** のままにします。 </br> ルーティングの優先順位の詳細については、「[ルーティングの優先順位とは (プレビュー)](../routing-preference-overview.md)」を参照してください。 |
