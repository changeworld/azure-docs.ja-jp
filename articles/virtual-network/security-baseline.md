...
- [Azure portal を使用した Azure DDoS Protection Standard の管理](manage-ddos-protection.md)

- [Azure Firewall の脅威インテリジェンスベースのフィルター処理](../firewall/threat-intel.md)

- [Security Center での脅威の防止](/azure/security-center/threat-protection)
...
- [セキュリティ センターのリスク検出 (疑わしいアクティビティ) について](/azure/active-directory/reports-monitoring/concept-risk-events) 
...
### <a name="46-use-role-based-access-control-to-manage-access-to-resources"></a>4.6:ロールベースのアクセス制御を使用してリソースへのアクセスを管理する 
