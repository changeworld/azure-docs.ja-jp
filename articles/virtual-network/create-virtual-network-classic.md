...
2. Portal で **[+新規]** をクリックします。
3. 表示された **[新規]** ブレードの上部にある **[Marketplace を検索]** ボックスに「"*仮想ネットワーク*"」と入力します。  検索結果に **[仮想ネットワーク]** が表示されたら、それをクリックします。
4. 表示された **[仮想ネットワーク]** ブレードの **[デプロイ モデルの選択]** ボックスで **[クラシック]** を選択し、**[作成]** をクリックします。 
5. **[仮想ネットワーク (クラシック) の作成]** ブレードで次の値を入力し、**[作成]** をクリックします。
