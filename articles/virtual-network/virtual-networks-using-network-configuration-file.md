...
## 次のステップ
仮想ネットワークの設定について詳しくは、次のトピックをご覧ください。

-  [ネットワーク構成スキーマを使用したクラウド サービスのオプション設定に関するページ](https://msdn.microsoft.com/library/azure/jj156091.aspx)
-  [管理ポータルでの Virtual Network の設定について](https://msdn.microsoft.com/library/azure/jj156074.aspx)
