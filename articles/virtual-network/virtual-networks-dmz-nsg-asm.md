---
title: "DMZ の例 – NSG を使用して単純な DMZ を構築する | Microsoft Docs"
...
---
# <a name="example-1--build-a-simple-dmz-with-nsgs"></a>例 1: NSG を使用して単純な DMZ を構築する
...
#### <a name="allowed-web-to-web-server"></a>(*許可*) Web から Web サーバーへ
...
#### <a name="allowed-web-server-dns-lookup-on-dns-server"></a>(*許可*) DNS サーバー上での Web サーバー DNS の参照
...
#### <a name="denied-web-dns-lookup-on-dns-server"></a>(*拒否*) DNS サーバー上での Web DNS の参照
