---
title: クラシック デプロイメント モデルで PowerShell を使用して複数 NIC VM をデプロイする | Microsoft Docs
...
[Resource Manager モデルを使用してこれらの手順を実行する](virtual-network-deploy-multinic-arm-ps.md)方法について説明します。
