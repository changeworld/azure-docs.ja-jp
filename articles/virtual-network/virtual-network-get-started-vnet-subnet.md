...
2. **[リソースの作成]** > **[ネットワーク]** > **[仮想ネットワーク]** の順にクリックします。
...
1. [Azure Portal](https://portal.azure.com) で、**[リソースの作成]** > **[Compute]** > **[Windows Server 2016 Datacenter]** の順にクリックします。
...
1. [Azure Portal](https://portal.azure.com) で、**[すべてのサービス]** をクリックします。
2. "*フィルター*" と書かれたボックスに「*リソース グループ*」と入力します。 フィルターで抽出されたリストに "**リソース グループ**" が表示されたらそれをクリックします。
