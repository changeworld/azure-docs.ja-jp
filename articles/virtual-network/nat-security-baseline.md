...
ms.locfileid: "95255078"
---
# <a name="azure-security-baseline-for-virtual-network-nat"></a>Virtual Network NAT 用の Azure セキュリティ ベースライン

このセキュリティ ベースラインによって、[Azure セキュリティ ベンチマーク バージョン 1.0](https://docs.microsoft.com/azure/security/benchmarks/overview-v1) のガイダンスが Microsoft Virtual Network NAT に適用されます。 Azure セキュリティ ベンチマークには、Azure 上のクラウド ソリューションをセキュリティで保護する方法に関する推奨事項がまとめてあります。
...
- [Virtual Network NAT の概要](https://docs.microsoft.com/azure/virtual-network/nat-overview)

- [NAT ゲートウェイ リソース](https://docs.microsoft.com/azure/virtual-network/nat-gateway-resource)

- [ネットワーク セキュリティ グループのフローのログを有効にする方法](https://docs.microsoft.com/azure/network-watcher/network-watcher-nsg-flow-logging-portal) 
...
- [Azure Network Watcher のインスタンスを作成する方法](https://docs.microsoft.com/azure/network-watcher/network-watcher-create)
...
- [Azure Resource Graph クエリ](https://docs.microsoft.com/azure/governance/resource-graph/first-query-portal)
