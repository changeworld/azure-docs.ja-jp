...
このドキュメントでは、従来のデプロイ モデルを使用して VNet を作成する方法を説明します。[Create a virtual network in the Resource Manager deployment model by using the Azure CLI (Azure CLI を使用して、リソース マネージャーのデプロイ モデルに基づいた仮想ネットワークを作成) ](virtual-networks-create-vnet-arm-cli.md)することもできます。
