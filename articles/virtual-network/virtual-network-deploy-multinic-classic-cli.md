---
title: クラシック デプロイメント モデルで Azure CLI を使用して複数 NIC の VM をデプロイする | Microsoft Docs
...
[Resource Manager モデルを使用してこれらの手順を実行する](virtual-network-deploy-multinic-arm-cli.md)方法について説明します。
