...
6. 仮想ネットワーク名のパラメーターを編集するには、**parameters** の **value** プロパティを変更します。
    ...
    ```
7. エディターで、ソース仮想ネットワーク名の値を、ターゲット VNET に対して選択した名前に変更します。 名前は引用符で囲んでください。
...
15. **[基本]**  >  **[リソース グループ]** をクリックして、ターゲット VNET をデプロイするリソース グループを選択します。  **[新規作成]** をクリックして、ターゲット VNET の新しいリソース グループを作成できます。  名前が既存の VNET のソース リソース グループと同じでないことを確認します。 
