---
title: Microsoft OPC Publisher のテレメトリ形式
description: この記事では、構成設定ファイルの概要について説明します
author: jehona-m
ms.author: jemorina
...
また、OPC Publisher のすべてのバージョンでは、標準化されていない単純な JSON テレメトリ形式もサポートしています。これは [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) と互換性があり、次のようになります。
```
[
   {
