...
Privileged Access Workstations の詳細については、「[Securing Privileged Access (特権アクセスのセキュリティ保護)](https://technet.microsoft.com/library/mt631194.aspx)」を参照してください。
...
SQL TDE 暗号化の詳細については、「[Azure SQL Database の Transparent Data Encryption](https://msdn.microsoft.com/library/0bf7e8ff-1416-4923-9c4c-49341e208c62.aspx)」を参照してください。
...
Azure VPN オプションの詳細については、「[VPN ゲートウェイの計画と設計](./vpn-gateway/vpn-gateway-plan-design.md)」を参照してください。
...
Azure RMS の詳細については、「[Azure Rights Management の概要](https://technet.microsoft.com/library/jj585016.aspx)」を参照してください。
