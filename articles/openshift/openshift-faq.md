...
詳細については、OpenShift ドキュメントの[セルフプロビジョニングを無効にする](https://docs.openshift.com/container-platform/3.11/admin_guide/managing_projects.html#disabling-self-provisioning)方法に関するセクションをご覧ください。
