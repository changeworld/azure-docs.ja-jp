<properties
	pageTitle="エネルギー需要予測のための Cortana Intelligence Solution Template Playbook | Microsoft Azure"
...
# エネルギー需要予測のための Cortana Intelligence Solution Template Playbook  
...
>[AZURE.TIP] このテンプレートのアーキテクチャの概要を説明した図をダウンロードするには、「[エネルギー需要予測のための Cortana Intelligence ソリューション テンプレートのアーキテクチャ](cortana-analytics-architecture-demand-forecasting-energy.md)」を参照してください。
