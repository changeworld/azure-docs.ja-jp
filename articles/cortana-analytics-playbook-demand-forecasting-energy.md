---
title: エネルギー需要予測のための Cortana Intelligence Solution Template Playbook
...
このドキュメントは、データ サイエンス プロセスや、その数学的、技術的な側面について詳しく説明するものではありませんので、ご注意ください。 これらの詳細については、[Azure Machine Learning service に関するドキュメント](https://azure.microsoft.com/services/machine-learning/)と[ブログ](https://blogs.microsoft.com/blog/tag/azure-machine-learning/)を参照してください。
