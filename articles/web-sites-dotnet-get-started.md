...
4. **[構成]** タブをクリックします。
	...
	[構成](/ja-jp/documentation/articles/web-sites-configure//) タブでは、サイトで使用する .NET バージョンを管理し、[WebSockets](/blog/2013/11/14/introduction-to-websockets-on-windows-azure-web-sites/) と [診断ログ](/ja-jp/documentation/articles/web-sites-enable-diagnostic-log/) などの機能を有効にして、[connection string values](/blog/2013/07/17/windows-azure-web-sites-how-application-strings-and-connection-strings-work/)、その他を設定します。 

	![Portal web site configure tab](./media/web-sites-dotnet-get-started-vs2013/portalconfigure.png)
  
5. **[規模の設定]** タブをクリックします。

	Websites サービスの有料レベルでは、[規模の設定](/ja-jp/documentation/articles/web-sites-scale/) タブで Web アプリケーションで使用するコンピューターの大きさと数を管理して、トラフィックの変化に対応します。
