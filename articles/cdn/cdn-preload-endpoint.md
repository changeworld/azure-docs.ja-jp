<properties 
	pageTitle="Azure CDN エンドポイント上のアセットを事前に読み込む" 
...
# Azure CDN エンドポイント上のアセットを事前に読み込む

このチュートリアルでは、すべての Azure CDN エッジ ノード上のキャッシュされたコンテンツを事前に読み込む方法について説明します。

## チュートリアル

1. [Azure ポータル](http://portal.azure.com)で、事前に読み込むエンドポイントを含む CDN プロファイルを開きます。プロファイル ブレードが開きます。
