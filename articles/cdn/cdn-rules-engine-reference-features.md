---
title: "Azure Content Delivery Network ルール エンジンの機能 | Microsoft Docs"
...
# <a name="features-for-azure-content-delivery-network--cdn-rules-engine"></a>Azure Content Delivery Network (CDN) ルール エンジンの機能
