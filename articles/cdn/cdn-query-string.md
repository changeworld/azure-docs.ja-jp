---
title: "クエリ文字列による要求の Azure CDN キャッシュ動作の制御 | Microsoft Docs"
...
---
# <a name="controlling-caching-behavior-of-cdn-requests-with-query-strings"></a>クエリ文字列による CDN 要求のキャッシュ動作の制御
