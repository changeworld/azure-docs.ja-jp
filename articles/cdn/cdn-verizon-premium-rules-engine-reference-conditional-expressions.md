...
Verizon Premium のルール エンジンの式の詳細については、「[Independent Conditional Expressions (独立した条件式](https://docs.vdms.com/cdn/index.html#Whats_New/Whats-New-RE.htm#RuleSetup))」を参照してください。
