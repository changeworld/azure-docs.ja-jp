...
| 演算子 | 自動プロビジョニングを構成する | この操作は、自動プロビジョニングの第 1 フェーズに対応します。<br><br>**クイック スタート**: オペレーターの役割として、Azure サブスクリプション内の Device Provisioning Service および IoT Hub のインスタンスを構成します。 | 自動プロビジョニングをセットアップする |
