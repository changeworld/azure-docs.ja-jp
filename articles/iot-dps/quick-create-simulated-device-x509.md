...
---
# <a name="create-and-provision-an-x509-simulated-device-using-iot-hub-device-provisioning-service-preview"></a>シミュレートされた X.509 デバイスを作成して IoT Hub Device Provisioning Service (プレビュー) でプロビジョニングする
