...
geo 冗長ストレージと読み取りアクセス geo 冗長ストレージの詳細については、「[Azure Storage のレプリケーション](../storage/storage-redundancy.md)」を参照してください。
...
### <a name="sql-server-on-azure-virtual-machines"></a>Azure Virtual Machines における SQL Server
