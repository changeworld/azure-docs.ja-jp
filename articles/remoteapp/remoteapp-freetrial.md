...
<properties 
    pageTitle="RemoteApp の 30 日間無料評価版"
    description="RemoteApp の 30 日間無料評価版をお試しください。" 
    services="remoteapp" 
...
# RemoteApp の 30 日間無料評価版

Azure サブスクリプションをお持ちであれば、RemoteApp を無料で 30 日間お試しいただけます。Azure 管理ポータルにサインインして [RemoteApp] ノードに移動し、コレクションを作成するだけで使用を開始できます。 これは、Azure RemoteApp の有料サブスクリプションに変換する前に、管理者としての経験を積むための優れた方法です。  
