...
Microsoft Azure PowerShell と SDK を使用し、コレクションのデバイス リダイレクト設定を変更できます。 新しい PowerShell と SDK をインストールした後を構成したら、最初に「 [Azure PowerShell を構成する方法](/powershell/azure/overview)」の説明に従い、サブスクリプションを管理するように設定します。
