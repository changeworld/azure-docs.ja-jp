...
---
title: 顧客の Virtual Network にデプロイした Azure RemoteApp 向けにホワイトリスト登録する必要があるポートと URL の一覧 | Microsoft Docs
