...
既存の Azure RemoteApp のお客様は[登録して無料試用版を使用できます](https://www.citrix.com/global-partners/microsoft/remote-app.html)。  注: Citrix ユーザー サービスの料金のみ無料で、Azure のコンピューティングおよびストレージ料金が適用されます

詳細については、[Citrix XenApp Essentials](https://www.citrix.com/global-partners/microsoft/remote-app.html) を参照してください。
