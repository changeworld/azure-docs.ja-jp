...
利用可能なクレジットを使い切るか、12 か月が経過すると、Azure サブスクリプションが無効になります。 Azure for Students サブスクリプションは更新できません。 引き続き Azure を使用する場合は、[Azure portal](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade) で従量課金制サブスクリプションにアップグレードできます。 12 か月が経過した時点または $100 のクレジットを使い切った時点 (どちらか早い方) でアップグレードしないことを決定した場合、お客様がデプロイした製品はすべて使用停止になり、アクセスできなくなります。 無料サブスクリプションの終了から 90 日以内に、従量課金制サブスクリプションにアップグレードしてください。
