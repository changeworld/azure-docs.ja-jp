...
- Azure DevOps Server (旧称 Visual Studio Team Services)
...
Microsoft Azure for Students Starter プランにクレジット カードは必要ありません。 ただし、[Azure Account portal](https://account.azure.com/) でいつでも従量課金制のサブスクリプションにアップグレードし、すべての Azure サービスをご利用いただけます。
