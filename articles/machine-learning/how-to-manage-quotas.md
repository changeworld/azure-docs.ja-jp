...
:::image type="content" source="media/how-to-manage-quotas/quota-increase-private-endpoint.png" alt-text="プライベート エンドポイントとプライベート DNS のクォータの引き上げ依頼":::
