...
# Excel からの Azure Machine Learning Web サービスの使用
 ...
 Excel 2013 (またはそれ以降) を実行しているか、Excel Online と併用する OneDrive または SharePoint にファイルを保存できる場合は、[Excel アドイン](machine-learning-excel-add-in-for-web-services.md) をお勧めします。
