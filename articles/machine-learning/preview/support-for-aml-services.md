...
[Azure Machine Learning ドキュメント センター](./overview-what-is-azure-ml.md)に、ハウツー ガイドやビデオ チュートリアルが用意されています。 これらのステップバイステップ形式のガイドでは、サービスを紹介するとともに、データ サイエンスのライフ サイクルについて説明しています。 Machine Learning Center には継続的に新しい資料が追加されます。 
...
+ [Azure Machine Learning フィードバック チャンネル](https://feedback.azure.com/forums/257792-machine-learning)では、**製品に関する提案を共有**したり、機能に関する要望を提出できます。このチャンネルには、各記事の下部にあるリンクからもアクセスできます。 
