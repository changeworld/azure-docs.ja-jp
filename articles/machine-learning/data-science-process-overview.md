...
2. 関連性があり、具体的かつ明確な "鋭い" 質問の問いかけと改善を行うことで、**プロジェクトの目標**を定義します。 データ サイエンスは、名前と数字を使ってこのような質問に回答するプロセスです。 鋭い質問をする追加のガイダンスについては、ブログ「[How to do Data Science](https://blogs.technet.microsoft.com/machinelearning/2016/03/28/how-to-do-data-science/)」(データ サイエンスの実施方法) をご覧ください。 データ サイエンスや機械学習は、一般的には以下の 5 種類の質問に回答するために使用されます。
