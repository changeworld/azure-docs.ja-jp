...
TDSP ライフサイクルは、繰り返し実行される 5 つの主なステージで構成されています。
...
TDSP におけるライフサイクルの各ステージの目標、タスク、ドキュメント アーティファクトについては、「[Team Data Science Process ライフサイクル](data-science-process-lifecycle.md)」のトピックで説明しています。 これらのタスクとアーティファクトは、プロジェクトの各種役割に関連付けられます。
...
![TDSP の役割とタスク](./media/data-science-process-overview/tdsp-tasks-by-roles.png)
...
![TDSP のディレクトリ](./media/data-science-process-overview/tdsp-dir-structure.png)
...
![TDSP インフラストラクチャ](./media/data-science-process-overview/tdsp-analytics-infra.png)
