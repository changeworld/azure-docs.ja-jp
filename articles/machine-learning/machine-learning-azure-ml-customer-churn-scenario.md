...
> これはプライベート データであるため、モデルとデータを共有することはできません。ただし、パブリックに使用可能なデータを使用する同様のモデルに関しては、「[Model Gallery](http://gallery.azureml.net/): [Telco Customer Churn (Telco の顧客離れ)](http://gallery.azureml.net/Experiment/31c19425ee874f628c847f7e2d93e383)」にあるサンプル実験をご覧ください。
> 
