...
-	Web サービスでのログ記録を有効にする方法   
	-	[Microsoft Azure 管理ポータル](https://manage.windowsazure.com/)にログインします。
...
-	ログ記録の有効化による効果  
	-	ログ記録が有効な場合、選択したエンドポイントのすべての診断とエラーが、ユーザーのワークスペースにリンクされている Azure ストレージ アカウントに記録されます。このストレージ アカウントは、ワークスペースのAzure ポータルの [ダッシュボード] ビュー ([概要] セクションの下部) で確認できます。  
-	ログを表示する方法  
