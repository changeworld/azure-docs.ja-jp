...
追加のデータ ディスクをアタッチするには、「[Windows 仮想マシンにデータ ディスクをアタッチする方法](../virtual-machines/virtual-machines-windows-classic-attach-disk.md)」で説明されている次のような手順に従います。
