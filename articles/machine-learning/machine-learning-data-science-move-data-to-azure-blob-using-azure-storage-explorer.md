...
2.  アクセスするストレージ アカウントが、Azure ストレージ エクスプローラーに追加されていない場合は、[アカウントの追加] ボタンをクリックしてアカウントを追加します。既に追加されている場合は、[--ストレージ アカウントの選択--] ドロップダウンからアカウントを選択します。![ワークスペースの作成][1] <br>
3. ストレージ アカウント名とストレージ アカウント キーを入力して、[ストレージ アカウントの追加] をクリックします。複数のストレージ アカウントを追加できます。その場合、各アカウントがタブに表示されます。このストレージ アカウント下のコンテナーは、左側のパネルに表示されます。コンテナーを選択すると、右側のパネルにコンテナー内の BLOB が表示されます。![ワークスペースの作成][2] <br> ![ワークスペースの作成][3] <br>
