...
![ブースト デシジョン ツリー分類子](./media/machine-learning-algorithm-parameters-optimize/fig6a.png)
...
![検証データセット](./media/machine-learning-algorithm-parameters-optimize/fig6b.png)
