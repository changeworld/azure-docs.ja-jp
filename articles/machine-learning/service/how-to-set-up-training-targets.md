...
Azure Machine Learning サービスでは、いくつかの異なる環境でモデルをトレーニングできます。 __コンピューティング ターゲット__と呼ばれるこれらの環境はローカルまたはクラウドにできます。 このドキュメントでは、サポートされているコンピューティング ターゲットとその使用方法について学びます。
