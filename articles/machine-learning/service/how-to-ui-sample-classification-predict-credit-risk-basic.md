...
![実験のグラフ](media/how-to-ui-sample-classification-predict-credit-risk-basic/overall-graph.png)
...
4. サンプル 3 実験用の **[開く]** ボタンを選択します。
    ...
    ![実験を開く](media/how-to-ui-sample-classification-predict-credit-risk-basic/open-sample3.png)

## <a name="related-sample"></a>関連サンプル

[サンプル 4 - 分類:信用リスクの予測 (コスト重視)](how-to-ui-sample-classification-predict-credit-risk-cost-sensitive.md) は、この実験と同じ問題を解決する高度な実験を提供します。 **Python スクリプトの実行**モジュールを使用して*コスト重視*の分類を実行し、二項分類アルゴリズムのパフォーマンスを比較する方法を示します。 分類パイプラインの構築方法について詳しく知りたい場合に参照してください。

## <a name="data"></a>Data

このサンプルでは、UC Irvine リポジトリの German Credit Card のデータセットを使用します。
