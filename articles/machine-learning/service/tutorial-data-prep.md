...
* Jupyter Notebook のダッシュボードを起動したら、**tutorials/regression-part1-data-prep.ipynb** ノートブックを開きます。

このチュートリアルは、独自の[ローカル環境](how-to-configure-environment.md#local)で使用する場合は、[GitHub](https://github.com/Azure/MachineLearningNotebooks/tree/master/tutorials) で入手することもできます。  Azure Machine Learning SDK の `azureml-dataprep` パッケージがインストールされていることを確認してください。
