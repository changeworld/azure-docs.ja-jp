...
詳細については、「[Azure Machine Learning service におけるモデルの解釈可能性](how-to-machine-learning-interpretability.md)」を参照してください。
...
* **[実験]** ウィンドウ (プレビュー)
  1. 左側のウィンドウの **[実験]** を選択して、Azure Machine Learning service で実行した実験の一覧を表示します。
