...
Azure Kubernetes Service と Azure Machine Learning service の使用の詳細については、[デプロイの方法と場所](how-to-deploy-and-where.md#deploy-aks)に関する記事を参照してください。
