...
このセクションでは、パイプラインを Azure Machine Learning Web サービスとして配置し、トレーニングとスコア付けを行うために使用します。 デプロイされた Web サービスをスコア付けすると、モデルが再度トレーニングされ、新しいデータで予測が生成されます。
