...
![ギャラリー ホーム ページでカスタム モジュールを選択する](media/machine-learning-gallery-custom-modules/select-custom-modules-in-gallery.png)
...
![[See all (すべて表示)] を選択してすべてのカスタム モジュールを参照する](media/machine-learning-gallery-custom-modules/click-see-all-for-all-custom-modules.png)
