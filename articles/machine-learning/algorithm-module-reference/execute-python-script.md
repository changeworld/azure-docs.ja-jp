...
## <a name="access-to-registered-datasets"></a>登録済みデータセットへのアクセス
...
Python スクリプトの実行モジュールでは、[Azure Machine Learning Python SDK](/python/api/azureml-core/azureml.core.run%28class%29?preserve-view=true&view=azure-ml-py#upload-file-name--path-or-stream-) を使用したファイルのアップロードがサポートされています。
