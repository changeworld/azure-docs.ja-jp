...
この記事では、Microsoft Azure Machine Learning でモデルをデバッグする方法について説明します。 具体的には、モデルを実行したときに次の&2; つの障害が発生する場合の潜在的な理由について取り上げます。
...
## <a name="score-model-module-does-not-produce-correct-results"></a>[モデルのスコア付け] モジュールから正しい結果が生成されない
