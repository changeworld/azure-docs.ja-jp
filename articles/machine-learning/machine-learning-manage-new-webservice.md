...
> [!NOTE]
> このセクションの手順は、Azure Machine Learning Web サービス ポータルでのクラシック Web サービスの管理に関連しています。 Machine Learning Studio および Azure クラシック ポータルでのクラシック Web サービスの管理については、「[Azure Machine Learning ワークスペースを管理する](machine-learning-manage-workspace.md)」をご覧ください。
> 
> 
