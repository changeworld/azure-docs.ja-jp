...
> [!NOTE]
> このチュートリアルの手順では、「[Retrain Machine Learning models programmatically (プログラムによる機械学習モデルの再トレーニング)](machine-learning-retrain-models-programmatically.md)」の手順に従って Web サービスを作成したと想定しています。
> 
> 
