<properties
    pageTitle="従来の Web サービスの再トレーニング | Microsoft Azure"
...
# <a name="retrain-a-classic-web-service"></a>従来の Web サービスの再トレーニング
...
>[AZURE.NOTE] このチュートリアルの手順では、「[Retrain Machine Learning models programmatically (プログラムによる機械学習モデルの再トレーニング)](machine-learning-retrain-models-programmatically.md)」の手順に従って Web サービスを作成したと想定しています。
...
3. プログラムを使用する
1. Microsoft Azure Web サービス ポータルを使用する
2. Azure クラシック ポータルを使用する
...
## <a name="update-the-added-endpoint’s-trained-model"></a>追加エンドポイントのトレーニング済みモデルを更新する
