---
title: '2 クラス平均化パーセプトロン: コンポーネント リファレンス'
titleSuffix: Azure Machine Learning
description: デザイナーの 2 クラス平均化パーセプトロン コンポーネントを使用して、二項分類器を作成する方法について説明します。
...
ms.locfileid: "131565724"
---
# <a name="two-class-averaged-perceptron-component"></a>2 クラス平均化パーセプトロン コンポーネント
