---
title: '2 クラス サポート ベクター マシン: コンポーネント リファレンス'
titleSuffix: Azure Machine Learning
description: Azure Machine Learning で 2 クラス サポート ベクター マシン コンポーネントを使用して、二項分類器を作成する方法について説明します。
...
ms.locfileid: "131565699"
---
# <a name="two-class-support-vector-machine-component"></a>2 クラス サポート ベクター マシン コンポーネント

この記事では Azure Machine Learning デザイナーのコンポーネントについて説明します。

このコンポーネントを使用して、サポート ベクター マシン アルゴリズムに基づくモデルを作成します。 

サポート ベクター マシン (SVM) は、よく調査されたクラスの教師あり学習手法です。 この特定の実装は、連続変数かカテゴリ変数に基づいて、推定される 2 つの結果を予測するのに適しています。

モデルのパラメーターを定義した後、トレーニング コンポーネントを使用して、ラベルまたは結果列を含んだ *タグ付けされたデータセット* を与えてモデルをトレーニングします。
...
1.  **2 クラス サポート ベクター マシン** コンポーネントをパイプラインに追加します。  
