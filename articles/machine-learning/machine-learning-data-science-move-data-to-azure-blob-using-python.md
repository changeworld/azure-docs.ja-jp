...
## はじめに
このトピックでは、Python API を使用して BLOB の一覧表示、アップロード、ダウンロードを行う方法について説明します。
...
Python API を使用する方法の詳細については、「[Python から Azure BLOB ストレージを使用する方法](../storage-python-how-to-use-blob-storage.md)」を参照してください。
