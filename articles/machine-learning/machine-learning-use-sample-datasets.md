...
<tr ID=breast-cancer-features>
  <td valign=top>乳がん特徴 <td valign=top>
...
<tr>
  ...
  <td valign=top>
パターン認識の文献でおそらく最も多く使用されているデータベースです。 3 種類のあやめの品種について 50 例の花弁を測定した、比較的小さなデータセットです。<p> </p><b>使用法:</b> あやめの品種を測定値から予測します。  <p> </p><b>関連の研究:</b> Fisher, R.A. (1988 年)。 UCI Machine Learning Repository <a href="http://archive.ics.uci.edu/ml">http://archive.ics.uci.edu/ml</a>。 カリフォルニア州アーバイン: カリフォルニア大学、情報・コンピューター サイエンス学部 </td>
</tr>
