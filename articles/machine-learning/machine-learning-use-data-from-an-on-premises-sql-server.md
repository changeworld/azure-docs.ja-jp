---
title: "Machine Learning でオンプレミスの SQL Server データベースのデータを使用する | Microsoft Docs"
...
インストールの前提条件、インストールの手順、およびトラブルシューティングのヒントの詳細については、「[Data Management Gateway を使用してオンプレミスのソースとクラウドの間でデータを移動する](../data-factory/data-factory-move-data-between-onprem-and-cloud.md)」という記事を参照してください。
...
8. 既にゲートウェイがインストールされている場合は、Data Management Gateway 構成マネージャーを実行し、**[キーの変更]** をクリックして、クリップボードにコピーした **ゲートウェイ登録**キーを貼り付け、**[OK]** をクリックします。
