...
RStudio を初めて使用する場合は、デスクトップ バージョンをダウンロードしてインストールします。Windows、MacOS、Linux/UNIX 向けの RStudio は、http://www.rstudio.com/products/RStudio/ でダウンロードできます。指示に従って、RStudio をデスクトップ コンピューターにインストールします。
...
###Machine Learning Studio でのデータの読み込みとチェック
...
![カリフォルニア酪農生産の時系列プロットと価格データ (初回)](./media/machine-learning-r-quickstart/unnamed-chunk-161.png)

![カリフォルニア酪農生産の時系列プロットと価格データ (2 度目)](./media/machine-learning-r-quickstart/unnamed-chunk-162.png)

![カリフォルニア酪農生産の時系列プロットと価格データ (3 度目)](./media/machine-learning-r-quickstart/unnamed-chunk-163.png)

![カリフォルニア酪農生産の時系列プロットと価格データ (4 度目)](./media/machine-learning-r-quickstart/unnamed-chunk-164.png)
...
![傾向モデルを示すカリフォルニア牛乳生産データ](./media/machine-learning-r-quickstart/unnamed-chunk-18.png)
...
![季節的影響を含むカリフォルニア牛乳生産のモデル](./media/machine-learning-r-quickstart/unnamed-chunk-20.png)
...
![トレーニング データの季節モデルの残差](./media/machine-learning-r-quickstart/unnamed-chunk-21.png)
...
![季節モデルの診断プロット (初回)](./media/machine-learning-r-quickstart/unnamed-chunk-221.png)

![季節モデルの診断プロット (2 度目)](./media/machine-learning-r-quickstart/unnamed-chunk-222.png)

![季節モデルの診断プロット (3 度目)](./media/machine-learning-r-quickstart/unnamed-chunk-223.png)

![季節モデルの診断プロット (4 度目)](./media/machine-learning-r-quickstart/unnamed-chunk-224.png)
...
3.	デバッグ
	...
	ブレークポイント トラブルシューティング機能に関するドキュメントは、https://support.rstudio.com/hc/articles/200534337-Breakpoint-Troubleshooting にあります。
...
R 時系列パッケージのカタログは、時系列分析用の CRAN タスク ビューにあります。http://cran.r-project.org/web/views/TimeSeries.html特定の時系列オブジェクト パッケージの情報については、そのパッケージのドキュメントを参照する必要があります。
