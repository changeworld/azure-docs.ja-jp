...
ms.locfileid: "84636752"
---
# <a name="tutorial-create-an-ubuntu-data-science-virtual-machine-using-a-resource-manager-template"></a>チュートリアル:Resource Manager テンプレートを使用して Ubuntu Data Science Virtual Machine を作成する
