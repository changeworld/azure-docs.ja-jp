...
> [!NOTE]
> 次の VM イメージは、どちらも非推奨とされています。
>
> * Windows Server 2016 DSVM イメージ
> * Ubuntu 16.04 DSVM イメージ 
>
> これらの VM イメージは、ARM デプロイを使用している既存のお客様のみが利用できます。 これらのイメージは、提供終了日までは重要なセキュリティ パッチを引き続き受信されますが、今後の最新のデータ サイエンス ツールでは更新されません。
> 
> [DSVM イメージの非推奨化に関するページ](./reference-deprecation.md)を参照してください。
...
| ------------- | ------------- |
| サポートされるバージョン | |
| サポートされている DSVM エディション      | Ubuntu 16.04 (非推奨)    |
...
| サポートされている DSVM エディション      | Windows Server 2019<br>Ubuntu 18.04<br> Windows 2016 (非推奨)<br> Ubuntu 16.04 (非推奨)  |
...
| ------------- | ------------- |
| サポートされるバージョン | 0.16.1|
| サポートされている DSVM エディション      | Ubuntu 18.04<br> Ubuntu 16.04 (非推奨)   |
...
| ------------- | ------------- |
| サポートされるバージョン | 2.5.1 |
| サポートされている DSVM エディション      | Windows 2016 (非推奨)<br> Ubuntu 16.04 (非推奨)   |
...
| サポートされている DSVM エディション      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16.04 (非推奨) |
