---
title: クイック スタート:Ubuntu DSVM の作成
...
Ubuntu Data Science Virtual Machine を起動して実行します。
...
1. 「data science virtual machine」と入力して仮想マシンの一覧を検索し、"Data Science Virtual Machine for Linux (Ubuntu)" を選択します。
    
    ![Ubuntu VM の一覧](./media/dsvm-ubuntu-intro/search-ubuntu.png)

1. 次のウィンドウで **[作成]** を選択します。

   [![](media/dsvm-ubuntu-intro/create-linux.png "Ubuntu マシンを作成するためのボタン")](media/dsvm-ubuntu-intro/create-linux-expanded.png#lightbox)

1. [仮想マシンの作成] ブレードにリダイレクトされます。
   
   ![Ubuntu 仮想マシンに対応する [基本] タブ](./media/dsvm-ubuntu-intro/review-create-ubuntu.png)
