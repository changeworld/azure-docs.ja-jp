---
title: ディープ ラーニング Data Science Virtual Machine の使用方法について説明します
titleSuffix: Azure
...
AI 用の ディープ ラーニング VM で提供されるツールはたくさんあります。 [ディープ ラーニングと AI フレームワークのページ](dsvm-deep-learning-ai-frameworks.md)に、これらのツールの使用方法の詳細が記載されています。 
