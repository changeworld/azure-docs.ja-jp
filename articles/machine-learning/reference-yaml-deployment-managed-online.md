...
ソース JSON スキーマは https://azuremlschemas.azureedge.net/latest/managedOnlineDeployment.schema.json にあります。 スキーマは、便宜上、以下の JSON 形式と YAML 形式で提供されています。
