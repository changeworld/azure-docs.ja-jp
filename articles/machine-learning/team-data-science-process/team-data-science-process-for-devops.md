...
|  | Release | [このヘッド リファレンス記事では、CI/CD 環境でのビルド、テスト、リリースの概念について説明します](/azure/devops/pipelines/?view=azure-devops) | Visual Studio Codespace | 上級 | ソフトウェア開発経験、CI/CD 環境に関する知識、SDLC に関する知識 |
