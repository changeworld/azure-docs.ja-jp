...
| 6 | [Azure IoT 予測メンテナンス](https://github.com/Azure/azure-iot-predictive-maintenance) | Azure IoT Suite PCS - 構成済みソリューションです。 IoT Suite を使用した航空機メンテナンスの PdM テンプレートです。 同じプロジェクトに関連する[別のドキュメント](../../iot-accelerators/quickstart-predictive-maintenance-deploy.md)と[チュートリアル](../../iot-accelerators/iot-accelerators-predictive-walkthrough.md)をご覧ください。 |
