...
| ---- | ---- | --- | --- |
| A123 |Day 1 | が必要です。 が必要です。 が必要です。 | が必要です。 |
| A123 |Day 2 | が必要です。 が必要です。 が必要です。 | が必要です。 |
| ...  |...   | が必要です。 が必要です。 が必要です。 | が必要です。 |
| B234 |Day 1 | が必要です。 が必要です。 が必要です。 | が必要です。 |
| B234 |Day 2 | が必要です。 が必要です。 が必要です。 | が必要です。 |
| ...  |...   | が必要です。 が必要です。 が必要です。 | が必要です。 |
...
| [GitHub からの Azure AI ラーニング](http://azure.github.io/learnanalytics/public) | パブリック |
