...
最初に[ユーザー割り当てのマネージド ID を作成](../active-directory/managed-identities-azure-resources/how-to-manage-ua-identity-cli.md)し、マネージド ID の ARM リソース ID を書き留めます。
