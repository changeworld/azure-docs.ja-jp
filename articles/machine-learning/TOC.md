...
### [Azure VM をセットアップする](machine-learning-data-science-setup-virtual-machine.md)
### [SQL VM をセットアップする](machine-learning-data-science-setup-sql-server-virtual-machine.md)
...
## ワークスペースを管理する
### [ワークスペースを作成する](machine-learning-create-workspace.md)
### [ワークスペースを管理する](machine-learning-manage-workspace.md)
...
### [SQL パーティション テーブルを使用する](machine-learning-data-science-parallel-load-sql-partitioned-tables.md)
...
#### [TDSP の概要](machine-learning-data-science-select-features.md)
### モデルの作成とトレーニング
#### [初めての実験を作成する](machine-learning-create-experiment.md)
