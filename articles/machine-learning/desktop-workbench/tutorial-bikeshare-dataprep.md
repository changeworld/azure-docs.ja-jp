...
1. __ボストンの気象__ のファイルには、時間単位で報告される、次の気象関連フィールドが含まれています。
...
1. **[サンプリング]**: サンプリング スキームを作成するには、**[編集]** を選択します。 追加された新しい __上位 10000__ 行を選択して、__[編集]__ を選択します。 __[Sample Strategy]\(サンプル戦略\)__ を **[Full File]\(完全ファイル\)** に設定してから、**[適用]** を選択します。
