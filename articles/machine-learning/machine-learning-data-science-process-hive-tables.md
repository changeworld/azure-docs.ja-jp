...
を Web ブラウザーに入力することもできます。ログインする場合、Hadoop クラスターの資格情報の入力を求められることに注意してください。代わりに、 [PowerShell を使用して Hive ジョブを送信](../hdinsight/hdinsight-submit-hadoop-jobs-programmatically.md#hive-powershell)することもできます。 
