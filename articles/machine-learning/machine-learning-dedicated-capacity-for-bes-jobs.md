...
![Batch プール サービスのアーキテクチャ](media/machine-learning-dedicated-capacity-for-bes-jobs/pool-architecture.png)
...
Web サービスの作成の詳細については、「[Azure Machine Learning Web サービスをデプロイする](machine-learning-publish-a-machine-learning-web-service.md)」を参照してください。
