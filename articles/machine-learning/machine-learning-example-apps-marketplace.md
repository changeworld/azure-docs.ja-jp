...
Azure Machine Learning を使用して、データ サイエンティストはスマートフォン アプリケーションの開発者と同じように自らのノウハウや創造性を収益につなげるチャネルを得られます。機械学習サービスを Azure Marketplace に発行することで、発行したクラウド API を世界中のあらゆる人が購入、サブスクライブして自らのアプリケーションに使用できるようになります。
