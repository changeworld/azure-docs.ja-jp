...
>
>機械学習についてよく知らない場合は、まずビデオ シリーズ「[初心者向けデータ サイエンス](data-science-for-beginners-the-5-questions-data-science-answers.md)」をご覧になることをお勧めします。 日常的な言葉と概念が使用されているこのビデオ シリーズは、機械学習の導入として優れています。
>
