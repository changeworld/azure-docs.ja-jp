---
title:Machine Learning Studio ワークスペースの管理 titleSuffix: Azure Machine Learning Studio description:Azure Machine Learning ワークスペースへのアクセスを管理し、ML API Web サービスをデプロイおよび管理します services: machine-learning ms.service: machine-learning ms.component: studio ms.topic: article
