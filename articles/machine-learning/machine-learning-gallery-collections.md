...
![ギャラリー ホーム ページでコレクションを選ぶ](media/machine-learning-gallery-collections/select-collections-in-gallery.png)
...
2.  ページの上部にあるイメージを選択してから、名前を選択します。
    ...
    ![アカウント名を選択する](media/machine-learning-gallery-collections/click-account-name.png)
...
6. **[Settings (設定)]** ページの **[Visibility (表示)]** で、コレクションが **[Public (公開)]** (誰でもコレクションを表示できる) であるか、または **[Unlisted (非公開)]** (コレクションへの直接リンクを持つユーザーのみが見られる) であるかを選択します。
   ...
   > 
    ...
    ![[Public (公開)] または [Unlisted (非公開)] を選択する](media/machine-learning-gallery-collections/create-collection-page-3.png)
7. **[作成]**を選択します。
