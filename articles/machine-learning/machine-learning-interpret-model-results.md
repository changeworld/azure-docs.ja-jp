...
Azure Machine Learning を初めて使用する場合は、手始めとして単純な実験を作成する方法について、[Azure Machine Learning Studio での簡単な実験の作成](machine-learning-create-experiment.md)に関するページをご覧ください。
...
![あやめの実験のスクリーンショット](./media/machine-learning-interpret-model-results/1.png)
...
![モデルのスコア付けモジュール](./media/machine-learning-interpret-model-results/1_1.png)

図 2 に示すように、スコア付けの結果が表示されます。

![あやめの 2 クラス分類実験の結果](./media/machine-learning-interpret-model-results/2.png)
...
予測結果を理解し、結果の妥当性が確認できたら、実験を Web サービスとして発行できます。発行すると、さまざまなアプリケーションでデプロイして呼び出し、新しいあやめに関するクラスの予測を取得できます。 トレーニング実験をスコア付け実験に変換し、Web サービスとして発行する方法については、[Azure Machine Learning Web サービスの発行](machine-learning-walkthrough-5-publish-web-service.md)に関するページをご覧ください。 この手順に従うと、図 3 で示すスコア付け実験を実行できます。

![スコア付け実験のスクリーンショット](./media/machine-learning-interpret-model-results/3.png)
...
![あやめの 2 クラス分類の実験](./media/machine-learning-interpret-model-results/4.png)
...
![モデルのスコア付けの解釈のテスト](./media/machine-learning-interpret-model-results/4_1.png)

![スコア付けテストの結果](./media/machine-learning-interpret-model-results/5.png)
...
![文字の認識の例](./media/machine-learning-interpret-model-results/5_1.png)
...
![文字認識の多クラス分類の実験](./media/machine-learning-interpret-model-results/6.png)
...
![モデルのスコア付けの結果](./media/machine-learning-interpret-model-results/7.png)
...
![R コード例](./media/machine-learning-interpret-model-results/8.png)

図 8: スコア付けラベルとそのラベルに関連付けられた確率を抽出する R コード

![実行結果](./media/machine-learning-interpret-model-results/9.png)
...
![スコア付けモジュールの解釈のテスト](./media/machine-learning-interpret-model-results/9_1.png)

![テスト結果](./media/machine-learning-interpret-model-results/10.png)
...
![自動車価格の予測問題のスコア付け結果](./media/machine-learning-interpret-model-results/12.png)
...
![自動車価格の回帰問題のスコア付け実験](./media/machine-learning-interpret-model-results/13.png)

図 13. 自動車価格の回帰問題のスコア付け実験

Web サービスを実行して返された結果は、図 14 のようになります。 この車の予測価格は 15,085.52 ドルです。

![スコア付けモジュールの解釈のテスト](./media/machine-learning-interpret-model-results/13_1.png)

![スコア付けモジュールの結果](./media/machine-learning-interpret-model-results/14.png)
...
![あやめのクラスタリング問題の実験](./media/machine-learning-interpret-model-results/15.png)
...
![クラスタリング結果](./media/machine-learning-interpret-model-results/16.png)

図 16:  トレーニング データセットのクラスタリング結果を視覚化する

図 17 には、2 つ目のパートの結果である、トレーニング済みクラスタリング モデルによる新しいエントリのクラスタリングを示します。

![クラスタリング結果を視覚化する](./media/machine-learning-interpret-model-results/17.png)
...
![あやめのクラスタリング問題のスコア付け実験](./media/machine-learning-interpret-model-results/18.png)

図 18:  あやめのクラスタリング問題のスコア付け実験

Web サービスを実行して返された結果は、図 19 のようになります。 この花は、クラスター 0 に属していると予測されます。

![スコア付けモジュールの解釈のテスト](./media/machine-learning-interpret-model-results/18_1.png)

![スコア付けモジュールの結果](./media/machine-learning-interpret-model-results/19.png)
...
![レストランの推奨問題のスコア付け実験](./media/machine-learning-interpret-model-results/25.png)
...
![レコメンダー システム サービスの例](./media/machine-learning-interpret-model-results/25_1.png)

![実験結果の例](./media/machine-learning-interpret-model-results/26.png)
