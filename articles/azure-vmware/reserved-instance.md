...
-   クラウド ソリューション プロバイダー (CSP) Azure プランのサブスクリプションの場合、パートナーは Azure portal で顧客の予約インスタンスを購入する必要があります。 
