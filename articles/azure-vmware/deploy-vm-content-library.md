...
ms.locfileid: "86014194"
---
# <a name="create-a-content-library-to-deploy-vms-in-azure-vmware-solution-avs"></a>Azure VMware Solution (AVS) で VM をデプロイするためのコンテンツ ライブラリを作成する
