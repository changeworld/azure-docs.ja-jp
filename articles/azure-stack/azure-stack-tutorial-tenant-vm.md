...
3. **オファーの作成**
   ...
   a. ポータルにクラウドの管理者として[サインイン](azure-stack-connect-azure-stack.md)してから、**[新規]** > **[プラン]** > **[オファー]** の順にクリックします。
...
2. **仮想マシンのプロビジョニング**
   ...
   f.SAML 属性の属性名またはスキーマ リファレンスを入力します。 **[概要]** セクションで、**[OK]** をクリックして仮想マシンを作成します。  
