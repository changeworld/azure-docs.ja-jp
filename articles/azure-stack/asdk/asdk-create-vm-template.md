...
> [!IMPORTANT]
> 以下の手順を開始する前に、Ubuntu VM イメージ (この例では Ubuntu Server 16.04 LTS) が既に [Azure Stack マーケットプレースに追加](asdk-marketplace-item.md)されている必要があります。
...
> [高度な評価タスクについて学習する](asdk-advanced-eval.md)