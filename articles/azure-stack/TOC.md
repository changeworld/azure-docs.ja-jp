...
# Key Vault を使用したセキュリティで保護された値の管理
...
## [Key Vault 証明書を使用して VM を作成する](azure-stack-kv-push-secret-into-vm.md)
...
## [MSDN フォーラム](https://social.msdn.microsoft.com/Forums/azure/en-US/home?forum=AzureStack)  
