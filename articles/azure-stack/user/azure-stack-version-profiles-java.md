...
Azure Stack のテナント ID を確認するには、[こちら](../azure-stack-csp-ref-operations.md)の手順をご覧ください。 環境変数を設定するには、次の手順に従います。
...
- Azure Stack でのバージョン プロファイル](azure-stack-version-profiles.md)
