...
- 1809 を適用する前に、1808 の最新の Azure Stack 修正プログラムをインストールしてください。 詳細については、[KB 4481066 – Azure Stack 修正プログラム Azure Stack 修正プログラム 1.1808.9.117](https://support.microsoft.com/help/4481066/) を参照してください。 Microsoft では、利用可能な最新の修正プログラムを推奨していますが、1809 のインストールに必要な最小バージョンは 1.1808.5.110 です。
