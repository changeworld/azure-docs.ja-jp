...
1. **+ Create a resource** > **Tenant Offers + Plans** > **オファー**を選択します。
...
4. これら公開用の委任されたオファーは、委任されたポータルを介してのみ表示できるようになりました。 この URL を検索し変更するには、以下を行います。
    ...
    a.  **参照** > **すべてのサービス** を選択し、**全般**カテゴリで **サブスクリプション** を選択します｡ 委任されたプロバイダーのサブスクリプションを選択します｡ たとえば、**[DPSubscription]** > **[プロパティ]** を選択します。
