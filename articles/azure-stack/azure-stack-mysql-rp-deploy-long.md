...
# <a name="deploy-the-mysql-resource-provider-on-azure-stack-to-use-with-webapps"></a>Deploy the MySQL Resource Provider on Azure Stack to use with WebApps
...
### <a name="create-an-image-of-windows-server-including-.net-3.5"></a>Create an image of Windows Server including .NET 3.5
...
### <a name="create-the-required-certificates"></a>Create the required certificates
...
### <a name="download-mysql-binaries-to-your-azure-stack"></a>Download MySQL binaries to your Azure Stack
...
## <a name="deploy-the-mysql-resource-provider-vm"></a>Deploy the MySQL Resource Provider VM
