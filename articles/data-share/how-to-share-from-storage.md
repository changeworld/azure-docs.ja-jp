...
1. スナップショットは **[詳細]** タブからトリガーできます。このタブで **[スナップショットのトリガー]** を選択します。 データの完全なスナップショットまたは増分スナップショットがトリガーされるように選択することができます。 データ プロバイダーから初めてデータを受信する場合は、 **[完全なコピー]** を選択します。 
