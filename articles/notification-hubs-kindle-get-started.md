...
2. Eclipse で、プロジェクトを右クリックし、**[プロパティ]** をクリックします。左側の **[Java ビルド パス]** を選択し、上部の **[ライブラリ]** タブを選択します。**[外部 Jar の追加]** をクリックし、Amazon SDK を解凍したディレクトリから `\SDK\Android\DeviceMessaging\lib\amazon-device-messaging-*.jar` ファイルを選択します。
