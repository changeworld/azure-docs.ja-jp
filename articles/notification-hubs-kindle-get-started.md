...
-   Android SDK (前提条件として Eclipse を使用する必要があります) は、[ここ][ここ]からダウンロードできます。
-   [ここ][1]に表示される指示に従って、Kindle の開発環境を設定します。

## 開発者ポータルへの新しいアプリの追加

1.  最初に、[開発者ポータル][開発者ポータル]でアプリを作成します。
...
1.  ADM ライブラリを取得するには、[SDK をダウンロード][SDK をダウンロード]します。SDK zip ファイルを解凍します。
