...
| [Azure SQL Analytics (プレビュー)](../log-analytics/log-analytics-azure-sql.md) | Windows | | | | | | 10 分 |
| [Backup](../backup/backup-introduction-to-azure-backup.md) | Azure |  |  |  |  |  | 該当なし |
...
* [クエリを作成](../log-analytics/log-analytics-log-searches.md)して、管理ソリューションで収集したデータを分析する方法を確認する。
