...
[コンテナー用の Azure Monitor](monitoring-container-insights-overview.md) を使用することで、Linux コンテナー インフラストラクチャのパフォーマンスと正常性を一目で確認し、問題をすばやく調査することができます。 利用統計情報を Log Analytics ワークスペースに格納し、Azure Portal に統合して、ダッシュボードでデータを検索、フィルター処理したり、セグメントごとに集計することで、負荷、パフォーマンスおよび正常性を監視できます。  
