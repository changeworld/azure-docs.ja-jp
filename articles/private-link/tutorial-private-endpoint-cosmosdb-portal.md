...
description: Azure プライベート エンドポイントを使用して Azure Cosmos アカウントに非公開で接続してみましょう。
author: asudbring
ms.author: allensu
...
12. ストレージ エクスプローラーで、 **[Cosmos DB アカウント]** を右クリックし、 **[Cosmos DB に接続]** を選択します。
