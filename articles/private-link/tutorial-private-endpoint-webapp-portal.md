...
10. **403** ページが表示されることを確認します。 このページは、Web アプリに外部からアクセスできないことを示しています。
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-ext-403.png" alt-text="Azure portal の [Web アプリの作成] の [基本] タブ。" border="true":::
...
13. 既定の Web アプリ ページが表示されることを確認します。
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-default-page.png" alt-text="Azure portal の [Web アプリの作成] の [基本] タブ。" border="true":::
