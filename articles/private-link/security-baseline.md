...
- [Azure Security Center のリスク検出 (疑わしいアクティビティ) について](/azure/active-directory/reports-monitoring/concept-risk-events)
...
Azure Active Directory のロールベースのアクセス制御を使用して、Azure リソースへのアクセスを制御します。
