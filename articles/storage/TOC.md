...
## .NET
### [Blob、Queue、Table、File](https://msdn.microsoft.com/library/azure/mt347887.aspx)
### [リソース プロバイダー](/dotnet/api/)
### [データの移動](/dotnet/api/)

## REST ()
### [Blob、Queue、Table、File](/rest/api/storageservices/fileservices/azure-storage-services-rest-api-reference)
