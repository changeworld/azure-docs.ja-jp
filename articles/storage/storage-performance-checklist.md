...
## <a name="a-nameallservicesaall-services"></a><a name="allservices"></a>すべてのサービス
このセクションでは、任意の Azure Storage サービス (BLOB、テーブル、キュー、ファイル) を使用する場合に適用できる実証済みプラクティスを列挙します。  

### <a name="a-namesubheading1ascalability-targets"></a><a name="subheading1"></a>スケーラビリティ ターゲット
...
#### <a name="a-namesub1bandwidthabandwidth-scalability-target-for-all-services"></a><a name="sub1bandwidth"></a>すべてのサービスに対する帯域幅のスケーラビリティ ターゲット
...
### <a name="a-namesubheading47apartition-naming-convention"></a><a name="subheading47"></a>パーティションの命名規則
...
##### <a name="a-namesubheading2athroughput"></a><a name="subheading2"></a>スループット
...
##### <a name="a-namesubheading3alink-quality"></a><a name="subheading3"></a>接続品質
他のネットワーク運用と同様に、エラーやパケット損失が生じるネットワーク状態では、遅延が生じて有効なスループットが損なわれます。  WireShark または NetMon は、この問題の診断に有用です。  

##### <a name="useful-resources"></a>有用な情報
仮想マシンのサイズと割り当てられている帯域幅の詳細については、「[Windows VM のサイズ](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)」または「[Linux VM のサイズ](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)」をご覧ください。  

#### <a name="a-namesubheading4alocation"></a><a name="subheading4"></a>場所
...
### <a name="a-namesubheading5acontent-distribution"></a><a name="subheading5"></a>コンテンツ配信
...
### <a name="a-namesubheading6ausing-sas-and-cors"></a><a name="subheading6"></a>SAS と CORS の使用
...
#### <a name="a-namesubheading7agetting-data"></a><a name="subheading7"></a>データの取得
...
#### <a name="a-namesubheading8auploading-data-in-batches"></a><a name="subheading8"></a>データの一括アップロード
...
#### <a name="a-namesubheading9aincrease-default-connection-limit"></a><a name="subheading9"></a>既定の接続数の上限を増加する
...
#### <a name="a-namesubheading10aincrease-threadpool-min-threads-if-using-synchronous-code-with-async-tasks"></a><a name="subheading10"></a>非同期タスクを伴う同期コードを使用する場合は、スレッド プールの最小スレッド数 (ThreadPool Min Threads) を増やす
...
#### <a name="a-namesubheading11atake-advantage-of-net-45-garbage-collection"></a><a name="subheading11"></a>.NET 4.5 のガベージ コレクションを活用する
...
### <a name="a-namesubheading12aunbounded-parallelism"></a><a name="subheading12"></a>無制限の並列処理
...
### <a name="a-namesubheading13astorage-client-libraries-and-tools"></a><a name="subheading13"></a>ストレージ クライアント ライブラリとツール
...
#### <a name="a-namesubheading14athrottlingserverbusy"></a><a name="subheading14"></a>調整とサーバー ビジー
...
#### <a name="a-namesubheading15anon-retryable-errors"></a><a name="subheading15"></a>再試行できないエラー
...
#### <a name="a-namesubheading46amultiple-clients-accessing-a-single-object-concurrently"></a><a name="subheading46"></a>1 つのオブジェクトに同時にアクセスする複数のクライアント
...
#### <a name="a-namesubheading16abandwidth-and-operations-per-blob"></a><a name="subheading16"></a>BLOB ごとの帯域幅と操作
...
#### <a name="a-namesubheading17acopy-blob"></a><a name="subheading17"></a>BLOB のコピー
...
#### <a name="a-namesubheading18ause-azcopy"></a><a name="subheading18"></a>AzCopy の使用
...
#### <a name="a-namesubheading19aazure-importexport-service"></a><a name="subheading19"></a>Azure のインポート/エクスポート サービス
...
### <a name="a-namesubheading20ause-metadata"></a><a name="subheading20"></a>メタデータの使用
...
#### <a name="a-namesubheading21auploading-one-large-blob-quickly"></a><a name="subheading21"></a>1 つの大きな BLOB を迅速にアップロードする
...
#### <a name="a-namesubheading22auploading-many-blobs-quickly"></a><a name="subheading22"></a>多数の BLOB をすばやくアップロードする
...
### <a name="a-namesubheading23achoosing-the-correct-type-of-blob"></a><a name="subheading23"></a>正しい種類の BLOB の選択
...
### <a name="a-namesubheading24atable-specific-scalability-targets"></a><a name="subheading24"></a>テーブル固有のスケーラビリティ ターゲット
...
#### <a name="a-namesubheading25ause-json"></a><a name="subheading25"></a>JSON の使用
...
#### <a name="a-namesubheading26anagle-off"></a><a name="subheading26"></a>Nagle のオフ
...
#### <a name="a-namesubheading27atables-and-partitions"></a><a name="subheading27"></a>テーブルとパーティション
...
##### <a name="a-namesubheading28aappend-only-and-prepend-only-patterns"></a><a name="subheading28"></a>末尾または先頭にのみ追加されるパターン
...
##### <a name="a-namesubheading29ahigh-traffic-data"></a><a name="subheading29"></a>大量のトラフィック データ
...
##### <a name="a-namesubheading30aquery-scope"></a><a name="subheading30"></a>クエリ スコープ
...
##### <a name="a-namesubheading31aquery-density"></a><a name="subheading31"></a>クエリ密度
...
###### <a name="a-namesubheading32afiltering"></a><a name="subheading32"></a>フィルター処理
...
###### <a name="a-namesubheading33aprojection"></a><a name="subheading33"></a>プロジェクション
...
##### <a name="a-namesubheading34adenormalization"></a><a name="subheading34"></a>非正規化
...
##### <a name="a-namesubheading35abatching"></a><a name="subheading35"></a>バッチ処理
...
##### <a name="a-namesubheading36aupsert"></a><a name="subheading36"></a>アップサート (Upsert)
...
##### <a name="a-namesubheading37astoring-data-series-in-a-single-entity"></a><a name="subheading37"></a>単一エンティティでのデータ シリーズの格納
...
##### <a name="a-namesubheading38astoring-structured-data-in-blobs"></a><a name="subheading38"></a>BLOB での構造化データの格納
...
### <a name="a-namesubheading39ascalability-limits"></a><a name="subheading39"></a>スケーラビリティ限界
...
### <a name="a-namesubheading40anagle-off"></a><a name="subheading40"></a>Nagle のオフ
Nagle アルゴリズムについて論じているテーブル構成のセクションを参照してください。Nagle アルゴリズムは、一般的にキュー要求のパフォーマンスに適していないため、無効にする必要があります。  

### <a name="a-namesubheading41amessage-size"></a><a name="subheading41"></a>メッセージ サイズ
メッセージ サイズが増加すると、キューのパフォーマンスとスケーラビリティが低下します。 メッセージには、受信者が必要な情報のみを含める必要があります。  

### <a name="a-namesubheading42abatch-retrieval"></a><a name="subheading42"></a>一括取得
1 回の操作でキューから最大 32 個のメッセージを取得できます。 これにより、クライアント アプリケーションの取得回数を減らすことができ、モバイル デバイスなどの待機時間が長い環境では特に役立ちます。  

### <a name="a-namesubheading43aqueue-polling-interval"></a><a name="subheading43"></a>キューのポーリング間隔
...
### <a name="a-namesubheading45aapplication-architecture"></a><a name="subheading45"></a>アプリケーションのアーキテクチャ
