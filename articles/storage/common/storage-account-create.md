...
PowerShell で Azure Storage アカウントを作成するには、Azure PowerShell モジュール Az バージョン 0.7 以降をインストールしておく必要があります。 詳細については、[Azure PowerShell Az モジュールの概要](/powershell/azure/new-azureps-module-az)に関するページを参照してください。
