...
詳細については、[Azure Blob Storage のホット、クール、アーカイブ アクセス層](../blobs/storage-blob-storage-tiers.md?tabs=azure-portal)に関するページを参照してください。
...
詳細については、[Azure Blob Storage のライフサイクルの管理](../blobs/storage-lifecycle-management-concepts.md?tabs=azure-portal)に関するページを参照してください
