...
ロールベースのアクセス制御 [RBAC](https://docs.microsoft.com/azure/role-based-access-control/overview) は、アクセス許可のセットを _ロール_ に結合することで、Azure リソースの非常にきめ細かなアクセス管理を可能にします。 ここでは、Storage Explorer で RBAC を最適に動作させる方法について説明します。
