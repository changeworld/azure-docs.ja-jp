...
|    BlockBlobStorage<sup>1</sup>    | 東南アジア<br /> オーストラリア東部<br /> 西ヨーロッパ<br /> 米国東部    |    ブロック BLOB のみ    |
|    FileStorage    | 東南アジア<br /> オーストラリア東部<br /> 西ヨーロッパ<br /> 米国東部    |    Azure Files のみ    |
...
GRS と GZRS の主な違いは、プライマリ リージョンでのデータのレプリケート方法です。 セカンダリ ロケーションでは、データは常に LRS を使用して 3 回同期的にレプリケートされます。 セカンダリ リージョンの LRS は、ハードウェア障害からデータを保護します。
...
| プライマリ リージョンでリージョン全体の障害が発生する                                                                                     | ×                              | いいえ                               | 可<sup>1</sup>                                  | 可<sup>1</sup>                                  |
