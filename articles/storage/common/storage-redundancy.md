...
整合性、持続性、高可用性を必要とするシナリオでは、プライマリ リージョンで ZRS を使用することをお勧めします。 また、データ ガバナンスの要件により、1 つの国または地域内でのみデータをレプリケートするようにアプリケーションを制限する場合は、ZRS を使用することをお勧めします。
...
| BlockBlobStorage<sup>1</sup> | 東南アジア<br /> オーストラリア東部<br /> 西ヨーロッパ<br /> 米国東部 | Premium ブロック BLOB のみ |
| FileStorage | 東南アジア<br /> オーストラリア東部<br /> 西ヨーロッパ<br /> 米国東部 | Premium ファイル共有のみ |
