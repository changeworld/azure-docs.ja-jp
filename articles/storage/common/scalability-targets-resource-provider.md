---
title: Azure Storage リソース プロバイダーのスケーラビリティ
description: Azure Storage リソース プロバイダーに対する操作のスケーラビリティおよびパフォーマンスのターゲット。 リソース プロバイダーは、Azure Storage の Azure Resource Manager を実装します。
services: storage
author: tamram
ms.service: storage
ms.topic: conceptual
...
## <a name="scale-targets-for-the-resource-provider"></a>リソース プロバイダーのスケール ターゲット
