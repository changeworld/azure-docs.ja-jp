...
Ruby アプリケーションを作成します。手順については、「[Ruby on Rails Web application on an Azure VM](../virtual-machines/virtual-machines-linux-classic-ruby-rails-web-app.md)」 (Azure VM での Ruby on Rails Web アプリケーション) を参照してください。
