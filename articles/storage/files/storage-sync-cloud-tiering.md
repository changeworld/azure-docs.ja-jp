...
エージェントのバージョンが 9.x 以降の場合、階層化するファイルの最小ファイル サイズは、ファイル システムのクラスター サイズに基づきます (ファイル システムのクラスター サイズの 2 倍)。 たとえば、NTFS ファイル システムのクラスター サイズが 4 KB であれば、階層化するファイルの最小ファイル サイズは 8 KB になります。 エージェントのバージョンが 8.x 以前の場合、階層化するファイルの最小ファイル サイズは 64KB です。
