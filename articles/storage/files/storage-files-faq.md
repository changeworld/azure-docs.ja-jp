...
**データに Azure ファイル共有または Azure Blob Storage を使用する理由を教えてください。**  
...
**ある特定の機能が Azure Files に追加されることを個人的に望んでいます。それを追加していただくことはできますか。**  
...
**Windows Server 2012 R2 または Windows 8.1 で Azure ファイル共有をマウントしました。パフォーマンスが低下していますが、なぜでしょうか。**  
