...
:::row:::
    :::column:::
        :::image type="content" source="media/storage-files-migration-storsimple-8000/storage-files-migration-storsimple-8000-new-job.png" alt-text="移行ジョブの新しいジョブ作成フォームのスクリーンショット。":::
    :::column-end:::
    :::column:::
