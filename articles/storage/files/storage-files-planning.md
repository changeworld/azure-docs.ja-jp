...
Premium ファイル共有は、固定 GiB/IOPS/スループット比に基づいてプロビジョニングされます。 すべての共有のサイズは、最小ベースラインまたはスループットが提供され、バーストが許可されます。 プロビジョニングされた GiB ごとに、共有は、最小の IOPS/スループットと 1 IOPS と 0.1 MiB/s のスループットから、共有ごとの最大限度まで発行されます。 最小許容プロビジョニングは 100 GiB で、最小の IOPS/スループットになります。 

すべての Premium 共有は、ベスト エフォートで制限なしのバーストで提供されます。 すべての共有サイズは、最大 4,000 IOPS、またはプロビジョニングされた GiB あたり最大 3 IOPS のうち、共有に対してより大きいバースト IOPS を提供する方の値までバーストできます。 すべての共有では、ピーク バースト限度で最大 60 分間のバーストがサポートされています。 新しい共有は、プロビジョニングされた容量に基づく完全なバースト クレジットで開始されます。
...
>
> バースト限度 = MAX (4,000, 3 * ベースライン IOPS)。 (限度が大きい方。最大 100,000 IOPS まで)。
>
