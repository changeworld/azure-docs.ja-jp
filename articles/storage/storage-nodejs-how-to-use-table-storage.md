...
- [Node.js Web サイトの構築と Azure へのデプロイ][Create and deploy a Node.js application to an Azure Web Site]
- [WebMatrix を使用した Node.js Web サイトの構築と Azure へのデプロイ][Web Site with WebMatrix]
- [Node.js アプリケーションの構築と Azure クラウド サービスへのデプロイ][Node.js Cloud Service] (Windows PowerShell を使用)
