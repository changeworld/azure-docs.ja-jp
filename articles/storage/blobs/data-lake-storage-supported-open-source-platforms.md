---
title: Azure Data Lake Storage Gen2 がサポートされているオープンソース プラットフォーム | Microsoft Docs
description: Data Lake Storage Gen2 がサポートされているオープン ソース プラットフォームについて説明します
author: normesta
...
次の表に、Data Lake Storage Gen2 がサポートされているオープンソース プラットフォームの一覧を示します。
...
| --- | --- | --- |
| [HDInsight](https://azure.microsoft.com/services/hdinsight/) | 3.6 以降 | [HDInsight で使用できる Apache Hadoop コンポーネントおよびバージョンとは](https://docs.microsoft.com/azure/hdinsight/hdinsight-component-versioning?toc=%2Fazure%2Fhdinsight%2Fstorm%2FTOC.json&bc=%2F2Fazure%2Fbread%2Ftoc.json)
