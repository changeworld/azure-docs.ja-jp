...
5. **[診断設定の追加]** をクリックします。
   ...
   > [!div class="mx-imgBorder"]
   > ![ポータル - リソース ログ - 診断設定の追加](media/monitor-blob-storage/diagnostic-logs-settings-pane-2.png)

   **[診断設定]** ページが表示されます。

   > [!div class="mx-imgBorder"]
   > ![リソース ログ ページ](media/monitor-blob-storage/diagnostic-logs-page.png)
