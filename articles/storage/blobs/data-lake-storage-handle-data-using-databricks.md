...
3. ストレージ アカウントの **[概要]** ページから **[Explorer で開く]** を選択します。
   ...
   ![Storage Explorer を開く](./media/data-lake-storage-handle-data-using-databricks/data-lake-storage-open-storage-explorer.png "Storage Explorer を開く")

4. **[Azure Storage Explorer を開く]** を選択して Storage Explorer を開きます。

   ![[Storage Explorer を開く] の 2 つ目のプロンプト](./media/data-lake-storage-handle-data-using-databricks/data-lake-storage-open-storage-explorer-2.png "[Storage Explorer を開く] の 2 つ目のプロンプト")

   Storage Explorer が開きます。 ファイル システムを作成してサンプル データをアップロードすることができます。「[クイック スタート:Azure Storage Explorer を使用してオブジェクト ストレージ内に BLOB を作成する](data-lake-storage-explorer.md)」のトピックのガイダンスに従ってください。
