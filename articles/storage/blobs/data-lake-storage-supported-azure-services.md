...
|Azure Event Hubs のキャプチャ| 一般公開|[Azure Event Hubs で Azure Blob Storage または Azure Data Lake Storage にイベントをキャプチャする](https://docs.microsoft.com/azure/event-hubs/event-hubs-capture-overview)|
