...
description: .NET クライアント ライブラリまたは JavaScript v12 SDK を使用して、コンテナーまたは BLOB のサービスの Shared Access Signature (SAS) を作成する方法を学習します。
services: storage
author: tamram
ms.service: storage
ms.topic: how-to
...
ms.locfileid: "93027203"
---
# <a name="create-a-service-sas-for-a-container-or-blob"></a>コンテナーまたは BLOB のサービス SAS を作成する

[!INCLUDE [storage-auth-sas-intro-include](../../../includes/storage-auth-sas-intro-include.md)]

この記事では、ストレージ アカウント キーを使用して、[.NET 用の Azure Storage クライアント ライブラリ](/dotnet/api/overview/azure/storage)でコンテナーまたは BLOB のサービス SAS を作成する方法を示します。
