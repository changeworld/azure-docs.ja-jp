...
7. "*セキュリティ プリンシパル*" を ACL に追加するには、 **[プリンシパルの追加]** ボタンを選択します。 
   ...
   > [!NOTE]
   > Azure AD にセキュリティ グループを作成し、個々のユーザーではなく、グループに対するアクセス許可を保守することをお勧めします。 この推奨事項やその他のベスト プラクティスの詳細については、「[Azure Data Lake Storage Gen2 のアクセス制御モデル](data-lake-storage-explorer-acl.md)」を参照してください。
