...
3. ストレージ アカウント キー、接続文字列、Azure Active Directory (Azure AD) のいずれかを使用して、ストレージ アカウントの承認を取得します。 「[アカウントに接続する](data-lake-storage-directory-file-acl-powershell.md#connect-to-the-account)」を参照してください。
...
2. `storage-preview` 拡張機能をインストールします。
   ...
   ```
3. ストレージ アカウントに接続します。 「[アカウントに接続する](data-lake-storage-directory-file-acl-cli.md#connect-to-the-account)」を参照してください。
