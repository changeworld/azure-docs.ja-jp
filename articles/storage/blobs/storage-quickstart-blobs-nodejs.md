...
ms.locfileid: "71671349"
---
# <a name="upload-download-and-list-blobs-using-the-client-library-for-nodejs"></a>Node.js 用のクライアント ライブラリを使用して BLOB をアップロード、ダウンロード、および一覧表示する
