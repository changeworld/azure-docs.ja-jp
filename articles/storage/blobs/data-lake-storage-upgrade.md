...
| 可用性 SLA                            | [SLA を参照](https://azure.microsoft.com/support/legal/sla/data-lake-store/v1_0/)                                                                   | [SLA を参照](https://azure.microsoft.com/support/legal/sla/storage/v1_3/)                                                                                                                                                                                                                                                                                                                                                | "*まだ使用不可能*"                                                                                                                           |
...
| PowerShell - 管理/ファイル システム | [リンク](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | 管理 - 非サポート、ファイル システム - "*まだ使用不可能*"        | 管理 – "*既に使用可能*" - [リンク](https://docs.microsoft.com/powershell/module/az.storage)、ファイル システム - "*まだ使用不可能*" |
