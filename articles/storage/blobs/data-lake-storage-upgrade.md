...
| Developer SDK | .NET、Java、Python、Node.js  | .NET、Java、Python、Node.js、C++、Ruby、PHP、Go、Android、iOS| Blob SDK - "*既に使用可能*"。 Azure Data Lake Storage Gen2 SDK - "*まだ使用不可能*"  |
...
| 消費          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | "*既に使用可能*"                                                                                                                                                          | "*既に使用可能*"                                                                                                                             |
