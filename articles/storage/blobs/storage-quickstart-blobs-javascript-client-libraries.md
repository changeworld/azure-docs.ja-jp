---
title: クイック スタート:ブラウザーでの JavaScript v2 用 Azure Blob Storage
description: BlobService のインスタンスを使用し、HTML ページで JavaScript v2 SDK を使用して BLOB をアップロード、一覧表示、および削除する方法について説明します。
