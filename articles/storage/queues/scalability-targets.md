---
title: Queue Storage のスケーラビリティとパフォーマンスのターゲット
titleSuffix: Azure Storage
description: Queue Storage のスケーラビリティおよびパフォーマンスのターゲットについて説明します。
author: tamram
services: storage
ms.author: tamram
ms.date: 12/18/2019
