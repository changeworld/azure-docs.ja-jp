...
Ruby アプリケーションを作成します。 手順については、「[App Service on Linux での Ruby アプリの作成](../../app-service/quickstart-ruby.md)」を参照してください。
...
- [Azure Storage チーム ブログ](/archive/blogs/windowsazurestorage/)
