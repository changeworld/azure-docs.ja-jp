...
2. Azure ストレージ エクスプローラーを開き、左側のウィンドウの  ![アカウント アイコン](media/storage-resource-manager-cannot-delete-storage-account-container-vhd/account.png) を選択し、Azure 環境を選択してサインインします。
