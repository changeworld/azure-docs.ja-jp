...
BLOB ストレージ アカウントでは、アクセス層を変更すると、料金の変更の他に、変更に対する課金が発生することがあります。詳細については、[BLOB ストレージ アカウントの料金と課金](storage-blob-storage-tiers.md#pricing-and-billing)に関するセクションを参照してください。
