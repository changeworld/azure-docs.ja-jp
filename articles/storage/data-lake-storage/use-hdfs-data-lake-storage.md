...
ここで例として、HDInsight Hadoop クラスターを Linux 上に配置してみましょう。 HDFS CLI を使用するには、最初に[サービスに対してリモート アクセス](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-linux-information#remote-access-to-services)を確立する必要があります。 [SSH](https://docs.microsoft.com/azure/hdinsight/hdinsight-hadoop-linux-use-ssh-unix) を選択した場合、PowerShell のサンプル コードは、次のようになります。
```PowerShell
