...
> [!NOTE]
> BLOB ストレージ アカウントは、現在、ほとんどの Azure リージョンでサポートされており、残りのリージョンでも順次サポートされていきます。利用できるリージョンの更新された一覧については、「[Azure のリージョン](https://azure.microsoft.com/regions/#services)」を参照してください。
> 
> 
...
> [!NOTE]
> ホット ストレージ層またはクール ストレージ層を使用する場合のコストの計算に関する詳細な例については、「[Azure Storage 料金](https://azure.microsoft.com/pricing/details/storage/)」というページにある、*"ホットおよびクール アクセス層とはどのようなものですか? また、どちらを使用すればよいのでしょうか?"* というタイトルの FAQ を参照してください。
> 
> 
