...
この記事では、階層化ファイルの管理に関する質問があるユーザー向けのガイダンスを提供します。 クラウドを使った階層化の概念に関する質問については、[Azure Files の FAQ](../files/storage-files-faq.md?toc=%2fazure%2fstorage%2ffilesync%2ftoc.json) に関するページを参照してください。
