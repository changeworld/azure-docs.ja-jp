...
データ ディスクの詳細については、[ディスクとイメージの管理](storage-about-disks-and-vhds-linux.md)に関するページと[データ ディスクを Windows 仮想マシンにアタッチする方法](../virtual-machines/windows/classic/attach-disk.md)に関するページを参照してください。
