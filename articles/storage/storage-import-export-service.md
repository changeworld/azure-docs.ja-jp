...
1.	ドライブの準備ができたら、[クラシック ポータル](https://manage.windowsazure.com)のストレージ アカウントに移動し、ダッシュボードを表示します。**[概要]** の下で **[インポート ジョブの作成]** をクリックします。
...
1. 	エクスポート ジョブを作成するには、[クラシック ポータル](https://manage.windowsazure.com)のストレージ アカウントに移動し、ダッシュボードを表示します。**[概要]** の下で **[エクスポート ジョブの作成]** をクリックし、ウィザードの指示に従って続行します。
...
- 料金情報については、「[Import/Export の料金](http://go.microsoft.com/fwlink/?LinkId=329033)」を参照してください。
...
- マイクロソフトでは、ジョブの作成時に指定された業者のアカウント番号を使用して、データ センターからドライブを返送します。必ずデータ センターのリージョンでサポートされている業者のアカウント番号を指定してください。まだアカウントを作成していない場合は、[FedEx](http://www.fedex.com/us/oadr/) (米国およびヨーロッパ) または [DHL](http://www.dhl.com/) (アジアおよびオーストラリア) の宅配業者アカウントを作成できます。
