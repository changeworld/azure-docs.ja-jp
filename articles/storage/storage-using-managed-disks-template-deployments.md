---
title: "Azure Resource Manager テンプレートでの管理ディスクの使用 | Microsoft Docs"
description: "Azure Resource Manager テンプレートで管理ディスクを使用する方法について詳しく説明します。"
services: storage
documentationcenter: 
author: jboeshart
manager: 
...
* 管理ディスクの詳細については、「[Azure Managed Disks の概要](storage-managed-disks-overview.md)」のドキュメントを参照してください。
