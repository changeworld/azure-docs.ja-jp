...
空の Node.js アプリケーションを作成します。 Node.js アプリケーションの作成手順については、「[Azure App Service での Node.js Web アプリの作成]」、「[Node.js アプリケーションの構築と Azure クラウド サービスへのデプロイ]」 (Windows PowerShell の使用)、または「[WebMatrix を使用した Node.js Web アプリの構築と Azure へのデプロイ]」をご覧ください。
...
Azure Web サイトの [Azure Portal](https://portal.azure.com) で環境変数を設定する例については、「[Azure Table サービスを使用する Node.js Web アプリ]」をご覧ください。
...
[REST API を使用]: http://msdn.microsoft.com/library/azure/hh264518.aspx
