---
title: Azure Chaos Studio でのリソースのオンボード用の Azure Policy のサンプル
description: ターゲットと機能を使用して Azure Chaos Studio にリソースをオンボードするための Azure ポリシーのサンプル
...
ms.locfileid: "132404314"
---
# <a name="azure-policy-samples-for-onboarding-resources-to-azure-chaos-studio"></a>Azure Chaos Studio へのリソースのオンボード用の Azure Policy のサンプル
この記事には、特定のリソースの種類の[ターゲットと機能](chaos-studio-targets-capabilities.md)を作成する [Azure ポリシー](../governance/policy/overview.md)定義のサンプルが含まれています。 これらのサンプルを[カスタム ポリシー定義としてデプロイし](../governance/policy/tutorials/create-custom-policy-definition.md)、[ポリシーをスコープに割り当てる](../governance/policy/assign-policy-portal.md)ことで、Chaos Studio にリソースを自動的にオンボードできます。

これらのサンプルでは、[ターゲットと機能](chaos-studio-targets-capabilities.md)を使用して、[サポートされている各リソースの種類](chaos-studio-fault-providers.md)のサービス直接ターゲットと機能をオンボードします。

## <a name="azure-cache-for-redis-policy-definition"></a>Azure Cache for Redis のポリシー定義
...
## <a name="azure-cosmos-db-policy-definition"></a>Azure Cosmos DB のポリシー定義
...
## <a name="azure-kubernetes-service-policy-definition"></a>Azure Kubernetes Service のポリシー定義
...
## <a name="azure-network-security-group-policy-definition"></a>Azure ネットワーク セキュリティ グループのポリシー定義
...
## <a name="azure-virtual-machines-policy-definition"></a>Azure Virtual Machines のポリシー定義
...
## <a name="azure-virtual-machine-scale-sets-policy-definition"></a>Azure Virtual Machine Scale Sets のポリシー定義
