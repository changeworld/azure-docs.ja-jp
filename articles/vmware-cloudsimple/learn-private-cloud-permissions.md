...
| **外部統計プロバイダー**| Register <br> Unregister <br> アップデート |
...
| **正常性更新プロバイダー** | Register <br> Unregister <br> アップデート |
...
| **仮想マシン > インベントリ** | 既存から作成 <br> 新規作成 <br> Move <br> Register <br> Remove <br> Unregister |
...
| **仮想マシン > vSphere レプリケーション** | レプリケーションの構成 <br> レプリケーションの管理 <br> レプリケーションを監視します |
