---
title: CloudSimple による Azure VMware ソリューション - CloudSimple プライベート クラウドを Oracle RAC 用に最適化する
...
8. 作成している VM の ISO のゲスト OS を選択し、 **[Next]\(次へ\)** をクリックします。
