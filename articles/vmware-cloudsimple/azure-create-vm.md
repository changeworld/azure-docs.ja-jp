---
title: CloudSimple による Azure VMware ソリューション - VM テンプレートを使用して Azure に仮想マシンを作成する
...
4. 基本情報を入力して、 **[次へ:サイズ]** をクリックします。
    ...
    | フィールド | 説明 |
    | ------------ | ------------- |
    | Subscription | プライベート クラウドに関連付けられている Azure サブスクリプション。  |
    ...
    | パスワード <br>パスワードの確認 | VM 管理者のパスワード (Windows テンプレートの場合)。  |
