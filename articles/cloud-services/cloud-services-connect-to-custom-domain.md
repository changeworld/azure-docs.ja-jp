...
Azure に Virtual Network を作成するには、Azure クラシック ポータルか PowerShell を使います。このチュートリアルでは、PowerShell を使用します。Azure クラシック ポータルを使用して Virtual Network を作成するには、「[仮想ネットワークの作成](../create-virtual-network.md)」を参照してください。
