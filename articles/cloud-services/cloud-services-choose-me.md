<properties 
	pageTitle="コンピューティング Azure として Cloud Services を選択するべきか | Microsoft Azure" 
...
# Cloud Services を使用する目的

Azure にはアプリケーションを実行するための複数のホスティング モデルがあります。それぞれの実行モデルには異なるサービスが用意されているため、実行する内容に正確に基づいて実行モデルを選択してください。最適な Cloud Services の選択
