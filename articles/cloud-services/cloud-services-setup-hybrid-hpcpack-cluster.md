...
1. HPC クラスター マネージャーの **[ノード管理]** (最近のバージョンの HPC Pack では **[リソース管理]**) で、**[操作]** ウィンドウの **[ノードの追加]** をクリックします。
    ...
    ![[ノードの追加]][add_node1]
2. ノードの追加ウィザードの **[展開方法の選択]** ページで、**[Windows Azure ノードを追加する]** をクリックして、**[次へ]** をクリックします。
...
1. HPC クラスター マネージャーの **[ノード管理]** (最近のバージョンの HPC Pack では **[リソース管理]**) で、どちらか 1 つまたは両方のノードをクリックして、**[操作]** ウィンドウの **[開始]** をクリックします。
   ...
   ![ノードの開始][add_node4]
2. **[Azure ノードの起動]** ダイアログ ボックスで、**[開始]** をクリックします。
...
[概要]: ./media/cloud-services-setup-hybrid-hpcpack-cluster/hybrid_cluster_overview.png
