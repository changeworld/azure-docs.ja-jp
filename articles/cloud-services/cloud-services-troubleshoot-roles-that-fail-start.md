...
2. Visual Studio を使ってソリューションをデプロイする過程で、[リモート デスクトップ接続の構成] を選択します。リモート デスクトップ接続の構成について詳しくは、[Azure ロールでのリモート デスクトップの使用](https://msdn.microsoft.com/library/gg443832.aspx)に関するページをご覧ください。

3. Microsoft Azure 管理ポータルで、インスタンスのステータスが **[準備完了]** として表示されたら、いずれかのロール インスタンスをクリックします。
