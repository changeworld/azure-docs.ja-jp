...
[Azure ロールのリモート デスクトップ接続をセットアップする]: https://msdn.microsoft.com/library/azure/hh124107.aspx

[Using Remote Desktop with Azure Roles (Azure ロールでのリモート デスクトップの使用)]: https://msdn.microsoft.com/library/azure/gg443832.aspx
