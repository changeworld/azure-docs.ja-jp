...
### Microsoft Azure Service Management for Extensions という名前の証明書の期限が切れています
...
そのような証明書が削除され続ける原因は、ほとんどの場合が、ご使用になっているツール (Visual Studio など) です。証明書を使用しているツールに再接続するたびに、ツールが Azure に証明書を再アップロードします。
