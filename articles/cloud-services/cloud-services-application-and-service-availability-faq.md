...
* [Fixing slow initial load for IIS](http://stackoverflow.com/questions/13386471/fixing-slow-initial-load-for-iis) (IIS の初期ロードが遅い問題を修正する)
* [IIS 7.5 web application first request after app-pool recycle very slow](http://stackoverflow.com/questions/13917205/iis-7-5-web-application-first-request-after-app-pool-recycle-very-slow) (アプリケーション プールのリサイクル後、IIS 7.5 Web アプリケーションによる最初の要求の処理が非常に低速)
