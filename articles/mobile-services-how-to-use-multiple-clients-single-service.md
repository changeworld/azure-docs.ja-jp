...
モバイル サービスを使用する Xamarin アプリの構築を開始するには、Xamarin クイックスタート チュートリアル ([iOS](partner-xamarin-mobile-services-ios-get-started.md) / [Android](partner-xamarin-mobile-services-android-get-started.md)) を参照してください。
