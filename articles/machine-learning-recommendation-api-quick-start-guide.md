<properties title="Quick start guide for the Machine Learning Recommendations API" pageTitle="Machine Learning の Recommendations API のクイック スタート ガイド | Azure" description="Azure Machine Learning Recommendations - クイック スタート ガイド" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />
