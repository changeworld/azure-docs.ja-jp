---
title: Operations Management Suite (OMS) での Application Dependency Monitor (ADM) の構成 | Microsoft Docs
...
> [!NOTE]
> Application Dependency Monitor は、現在プライベート プレビューになっています。  ADM プライベート プレビューへのアクセスは、[https://aka.ms/getadm](https://aka.ms/getadm) から要求できます。
> 
