...
この脅威インテリジェンスを構築するために、OMS Security and Audit ソリューションでは Microsoft 内部の複数のソースから取得したデータを使用します。 OMS のセキュリティと監査では、このデータを活用して環境に対する潜在的な脅威を特定します。
...
> [!NOTE]
> これらのオプションすべての概要については、「[Operations Management Suite の Security and Audit ソリューションの概要](oms-security-getting-started.md)」を参照してください。
> 
> 
...
OMS の Security and Audit ソリューションの **[脅威インテリジェンス]** の情報を、これらのタスクに活用できます。 これらの **[脅威インテリジェンス]** オプションにアクセスするには、次の手順に従います。
