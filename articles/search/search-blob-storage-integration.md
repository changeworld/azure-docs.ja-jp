...
# Azure Search を使用した Blob Storage の検索
<a id="searching-blob-storage-with-azure-search" class="xliff"></a>
...
## エンタープライズ ドキュメント形式のコンテンツを開いて検索する
<a id="crack-open-and-search-through-the-content-of-enterprise-document-formats" class="xliff"></a>
...
## BLOB メタデータを検索する
<a id="search-through-your-blob-metadata" class="xliff"></a>
...
## イメージの検索
<a id="image-search" class="xliff"></a>
...
## JSON BLOB のインデックス作成および検索
<a id="index-and-search-through-json-blobs" class="xliff"></a>
