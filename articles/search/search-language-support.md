...
.NET 開発者の場合は、[Azure Cognitive Search .NET SDK](https://www.nuget.org/packages/Microsoft.Azure.Search) と [Analyzer](/dotnet/api/microsoft.azure.search.models.analyzer) プロパティを使用して言語アナライザーを構成できます。