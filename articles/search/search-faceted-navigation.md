...
## <a name="what-it-looks-like"></a>外観
 ![][1]
...
## <a name="check-for-data-quality"></a>データ品質のチェック
...
## <a name="best-practices-for-faceted-navigation"></a>ファセット ナビゲーションのベスト プラクティス
ベスト プラクティスを次にまとめます。
...
## <a name="tips-on-how-to-control-faceted-navigation"></a>ファセット ナビゲーションの制御方法に関するヒント
...
## <a name="facet-navigation-based-on-a-range-values"></a>範囲の値に基づくファセット ナビゲーション
...
### <a name="build-a-filter-for-facet-ranges"></a>ファセット範囲のフィルターの作成
...
## <a name="filtered-navigation-based-on-geopoints"></a>GeoPoints に基づいてフィルターされたナビゲーション
