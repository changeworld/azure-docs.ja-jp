...
ms.locfileid: "72793600"
---
# <a name="c-tutorial-crawl-an-azure-sql-database-using-azure-cognitive-search-indexers"></a>C# のチュートリアル: Azure Cognitive Search インデクサーを使用して Azure SQL データベースをクロールする
