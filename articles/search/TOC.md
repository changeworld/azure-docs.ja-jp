# 概要
## [Azure Search について](search-what-is-azure-search.md)

# クイック スタート

## [サービスを作成する](search-create-service-portal.md)
## ポータル
### [インデックスを作成する](search-create-index-portal.md)
### [データのインポート](search-import-data-portal.md)
### [Search エクスプローラー](search-explorer.md)
## .NET
### [インデックスを作成する](search-create-index-dotnet.md)
### [データのインポート](search-import-data-dotnet.md)
### [Search](search-query-dotnet.md)
## REST ()
### [インデックスを作成する](search-create-index-rest-api.md)
### [データのインポート](search-import-data-rest-api.md)
### [Search](search-query-rest-api.md)
### [REST クライアントを使用したテスト](search-fiddler.md)

# チュートリアル

## [1 - Azure SQL Database のインデックスを作成する](search-indexer-tutorial.md)
## [2 - Azure BLOB のインデックスを作成する](search-semi-structured-data.md)
## [3 - .NET でシノニムを追加する](search-synonyms-tutorial-sdk.md)
## [4 - ポータルのチュートリアル](search-get-started-portal.md)

# サンプル
## [Azure のコード サンプル](https://azure.microsoft.com/resources/samples/?service=search)
## [GitHub のサンプル](https://github.com/Azure-Samples/?utf8=%E2%9C%93&query=search)

# 概念
## [フルテキスト検索](search-lucene-query-architecture.md)
## [インデックス作成](search-what-is-data-import.md)
## [インデックスの定義](search-what-is-an-index.md)
## [言語分析](search-analyzers.md)
...
## セキュリティ
### [データと運用上のセキュリティ](search-security-overview.md)
### [ID フィルターを使用したセキュリティ保護](search-security-trimming-for-azure-search.md)
### [Active Directory を使用したセキュリティ保護](search-security-trimming-for-azure-search-with-aad.md)
...
##  検索
### [基本的なクエリの構築](search-query-overview.md)
...
### [スコアリング プロファイル](https://docs.microsoft.com/rest/api/searchservice/add-scoring-profiles-to-a-search-index)
### [検索候補](https://docs.microsoft.com/rest/api/searchservice/suggesters)
### [シノニム (プレビュー)](search-synonyms.md)
## フィルター
### [フィルターの概要](search-filters.md)
### [ファセット フィルター](search-filters-facets.md)
### [OData 式の構文](https://docs.microsoft.com/rest/api/searchservice/odata-expression-syntax-for-azure-search)

## 管理と分析
### [管理 (ポータル)](search-manage.md)
...
## パートナーとコミュニティ
### [Azure Search の MSDN フォーラム](https://social.msdn.microsoft.com/forums/azure/home?forum=AzureSearch)
