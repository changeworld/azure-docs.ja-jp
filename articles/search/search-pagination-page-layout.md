<properties 
	pageTitle="Azure Search でのページ検索結果の表示方法" 
	description="Azure Search の改ページ" 
	services="search" 
	documentationCenter="" 
	authors="HeidiSteen" 
	manager="mblythe" 
...
- [Azure Search: チュートリアル、ビデオ デモ、サンプル](http://msdn.microsoft.com/library/azure/dn818681.aspx)
