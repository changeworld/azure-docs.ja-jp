---
title: クイック スタート:ポータルで Azure Search サービスを作成する - Azure Search
...
ms.locfileid: "70883851"
---
# <a name="quickstart-create-an-azure-search-service-in-the-portal"></a>クイック スタート:ポータルでの Azure Search サービスの作成
