...
+ 一方、テーブル ストレージは、エンリッチされたドキュメントの物理的な射影に対応できます。 エンリッチされたドキュメントのスライスまたはレイヤーを作成し、特定の部分を含めるか除外することができます。 Power BI での分析の場合、Azure Table Storage内のテーブルが、さらなる視覚化と調査のためのデータ ソースになります。
