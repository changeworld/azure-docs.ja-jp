...
このチュートリアルは、前の[既存のアプリへのモバイル サービスの追加](/ja-jp/documentation/articles/mobile-services-windows-phone-get-started-data/)に関するチュートリアルの手順およびサンプル アプリケーションを基に作成されています。このため、このチュートリアルの前に、このチュートリアルを完了している必要があります。  
