...
- このトピックで紹介した設計の原則を取り入れるための前後関係を含めた例、「[テンプレート実装のベスト プラクティスに関するコンテキストの例](best-practices-resource-manager-examples.md)」を参照してください。
