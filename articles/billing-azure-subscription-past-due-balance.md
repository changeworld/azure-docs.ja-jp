...
**シナリオ 1**: 請求書モードの支払いを利用している場合、請求書の下部に記載されている場所に支払いを送付します。不明な点がある場合は、[Azure サポート](https://ms.portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade)にお問い合わせください。

**シナリオ 2**: 登録されているクレジット カードが拒否されたか期限切れのために支払われなかった場合は、サブスクリプションに別のクレジット カードまたは支払い方法を使用するか、ご利用の銀行に連絡して問題を解決してください。支払い方法を更新すると、その支払い方法に対するすべての未処理の請求が、直ちに自動的に決済されます。これには、Azure だけでなく、そのカードが使用されていた他のすべての Microsoft サービスに対する未処理の請求が含まれます。Azure の支払い方法を変更する手順については、[Azure サブスクリプションの支払いに使用するクレジット カードの変更方法](./billing-how-to-change-credit-card.md)に関するページを参照してください。クレジット カードを変更するには、アカウント管理者としてログオンする必要があります。
