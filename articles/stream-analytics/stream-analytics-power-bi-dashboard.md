...
## <a name="create-azure-stream-analytics-job"></a>Azure Stream Analytics ジョブの作成
...
> [!NOTE]
> Power BI アカウントにはこのデータセットとテーブルを明示的に作成する必要はありません。 Stream Analytics ジョブを開始すると自動的に作成され、Power BI への出力が開始されます。 ジョブ クエリで結果が返されない場合、データセットとテーブルは作成されません。
> 
> 
...
### <a name="powerbi-view-refresh"></a>PowerBI ビューの更新
