...
## <a name="what-can-i-use-stream-analytics-for"></a>Stream Analytics を使ってできること
...
次の図は、Stream Analytics パイプラインでデータが取り込まれ、分析されて、表示または処理のために送信されるようすを示したものです。 
