...
1.  オンラインの [Azure クラシック ポータル](http://manage.windowsazure.com)または [Azure ポータル](https://portal.azure.com/)にサインインします。
...
3.  Stream Analytics ジョブに必要な構成を指定します。
	...
	- Azure ポータルの **[リージョン]**、または Azure ポータルの **[場所]** を使用して、ジョブを実行する地理的な位置を指定します。
