---
title: Azure Stream Analytics の Data Lake Store 出力
...
1. Azure Portal で出力として Data Lake Store を選択すると、既存の Data Lake Store の使用を承認するか、Data Lake Store へのアクセス権を要求するように求められます。
...
<tr>
<td>エンコード</td>
<td>CSV または JSON 形式の場合、エンコードを指定する必要があります。 現時点でサポートされているエンコード形式は UTF-8 だけです。</td>
</tr>
<tr>
<td>区切り記号</td>
