...
- コンテンツに配信するストリーミング エンドポイントの 1 つ以上のオンデマンド ストリーミング ユニットを取得します。詳細については、[オンデマンド ストリーミング占有ユニットの規模変更方法](../media-services-manage-origins#scale_streaming_endpoints/)をご覧ください。
...
- コンテンツに配信するストリーミング エンドポイントの 1 つ以上のオンデマンド ストリーミング ユニットを取得します。詳細については、[オンデマンド ストリーミング占有ユニットの規模変更方法](../media-services-manage-origins#scale_streaming_endpoints/)をご覧ください。
- 「既定の AES クリア キー サービス ポリシー」または「既定 PlayReady ライセンス サービス ポリシー」を構成します。詳細については、[コンテンツ キー承認ポリシーを構成する](../media-services-portal-configure-content-key-auth-policy)をご覧ください。  
