<properties 
	pageTitle="Azure Media Services でメディア コンテンツを管理する方法" 
	description="Azure Media Services でメディア コンテンツを管理する方法について説明します。" 
...
# 方法:Azure Media Services でコンテンツを管理する 
...
Media Services で AES キーまたは PlayReady DRM を使用してアセットを暗号化するには、次の操作を実行します。
