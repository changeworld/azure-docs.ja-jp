...
## <a name="nsg"></a>AzureBastionSubnet 上で NSG を作成できない
...
## <a name="sshkey"></a>Azure Bastion に SSH キーを使用できません
...
## <a name="domain"></a>Windows ドメインに参加している仮想マシンにサインインできません
