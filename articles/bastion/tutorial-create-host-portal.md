...
ms.locfileid: "92078546"
---
# <a name="tutorial-create-an-azure-bastion-host-and-connect-to-a-windows-vm-through-a-browser"></a>チュートリアル:Azure Bastion ホストを作成し、ブラウザーを介して Windows VM に接続する
