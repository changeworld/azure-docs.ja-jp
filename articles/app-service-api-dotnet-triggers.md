...
たとえば、クライアント コードで [Twitter Connector API アプリ](app-service-logic-connector-twitter.md)が使用されていて、コードが特定の単語を含む新しいツイートに基づいて処理を実行する必要があるとします。この場合、このニーズを満たすために、プッシュ トリガーまたはポーリング トリガーを設定する場合があります。
