...
「[Windows 仮想マシンの可用性の管理](./virtual-machines/manage-availability.md?toc=%252fazure%252fvirtual-machines%252fwindows%252ftoc.json)」と「[Linux 仮想マシンの可用性管理](./virtual-machines/manage-availability.md?toc=%252fazure%252fvirtual-machines%252flinux%252ftoc.json)」をご覧ください。
...
「[Windows 仮想マシンの可用性の管理](./virtual-machines/manage-availability.md?toc=%252fazure%252fvirtual-machines%252fwindows%252ftoc.json)」または「[Linux 仮想マシンの可用性管理](./virtual-machines/manage-availability.md?toc=%252fazure%252fvirtual-machines%252flinux%252ftoc.json)」をご覧ください。  
...
「[仮想マシンの拡張機能とその機能について](./virtual-machines/extensions/features-windows.md?toc=%252fazure%252fvirtual-machines%252fwindows%252ftoc.json)」(Windows) と「[仮想マシンの拡張機能とその機能について](./virtual-machines/extensions/features-linux.md?toc=%252fazure%252fvirtual-machines%252flinux%252ftoc.json)」(Linux) をご覧ください。
