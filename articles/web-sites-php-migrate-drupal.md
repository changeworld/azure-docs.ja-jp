<properties urlDisplayName="Migrating Drupal to Azure Websites" pageTitle="Azure Websites への Drupal の移行 metaKeywords="Drupal, PHP, Web サイト" description="Drupal PHP サイトを Azure Websites に移行します。" metaCanonical="" services="web-sites" documentationCenter="PHP" title="Migrating Drupal to Azure Websites" authors="tomfitz" solutions="" manager="wpickett" editor="mollybos" />
