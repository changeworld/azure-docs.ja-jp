<properties pageTitle="データへのページングの追加 (JavaScript) - Azure Mobile Services" description="ページングを使用して、Mobile Services から Windows ストア JavaScript アプリに返されるデータの量を管理する方法について説明します。" services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
