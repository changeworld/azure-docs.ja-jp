...
5. **[個人設定]** メニューの左側で、**[個人用アクセス トークン]** を選択します。
6. **[新しいトークンの生成]** を選択します。
7. **新しい個人用アクセス トークン**ページで、**トークンの説明**を入力し、**[範囲の選択]** で既定の項目をそのまま使用します。次に **[Generate Token]** を選択します。
...
3. クローン URL を表示するには、プロジェクト **[コード]** ページで、**[クローン]** を選択します。
...
5. ラボの **[構成]** ブレードで、**[アーティファクト リポジトリ]** を選択します。
6. **[アーティファクト リポジトリ]** ブレードで、**[+ 追加]** を選択します。
