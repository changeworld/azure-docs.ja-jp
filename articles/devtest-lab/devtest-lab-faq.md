...
## <a name="ci/cd-integration-&-automation"></a>CI/CD 統合と自動化 
...
### <a name="what-if-my-question-isn't-answered-here?"></a>ここに質問の答えがない場合はどうすればいいですか。
...
### <a name="does-azure-devtest-labs-integrate-with-my-ci/cd-toolchain?"></a>Azure DevTest Labs は、CI/CD ツールチェーンと統合されますか。 
...
### <a name="why-can't-i-see-certain-vms-in-the-azure-virtual-machines-blade-that-i-see-within-azure-devtest-labs?"></a>Azure DevTest Labs で表示される特定の VM が Azure 仮想マシン ブレードに表示されないのはなぜですか。
...
1. [カスタム イメージを作成](devtest-lab-create-template.md) します。 
...
### <a name="why-isn't-my-existing-virtual-network-saving-properly?"></a>既存の仮想ネットワークが正しく保存されないのはなぜですか。  
