...
5. ラボの **[構成]** ブレードで、**[カスタム イメージ]** を選択します。
6. **[カスタム イメージ]** ブレードで、**[+ カスタム イメージ]** を選択します。
...
2. 次のブレードには、VHD ファイルを Azure サブスクリプションにアップロードする PowerShell スクリプトの変更と実行の手順が表示されます。**注:** VHD ファイルのサイズと接続速度によっては、このプロセスに時間がかかる可能性があります。
