...
1. [Azure Portal](http://go.microsoft.com/fwlink/p/?LinkID=525040) の **Marketplace イメージ**の一覧で、ユーザーがアクセスできるようにしたいが条件に同意していないライセンスされたイメージを特定します。 たとえば、**[同意した条件]** または **[確認が必要な条件]** のいずれかの状態を示すデータ サイエンス仮想マシンが表示される可能性があります。
