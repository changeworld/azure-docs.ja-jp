...
**注:** Web ジョブ SDK を使用しないアプリケーションでキュー メッセージを作成する場合は、必ず [BrokeredMessage.ContentType](http://msdn.microsoft.com/ja-jp/library/microsoft.servicebus.messaging.brokeredmessage.contenttype.aspx) を "text/plain" に設定します。
