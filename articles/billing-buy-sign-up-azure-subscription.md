...
Azure では、お客様のビジネス ニーズに合わせ、初めての方でもご利用いただける様々なプランをご用意しています。 [Azure のプラン](https://azure.microsoft.com/support/legal/offer-details/)についてのページにアクセスして、現在の全プランの一覧のほか、その内容、特典、および国/リージョン別の提供状況など、各プランの詳細をご覧ください。

## <a name="azure-offers---benefits-and-limits"></a>Azure プラン - 特典と制限
一般的なプランには次のようなものがあります。
...
| MPN (Microsoft Partner Network) - メンバーは、毎月無料で Azure クレジットを受領 |• [パートナー向けの Azure の特典](https://azure.microsoft.com/offers/ms-azr-0025p/)</br>• [パートナーとして登録](http://go.microsoft.com/fwlink/?linkid=309258&clcid=0x409)または [Microsoft Action Pack をサブスクライブ](http://go.microsoft.com/fwlink/?linkid=525768&clcid=0x409)</br>• Azure クレジットの使用 - [MPN ポータル](https://partner.microsoft.com)にアクセスして、利用資格を確認し、[ソフトウェア キーと特典] の手順に従います。 資格を確認できない場合は、 [MPN サポート](https://partner.microsoft.com/Support/)にお問い合わせください。 |
