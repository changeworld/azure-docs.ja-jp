...
このクイックスタートで使用されるテンプレートは [Azure クイックスタート テンプレート](https://azure.microsoft.com/resources/templates/)からのものです。 [1 つ目のテンプレート](https://azure.microsoft.com/resources/templates/101-app-configuration-store/)は、App Configuration ストアを作成するものです。
