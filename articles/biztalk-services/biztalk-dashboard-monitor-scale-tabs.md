...
<br/><br/>
BizTalk サービス ポータルに関する詳細情報については、<a HREF="http://go.microsoft.com/fwlink/p/?LinkID=303653">BizTalk サービス ポータルにおける EDI メッセージングのコンポーネントの構成に関するページ</a>を参照してください。</td>
</tr>
...
<td>BizTalk サービスで使用される SSL 証明書を別のものに更新できます。<a HREF="http://go.microsoft.com/fwlink/p/?LinkID=302280">BizTalk サービスを作成する</a>ときに自己署名 SSL 証明書が自動的に作成されます。</td>
</tr>
<tr>
