...
Azure Location Based Services については、次のビデオで紹介されています。
...
## <a name="unsupported-regions"></a>サポートされていない地域
この API は、以下の国では現在利用できません。 現在の IP アドレスをチェックして、ご自身の IP アドレスの場所が、以下のサポートされていない国に含まれていないことを確認してください。
