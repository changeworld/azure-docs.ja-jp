...
5. クエリ文字列に以下の値を追加して、**[送信]** をクリックします。
    ```
        ,countrySet=US
    ```
    >[!NOTE] 
    >クエリ文字列の追加の URI パラメーターは、必ずコンマ区切りにしてください。
...
4. クエリ文字列に以下の値を追加して、**[送信]** をクリックします。
    ```
        ,number
    ```
...
6. クエリ文字列に以下の値を追加して、**[送信]** をクリックします。
    ```
        ,returnSpeedLimit
    ```
...
7. クエリ文字列に以下の値を追加して、**[送信]** をクリックします。
    ```
        ,returnRoadUse
    ```
...
8. クエリ文字列に以下の値を追加して、**[送信]** をクリックします。
    ```
        ,roadUse
    ```
