...
| サブネットが検出された | 新しいサブネットが検出されました。 | **Learn**<br />サブネットを自動的に追加します。<br />**サブネット構成を開く**<br />見つからないサブネット情報をすべて追加します。<br />**無視**<br />通知を削除します。 |
| デバイスの種類の変更が検出された | 新しいデバイスの種類がデバイスに関連付けられています。 | **{…} として設定**<br />新しい種類をデバイスに関連付けます。<br />**無視**<br />通知を削除します。 |
