...
1. FortiGate 転送ルールを構成するには、次のパラメーターを設定します。
    ...
    | **受信インターフェイス** | 受信インターフェイス ポートを入力します。 |
    | **送信インターフェイス** | 発信インターフェイス ポートを入力します。 |
...
このチュートリアルでは、Fortinet 統合の使用を開始する方法を学習しました。 次に、[Palo Alto の統合](./tutorial-palo-alto.md)について学習します。
