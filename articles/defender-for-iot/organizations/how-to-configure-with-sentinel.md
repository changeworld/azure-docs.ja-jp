...
- Azure Sentinel の使用方法については、[クイックスタート: Azure Sentinel の概要](/azure/defender-for-iot/organizations/articles/sentinel/get-visibility.md)に関するページを参照してください。