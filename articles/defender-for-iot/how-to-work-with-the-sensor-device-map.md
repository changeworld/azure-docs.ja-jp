...
| ネットワーク | ワイヤレス アクセス ポイント <br />ルーター <br />スイッチ <br />Firewall <br />VPN Gateway <br />NTP サーバー <br />Wifi Pineapple <br />物理的な場所 <br />I/O アダプター <br /> プロトコル コンバーター |
...
特定の状況で、デバイスをマージする必要がある場合があります。 これは、1 つの一意のデバイスである別々のネットワーク エンティティがセンサーによって検出された場合に必要になることがあります。 たとえば、オブジェクトに適用された
