...
詳細については、[Microsoft Azure でログ記録とトレースを制御する方法](https://msdn.microsoft.com/magazine/ff714589.aspx)と [Microsoft Azure Diagnostics (第 4 部: カスタム ログ コンポーネントと Azure Diagnostics 1.3 の変更点)](http://justazure.com/microsoft-azure-diagnostics-part-4-custom-logging-components-azure-diagnostics-1-3-changes/) に関するページを参照してください。
