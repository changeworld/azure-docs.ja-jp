<properties urlDisplayName="Get Started with Media Services" pageTitle="Media Services の使用 - Azure" metaKeywords="Azure media services" description="Azure で Media Services を使用する方法を紹介します。" metaCanonical="" services="media-services" documentationCenter="" title="Get started with Media Services" authors="juliako" solutions="" manager="dwrede" editor="" />
