---
title: Java での粗い再局在化
description: Java で粗い再局在化を使用してアンカーを作成して配置する方法の詳細な説明。
author: bucurb
manager: dacoghl
...
ms.locfileid: "76545216"
---
# <a name="how-to-create-and-locate-anchors-using-coarse-relocalization-in-java"></a>Java で粗い再局在化を使用してアンカーを作成して配置する方法
