---
title: Objective-C でデバイス上のセンサーを使用してアンカーを作成して配置する方法 | Microsoft Docs
description: Objective-C でデバイス上のセンサーを使用してアンカーを作成して配置する方法の詳細な説明。
author: bucurb
manager: dacoghl
...
ms.locfileid: "74093108"
---
# <a name="how-to-create-and-locate-anchors-using-on-device-sensors-in-objective-c"></a>Objective-C でデバイス上のセンサーを使用してアンカーを作成して配置する方法
