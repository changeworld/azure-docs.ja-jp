...
- Azure IoT エクスプローラー 0.14.x (最新バージョンのアプリケーションをダウンロードしてインストールしてください)

    詳細については、「[Azure IoT エクスプローラーをインストールして使用する](howto-use-iot-explorer.md)」を参照してください。

- VS Code 拡張機能 1.0.0。

    詳細については、「[ライフサイクルとツール](concepts-modeling-guide.md#lifecycle-and-tools)」を参照してください。
