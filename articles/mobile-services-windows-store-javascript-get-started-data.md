...
* Visual Studio 2013。Windows ストア アプリをモバイル サービスに簡単に接続できる機能を備えています。Visual Studio 2012 を使用して同じ基本手順を実行するには、<a href="/ja-jp/documentation/articles/mobile-services-windows-store-javascript-get-started-data-vs2012">Visual Studio 2012 を使用したモバイル サービスでのデータの使用</a>に関するトピックの手順に従ってください。 
...
<ol start="7">
<li><p>ソリューション エクスプローラーで、**[サービス]**、**[モバイル サービス]**、**&lt;your_service&gt;** の各フォルダーを順に展開します。service.js スクリプト ファイルを開き、新しいグローバル変数が次の例のとおりであることを確認します。</p> 
