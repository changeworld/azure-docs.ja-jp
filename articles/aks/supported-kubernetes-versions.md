...
* 新しい**マイナー** バージョンの Kubernetes の場合
  ...
  * Azure サポートでは、お客様は、公示日から **30 日**の間、サポートされているマイナー バージョンのリリースにアップグレードすることができます。 30 日を過ぎた場合、引き続きサポートを受けるには、マイナー バージョンを更新する必要があります。
* 新しい**修正プログラム**のバージョンの Kubernetes の場合
  * すべてのユーザーには、リリースされている修正プログラムの新しいバージョンが通知され、最新の修正プログラムのリリースにアップグレードするよう通知されます。
  * Azure サポートでは、お客様は、以前のパッチ バージョンを削除してから **30 日**の間に、サポートされているパッチ リリースにアップグレードすることができます。 30 日を過ぎた場合、引き続きサポートを受けるには、パッチ バージョンを更新する必要があります。
...
クラスターに 3 つ以上のマイナー バージョンにわたってサポートが欠けており、セキュリティ リスクが生じることがわかっている場合、Azure はクラスターを事前にアップグレードするようにお客様に連絡します。 お客様が措置を講じない場合、Azure は、お客様に代わってクラスターを強制的にアップグレードする権利を保持します。
