...
このクイック スタートで使用されるテンプレートは、[Azure Kubernetes Service クラスターをデプロイする](https://azure.microsoft.com/resources/templates/101-aks/)ためのものです。 他の AKS サンプルについては、[AKS クイック スタートのテンプレート][aks-quickstart-templates]のサイトを参照してください。
