...
**[Create a resource]\(リソースの作成\)** を選択し、**[Kubernetes]** を検索して、**[Azure Kubernetes Service]** > **[作成]** を選択します。
...
少し待つと、AKS クラスターがデプロイされ、使用できるようになります。 AKS クラスター リソース グループを参照し、AKS リソースを選択して、AKS クラスター ダッシュボードを表示する必要があります。
