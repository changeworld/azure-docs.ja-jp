<properties 
	pageTitle="Traffic Manager を利用する Azure Website の Directnic ドメイン名の構成" 
	description="Traffic Manager を使用する Azure Web サイトを、Directnic に登録したドメイン名を使用するように構成する方法について説明します。" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
