...
1 つの Azure リソース マネージャー テンプレート内から、別のテンプレートにリンクして、デプロイを対象となる、目的に特化した一連のテンプレートに分解することができます。アプリケーションを複数のコード クラスに分解する場合と同様に、分解すると、テスト、再利用、読みやすさの面でメリットがあります。
