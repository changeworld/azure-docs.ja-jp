...
*[Package Explorer]* ウィンドウで、プロジェクトに対応するノードを展開します。プロジェクトに *src* という名前のフォルダーが含まれていることを確認します。このフォルダーには、JUnit テストのソース コードが含まれています。以下の指示に従い、プロジェクトをコンパイルし、デプロイできます。
