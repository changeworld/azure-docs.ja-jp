...
イメージ ギャラリーからのデプロイについて、また VHD の作成についての詳細は、次をご覧ください。  Azure Government 使用時におけるエンドポイントのプログラム的な相違点の詳細について、[Azure Government 開発者向けガイド](azure-government-developer-guide.md)を参照してください。
