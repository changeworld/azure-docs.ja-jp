...
<div class="dev-center-tutorial-subselector"><a href="/ja-jp/documentation/articles/mobile-services-html-authorize-users-in-scripts/"  title="JavaScript バックエンド" class="current">JavaScript バックエンド</a></div>
...
2.  そのアプリケーションで、**[Enter new task]** にテキストを入力して **[追加]** をクリックします。
...
3.  [管理ポータル][Azure の管理ポータル]の **TodoItem** テーブルに戻り、**[参照]** をクリックして、新しく追加された項目に対してユーザー ID の値が設定されているかどうかを確認します。
...
<!-- URLs. -->
  ...
  [JavaScript バックエンド]: /ja-jp/documentation/articles/mobile-services-html-authorize-users-in-scripts/ "JavaScript バックエンド"
