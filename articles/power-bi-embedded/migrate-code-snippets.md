---
title: Power BI ワークスペース コレクションからコンテツを移行するためのコード スニペット | Microsoft Docs
description: コンテンツの移行に必要な基本処理のコード スニペットを紹介します。
...
ms.locfileid: "31407716"
---
# <a name="code-snippets-for-migrating-content-from-power-bi-workspace-collections"></a>Power BI ワークスペース コレクションからコンテツを移行するためのコード スニペット

この記事では、コンテンツの移行に必要な基本処理のコード スニペットを紹介します。 特定のレポートの種類に関連するフローについては、「[How to migrate Power BI Embedded workspace collection content to Power BI](migrate-from-power-bi-workspace-collections.md#content-migration)」(Power BI に Power BI Embedded ワークスペース コレクション コンテンツを移行する方法) を参照してください。

**移行ツール**を使用すると、Power BI ワークスペース コレクションから Power BI Embedded にコンテツを簡単にコピーすることができます。 これは特に、コンテンツが大量にある場合に便利です。 詳細については、「[Power BI Embedded migration tool](migrate-tool.md)」(Power BI Embedded 移行ツール) を参照してください。
...
## <a name="export-report-from-a-power-bi-workspace-collection-workspace"></a>Power BI ワークスペース コレクションからレポートをエクスポートする
...
## <a name="import-report-to-power-bi-embedded"></a>Power BI Embedded にレポートをインポートする
...
## <a name="extract-directquery-connection-string-from-power-bi-workspace-collections"></a>Power BI ワークスペース コレクションから DirectQuery 接続文字列を抽出する

これは、Power BI Embedded に移行した後に PBIX を更新する場合の例です。
...
## <a name="update-directquery-connection-string-in-power-bi-embedded"></a>Power BI Embedded で DirectQuery 接続文字列を更新する
...
## <a name="set-directquery-credentials-in-power-bi-embedded"></a>Power BI Embedded で DirectQuery 資格情報を設定する
...
このスニペットでは、プッシュ可能なデータセットが既に Power BI 内のアプリのワークスペースにあることを前提としています。 プッシュ API の詳細については、「[Power BI データセットにデータをプッシュする](https://powerbi.microsoft.com/documentation/powerbi-developer-walkthrough-push-data/)」を参照してください。
...
移行プロセスの詳細については、「[How to migrate Power BI Workspace Collection content to Power BI Embedded](migrate-from-power-bi-workspace-collections.md)」(Power BI Embedded に Power BI ワークスペース コレクション コンテンツを移行する方法) を参照してください。
