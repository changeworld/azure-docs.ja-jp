<properties 
	...
	description="Linux 用の VMAccess 拡張機能を使用して、パスワード、SSH キー、および SSH 構成をリセットする方法" 
...
[RDP または SSH を使用する Azure の仮想マシンへの接続]: http://msdn.microsoft.com/library/azure/dn535788.aspx
