...
# Continuous delivery to Azure using Visual Studio Online (Visual Studio Online を使用した Azure への継続的な配信)
  ...
  Visual Studio Online チーム プロジェクトを、自動的にビルドして Azure の Web アプリまたはクラウド サービスにデプロイするように構成できます*内部設置型* Team Foundation Server を使用した継続的なビルドおよびデプロイ システムのセットアップ方法については、「[Continuous Delivery for Cloud Applications in Azure (Azure でのクラウド サービスの継続的な配信)](cloud-services/cloud-services-dotnet-continuous-delivery.md)」を参照してください。
