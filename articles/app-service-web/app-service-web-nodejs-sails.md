...
## <a name="step-1-create-a-sailsjs-app-locally"></a>手順 1: Sails.js アプリをローカルで作成する
...
詳細については、「 [iisnode から stdout ログと stderr ログを取得する](app-service-web-nodejs-get-started.md#get-stdout-and-stderr-logs-from-iisnode)」をご覧ください。
