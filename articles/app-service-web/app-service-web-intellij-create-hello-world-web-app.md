...
---
# <a name="create-a-hello-world-web-app-for-azure-in-intellij"></a>IntelliJ で Azure 用の Hello World Web アプリを作成する
...
3. このチュートリアルでは、プロジェクトに **Java-Web-App-On-Azure** という名前を付け、**[Finish (完了)]** をクリックします。
    ...
    ![[新しいプロジェクト] ダイアログ][04]
4. IntelliJ の [Project Explorer (プロジェクト エクスプローラー)] ビューで、**[Java-Web-App-On-Azure]**、**[Web]** の順に展開し、**index.jsp** をダブルクリックします。
   
    ![インデックスを開くページ][05]
5. index.jsp ファイルが IntelliJ で開いたら、"**Hello World!**" を動的に表示するためのテキストを 既存の `<body>` 要素に追加します。 更新された `<body>` コンテンツは、次のようになります。
...
## <a name="starting-or-stopping-an-existing-web-app"></a>既存の Web アプリを起動または停止する
