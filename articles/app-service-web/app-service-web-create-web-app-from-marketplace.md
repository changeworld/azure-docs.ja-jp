...
[!INCLUDE [タブ](../../includes/app-service-web-get-started-nav-tabs.md)]
...
7. **[WordPress]** ブレードで、法律条項に同意し、**[作成]** をクリックします。
...
5. WordPress の **[ようこそ]** ページで、WordPress に必要な構成情報を入力し、**[WordPress のインストール]** をクリックします。
