...
* [.NET 管理 API](#api)
* [クロスプラットフォーム コマンド ライン (xplat-cli)](#cli)
...
* [Deploying to Web Apps with GitHub using Kudu (Kudu を使用した GitHub による Web アプリへのデプロイ)](/documentation/videos/deploying-to-azure-from-github/)。Scott Hanselman と David Ebbo によるビデオ。GitHub から Web アプリへ直接 Web アプリをデプロイする方法を示します。
...
* [コマンド ライン ツール](/downloads/#cmd-line-tools)。コマンド ライン ツールに関する情報を掲載している Azure.com のポータル ページです。
