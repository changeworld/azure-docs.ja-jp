...
- Azure サブスクリプションで購入したすべてのカスタム ドメインは、そのサブスクリプションの*あらゆる* App Service アプリの **[カスタム ドメインと SSL]** ブレードで管理できます。
...
**[カスタム ドメインと SSL]** ブレード内からカスタム ドメインを購入したが、**[管理対象ドメイン]** にカスタム ドメインが表示されない場合、次を確認してください。
