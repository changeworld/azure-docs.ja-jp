...
6. **[プロファイル]** ボックスの一覧から、「[ASP.NET Web アプリケーションを Azure Web サイトに展開する][GetStarted]」で使用したものと同じプロファイルを選択します。
...
3. **[Contact]** ページが表示されているブラウザー ウィンドウで、**[Home]**、**[About]**、**[Contact]** を順にクリックします。
...
4. Web アプリの [[Azure ポータル]](https://portal.azure.com) の **[設定]** ブレードで **[デプロイ資格情報]** をクリックし、新しいユーザー名とパスワードを入力します。
