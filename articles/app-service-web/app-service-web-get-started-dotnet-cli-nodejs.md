---
title: "初めての ASP.NET Web アプリを Azure に&5; 分でデプロイする | Microsoft Docs"
...
---
# <a name="deploy-your-first-aspnet-web-app-to-azure-in-five-minutes"></a>初めての ASP.NET Web アプリを Azure に&5; 分でデプロイする
...
4. 作業ディレクトリに移動 (`CD`) し、サンプル ASP.NET アプリを複製します。
