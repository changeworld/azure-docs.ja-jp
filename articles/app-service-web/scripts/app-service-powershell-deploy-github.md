...
必要に応じて、[Azure PowerShell ガイド](https://docs.microsoft.com/powershell/azureps-cmdlets-docs/)の手順に従って Azure PowerShell をインストールします。 また、Web アプリのコードを含む GitHub リポジトリへのリンクも必要です。
