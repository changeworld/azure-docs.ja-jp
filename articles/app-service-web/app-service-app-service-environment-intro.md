...
フロントエンド プールには、SSL 端点と、App Service 環境内でのアプリ要求の自動負荷分散を担当するコンピューティング リソースが含まれます。
...
App Service 環境のネットワーク アーキテクチャの概要については、「[App Service 環境のネットワーク アーキテクチャの概要][NetworkArchitectureOverview]」をご覧ください。
