---
title: Azure App Service のアプリの監視
...
> [!NOTE]
> App Service プランのメトリックは、**Basic** SKU、**Standard** SKU、**Premium** SKU のプランでのみ利用できます。
> 
> 
