...
Key Vault を Azure Private Link と統合する方法: https://docs.microsoft.com/azure/key-vault/private-link-service
...
Azure portal を使用した Azure DDoS Protection Standard の管理: https://docs.microsoft.com/azure/virtual-network/manage-ddos-protection Azure Security Center での Azure サービス レイヤーの脅威検出: https://docs.microsoft.com/azure/security-center/security-center-alerts-service-layer
...
Key Vault を Azure Private Link と統合する: https://docs.microsoft.com/azure/key-vault/private-link-service
...
Azure Key Vault 用 Advanced Threat Protection を設定する: https://docs.microsoft.com/azure/security-center/advanced-threat-protection-key-vault
...
クイック スタート:Azure Sentinel をオンボードする: https://docs.microsoft.com/azure/sentinel/quickstart-onboard
...
### <a name="46-use-an-active-discovery-tool-to-identify-sensitive-data"></a>4.6:アクティブ検出ツールを使用して機密データを特定する
...
Azure Key Vault のセキュリティ コントロール: https://docs.microsoft.com/azure/key-vault/key-vault-security-controls
...
Azure Monitor の Azure Key Vault Analytics ソリューション: https://docs.microsoft.com/azure/azure-monitor/insights/azure-key-vault
...
現在のアカウントでアクセスできるサブスクリプションを取得する: https://docs.microsoft.com/powershell/module/az.accounts/get-azsubscription?view=azps-3.0.0

Azure リソースのロールベースのアクセス制御 (RBAC) の概要 https://docs.microsoft.com/azure/role-based-access-control/overview
