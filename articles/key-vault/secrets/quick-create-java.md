...
シークレットが設定されたことは、[az keyvault secret show](/cli/azure/keyvault/secret?#az_keyvault_secret_show) コマンドを使用して確認できます。
...
シークレットが削除されたことを確認するには、[az keyvault secret show](/cli/azure/keyvault/secret?#az_keyvault_secret_show) コマンドを使用します。
