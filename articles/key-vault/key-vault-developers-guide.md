...
# <a name="azure-key-vault-developer's-guide"></a>Azure Key Vault 開発者ガイド
...
- [Azure Resource Manager テンプレートを使用した Key Vault の作成とシークレットの追加](../resource-manager-template-keyvault.md)
