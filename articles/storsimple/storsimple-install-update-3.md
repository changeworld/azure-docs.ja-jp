...
Update 3 には、デバイス ソフトウェア、LSI ドライバーとファームウェア、Storport および Spaceport 更新プログラムが含まれています。 Update 2 またはそれ以前のバージョンから更新する場合は、iSCSI と WMI、場合によってはディスク ファームウェアの更新プログラムも適用する必要があります。 デバイス ソフトウェア、WMI、iSCSI、LSI ドライバー、Spaceport、Storport の修正プログラムは中断を伴わない更新プログラムです。 これらの更新プログラムは Azure クラシック ポータルを使用して適用できます。 ディスク ファームウェアの更新プログラムは中断を伴う更新プログラムであるため、デバイスの Windows PowerShell インターフェイスでのみ適用できます。
...
> [!NOTE]
> Update 2 以降 (Update 2.1 を含む) を適用する場合、Microsoft はデバイスから追加の診断情報を取得することができます。 このデータは、問題のある StorSimple デバイスの特定と、問題の診断に役立ちます。 Update 2 以降を受け入れると、このプロアクティブ サポートの提供に同意することになります。


[!INCLUDE [storsimple-install-update2-via-portal](../../includes/storsimple-install-update2-via-portal.md)]

デバイスで **StorSimple 8000 Series Update 3 (6.3.9600.17759)**が実行されていることを確認します。 **[最終更新日]** が変更されます。 
   - Update 2 以前のバージョンから更新している場合は、メンテナンス モードの更新プログラムが利用できることが示されます。 このメッセージは、更新プログラムをインストールしてから最大 24 時間表示され続ける可能性があります。
     メンテナンス モードの更新プログラムは、中断を伴う更新プログラムであり、その結果、デバイスにダウンタイムが発生します。 これらの更新プログラムは、デバイスの Windows PowerShell インターフェイスのみを使用して適用できます。 Update 1.2 を実行している場合は、ディスクのファームウェアが既に最新になっている可能性があり、メンテナンス モードの更新プログラムをインストールする必要はありません。
