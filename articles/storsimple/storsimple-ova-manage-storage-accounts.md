...
3. **[ストレージ アカウントの追加/編集]** ダイアログ ボックスで、次の操作を行います。
   ...
   3. ストレージ アカウント アクセス キーを再生成できます。詳細については、[ストレージ アカウント キーの再生成](../storage/storage-create-storage-account.md#manage-your-storage-access-keys)に関するセクションをご覧ください。新しいストレージ アカウント キーを指定します。Azure ストレージ アカウントの場合、これはプライマリ アクセス キーです。 
