...
次の表に、StorSimple デバイスの各モデルの消費電力データを示します。
 
| 条件 | 240 V AC | 110 V AC |
| ---------- | -------- | -------- |
| ファンは低速、ドライブはアイドル状態 | 1.45 A  0.31 kW | 3.19 A  0.34 kW |
| ファンは低速、ドライブはアクセス中 | 1.54 A  0.33 kW | 3.27 A  0.36 kW |
| ファンは高速、ドライブはアイドル状態、2 台の PSU が稼働 | 2.14 A  0.49 kW | 4.99 A  0.54 kW |
| ファンは高速、ドライブはアイドル状態、PSU は 1 台が稼働し 1 台がアイドル状態 | 2.05 A  0.48 kW | 4.58 A  0.5 kW |
| ファンは高速、ドライブはアクセス中、2 台の PSU が稼働 | 2.26 A  0.51 kW | 4.95 A  0.54 kW |
| ファンは高速、ドライブはアクセス中、PSU は 1 台が稼働し 1 台がアイドル状態 | 2.14 A  0.49 kW | 4.81 A  0.53 kW |
...
10 GbE ネットワーク インターフェイス DATA 2 および DATA3 の場合、サポートされるネットワーク ケーブルおよびモジュールのリストは次のリンクで入手できます。[http://www.mellanox.com/page/cables?mtag=cable_overview](http://www.mellanox.com/page/cables?mtag=cable_overview)
