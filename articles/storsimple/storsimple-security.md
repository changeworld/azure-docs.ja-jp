...
CHAP の詳細と構成方法については、「[StorSimple デバイスの CHAP の構成](storsimple-configure-chap.md)」をご覧ください。
...
- 冗長性を実装するには、マルチパス (MPIO) を使用して、iSCSI SAN の単一障害点を回避します。詳細な手順については、「[StorSimple デバイスの MPIO の構成](storsimple-configure-mpio-windows-server.md)」をご覧ください。
