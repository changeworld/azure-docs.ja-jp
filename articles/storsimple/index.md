...
オンプレミスのデバイスと Azure クラウド ストレージの間のストレージ タスクを管理する統合ストレージ ソリューション、Azure StorSimple の使用方法について説明します。 チュートリアルなどのドキュメントでは、ストレージ管理、場所に依存しないバックアップ、ディザスター リカバリーを設定する方法を紹介します。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>StorSimple を Azure File Sync および Data Box Edge と比較する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>StorSimple 8000 シリーズのリリース ノート</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>StorSimple Virtual Array のリリース ノート</h3>
                    </div>
                </div>
            </div>
        </div>
