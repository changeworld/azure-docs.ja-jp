...
* **ディスク障害のアラート** - このリリースでは、ディスク障害の兆候をユーザーに知らせるアラートが新しく追加されました。 このアラートが発生した場合は、Microsoft サポートに連絡して、交換ディスクを発送してもらってください。 詳しくは、[StorSimple デバイスでのハードウェアのアラート](storsimple-manage-alerts.md#hardware-alerts)に関するページをご覧ください。
