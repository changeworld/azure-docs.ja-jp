...
1. Azure クラシック ポータルで、**[デバイス]**、**[メンテナンス]**、**[ハードウェアの状態]** の順に移動します。**[共有コンポーネント]** で、バッテリの状態を確認します。
...
4. 交換が完了した後、Azure クラシック ポータルにアクセスして **[デバイス]**、**[メンテナンス]**、**[ハードウェアの状態]** の順に移動し、バッテリの状態を調べて取り付けが成功したことを確認します。LED が緑ならバッテリは正常です。
