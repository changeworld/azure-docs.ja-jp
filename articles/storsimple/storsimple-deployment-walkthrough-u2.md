<properties 
   pageTitle="StorSimple デバイス (Update 2) をデプロイする | Microsoft Azure"
...
> [AZURE.IMPORTANT] StorSimple Manager は、シン ボリュームと完全にプロビジョニングされたボリュームの両方を作成できます。ただし、部分的にプロビジョニングされたボリュームは作成できません。
