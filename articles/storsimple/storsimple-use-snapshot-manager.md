...
* MMC のユーザー補助機能については、「 [MMC 3.0 のユーザー補助機能](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc766075(v=ws.11))
...
| スナップインの追加と削除 |スナップインを追加または削除したり、**スコープ** ウィンドウのノードを整理したりするには、 **[スナップインの追加と削除]** をクリックします。 詳細については、「 [MMC 3.0 でスナップインと拡張機能を追加、削除、および整理する](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc722035(v=ws.11))」をご覧ください。 |
| Options |コンソール アイコンの変更、ユーザー アクセス モードとアクセス許可の指定、空きディスク領域を増やすためのコンソール ファイルの削除などを行うには、 **[オプション]** をクリックします。 |
