...
- ボリューム コンテナーごとの削除ジョブ (フェールオーバー) は、**[ジョブ]** ページで確認できます。ボリューム コンテナーの削除が完了するまでの時間は、コンテナー内のデータ量によって異なります。テスト フェールオーバー/フェールバックを計画している場合は、データの少ない (GB) ボリューム コンテナーをテストすることをお勧めします。

- すべての削除ジョブが完了したら、フェールバックを試行できます。
