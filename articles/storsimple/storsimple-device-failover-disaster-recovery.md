<properties 
   pageTitle="StorSimple デバイスをフェールオーバーする方法"
...
1. 表示されるウィザードの **[フェールオーバーするボリューム コンテナーを選択する]** で、次の手順を実行します。
	...
	1. ボリューム コンテナーの一覧から、フェールオーバーするボリューム コンテナーを選択します。
		...
		>[AZURE.NOTE]**関連するクラウド スナップショットのボリューム コンテナーとオフライン ボリュームのみが表示されます。**
...
1. 表示されるウィザードの **[フェールオーバーするボリューム コンテナーを選択する]** で、次の手順を実行します。
	...
	>[AZURE.NOTE]**物理デバイスが Update 1 を実行する場合、Update 1 を実行している仮想デバイスのみにフェールオーバーできます。ターゲットの仮想デバイスで、古いソフトウェアのバージョンを実行する場合、ターゲット デバイスのソフトウェアを更新する必要がある旨のエラーが表示されます。**
...
- [StorSimple デバイスの非アクティブ化](https://msdn.microsoft.com/library/azure/dn772379.aspx#deactivate)
- [StorSimple デバイスの削除](https://msdn.microsoft.com/library/azure/dn772379.aspx#delete)
