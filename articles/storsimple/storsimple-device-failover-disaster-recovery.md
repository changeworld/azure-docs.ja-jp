...
---
# <a name="failover-and-disaster-recovery-for-your-storsimple-device"></a>StorSimple デバイスのフェールオーバーと障害復旧
...
## <a name="fail-over-to-another-physical-device"></a>別の物理デバイスにフェールオーバーする
