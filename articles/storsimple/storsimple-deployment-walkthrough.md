...
これらのデプロイメントのチュートリアルは、StorSimple 8000 シリーズ リリース バージョン、StorSimple 8000 シリーズ Update 0.1、StorSimple 8000 シリーズ Update 0.2、StorSimple 8000 Series Update 0.3 に適用されます。
...
| 2 | ネットワーク設定 <ol><li>ネットワーク インターフェイス、4 x 1 GbE、2 x 10 GbE</li><li>固定コントローラーの IP</li><li>サブネット マスク</li><li>ゲートウェイ</li></ol> | 必要な IP アドレスの合計: 8 <ol><li>有効なネットワーク インターフェイスごとに 1 つ、計 6 </li><li>コントローラーごとに 1 つ、計 2 </li><li>IP アドレスごとに 1 つ</li><li>デバイスごとに 1 つ</li></ol> | |
