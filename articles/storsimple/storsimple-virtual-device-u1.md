...
- **[仮想デバイスの作成] ダイアログ ボックス**で、次のように指定します。
	...
	b.**[バージョン]** -仮想デバイスのバージョンを選択します。このサービスに更新プログラム 1 の物理デバイスしか登録されていない場合、このオプションは表示されません。このフィールドが表示されるのは、更新プログラム 1 を適用する前のソフトウェアの物理デバイスと更新プログラム 1 の物理デバイスの組み合わせが、このサービスに登録されている場合に限定されます。フェールオーバーまたは複製元として有効な物理デバイスは仮想デバイスのバージョンによって決まるので、適切なバージョンの仮想デバイスを作成することが重要です。選択肢:

	- バージョン更新プログラム 0.3。GA リリースまたは更新プログラム 0.1 ～ 0.3 を備えた物理デバイスからのフェールオーバーまたは DR を行う場合。 
	- バージョン更新プログラム 1。更新プログラム 1 を備えた物理デバイスからのフェールオーバーまたは複製を行う場合。 
...
- チェック マークをクリックして、仮想デバイスの初期構成と登録を完了します。デバイス管理者パスワードにはあらかじめ既定値が設定されています。デバイス登録後に変更してください。
