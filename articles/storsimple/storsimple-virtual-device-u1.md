...
](./media/storsimple-virtual-device-u1/StorSimple_CreateVirtualDevice1.png)
...
4. 仮想デバイスに格納するデータがマイクロソフトのデータセンターでホストされることに同意する旨のチェック ボックスをオンにします。物理デバイスのみを使用する場合は、暗号化キーがご利用のデバイスに保管されるため、マイクロソフトが暗号化を解除することはできません。![StorSimple 仮想デバイスの作成ステージ](./media/storsimple-virtual-device-u1/StorSimple_VirtualDeviceCreating1M.png)
...
](./media/storsimple-virtual-device-u1/StorSimple_VirtualDeviceOnline1M.png)
