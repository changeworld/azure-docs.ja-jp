...
| 3\. | KB3103616 | WMI パッケージ | 通常 | ～ 12 分 |
 ...
 &#42; *ソフトウェア更新は、`all-hcsmdssoftwareupdate_d5db7c7a86fc0fffd7fd7e8a1b58584ca4850936.exe` と `all-cismdsagentupdatebundle_a3b6e721045c9229f62ffe3374fb5715bf3699e3.exe` の 2 つのバイナリ ファイルで構成されます。Cis と Mds のエージェント `all-cismdsagentupdatebundle_a3b6e721045c9229f62ffe3374fb5715bf3699e3.exe` の前に、デバイスのソフトウェア更新プログラム `all-hcsmdssoftwareupdate_d5db7c7a86fc0fffd7fd7e8a1b58584ca4850936.exe` をインストールする必要があります。また、Cis と MDS のエージェント更新プログラムを適用したら (残りの更新プログラムを適用する前に)、`Restart-HcsController` コマンドレットを使用してアクティブなコントローラーを再起動する必要があります。*
