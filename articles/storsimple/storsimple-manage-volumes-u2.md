...
階層化ボリュームをアーカイブ ボリュームとして指定するには、**[アクセス頻度の低いアーカイブ データにこのボリュームを使用します]** チェック ボックスをオンにします。アーカイブ ボリュームでは 512 KB の重複除去チャンク サイズが使用されますが、非アーカイブ ボリュームでは 64 KB のチャンク サイズが使用されます。より大きな重複除去チャンク サイズを使用すると、デバイスはより大きなデータのチャンクをクラウドに転送できます。
