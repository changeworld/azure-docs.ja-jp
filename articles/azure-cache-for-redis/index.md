---
title: Azure Cache for Redis のドキュメント - チュートリアル、API リファレンス
...
ms.locfileid: "74122542"
---
# <a name="azure-cache-for-redis-documentation"></a>Azure Cache for Redis のドキュメント

アプリケーションに対してスループットが高く待機時間の短いデータ アクセスを提供する、セキュリティで保護されたデータ キャッシュおよびメッセージング ブローカー、Azure Cache for Redis の使用方法について説明します。 チュートリアルや API リファレンスなどのドキュメントでは、Azure 上の任意のアプリケーションから Azure Cache for Redis を使用する方法を紹介します。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Cache for Redis の Premium レベルについて</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Cache for Redis のビデオ ライブラリ</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>.NET を使用して Azure Cache for Redis の作業を開始する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>ASP.NET MVC を使用して Azure Cache for Redis の作業を開始する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Node.js を使用して Azure Cache for Redis の作業を開始する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Java を使用して Azure Cache for Redis の作業を開始する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Python を使用して Azure Cache for Redis の作業を開始する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Cache for Redis で変更可能な部分的データを処理する</h3>
                    </div>
                </div>
            </div>
        </div>
