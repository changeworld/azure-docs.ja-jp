...
また、カスタム ドメイン名もストレージ アカウントを使用するように構成することができます。詳細については、[ストレージ アカウントの BLOB データのカスタム ドメイン名の構成](http://azure.microsoft.com/ja-jp/documentation/articles/storage-custom-domain-name/) を参照してください。
