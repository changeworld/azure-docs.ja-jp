...
[WACOM.INCLUDE [modes][modes]]
  ...
  [Web サイト]: /ja-jp/documentation/articles/web-sites-godaddy-custom-domain-name/ "Web サイト"
  [Traffic Manager を利用する Web サイト]: /ja-jp/documentation/articles/web-sites-godaddy-traffic-manager-custom-domain-name/ "Traffic Manager を利用する Web サイト"
