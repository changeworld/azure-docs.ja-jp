...
[Azure CLI command reference(Azure CLI コマンド リファレンス)]: http://azure.microsoft.com/documentation/articles/command-line-tools/
...
[[Azure Linux VM 上で MySQL のパフォーマンスを最適化およびテストする]:http://azure.microsoft.com/documentation/articles/virtual-machines-linux-optimize-mysql-perf/
