...
-   選択したモバイル プラットフォームの「[Notification Hubs の使用][Notification Hubs の使用]」に従って、Java のバックエンド部分を実装します。
...
「[Java REST wrapper sample (Java REST ラッパー サンプル)][Java REST wrapper sample (Java REST ラッパー サンプル)]」で利用可能なすべてのコードを検索できます。
...
また、「[Java REST wrapper sample (Java REST ラッパー サンプル)][Java REST wrapper sample (Java REST ラッパー サンプル)]」のコードを使用する場合は、「[チュートリアルを完了する][チュートリアルを完了する]」セクションに直接進んでください。

REST ラッパーすべての実装の詳細については、[MSDN の記事][MSDN の記事]を参照してください。このセクションでは、Notification Hubs REST エンドポイントにアクセスするために必要な主要手順の Java 実装について説明します。
...
-   [Java REST ラッパー サンプル][Java REST wrapper sample (Java REST ラッパー サンプル)]をすべてダウンロードします。サンプルには上記のコード、および登録管理のコードがすべて含まれています。
