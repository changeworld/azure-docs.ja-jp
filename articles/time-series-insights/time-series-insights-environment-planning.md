...
1. **[Time Series Insights 環境]** ウィンドウで、 **[設定]** 下の **[構成]** を選択します。
...
> [!TIP]
> 適切なデータ リテンション ポリシーの実装方法について詳しくは、[リテンション期間の構成方法](./time-series-insights-how-to-configure-retention.md)に関するページをご覧ください。
