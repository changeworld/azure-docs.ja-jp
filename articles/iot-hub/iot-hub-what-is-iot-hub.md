...
[IoT Hub と Event Hubs の比較][lnk-compare]に関する記事では、これらの 2 つのサービスの主な違いについて説明し、IoT ソリューションで IoT Hub を使用する利点を示しています。
...
## <a name="iot-deviceconnectivity-challenges"></a>IoT デバイスの接続の課題
