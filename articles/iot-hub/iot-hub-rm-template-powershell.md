---
title: Resource Manager テンプレートと PowerShell を使用した IoT Hub の作成 | Microsoft Docs
...
> [!TIP]
> PowerShell スクリプトと Resource Manager テンプレートを使って Azure のリソースを作成する方法の詳細については、「[Azure Resource Manager での Azure PowerShell の使用][lnk-powershell-arm]」の記事を参照してください。
> 
> 
