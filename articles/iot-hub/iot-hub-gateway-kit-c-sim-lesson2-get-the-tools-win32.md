---
title: "シミュレートされたデバイスと Azure IoT Gateway - レッスン 2: ツールの取得 (Windows) | Microsoft Docs"
...
> * [Windows 7 以降](iot-hub-gateway-kit-c-sim-lesson2-get-the-tools-win32.md)
...
インストールで問題が発生した場合は、[トラブルシューティング ガイド](iot-hub-gateway-kit-c-sim-troubleshooting.md)で一般的な問題に対する解決策を確認してください。
