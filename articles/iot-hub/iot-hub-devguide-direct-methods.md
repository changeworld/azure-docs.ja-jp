...
description: "Azure の IoT Hub 開発者ガイド - ダイレクト メソッドを使用して、デバイス上のコードを呼び出す"
services: iot-hub
...
---
# <a name="invoke-a-direct-method-on-a-device"></a>デバイス上のダイレクト メソッドを呼び出す
...
ダイレクト メソッドの使用方法を理解できたら、次の開発者ガイド トピックも参考にしてください。
