...
|c2d<br>.twin<br>.read<br>.success|成功したバック エンドからのツイン読み取り|Count|合計|バックエンドが開始して成功したツイン読み取りの数。 この数には、ツイン クエリから開始されたツイン読み取りは含まれません。|ディメンションなし|
