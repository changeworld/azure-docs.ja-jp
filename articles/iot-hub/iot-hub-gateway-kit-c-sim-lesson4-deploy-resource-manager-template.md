...
- [レッスン 1: Intel NUC を IoT ゲートウェイとしてセットアップする](iot-hub-gateway-kit-c-sim-lesson1-set-up-nuc.md)
- [レッスン 2: ホスト コンピューターと Azure IoT ハブを準備する](iot-hub-gateway-kit-c-sim-lesson2-get-the-tools-win32.md)
- [レッスン 3: シミュレート デバイスからメッセージを受信し、IoT ハブからメッセージを読み取る](iot-hub-gateway-kit-c-sim-lesson3-configure-simulated-device-app.md)
...
[Azure Storage に保持されたメッセージの読み取り](iot-hub-gateway-kit-c-sim-lesson4-read-table-storage.md)
