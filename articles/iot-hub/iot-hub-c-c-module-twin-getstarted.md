...
ms.locfileid: "37034891"
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-using-c-back-end-and-c-device"></a>C バックエンドおよび C デバイスを使用した Azure IoT Hub モジュール ID とモジュール ツインの概要
...
* IoT Hub。
* 最新の [C SDK](https://github.com/Azure/azure-iot-sdk-c) をインストールします。
