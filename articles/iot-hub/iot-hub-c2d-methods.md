---
title: ダイレクト メソッドの使用 | Microsoft Docs
...
> [!NOTE]
> 現在のところ、ダイレクト メソッドには MQTT プロトコルを使用して IoT Hub に接続するデバイスからのみアクセスできます。 既存のデバイス アプリを変換して MQTT を使用する方法については、[MQTT サポート][lnk-devguide-mqtt]の記事をご覧ください。
> 
> 
