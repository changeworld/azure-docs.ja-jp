...
この機能を利用するには、次のいずれかのリージョンで新しい IoT Hub (Basic または Standard レベル) を作成する必要があります:米国東部、米国西部 2、または米国中南部。 この機能を試用するには、[Microsoft サポート](https://azure.microsoft.com/support/create-ticket/)経由でお問い合わせください。 Microsoft サポートへのお問い合わせの際は、お客様の会社名とサブスクリプション ID をお知らせください。
