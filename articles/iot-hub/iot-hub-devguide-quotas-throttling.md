...
| -------- | ------- | ------- | ------- |
| ID レジストリの操作 (作成、取得、一覧表示、更新、削除) | 1.67/sec/unit (100/分/ユニット) | 1.67/sec/unit (100/分/ユニット) | 83.33/sec/unit (5000/分/ユニット) |
...
| cloud-to-device の送信<sup>1</sup> | 1.67/sec/unit (100/分/ユニット) | 1.67/sec/unit (100/分/ユニット) | 83.33/sec/unit (5000/分/ユニット) |
| cloud-to-device の受信<sup>1</sup> <br/> (デバイスが HTTPS を使用する場合のみ)| 16.67/sec/unit (1000/分/ユニット) | 16.67/sec/unit (1000/分/ユニット) | 833.33/sec/unit (50000/分/ユニット) |
| ファイルのアップロード | 1.67 ファイル アップロード通知/秒/ユニット (100/分/ユニット) | 1.67 ファイル アップロード通知/秒/ユニット (100/分/ユニット) | 83.33 ファイル アップロード通知/秒/ユニット (5000/分/ユニット) |
...
| ジョブの操作<sup>1</sup> <br/> (作成、更新、一覧表示、削除) | 1.67/sec/unit (100/分/ユニット) | 1.67/sec/unit (100/分/ユニット) | 83.33/sec/unit (5000/分/ユニット) |
| Jobs デバイスごとのジョブの操作のスループット<sup>1</sup> | 10/秒 | 10/秒または 1/秒/ユニット以上 | 50/秒/ユニット |
| 構成と Edge の展開<sup>1</sup> <br/> (作成、更新、一覧表示、削除) | 0.33/秒/ユニット (20/分/ユニット) | 0.33/秒/ユニット (20/分/ユニット) | 0.33/秒/ユニット (20/分/ユニット) |
