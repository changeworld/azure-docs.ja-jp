---
title: "開発者ガイド - クォータと調整 | Microsoft Docs"
description: "Azure IoT Hub 開発者ガイド - IoT Hub に適用されるクォータと予想される調整動作の説明"
services: iot-hub
...
---
# <a name="reference---quotas-and-throttling"></a>参照 - クォータと調整
...
たとえば、1 つの S1 ユニットを購入した場合、1 秒あたり 100 接続のスロットルを利用できます。 これは、100,000 個のデバイスに接続するために、少なくとも 1,000 秒 (約 16 分) かかることを意味します。 ただし、ID レジストリに登録されたデバイスの数だけ、同時に接続されたデバイスを持つことができます。
