...
| ダイレクト メソッド | 160 KB/秒/ユニット<sup>1</sup> | 480 KB/秒/ユニット<sup>1</sup> | 24 MB/秒/ユニット<sup>1</sup> | 
| デバイス ツインの読み取り | 10/秒 | 10/秒または 1/秒/ユニット以上 | 50/秒/ユニット |
| デバイス ツインの更新 | 10/秒 | 10/秒または 1/秒/ユニット以上 | 50/秒/ユニット |
| ジョブ操作 <br/> (作成、更新、一覧表示、削除) | 1.67/sec/unit (100/分/単位) | 1.67/sec/unit (100/分/単位) | 83.33/sec/unit (5000/分/単位) |
| デバイスごとのジョブの操作のスループット | 10/秒 | 10/秒または 1/秒/ユニット以上 | 50/秒/ユニット |

<sup>1</sup> 調整メーター サイズは 8 KB です
...
| ダイレクト メソッド | ダイレクト メソッドの最大ペイロード サイズは 128 KB です |
