---
title: Azure IoT Hub SDK のリスト | Microsoft Docs
...
---
# IoT Hub SDK
この記事には、さまざまな [Microsoft Azure IoT SDK][Microsoft Azure IoT SDK] に関する情報と、追加リソースへのリンクが記載されています。
...
* [C 用 Azure IoT デバイス SDK][C 用 Azure IoT デバイス SDK]。移植性と広範なプラットフォーム互換性を得るために、ANSI C (C99) で作成されています。
* [.NET 用 Azure IoT デバイス SDK][.NET 用 Azure IoT デバイス SDK]
* [Java 用 Azure IoT デバイス SDK][Java 用 Azure IoT デバイス SDK]
* [Node.js 用 Azure IoT デバイス SDK][Node.js 用 Azure IoT デバイス SDK]
* [Python 2.7 用 Microsoft Azure IoT device SDK][Python 2.7 用 Microsoft Azure IoT device SDK]
...
* [Microsoft Azure Certified for IoT プログラム][Microsoft Azure Certified for IoT プログラム]
...
* [Node.js 用 Azure IoT サービス SDK][Node.js 用 Azure IoT サービス SDK]
* [Java 用 Azure IoT サービス SDK][Java 用 Azure IoT サービス SDK]
...
GitHub から [Azure IoT Gateway SDK][Azure IoT Gateway SDK] をダウンロードできます。

## オンライン API リファレンス ドキュメント
Azure IoT デバイス、サービス、およびゲートウェイ ライブラリのオンライン API リファレンス ドキュメントへのリンクの一覧を次に示します。

* [Internet of Things (IoT) .NET (モノのインターネット (IoT) .NET)][Internet of Things (IoT) .NET (モノのインターネット (IoT) .NET)]
* [IoT Hub REST][IoT Hub REST]
* [Microsoft Azure IoT device SDK for C (C 用 Microsoft Azure IoT デバイス SDK)][Microsoft Azure IoT device SDK for C (C 用 Microsoft Azure IoT デバイス SDK)]
* [Microsoft Azure IoT device SDK for Java (Java 用 Microsoft Azure IoT デバイス SDK)][Microsoft Azure IoT device SDK for Java (Java 用 Microsoft Azure IoT デバイス SDK)]
* [Microsoft Azure IoT service SDK for Java (Java 用 Microsoft Azure IoT サービス SDK)][Microsoft Azure IoT service SDK for Java (Java 用 Microsoft Azure IoT サービス SDK)]
* [Microsoft Azure IoT device SDK for Node.js (Node.js 用 Microsoft Azure IoT デバイス SDK)][Microsoft Azure IoT device SDK for Node.js (Node.js 用 Microsoft Azure IoT デバイス SDK)]
* [Microsoft Azure IoT service SDK for Node.js (Node.js 用 Microsoft Azure IoT サービス SDK)][Microsoft Azure IoT service SDK for Node.js (Node.js 用 Microsoft Azure IoT サービス SDK)]
