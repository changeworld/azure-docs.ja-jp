...
**devicetype** として "chiller" のタグが付けられたすべてのデバイスでファームウェア更新プロセスを開始するには、バックエンド アプリケーションで自動デバイス管理構成を作成します。 このセクションでは、次の方法について説明します。
