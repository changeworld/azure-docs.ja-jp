...
## [ツインのプロパティの使用方法](iot-hub-node-node-twin-how-to-configure.md)
## [ダイレクト メソッドの使用](iot-hub-c2d-methods.md)
## [デバイス管理の開始](iot-hub-device-management-get-started.md)
## [デバイス ジョブを使用してデバイスのファームウェアを更新する](iot-hub-firmware-update.md)
## [ジョブのスケジュールとブロードキャスト](iot-hub-schedule-jobs.md)
