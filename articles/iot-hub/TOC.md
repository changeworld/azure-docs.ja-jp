...
#### [接続と信頼できるメッセージングの管理](iot-hub-reliability-features-in-sdks.md)
...
### [X.509 証明書によるハブのセキュリティ保護](iot-hub-security-x509-get-started.md)
...
## [REST (デバイス)](https://docs.microsoft.com/rest/api/iothub/device)
## [REST (サービス)](https://docs.microsoft.com/rest/api/iothub/service)
## [REST (IoT Hub リソース)](https://docs.microsoft.com/rest/api/iothub/iothubresource)
## [REST (証明書)](https://docs.microsoft.com/rest/api/iothub/certificates)

# 関連項目
## 解決方法 
### [IoT ソリューション アクセラレータ](/azure/iot-accelerators) 
...
## [Azure のロードマップ](https://azure.microsoft.com/roadmap/?category=iot)
