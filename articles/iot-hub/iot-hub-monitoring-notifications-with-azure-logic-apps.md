...
1. [Azure Portal](https://portal.azure.com/) で、**[リソースの作成]** > **[エンタープライズ統合]** > **[Service Bus]** の順にクリックします。
1. 次の情報を指定します。
...
1. [Azure Portal](https://portal.azure.com/) で、**[リソースの作成]** > **[エンタープライズ統合]** > **[ロジック アプリ]** の順にクリックします。
1. 次の情報を入力します。
