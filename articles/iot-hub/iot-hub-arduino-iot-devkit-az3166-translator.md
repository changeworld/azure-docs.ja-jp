...
description: IoT DevKit のマイクを使用して音声メッセージを受信し、そのメッセージを Azure Cognitive Services によって英語のテキストに翻訳する
author: liydu
manager: jeffya
ms.service: iot-hub
services: iot-hub
...
> [!NOTE]
> MXCHIP AZ3166 セクションの例が表示されない場合は、デバイスが正しく接続されていることを確認し、Visual Studio Code を再起動します。  
