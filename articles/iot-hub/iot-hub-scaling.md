...
このスループット情報に加え、「[IoT Hub のクォータとスロットル][IoT Hub のクォータとスロットル]に関するページを参照して、適切にソリューションを設計してください。
...
特定のバースト パフォーマンスの数値については、[IoT Hub のクォータとスロットル][IoT Hub のクォータとスロットル]に関するページを参照してください。
