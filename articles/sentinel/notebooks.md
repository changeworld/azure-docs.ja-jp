...
1. コンピューティング インスタンスを選択します。 コンピューティング インスタンスがない場合は、以下を実行します。
    1. プラス記号 (+) を選択して **[コンピューティング インスタンスを作成する]** ウィザードを開始します。

        > [!div class="mx-imgBorder"]
        > ![コンピューティング インスタンスのウィザードを開始する](./media/notebooks/sentinel-azure-notebooks-compute-wizard.png)

    1. **[仮想マシンの選択]** ページで、必要な情報を入力して、 **[次へ]** を選択します。

        > [!div class="mx-imgBorder"]
        > ![コンピューティング インスタンス VM を選択する](./media/notebooks/sentinel-azure-notebooks-compute-create.png)

    1. **[設定の構成]** ページで、必要な情報を指定してから、 **[作成]** を選択します。
    
        > [!div class="mx-imgBorder"]
        > ![コンピューティング インスタンスの設定の構成](./media/notebooks/sentinel-azure-notebooks-compute-settings.png)
