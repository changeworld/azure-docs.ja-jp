...
- Azure Policy を使用して Azure Key Vault リソースにログ ストリーミング ポリシーを適用するには、ポリシー割り当てスコープの所有者ロールが必要です。
...
1. コネクタ ページの **[構成]** セクションで、 **[Azure Key Vault から診断ログを大規模にストリーミングする]** を展開します。
...
このドキュメントでは、Azure Policy を使用して Azure Key Vault を Azure Sentinel に接続する方法について学習しました。 Azure Sentinel の詳細については、次の記事をご覧ください。
