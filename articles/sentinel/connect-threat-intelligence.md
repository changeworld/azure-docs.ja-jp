...
3. 組織に登録されているアプリケーションに対して管理者の同意を許可するよう、Azure Active Directory テナント管理者に依頼します。 Azure ポータルで次の手順を実行します。 **[Azure Active Directory]**  >  **[アプリの登録]**  >  **\<*アプリ名*>**  >  **[API アクセス許可の表示]**  >  **[\<*テナント名*> に管理者の同意を与えます]** 。
