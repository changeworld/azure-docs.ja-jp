...
> [!IMPORTANT]
> Azure Sentinel の Azure Firewall データ コネクタは、現在パブリック プレビュー段階にあります。
...
[Azure Firewall ログの監視](https://docs.microsoft.com/azure/firewall/tutorial-diagnostics)について説明します。
