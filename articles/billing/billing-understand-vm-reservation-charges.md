---
title: Azure 予約インスタンスの割引を理解する | Microsoft Docs
...
ms.locfileid: "37064472"
---
# <a name="understand-how-the-reserved-instance-discount-is-applied"></a>予約インスタンスの割引の適用方法について
Azure Reserved VM Instance を購入すると、予約インスタンスの属性や数量に合致する仮想マシンに対して予約インスタンスの割引が自動的に適用されます。 予約インスタンスは、ご利用の仮想マシンのインフラストラクチャ コストに充当されます。 以下の表は、予約インスタンスを購入した後の仮想マシンのコストを示しています。 ストレージとネットワークについては、すべての場合において通常料金が適用されます。
...
Azure 予約インスタンスの適用を課金の使用状況レポートの観点から理解し、把握するには、[予約インスタンスの使用量の概要](https://go.microsoft.com/fwlink/?linkid=862757)に関するページを参照してください。
...
- [CSP サブスクリプションの予約インスタンス使用量について](https://docs.microsoft.com/partner-center/azure-reservations)
