...
- [予約トランザクションの表示](billing-view-reservations.md)
- [API での予約トランザクションと使用率の取得](billing-reservation-apis.md)
- [予約を管理する](billing-manage-reserved-vm-instance.md)
