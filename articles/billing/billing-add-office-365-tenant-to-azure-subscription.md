...
# Office 365 テナントを Azure サブスクリプションに追加します。
...
## Office 365 テナントを Azure サブスクリプションにリンクする
...
### 手順 1: Office 365 テナントを Azure サブスクリプションに追加する
...
### 手順 3: Office 365 の組織アカウントを共同管理者として Azure Active Directory テナントに追加する
