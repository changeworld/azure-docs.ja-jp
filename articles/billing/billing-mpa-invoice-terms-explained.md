...
**[製品ごとの請求の詳細]** セクションには、この課金プロファイルに関連付けられた製品ごとに請求金額の合計が一覧表示されます。 Azure の利用状況と請求金額を含む CSV で、各製品の請求金額に対する日単位の内訳を確認できます。 Azure の利用状況と請求金額を含む CSV と照らして請求書の PDF を調整する方法については、[Microsoft Partner Agreement の請求書について](billing-mpa-understand-your-bill.md)のページを参照してください。
