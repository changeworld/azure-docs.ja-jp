...
アカウントの転送は、転送先加入契約の開始日またはアカウントの開始日のうち、後の方の開始日までさかのぼることができます。 アカウントの転送後、有効な転送日より前のアカウントの使用状況情報はすべて、転送元の登録に残ります。 転送日以降の使用状況情報は、転送先の加入契約に移動されます。
...
- アカウント転送の発効日については、転送先加入契約の開始日またはアカウントの開始日のうち、後の方の開始日までさかのぼることができます
...
転送は、転送先の加入契約の開始日までさかのぼることができます。 選択した転送日を指定しても、既に発行済みの超過分請求書の使用量には影響しません。
