...
[無料のサービス ページ](https://go.microsoft.com/fwlink/?linkid=859151)を使用して、新しいサービスを作成することをお勧めします。 または、[Azure Portal](http://portal.azure.com) にサインインして、左側にある **[すべてのサービス]** を選択し、**[無料サービス]** を検索できます。 
