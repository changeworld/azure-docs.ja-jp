...
マイクロソフト エンタープライズ契約または Microsoft 顧客契約のお客様の場合は、[API](billing-reservation-apis.md#see-reservation-usage) を使用して、[使用状況データ](billing-understand-reserved-instance-usage-ea.md#common-cost-and-usage-tasks)から予約使用率を取得することもできます。
