...
予約は [Azure portal](https://aka.ms/reservations) で購入できます。
...
- マイクロソフト エンタープライズ契約のお客様の場合、課金コンテキストは登録です。
 従量課金制のお客様の場合、課金コンテキストはアカウント管理者が作成するすべての有効なサブスクリプションです。
...
- 従量課金制 (オファー番号:MS-AZR-0003P または MS-AZR-0023P)
- CSP サブスクリプション
