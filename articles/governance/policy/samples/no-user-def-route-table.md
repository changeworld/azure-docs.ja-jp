---
title: Azure Policy サンプル - ユーザー定義ルート テーブルがない
description: このサンプル ポリシーは、仮想ネットワークがユーザー定義のルート テーブルを使ってデプロイされることを禁止します。
...
ms.locfileid: "46977275"
---
# <a name="no-user-defined-route-table"></a>ユーザー定義ルート テーブルがない
