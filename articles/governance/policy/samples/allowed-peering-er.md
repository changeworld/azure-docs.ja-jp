---
title: Azure Policy のサンプル - Express Route に対して許可されているピアリングの場所
description: このポリシーは、Express Route で指定したピアリングの場所が使用されていることが要件です。
...
ms.locfileid: "46946920"
---
# <a name="allowed-peering-location-for-express-route"></a>Express Route に対して許可されているピアリングの場所

このポリシーは、Express Route で指定したピアリングの場所が使用されていることが要件です。 許可されているピアリングの場所の配列を指定します。
