---
title: Azure Policy サンプル - タグとその値を強制
description: このサンプル ポリシーは、指定されたタグ名と値を要求します。
...
ms.locfileid: "46982870"
---
# <a name="enforce-tag-and-its-value"></a>タグとその値を強制

このポリシーは、指定されたタグ名と値が要件です。 強制的に適用するタグ名と値を指定します。
