---
title: Azure Policy のサンプル - リージョンで Network Watcher が有効になっていない場合の監査
description: このサンプル ポリシーでは、特定のリージョンで Network Watcher が有効になっていない場合に監査が行われます
