...
description: ISO 27001 ブループリント サンプルの Azure Policy へのコントロール マッピング。
author: DCtheGeek
ms.author: dacoulte
ms.date: 07/22/2019
ms.topic: sample
...
ISO 27001 ブループリントのコントロール マッピングを確認したので、以下の記事に進み、アーキテクチャとこのサンプルのデプロイ方法を確認します。

> [!div class="nextstepaction"]
> [ISO 27001 ブループリント - 概要](./index.md)
