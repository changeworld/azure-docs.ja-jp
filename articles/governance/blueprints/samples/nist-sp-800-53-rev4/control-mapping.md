...
description: NIST SP 800-53 R4 のブループリント サンプルから Azure Policy と RBAC へのコントロール マッピング。
author: DCtheGeek
ms.author: dacoulte
ms.date: 06/24/2019
ms.topic: sample
...
- [プレビュー]: Audit external accounts with read permissions on a subscription
...
- [Preview]:可能なネットワーク Just In Time (JIT) アクセスの Azure Security Center での監視
...
- [プレビュー]: Audit CORS resource access restrictions for a Web Application
...
- [プレビュー]: Audit remote debugging state for a Function App
- [プレビュー]: Audit remote debugging state for a Web Application
- [プレビュー]: Audit remote debugging state for an API App
- [プレビュー]: Audit that Linux VMs do not allow remote connections from accounts without passwords
- [プレビュー]: Deploy VM extension to audit that Linux VMs do not allow remote connections from accounts without passwords
...
- [Preview]:VMSS の Log Analytics エージェントのデプロイの監査 - VM イメージ (OS) が一覧にない
- [プレビュー]: Audit Log Analytics Workspace for VM - Report Mismatch
- [プレビュー]: Deploy Log Analytics Agent for Linux VM Scale Sets (VMSS)
- [プレビュー]: Deploy Log Analytics Agent for Linux VMs
- [プレビュー]: Deploy Log Analytics Agent for Windows VM Scale Sets (VMSS)
...
- [プレビュー]: Monitor unaudited SQL servers in Azure Security Center
- 診断設定の監査
...
- [プレビュー]: Audit that Linux VMs do not have accounts without passwords
- [プレビュー]: Deploy VM extension to audit that Linux VMs do not have accounts without passwords
- [プレビュー]: Audit that Linux VMs have the passwd file permissions set to 0644
- [プレビュー]: Audit that Windows VMs store passwords using reversible encryption
- [プレビュー]: Deploy VM extension to audit that Linux VMs have the passwd file permissions set to 0644
...
- [プレビュー]: Audit that Windows VMs cannot re-use the previous 24 passwords
- [プレビュー]: Audit that Windows VMs have a maximum password age of 70 days
- [プレビュー]: Audit that Windows VMs have a minimum password age of 1 day
- [プレビュー]: Audit that Windows VMs have the password complexity setting enabled
- [プレビュー]: Audit that Windows VMs restrict the minimum password length to 14 characters
- [プレビュー]: Audit that Windows VMs store passwords using reversible encryption
- [プレビュー]: Deploy VM extension to audit that Windows VMs cannot re-use the previous 24 passwords
- [プレビュー]: Deploy VM extension to audit that Windows VMs have a maximum password age of 70 days
- [プレビュー]: Deploy VM extension to audit that Windows VMs have a minimum password age of 1 day
- [プレビュー]: Deploy VM extension to audit that Windows VMs have the password complexity setting enabled
- [プレビュー]: Deploy VM extension to audit that Windows VMs restrict the minimum password length to 14 characters
- [プレビュー]: Deploy VM extension to audit that Windows VMs store passwords using reversible encryption
...
- Advanced Data Security を使用していない SQL サーバーの監査
- SQL サーバーに対する Advanced Data Security のデプロイ
- [プレビュー]: Audit OS vulnerabilities on your virtual machine scale sets in Azure Security Center
...
- [プレビュー]: Audit standard tier of DDoS protection is enabled for a virtual network
...
- [プレビュー]: Monitor Internet-facing virtual machines for Network Security Group traffic hardening recommendations
...
- [プレビュー]: Monitor unencrypted SQL databases in Azure Security Center
...
- [プレビュー]: Audit any missing system updates on virtual machine scale sets in Azure Security Center
- [プレビュー]: Audit OS vulnerabilities on your virtual machine scale sets in Azure Security Center
...
- [プレビュー]: Audit the endpoint protection solution on virtual machine scale sets in Azure Security Center
