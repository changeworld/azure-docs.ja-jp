---
title: サンプル - CIS Microsoft Azure Foundations Benchmark ブループリント - 概要
description: CIS Microsoft Azure Foundations Benchmark ブループリント サンプルの概要。
author: DCtheGeek
ms.author: dacoulte
ms.date: 08/09/2019
ms.topic: sample
