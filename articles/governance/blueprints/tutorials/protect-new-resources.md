...
Azure Blueprints の [リソース ロック](../concepts/resource-locking.md)を使用すると、新しくデプロイされたリソースが改ざんされること (それが "_所有者_" ロールのアカウントによるものであっても) から保護することができます。 この保護は、Azure Resource Manager テンプレート (ARM テンプレート) 成果物によって作成されたリソースのブループリント定義に追加することができます。
