...
1. 最新の Azure CLI がインストールされていることを確認します (**2.8.0** 以降)。 インストールされていない場合は、こちらの[手順](/cli/azure/install-azure-cli-windows?view=azure-cli-latest)に従ってください。
