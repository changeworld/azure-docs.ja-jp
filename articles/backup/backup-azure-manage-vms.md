...
* 最新の復旧ポイントは無期限に保持され、ユーザーは適用されるバックアップの料金に応じて課金されるため、削除リソースのバックアップ項目/データが必要なくなった場合は、追加コストを避けるため、プライマリ データ ソースが存在しなくなったバックアップ項目を削除することをお勧めします。
