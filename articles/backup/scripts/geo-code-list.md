...
このサンプル XML から、各リージョンにマップされているジオコードを把握できます。 これらのジオコードを使用して、Recovery Services コンテナーのプライベート エンドポイント用のカスタム DNS ゾーンを作成、追加します。

## <a name="mapping-details"></a>マッピングの詳細
