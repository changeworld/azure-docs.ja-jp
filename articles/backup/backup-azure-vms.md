<properties
	...
	description="この記事では、Azure の仮想マシンをバックアップする手順について説明します。"
	services="backup"
	documentationCenter=""
	authors="Jim-Parker"
	manager="jwhit"
...
5. バックアップに関連付ける**保持期間**を選択します。
    ...
    - **日単位の保持ポリシー**: バックアップは毎日作成され、30 日間保持されます。
    - **週単位の保持ポリシー**: バックアップは毎週日曜日に作成され、104 週間保持されます。
    - **月単位の保持ポリシー**: バックアップは各月の最後の日曜日に作成され、120 か月保持されます。
    - **年単位の保持ポリシー**: バックアップは 1 月の最初の日曜日に作成され、99 年間保持されます。
