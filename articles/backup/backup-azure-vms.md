...
3. ページの下部にある **[探索]** をクリックします。![[探索] ボタン](./media/backup-azure-vms/discover-button.png)
...
3. ページの下部にある **[登録]** をクリックします。![[登録] ボタン](./media/backup-azure-vms/register-button.png)
...
- Azure 仮想マシンにログインし、フォルダー *C:\WindowsAzure\Packages* に移動します。
- WaAppAgent.exe ファイルを探します。
- このファイルを右クリックして、**[プロパティ]** をクリックした後、**[詳細]** タブを選択します。
- [製品バージョン] が 2.6.1198.718 以上であることを確認します。
