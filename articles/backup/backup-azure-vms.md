...
6. コンテナー メニューから **[保護の構成]** ジョブを一覧表示するには、**[ジョブ]** をクリックし、**[操作]** フィルターから **[保護の構成]** を選択します。
...
## バックアップの状態と詳細の表示
仮想マシンが保護されると、**[ダッシュボード]** ページの概要に示される仮想マシンの数が増加します。**[ダッシュボード]** ページには、過去 24 時間の間に*成功したジョブ*、*失敗したジョブ*、*現在進行中のジョブ*の数が表示されます。**[ジョブ]** ページで、**[状態]**、**[操作]**、または **[開始]** と **[終了]** メニューを使用して、ジョブのフィルター処理を行います。
