...
- 保護グループとしてまとめる複数のマシンのバックアップを、単一のコンソールで管理できます。 これは、アプリが複数のマシンにわたって階層化されていて、それらをまとめてバックアップする場合に便利です。
...
|  | Azure Backup (MARS) エージェント| System Center DPM | Azure Backup Server | Azure IaaS VM のバックアップ |
| --- | --- | --- | --- | --- |
