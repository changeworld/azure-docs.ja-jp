...
1 日あたりのバックアップ回数 (Azure VM 拡張機能を使用した場合) | 1 日あたり 1 回のスケジュール済みバックアップ。<br/><br/> このサービスを使うと、1 日に最大 9 回のオンデマンド バックアップを実行できますが、Microsoft では、毎日最大 4 回のオンデマンド バックアップのみを推奨し、サポートしています。
