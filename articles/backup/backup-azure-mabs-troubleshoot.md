...
| Backup | オンライン回復ポイントを作成できませんでした | "Windows Azure Backup Agent は、選択されたボリュームのスナップショットを作成できませんでした。" というエラー メッセージが表示された場合は、レプリカおよび復旧ポイントのボリュームの領域を増やしてください。
