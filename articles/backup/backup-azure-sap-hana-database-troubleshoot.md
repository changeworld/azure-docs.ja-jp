...
| **エラー メッセージ**      | <span style="font-weight:normal">Azure Backup には、バックアップおよび復元操作を実行するために必必須のロール特権がありません</span>    |
| ---------------------- | ------------------------------------------------------------ |
...
| **エラー メッセージ**      | <span style="font-weight:normal">Backint の構成が正しく更新されないと、バックアップは失敗し、このエラーが発生します。</span>                       |
| ------------------ | ------------------------------------------------------------ |
...
**エラー メッセージ** | <span style="font-weight:normal">バックアップ用に構成されたデータベースが存在しません。</span>
--------- | --------------------------------
...
**エラー メッセージ** | <span style="font-weight:normal">Azure Backup には、バックアップおよび復元操作を実行するための十分な特権がありません。</span>
---------- | ---------
...
**エラー メッセージ** | <span style="font-weight:normal">データベースまたはバックアップ ユーザーのパスワードの有効期限が切れています。</span>
----------- | -----------
...
**エラー メッセージ** | <span style="font-weight:normal">SAP HANA エラー</span>
------------ | ----------
...
**エラー メッセージ** | <span style="font-weight:normal">HANA システムから AAD サービスに接続できません。</span>
--------- | --------
...
**エラー メッセージ** | <span style="font-weight:normal">正しく構成されていない CA ストア</span>
-------- | -------
...
**エラー メッセージ** | <span style="font-weight:normal">修復バックアップが進行中です。</span>
---------- | -------
...
**エラー メッセージ** | <span style="font-weight:normal">競合する操作が進行中です。</span>
----------- | -------------
...
**エラー メッセージ** | <span style="font-weight:normal">自動修復の完全バックアップが進行中です。</span>
------- | -------
...
**エラー メッセージ** | <span style="font-weight:normal">事前登録スクリプトが実行されていません。</span>
--------- | --------
...
**エラー メッセージ** | <span style="font-weight:normal">復元のためにターゲット データベースを上書きすることはできません。</span>
------- | -------
...
**エラー メッセージ** | <span style="font-weight:normal">システム DB を復元するための RecoverySys.py を正常に実行できませんでした。</span>
-------- | ---------
...
**エラー メッセージ** | <span style="font-weight:normal">復元されたデータベース名が正しい形式ではありません。</span>
--------- | --------
**考えられる原因** | ユーザーが指定した復元されたデータベース名が、許容または予期される形式ではありません。
**推奨される操作** | 復元されたデータベース名が文字で始まり、数字またはアンダースコア以外の記号が含まれていないことを確認します。<br>最大文字数は 127 文字で、先頭を "\_SYS_\" にすることはできません。

###### <a name="usererrordefaultsidadmdirectorychanged"></a>UserErrorDefaultSidAdmDirectoryChanged

**エラー メッセージ** | <span style="font-weight:normal">既定の sid-adm ディレクトリが変更されました。</span>
------- | -------
...
**エラー メッセージ** | <span style="font-weight:normal">HDBSetting.sh ファイルが見つかりません。</span>
--------- | -------
