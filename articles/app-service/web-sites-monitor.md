...
| **IO その他のバイト/秒** | アプリ プロセスが I/O 操作に対して発行しているデータを含まないバイトの速度 (制御操作など)。|
| **IO その他の操作/秒** | アプリ プロセスが発行している読み取り操作でも書き込み操作でもない I/O 操作の速度。|
...
| **プライベート バイト** | アプリ プロセスによって現在割り当てられている、他のプロセスと共有できないメモリのサイズ (バイト単位)。|
