...
| **ディスク キューの長さ** | ストレージのキューに登録された読み取り要求と書き込み要求の平均数。 ディスク キューが長い場合は、過剰なディスク I/O によってアプリの速度が低下している可能性があることを示しています。 |
...
![Azure portal 上のメトリック グラフ][metrics] メトリックには **[リソース]** ページから直接アクセスできます。 グラフをカスタマイズするには: 
1. グラフを選択します。
1. **[グラフの編集]** を選択します。
1. **[時間範囲]** を編集します。
1. **[グラフの種類]** を編集します。
