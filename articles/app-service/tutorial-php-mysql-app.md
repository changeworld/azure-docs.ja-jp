...
:::image type="content" source="./media/tutorial-php-mysql-app/php-mysql-in-azure.png" alt-text="Task List という PHP サンプル アプリのスクリーンショット。":::
