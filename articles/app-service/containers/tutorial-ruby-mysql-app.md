...
App Service では、Cloud Shell の [az webapp config appsettings set](/cli/azure/webapp/config/appsettings?view=azure-cli-latest#az_webapp_config_appsettings_set) コマンドを使って、環境変数を "_アプリ設定_" として設定します。
