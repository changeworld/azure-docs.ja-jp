---
title: チュートリアル:Linux 上の Java Enterprise アプリ
description: Azure での PostgreSQL データベースへの接続を使用して、Azure App Service on Linux 上の Wildfly で Java Enterprise アプリを動作させる方法について説明します。
