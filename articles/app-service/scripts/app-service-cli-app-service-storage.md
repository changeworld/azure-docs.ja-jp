...
| [`az storage account show-connection-string`](/cli/azure/storage/account?view=azure-cli-latest#az_storage_account_show_connection_string) | ストレージ アカウントの接続文字列を取得します。 |
