...
ms.locfileid: "46969276"
---
# <a name="connect-a-web-app-to-a-redis-cache"></a>Web アプリを Redis Cache に接続する

このサンプル スクリプトでは、Azure Redis Cache と Azure Web アプリを作成します。 作成後、アプリの設定で Redis Cache を Web アプリにリンクします。
...
| [`az redis create`](/cli/azure/redis?view=azure-cli-latest#az-redis-create) | 新しい Redis Cache インスタンスを作成します。 |
| [`az redis list-keys`](/cli/azure/redis?view=azure-cli-latest#az-redis-list-keys) | Redis Cache インスタンスのアクセス キーを一覧表示します。 |
