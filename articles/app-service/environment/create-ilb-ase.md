---
title: App Service 環境で内部ロード バランサーを作成する - Azure
...
1. Azure portal で、 **[リソースの作成]** > **[Web]** > **[App Service 環境]** の順に選択します。
...
1. Azure portal で  **[リソースの作成]** > **[Web + モバイル]** > **[Web アプリ]** の順に選択します。
