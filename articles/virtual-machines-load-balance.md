...
詳細については、次を参照してください。[内部負荷分散](http://msdn.microsoft.com/library/azure/dn690121.aspx)です。負荷分散セットの作成手順については、「[内部負荷分散セットの構成](http://msdn.microsoft.com/library/azure/dn690125.aspx)」を参照してください。
