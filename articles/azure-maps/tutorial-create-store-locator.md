...
1. 設定を更新しやすいようグローバル オプションを追加します。 地図、ポップアップ ウィンドウ、データ ソース、アイコン レイヤー、検索エリアの中心に表示される HTML マーカー、Azure Maps Search サービス クライアントのインスタンス用の各変数を定義します。
