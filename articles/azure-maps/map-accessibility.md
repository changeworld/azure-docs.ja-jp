...
多くの場合、マップ上の場所を表すためにマーカーまたはシンボルが使用されます。 通常、場所に関する追加情報は、ユーザーがマーカーに触れるとポップアップの中に表示されます。 ほとんどのアプリケーションでは、ポップアップは、ユーザーがマーカーをクリックするかタップしたときに表示されます。ただし、このイベントでは、ユーザーがマウスまたはタッチ スクリーンを使用することが求められます。 キーボードを使用する場合に、ポップアップをアクセス可能にすることをお勧めします。 この機能は、データ ポイントごとにポップアップを作成し、それをマップに追加することで実現できます。 
