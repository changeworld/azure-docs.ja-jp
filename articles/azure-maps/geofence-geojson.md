...
ms.locfileid: "56007490"
---
# <a name="geofencing-geojson-data"></a>GeoJSON データのジオフェンシング

Azure Maps の [GET Geofence](https://docs.microsoft.com/rest/api/map/spatial/getgeofencepreview) および [POST Geofence](https://docs.microsoft.com/rest/api/map/spatial/postgeofencepreview) API を使用すると、指定したジオフェンスまたはフェンスのセットを基準とする座標の近接度を取得できます。 この記事では、Azure Maps の GET および POST API で使用できるジオフェンス データを準備する方法を説明します。
