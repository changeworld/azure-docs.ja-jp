...
ms.locfileid: "34659341"
---
# <a name="azure-maps-supported-categories"></a>Azure Maps でサポートされているカテゴリ

目的地の[カテゴリ検索](https://docs.microsoft.com/en-us/rest/api/maps/search/getsearchpoicategory)を行うときのために、100 を超えるカテゴリがサポートされています。 以下は、サポートされているカテゴリ名のカテゴリ コードの一覧です。 カテゴリ コードは最上位レベルのカテゴリに対して生成されます。 すべてのサブ カテゴリは同じカテゴリ コードを共有します。 このカテゴリ リストは、新しいデータがリリースされるたびに変更される可能性があることに注意してください。
...
| ADVENTURE\_SPORTS\_VENUE | アドベンチャー スポーツ会場 |
...
| COURTHOUSE | 裁判所 |
| CULTURAL\_CENTER | カルチャー センター |
| DENTIST | 歯医者 |
| DEPARTMENT\_STORE | 百貨店 |
| DOCTOR | 一般開業医、専門医、医者 |
| ELECTRIC\_VEHICLE\_STATION | 電気自動車ステーション |
| EMBASSY | 大使館 |
| EMERGENCY\_MEDICAL\_SERVICE | 緊急医療サービス |
| ENTERTAINMENT | エンターテイメント |
| EXCHANGE | 金為替、両替、証券取引所、取引所 |
| EXHIBITION\_CONVENTION\_CENTER | 展示コンベンション センター |
| FERRY\_TERMINAL | フェリー、フェリー ターミナル |
| FIRE\_STATION\_BRIGADE | 消防署/消防団 |
| FRONTIER\_CROSSING | 入国 |
...
| ICE\_SKATING\_RINK | アイス スケート リンク |
...
| TRUCK\_STOP | トラック ストップ |
| VETERINARIAN | 動物病院、獣医 |
| WATER\_SPORT | ウォーター スポーツ |
| WEIGH\_STATION | 計量器、計量所 |
| WELFARE\_ORGANIZATION | 福祉団体 |
| WINERY | ワイナリー |
