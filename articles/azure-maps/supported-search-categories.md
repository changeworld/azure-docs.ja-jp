...
ms.locfileid: "75910407"
---
# <a name="azure-maps-supported-categories"></a>Azure Maps でサポートされているカテゴリ

目的地の[カテゴリ検索](https://docs.microsoft.com/rest/api/maps/search/getsearchpoicategory)を行うときのために、100 を超えるカテゴリがサポートされています。 以下は、サポートされているカテゴリ名のカテゴリ コードの一覧です。 カテゴリ コードは最上位レベルのカテゴリに対して生成されます。 すべてのサブ カテゴリは同じカテゴリ コードを共有します。 このカテゴリ リストは、新しいデータがリリースされるたびに変更される可能性があることに注意してください。
...
| AMUSEMENT\_PARK | アミューズメント アーケード、娯楽場、アミューズメント パーク |
| AUTOMOTIVE\_DEALER | オフロードカー/スノーモービル、ボート、バス、オートバイ、トラック、バン、キャンピング カー、自動車、自動車販売店 |
| BANK | 銀行、銀行店舗、銀行支店 |
| BEACH | ビーチ、砂浜 |
| BUILDING\_POINT | building (point) |
| BUSINESS\_PARK | ビジネス パーク、工業地域 |
| CAFE\_PUB | インターネット カフェ、ティー ハウス、喫茶店、インターネット カフェ、カフェ、コーヒー ショップ、地酒醸造所/ビア ガーデン、パブ、カフェ/パブ、喫茶店/飲み屋 |
| CAMPING\_GROUND | レクリエーショナル、キャラバン サイト、キャンプ場 |
| CAR\_WASH | car wash |
| CASH\_DISPENSER | 現金自動預払機、キャッシュ ディスペンサー |
| CASINO | casino |
| CINEMA | ドライブイン映画、映画 |
| CITY\_CENTER | 近隣、管理区域、シティ センター、センター |
| CLUB\_ASSOCIATION | ビーチ クラブ、ホッケー クラブ、クラブ協会 |
| COLLEGE\_UNIVERSITY | 短期大学/コミュニティ カレッジ、カレッジ/大学、カレッジ、大学予備校、大学 |
...
| THEATER | 円形劇場、コンサート ホール、ディナー シアター、音楽センター、オペラ、キャバレー、シアター、オペラ ハウス |
