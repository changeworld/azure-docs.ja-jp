...
> [!div class="nextstepaction"]
> [多角形浮き出しレイヤー](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.layer.polygonextrusionlayer)
