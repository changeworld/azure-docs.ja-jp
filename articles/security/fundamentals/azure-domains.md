---
title: Azure ドメインの参照一覧
description: Azure ドメインの参照一覧 (一部)
services: security
author: memildin
manager: rkarlin
ms.assetid: ''
...
ms.locfileid: "94409401"
---
# <a name="reference-list-of-azure-domains-not-comprehensive"></a>Azure ドメインの参照一覧 (一部)

このページは、使用されている Azure ドメインの部分的な一覧です。 このうちの一部は REST API エンドポイントです。


|サービス  |Subdomain  |
|---------|---------|
|[Azure Access Control Service](https://azure.microsoft.com/blog/one-month-retirement-notice-access-control-service/) (廃止)|*.accesscontrol.windows.net|
...
|[Azure BizTalk Services](https://azure.microsoft.com/pricing/details/biztalk-services/) (廃止)|*.biztalk.windows.net|
|[Azure BLOB Storage](../../storage/blobs/index.yml)|*.blob.core.windows.net|
|[Azure Cloud Services](../../cloud-services/cloud-services-choose-me.md) と [Azure Virtual Machines](../../virtual-machines/index.yml)|*.cloudapp.net|
...
|Azure Container Service (ACS) (非推奨)|*.azurecontainer.io|
...
|Azure 管理サービス|*.management.core.windows.net|
...
|[Azure の Traffic Manager](../../traffic-manager/traffic-manager-overview.md)|*.trafficmanager.net|
