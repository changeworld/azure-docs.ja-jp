---
title: Azure のセキュリティの基礎に関するドキュメント
description: Azure のセキュリティについて説明します。
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "72792369"
---
# <a name="azure-security-fundamentals-documentation"></a>Azure のセキュリティの基礎に関するドキュメント

Azure のセキュリティについて説明します。
        ...
        <a href="/azure/security/fundamentals/infrastructure">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Microsoft はどのように Azure のインフラストラクチャを保護していますか?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">セキュリティで保護されたアプリケーションの開発とデプロイ</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">安全な開発のベスト プラクティス</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Azure のネットワーク セキュリティ</a>
                            </li>
                            <li style="list-style: none;">
