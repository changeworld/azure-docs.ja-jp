...
| :------------- | :------------- |:------------- |:------------- |:------------- |
|   [ディレクトリ オブジェクト](../../active-directory/active-directory-whatis.md)、[ユーザーとグループの管理 (追加/更新/削除)、ユーザーベースのプロビジョニング、デバイスの登録](../../active-directory/active-directory-whatis.md)、[シングル サインオン (SSO)](../../active-directory/active-directory-whatis.md)、[クラウド ユーザーのセルフ サービスによるパスワード変更](../../active-directory/active-directory-whatis.md)、[Connect (Azure Active Directory にオンプレミスのディレクトリを拡張する同期エンジン)](../../active-directory/active-directory-whatis.md)、[セキュリティと使用状況に関するレポート](../../active-directory/active-directory-whatis.md)       |   [グループベースのアクセス管理/プロビジョニング](../../active-directory/active-directory-whatis.md)、[クラウド ユーザーに対するセルフサービス パスワード リセット](../../active-directory/active-directory-whatis.md)、[会社のブランド設定 (ログオン ページやアクセス パネルのカスタマイズ)](../../active-directory/active-directory-whatis.md)、[アプリケーション プロキシ](../../active-directory/active-directory-whatis.md)、[SLA 99.9%](../../active-directory/active-directory-whatis.md) |  [セルフ サービスのグループおよびアプリケーション管理/セルフ サービスのアプリケーション追加/動的グループ](../../active-directory/active-directory-whatis.md)、[セルフサービス パスワード リセット/変更/ロック解除とオンプレミスの書き戻し](../../active-directory/active-directory-whatis.md)、[Multi-Factor Authentication (クラウドおよびオンプレミス (MFA サーバー))](../../active-directory/active-directory-whatis.md)、[MIM CAL + MIM サーバー](../../active-directory/active-directory-whatis.md)、[Cloud App Discovery](../../active-directory/active-directory-whatis.md)、[Connect Health](../../active-directory/active-directory-whatis.md)、[グループ アカウントのパスワードの自動ロールオーバー](../../active-directory/active-directory-whatis.md)|    [ID の保護](../../active-directory/identity-protection/overview.md)、[Privileged Identity Management](../../active-directory/privileged-identity-management/pim-configure.md)|   [Azure AD へのデバイスの参加、デスクトップ SSO、Azure AD 用の Microsoft Passport、管理者による BitLocker の復旧](../../active-directory/active-directory-whatis.md)、[MDM 自動登録、セルフサービスの BitLocker の復旧、Azure AD Join を介した Windows 10 デバイスへのローカル管理者の追加](../../active-directory/active-directory-whatis.md)|
