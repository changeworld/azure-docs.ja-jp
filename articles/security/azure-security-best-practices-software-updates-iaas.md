...
---
# <a name="best-practices-for-software-updates-on-microsoft-azure-iaas"></a>Microsoft Azure IaaS でのソフトウェアの更新のためのベスト プラクティス
...
## <a name="initial-assessment"></a>最初の評価
...
## <a name="establish-a-baseline"></a>ベースラインの確立
...
## <a name="subscribe-to-the-appropriate-software-update-notification-services"></a>適切なソフトウェア更新プログラム通知サービスのサブスクライブ
...
## <a name="software-update-considerations"></a>ソフトウェアの更新に関する注意点
