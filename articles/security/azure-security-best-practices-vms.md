...
リソース グループに属する VM は、そのポリシーを自然に継承します。 この方法で VM を管理することをお勧めしますが、[ロールベースのアクセス制御 (RBAC)](../role-based-access-control/role-assignments-portal.md) を使って、個々の VM に対するアクセス ポリシーを制御することもできます。
