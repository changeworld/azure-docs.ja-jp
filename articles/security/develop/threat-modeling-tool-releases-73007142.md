---
title: Microsoft Threat Modeling Tool のリリース 2020 年 7 月 14 日 - Azure
description: Threat Modeling Tool リリース 7.3.00714.2 のリリース ノートです。
author: jegeib
ms.author: jegeib
ms.service: security
ms.topic: article
...
バージョン 7.3.00714.2 の Microsoft Threat Modeling Tool (TMT) が 2020 年 7 月 14 日にリリースされました。変更点は以下のとおりです。
