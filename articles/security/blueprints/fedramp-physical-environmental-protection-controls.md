---
title: "FedRAMP Azure Blueprint Automation - 物理的および環境的保護"
description: "FedRAMP 用の Web アプリケーション - 物理的および環境的保護"
services: security
...
|||
|---|---|
| **顧客** | 顧客のエンタープライズ レベルの物理的および環境的保護に関するポリシーと手順は、このコントロールに対処するために十分である可能性があります。 |
