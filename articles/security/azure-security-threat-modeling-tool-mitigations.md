---
title: "緩和策 - Microsoft 脅威モデリング ツール - Azure |Microsoft ドキュメント"
description: "Microsoft 脅威モデリング ツールに公開されている最も考えられる解決策を強調表示の緩和策のページには、脅威が生成されます。"
services: security
...
---
# <a name="microsoft-threat-modeling-tool-mitigations"></a>Microsoft 脅威モデリング ツールの緩和策
...
## <a name="mitigation-categories"></a>軽減策カテゴリ
...
| **[構成の管理](./azure-security-threat-modeling-tool-configuration-management.md)** | アプリケーションがだれとして実行されるか。 どのデータベースに接続するか。 アプリケーションはどのように管理されるか。 これらの設定はどのように保護されるか。 構成管理とは、アプリケーションがこれらの操作上の問題を扱う方法のことです |
...
| **[例外の管理](./azure-security-threat-modeling-tool-exception-management.md)** | アプリケーションで呼び出したメソッドが失敗した場合、アプリケーションはどうするか。 どの程度公開するか。 エンド ユーザーにわかりやすいエラー情報を返すか。 呼び出し元に有益な例外情報を戻すか。 アプリケーションの失敗時に正常に終了させるか。 |
...
そのため、これらのカテゴリを使用して、セキュリティに関連する作業の対象と優先順位を定めることができます。最も一般的なセキュリティの問題が入力の検証、認証、および承認のカテゴリで発生することが判明した場合は、そこから作業を開始できます。 詳細については、次を参照してください**[この特許リンク。](https://www.google.com/patents/US7818788)**

## <a name="next-steps"></a>次のステップ

参照してください**[脅威モデリング ツールの上の脅威](./azure-security-threat-modeling-tool-threats.md)**可能性がある設計上の脅威を生成するツールを使用して脅威のカテゴリに関する詳細についてはします。