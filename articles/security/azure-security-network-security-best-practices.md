...
Azure Application Gateway のしくみと、使用しているデプロイでの使用方法の詳細については、[Application Gateway の概要](../application-gateway/application-gateway-introduction.md)に関する記事をご覧ください。
