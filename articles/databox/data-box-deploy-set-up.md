...
4. 100 TB ストレージ デバイスで使用するためのアース端子付き電源ケーブル 1 本を受け取っていること。
...
3. 電源ケーブルとネットワーク ケーブルを接続します。 一般的な構成で接続したデバイスのバックプレーンを以下に示します。 
    
    ![ケーブルを配線した Data Box デバイスのバックプレーン](media/data-box-deploy-set-up/data-box-cabled-dhcp.png)
    ...
    5. データ ポートに接続したケーブルのもう一方の端は、10 GbE スイッチを介してホスト コンピューターに接続します。
