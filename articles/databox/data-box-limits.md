...
## <a name="data-box-service-limits"></a>Data Box サービスの制限
 ...
 - Data Box サービスは、米国における [Azure パブリック クラウドのすべての Azure リージョン](https://azure.microsoft.com/regions/)でのみ利用できます。
...
- Data Box は、最大で 500 万件のファイルを格納できます。
