...
気象データを取得するには、確実に [FarmBeats をインストール](https://aka.ms/farmbeatsinstalldocumentation)してください。 気象の統合は、バージョン 1.2.11 以降でサポートされています。 
