...
1. Farm Accelerator にログインすると、 **[Farms]\(ファーム\)** ページが表示されます。
    **[Farms]\(ファーム\)** ページにはファームの一覧が表示されます (サブスクリプションに既に作成されている場合)。
    ...
    ![プロジェクト (Farm Beats)](./media/create-farms/create-farm-main-page-1.png)
...
1. **[Mark on Map]\(マップにマーク\)** : マップ管理ツールを使用して、ファームの境界線を描画してマークします。 境界をマークするには、![[Project Farm Beats]\(プロジェクト (Farm Beats)\)](./media/create-farms/pencil-icon-1.png) で、正確な境界をマークします。

    ![プロジェクト (Farm Beats)](./media/create-farms/create-farm-mark-on-map-1.png)
...
ヒントを使用すると、情報の入力に役立ちます。
    ...
    ![プロジェクト (Farm Beats)](./media/create-farms/create-new-farm-1.png)

4.  **[送信]** を選択してファームを作成します。 新しいファームが作成され、 **[Farms]\(ファーム\)** ページに表示されます。
...
2.  **[Delete Farm]\(ファームの削除\)** を選択して、ファームを削除します。
    ...
    ![プロジェクト (Farm Beats)](./media/create-farms/delete-farm-1.png)
