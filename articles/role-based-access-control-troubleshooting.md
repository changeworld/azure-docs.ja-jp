...
所有者と共同作成者には管理操作に対するフル アクセス許可があります。両者の違いは、共同作成者が他のユーザーやグループにアクセス権を付与できないことです。閲覧者の役割はさらに興味深いので、以下で詳しく考慮します。正確にアクセス権を付与する方法の詳細については、[この記事を参照してください](http://azure.microsoft.com/ja-jp/documentation/articles/role-based-access-control-configure/)。
