...
## 方法: 作業項目をバックログに追加する 
1. チーム プロジェクト ブレードに移動します。

2. 下部にある [作業] レンズ内で、[バックログ] パーツをクリックします。 
...
3. 項目を追加するには、上部にあるテキスト ボックスにタイトルを入力し、Enter キーを押します。
	...
	Scrum のプロセス テンプレートを使用している場合は、バグや製品のバックログ項目を右側のドロップダウンから選択して追加できます。 
...
5. 作業項目フォームでは、タイトルの編集、説明の追加、ユーザーへの割り当て、完了マークの設定を実行できます。 

6. 作業項目フォームの下部では、作業項目へのコメントの追加やその項目の履歴の表示を実行できます。
	
	作業項目の履歴を調べるには、変更箇所をクリックします。ブレードが開いて、これまで実行された作業の詳細が表示されます。 

## 方法: バックログを管理する

作業を優先順位付けしたバックログを維持することは、Web サイトの作業を管理するための鍵となります。これは次の 2 つに分けられます。 
