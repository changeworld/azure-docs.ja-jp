...
* Microsoft Monitoring Agent がインストールされており、同エージェントが OMS ワークスペースに直接接続している Windows コンピューター
* OMS Agent for Linux が OMS ワークスペースに直接接続されている Linux コンピューター  
* System Center Operations Manager 2012 SP1 with UR7、Operations Manager 2012 R2 with UR3、またはOperations Manager 2016 の管理グループのうち、OMS と統合しているもの  
