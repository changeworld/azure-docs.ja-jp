...
>[AZURE.NOTE] 使用する必要がある範囲構文は、コロン (:) 区切り記号であり (field:value)、等号 (=) は使用 "*しません*"。 範囲の下限と上限を 2 つのピリオド(..) で区切り、全体を角かっこで囲みます。
