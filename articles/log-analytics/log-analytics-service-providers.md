<properties
    pageTitle="Log Analytics のサービス プロバイダー向け機能 | Microsoft Azure"
...
>[AZURE.NOTE] Log Analytics の Backup ソリューションと Site Recovery ソリューションは、Recovery Services コンテナーに接続できず、CSP サブスクリプションでは構成できません。
