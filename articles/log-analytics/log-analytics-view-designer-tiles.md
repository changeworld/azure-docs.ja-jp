---
title: "Azure Log Analytics ビュー デザイナー タイル リファレンス | Microsoft Docs"
description: "Log Analytics のビュー デザイナーを使用すると、Azure Portal に、Log Analytics ワークスペースのデータのさまざまな視覚化を含むカスタム ビューを作成できます。 この記事は、カスタム ビューで使用できるタイルについて、タイルごとに設定を説明しています。"
...
Log Analytics のビュー デザイナーを使用すると、Azure Portal に、Log Analytics ワークスペースのデータのさまざまな視覚化を含むカスタム ビューを作成できます。 この記事は、カスタム ビューで使用できるタイルについて、タイルごとに設定を説明しています。
