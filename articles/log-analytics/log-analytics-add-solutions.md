...
| [更新プログラムのコンプライアンス](https://technet.microsoft.com/en-us/itpro/windows/manage/update-compliance-get-started) <br>(プレビュー)                                                             | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>     | 無料<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)     | データまたはノードに対する課金はありません。 |
| [Upgrade Readiness](https://technet.microsoft.com/itpro/windows/deploy/manage-windows-upgrades-with-upgrade-readiness)                                                             | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>     | 無料<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)     | データまたはノードに対する課金はありません。 |
