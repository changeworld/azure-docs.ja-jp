...
8. 必要に応じて、Azure サブスクリプション、リソース グループ、および場所に関するワークスペースの設定を変更します。 **[Automation オプション]** を選択することもできます。 **Create** をクリックしてください。  
...
次の表に、どの管理ソリューションが各 Operations Management Suite に属するかを特定します。
...
| ---                                                                                       | ---                                                                       | ---                                                                                                       | ---   |
| [アクティビティ ログ分析](log-analytics-activity.md)                                                                   | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | 90 日間のデータを無料で使用できます。<br>Free レベル キャップの対象とならないデータ |
| [AD 評価](log-analytics-ad-assessment.md)                                           | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
| [AD レプリケーションの状態](log-analytics-ad-replication-status.md)                           | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | Azure ポータル/Marketplace からの追加には使用できません。 |
| [Agent Health](../operations-management-suite/oms-solution-agenthealth.md)                                                                                | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | Free レベル キャップの対象とならないデータ<br> Azure ポータル/Marketplace からの追加には使用できません。 |
| [アラートの管理](log-analytics-solution-alert-management.md)                            | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | Azure ポータル/Marketplace からの追加には使用できません。 |
| [Application Insights Connector (プレビュー)](log-analytics-app-insights-connector.md)                                               | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
| [Automation Hybrid Worker](../automation/automation-hybrid-runbook-worker.md)                                                                     | <ul><li>Automation and Control</li></ul>                                  | 無料<br> &nbsp;ノード&nbsp;単位 (OMS)                                                                         | Log Analytics ワークスペースを Automation アカウントにリンクする必要があります。 |
| [Azure Application Gateway 分析](log-analytics-azure-networking-analytics.md)    | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
| [Azure ネットワーク セキュリティ グループ分析](log-analytics-azure-networking-analytics.md)     | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
...
| [Azure Web Apps Analytics](log-analytics-azure-web-apps-analytics.md)     | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
...
| [Logic Apps B2B](../logic-apps/logic-apps-track-b2b-messages-omsportal.md)                    | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | Azure ポータル/Marketplace からの追加には使用できません。 |
| [マルウェアの評価](log-analytics-malware.md)                                            | <ul><li>セキュリティとコンプライアンス</li></ul>                                 | 無料<br> スタンドアロン<br>&nbsp;ノード&nbsp;単位 (OMS)                                                                           | セキュリティとコンプライアンスのソリューションを追加すると、2017 年 6 月 19 日以降、ワークスペースの価格レベルに関係なく、[課金はノードごとに行われます](https://azure.microsoft.com/pricing/details/security-compliance/)。 最初の 60 日間は無料です。  |
| [ネットワーク パフォーマンス監視](log-analytics-network-performance-monitor.md) <br>  | <ul><li>洞察と分析</li></ul>                                   | 無料<br> &nbsp;ノード&nbsp;単位 (OMS)                                                                         | |
| [Office 365 Analytics (プレビュー)](../operations-management-suite/oms-solution-office-365.md)                                                       | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
| [セキュリティと監査](../operations-management-suite/oms-security-getting-started.md)      | <ul><li>Security&nbsp;and&nbsp;Compliance</li></ul>                       | 無料<br> スタンドアロン<br>&nbsp;ノード&nbsp;単位 (OMS)                                                                           | セキュリティ イベント ログの収集にはこのソリューションが必要です。<br>セキュリティとコンプライアンスのソリューションを追加すると、2017 年 6 月 19 日以降、ワークスペースの価格レベルに関係なく、[課金はノードごとに行われます](https://azure.microsoft.com/pricing/details/security-compliance/)。 最初の 60 日間は無料です。 |
| [Service Fabric Analytics (プレビュー)](log-analytics-service-fabric.md)                     | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
| [Service Map (プレビュー)](../operations-management-suite/operations-management-suite-service-map.md) | <ul><li>洞察と分析</li></ul>                      | 無料<br> &nbsp;ノード&nbsp;単位 (OMS)                                                                         | 米国東部、西ヨーロッパ、米国中西部で使用できます。    |
| [Site Recovery](../site-recovery/site-recovery-overview.md)                                                                               | <ul><li>洞察と分析</li></ul>                                   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)                                                                       | 従来の Site Recovery コンテナーが必要です。<br> Azure ポータル/Marketplace からの追加には使用できません。 |
| [SQL の評価](log-analytics-sql-assessment.md)                                         | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
...
| [SurfaceHub](log-analytics-surface-hubs.md)                                               | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | Azure ポータル/Marketplace からの追加には使用できません。 |
| [System Center Operations Manager Assessment (プレビュー)](log-analytics-scom-assessment.md)  | <ul><li>洞察と分析</li><li>Log Analytics</li></ul>        | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
| [更新管理](../operations-management-suite/oms-solution-update-management.md)                                                                         | <ul><li>Automation and Control</li></ul>                                  | 無料<br> &nbsp;ノード&nbsp;単位 (OMS)                                                                         | Log Analytics ワークスペースを Automation アカウントにリンクする必要があります。 |
| [Update Compliance (プレビュー)](https://docs.microsoft.com/windows/deployment/update/update-compliance-get-started)                                                             | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | データまたはノードに対する課金はありません。<br>Free レベル キャップの対象とならないデータ。<br> Azure ポータル/Marketplace からの追加には使用できません。 |
| [Upgrade Readiness](https://docs.microsoft.com/windows/deployment/upgrade/upgrade-readiness-get-started)                                                          | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | データまたはノードに対する課金はありません。<br>Free レベル キャップの対象とならないデータ。<br> Azure ポータル/Marketplace からの追加には使用できません。 |
| [VMware Monitoring (プレビュー)](log-analytics-vmware.md)                                | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | 無料<br> 標準<br> Premium&nbsp;(OMS)<br> &nbsp;GB&nbsp;単位 (スタンドアロン)<br> &nbsp;ノード&nbsp;単位 (OMS)   | |
| [Wire Data 2.0 (プレビュー)](log-analytics-wire-data.md)                                                                 | <ul><li>洞察と分析</li></ul>                                   | 無料<br> &nbsp;ノード&nbsp;単位 (OMS)                                                                         | 米国東部、西ヨーロッパ、米国中西部で使用できます。 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| アクティビティ ログ分析 | Azure |   |   |   |   |   | 通知時 |
| AD 評価 |Windows |&#8226; |&#8226; |  |  |&#8226; |7 日 |
| AD レプリケーションの状態 |Windows |&#8226; |&#8226; |  |  |&#8226; |5 日 |
| エージェントの正常性 | Windows および Linux | &#8226; | &#8226; |   |   | &#8226; | 1 分 |
| アラート管理 (Nagios) |Linux |&#8226; |  |  |  |  |着信時 |
| アラート管理 (Zabbix) |Linux |&#8226; |  |  |  |  |1 分 |
| アラート管理 (Operations Manager) |Windows |  |&#8226; |  |&#8226; |&#8226; |3 分 |
| Application Insights コネクタ (プレビュー) | Azure |   |   |   |   |   | 通知時 |
