...
3. 引き続き Azure Portal で作業を行う場合は **[ログ検索]** を選択します。OMS ポータルを起動する場合は **[OMS ポータル]** を選択して、[ログ検索] ボタンをクリックします。
...
![フィルター](media/log-analytics-log-search-log-search-portal/log-search-portal-04.png)
