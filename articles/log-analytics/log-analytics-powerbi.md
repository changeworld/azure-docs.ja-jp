...
まず、Power BI データセットに設定するデータを Log Analytics が返すような[ログ検索](log-analytics-queries.md)を作成します。  次にそのクエリを Power BI Desktop で使用できる [Power Query (M) 言語](https://msdn.microsoft.com/library/mt807488.aspx)にエクスポートします。
...
* [ログ検索](log-analytics-queries.md) について学習し、Power BI にエクスポートできるクエリを作成します。
