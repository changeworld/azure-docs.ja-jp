...
## スケジュール
保存した検索条件には、1 つ以上のスケジュールを設定できます。スケジュールは、検索を実行する頻度と、条件を識別する時間間隔を定義します。スケジュールには、次の表に示したプロパティがあります。
...
Get メソッドを使用して、保存した検索条件の特定のスケジュールを取得します。
...
### スケジュールの作成または編集
新しいスケジュールを作成するには、保存した検索条件に固有のスケジュール ID と共に Put メソッドを使用します。既存のスケジュール ID を使用すると、そのスケジュールが変更されます。OMS コンソールでスケジュールを作成すると、スケジュール ID に対して GUID が作成されます。
...
### アクションの作成または編集
新しいアクションを作成するには、スケジュールに固有のアクション ID と共に Put メソッドを使用します。既存のアクション ID を使用すると、そのアクションが変更されます。OMS コンソールでアクションを作成すると、アクション ID に対して GUID が作成されます。
...
アクション ID と共に Put メソッドを使用して、スケジュールの新しいしきい値アクションを作成します。アクションに対して新しい ID を使用すると、新しいアクションが作成されます。スケジュールに既に存在している ID を使用すると、そのアクションが変更されます。
...
アクション ID と共に Put メソッドを使用して、スケジュールの新しい電子メール アクションを作成します。アクションに対して新しい ID を使用すると、新しいアクションが作成されます。スケジュールに既に存在している ID を使用すると、そのアクションが変更されます。

次の例では、しきい値を含む電子メール通知を作成し、保存した検索条件の結果がしきい値を超えた場合にメールが送信されます。
...
アクション ID と共に Put メソッドを使用して、スケジュールの新しい修復アクションを作成します。アクションに対して新しい ID を使用すると、新しいアクションが作成されます。スケジュールに既に存在している ID を使用すると、そのアクションが変更されます。

次の例では、しきい値を含む修復を作成し、保存した検索条件の結果がしきい値を超えた場合に Runbook が開始されます。
...
#### Webhook アクションの作成または編集
アクション ID と共に Put メソッドを使用して、スケジュールの新しい Webhook アクションを作成します。アクションに対して新しい ID を使用すると、新しいアクションが作成されます。スケジュールに既に存在している ID を使用すると、そのアクションが変更されます。次の例では、Webhook アクションとしきい値を含むアラート アクションとを作成して、保存した検索条件の結果がしきい値を超えたときに Webhook がトリガーされるようにします。
