<properties
    pageTitle="Log Analytics の Azure Key Vault ソリューション | Microsoft Azure"
...
>[AZURE.NOTE] これは[プレビュー ソリューション](log-analytics-add-solutions.md#log-analytics-preview-solutions-and-features)です。
...
2.  Blob Storage からログを読み取るための設定を Log Analytics に対して行います。[Blob Storage 内の JSON ファイル](../log-analytics/log-analytics-azure-storage-json.md)に関するページで説明されている手順に従ってください。
