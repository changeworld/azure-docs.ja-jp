...
サービスによって、サーバーのバックアップが自動的に取得されます。 7 日間から 35 日間までの保持期間を選択できます。 汎用サーバーとメモリ最適化サーバーでは、バックアップに geo 冗長ストレージを与えることを選択できます。 バックアップの詳細については[概念に関するアーティクル](concepts-backup.md) をご覧ください。
