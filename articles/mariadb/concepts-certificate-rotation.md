...
2020 年 10 月 26 日までにルート証明書を更新しない場合、SSL/TLS を使用して接続し、ルート証明書の検証を行っているアプリケーションは、MariaDB データベース サーバーと通信できなくなり、アプリケーションで MariaDB データベース サーバーへの接続に関する問題が発生します。
