...
* [C# AzureSession クラス](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.azuresession)
...
* [C++ AzureSession クラス](https://docs.microsoft.com/cpp/api/remote-rendering/azuresession)
