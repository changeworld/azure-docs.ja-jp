...
詳細については、「[SharePoint Server Farm (SharePoint サーバー ファーム)][SharePoint Server Farm (SharePoint サーバー ファーム)]」を参照してください。
...
-   SharePoint サーバー
  ...
  [SharePoint Server Farm (SharePoint サーバー ファーム)]: ../virtual-machines-sharepoint-farm-azure-preview/
