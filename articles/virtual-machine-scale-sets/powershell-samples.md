...
| [単一ゾーン スケール セットを作成する](scripts/powershell-single-av-zone-scale-set.md?toc=%2fpowershell%2fazure%2ftoc.json) | 単一の可用性ゾーンを使用する仮想マシン スケールを作成します。 |
