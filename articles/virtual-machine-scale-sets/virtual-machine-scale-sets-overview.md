...
## VM スケール セットの作成と管理
[Azure ポータル](https://portal.azure.com)で VM スケール セットを作成するには、*[新規]* を選択して、検索バーに「スケール」と入力します。検索結果として、"仮想マシン スケール セット" が表示されます。そこから必要なフィールドを入力し、スケール セットをカスタマイズしてデプロイします。
