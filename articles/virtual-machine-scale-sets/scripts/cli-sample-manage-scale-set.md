...
拡張ディスクを使用するには、基になるパーティションを拡張します。 詳細については、「[ディスク パーティションとファイル システムの拡張](/azure/virtual-machines/linux/expand-disks#expand-a-disk-partition-and-filesystem)」をご覧ください。
