...
- [Log Analytics ワークスペースについて](/azure/azure-monitor/logs/get-started-queries)
...
- [Azure で仮想マシンを監視する方法](/azure/azure-monitor/vm/monitor-vm-azure)
