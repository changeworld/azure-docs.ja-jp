<properties
	pageTitle="CLI と Portal でのスケール セットの作成 | Microsoft Azure"
...
Portal では、CentOS、CoreOS、Debian、Open Suse、Red Hat Enterprise Linux、SUSE Linux Enterprise Server、または Ubuntu Server イメージを使用してスケール セットを簡単にデプロイすることができます。
