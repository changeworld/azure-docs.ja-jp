<properties
	pageTitle="Azure Batch PowerShell コマンドレットの使用"
...
詳細なコマンドレットの構文については、```get-help <Cmdlet_name>``` を入力してください。
...
* [Azure コマンドレット リファレンス](https://msdn.microsoft.com/library/jj554330.aspx)
