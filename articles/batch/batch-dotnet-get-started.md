...
これでジョブが完了したので、タスクの出力を Azure Storage からダウンロードできます。ダウンロードするには、*DotNetTutorial* の `Program.cs` の `DownloadBlobsFromContainerAsync` を呼び出します。
