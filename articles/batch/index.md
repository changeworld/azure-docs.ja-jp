        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Node.js で Batch の使用を開始する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Batch</h3>
                        <p><a href="/azure/batch/batch-diagnostics">Batch 診断ログ</a></p>
                        <p><a href="/azure/batch/batch-analytics">一括分析</a></p>
                        <p><a href="/azure/batch/batch-compute-node-environment-variables">Batch コンピューティング ノードの環境変数</a></p>
                    </div>
                </div>
            </div>
        </div>
