---
title: Azure Batch でのマルチインスタンス タスクを使用した MPI アプリケーションの実行 | Microsoft Docs
...
> [!NOTE]
> Batch でマルチインスタンス タスクを使用する MPI ソリューションを実装する場合、MS-MPI しか使用できないというわけではありません。 プールのコンピューティング ノードに指定したオペレーティング システムと互換性のある MPI 標準の任意の実装を使用できます。
> 
> 
