...
.NET 以外の開発言語を使用する場合、ファイル規則の標準を独自にアプリケーションに実装できます。 詳細については、「[Batch ファイル規則の標準を実装する](batch-task-output.md#implement-the-batch-file-conventions-standard)」を参照してください。
