...
1. **[すべてのリソース]** ページに移動し、許可リストに登録された NPM ワークスペースをクリックして、Network Performance Monitor の概要タイルに移動します。
...
![スクリーンショットには、ExpressRoute 回路およびピアリングの正常性の概要を表示したダッシュボードが示されています。](./media/how-to-npm/dashboard.png)
