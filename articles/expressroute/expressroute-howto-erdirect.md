...
ExpressRoute Direct リソースを削除する前に、まず ExpressRoute Direct のポートのペアで作成された ExpressRoute 回線を削除する必要があります。
ExpressRoute Direct リソースは、次のコマンドを実行して削除できます。
 ```powershell
