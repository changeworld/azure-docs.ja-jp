...
## Resource Manager デプロイ モデルに ExpressRoute 回線を移行する
...
### 手順 1: クラシック デプロイ モデルからの回線の詳細を収集する
...
### 手順 2: Resource Manager 環境にサインインし、新しいリソース グループを作成する
...
### 手順 3: Resource Manager デプロイ モデルに ExpressRoute 回線を移行する
...
## 両方のデプロイ モデルに対して ExpressRoute 回線を有効にする
...
## クラシック デプロイ モデルに対して ExpressRoute 回線を無効にする
