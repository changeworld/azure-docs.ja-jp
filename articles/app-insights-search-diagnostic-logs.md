<properties title="Search diagnostic logs with Application Insights" pageTitle="診断ログを検索する" description="Search logs generated with Trace, NLog, or Log4Net." metaKeywords="analytics web test" authors="awills"  manager="kamrani" />
