<properties pageTitle="Azure の Web サイトのデプロイ方法" metaKeywords="Azure の Web サイトのデプロイ" description="Learn what methods are available for deploying content to an Azure Website." metaCanonical="" services="web-sites" documentationCenter="" title="How to Deploy an Azure Website" authors="tdykstra" solutions="" manager="wpickett" editor="mollybos" />
