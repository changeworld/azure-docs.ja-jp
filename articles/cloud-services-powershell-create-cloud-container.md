...
1. [Azure PowerShell のダウンロード ページ](http://go.microsoft.com/?linkid=9811175&clcid=0x409)から Microsoft Azure PowerShell コマンドレットをインストールします。詳しい手順について Azure PowerShell コマンドレットをインストールして、Azure サブスクリプションに接続する手順については、[Azure PowerShell をインストールして構成する方法](install-configure-powershell.md)に関するページを参照してください。
...
3. Azure クラウド サービスを作成する方法については、次のコマンドレットを実行します:  
```
