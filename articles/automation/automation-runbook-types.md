...
Python Runbook は、Python スクリプト言語に基づくテキスト Runbook です。 Azure Automation では、Python 2 および Python 3 の両方の Runbook をサポートします。
Python についての詳細は、[https://www.python.org/](https://www.python.org/) をご覧ください。
Python Runbook の例については、「[My first Python runbook in Azure Automation (Azure Automation の初めての Python Runbook)](automation-first-runbook-textual-python2.md)」をご覧ください。

## <a name="bash-runbooks"></a>Bash Runbook

Bash Runbook は、GNU Bash シェルに基づくテキスト Runbook です。 Bash の詳細については、[https://www.gnu.org/software/bash/](https://www.gnu.org/software/bash/) をご覧ください。
