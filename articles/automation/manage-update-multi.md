...
Azure portal で、Automation アカウントを開き、**[更新の管理]** を選択します。

ウィンドウの上部にある **[Azure VM の追加]** を選択します。

![[Azure VM の追加] タブ](./media/manage-update-multi/update-onboard-vm.png)

利用を開始する仮想マシンを選択します。 **[更新管理の有効化]** ダイアログ ボックスが表示されます。 **[有効にする]** を選択して、仮想マシンをオンボードします。 オンボードが完了すると、仮想マシンに対する更新の管理が有効になります。
...
マシンの更新管理を有効にした後は、**[コンピューター]** をクリックしてその情報を表示できます。 コンピューターの情報 (*名前*、*コンプライアンス*、*環境*、*OS の種類*、*重要な更新プログラムとセキュリティ更新プログラム*、*他の更新プログラム*、*エージェントの更新の準備*) が確認できます。
...
エージェントの状態を表示するには、**[エージェントの更新の準備]** 列のリンクをクリックします。 これで、ハイブリッド worker の状態を示すハイブリッド worker のページが開きます。 次の図は、非常に長い時間、Update Management に接続されていないエージェントの例を示しています。
...
**[更新管理]** ダイアログ ボックスの上部にある **[更新プログラムの展開のスケジュール]** を選択して、1 台以上の仮想マシンの新しい更新プログラムの展開をスケジュールします。
**[新しい更新プログラムの展開]** ウィンドウで、次の情報を指定します。

- **[名前]**: 更新プログラムの展開を識別する一意の名前を指定します。
- **[OS の種類]**: [Windows] または [Linux] を選択します。
- **[更新するマシン]**: 更新する仮想マシンを選択します。 マシンの準備状況は、**[エージェントの更新の準備]** 列に示されます。 これにより、更新プログラムのデプロイをスケジュールする前にマシンの正常性状態を確認できます。
