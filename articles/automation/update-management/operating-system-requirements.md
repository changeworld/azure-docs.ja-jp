...
|SUSE Linux Enterprise Server 12、15、および 15.1 (x64)     | Linux エージェントでは、更新リポジトリへのアクセス権が必要です。     |
...
オペレーティング システム固有の要件については、次の情報を参照してください。 追加のガイダンスについては、「[ネットワークの計画](plan-deployment.md#ports)」を参照してください。 TLS 1.2 の要件を理解するには、「[Azure Automation に対する TLS 1.2 の強制](../automation-managing-data.md#tls-12-enforcement-for-azure-automation)」を参照してください。
