---
title: Azure Automation のセキュリティ | Microsoft Docs
...
| メソッド | 環境 | 記事 |
| --- | --- | --- |
| Azure AD ユーザー アカウント |Azure リソース マネージャーと Azure サービス管理 |[Authenticate Runbooks with Azure AD User account (Azure AD ユーザー アカウントでの Runbook の認証)](automation-sec-configure-aduser-account.md) |
...
| Windows 認証 |オンプレミスのデータセンター |[Azure Automation の Hybrid Runbook Worker](automation-hybrid-runbook-worker.md) |
| AWS 資格情報 |Amazon Web Services |[Authenticate Runbooks with Amazon Web Services (AWS) (Amazon Web Services (AWS) での Runbook の認証)](automation-sec-configure-aws-account.md) |
