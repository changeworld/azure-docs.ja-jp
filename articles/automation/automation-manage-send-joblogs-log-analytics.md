...
ログを表示するには、Log Analytics のログ検索で次のクエリを実行します:`Type=AzureDiagnostics ResourceProvider="MICROSOFT.AUTOMATION"`
...
Azure Automation の診断から、Log Analytics に 2 種類のレコードが作成され、タグ **Type=AzureDiagnostics** が付けられます。
