...
### Azure クラシック ポータルで新しい証明書を作成するには
1. Automation アカウントから、ウィンドウの上部にある **[資産]** をクリックします。
2. ウィンドウの下部にある **[設定の追加]** をクリックします。
3. **[資格情報の追加]** をクリックします。
4. **[資格情報の種類]** ドロップダウンで、**[証明書]** を選択します。
5. **[名前]** ボックスに証明書の名前を入力し、右矢印をクリックします。
...
5. **[証明書ファイルをアップロードします]** の **[ファイルの選択]** をクリックして、.cer または .pfx ファイルを参照します。.pfx ファイルを選択する場合は、パスワードおよびエクスポートを許可するかどうかを指定します。
