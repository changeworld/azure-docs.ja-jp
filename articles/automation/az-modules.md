...
ms.locfileid: "56585064"
---
# <a name="az-module-support-in-azure-automation"></a>Az module support in Azure Automation
...
## <a name="migrating-to-az-modules"></a>Migrating to Az modules
...
### <a name="stop-and-unschedule-all-runbook-that-uses-azurerm-modules"></a>Stop and unschedule all runbook that uses AzureRM modules
...
### <a name="import-the-az-modules"></a>Import the Az modules
...
## <a name="test-your-runbooks"></a>Test your runbooks
...
## <a name="after-migration-details"></a>After migration details
