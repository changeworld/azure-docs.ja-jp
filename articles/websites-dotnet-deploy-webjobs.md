<properties urlDisplayName="Deploy Azure WebJobs to Azure Websites" pageTitle="Azure Web サイトへの Web ジョブのデプロイ" metaKeywords="Azure Websites, Web ジョブ, バックグラウンド タスク" description="Visual Studio を使用して Azure Web ジョブを Azure Websites にデプロイする方法について説明します。" metaCanonical="" services="web-sites" documentationCenter="" title="Deploy Azure WebJobs to Azure Websites" authors="tdykstra"  solutions="" manager="wpickett" editor="mollybos" />
