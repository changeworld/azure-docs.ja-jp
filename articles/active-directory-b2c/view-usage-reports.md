...
[Azure AD B2C の最新の価格](https://azure.microsoft.com/pricing/details/active-directory-b2c/)と組み合わせることで、毎日、毎週、および毎月の Azure の消費量を見積もることができます。  全体のコストに影響する可能性があるテナント動作の変更を計画する場合は、特に見積もりが役立ちます。 実際のコストは、[リンクされている Azure サブスクリプション](billing.md)で確認できます。
