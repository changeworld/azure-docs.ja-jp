...
3. [ここ](./custom-policy-ui-customization.md#3-configure-cors)の CORS の要件に従って、選択したプロバイダーで HTML ファイルをホストします
