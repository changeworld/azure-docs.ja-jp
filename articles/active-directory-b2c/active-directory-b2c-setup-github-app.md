...
4. **[Authorization callback URL]**(承認コールバック URL) に `https://{tenant}.b2clogin.com/te/{tenant}.onmicrosoft.com/oauth2/authresp` を入力します。 **{tenant}** を実際の Azure AD B2C テナントの名前 (例: contosob2c) に置き換えます。
