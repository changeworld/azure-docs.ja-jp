...
# Azure Active Directory B2C プレビュー: サポート要求の提出

[AZURE.INCLUDE [active-directory-b2c-preview-note](../../includes/active-directory-b2c-preview-note.md)]

Azure ポータルで Azure Active Directory (Azure AD) B2C のサポート要求を提出するには、次の手順に従います。
...
7. **[連絡先情報]** ブレードで、自分の連絡先情報を追加します。**[作成]** をクリックします。*注: プレビュー期間中は、Azure AD B2C のサポートは英語でのみ提供されます。*
