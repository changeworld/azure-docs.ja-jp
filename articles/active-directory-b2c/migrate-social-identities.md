...
この記事は、ユーザー移行記事の続編であり、ソーシャル ID の移行に焦点を当てています。 作業を開始する前に、[ユーザー移行](user-migration.md)に関する記事をお読みください。
...
サンプル アプリの使い方について詳しくは、「[Azure Active Directory B2C: ユーザー移行](user-migration.md)」をご覧ください。
