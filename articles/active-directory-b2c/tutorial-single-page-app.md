...
このチュートリアルでは、Azure Active Directory B2C (Azure AD B2C) を使用して、[OAuth 2.0 認可コード フロー](./authorization-code-flow.md) ([MSAL.js](https://github.com/AzureAD/microsoft-authentication-library-for-js/tree/dev/lib/msal-browser) を使用) を使用するシングルページ アプリケーション (SPA) でユーザーをサインアップおよびサインインする方法について説明します。
...
#### <a name="app-registrations"></a>[アプリの登録](#tab/app-reg-auth/)
