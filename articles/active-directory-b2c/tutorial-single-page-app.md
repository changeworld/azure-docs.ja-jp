...
1. サインアップ ワークフローによって、メール アドレスを使用してユーザーの ID を収集および確認するためのページが表示されます。 また、サインアップ ワークフローでは、ユーザー フローで定義されているユーザーのパスワードと要求された属性も収集されます。
    ...
    ![サインインまたはサインアップ ユーザー フローによって表示されるサインアップ ページ](./media/tutorial-single-page-app/azure-ad-b2c-sign-up-workflow.png)
...
> [チュートリアル:Azure AD B2C を使用して SPA から ASP.NET Core Web API へのアクセスを許可する](tutorial-single-page-app-webapi.md)
