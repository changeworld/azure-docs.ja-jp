...
3. ストレージ アカウントの**サブスクリプション**を選択します。
4. **リソース グループ**を作成するか、既存のリソース グループを選択します。
5. ストレージ アカウント用に一意の**名前**を入力します。
6. ストレージ アカウントの**地理的な場所**を選択します。 
7. **[デプロイ モデル]** は **[リソース マネージャー]** のまま残してかまいません。
8. **[パフォーマンス]** は **[標準]** のまま残してかまいません。
9. **[Account Kind]** (アカウントの種類) を **[Blob Storage]** に変更します。
10. **[レプリケーション]** は **[RA-GRS]** のまま残してかまいません。
11. **[アクセス レベル]** は **[ホット]** のまま残してかまいません。 
12. **[確認および作成]** をクリックして、ストレージ アカウントを作成します。  
