---
title: Active Directory B2C におけるユーザー アクセスの管理 | Microsoft Docs
...
2. **MinorConsent** ノードが国の要素に存在する場合: <br>a.[サインオン URL] ボックスに、次のパターンを使用して、ユーザーが RightScale アプリケーションへのサインオンに使用する URL を入力します。 ユーザーが成人と見なされるために生まれている必要がある日付の最小値を計算します。 例: 生年月日が 2015 年 3 月 14 日で **MinorConsent** が 18 の場合、最小生年月日は 2000 年 3 月 14 日です。
