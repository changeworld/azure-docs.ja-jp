<properties
	pageTitle="Azure Active Directory B2C: 拡張可能なポリシー フレームワーク | Microsoft Azure"
...
8. **[作成]** をクリックします。作成したポリシーが **[Sign-up policies (サインアップ ポリシー)]** ブレードに "**B2C\_1\_SiUp**" と表示されます (**B2C\_1\_** フラグメントが自動的に追加されます)。
