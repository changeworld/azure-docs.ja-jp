...
| **error_sms_throttled** | テキスト メッセージの数が上限に達しました。 すぐにもう一度お試しください。 |
| **error_phone_throttled** | 呼び出しの試行回数が上限に達しました。 すぐにもう一度お試しください。 |
| **error_throttled** | 確認の試行回数が上限に達しました。 すぐにもう一度お試しください。 |
