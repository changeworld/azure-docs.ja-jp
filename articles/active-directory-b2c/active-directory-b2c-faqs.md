...
- サブスクリプション管理者として [Azure クラシック ポータル](https://manage.windowsazure.com/)にサインインします。(これは、Azure へのサインアップに使用したものと同じ職場/学校アカウント、または同じ Microsoft アカウントです)。
...
**ユーザー**、**アプリケーション**、または他のオブジェクトを B2C テナントに既に作成している場合は、これらの手順を行う前に削除する必要があります。
