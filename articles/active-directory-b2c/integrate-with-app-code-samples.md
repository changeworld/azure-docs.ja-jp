---
title: Azure Active Directory B2C をサンプル アプリと統合する | Microsoft Docs
description: Azure AD B2C とモバイル、デスクトップ、Web、およびシングルページ アプリケーションを統合するためのコード サンプル。
