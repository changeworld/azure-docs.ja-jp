...
1. **[Link an existing Azure AD B2C Tenant to my Azure subscription]\(既存の Azure AD B2C テナントを Azure サブスクリプションにリンクする\)** を選択します。 この手順を行うには、所有者ロールとしてログインする必要があります。
