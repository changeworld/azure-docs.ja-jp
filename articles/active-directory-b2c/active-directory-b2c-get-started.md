...
5. 新しいブラウザー タブまたはウィンドウで、B2C 機能ブレードが含まれた Azure Portal が開きます。
   
   > [!IMPORTANT]
   > テナントが Azure Portal でアクセスできるようになるまでに、最大で 2 ～ 3 分かかる場合があります。 しばらく待ってからこれらの手順をもう一度試すと、これは修正されます。 解決されない場合は、サポートにご連絡ください。
   > 
   > 
