...
[!NOTE]
現在、Azure AD B2C ディレクトリのユーザーを管理するには、[Azure AD Graph API](https://msdn.microsoft.com/Library/Azure/Ad/Graph/howto/azure-ad-graph-api-operations-overview?f=255&MSPPError=-2147217396) を使う必要があります。
