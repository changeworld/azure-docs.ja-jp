...
---
# <a name="azure-active-directory-b2c-modify-signup-to-add-new-claims-and-configure-user-input"></a>Azure Active Directory B2C: 新しい要求を追加するようにサインアップを変更し、ユーザー入力を構成します。
...
ユーザーに市区町村の入力を求めることにしましょう。  TrustFrameWorkExtensions ポリシー ファイル内の `<ClaimsSchema>` 要素に以下の要素を追加します。
```
        <ClaimType Id="city">
...
## <a name="add-the-claim-to-the-singupsign-user-journey"></a>サインアップ/サインイン ユーザー体験に要求を追加する
...
テスト モードのサインアップ画面は、次のようになります。![変更されたサインアップ オプションのスクリーンショット](./media/active-directory-b2c-configure-signup-self-asserted-custom/signup-with-city-claim-dropdown-example.png)
...
## <a name="optional-remove-email-verification-from-signup-journey"></a>サインアップ体験から電子メール確認をオプションで削除する
