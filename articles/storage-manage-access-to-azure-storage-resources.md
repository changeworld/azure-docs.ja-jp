...
|--------------------------------------------------------|--------------------------------------------------|-----------------------------------------|---------------------------------------------------|
| List Containers                                        | ListContainers                                   | 所有者のみ                              | 所有者のみ                                        |
| Create Container                                       | 作成                                           | 所有者のみ                              | 所有者のみ                                        |
| Get Container Properties                               | プロパティ                                       | すべて                                     | 所有者のみ                                        |
| Get Container Metadata                                 | Metadata                                         | すべて                                     | 所有者のみ                                        |
| Set Container Metadata                                 | Metadata                                         | 所有者のみ                              | 所有者のみ                                        |
| Get Container ACL                                      | BlobContainerPermissions                         | 所有者のみ                              | 所有者のみ                                        |
| Set Container ACL                                      | BlobContainerPermissions                         | 所有者のみ                              | 所有者のみ                                        |
| Delete Container                                       | 削除                                           | 所有者のみ                              | 所有者のみ                                        |
| List Blobs                                             | ListBlobs                                        | すべて                                     | 所有者のみ                                        |
| Put Blob                                               | CloudPageBlob または CloudBlockBlob の Create メソッド | 所有者のみ                              | 所有者のみ                                        |
| Get Blob                                               | DownloadByteArray and others                     | すべて                                     | すべて                                               |
| Get Blob Properties                                    | プロパティ                                       | すべて                                     | すべて                                               |
| Set Blob Properties                                    | SetProperties                                    | 所有者のみ                              | 所有者のみ                                        |
| Get Blob Metadata                                      | Metadata                                         | すべて                                     | すべて                                               |
| Set Blob Metadata                                      | Metadata                                         | 所有者のみ                              | 所有者のみ                                        |
| Put Block                                              | PutBlock                                         | 所有者のみ                              | 所有者のみ                                        |
| Get Block List (REST API) (コミット後のブロックのみ)                 | DownloadBlockList                                | すべて                                     | すべて                                               |
| Get Block List (REST API) (コミット前のブロックのみまたは全ブロック) | DownloadBlockList                                | 所有者のみ                              | 所有者のみ                                        |
| Put Block List                                         | PutBlockList                                     | 所有者のみ                              | 所有者のみ                                        |
| Delete Blob                                            | 削除                                           | 所有者のみ                              | 所有者のみ                                        |
| BLOB のコピー                                              | CopyFromBlob                                     | 所有者のみ                              | 所有者のみ                                        |
| Snapshot Blob                                          | CreateSnapshot                                   | 所有者のみ                              | 所有者のみ                                        |
| Lease Blob                                             | 占有                                            | 所有者のみ                              | 所有者のみ                                        |
| Put Page                                               | WritePages                                       | 所有者のみ                              | 所有者のみ                                        |
| Get Page Ranges                                        | GetPageRanges                                    | すべて                                     |                                                   |
...
>[AZURE.NOTE]共有アクセス署名に関する詳細な概要とチュートリアルが必要な場合、「[共有アクセス署名](http://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/)」をご覧ください。
...
共有アクセス署名の URI の形式に関する詳細については、「[共有アクセス署名を使用したアクセスの委任](https://msdn.microsoft.com/library/ee395415.aspx)」をご覧ください。
