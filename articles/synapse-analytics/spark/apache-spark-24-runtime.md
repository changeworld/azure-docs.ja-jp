...
description: Apache Spark 2.4 でサポートされている Spark、Scala、Python、.NET の各バージョン。
...
ms.locfileid: "122429244"
---
# <a name="azure-synapse-runtime-for-apache-spark-24"></a>Azure Synapse Runtime for Apache Spark 2.4

Azure Synapse Analytics は、Apache Spark の複数のランタイムをサポートしています。 このドキュメントでは、Azure Synapse Runtime for Apache Spark 2.4 のランタイム コンポーネントとバージョンについて説明します。
