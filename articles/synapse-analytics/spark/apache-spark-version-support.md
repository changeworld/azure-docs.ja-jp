...
Azure Synapse Analytics サービスの Apache Spark では、さまざまなランタイムおよびサービスがサポートされています。このドキュメントでは、サポートされているバージョンの一覧を示します。

## <a name="spark-version"></a>Spark のバージョン

Spark 2.4 は現在サポートされているバージョンです。

## <a name="operating-system-version"></a>オペレーティング システムのバージョン

Azure Synapse の Apache Spark は Ubuntu バージョン 16.04 で動作します。
...
Azure Synapse の Apache Spark には Scala 2.11.12 が含まれています
...
Azure Synapse の Apache Spark には Python バージョン 3.6.1 のインストールが含まれています
