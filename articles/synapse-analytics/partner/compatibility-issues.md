...
* [Azure Synapse Analytics の専用 SQL プールの T-SQL 言語要素。](../sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements.md)
* [Azure Synapse Analytics の専用 SQL プール用にサポートされている T-SQL ステートメント。](../sql-data-warehouse/sql-data-warehouse-reference-tsql-statements.md)