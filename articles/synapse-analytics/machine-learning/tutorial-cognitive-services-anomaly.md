...
ms.locfileid: "96464459"
---
# <a name="tutorial-anomaly-detection-with-cognitive-services-preview"></a>チュートリアル:Cognitive Services を使用した異常検出 (プレビュー)

このチュートリアルでは、[Cognitive Services](https://go.microsoft.com/fwlink/?linkid=2147492) を使用して Azure Synapse でデータを簡単に強化する方法について学習します。 [Anomaly Detector](https://go.microsoft.com/fwlink/?linkid=2147493) を使用して異常検出を実行します。 Azure Synapse のユーザーは、異常を検出するために強化するテーブルを選択するだけです。
...
これで、セルを **すべて実行** して、異常検出を実行できます。 [Cognitive Services - Anomaly Detector](https://go.microsoft.com/fwlink/?linkid=2147493) の詳細を確認してください。
