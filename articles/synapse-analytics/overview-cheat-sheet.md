...
## <a name="synapse-sql-terminology"></a>Synapse SQL の用語
...
## <a name="apache-spark-for-synapse-terminology"></a>Synapse 用 Apache Spark の用語
...
## <a name="pipelines-terminology"></a>パイプラインの用語
