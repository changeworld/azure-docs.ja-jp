...
サポートされている出力の種類は、Parquet と CSV だけです。 その他の種類については、[Azure フィードバック サイト](https://feedback.azure.com/forums/307516-azure-synapse-analytics/)で投票することができます。
