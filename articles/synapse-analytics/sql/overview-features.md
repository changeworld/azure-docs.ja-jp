...
| **MERGE ステートメント** | はい ([プレビュー](https://docs.microsoft.com/sql/t-sql/statements/merge-transact-sql?view=sql-server-ver15)) | いいえ |
