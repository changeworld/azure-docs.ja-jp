...
> [!NOTE]
> Synapse SQL オンデマンドでは SQL Server カタログ ビューのみがサポートされます。  

## <a name="sql-pool-catalog-views"></a>SQL プールのカタログ ビュー
...
* [sys.pdw_materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (プレビュー)
* [sys.pdw_materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (プレビュー)
* [sys.pdw_materialized_view_mappings](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (プレビュー)
...
* [sys.workload_management_workload_classifier_details](/sql/relational-databases/system-catalog-views/sys-workload-management-workload-classifier-details-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (プレビュー)
* [sys.workload_management_workload_classifiers](/sql/relational-databases/system-catalog-views/sys-workload-management-workload-classifiers-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (プレビュー)

## <a name="sql-pool-dynamic-management-views-dmvs"></a>SQL プールの動的管理ビュー (DMV)
...
## <a name="sql-server-dmvs-applicable-to-sql-pool"></a>SQL プールに適用可能な SQL Server DMV
...
SQL プールと、Analytics Platform System の Parallel Data Warehouse (PDW) では、同じシステム ビューが使用されます。 各 DMV には pdw_node_id という列があります。これは、コンピューティング ノードの識別子です。
...
詳細については、[Synapse SQL の T-SQL ステートメント](/sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements)および [Synapse SQL の T-SQL 言語要素](/sql-data-warehouse/sql-data-warehouse-reference-tsql-statements)に関するページを参照してください。
