---
title: 管理と監視 - 概要
description: Synapse SQL プールを使用した、リソース使用率、ログとクエリのアクティビティ、レコメンデーション、およびデータ保護 (バックアップと復元) の監視と管理容易性の概要。
...
Synapse SQL では、SQL プールを使用してデータ ウェアハウスをプロビジョニングすることができます。 以下の記事は、データ ウェアハウスの管理と監視に役立ちます。 また、データ ウェアハウスの使用状況とパフォーマンスを最適化する方法についても説明します。
