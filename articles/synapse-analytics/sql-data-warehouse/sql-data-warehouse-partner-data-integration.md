...
ms.locfileid: "80351487"
---
# <a name="azure-synapse-analytics-data-integration-partners"></a>Azure Synapse Analytics データ統合パートナー
Azure Synapse の SQL Analytics 機能を使用してデータ ウェアハウス ソリューションを作成するため、業界をリードする幅広いツールから選択できます。 この記事では、Azure Synapse をサポートする公式のデータ統合ソリューションを提供している Microsoft パートナー企業について説明します。
