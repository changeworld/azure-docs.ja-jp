...
1. Fortanix Confidential Computing Manager アカウントを持っていない場合は、開始する前に[サインアップ](https://em.fortanix.com/auth/sign-up)します。
...
1. [Fortanix Confidential Computing Manager (Fortanix EM)](https://em.fortanix.com) にサインインします。
...
1. [Fortanix Confidential Computing Manager](https://em.fortanix.com/console) に戻ります
...
作成した Fortanix Confidential Computing Manager アカウントを削除するには、Fortanix Confidential Computing Manager の[アカウント ページ](https://em.fortanix.com/accounts)に移動します。 削除するアカウントにマウス ポインターを移動します。 右上隅の垂直方向の黒いドットを選択し、 **[Delete Account]** を選択します。
