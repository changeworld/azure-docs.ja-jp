<properties 
	pageTitle="Azure App Service における価格レベルのスケーリング" 
	description="Azure App Service で Web アプリ、モバイル アプリ、API アプリ、およびロジック アプリをスケールする方法 (自動スケールを含む) について説明します。" 
...
App Service プランの詳細については、[App Service プラン](web-sites-web-hosting-plan-overview.md)に関するページおよび「[Azure App Service プランの詳細な概要](azure-web-sites-web-hosting-plans-in-depth-overview.md)」を参照してください。App Service の個々のプランの料金と機能の詳細については、[App Service の料金の詳細](/pricing/details/app-service/)に関するページを参照してください。
