...
* [Cloud Foundry on Azure のデプロイ](https://github.com/cloudfoundry-incubator/bosh-azure-cpi-release/blob/master/docs/guidance.md)
...
[アラートを作成](../azure-monitor/alerts/alerts-overview.md)して、必要に応じてクエリとしきい値をカスタマイズできます。 次のアラートが推奨されます。
