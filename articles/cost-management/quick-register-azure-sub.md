...
description: Azure サブスクリプションを使用して Cloudyn に登録する
...
2. **[概要]** の **[Cloudyn]** をクリックします｡  
    ![Cloudyn のページ](./media/quick-register-azure-sub/cost-mgt-billing-service.png)
...
4. [Cloudyn ポータル試用版の登録] ページで、会社名を入力し、**[Azure Individual Subscription Owner]\(Azure サブスクリプションの個人所有者\)** を選択し、**[次へ]** をクリックします。 お使いのアカウント名とテナント ID が、自動的にフォームに追加されます。  
    ![試用登録](./media/quick-register-azure-sub/trial-reg-ind.png)
