...
2. 表示されるウィンドウで、 **[デジタル署名]** タブを選択します。次の図に示すように、タブの一覧には項目が 1 つだけ表示されます。 その項目を選択して項目を強調表示し、[**De] を選択します
3. デジタル信号の詳細ウィンドウが表示されたら、 **[全般]** タブを選択し、 **[証明書のインストール]** を選択します。
...
6.  今コピーしたボリューム GUID を使用して、 **\$volumeGuid** 変数を更新します。
