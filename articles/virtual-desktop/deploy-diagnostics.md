...
パフォーマンス カウンターの詳細については、「[Azure Monitor での Windows および Linux のパフォーマンス データ ソース](/articles/azure-monitor/platform/data-sources-performance-counters.md)」を参照してください。
