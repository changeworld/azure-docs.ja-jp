...
>[!IMPORTANT]
>接続時に仮想マシンを起動機能が現在サポートされているのは PowerShell と REST API のみで、Azure portal は対象ではありません。 詳細については、[ホスト プールの作成または更新](/rest/api/desktopvirtualization/hostpools/createorupdate)に関する記事を参照してください。
