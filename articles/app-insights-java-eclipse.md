...
![名前別の要求数](./media/app-insights-java-track-http-requests/6-barchart.png)
...
![セッション、ユーザー、ページ ビュー](./media/appinsights/appinsights-47usage-2.png)
...
![Web テストの例](./media/appinsights/appinsights-10webtestresult.png)
