...
[Avere vFXT for Azure](https://docs.microsoft.com/azure/avere-vfxt/) は、Microsoft Azure の仮想ノードを使用する同様のクラスター キャッシュ製品です。 これは Azure portal で作成されますが、Azure FXT Edge Filer ハードウェア キャッシュと同じコントロール パネル構成ソフトウェアが使用されます。 
