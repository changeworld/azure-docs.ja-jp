...
- **Api**:静的アプリに気象情報を提供する API エンドポイントを実装する C# Azure Functions アプリケーション。 [`WeatherForecastFunction`](https://github.com/staticwebev/blazor-starter/blob/main/Api/WeatherForecastFunction.cs) で、`WeatherForecast` オブジェクトの配列が返されます。
