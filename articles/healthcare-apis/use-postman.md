...
ms.locfileid: "130187797"
---
# <a name="access-using-postman"></a>Postman を使用したアクセス

> [!IMPORTANT]
> Azure Healthcare APIs は現在プレビュー段階です。 ベータ版、プレビュー版、または一般提供としてまだリリースされていない Azure の機能に適用されるその他の法律条項については、「[Microsoft Azure プレビューの追加使用条件](https://azure.microsoft.com/support/legal/preview-supplemental-terms/)」に記載されています。

この記事では、 [Postman](https://www.getpostman.com/)を使用して、医療 API fhir サービス (fhir サービスと呼ばれます) にアクセスする手順について説明します。

## <a name="prerequisites"></a>前提条件

* Azure にデプロイされた FHIR サービス。 FHIR サービスをデプロイする方法の詳細については、「 [deploy a FHIR service](fhir/fhir-portal-quickstart.md)」を参照してください。
...
* FHIR サービスにアクセスするために、クライアントアプリケーションとユーザーアカウントに付与されたアクセス許可 ("FHIR データ共同作成者" など)。 
...
[![Postman で新しいワークスペースを作成するスクリーンショット。 ](media/postman/postman-create-new-workspace.png) ](media/postman/postman-create-new-workspace.png#lightbox)
...
[![新しいコレクションの作成のスクリーンショット。 ](media/postman/postman-create-a-new-collection.png) ](media/postman/postman-create-a-new-collection.png#lightbox)
...
[![データのインポートのスクリーンショット。 ](media/postman/postman-import-data.png) ](media/postman/postman-import-data.png#lightbox)
...
> [!NOTE]
> クライアントアプリケーションの登録で、リダイレクト URL を構成していることを確認し `https://www.getpostman.com/oauth2/callback` ます。

[![環境変数のスクリーンショット。 ](media/postman/postman-environments-variable.png) ](media/postman/postman-environments-variable.png#lightbox)
...
[![新しい要求の作成のスクリーンショット。 ](media/postman/postman-create-new-request.png) ](media/postman/postman-create-new-request.png#lightbox)

## <a name="get-capability-statement"></a>Get 機能ステートメント

`{{fhirurl}}/metadata`要求に「」と入力し、 `GET` ヒット `Send` します。 FHIR サービスの機能ステートメントが表示されます。

[![機能ステートメントのパラメーターのスクリーンショット。 ](media/postman/postman-capability-statement.png) ](media/postman/postman-capability-statement.png#lightbox)

[![保存要求のスクリーンショット。 ](media/postman/postman-save-request.png) ](media/postman/postman-save-request.png#lightbox)
...
4. **[保存]** を選択して設定を保存します。
5. **Send** を押します。 Azure AD アクセストークンを含む応答が表示されます。これは、変数に `bearerToken` 自動的に保存されます。 これは、すべての FHIR サービス API 要求で使用できます。

  [![[送信] ボタンのスクリーンショット。 ](media/postman/postman-send-button.png) ](media/postman/postman-send-button.png#lightbox)

などのオンラインツールを使用してアクセストークンを調べることができ [https://jwt.ms](https://jwt.ms) ます。 [ **要求** ] タブを選択すると、トークン内の各要求に関する詳細な説明が表示されます。

[![アクセストークン要求のスクリーンショット。 ](media/postman/postman-access-token-claims.png) ](media/postman/postman-access-token-claims.png#lightbox)
...
[![[ベアラートークンの選択] のスクリーンショット。 ](media/postman/postman-select-bearer-token.png) ](media/postman/postman-select-bearer-token.png#lightbox)
...
[![新しい患者を作成するための [送信] ボタンのスクリーンショット。 ](media/postman/postman-send-create-new-patient.png) ](media/postman/postman-send-create-new-patient.png#lightbox)
...
[![新しい患者202の受け入れられた応答を作成するための post のスクリーンショット。 ](media/postman/postman-202-accepted-response.png) ](media/postman/postman-202-accepted-response.png#lightbox)
