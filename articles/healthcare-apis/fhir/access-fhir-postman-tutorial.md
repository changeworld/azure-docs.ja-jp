...
- FHIR サービスにアクセスするためのアクセス許可を、confidential クライアントアプリケーションとユーザーアカウント (たとえば、"FHIR データコントリビューター") に付与しました。 詳細については、「 [FHIR 用に AZURE RBAC を構成する](./configure-azure-rbac.md)」を参照してください。
