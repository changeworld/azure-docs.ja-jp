<properties pageTitle="SSH を使用した Azure の Linux 仮想マシンへの接続" description="Azure 上の Linux 仮想マシンで SSH キーを生成して使用する方法について説明します。" services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor=""/>
