...
* Helm 3 グラフをレジストリに [OCI 成果物](container-registry-image-formats.md#oci-artifacts)として格納します。 Azure Container Registry では、Helm チャートなどの [OCI 成果物](container-registry-oci-artifacts.md)に対する GA サポートが提供されます。
