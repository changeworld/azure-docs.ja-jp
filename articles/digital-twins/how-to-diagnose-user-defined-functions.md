...
「[Azure リソースからのログ データの収集と使用](../azure-monitor/platform/diagnostic-logs-overview.md)」に、Azure portal、Azure CLI、または PowerShell を使用する Azure Digital Twins インスタンスの診断ログ設定に関する詳細があるのでお読みください。
