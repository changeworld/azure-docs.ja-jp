...
以降のセクションでは、IoT Hub と Azure Digital Twins (またはその他の Azure IoT サービス) によって発信されるさまざまな種類の通知について詳しく説明します。 各通知の種類のトリガーとなるものと、通知本文の種類ごとに含まれる一連のフィールドについて説明します。
