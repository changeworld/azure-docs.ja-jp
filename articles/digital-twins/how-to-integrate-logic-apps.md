...
[DigitalTwins API](/rest/api/digital-twins/dataplane/twins)、[NET (C#) SDK](/dotnet/api/overview/azure/digitaltwins/client?view=azure-dotnet&preserve-view=true)、または [Azure Digital Twins CLI](concepts-cli.md) を使用してツインを追加できます。 これらの方法を使用してツインを作成する方法の詳細な手順については、" [「デジタル ツインを管理する」方法](how-to-manage-twin.md)を参照してください。
...
:::image type="content" source="media/how-to-integrate-logic-apps/create-logic-app.png" alt-text="Azure portal の [Logic Apps] ページ。[追加] ボタンを選択する":::
...
任意の方法 ([カスタム クライアント アプリ](tutorial-command-line-app.md)、[Azure Digital Twins Explorer サンプル アプリ](/samples/azure-samples/digital-twins-explorer/digital-twins-explorer/)、[SDK と API](concepts-apis-sdks.md)、[CLI](concepts-cli.md) など) を選択して、ツインのクエリを実行できます。 
...
使用可能な API 操作とその詳細については、[概念: Azure Digital Twins の API および SDK](concepts-apis-sdks.md) に関するページを参照してください。
