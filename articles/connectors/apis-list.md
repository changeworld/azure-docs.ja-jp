...
| コネクタ |  |  |  |
| --- | --- | --- | --- |
|[![API Icon][API/Web-Appicon]<br/>**API/Web アプリ**][API/Web-Appdoc]|![API アイコン][appFiguresicon]<br/>**appFigures**|![API アイコン][Asanaicon]<br/>**Asana**|![API アイコン][Azure-DocumentDBicon]<br/>**Azure DocumentDB**|
|![API アイコン][Azure-MLicon]<br/>**Azure ML**|[![API Icon][Azure-Functionsicon]<br/>**Azure<br/>Functions**][Azure-Functionsdoc]|[![API Icon][AzureBlobStorageicon]<br/>**Azure Blob<br/>Storage**][AzureBlobStoragedoc]|![API アイコン][Basecamp-3icon]<br/>**Basecamp 3**|
...
| 統合アカウント<br/>コネクタ |  |  |  |
| --- | --- | --- | --- |
| [![API Icon][xmlvalidateicon]<br/>**XML <br/>検証**][xmlvalidatedoc] |[![API Icon][xmltransformicon]<br/>**XML<br/>変換**][xmltransformdoc] |[![API Icon][flatfileicon]<br/>**フラット ファイル</br>エンコード**][flatfiledoc] |[![API Icon][flatfiledecodeicon]<br/>**フラット ファイル</br>デコード**][flatfiledecodedoc] |
| [![API Icon][as2icon]<br/>**AS2</br>デコード**][as2decode] |[![API Icon][as2icon]<br/>**AS2</br>エンコード**][as2encode] |[![API Icon][x12icon]<br/>**X12</br>デコード**][x12decode] |[![API Icon][x12icon]<br/>**X12</br>エンコード**][x12encode] |
| [![API Icon][x12icon]<br/>**EDIFACT</br>デコード**][EDIFACTdecode] |[![API Icon][x12icon]<br/>**EDIFACT</br>エンコード**][EDIFACTencode] | | |
...
| エンタープライズ<br/>コネクタ |  |
| --- | --- |
|![API アイコン][MQicon]<br/>**MQ**|![API アイコン][SAPicon]<br/>**SAP**<br/>[sapconnector]|
...
[office365-outlookdoc]: ./connectors-create-api-office365-outlook.md "Office 365 コネクタを使用すると、電子メールの送受信、予定表の管理などの操作を実行できます。さらに、Office 365 アカウントを使用して連絡先を管理することができます。"
...
[instagramdoc]: ./connectors-create-api-instagram.md "Instagram に接続して、イベントをトリガーするか、イベントに対するアクションを実行できます。"
