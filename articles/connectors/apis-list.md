...
> [!TIP]
> このトピックの「[A ～ Z の完全な一覧](#az)」には、Logic Apps で使用できるすべてのコネクタの一覧が示されています。
...
Logic Apps には、次の種類のトリガーが用意されています。  
