...
# SMTP API を使ってみる
SMTP サーバーに接続して、電子メールを送信します。

SMTP API は、ロジック アプリから使用できます。

>[AZURE.NOTE] 本記事は、ロジック アプリの 2015-08-01-preview スキーマ バージョンを対象としています。2014-12-01-preview スキーマ バージョンについては、「[SMTP コネクタ](../app-service-logic/app-service-logic-connector-smtp.md)」を参照してください。
...
| ---|---|---|---|---|---|
|emailMessage| 多数|○|本文|なし |電子メール メッセージ|
