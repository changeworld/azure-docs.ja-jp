...
唯一の前提条件は [Microsoft .NET Framework 4.8](https://aka.ms/net-framework-download) です。
...
1. 記録を開始するには、 **[Recording]\(記録\)** メニューから **[Start Recording]\(記録開始\)** を選択します。 (キーボード: Ctrl + E)
...
1. 記録を停止するには、 **[Recording]\(記録\)** メニューから **[Stop Recording]\(記録停止\)** を選択します。 (キーボード: Ctrl + Shift + E)
...
1. アクションを追加する最後のステップで、 **[新しいステップ]** **>** **[アクションの追加]** を選択します。 

1. 検索ボックスで、 **[Enterprise]\(エンタープライズ\)** を選択します。 検索ボックスに、フィルターとして「`3270`」と入力します。 アクションの一覧から、 **[TN3270 接続経由でメインフレーム プログラムを実行する]** という名前のアクションを選択します。
