...
>[AZURE.NOTE] 本記事は、ロジック アプリの 2015-08-01-preview スキーマ バージョンを対象としています。2014-12-01-preview スキーマ バージョンについては、「[Facebook コネクタの使用開始とロジック アプリへの追加](../app-service-logic/app-service-logic-connector-facebook.md)」をご覧ください。
...
| トリガー | アクション|
| --- | --- |
| <ul><li>タイムラインに新しい投稿があるとき</li></ul> |<ul><li>タイムラインからフィードを取得する</li><li>タイムラインに投稿する</li><li>タイムラインに新しい投稿があるとき</li><li>ページ フィードを取得する</li><li>ユーザーのタイムラインを取得する</li><li>ページに投稿する</li></ul>
...
接続を作成したら、Facebook のプロパティを入力します。これらのプロパティについては、このトピックの **REST API リファレンス**をご覧ください。
...
### タイムラインからフィードを取得する
ログインしているユーザーのタイムラインからフィードを取得します。```GET: /me/feed```
...
### タイムラインに投稿する
ログインしているユーザーのタイムラインにステータス メッセージを投稿します。```POST: /me/feed```
...
### タイムラインに新しい投稿がある場合
ログインしているユーザーのタイムラインに新しい投稿があるときに新しいフローをトリガーします。```GET: /trigger/me/feed```
...
### ページに投稿する
ログインしているユーザーとして Facebook ページにメッセージを投稿します。```POST: /{pageId}/feed```
