...
SQL Azure API は、ロジック アプリから使用できます。

>[AZURE.NOTE] 本記事は、ロジック アプリの 2015-08-01-preview スキーマ バージョンを対象としています。2014-12-01-preview スキーマ バージョンについては、こちらの [SQL コネクタ](../app-service-logic/app-service-logic-connector-sql.md)をクリックしてください。
...
### 行を取得する 
SQL テーブルから行を取得します。```GET: /datasets/default/tables/{table}/items```
