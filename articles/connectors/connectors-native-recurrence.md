...
| **間隔** | はい | interval | 整数 | ワークフローの実行間隔を、[頻度] に指定された単位に基づいて表す正の整数。 <p>既定の間隔は 1 です。 間隔の最小値と最大値は次のとおりです。 <p>- [月]: 1 ～ 16 か月 </br>- [日]: 1 ～ 500 日 </br>- [時間]: 1 ～ 12,000 時間 </br>- [分]: 1 ～ 72,000 分 </br>- [秒]: 1 ～ 9,999,999 秒<p>たとえば間隔が 6 で、頻度が "月" である場合は、繰り返しは 6 か月ごとになります。 | 
