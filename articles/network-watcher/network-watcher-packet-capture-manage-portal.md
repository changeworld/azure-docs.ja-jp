...
>  * まだインストールされていない場合は、仮想マシンに、*Linux* または [Windows](../virtual-machines/linux/extensions-nwa.md) 用の [AzureNetworkWatcherExtension](../virtual-machines/windows/extensions-nwa.md) 仮想マシン拡張機能を追加します。
