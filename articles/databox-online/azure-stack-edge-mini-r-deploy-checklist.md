---
title: Azure Stack Edge Mini R デバイスをデプロイするためのデプロイ前チェックリスト
description: この記事では、Azure Stack Edge Mini R デバイスをデプロイする前に収集できる情報について説明します。
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
| アクティベーション  | Azure Stack Edge リソースのアクティブ化キーが必要です。    | 生成されたキーは 3 日後に有効期限が切れます。 |
...
[Azure Stack Edge Mini R デバイス](azure-stack-edge-gpu-deploy-prep.md)のデプロイを準備します。
