---
title: Microsoft Azure Stack Edge Pro FPGA デバイスに Windows PowerShell インターフェイス経由で接続して管理する
description: Windows PowerShell インターフェイス経由での Azure Stack Edge Pro FPGA の接続と管理について説明します。
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
