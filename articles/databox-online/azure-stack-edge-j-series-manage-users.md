---
title: Azure Stack Edge GPU のユーザー管理 | Microsoft Docs
description: Azure portal を使用して Azure Stack Edge GPU のユーザーを管理する方法について説明します。
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "89254187"
---
# <a name="use-the-azure-portal-to-manage-users-on-your-azure-stack-edge"></a>Azure portal を使用して Azure Stack Edge のユーザーを管理する
