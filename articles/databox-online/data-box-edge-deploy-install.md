...
- 電源コード 2 本。 
- 1 GbE RJ-45 ネットワーク ケーブル 2 本、25 GbE SFP+ 銅線ケーブル 4 本。
- 2 つの配電ユニットへのアクセス (推奨)。
...
4. RJ-45 ネットワーク ケーブルを使用して、1 GbE ネットワーク インターフェイスのポート 2 を、データセンター ネットワークまたはインターネットに接続します。 
5. ポート 3、ポート 4、ポート 5、ポート 6 の 4 つの 25 GbE ネットワーク インターフェイスは、SFP+ 銅線ケーブルを使用して、データセンター ネットワークまたはインターネットに接続します。 

> [!NOTE]
> - ポート 2、ポート 3、ポート 4、ポート 5、ポート 6 のうち、少なくとも 1 つのデータ ネットワーク インターフェイスはインターネットに接続する必要があります (Azure への接続)。 
> - Azure へのデータ送信には、ポート 3、ポート 4、ポート 5、ポート 6 などの 25 GbE ネットワーク インターフェイスを使用することをお勧めします。 
