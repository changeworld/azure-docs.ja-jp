...
description: Event Grid に関する Azure PowerShell のサンプル
services: event-grid
author: tfitzmac
manager: timlt
...
|**Event Grid トピック**||
| [カスタム トピックの作成](scripts/event-grid-powershell-create-custom-topic.md) | OS ディスクとして特殊化した VHD から、またはデータ ディスクとしてのデータ VHD から管理ディスクを作成します。  |
| | |
