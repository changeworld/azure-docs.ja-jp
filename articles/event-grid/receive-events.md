...
検証コードをプログラムでエコーするには、次のコードを使用します (https://github.com/Azure-Samples/event-grid-dotnet-publish-consume-events/tree/master/EventGridConsumer): で関連サンプルを見つけることもできます)。
