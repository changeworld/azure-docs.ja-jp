---
title: HDInsight で提供される Hadoop クラスター バージョンの新機能 | Microsoft Docs
...
> [!NOTE]
> HDInsight 2.1 と 3.0 クラスターはともに、64 ビット版 Windows Server 2012 R2 を使用し、.NET Framework 4.0、4.5、4.5.1 をサポートする Azure ゲスト OS [ファミリ 4](../cloud-services/cloud-services-guestos-update-matrix.md) で実行されます。
> 
> 
