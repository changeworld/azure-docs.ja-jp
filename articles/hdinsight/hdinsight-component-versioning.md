...
* ブラジル南部と西日本を除くすべてのサポートされているリージョン:
  ...
  | --- | --- | --- | --- | --- | --- | --- |
  | ヘッド: 既定の VM サイズ |D3 v2 |D3 v2 | D13、<br/> D14 |A4 v2 |D12 v2 |D12 v2 |
  ...
  | worker: 既定の VM サイズ |D3 v2 |D3 v2  | D13、<br/> D14 |D3 v2 |D4 v2 | D4 v2 |
  ...
  | ZooKeeper: 既定の VM サイズ | |A4 v2 | |A2 v2 | | |
