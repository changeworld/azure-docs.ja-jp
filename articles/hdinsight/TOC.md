...
## [対話型クエリの開始](hdinsight-hadoop-use-interactive-hive.md)
...
#### [Azure PowerShell の使用](hdinsight-hadoop-use-hive-powershell.md)
...
#### [Azure PowerShell の使用](hdinsight-hadoop-use-mapreduce-powershell.md)
#### [リモート デスクトップを使用する](hdinsight-hadoop-use-mapreduce-remote-desktop.md)
#### [.NET SDK の使用](hdinsight-hadoop-use-mapreduce-dotnet-sdk.md)
...
#### [Azure PowerShell の使用](hdinsight-hadoop-use-pig-powershell.md)
...
## 対話型クエリの使用
### [Zeppelin を使用して Hive クエリを実行する](hdinsight-connect-hive-zeppelin.md)
## 開発
...
### [HDInsight の VSCode ツールを使用する](hdinsight-for-vscode.md)
## ビッグ データの分析
### [Power Query を使用して分析する](hdinsight-connect-excel-power-query.md)
### [Power BI を Hadoop に接続する](hdinsight-connect-hive-power-bi.md)
...
#### [Azure PowerShell を使用して実行する](hdinsight-hadoop-use-sqoop-powershell.md)
