...
クラスター内のノードをアドレスを指定するときは、完全修飾ドメイン名 (FQDN) を使用してください。 [Ambari API](hdinsight-hadoop-manage-ambari-rest-api.md) を使用すると、クラスター内のさまざまなノードの種類の FQDN を取得できます。 
