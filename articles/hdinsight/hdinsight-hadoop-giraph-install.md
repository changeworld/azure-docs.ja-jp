...
---
# <a name="install-and-use-giraph-in-hdinsight"></a>HDInsight に Giraph をインストールし、使用する
...
2. ウィザードの **[スクリプトのアクション]** ページで、**[スクリプト アクションの追加]** をクリックし、次に示すように、スクリプト アクションの詳細を指定します。
    ...
    ![スクリプト アクションを使ってクラスターをカスタマイズする](./media/hdinsight-hadoop-giraph-install/hdi-script-action-giraph.png "Use Script Action to customize a cluster")
...
* [HDInsight クラスターに R をインストールする][hdinsight-install-r]: R のインストールに関するスクリプト アクションのサンプル。
