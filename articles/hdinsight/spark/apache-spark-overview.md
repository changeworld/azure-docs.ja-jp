...
HDInsight の Spark クラスターには、Microsoft Power BI などの BI ツールからの接続を可能にする [ODBC ドライバー](/sql/connect/odbc/download-odbc-driver-for-sql-server?view=sql-server-ver15)が用意されています。
