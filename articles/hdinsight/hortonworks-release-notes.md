---
title: Azure HDInsight バージョンに対応する Hortonworks リリース ノート
...
## <a name="current-versions"></a>現在のバージョン
...
* [HDInsight の Apache Hadoop コンポーネント](./hdinsight-component-versioning.md)
