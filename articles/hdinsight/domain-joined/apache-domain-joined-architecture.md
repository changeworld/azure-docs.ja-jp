...
![ドメイン参加の HDInsight クラスター トポロジ](./media/apache-domain-joined-architecture/hdinsight-domain-joined-architecture_2.png)
...
![ドメイン参加の HDInsight クラスター トポロジ](./media/apache-domain-joined-architecture/hdinsight-domain-joined-architecture_1.png)
