...
# <a name="use-ambari-views-to-debug-tez-jobs-on-hdinsight"></a>Use Ambari Views to debug Tez Jobs on HDInsight
...
### <a name="understanding-the-tez-view"></a>Understanding the Tez view
...
## <a name="use-the-tez-view"></a>Use the Tez View
