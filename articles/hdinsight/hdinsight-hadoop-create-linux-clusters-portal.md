...
* **最新の Web ブラウザー**。Azure ポータルでは、HTML5 と Javascript が使用されています。Web ブラウザーのバージョンが低いと正しく機能しない場合があります。
...
6. **[リソース グループ]** をクリックして、既存のリソース グループを選択するか、**[新規]** をクリックして、新しいリソース グループを作成します。
