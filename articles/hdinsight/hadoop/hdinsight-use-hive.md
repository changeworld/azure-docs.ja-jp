...
* [HDInsight にカスタムの Apache Hive ユーザー定義関数を追加する方法](https://docs.microsoft.com/archive/blogs/bigdatasupport/how-to-add-custom-hive-udfs-to-hdinsight)
