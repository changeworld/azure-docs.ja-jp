...
Mahout は HDInsight 3.6 では使用できますが、HDInsight 4.0 では使用できません。 HDInsight に含まれる Mahout のバージョンについては、「[HDInsight 3.6 のコンポーネントのバージョン](../hdinsight-36-component-versioning.md)」を参照してください。
