...
1. **[基本]** タブで次の情報を指定します。
    ...
    ![HDInsight Linux の使用。クラスターの基本的な値の指定](./media/apache-hadoop-linux-create-cluster-get-started-portal/azure-portal-cluster-basics.png "HDInsight クラスターを作成するための基本的な値の指定")
