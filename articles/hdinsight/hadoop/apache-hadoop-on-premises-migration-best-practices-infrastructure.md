...
詳細については、[HDInsight の各バージョンで使用できる Hadoop コンポーネント](../hdinsight-component-versioning.md#hadoop-components-available-with-different-hdinsight-versions)を参照してください
