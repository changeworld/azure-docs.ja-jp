...
> [!IMPORTANT]  
> パラメーター `Spark2Defaults` は、[Add-AzHDInsightConfigValues](https://docs.microsoft.com/powershell/module/az.hdinsight/add-azhdinsightconfigvalues) と共に使用しなければならない場合があります。 以下のコード例に示すように、パラメーターに空の値を渡すことができます。
