...
------------- | ------------- | -------------- | -------------- | --------------- | --------------
管理 | .NET SDK を使用した HDInsight クラスターの管理 | 1 | 作成中 | [@mumian](https://github.com/mumian) | - |
...
開発 | Sqoop を使用した Curl および Rest API のサンプル | 2 | 保留中 | [@mumian](https://github.com/mumian) | Jon Kennerly | 
開発 | [HDInsight .NET アプリケーションでの非対話型認証](hdinsight-create-non-interactive-authentication-dotnet-applications) |2| [完了](hdinsight-create-non-interactive-authentication-dotnet-applications.md) | [@mumian](https://github.com/mumian) | [@matt1883](https://github.com/matt1883)
