...
## HDInsight の 2015 年 11 月 30 日リリース
...
|-------------------------------------------------|------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------|----------------------|
| すべての HDInsight クラスターの HDInsight バージョンと HDInsight 3.2 クラスターの HDP バージョンの更新 (Windows and Linux) | このリリースでは、HDInsight と HDP のバージョンが更新されています | サービス | すべて| 該当なし
