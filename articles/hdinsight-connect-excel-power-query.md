...
-   [Microsoft Power Query for Excel のインストール][Microsoft Power Query for Excel のインストール]
-   [データを Excel へインポート][データを Excel へインポート]
-   [次のステップ][次のステップ]
