...
![製品の追加](media/api-management-howto-add-products/added-product.png)
...
![製品 API を追加する](media/api-management-howto-add-products/add-product-api.png)
