...
-   [Azure API Management:構成のバックアップと復元](https://docs.microsoft.com/archive/blogs/stuartleeks/azure-api-management-backing-up-and-restoring-configuration)
