...
1. 右側のウィンドウで **[カスタム]** をクリックします。
    ...
    > [!TIP]
    > [Azure Key Vault を使用して証明書を管理](https://docs.microsoft.com/azure/key-vault/certificates/about-certificates)し、それらを自動更新するように設定することをおすすめします。
