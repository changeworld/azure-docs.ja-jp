...
|プロパティ|型|Description|  
|--------------|----------|-----------------|  
|発行|[問題](api-management-template-data-model-reference.md#Issue)エンティティのコレクション。|現在のユーザーに表示される問題。|  
...
|Search|string|このプロパティは廃止されました。使用しないでください。|  
