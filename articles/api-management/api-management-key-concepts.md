...
詳細については、[API の作成方法][API の作成方法]に関する記事および [API に操作を追加する方法][API に操作を追加する方法]に関する記事をご覧ください。
...
詳細については、[成果物を作成して発行する方法][成果物を作成して発行する方法]に関する記事と、次のビデオをご覧ください。
...
詳細については、[グループを作成して使用する方法][グループを作成して使用する方法]に関する記事をご覧ください。

## <a name="developers"> </a> 開発者
開発者は、API Management サービス インスタンス内のユーザー アカウントです。 開発者は、管理者が作成したり参加を招待したりすることができます。また、[開発者ポータル][開発者ポータル]からサインアップすることもできます。 それぞれの開発者はグループ (複数可) に所属し、そのグループに閲覧が認められている成果物のサブスクリプションを得ることができます。

成果物のサブスクリプションを持つ開発者には、その成果物へのプライマリ キーとセカンダリ キーが付与されます。 成果物の API を呼び出す際は、このキーを使用することになります。

詳細については、[開発者を作成または招待する方法][開発者を作成または招待する方法]に関する記事および[グループを開発者に関連付ける方法][グループを開発者に関連付ける方法]に関する記事をご覧ください。
...
API Management のポリシーの一覧については、[ポリシー リファレンス][ポリシー リファレンス]に関する記事をご覧ください。 ポリシーの使用と構成の詳細については、[API Management のポリシー][API Management のポリシー]に関する記事をご覧ください。 レート制限ポリシーとクォータ ポリシーを適用した成果物の作成方法のチュートリアルについては、[成果物を作成して詳細設定を構成する方法][成果物を作成して詳細設定を構成する方法]に関する記事をご覧ください。 デモについては、次のビデオをご覧ください。
...
[How to associate groups with developers (グループを開発者に関連付ける方法) (グループを開発者に関連付ける方法)]: api-management-howto-create-groups.md#associate-group-developer
[Azure API Management で成果物を作成して詳細設定を行う方法]: api-management-howto-product-with-rules.md
[開発者を作成または招待する方法]: api-management-howto-create-or-invite-developers.md
[Policy reference (ポリシー リファレンス) (ポリシー リファレンス)]: api-management-policy-reference.md
[API Management policies (API Management のポリシー) (API Management のポリシー)]: api-management-howto-policies.md
