...
1. **[カスタム イメージ]** ウィンドウで、カスタム イメージの名前と説明を入力します。 この情報は、VM を作成する際にベースの一覧に表示されます。 カスタム イメージには、仮想マシンに接続された OS ディスクとすべてのデータ ディスクが含まれます。
    ...
    :::image type="content" source="./media/devtest-lab-create-template/create-custom-image-blade.png" alt-text="カスタム イメージのメニュー項目の作成":::
...
1. 完了したら **[OK]** を選択して、カスタム イメージを作成します。
    ...
    :::image type="content" source="./media/devtest-lab-create-template/custom-image-available-as-base.png" alt-text="カスタム イメージのメニュー項目の作成":::
