...
| [az lab vm create](/cli/azure/lab/vm#az_lab_vm_create) | ラボに仮想マシン (VM) を作成します。 |
| [az lab vm show](/cli/azure/lab/vm#az_lab_vm_show) | ラボの VM の状態を表示します。 |
