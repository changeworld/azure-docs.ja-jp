...
1. **カスタマイズ** を選択します。
    ...
    ![Azure IoT Central RuuviTag センサー デバイス テンプレート](./media/tutorial-in-store-analytics-create-app/ruuvitag-device-template.png)
...
1. **[保存]** を選択して変更を保存します。
    ...
    ![Azure IoT Central RuuviTag デバイス テンプレートのカスタマイズ](./media/tutorial-in-store-analytics-create-app/ruuvitag-device-template-customize.png)
