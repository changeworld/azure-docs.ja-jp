...
ms.locfileid: "55768642"
---
# <a name="manage-devices-in-your-azure-iot-central-application-new-ui-design"></a>Azure IoT Central アプリケーションでデバイスを管理する (新しい UI デザイン)
...
1. 左側のナビゲーション メニューで **[Device Explorer]** を選択します。 ここには、[デバイス テンプレート](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)が一覧表示されます。
...
1. **Device Explorer** ページの右側のウィンドウに、そのデバイス テンプレートから作成されたデバイスが一覧表示されます。 各デバイスを選択すると、そのデバイスのデバイス詳細ページが表示されます。
    ...
    ![[デバイスの詳細] ページ](./media/howto-manage-devices-experimental/devicelist.png)
...
1. **[インポート]** をクリックします。
    ...
    ![インポート アクション](./media/howto-manage-devices-experimental/BulkImport1.png)
...
1. インポートが完了すると、デバイス グリッドに完了メッセージが表示されます。
    ...
    ![インポート成功](./media/howto-manage-devices-experimental/BulkImport3.png)
...
1. 左側のパネルで、**[関連付けが解除されているデバイス]** を選択します。
    ...
    ![関連付けが解除されているデバイス](./media/howto-manage-devices-experimental/UnassociatedDevices1.png)

1. テンプレートに関連付けるデバイスを選択します。

1. **[関連付け]** をクリックします。

    ![デバイスの関連付け](./media/howto-manage-devices-experimental/UnassociatedDevices2.png)
...
実際のデバイスを IoT Central に接続するには、その接続文字列が必要です。 デバイスの詳細を一括エクスポートして、接続文字列とその他のプロパティを取得することができます。 エクスポート プロセスでは、選択したすべてのデバイスのデバイス ID、デバイス名、プライマリ接続文字列を含む CSV ファイルが作成されます。
...
1. エクスポートするデバイスを選択して、**エクスポート** アクションをクリックします。
    ...
    ![エクスポート](./media/howto-manage-devices-experimental/Export1.png)
...
1. **成功メッセージ** をクリックし、ディスク上のローカル フォルダーにファイルをダウンロードします。
    ...
    ![エクスポート - 成功](./media/howto-manage-devices-experimental/Export2.png)
...
> [デバイス セットを使用する方法](howto-use-device-sets-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
