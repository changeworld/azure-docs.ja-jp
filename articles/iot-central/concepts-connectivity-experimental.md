...
1. これらの接続の詳細 (**デバイス ID、デバイス名、デバイスのプライマリ キー**) をデバイス コードで使用して、デバイスをプロビジョニングして接続し、すぐに通過するデータの表示を始めます。 MxChip デバイスを使用している場合は、[こちら](howto-connect-devkit-experimental.md#add-a-real-device)の「**DevKit デバイスを準備する**」セクション以降の手順に従います。   
    ...
    *   **Node.js:** Node.js を使う場合は、[こちら](tutorial-add-device-experimental.md#prepare-the-client-code)の「**クライアント コードの準備**」セクション以降の手順に従います。
...
**MxChip** デバイスを使用して接続している場合は、[こちら](howto-connect-devkit-experimental.md#add-a-real-device)の「**DevKit デバイスを準備する**」セクション以降の手順に従います。   
...
- [汎用の Node.js クライアント を Azure IoT Central アプリケーションに接続する](howto-connect-nodejs-experimental.md)
- [Raspberry Pi デバイスを Azure IoT Central アプリケーションに接続する ](howto-connect-raspberry-pi-python.md)
- [DevDiv キット デバイスを Azure IoT Central アプリケーションに接続する ](howto-connect-devkit-experimental.md)
...
- [DevKit デバイスを準備して接続する](howto-connect-devkit-experimental.md)
