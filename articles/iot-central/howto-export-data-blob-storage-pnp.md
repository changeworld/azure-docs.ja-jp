...
4. ドロップダウン リスト ボックスで、お使いの **Storage Account 名前空間**を選択します。 リスト内の最後のオプション ( **[Enter a connection string]\(接続文字列を入力する\)** ) を選択することもできます。 
    ...
    ![新しい cde イベント ハブの作成](media/howto-export-data-pnp/export-create-blob.png)
...
6. 継続的データ エクスポートを有効にするには、 **[データのエクスポート]** が **[オン]** になっていることを確認します。 **[保存]** を選択します。
   ...
   ![連続データ エクスポートを構成する](media/howto-export-data-pnp/export-list-blob.png)
...
> [Power BI でデータを視覚化する方法](howto-connect-powerbi-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
