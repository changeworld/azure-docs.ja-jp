...
1. **[アクション]** の横にある **+** を選択します。 使用可能なアクションの一覧が表示されます。  
    ...
    ![アクションを追加する](media/howto-create-telemetry-rules/add_action1.png)
...
1. **[電子メール]** アクションを選択し、 **[宛先]** フィールドに有効な電子メール アドレスを入力して、ルールがトリガーされた際に電子メールの本文に表示されるメモを指定します。
   ...
   ![アクションを構成する](media/howto-create-telemetry-rules/configure_action1.png)
