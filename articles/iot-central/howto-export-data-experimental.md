...
詳細については、[BLOB ストレージへのエクスポート](howto-export-data-blob-storage.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)に関するページを参照してください。
...
詳細については、[Event Hubs と Service Bus へのエクスポート](howto-export-data-event-hubs-service-bus.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)に関するページを参照してください。
...
2. 左側のメニューで、**[継続的データ エクスポート]** をクリックします。
    ...
    ![新しい cde イベント ハブの作成](media/howto-export-data-experimental/export_menu.png)
...
3. 右上の **[+ 新規]** ボタンをクリックします。 エクスポート先として、**Azure Blob Storage**、**Azure Event Hubs**、または **Azure Service Bus** のいずれかを選択します。 
    ...
    ![新しい継続的データ エクスポートの作成](media/howto-export-data-experimental/export_new.png)
...
4. ドロップダウン リスト ボックスで、**Storage Account/Event Hubs 名前空間/Service Bus 名前空間**を選択します。 リスト内の最後のオプション (**[Enter a connection string]\(接続文字列を入力する\)**) を選択することもできます。 
    ...
    ![新しい cde イベント ハブの作成](media/howto-export-data-experimental/export_create.png)
...
6. 継続的データ エクスポートを有効にするには、**[データのエクスポート]** が **[オン]** になっていることを確認します。 **[保存]** を選択します。
  ...
  ![連続データ エクスポートを構成する](media/howto-export-data-experimental/export_list.png)
...
> [Azure Blob Storage にデータをエクスポートする](howto-export-data-blob-storage.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)

> [!div class="nextstepaction"]
> [Azure Event Hubs および Azure Service Bus にデータをエクスポートする](howto-export-data-event-hubs-service-bus.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)

> [!div class="nextstepaction"]
> [Power BI でデータを視覚化する方法](howto-connect-powerbi.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
