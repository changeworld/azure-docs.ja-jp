...
description: この記事では、Azure IoT Central アプリケーションでクエリと視覚エフェクトを使用してデバイス データを分析する方法について説明します。
author: lmasieri
ms.author: lmasieri
ms.date: 06/09/2019
ms.topic: conceptual
