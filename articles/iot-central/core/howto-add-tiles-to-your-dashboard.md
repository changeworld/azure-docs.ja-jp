...
ms.locfileid: "72942876"
---
# <a name="configure-the-application-dashboard"></a>アプリケーション ダッシュボードの構成

**ダッシュボード**は、アプリケーションにアクセスできるユーザーがアプリケーションの URL に移動したときに読み込まれるページです。 いずれかの**アプリケーション テンプレート**からアプリケーションを作成した場合、アプリケーションには事前定義されたダッシュボードがあり、それを基に作業を開始できます。 **カスタム アプリケーション** アプリケーション テンプレートからアプリケーションを作成した場合、ダッシュボードは空白であり、そこから作業を開始します。
