...
> [!NOTE] 
> Azure IoT Edge デバイスのジョブは現在サポートされていません。 
...
4. ジョブを適用するデバイス セットを選択します。 デバイス セットを選択すると、デバイス セット内のデバイスが右側に表示されます。 壊れたデバイス セットを選択した場合、デバイスは表示されず、デバイス セットが壊れていることを示すメッセージが表示されます。

5. 次に、定義するジョブの種類 (設定、プロパティ、またはコマンド) を選択します。 選択したジョブの種類の横にある **+** を選択して、操作を追加します。
...
8. ジョブの概要を取得するには、一覧から表示するジョブを選択します。 この概要には、ジョブの詳細、デバイス、デバイスの状態の値が含まれています。 この概要で **[Download Job Details]\(ジョブの詳細をダウンロード\)** を選択して、デバイスやその状態の値など、ジョブの詳細の .csv ファイルをダウンロードすることもできます。 この情報は、トラブルシューティングに役立つことがあります。
