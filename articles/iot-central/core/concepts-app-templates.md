...
現時点では、"_一般公開_" 機能を使用するアプリケーション テンプレートは次のとおです。

- カスタム アプリ > レガシ アプリケーション
...
> [!NOTE]
> **レガシ アプリケーション** テンプレートは現在、**米国**、**オーストラリア**、**アジア太平洋**、または**ヨーロッパ**で使用できますが、他のテンプレートは現在、**ヨーロッパ**と**米国**でのみ使用できます。
