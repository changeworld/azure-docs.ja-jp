...
1. デバイス テンプレートから **[+ 新規]** を選択します。![デバイス テンプレート](media/howto-connect-raspberry-pi-csharp/adddevicetemplate.png)
   

2. **[Raspberry Pi]** を選択し、Raspberry Pi デバイス テンプレートを作成します。![デバイス テンプレートの追加](media/howto-connect-raspberry-pi-csharp/newdevicetemplate.png)
