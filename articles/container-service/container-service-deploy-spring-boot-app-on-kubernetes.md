...
* Apache の [Maven] ビルド ツール (バージョン 3)。
* [Git] クライアント。
* [Docker] クライアント。
...
* [Azure Container Service で Spring Boot アプリを Kubernetes にデプロイする](../container-service/container-service-deploy-spring-boot-app-on-linux.md)
