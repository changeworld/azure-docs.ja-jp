...
**Q1.Azure Backup を使用して Azure にバックアップできる、サポートされるオペレーティング システムの一覧とは** <br/> A1.次の OS の一覧が Azure Backup でサポートされています
...
**Q3.どのバージョンの SCDPM サーバーがサポートされていますか。** <br/> A3.[最新版](http://aka.ms/azurebackup_agent)の Azure Backup エージェントを SCDPM の最新の更新プログラムのロールアップにインストールすることをお勧めします (2015 年 2 月時点で UR5)。
...
**Q5.各 Azure サブスクリプションで作成できるバックアップ資格情報コンテナー数に制限はありますか。** <br/> A5.はい。2015 年 3 月時点では、サブスクリプションあたり 25 の資格情報コンテナーを作成できます。さらに資格情報コンテナーが必要な場合は、新しいサブスクリプションを作成してください。
...
## バックアップと保有期間
**Q1.バックアップされる各データ ソースのサイズに制限はありますか?** <br/> A1.2015 年 3 月時点で、各データ ソースは 1.7 TB 以下にする必要があります。データ ソースとは次のいずれかです。
