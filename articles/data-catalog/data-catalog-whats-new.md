...
- 登録済みのデータ ソースデータに関するデータ プレビューおよびデータ プロファイルの保存時に暗号化をサポートします。**Azure Data Catalog** では、サービスに登録されたデータ ソースの任意のプレビュー レコードとデータ プロファイルを透過的に暗号化します。Catalog 管理者がキーを管理する必要はありません。
