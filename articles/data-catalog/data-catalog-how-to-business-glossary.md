...
/* ビジネス用語集は、Azure Data Catalog の Standard Edition で使用できます。Data Catalog の無料エディションに用語集はありません。*/
...
Data Catalog 管理者は、ビジネス用語集の用語を作成、編集、削除できます。すべての Data Catalog ユーザーは用語定義を表示し、資産に用語集の用語でタグを付けることができます。
...
Data Catalog 管理者が新しい用語集の用語を作成するには、[新しい用語] ボタンをクリックして、次のフィールドがある用語集の用語を作成します。
