...
このドキュメントでは、[テキスト分析 API](//go.microsoft.com/fwlink/?LinkID=759711) を使うためにサービスまたはアプリケーションをオンボードする方法について説明します。この API を使用すると、テキストからセンチメント、キー フレーズ、トピック、および言語を検出することができます。対話型のエクスペリエンス デモをご覧になる場合は、[ここ](//go.microsoft.com/fwlink/?LinkID=759712)をクリックしてください。
