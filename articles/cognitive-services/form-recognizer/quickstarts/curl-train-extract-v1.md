...
> [!IMPORTANT]
> このクイックスタートでは、Form Recognizer v1.0 API を使用します。 お使いのサブスクリプションが `West US 2` または `West Europe` リージョンにある場合は、v[2.0 API のクイックスタート](./curl-train-extract.md)に従ってください。
