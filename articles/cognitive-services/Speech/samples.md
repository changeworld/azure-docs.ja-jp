...
Bing Speech では、コマンド認識、連続的認識、意図検出など、さまざまなユースケースを示すエンドツーエンドのサンプルが提供されます。 すべてのサンプルは GitHub で入手可能で、次のリンクからダウンロードできます。サンプルをビルドして実行する方法の詳細については、各リポジトリ内の README.md と[クライアント ライブラリ](GetStarted/GetStartedClientLibraries.md)のページを参照してください。
