...
|Domain|目的|
|---|---|
|__全般__| さまざまな画像分類タスクに最適化されています。 他のドメインのいずれも適切でない場合、またはどのドメインを選択すればよいか不確かな場合は、汎用ドメインを選択してください。 ID: `ee85a74c-405e-4adc-bb47-ffa8ca0c9f31`|
...
|---|---|---|---|---|---|
|分類|[General (compact)]\(汎用 (コンパクト)\)|`0732100f-1a38-4e49-a514-c9b44c697ab5`|5 MB|13 ミリ秒|5 ミリ秒|
