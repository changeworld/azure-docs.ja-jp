---
title: Bing Web Search Java クライアント ライブラリのクイックスタート
...
今すぐコードを確認したい場合は、 [Java 用の Bing Search クライアント ライブラリ](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples/tree/master/Search)のサンプルは、GitHub で入手できます。
