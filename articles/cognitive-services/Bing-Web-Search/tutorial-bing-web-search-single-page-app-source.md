---
title: Bing Web Search 単一ページ Web アプリ (ソース コード) | Microsoft Docs
description: 単一ページの Web アプリケーションで Bing Web Search API を使用する方法を示すチュートリアルのソース コードです。
...
ms.locfileid: "35373136"
---
# <a name="tutorial-single-page-web-app"></a>チュートリアル: 単一ページ Web アプリ

これは、[単一ページのアプリのチュートリアル](tutorial-bing-web-search-single-page-app.md)で説明した、Bing Web Search 用の完全なソース コードです。 アプリを実行するには、メモ帳または別のテキスト エディターにソース コードをコピーし、`bing.html` として保存します。 保存したファイルを、Microsoft Edge やその他一般的なブラウザーで開きます。
