...
| 名前 | 必須 | 型 | 説明
|-------|------------|------|---------------
|ユーザー ID| はい|[A-z]、[a-z]、[0-9]、[\_] &#40;アンダースコア&#41;、[-] &#40;ダッシュ&#41;<br> 最大長: 255 |ユーザーの一意識別子。|Item Id|Yes|[A-z]、[a-z]、[0-9]、[&#95;] &#40;アンダースコア&#41;, [-] &#40;ダッシュ&#41;<br> 最大長: 50|項目の一意識別子。|Time|はい|次の形式の日付: YYYY/MM/DDTHH:MM:SS (例: 2013/06/20T10:00:00)|データの時間。|Event|いいえ | 次のいずれか:<br>• Click<br>• RecommendationClick<br>• AddShopCart<br>• RemoveShopCart<br>• Purchase| トランザクションの種類。|
...
モデルを作成したら、[オフライン評価](cognitive-services-recommendations-buildtypes.md)を実行して、モデルがどのくらいうまく機能するかを確認できます。
