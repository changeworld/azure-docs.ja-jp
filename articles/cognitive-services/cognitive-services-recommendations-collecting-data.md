...
| Features list | いいえ |任意の英数字 <br> 最大長: 4000; 特徴の最大数: 20 | 特徴の値のコンマ区切りの一覧 = モデルの推奨事項を強化するために使用できる特徴名。|
...
|Item Id|Yes|[A-z]、[a-z]、[0-9]、[&#95;] &#40;アンダースコア&#41;, [-] &#40;ダッシュ&#41;<br> 最大長: 50|項目の一意識別子。
|Time|はい|次の形式の日付: YYYY/MM/DDTHH:MM:SS (例: 2013/06/20T10:00:00)|データの時間。
|Event|いいえ | 次のいずれか:<br>• Click<br>• RecommendationClick<br>• AddShopCart<br>• RemoveShopCart<br>• Purchase| トランザクションの種類。|
