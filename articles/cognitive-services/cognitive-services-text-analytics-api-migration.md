...
1. [Cortana Analytics ギャラリー](//gallery.cortanaanalytics.com/MachineLearningAPI/Text-Analytics-2)から Text Analytics に移動します。ここには、ドキュメントやコード サンプルへのリンクも用意されています。
