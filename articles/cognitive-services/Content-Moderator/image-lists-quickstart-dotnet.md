---
title: 'クイック スタート: カスタム画像リストを使用してモデレートする - Content Moderator'
titlesuffix: Azure Cognitive Services
description: Content Moderator SDK for .NET を使用してカスタム画像リストをモデレートする方法。
...
ms.locfileid: "47226461"
---
# <a name="quickstart-moderate-with-custom-image-lists-in-net"></a>クイック スタート: .NET でカスタム画像リストを使用してモデレートする
...
- カスタム画像リストを作成する
- リストからの画像の追加と削除
- リスト内のすべての画像の ID を取得する
- リストのメタデータの取得と更新
- リスト検索インデックスを更新する
- リスト内の画像に対して画像をスクリーニングする
- リストからすべての画像を削除する
- カスタム リストを削除する
...
1. ソリューションに新しい**コンソール アプリ (.NET Framework)** プロジェクトを追加します。
   ...
   サンプル コードで、プロジェクトに **ImageLists** と名前を付けます。
...
次のクラスと静的フィールドを Program.cs 内の **Program** クラスに追加します。
...
## <a name="create-a-method-to-create-the-custom-list"></a>カスタム リストを作成するメソッドを作成する
...
このクイック スタートでは、リスト内の画像にタグを適用する方法を説明しません。 
...
## <a name="create-a-method-to-remove-images-from-the-list"></a>リストから画像を削除するメソッドを作成する
...
## <a name="create-a-method-to-get-all-of-the-content-ids-for-images-in-the-list"></a>リスト内の画像のすべてのコンテンツ ID を取得するメソッドを作成する
...
## <a name="create-a-method-to-update-the-details-of-the-list"></a>リストの詳細を更新するメソッドを作成する
...
## <a name="create-a-method-to-retrieve-the-details-of-the-list"></a>リストの詳細を取得するメソッドを作成する
...
## <a name="create-a-method-to-refresh-the-search-index-of-the-list"></a>リストの検索インデックスを更新するメソッドを作成する

**Program** クラスに次のメソッドを追加します。

リストを更新するたびに、リストを使用して画像をスクリーニングする前に、検索インデックスを更新する必要があります。
...
## <a name="create-a-method-to-match-images-against-the-list"></a>画像をリストと照合するメソッドを作成する
...
## <a name="create-a-method-to-delete-all-images-from-the-list"></a>リストからすべての画像を削除するメソッドを作成する
...
## <a name="create-a-method-to-delete-the-list"></a>リストを削除するメソッドを作成する
...
## <a name="create-a-method-to-retrieve-ids-for-all-image-lists"></a>すべての画像リストの ID を取得するメソッドを作成する
