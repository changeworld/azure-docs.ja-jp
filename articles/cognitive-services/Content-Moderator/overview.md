...
Web ポータルで Content Moderator の使用を開始するには、「[Web 上で Content Moderator を試す](quick-start.md)」の手順に従います。 あるいは、[クライアント ライブラリのクイックスタート](client-libraries.md)を完了し、コードに基本シナリオを実装します。