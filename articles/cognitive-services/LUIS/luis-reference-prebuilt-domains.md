...
| ---------------- |-----------------------|:------:|
| カレンダー | Calendar ドメインには、予定の追加、削除、または編集、参加者の空き状況の確認、カレンダー イベントに関する情報の検索を行う意図とエンティティが用意されています。| en-US<br/> zh-CN |
| Camera | Camera ドメインには、写真の撮影、ビデオの録画、ビデオのアプリケーションへのブロードキャストに関する意図とエンティティが用意されています。| en-US |
| 通信 | メッセージの送信と電話の発信を行います。| en-US <br/> zh-CN |
| Entertainment  | 音楽、映画、テレビに関するクエリを処理します。| en-US |
| イベント | コンサート、フェスティバル、スポーツ ゲーム、お笑いライブのチケットを予約します。| en-US |
| Fitness | フィットネス アクティビティの追跡に関する要求を処理します。| en-US |
| ゲーム | マルチプレーヤー ゲームでゲーム パーティーに関する要求を処理します。| en-US |
...
| 注 | Note ドメインには、メモの作成、編集、および検索に関する意図とエンティティが用意されています。| en-US<br/> zh-CN |
...
| アラーム | リマインダーの作成、編集、および検索に関する要求を処理します。| en-US<br/> zh-CN |
| RestaurantReservation | レストランの予約を管理する要求を処理します。| en-US<br/> zh-CN |
| Taxi | タクシーの予約を処理します。| en-US<br/> zh-CN |
| 翻訳 | テキストを対象言語に翻訳します。| en-US<br/> zh-CN |
| TV | テレビを制御します。| en-US |
| 公共事業  | 多くのドメインで一般的に使われている要求 ("ヘルプ"、"繰り返す"、"やり直す" など) を処理します。| en-US |
...
| 意図の名前 | 説明 | 例 |
| ---------------- |-----------------------|----|
| Add | 新しい 1 回限りの項目をカレンダーに追加します。| 日曜日午後 2 時に美由と約束 <br/><br/>会議のスケジュールを設定したい<br/><br/>会議を設定する必要がある|
...
| 削除 | カレンダー エントリを削除する要求。| Carol との約束をキャンセルして。 <br/><br/>午前 9 時の会議を削除して<br/>|
| 編集 | 既存の会議またはカレンダー エントリを変更する要求。| 午前 9 時の会議を午前 10 時に変更して。<br/><br/>自分のスケジュールを更新したい。<br/><br/>Ryan との会議予定を変更して。|
| 検索 | 自分の週間カレンダーを表示します。| 歯科の診察予定を探して。 <br/><br/>カレンダーを表示して<br/>|

### <a name="entities"></a>エンティティ
| エンティティ名 | 説明 | 例 |
| ---------------- |-----------------------|----|
| リージョン | カレンダー項目、会議、予定の場所。 たとえば、住所、都市、地域などです。| 209 ナッシュビル ジム <br/><br/>897 パンケーキ ハウス<br/><br/>ガレージ|
| 件名 | 会議または予定のタイトル。| 歯科の予約 <br/><br/>Julia とランチ<br/><br/>医師の予約|
...
| CaptureSelfie | 自撮り写真を撮って。| 自撮りして。 <br/><br/>私の写真を撮って |
| CaptureVideo | ビデオの録画を開始して。| 録画を開始して <br/><br/>録画の開始|
| StartBroadcasting| ビデオのブロードキャストを開始して。| Facebook へのブロードキャストを開始して。|
| StopBroadcasting| ビデオのブロードキャストを停止して。| ブロードキャストを停止して。|
| StopVideoRecording| ビデオの録画を停止して。| 止めて<br/><br/>録画の停止|
...
| 意図の名前 | 説明 | 例 |
| ---------------- |-----------------------|----|
| AddContact| ユーザーの連絡先リストに新しい連絡先を追加します。|新しい連絡先を追加して <br/><br/>この番号を保存して、琴音と名前を付けて|
| AddMore| 段階的な電子メールまたはテキストの作成の一部として、電子メールまたはテキストに追加します。|テキストに追加 <br/><br/>電子メールの本文に追加|
| リダイレクト先| 電話の着信に応答します。|電話に応答して <br/><br/>電話に出て|
...
| 確認| アクションを確認します。|[はい]<br/>OK<br/>大丈夫<br/>このメールの送信を確定します。<br/>|
...
| 無視| 電話の着信を無視します。|応答しないで<br/>着信を無視して|
...
| カテゴリ | メッセージまたは電子メールのカテゴリ。| 重要:<br/>優先度が高い|
...
| 折れ線グラフ | ユーザーが電話をかけるとき、またはテキスト/電子メールを送信するときに使用したい回線。| 会社の回線<br/>British cell<br/>Skype|
| メッセージ | 電子メールまたはテキストとして送信するメッセージ。| 今日は素晴らしい会議でしたね。 また近いうちに会いましょう。|
| MessageType | 連絡先またはメッセージ受信者の名前。| テキスト<br/>電子メール|
...
| キーワード| より詳しいメディア スロットには存在しない属性を指定する一般的な検索キーワード。|Soundtracks<br/>ムーン リバー<br/>アメリア・イアハート|
| 言語 | 映画の G、R など、メディア コンテンツ レーティング。|フランス語<br/>英語<br/>韓国語|
...
| 役割| メディアの作成において、ある人物が果たした役割。|歌う<br/>監督した<br/>別|
...
| エンティティ名 | 説明 | 例 |
| ---------------- |-----------------------|----|
| ActivityType | 追跡するアクティビティの種類。 |実行<br/>散歩<br/>水泳<br/>サイクル |
| Food | フィットネス アプリで追跡する食べ物の種類。 |Banana<br/>サーモン<br/>プロテイン シェイク|
| MealType| 健康またはフィットネス アプリで追跡する食事の種類。|朝食<br/>夕食<br/>昼食<br/>夜食|
| 測定| フィットネスまたは健康アプリで使用される時間、距離、または体重の測定単位の種類。|キロメートル<br/>マイル<br/>分<br/>キログラム|
...
| エンティティ名 | 説明 | 例 |
| ---------------- |-----------------------|----|
| 連絡先| マルチプレーヤー ゲームで使用する連絡先の名前。|Carol<br/>Jim|
...
| エンティティ名 | 説明 | 例 |
| ---------------- |-----------------------|----|
| デバイス | オンまたはオフにすることができるデバイスの種類。|コーヒー メーカー<br/>サーモスタット<br/>照明|
| 操作 | デバイスに設定する状態。|lock<br/>オープン<br/>on<br/>オフ|
| ルーム | デバイスがある場所または部屋。|リビング ルーム<br/>寝室<br/>キッチン|
...
| 一時停止 | 再生中の音楽を一時停止します。|一時停止<br/>音楽を一時停止して<br/>トラックを一時停止して|
...
| 再開 | 再生中の音楽を再開します。|歌を再開して<br/>音楽を再開して<br/>一時停止を解除|
| SkipBack | トラックを後方にスキップします。|次の歌にスキップして<br/>次の歌を再生して|
| SkipForward |トラックを前方にスキップ|前の歌を再生して<br/>前のトラックに戻って |
...
| 確認 | メモに関するアクションを確認します。|私は大丈夫です<br/>はい<br/>リスト上のすべての項目を保存することを確認します。|
| [作成] | 新しいメモを作成します。 | リストを作成して<br/>明人が 5 月第 1 週にいることを忘れないようにするメモ|
| 削除 | メモ全体を削除して。 |休暇リストを削除して <br/>買い物メモを削除して|
...
| テキスト | メモまたはリマインダーのテキスト。|散歩前にストレッチ<br/>明日は長距離走|
| タイトル | メモのタイトル。|買い物メモ<br/>電話する相手<br/>To do|
...
|[ヘルプ]| ヘルプを要求します。|助けてください。<br/>こんにちは<br/>何ができますか?<br/>ヘルプが必要です| 
...
|スリープ|デバイスをスリープ状態にします。|スリープして<br/>スリープ<br/>マイ コンピューターをスリープして|
...
|TurnOnSetting|デバイスの設定をオンにします。|反対に、 <br/> オフ|
...
|確認|場所に関するアクションを確認します。|レストランの予約を確認して。|
|終了|場所に関連するタスクを終了するアクション。|終了してください<br/>道案内を終了して|
...
| 製品 | 場所が提供している製品。 | 衣類<br/>デジタル ASR カメラ<br/>鮮魚 | 
...
| [作成]| 新しいリマインダーを作成します。|リマインダーを作成して<br/>牛乳の購入を通知して<br/>自宅に帰ったら忘れずに Rebecca に電話したい|
| 削除 | リマインダーを削除します。|写真のリマインダーを削除して<br/>このリマインダーを削除して|
| 検索 | リマインダーを検索します。|自分の記念日に関するリマインダーはありますか?<br/>Christine の誕生日に関するリマインダーがあるかどうかを確認できますか?|

### <a name="entities"></a>エンティティ
| エンティティ名 | 説明 | 例 |
| ---------------- |-----------------------|----|
| テキスト | リマインダーのテキスト説明です。|クリーニングの受け取り<br/>サービス センターで下車|
...
| キャンセル | タクシーの予約に関するアクションを取り消します。|タクシーをキャンセルして<br/>Uber をキャンセルして|
...
| 意図の名前 | 説明 | 例 |
| ---------------- |-----------------------|----|
| 翻訳| テキストを別の言語に翻訳します。|フランス語に翻訳して<br/>「こんにちは」をドイツ語に翻訳して|
...
| テキスト | 翻訳するテキスト。|Hello World<br/>おはようございます<br/>こんばんは|
...
| 意図の名前 | 説明 | 例 |
| ---------------- |-----------------------|----|
| キャンセル | アクションを取り消します。|メッセージを取り消して<br/>もう電子メールを送信したくない|
| 確認 | アクションを確認します。|はい、確認します<br/>いいですね、確認します<br/>OK、確認します|
...
| [ヘルプ] | ヘルプを要求します。|助けてください<br/>ヘルプを開いて<br/>help|
...
| エンティティ名 | 説明 | 例 |
| ---------------- |-----------------------|----|
| リージョン| 気象リクエストの絶対的な場所。|シアトル<br/>パリ<br/>パロ アルト|
...
| 意図の名前 | 説明 | 例 |
| ---------------- |-----------------------|----|
| 移動する。 | 指定された Web サイトに移動する要求。 |facebook.com に移動して<br/>www.twitter.com にアクセスして|
