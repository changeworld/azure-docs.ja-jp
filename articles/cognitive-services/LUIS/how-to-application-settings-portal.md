...
## <a name="change-application-settings"></a>アプリケーション設定の変更

設定を変更するには、ページでトグルを選択します。

[!INCLUDE [App settings](includes/app-settings.md)]

## <a name="change-version-settings"></a>バージョン設定の変更
...
* [発行の設定](luis-how-to-publish-app.md#configuring-publish-settings)