...
1. **number** エンティティをアプリに追加した後、アプリを[トレーニング](interactive-test.md)して[発行](PublishApp.md)します。
...
1. **datetimeV2** エンティティをアプリに追加した後、アプリを[トレーニング](interactive-test.md)して[発行](PublishApp.md)します。
2. **[アプリの発行]** ページでエンドポイント URL をクリックして、LUIS エンドポイントを Web ブラウザーで開きます。 
