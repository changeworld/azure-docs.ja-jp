...
4. 発話の例を意図に追加します。
    ...
    [![意図に新しい発話を追加している LUIS のスクリーンショット](media/luis-tutorial-pattern/hr-orgchart-manager-intent.png "意図に新しい発話を追加している LUIS のスクリーンショット")](media/luis-tutorial-pattern/hr-orgchart-manager-intent.png#lightbox)
