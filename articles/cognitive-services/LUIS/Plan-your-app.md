...
LUIS には、チケット注文におけるチケット数に使用できる `Number` など、一般的な種類については、[事前構築済みのエンティティ](Pre-builtEntities.md)が用意されています。
...
お使いのアプリによってエンドポイント発話が取得されたら、[アクティブ ラーニング](label-suggested-utterances.md)、[フレーズ リスト](luis-concept-feature.md)、および[パターン](luis-concept-patterns.md)を使用して、予測機能強化の実装を計画します。 
...
* LUIS アプリを作成するための簡単なチュートリアルについては、[最初の Language Understanding Intelligent Service (LUIS) アプリの作成][luis-get-started-create-app]に関するページをご覧ください。
