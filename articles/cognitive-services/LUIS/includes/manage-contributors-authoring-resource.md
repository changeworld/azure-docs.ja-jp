...
ご自身が Azure サブスクリプションの所有者または管理者の場合は、リソースに共同作成者を追加できます。

ご自身が Azure サブスクリプションの所有者または管理者でない場合は、お使いの Azure アカウントに `Microsoft.Authorization/roleAssignments/write` アクセス許可が必要です。
