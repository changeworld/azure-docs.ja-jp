...
アプリ ID、バージョン ID、および例を指定して [examples.add](/javascript/api/@azure/cognitiveservices-luis-authoring/examples?view=azure-node-lates) を呼び出します。
