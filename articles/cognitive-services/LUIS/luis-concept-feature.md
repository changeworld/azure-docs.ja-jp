...
1 つの特性または概念を記述するために、複数の特徴を使用できます。 よく使われる組み合わせは、フレーズ リストの特徴と、特徴として使用されることも多いエンティティ型を使用することです。
...
最初の例として、フライト予約の意図とチケット予約エンティティが使用される、フライト予約用のアプリを考えてみましょう。

チケット予約エンティティは、フライト先についての機械学習エンティティです。 場所を抽出するために、次の 2 つの特徴を使用します。

* 関連する単語のフレーズ リスト (**飛行機**、**フライト**、**予約**、**チケット**など)
* エンティティに対する特徴として事前構築済みの **geographyV2** エンティティ

### <a name="pizza-entity-example"></a>ピザ エンティティの例

別の例として、ピザの注文を作成する意図と、ピザ エンティティが使用されるピザ注文用のアプリを考えてみましょう。

ピザ エンティティは、ピザの詳細についての機械学習エンティティです。 詳細を抽出するために、次の 2 つの特徴を役立てます。

* 関連する単語のフレーズ リスト (**チーズ**、**クラスト**、**ペペロニ**、**パイナップル**など)
* エンティティに対する特徴として事前構築済みの **number** エンティティ
