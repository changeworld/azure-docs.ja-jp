...
1. [プル要求](https://help.github.com/github/collaborating-with-issues-and-pull-requests/about-pull-requests) (PR) が発生したときにトリガーされる **PR ワークフロー**。 このワークフローでは、更新がメイン ブランチにマージされる *前に* PR の内容を検証します。
