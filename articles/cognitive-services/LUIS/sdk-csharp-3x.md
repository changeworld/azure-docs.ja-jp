---
title: クイック スタート:.NET 用 Language Understanding (LUIS) 作成クライアント ライブラリ 3.x
titleSuffix: Azure Cognitive Services
description: .NET 用の LUIS クライアント ライブラリ 3.x を使ってみます。 以下の手順に従って、パッケージをインストールし、基本タスクのコード例を試してみましょう。
...
ms.locfileid: "74808021"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>クイック スタート:.NET 用 Language Understanding (LUIS) クライアント ライブラリ 3.x

.NET 用 Language Understanding (LUIS) クライアント ライブラリ 3.x の使い方を説明します。 以下の手順に従って、パッケージをインストールし、基本タスクのコード例を試してみましょう。  Language Understanding (LUIS) を使うと、カスタムの機械学習インテリジェンスをユーザーの自然言語での会話に適用して、全体の意味を予測し、関連性のある詳細な情報を引き出すことができます。

.NET 用 Language Understanding (LUIS) クライアント ライブラリ 3.x を使用して次のことを行います。

* 発行したエンドポイントに対してクエリを実行する
