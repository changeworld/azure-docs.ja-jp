...
1. 上部のナビゲーション バーの **[Test]\(テスト\)** を選択します。 
    ...
    [ ![右上のナビゲーション バーでテストが強調表示されている LUIS アプリのスクリーンショット](./media/luis-tutorial-batch-testing/hr-first-image.png)](./media/luis-tutorial-batch-testing/hr-first-image.png#lightbox)

2. 右側のパネルで、**[Batch testing panel]\(バッチ テスト パネル\)** を選択します。 

    [ ![[Batch test panel] (バッチ テスト パネル) が強調表示されている LUIS アプリのスクリーンショット](./media/luis-tutorial-batch-testing/hr-batch-testing-panel-link.png)](./media/luis-tutorial-batch-testing/hr-batch-testing-panel-link.png#lightbox)

3. **[Import dataset]\(データセットのインポート\)** を選択します。

    [ ![[Import dataset] (データセットのインポート) が強調表示されている LUIS アプリのスクリーンショット](./media/luis-tutorial-batch-testing/hr-import-dataset-button.png)](./media/luis-tutorial-batch-testing/hr-import-dataset-button.png#lightbox)
...
6. **[実行]** ボタンを選択します。 テストが完了するまで待ちます。
    ...
    [ ![[実行] が強調表示されている LUIS アプリのスクリーンショット](./media/luis-tutorial-batch-testing/hr-run-button.png)](./media/luis-tutorial-batch-testing/hr-run-button.png#lightbox)
...
1. 上部のナビゲーション パネルにある **[テスト]** ボタンを選択することによってバッチ テスト パネルを閉じます。 
    ...
    [ ![[テスト] ボタンが強調表示されている LUIS のスクリーンショット](./media/luis-tutorial-batch-testing/hr-close-test-panel.png)](./media/luis-tutorial-batch-testing/hr-close-test-panel.png#lightbox)

2. 意図の一覧から **[GetJobInformation]** を選択します。 

    [ ![[テスト] ボタンが強調表示されている LUIS のスクリーンショット](./media/luis-tutorial-batch-testing/hr-select-intent-to-fix-1.png)](./media/luis-tutorial-batch-testing/hr-select-intent-to-fix-1.png#lightbox)
