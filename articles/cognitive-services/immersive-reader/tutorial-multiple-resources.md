...
4. ブラウザーを開き、[http://localhost:3000](http://localhost:3000) に移動します。 ページに上記のコンテンツが表示されます。 **[EastUS Immersive Reader]\(EastUS イマーシブ リーダー\)** ボタンまたは **[WestUS Immersive Reader]\(WestUS イマーシブ リーダー\)** ボタンをクリックし、それぞれのリソースを使用してイマーシ ブリーダーを起動します。
