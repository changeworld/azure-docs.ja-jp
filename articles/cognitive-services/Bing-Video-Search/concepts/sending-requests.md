---
title: Bing Video Search API に検索要求を送信する
titleSuffix: Azure Cognitive Services
description: この記事では、Bing Video Search API に送信される要求のパラメーターと属性、およびそこから返される JSON 応答オブジェクトについて説明します。
