---
title: Azure Cognitive Services、Text Analytics API の Go のクイック スタート | Microsoft Docs
...
ms.locfileid: "43771437"
---
# <a name="quickstart-for-text-analytics-api-with-go"></a>Go での Text Analytics API のクイック スタート 
<a name="HOLTop"></a>
...
## <a name="identify-linked-entities-request"></a>リンクされているエンティティの識別要求
...
## <a name="identify-linked-entities-response"></a>リンクされているエンティティの識別応答
