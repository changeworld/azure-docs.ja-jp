...
ms.locfileid: "73750142"
---
# <a name="quickstart-use-the-text-analytics-client-library-for-detecting-language"></a>クイック スタート:Text Analytics クライアント ライブラリを使って言語を検出する
