---
title: Translator Text と Java でテキストの言語を認識する | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: このクイック スタートでは、Cognitive Services の Translator Text API と Java を使って、ソース テキストの言語を認識します。
