---
title: Translator Text と Node.js でテキストの表記を変換する | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: このクイック スタートでは、Cognitive Services の Translator Text API と Node.js を使って、1 つの言語の中でテキストの表記を変換します。
...
ms.locfileid: "43770826"
---
# <a name="quickstart-transliterate-text-with-nodejs"></a>クイック スタート: Node.js を使ったテキストの表記変換
