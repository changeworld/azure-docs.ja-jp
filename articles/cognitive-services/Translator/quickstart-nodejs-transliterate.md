---
title: 'クイック スタート: テキスト スクリプトを変換する、Node.js - Translator Text API'
titleSuffix: Azure Cognitive Services
description: このクイック スタートでは、Node.js で Translator Text API を使って 1 つの言語の中でテキストの表記を変換します。
...
ms.locfileid: "49646198"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-nodejs"></a>クイック スタート: Translator Text REST API を使用してテキストを表記変換する (Node.js)
