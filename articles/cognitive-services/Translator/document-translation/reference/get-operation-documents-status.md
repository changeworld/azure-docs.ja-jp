---
title: ドキュメント翻訳の操作ドキュメント状態の取得
titleSuffix: Azure Cognitive Services
description: 操作ドキュメント状態の取得メソッドは、バッチ ドキュメント翻訳要求内のすべてのドキュメントの状態を返します。
...
ms.locfileid: "105613778"
---
# <a name="document-translation-get-operation-documents-status"></a>ドキュメント翻訳: 操作ドキュメント状態の取得

操作ドキュメント状態の取得メソッドは、バッチ ドキュメント翻訳要求内のすべてのドキュメントの状態を返します。
...
## <a name="get-operation-documents-status-response"></a>操作ドキュメント状態の取得の応答

### <a name="successful-get-operation-documents-status-response"></a>成功した操作ドキュメント状態の取得の応答
