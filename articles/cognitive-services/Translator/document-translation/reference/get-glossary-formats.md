---
title: ドキュメント翻訳の用語集の形式の取得メソッド
titleSuffix: Azure Cognitive Services
description: 用語集の形式の取得メソッドでは、サポートされている用語集の形式の一覧が返されます。
...
ms.locfileid: "105613813"
---
# <a name="document-translation-get-glossary-formats"></a>ドキュメント翻訳: 用語集の形式の取得

用語集の形式の取得メソッドでは、ドキュメント翻訳サービスでサポートされている用語集形式の一覧が返されます。 一覧には、使用される共通ファイル拡張子が含まれています。
...
## <a name="get-glossary-formats-response"></a>用語集の形式の取得の応答

一覧の基本データ型が、Get Glossary Formats API で返されます。

### <a name="successful-get-glossary-formats-response"></a>成功した用語集の形式の取得の応答
