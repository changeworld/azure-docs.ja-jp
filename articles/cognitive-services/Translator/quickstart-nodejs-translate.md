---
title: Translator Text と Node.js でテキストを翻訳する | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: このクイック スタートでは、Cognitive Services の Translator Text API と Node.js を使って、テキストを別の言語に翻訳します。
...
ms.locfileid: "43770842"
---
# <a name="quickstart-translate-text-with-nodejs"></a>クイック スタート: Node.js を使ったテキストの翻訳
