...
>[!NOTE]
> エンドポイント、ルート、要求パラメーターの詳細については、[Translator Text API 3.0 の Dictionary Break Sentence](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence) に関するページを参照してください。
