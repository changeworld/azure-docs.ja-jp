---
title: Translator Text と PHP で翻訳の代替候補を探す | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: このクイック スタートでは、Cognitive Services の Translator Text API と PHP を使って、文脈中における用語の例と翻訳の代替候補を探します。
...
ms.locfileid: "43771088"
---
# <a name="quickstart-find-alternate-translations-and-usage-with-php"></a>クイック スタート: PHP を使って翻訳の代替候補と用法を探す
