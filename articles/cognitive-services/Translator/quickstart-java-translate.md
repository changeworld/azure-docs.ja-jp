---
title: Translator Text と Java でテキストを翻訳する | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: このクイック スタートでは、Cognitive Services の Translator Text API と Java を使って、テキストを別の言語に翻訳します。
...
ms.locfileid: "43770729"
---
# <a name="quickstart-translate-text-with-java"></a>クイック スタート: Java を使ったテキストの翻訳
