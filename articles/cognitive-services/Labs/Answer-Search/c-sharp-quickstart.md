---
title: Microsoft Cognitive Services、Project Answer Search の C# のクイック スタート | Microsoft Docs
description: Azure 上の Microsoft Cognitive Services の Project Answer Search の使用を開始するためのコード サンプルです。
