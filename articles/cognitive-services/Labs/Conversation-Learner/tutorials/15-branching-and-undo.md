---
title: Conversation Learner アプリケーションでの分岐操作と元に戻す操作の使用方法 - Microsoft Cognitive Services | Microsoft Docs
titleSuffix: Azure
description: Conversation Learner アプリケーションで分岐操作と元に戻す操作を使用する方法について説明します。
...
2. [Undo Step]\(ステップを元に戻す\) をクリックします。
    - 直前のエントリが削除され、[Would you like anything else?] に戻っていることに注意してください  (以下のスクリーンショットを参照)。
