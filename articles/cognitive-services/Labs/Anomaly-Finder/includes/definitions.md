...
|**Value**  <br>*省略可能*|データの測定値。|数値 (倍精度浮動小数点型)|
...
|Name|説明|スキーマ|
|---|---|---|
|**Period**  <br>*省略可能*|データ ポイントの期間。 値が null であるか、存在しない場合には、API が自動で期間を決定します。|数値 (倍精度浮動小数点型)|
...
|**Period**  <br>*省略可能*|API が異常なポイントの検出に使用した期間。|数値 (浮動小数点型)|
