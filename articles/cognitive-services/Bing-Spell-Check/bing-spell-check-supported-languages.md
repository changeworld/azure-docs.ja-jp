---
title: Bing Spell Check API でサポートされている言語 (Azure 上の Microsoft Cognitive Services) | Microsoft Docs
description: Bing Spell Check API の操作で一般に使用可能な言語とプレビュー言語のサポートのリストです。
...
ms.locfileid: "45573792"
---
# <a name="supported-language-list-and-status"></a>サポートされている言語の一覧と状態
