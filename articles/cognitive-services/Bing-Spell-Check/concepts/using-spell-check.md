...
要求には、`mkt` クエリ パラメーターで[市場コード](https://docs.microsoft.com/rest/api/cognitiveservices/bing-spell-check-api-v7-reference#market-codes)を指定する必要があります。 指定しなかった場合は、要求の IP アドレスに基づく既定の市場が使用されます。
