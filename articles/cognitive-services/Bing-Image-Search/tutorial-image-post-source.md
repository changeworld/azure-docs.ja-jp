---
title: Bing 画像をアップロードして分析情報を取得する (ソース コード) | Microsoft Docs
description: Bing Image Search API を使用して画像をアップロードし、画像の分析情報を取得するコンソール アプリケーションのソース コードです。
...
ms.locfileid: "35373013"
---
# <a name="tutorial-bing-image-upload-for-insights"></a>チュートリアル: Bing 画像をアップロードして分析情報を取得する

これは、`POST` 要求で画像検索エンドポイントを使用する、「[Bing 画像をアップロードして分析情報を取得する](tutorial-image-post.md)」チュートリアルの完全なソース コードです。 アプリを実行するためには、ソース コードを C# コンソール アプリケーションにコピーします。 ビルドして、Visual Studio デバッガーで実行します。
