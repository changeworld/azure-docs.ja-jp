...
不足している機能について質問がある場合は、 [フィードバック ツール](https://feedback.azure.com/forums/932041-azure-cognitive-services?category_id=395749)を使用して、要求、または投票を検討してください。
