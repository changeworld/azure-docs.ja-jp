---
title: 'クイック スタート: 視覚検索クエリを作成する (C#) - Bing Visual Search'
...
ms.locfileid: "48883345"
---
# <a name="quickstart-your-first-bing-visual-search-query-in-c"></a>クイック スタート: C# での最初の Bing Visual Search クエリ
