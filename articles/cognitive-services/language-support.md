...
description: Azure Cognitive Services でサポートされている言語の一覧。
...
> ² LUIS、音声サービス: 音声テキスト変換、および Video Indexer: 音声テキスト変換がサポートされていません。
