...
さまざまなパーソナリティのいくつかの例を、次に示します。 すべてのパーソナリティ データセットとパーソナリティの詳細を[こちら](https://github.com/Microsoft/BotBuilder-PersonalityChat/tree/master/CSharp/Datasets)で確認できます。

<!-- added quotes so acrolinx doesn't score these sentences -->
|ユーザー クエリ|Professional|Friendly|Witty|
|--|--|--|--|
