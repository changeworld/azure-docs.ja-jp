---
title: ナレッジ ベースの公開 - Go のクイック スタート - Azure Cognitive Services | Microsoft Docs
description: QnA Maker に使用するナレッジ ベースを Go で公開する方法。
...
ms.locfileid: "43770841"
---
# <a name="publish-a-knowledge-base-in-go"></a>Go でナレッジ ベースを公開する
