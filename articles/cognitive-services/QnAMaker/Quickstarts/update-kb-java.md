---
title: ナレッジ ベースの更新 - Java のクイック スタート - Azure Cognitive Services | Microsoft Docs
...
1. [apache httpclient](http://hc.apache.org/downloads.cgi) ライブラリが必要となります。 たとえば、バイナリ HttpClient 4.x.x.tar.gz をダウンロードすると、プロジェクトへのインポートに必要な jar ファイルがすべて見つかります。
