---
title: 'クイック スタート: C# によるナレッジ ベースの公開 - QnA Maker'
titleSuffix: Azure Cognitive Services
description: QnA Maker に使用するナレッジ ベースを C# で公開する方法。
...
ms.locfileid: "47033058"
---
# <a name="publish-a-knowledge-base-in-c"></a>C# でナレッジ ベースを公開する
