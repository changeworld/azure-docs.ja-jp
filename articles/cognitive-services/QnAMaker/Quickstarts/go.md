---
title: Microsoft QnA Maker API (V4) の Go クイック スタート - Azure Cognitive Services | Microsoft Docs
...
ms.locfileid: "36301293"
---
# <a name="quickstart-for-microsoft-qna-maker-api-with-go"></a>Microsoft QnA Maker API の Go クイック スタート 
<a name="HOLTop"></a>
...
このコードを実行するには、[Go 1.10.1](https://golang.org/dl/) が必要です。
...
1. `kb` の値を、回答を求めるサポート技術情報の ID で置換します。 このサポート技術情報は [Publish](#Publish) メソッドを利用して公開しておく必要があります。
1. プログラムを実行します。
