...
音響マテリアルは、各サーフェスから反射される音エネルギーの量を制御します。 既定の音響マテリアルの吸音はコンクリートに似ています。 Project Acoustics はシーンのマテリアル名に基づいてマテリアルを提案します。
...
### <a name="estimating-azure-bake-cost"></a><a name="Estimating-bake-cost"></a> Azure のベイク コストの見積もり
...
## <a name="data-files"></a><a name="Data-Files"></a>データ ファイル
