...
description: Speech Service を使ってみましょう。 音声認識、音声合成、リアルタイムのトランザクションの取得、会話の文字起こし、ボットへの音声の統合を行います。
ms.openlocfilehash: a965090be737a10633ead2ca1ed7033ec061ed7f
ms.sourcegitcommit: 984c5b53851be35c7c3148dcd4dfd2a93cebe49f
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 01/28/2020
ms.locfileid: "76771977"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Speech Service のドキュメント</h1>
        <ul class="pivots">
            <li>
                <a href="#start">作業開始</a>
                <ul id="start">
                    <li>
                        <a href="#speechtotext">音声テキスト変換</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>マイクを使用して音声を認識する</h3>
                                                    <p>Speech SDK を使用してマイクからの音声を認識し、出力を文字起こしします。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>オーディオ ファイルから音声を認識する</h3>
                                                    <p>Speech SDK を使用して単一ファイルからの音声を認識し、出力を文字起こしします。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>BLOB からの非同期認識</h3>
                                                    <p>REST サービスを使用して、Azure Blob Storage に格納されたファイルからの音声を非同期的に認識します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>言語のサポート</h3>
                                                    <p>音声テキスト変換に対するプログラミング言語と音声言語のサポートについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>価格</h3>
                                                    <p>音声テキスト変換に関連したコストについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ドキュメントを確認する</h3>
                                                    <p>使用しているアプリ、ツール、製品に音声認識を追加する方法について説明します。 概念、チュートリアル、API リファレンス、リリースノートが含まれています。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <li>
                            <a href="#texttospeech">テキスト読み上げ</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>スピーカーに音声を合成する</h3>
                                                    <p>Speech SDK を使用して音声をオーディオ出力 (スピーカーなど) に合成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>オーディオ ファイルに音声を合成する</h3>
                                                    <p>Speech SDK を使用して音声をオーディオ ファイルに合成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>音声合成マークアップ言語</h3>
                                                    <p>音声合成マークアップ言語を使用して、オーディオ出力のピッチ、韻律、読み上げ速度を微調整します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>言語のサポート</h3>
                                                    <p>音声合成に関してサポートされる言語について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>価格</h3>
                                                    <p>テキスト読み上げに関連したコストについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ドキュメントを確認する</h3>
                                                    <p>使用しているアプリ、ツール、製品に音声合成を追加する方法について説明します。 概念、チュートリアル、API リファレンス、リリースノートが含まれています。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#intentrecognition">意図認識</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>言語のサポート</h3>
                                                    <p>意図認識に関してサポートされる言語について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ドキュメントを確認する</h3>
                                                    <p>使用しているアプリ、ツール、製品に意図認識を追加する方法について説明します。 概念、チュートリアル、API リファレンス、リリースノートが含まれています。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#speechtranslation">音声翻訳</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>マイクからの音声テキスト変換の翻訳</h3>
                                                    <p>Speech SDK を使用してマイクからの音声テキスト変換を翻訳します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>音声を複数のターゲット言語に翻訳する</h3>
                                                    <p>Speech SDK を使用して音声を複数のターゲット言語出力に翻訳します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>音声間翻訳</h3>
                                                    <p>Speech SDK を使用して音声間翻訳を行います。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>言語のサポート</h3>
                                                    <p>音声翻訳に対するプログラミング言語と音声言語のサポートについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ドキュメントを確認する</h3>
                                                    <p>使用しているアプリ、ツール、製品に音声翻訳を追加する方法について説明します。 概念、チュートリアル、API リファレンス、リリースノートが含まれています。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#conversationtranscription">会話の文字起こし</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>リアルタイムの会話を文字起こしする</h3>
                                                    <p>会話をリアルタイムに文字起こしする方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>会話を非同期的に文字起こしする</h3>
                                                    <p>非同期的に会話を文字起こしし、状態をポーリングして、出力をダウンロードする方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>コール センターの文字起こし</h3>
                                                    <p>さまざまなシステムから入ってくる大量の電話データを文字起こしする方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>言語のサポート</h3>
                                                    <p>会話の文字起こしに対するプログラミング言語と音声言語のサポートについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>価格</h3>
                                                    <p>会話の文字起こしに関連したコストについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ドキュメントを確認する</h3>
                                                    <p>会話の文字起こしと、それを自分の製品に統合する方法について詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#voice-assistants">音声アシスタント</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bot Framework との統合</h3>
                                                    <p>Bot Framework や Direct Line Speech チャネルなどについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>カスタム コマンドの使用</h3>
                                                    <p>ユーザーが自分の声を使ってタスクを完了できるように、堅牢なコマンドを簡単に作成し、音声アプリケーションを制御する方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ドキュメントを確認する</h3>
                                                    <p>音声アシスタントの構築に必要なことについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#deploy-architecture">ホスティング</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 音声サービス リソースを作成する</h3>
                                                    <p>Azure サブスクリプション キーを取得し、音声リソースを作成して、使用を開始する方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>音声サービス コンテナーをデプロイする</h3>
                                                    <p>Kubernetes と Helm を利用してオンプレミスで、または Azure Container Instances で、音声コンテナーを使用する方法について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ソブリン クラウド</h3>
                                                    <p>Azure ソブリン クラウドでの音声サービス リソースの可用性。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サポートされているリージョン</h3>
                                                    <p>Speech Service がサポートされている場所について説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>GitHub のイシュー</h3>
                                                    <p>GitHub で、Speech SDK に関する未解決のイシューを参照したり、新しいイシューを作成したりできます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>スタック オーバーフロー</h3>
                                                    <p>Stack Overflow で、質問をしたり、Speech Service コミュニティによるサポートを受けたりできます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>UserVoice フォーラム</h3>
                                                    <p>Speech Service に関するアイデアの共有、拡張機能の提案、新機能のリクエストを行うことができます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>シナリオと使用可能な機能</h3>
                                                    <p>さまざまなプログラミング言語と環境にわたる Speech SDK 機能の多数のシナリオについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>サポートされているリージョン</h3>
                                                    <p>音声サービスを利用できるリージョンとエンドポイントについて説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                ...
                <ul id="customization">
                    <li>
                        <a href="#speech-to-text-customization">音声テキスト変換</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>フレーズ リストを使用して精度を向上させる</h3>
                                                    <p>Speech SDK でフレーズ リストを使用して認識精度を高めます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>テナント モデルを使用して精度を向上させる</h3>
                                                    <p>Office 365 データを使用してカスタム モデルを生成し、組織固有の用語に対して音声認識精度を最適化します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Custom Speech を使用して精度を向上させる</h3>
                                                    <p>ご利用のアプリ、ツール、製品に使用する Microsoft の音声テキスト変換の正確性を評価して改善することのできる一連のオンライン ツールです。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>言語のサポート</h3>
                                                    <p>Custom Speech に対するプログラミング言語と音声言語のサポートについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>価格</h3>
                                                    <p>Custom Speech に関連したコストについて詳しく説明します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <li>
                        <a href="#text-to-speech-customization">テキスト読み上げ</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SSML を使用して合成を改善する</h3>
                                                    <p>音声合成マークアップ言語を使用して、オーディオ出力のピッチ、韻律、読み上げ速度を微調整します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Custom Voice を使用して合成を改善する</h3>
                                                    <p>お客様のスピーチ データを使用して、テキスト読み上げアプリ用の認識可能な独自の音声を作成します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Audio Content Creation を使用して合成を改善する</h3>
                                                    <p>合成された音声出力を Audio Content Creation ツールを使用して微調整します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>カスタム ニューラル音声を利用する</h3>
                                                    <p>これは、カスタム ニューラル音声を作成できるゲーティングされた機能です。 アクセスと制限について詳しく説明します。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>言語のサポート</h3>
                                                    <p>カスタム音声に対するプログラミング言語と音声言語のサポートについて詳しく説明します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
