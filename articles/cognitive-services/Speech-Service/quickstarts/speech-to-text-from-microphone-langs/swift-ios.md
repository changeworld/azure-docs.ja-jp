---
title: クイック スタート:音声を認識する、Swift - Speech Service (iOS)
titleSuffix: Azure Cognitive Services
description: Cognitive Services Speech SDK を使用して iOS デバイス向けの音声認識アプリを Swift で作成する方法について説明します。
