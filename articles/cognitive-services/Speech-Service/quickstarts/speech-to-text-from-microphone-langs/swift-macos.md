---
title: クイック スタート:音声を認識する、Swift - Speech サービス (macOS)
titleSuffix: Azure Cognitive Services
description: Cognitive Services Speech SDK を使用して macOS コンピューター向けの音声認識アプリを Swift で作成する方法について説明します。
