...
description: このクイックスタートでは、Speech SDK を使用して、ある言語の音声を別の言語の音声に対話的に翻訳します。
...
ms.locfileid: "81400249"
---
# <a name="quickstart-translate-speech-to-multiple-languages"></a>クイック スタート:音声を複数の言語に翻訳する
