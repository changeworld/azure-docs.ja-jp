...
description: このクイックスタートでは、Speech SDK を使用して、ある言語の音声を別の言語のテキストに対話的に翻訳します。
...
ms.locfileid: "81400262"
---
# <a name="quickstart-translate-speech-to-speech"></a>クイック スタート:音声間翻訳
