...
まず [Azure サブスクリプション キー](https://azure.microsoft.com/try/cognitive-services/)を入手した後、[Batch トランスクリプト API](batch-transcription.md) のドキュメントを参照する必要があります。
