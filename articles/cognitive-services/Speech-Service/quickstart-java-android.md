...
このアプリケーションは、Microsoft Cognitive Services Speech SDK Maven パッケージ (バージョン 1.3.0) と Android Studio 3.1 が基になっています。
...
1. 表示されたウィンドウで、Android 用 Speech SDK の名前とバージョン (`com.microsoft.cognitiveservices.speech:client-sdk:1.3.0`) を入力します。 **[OK]** をクリックします。
