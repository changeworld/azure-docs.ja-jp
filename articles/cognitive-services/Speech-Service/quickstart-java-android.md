...
このアプリケーションは、Speech SDK Maven パッケージ (バージョン 1.5.1) と Android Studio 3.3 が基になっています。
...
1. 表示されたウィンドウで、Android 用 Speech SDK の名前とバージョン (`com.microsoft.cognitiveservices.speech:client-sdk:1.5.1`) を入力します。 **[OK]** をクリックします。
