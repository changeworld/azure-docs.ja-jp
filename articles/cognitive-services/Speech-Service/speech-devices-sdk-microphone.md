---
title: Speech Devices SDK のマイク配列の推奨事項
...
\*\*_THD を測定するには低ひずみのスピーカーが必要です (例: Neumann KH120)_

\*\*_高品質なコミュニケーション (VoIP) アプリケーションには、"より広い" 周波数範囲が必要になる場合があります_
