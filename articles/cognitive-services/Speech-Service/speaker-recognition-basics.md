---
title: Speaker Recognition の基礎 - Speech Service
titleSuffix: Azure Cognitive Services
description: Speech SDK を使用して、"誰が話しているのか" という質問に答える方法について学習します。 この記事では、話者の認証および識別の両方を使用する場合の一般的な設計パターンについて学習します。
...
ms.locfileid: "84632299"
---
# <a name="learn-the-basics-of-speaker-recognition"></a>Speaker Recognition の基礎を学ぶ

この記事では、Speech SDK を使用した Speaker Recognition の基本的な設計パターンについて学習します。これには次のものが含まれます。
