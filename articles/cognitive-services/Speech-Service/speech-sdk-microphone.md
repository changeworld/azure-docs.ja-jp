---
title: Speech SDK のマイク配列の推奨事項
titleSuffix: Azure Cognitive Services
description: Speech SDK のマイク配列の推奨事項。 Microsoft Audio Stack での使用には、次の配列のジオメトリをお勧めします。
...
ms.locfileid: "131091259"
---
# <a name="speech-sdk-microphone-array-recommendations"></a>Speech SDK のマイク配列の推奨事項

この記事では、Speech SDK のマイク配列を設計する方法について説明します。

Speech SDK は、マイク ジオメトリやコンポーネントの選択など、次のガイドラインに従って設計されたマイク配列で最適に動作します。 ガイダンスは、統合と電気的な考慮事項でも提供されます。
...
> [オーディオ処理の詳細を学習する](audio-processing-overview.md)
