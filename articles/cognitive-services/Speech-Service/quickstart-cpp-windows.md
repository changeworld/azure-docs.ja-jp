---
title: 'クイック スタート: Windows で C++ と Cognitive Services Speech SDK を使用して音声を認識する'
titleSuffix: Microsoft Cognitive Services
description: Windows デスクトップで C++ と Cognitive Services Speech SDK を使用して音声を認識する方法について説明します
