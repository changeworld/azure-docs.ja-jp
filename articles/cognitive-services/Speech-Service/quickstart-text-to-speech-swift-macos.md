---
title: クイック スタート:音声を合成する、Swift - Speech Service
titleSuffix: Azure Cognitive Services
description: macOS 上で Swift と Speech SDK を使用して音声を合成する方法について説明します
...
[音声認識](quickstart-swift-macos.md)のクイックスタートも利用できます。

この記事では、Swift と Cognitive Services Speech SDK を使用して、テキストから音声を合成して既定のオーディオ出力で再生する macOS アプリを作成する方法について説明します。
...
> [!NOTE] 
> このチュートリアルは 1.7.0 より前のバージョンの SDK では動作しません。
