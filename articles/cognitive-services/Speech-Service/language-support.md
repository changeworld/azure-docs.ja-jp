...
Microsoft の音声認識 API では、次の言語がサポートされています。 言語ごとにさまざまなレベルのカスタマイズを利用できます。
 ...
 en-AU | 英語 (オーストラリア) | [はい] | はい | [はい]
 en-CA | 英語 (カナダ) | [はい] | はい | [はい]
 en-GB | 英語 (イギリス) | [はい] | はい | [はい]
 en-IN | 英語 (インド) | いいえ  | 可能  | [はい]
 en-NZ | 英語 (ニュージーランド) | [はい] | はい | [はい]  
 en-US | 英語 (米国) | [はい] | はい | [はい]
 es-ES | スペイン語 (スペイン) | [はい] | [はい] | いいえ 
 es-MX | スペイン語 (メキシコ) | [はい] | [はい] | いいえ 
 fi-FI | フィンランド語 (フィンランド) | いいえ  | いいえ  | いいえ 
 fr-CA | フランス語 (カナダ) | [はい] | [はい] | いいえ 
...
言語の一覧は、REST API の言語エンドポイントを利用してプログラムで取得できます。 この一覧には、各言語コードと、英語表記またはサポートされているその他の言語表記による言語名が記載されています。 この一覧は、新しい言語が使用できるようになると、Microsoft Translator サービスによって更新されます。
