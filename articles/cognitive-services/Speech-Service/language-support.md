...
|------------------------------------|--------|---------------------------------------------------|-------------------------------|
| アラビア語 (バーレーン)、現代標準  | `ar-BH` | 言語モデル                                   | はい                           | 
| アラビア語 (エジプト)                     | `ar-EG` | 言語モデル                                   | はい                          |
...
| アラビア語 (サウジアラビア)              | `ar-SA` | 言語モデル                                   | はい                          |
| アラビア語 (パレスチナ自治政府)        | `ar-PS` | 言語モデル                                   |                           |
| アラビア語 (シリア)                     | `ar-SY` | 言語モデル                                   | はい                          |
| アラビア語 (アラブ首長国連邦)      | `ar-AE` | 言語モデル                                   |                           |
| ブルガリア語 (ブルガリア)               | `bg-BG` | 言語モデル                                   |                           |
| カタルニア語 (スペイン)                    | `ca-ES` | 言語モデル                                   | はい                          |
| 中国語 (繁体字)   | `zh-HK` | 音響モデル (20201015)<br>言語モデル                 |        はい                   |
| 中国語 (標準、簡体字)     | `zh-CN` | 音響モデル (20200910)<br>言語モデル                 |     はい                      |
| 中国語 (台湾標準中国語)       | `zh-TW` | 音響モデル (20190701、20201015)<br>言語モデル                 |           はい                |
| クロアチア語 (クロアチア)                 | `hr-HR` | 言語モデル                                   |                           |
| チェコ語 (チェコ共和国)             | `cs-CZ` | 言語モデル                                   |                           |
| デンマーク語 (デンマーク)                   | `da-DK` | 言語モデル                                   | はい                          |
| オランダ語 (オランダ)                | `nl-NL` | 音響モデル (20201015)<br>言語モデル                                   |    はい                       |
| 英語 (オーストラリア)                | `en-AU` | 音響モデル (20201019)<br>言語モデル                 | はい                          |
| 英語 (カナダ)                   | `en-CA` | 音響モデル (20201019)<br>言語モデル                 | はい                          |
| 英語 (香港)                | `en-HK` | 言語モデル                                   |                           |
| 英語 (インド)                    | `en-IN` | 音響モデル (20200923)<br>言語モデル                 | はい                          |
| 英語 (アイルランド)                  | `en-IE` | 言語モデル                                   |                           |
| 英語 (ニュージーランド)              | `en-NZ` | 音響モデル (20201019)<br>言語モデル                 |  はい                         |
| 英語 (ナイジェリア)                  | `en-NG` | 言語モデル                                   |                           |
| 英語 (フィリピン)              | `en-PH` | 言語モデル                                   |                           |
| 英語 (シンガポール)                | `en-SG` | 言語モデル                                   |                           |
| 英語 (南アフリカ)             | `en-ZA` | 言語モデル                                   |                           |
| 英語 (イギリス)           | `en-GB` | 音響モデル (20201019)<br>言語モデル<br>発音| はい                          |
| 英語 (米国)            | `en-US` | 音響モデル (20201019)<br>言語モデル<br>発音| はい                          |
| エストニア語 (エストニア)                  | `et-EE` | 言語モデル                                   |                           |
| フィンランド語 (フィンランド)                  | `fi-FI` | 言語モデル                                   |     はい                      |
| フランス語 (カナダ)                    | `fr-CA` | 音響モデル (20201015)<br>言語モデル                 |     はい                      |
| フランス語 (フランス)                    | `fr-FR` | 音響モデル (20201015)<br>言語モデル<br>発音|      はい                     |
| ドイツ語 (ドイツ)                   | `de-DE` | 音響モデル (20190701、20200619、20201127)<br>言語モデル<br>発音|  はい                         |
| ギリシャ語 (ギリシャ)                     | `el-GR` | 言語モデル                                   |                           |
| グジャラート語 (インド)                  | `gu-IN` | 言語モデル                                   |                           |
| ヒンディー語 (インド)                      | `hi-IN` | 音響モデル (20200701)<br>言語モデル                 |     はい                      |
| ハンガリー語 (ハンガリー)                | `hu-HU` | 言語モデル                                   |                           |
| アイルランド語 (アイルランド)                     | `ga-IE` | 言語モデル                                   |                           |
| イタリア語 (イタリア)                    | `it-IT` | 音響モデル (20201016)<br>言語モデル<br>発音|      はい                     |
| 日本語 (日本)                   | `ja-JP` | 言語モデル                                   |      はい                     |
| 韓国語 (韓国)                     | `ko-KR` | 音響モデル (20201015)<br>言語モデル                 |      はい                     |
| ラトビア語 (ラトビア)                   | `lv-LV` | 言語モデル                                   |                           |
| リトアニア語 (リトアニア)             | `lt-LT` | 言語モデル                                   |                           |
| マルタ語 (マルタ)                     | `mt-MT` | 言語モデル                                   |                           |
| マラーティー語 (インド)                    | `mr-IN` | 言語モデル                                   |                           |
| ノルウェー語 (ブークモール、ノルウェー)         | `nb-NO` | 言語モデル                                   |     はい                      |
| ポーランド語 (ポーランド)                    | `pl-PL` | 言語モデル                                   |       はい                    |
| ポルトガル語 (ブラジル)                | `pt-BR` | 音響モデル (20190620、20201015)<br>言語モデル<br>発音|          はい                 |
| ポルトガル語 (ポルトガル)              | `pt-PT` | 言語モデル                                   |             はい              |
| ルーマニア語 (ルーマニア)                 | `ro-RO` | 言語モデル                                   |                           |
| ロシア語 (ロシア)                   | `ru-RU` | 音響モデル (20200907)<br>言語モデル                 |                はい           |
