...
| `ro-RO` | ルーマニア語 (ルーマニア)                | 言語モデル                                    |
| `ru-RU` | ロシア語 (ロシア)                  | 音響モデル<br>言語モデル                  |
| `sk-SK` | スロバキア語 (スロバキア)                 | 言語モデル                                    |
| `sl-SI` | スロベニア語 (スロベニア)              | 言語モデル                                    |
