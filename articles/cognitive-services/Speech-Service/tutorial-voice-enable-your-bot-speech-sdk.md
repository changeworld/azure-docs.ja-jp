...
1. [Azure portal](https://portal.azure.com) に移動し、左側のナビゲーションで **[リソースの作成]** を選択します。
2. 検索バーに「**音声**」と入力します。
