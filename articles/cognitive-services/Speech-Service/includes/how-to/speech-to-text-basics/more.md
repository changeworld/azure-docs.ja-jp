...
ms.locfileid: "79371943"
---
## <a name="additional-language-and-platform-support"></a>言語とプラットフォームのその他のサポート

このタブをクリックした場合、お気に入りのプログラミング言語で基本記事が表示されないことがあります。 ご安心ください。GitHub で入手できる追加のコード サンプルを用意しています。 この表を使用して、お使いのプログラミング言語とプラットフォーム/OS の組み合わせに適したサンプルを見つけます。

| Language    | コード サンプル                                                                                                                            |
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| C#          | [.NET Framework][csharp-netframework]、[.NET Core][csharp-netcore]、[UWP][csharp-uwp]、[Unity][csharp-unity]、[Xamarin][csharp-xamarin] |
| C++         | [クイックスタート][cpp-quickstarts]、[サンプル][cpp-samples]                                                                                  |
| Java        | [Android][java-android]、[JRE][java-jre]                                                                                                |
| JavaScript  | [ブラウザー][js-browser]                                                                                                                   |
