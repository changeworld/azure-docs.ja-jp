...
![ボット UI との対話がどのように表示されるかを示すスクリーンショット。](~/articles/cognitive-services/speech-service/media/sdk/qs-java-android-assistant-designer-ui.png)
