...
|--|--|--|
| C# | [mic から][1-mic]、[ファイルから][1-file] | [.NET Framework][dotnet]、[.NET Core][netcore]、[UWP][uwp]、[Unity][unity]、[Xamarin][xamarin] |
| C++ | [mic から][2-mic]、[ファイルから][2-file] | [Windows][cpp-windows]、[Linux][cpp-linux]、[macOS][cpp-mac] |
| Java | [mic から][3-mic]、[ファイルから][3-file] | [Android][java-android]、[JRE][java-jre] |
| JavaScript | [mic からブラウザー][js-browser]、[ファイルから Node.js][js-node] | [Windows、Linux、macOS][js-code] |
| Objective-C | [mic から iOS][obj-iOS-qck]、[mic から macOS][obj-macOS-qck] | [iOS][obj-iOS]、[macOS][obj-macOS] |
| Python | [mic から][4-mic]、[ファイルから][4-file] | [Windows、Linux、macOS][python] |
| Swift | [mic から iOS][swift-iOS-qck]、[mic から macOS][swift-macOS-qck] | [iOS][swift-iOS]、[macOS][swift-macOS] |
