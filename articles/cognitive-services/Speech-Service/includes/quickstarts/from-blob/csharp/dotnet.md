...
このコードを `TranscribeAsync` [!code-csharp に挿入します。[](~/samples-cognitive-services-speech-sdk/quickstart/csharp/dotnet/from-blob/program.cs?range=46-50)]
