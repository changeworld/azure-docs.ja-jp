...
|--|--|--|
| C# | [ファイルから][1-file]、[BLOB から][1-blob] | [.NET Framework][dotnet]、[.NET Core][netcore]、[UWP][uwp]、[Unity][unity]、[Xamarin][xamarin] |
| C++ | [ファイルから][2-file]、[BLOB から][2-blob] | [Windows][cpp-windows]、[Linux][cpp-linux]、[macOS][cpp-mac] |
| Java | [ファイルから][3-file]、[BLOB から][3-blob] | [Android][java-android]、[JRE][java-jre] |
...
| Python | [ファイルから][4-file]、[BLOB から][4-blob] | [Windows、Linux、macOS][python] |
