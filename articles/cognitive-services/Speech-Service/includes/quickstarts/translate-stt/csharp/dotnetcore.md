---
title: クイック スタート:音声テキスト変換を翻訳する、C# (.NET Core Windows) - Speech サービス
...
1. 文字列 `YourServiceRegion` を[リージョン](~/articles/cognitive-services/Speech-Service/regions.md)に置き換えます。
