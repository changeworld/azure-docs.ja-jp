...
ms.locfileid: "75660518"
---
## <a name="prerequisites"></a>前提条件

開始する前に、以下の操作を行います。

* 今回初めて Python プロジェクトを作成する場合は、このガイドを使用して<a href="../quickstarts/create-project.md" target="_blank">空のサンプル プロジェクトを作成</a>します。
* <a href="../quickstarts/setup-platform.md" target="_blank">開発環境に対応した Speech SDK をインストールします</a>。
