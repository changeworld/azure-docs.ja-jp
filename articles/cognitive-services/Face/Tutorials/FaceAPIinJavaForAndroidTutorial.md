...
- API レベル 22 以降の [Android Studio](https://developer.android.com/studio/)。
...
このチュートリアルでは、Face Java SDK を使用して画像内の顔を検出してフレームに収めるアプリケーションを作成する方法を学びました。 次は、顔検出の詳細について学習してください。
