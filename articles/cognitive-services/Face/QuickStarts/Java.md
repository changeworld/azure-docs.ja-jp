---
title: 'クイック スタート: 画像の中にある顔を検出する - Face API、Java'
...
ms.locfileid: "46122792"
---
# <a name="quickstart-detect-faces-in-an-image-using-java"></a>クイック スタート: Java を使って画像の中にある顔を検出する
