---
title: 'クイック スタート: REST API と Node.js を使って画像の中にある顔を検出する'
...
ms.locfileid: "49954100"
---
# <a name="quickstart-detect-faces-in-an-image-using-the-rest-api-and-nodejs"></a>クイック スタート: REST API と Node.js を使って画像の中にある顔を検出する
