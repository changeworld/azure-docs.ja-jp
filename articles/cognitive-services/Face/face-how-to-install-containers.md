...
|{BILLING_ENDPOINT_URI} | 課金エンドポイント URI の値は、Azure `Cognitive Services` の [概要] ページで確認できます。 例: `https://westus.api.cognitive.microsoft.com/face/v1.0`|

`face/v1.0` ルーティングをエンドポイント URI に追加する必要があります。前の BILLING_ENDPOINT_URI の例を参照してください。 
