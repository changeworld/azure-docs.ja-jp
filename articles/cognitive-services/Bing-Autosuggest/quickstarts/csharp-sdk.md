---
title: クイック スタート:.NET 用 Bing Autosuggest クライアント ライブラリ | Microsoft Docs
description: .NET 用 Bing Autosuggest クライアント ライブラリの使用を開始し、部分クエリ文字列に基づいて検索候補を取得します。
...
ms.locfileid: "75450979"
---
# <a name="quickstart-bing-autosuggest-client-library-for-net"></a>クイック スタート:.NET 用 Bing Autosuggest クライアント ライブラリ
