...
ms.locfileid: "53250418"
---
# <a name="quickstart-perform-a-news-search-using-c-and-the-bing-news-search-rest-api"></a>クイック スタート:C# と Bing News Search REST API を使用してニュース検索を実行する
