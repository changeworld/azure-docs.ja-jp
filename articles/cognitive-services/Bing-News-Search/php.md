---
title: 'クイック スタート: Bing News Search API (PHP)'
...
ms.locfileid: "48801746"
---
# <a name="quickstart-for-bing-news-search-api-with-php"></a>PHP での Bing News Search API のクイック スタート
