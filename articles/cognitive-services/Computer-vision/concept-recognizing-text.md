...
読み取り操作では、認識された単語の元の行グループが出力で維持されます。 各行は境界ボックスの座標を持ち、行内の各単語もそれ自体の座標を持っています。 単語が低い信頼度で認識された場合は、その情報も伝えられます。 詳細については、[Read API v2.0 のリファレンス ドキュメント](https://westus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/2afb498089f74080d7ef85eb)と [Read API v3.0 プレビューのリファレンス ドキュメント](https://go.microsoft.com/fwlink/?linkid=2118322)をご覧ください。

> [!NOTE]
> この機能は、英語とスペイン語 (v3.0 プレビュー) のテキストでのみ使用できます。
