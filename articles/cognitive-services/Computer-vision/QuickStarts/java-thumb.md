...
description: このクイック スタートでは、Cognitive Services の Computer Vision と Java を使って、画像からサムネイルを生成します。
...
ms.locfileid: "43772428"
---
# <a name="quickstart-generate-a-thumbnail---rest-java"></a>クイック スタート: サムネイルの生成 - REST、Java
