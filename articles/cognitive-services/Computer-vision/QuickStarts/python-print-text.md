...
> [!NOTE]
> 英語のテキストを抽出する場合は、新しい[読み取り操作](../concept-recognizing-text.md)の使用を検討してください。 [Python のクイックスタート](./python-hand-text.md)を使用できます。 
...
## <a name="upload-image-from-local-storage"></a>ローカル ストレージからの画像のアップロード

ローカルの画像を分析する場合は、Content-Type ヘッダーを application/octet-stream に設定し、要求本文を JSON データではなくバイト配列に設定します。
...
> [Computer Vision API Python チュートリアル](https://github.com/Microsoft/Cognitive-Vision-Python)
