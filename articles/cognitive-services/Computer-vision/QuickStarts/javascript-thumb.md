---
title: 'クイック スタート: サムネイルの生成 - REST、JavaScript - Computer Vision'
titleSuffix: Azure Cognitive Services
description: このクイック スタートでは、Computer Vision API と JavaScript を使って、画像からサムネイルを生成します。
