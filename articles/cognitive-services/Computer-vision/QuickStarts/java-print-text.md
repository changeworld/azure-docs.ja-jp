...
description: このクイック スタートでは、Cognitive Services の Computer Vision と Java を使って、画像内の印刷されたテキストを抽出します。
...
ms.locfileid: "43772134"
---
# <a name="quickstart-extract-printed-text-ocr---rest-java"></a>クイック スタート: 印刷されたテキストの抽出 (OCR) - REST、Java
...
成功応答が JSON で返されます。 OCR の結果には、検出されたテキストのほか、領域、線、単語を囲む境界ボックスが含まれます。
