---
title: クイック スタート:Computer Vision 2.1 および 3.0 - 印刷されたテキストと手書きテキストの抽出 - REST、C#
...
ms.locfileid: "83681200"
---
# <a name="quickstart-extract-printed-and-handwritten-text-using-the-computer-vision-21-and-30-rest-api-and-c"></a>クイック スタート:Computer Vision 2.1 および 3.0 の REST API と C# を使用して、印刷されたテキストと手書きテキストを抽出する
...
Computer Vision 2.1 および 3.0 に比べ、Computer Vision 3.0 パブリック プレビューでは次の機能が提供されます。
