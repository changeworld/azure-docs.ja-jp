---
title: 'Computer Vision API Node.js クイック スタート: OCR | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: このクイック スタートでは、Cognitive Services の Computer Vision と Node.js を使って、画像内の印刷されたテキストを抽出します。
...
ms.locfileid: "43772008"
---
# <a name="quickstart-extract-printed-text-ocr---rest-nodejs"></a>クイック スタート: 印刷されたテキストの抽出 (OCR) - REST、Node.js
