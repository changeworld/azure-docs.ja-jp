---
title: 'Computer Vision API C# クイック スタート SDK: サムネイルの作成 | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: このクイック スタートでは、Cognitive Services の Computer Vision Windows C# クライアント ライブラリを使って、画像からサムネイルを生成します。
...
ms.locfileid: "43772176"
---
# <a name="quickstart-generate-a-thumbnail---sdk-c35"></a>クイック スタート: サムネイルの生成 - SDK、C&#35;
