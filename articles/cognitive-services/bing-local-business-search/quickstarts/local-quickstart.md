...
description: このクイックスタートを利用して、Azure Cognitive Service である Bing Local Business Search API に C# から要求を送信してみましょう。
...
1. Visual Studio (Community Edition で十分です) で新しいコンソール ソリューションを作成します。
