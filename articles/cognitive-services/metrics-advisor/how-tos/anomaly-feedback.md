...
:::image type="content" source="../media/feedback/feedback-menu.png" alt-text="フィードバックのメニュー。":::
...
:::image type="content" source="../media/feedback/continuous-points.png" alt-text="複数のポイントを選択します":::
...
:::image type="content" source="../media/feedback/affected-point.png" alt-text="フィードバックの影響があるポイント":::
