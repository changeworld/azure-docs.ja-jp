...
* [ビデオ: Azure Backup の概要](http://azure.microsoft.com/documentation/videos/introduction-to-azure-batch-with-mark-scurrell/)

* [ビデオ: Mark russinovich による Azure Batch サービスのデモ](http://azure.microsoft.com/documentation/videos/azure-batch-demo-blender/)

* [ビデオ: Batch サービスの構築](http://azure.microsoft.com/documentation/videos/azure-batch-build-a-batch-service/)
...
* [Azure Batch のコード サンプル](https://code.msdn.microsoft.com/site/search?f[0].Type=Topic&f[0].Value=Azure%20Batch&f[0].Text=Azure%20Batch)
