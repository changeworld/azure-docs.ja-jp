...
description: この記事は、デプロイ テンプレートの成果物に対するリファレンスです。
...
ms.locfileid: "68336637"
---
# <a name="reference-deployment-template-artifact"></a>リファレンス: デプロイ テンプレートの成果物

この記事は、Azure Managed Applications の *mainTemplate.json* 成果物のリファレンスです。 デプロイ テンプレートの作成の詳細については、[Azure Resource Manager テンプレート](../azure-resource-manager/resource-group-authoring-templates.md)に関する記事を参照してください。

## <a name="deployment-template"></a>デプロイ テンプレート

次の JSON は、Azure Managed Applications 用の *mainTemplate.json* ファイルの例を示しています。
