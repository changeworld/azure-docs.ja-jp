...
- Strong 一貫性を使用した場合の (消費される[要求ユニット](documentdb-request-units.md)に関する) 読み取り操作のコストは Session と Eventual よりも高いものの、Bounded Staleness と同じです。
...
- Strong 一貫性を使用した場合の (消費される RU に関する) 読み取り操作のコストは Session と Eventual の一貫性よりも高いものの、Strong 一貫性と同じです。
