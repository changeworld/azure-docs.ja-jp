...
---
# <a name="distribute-data-globally-with-documentdb"></a>DocumentDB を使用したデータのグローバル分散
...
最初に、Karthik Raman が Azure DocumentDB での地理的分散を説明している次のビデオをご覧ください。

> [!VIDEO https://channel9.msdn.com/Shows/Azure-Friday/Planet-Scale-NoSQL-with-DocumentDB/player]
> 
> 

## <a name="configuring-multi-region-accounts"></a>複数リージョンのアカウントの構成
...
## <a name="using-multi-region-failover"></a>複数リージョンのフェールオーバーの使用
...
## <a name="scaling-across-the-planet"></a>世界規模のスケーリング
