...
##<a name="<a-id="refer"></a>referencing-data##"></a><a id="Refer"></a>データの参照##
...
###<a name="how-do-i-model-many:many-relationships?"></a>多対多のリレーションシップのモデル化
...
##<a name="<a-id="wrapup"></a>hybrid-data-models##"></a><a id="WrapUp"></a>ハイブリッド データ モデル##
...
##<a name="<a-name="nextsteps"></a>next-steps"></a><a name="NextSteps"></a>次のステップ
