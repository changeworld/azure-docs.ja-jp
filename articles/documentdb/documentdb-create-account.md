...
Microsoft Azure DocumentDB を使用するには、Azure ポータルを使用して DocumentDB データベース アカウントを作成する必要があります。
...
- ポータル。[Azure ポータルを使用した DocumentDB データベースの作成](documentdb-create-database.md)に関するページの説明を参照してください。
