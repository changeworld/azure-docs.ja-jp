---
title: "DocumentDB の SQL 構文と SQL クエリ | Microsoft Docs"
...
## <a name="documentdb-indexing"></a>DocumentDB のインデックス作成
...
## <a name="basics-of-a-documentdb-sql-query"></a>DocumentDB SQL クエリの基礎
...
### <a name="value-keyword"></a>VALUE キーワード
...
## <a name="advanced-database-concepts-and-sql-queries"></a>高度なデータベースの概念と SQL クエリ
...
## <a name="javascript-integration"></a>JavaScript 統合
...
### <a name="user-defined-functions-udfs"></a>ユーザー定義関数 (UDF)
...
DocumentDB は、以下の Open Geospatial Consortium (OGC) 組み込み関数を使った地理空間検索をサポートしています。 
...
DocumentDB での地理空間のサポートの詳細については、 [Azure DocumentDB での地理空間データの操作](documentdb-geospatial.md)に関するページを参照してください。 これで空間関数の説明が終わり、DocumentDB 用の SQL 構文の説明も終わります。 次に、LINQ クエリの動作とこれまでに説明した構文の関係を見ていきましょう。

## <a name="linq-to-documentdb-sql"></a>LINQ と DocumentDB SQL
...
### <a name="list-of-supported-linq-operators"></a>サポートされている LINQ 演算子の一覧
...
## <a name="executing-sql-queries"></a>SQL クエリの実行
...
### <a name="javascript-server-side-api"></a>JavaScript のサーバー側 API
