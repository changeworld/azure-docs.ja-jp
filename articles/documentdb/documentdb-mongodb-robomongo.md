...
* Azure Cosmos DB: MongoDB 用 API アカウントの[接続文字列](documentdb-connect-mongodb-account.md)情報を取得する
...
1. [ここ](documentdb-connect-mongodb-account.md)に記載されている手順に従って、Azure Cosmos DB: MongoDB 用 API アカウントの接続情報を取得します。
