...
この記事では、シャーディングの概念についていくつか紹介します。DocumentDB SDK を使用してデータをパーティション分割するコードを記述する準備が整っている場合は、「[.NET SDK を使用して DocumentDB 内のデータをパーティション分割する方法](documentdb-sharding.md)」をご覧ください。
