---
title: "DocumentDB クエリ エクスプローラー: SQL クエリ エディター |Microsoft Docs"
...
---
# <a name="write-edit-and-run-sql-queries-for-documentdb-using-query-explorer"></a>クエリ エクスプローラーを使用して DocumentDB に対する SQL クエリを作成、編集、実行する
