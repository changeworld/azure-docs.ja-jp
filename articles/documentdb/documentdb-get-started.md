...
Azure ポータルで、手順 1. の DocumentDB アカウントに移動し、**[キー]** をクリックします。

URI をコピーし、プログラムで *<your endpoint URI>* をコピーした URI に置き換えます。プライマリ キーをコピーし、プログラムで *<your key>* をコピーしたキーに置き換えます。
