...
アプリケーションのストレージやスループット スケールの要件に合うように、何個でもコレクションを作成できます。コレクションは [Azure プレビュー ポータル](https://portal.azure.com/)またはいずれかの [DocumentDB SDK](https://msdn.microsoft.com/library/azure/dn781482.aspx) を使用して作成できます。
...
Azure プレビュー ポータルで一貫性レベルを変更する手順については、「[DocumentDB アカウントの管理方法](documentdb-manage-account.md#consistency)」を参照してください。または、一貫性レベルの詳細については、「[一貫性レベルの使用](documentdb-consistency-levels.md)」を参照してください。
