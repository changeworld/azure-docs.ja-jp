...
**ハッシュ パーティション分割:** ![Diagram illustrating how hash partitioning evenly distributes requests across partitions](media/documentdb-sharding/partition-hash.png "Hash partitioning")
...
**HashPartitionResolver を使用したコンシステント ハッシュ:** ![Diagram illustrating how HashPartitionResolver creates a hash ring](media/documentdb-sharding/HashPartitionResolver.JPG "Consistent hashing")
