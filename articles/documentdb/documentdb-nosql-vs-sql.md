---
title: "NoSQL 対 SQL と Azure Cosmos DB | Microsoft Docs"
description: "Azure Cosmos DB を、NoSQL の非リレーショナル ソリューションと使用した場合と SQL ソリューションと使用した場合の利点を比較します。 Azure Cosmos DB が NoSQL と SQL にメリットを与えるしくみを説明します。"
...
---
# <a name="nosql-vs-sql-and-azure-cosmos-db"></a>NoSQL 対 SQL と Azure Cosmos DB
...
このソーシャル ネットワーク サイトは、NoSQL データベースがジョブの適切なデータ モデルとなるシナリオの 1 つにすぎません。 このシナリオの詳細、およびソーシャル メディア アプリケーションで Azure Cosmos DB のデータをモデル化する方法については、「[Azure Cosmos DB によるソーシャル化](documentdb-social-media-apps.md)」を参照してください。 
...
![Microsoft Azure の NoSQL 製品 (Azure Cosmos DB、Table Storage、HDInsight の一部として提供される HBase、Redis Cache) を使用する場合を示す NoSQL 対 SQL の図。](./media/documentdb-nosql-vs-sql/nosql-vs-sql-documentdb-storage-hbase-hdinsight-redis-cache.png)

これらのサービスの 1 つ以上がアプリケーションのニーズを満たしている場合は、次のリソースを参照してください。 

* [Azure Cosmos DB のユース ケース](documentdb-use-cases.md)
