...
---
# <a name="<a-name="get-started"></a>creating-an-internet-facing-load-balancer-in-resource-manager-by-using-powershell"></a><a name="get-started"></a>Resource Manager で PowerShell を使用したインターネットに接続するロード バランサーの作成
...
仮想マシンの作成と NIC の割り当て方法については、「[Powershell を使用した Windows VM の作成](../virtual-machines/virtual-machines-windows-ps-create.md)」をご覧ください。
