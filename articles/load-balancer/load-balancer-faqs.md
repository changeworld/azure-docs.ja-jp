...
## <a name="how-do-i-configure-my-load-balancer-with-an-azure-firewall"></a>Azure Firewall を使用してロード バランサーを構成するには、どうすればよいですか?
この記事に記載されている[手順](https://docs.microsoft.com/azure/firewall/integrate-lb)に従って、Azure Firewall を使用してロード バランサーを構成してください。

## <a name="what-are-best-practices-with-respect-to-outbound-connectivity"></a>アウトバウンド接続に関するベスト プラクティスは何ですか。
...
アウトバウンド規則を使用することで、アウトバウンド接続のすべての側面を細かく制御できます。
 ...
 ## <a name="how-can-i-view-the-traffic-from-my-configured-health-probes"></a><a name="probes"></a> 自分が構成した正常性プローブからのトラフィックは、どうすれば確認できますか?
