...
3. 送信用のフロントエンド IP 構成の設定には、以下の値を使用します。
    ...
    | パブリック IP アドレス | **[新規作成]** を選択します。 </br> **[パブリック IP アドレスの追加]** で「**myPublicIPOutbound**」と入力します。 </br> IP プレフィックスを使用する場合は、 **[パブリック IP プレフィックスの追加]** で「**myPublicIPPrefixOutbound**」と入力します。 パブリック IP プレフィックスの **[プレフィックス サイズ]** を選択します </br> **[OK]** を選択します。  |
