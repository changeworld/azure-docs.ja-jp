...
> [!NOTE]
> Azure には、リソースの作成と操作について [Resource Manager](../azure-resource-manager/resource-manager-deployment-model.md) と[クラシック](load-balancer-get-started-ilb-classic-ps.md)という 2 つのデプロイ モデルがあります。 この記事では、ResourceManager デプロイ モデルを使用してロード バランサーを作成する方法について説明します。 最新のデプロイには、Azure Resource Manager を使用することをお勧めします。
