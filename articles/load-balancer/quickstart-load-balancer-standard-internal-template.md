---
title: Azure Resource Manager テンプレート (ARM テンプレート) を使用して内部ロード バランサーを作成する
description: Azure Resource Manager テンプレート (ARM テンプレート) を使用して内部の Azure ロード バランサーを作成する方法について説明します。
