...
| SQL Server | Azure Synapse Analytics | [MAP Toolkit](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure Migrate](https://azure.microsoft.com/services/azure-migrate/)<br/>[Cloudamize*](https://www.cloudamize.com/) |  | [TCO 計算ツール](https://azure.microsoft.com/pricing/tco/calculator/) |
