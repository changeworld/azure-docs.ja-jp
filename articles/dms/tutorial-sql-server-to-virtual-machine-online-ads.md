...
1. 移行の詳細ページには、バックアップ ファイルとそれに対応する状態が表示されます。
    ...
    :::image type="content" source="media/tutorial-sql-server-to-virtual-machine-online-ads/online-to-vm-migration-status-detailed.png" alt-text="オンラインでの VM のバックアップの復元の詳細":::
