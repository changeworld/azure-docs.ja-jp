...
# Mobile Services におけるクラスプラットフォームでの設定の同期の使用

> [WACOM.NOTE] このコンテンツは準備が整っていないようですが、それについてお伝えしていきます。特にこのトピックに関心がある場合は、[@AzureMobile][@AzureMobile] をツイートするか、[フォーラム][フォーラム]または [User Voice][User Voice] に投稿して弊社にお知らせください。
  ...
  [User Voice]: http://feedback.azure.com/forums/216254-mobile-services
