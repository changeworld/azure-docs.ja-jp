...
[!INCLUDE [Notification Hubs Xamarin で Apple プッシュ通知を有効にする](../../includes/notification-hubs-xamarin-enable-apple-push-notifications.md)]
...
> [!NOTE]
> Cordova 5.1.1 より前のバージョンの Cordova (推奨バージョンは 6.1.1 ) を使用する場合は、config.xml で Toast Capable フラグを true に設定する必要もあります。
> 
> 
