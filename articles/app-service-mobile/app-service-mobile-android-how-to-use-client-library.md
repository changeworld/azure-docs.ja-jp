...
### <a name="a-namegradle-buildaupdate-the-gradle-build-file"></a><a name="gradle-build"></a>Gradle ビルド ファイルを更新する
...
### <a name="a-nameenable-internetaenable-internet-permission"></a><a name="enable-internet"></a>インターネット アクセス許可を有効にする
...
### <a name="a-namedata-objectadefine-client-data-classes"></a><a name="data-object"></a>クライアント データ クラスを定義する
...
### <a name="a-namecreate-clientahow-to-create-the-client-context"></a><a name="create-client"></a>方法: クライアント コンテキストを作成する
...
### <a name="a-namebindingahow-to-bind-data-to-the-user-interface"></a><a name="binding"></a>方法: データをユーザー インターフェイスにバインドする
...
#### <a name="a-namelayoutahow-to-define-the-layout"></a><a name="layout"></a>方法: レイアウトを定義する
...
#### <a name="a-nameadapterahow-to-define-the-adapter"></a><a name="adapter"></a>方法: アダプターを定義する
...
### <a name="a-nameapiathe-api-structure"></a><a name="api"></a>API の構造
...
#### <a name="a-nameuse-adapterahow-to-use-the-adapter"></a><a name="use-adapter"></a>方法: アダプターを使用する
...
## <a name="a-namequeryingahow-to-query-data-from-your-mobile-app-backend"></a><a name="querying"></a>方法: モバイル アプリ バックエンドのデータを照会する
...
### <a name="a-nameshowallahow-to-return-all-items-from-a-table"></a><a name="showAll"></a>方法: テーブルからすべての項目を返す
...
### <a name="a-namechainingahow-to-concatenate-query-methods"></a><a name="chaining"></a>方法: クエリ メソッドを連結する
...
## <a name="a-nameinsertingahow-to-insert-data-into-the-backend"></a><a name="inserting"></a>方法: バックエンドにデータを挿入する
...
## <a name="a-nameupdatingahow-to-update-data-in-a-mobile-app"></a><a name="updating"></a>方法: モバイル アプリのデータを更新する
...
## <a name="a-namedeletingahow-to-delete-data-in-a-mobile-app"></a><a name="deleting"></a>方法: モバイル アプリのデータを削除する
...
## <a name="a-namelookupahow-to-look-up-a-specific-item"></a><a name="lookup"></a>方法: 特定の項目を検索する
...
## <a name="a-nameuntypedahow-to-work-with-untyped-data"></a><a name="untyped"></a>方法: 型指定のないデータを処理する
...
### <a name="a-namejsoninstanceahow-to-create-an-instance-of-an-untyped-table"></a><a name="json_instance"></a>方法: 型指定のないテーブルのインスタンスを作成する
...
### <a name="a-namejsoninsertahow-to-insert-into-an-untyped-table"></a><a name="json_insert"></a>方法: 型指定のないテーブルに挿入する
...
### <a name="a-namejsondeleteahow-to-delete-from-an-untyped-table"></a><a name="json_delete"></a>方法: 型指定のないテーブルから削除する
...
### <a name="a-namejsongetahow-to-return-all-rows-from-an-untyped-table"></a><a name="json_get"></a>方法: 型指定のないテーブルからすべての行を返す
...
## <a name="a-namecustom-apiahow-to-call-a-custom-api"></a><a name="custom-api"></a>方法: カスタム API の呼び出し
...
## <a name="a-nameauthenticationahow-to-add-authentication-to-your-app"></a><a name="authentication"></a>方法: アプリに認証を追加する
...
### <a name="a-namecachingahow-to-add-authentication-code-to-your-app"></a><a name="caching"></a>方法: アプリケーションに認証コードを追加する
...
### <a name="a-namecachingahow-to-cache-authentication-tokens"></a><a name="caching"></a>方法: 認証トークンをキャッシュする
...
## <a name="a-namecustomizingahow-to-customize-the-client"></a><a name="customizing"></a>方法: クライアントをカスタマイズする
...
### <a name="a-nameserializationahow-to-customize-serialization"></a><a name="serialization"></a>方法: シリアル化をカスタマイズする
...
### <a name="a-namecolumnsahow-to-map-different-client-and-server-names"></a><a name="columns"></a>方法: クライアントとサーバーの間で異なる名前をマップする
...
### <a name="a-nametableahow-to-map-different-table-names-between-the-client-and-the-backend"></a><a name="table"></a>方法: クライアントとバックエンドの間で異なるテーブル名をマップする
クライアント テーブルの名前を別のモバイル サービス テーブルの名前にマップするには、[getTable()][4] メソッドのオーバーライドを使用します。

    mToDoTable = mClient.getTable("ToDoItemBackup", ToDoItem.class);

### <a name="a-nameconversionsahow-to-automate-column-name-mappings"></a><a name="conversions"></a>方法: 列名のマッピングを自動化する
...
### <a name="a-namecomplexahow-to-store-an-object-or-array-property-into-a-table"></a><a name="complex"></a>方法: オブジェクトまたは配列プロパティをテーブルに保存する
