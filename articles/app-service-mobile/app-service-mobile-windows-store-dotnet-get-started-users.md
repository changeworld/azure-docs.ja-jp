---
title: UWP アプリへの認証の追加
description: Azure App Service Mobile Apps を使用して、AAD、Google、Facebook、Twitter、Microsoft などの ID プロバイダーを使ってユニバーサル Windows プラットフォーム (UWP) アプリのユーザーを認証する方法を説明します。
