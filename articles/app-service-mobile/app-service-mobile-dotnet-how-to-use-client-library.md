...
#### <a name="a-nameclient-livesdkasingle-sign-on-using-microsoft-account-with-the-live-sdk"></a><a name="client-livesdk"></a>Microsoft アカウントと Live SDK を使用したシングル サインイン
