---
title: Xamarin Forms アプリでの認証の使用
description: Mobile Apps を使用して、AAD、Google、Facebook、Twitter、Microsoft などの ID プロバイダーにより Xamarin Forms アプリのユーザーを認証する方法について説明します。
