...
* [Azure Stream Analytics](../stream-analytics/stream-analytics-data-lake-output.md)。Event Hubs に取り込まれたイベントは、Azure Data Lake Store 出力を使用して Azure Data Lake に書き込むことができます。
