...
この記事では、 **非対話型** のアプローチを使用します。 非対話型 (サービス間呼び出し) の詳細については、 [資格情報を使用したサービス間呼び出し](/previous-versions/azure/dn645543(v=azure.100))に関するページを参照してください。
