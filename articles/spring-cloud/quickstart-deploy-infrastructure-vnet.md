...
Azure CLI と Terraform のデプロイについては、GitHub 上の [Azure Spring Cloud の参照アーキテクチャ](https://github.com/Azure/azure-spring-cloud-reference-architecture) リポジトリを参照してください。
