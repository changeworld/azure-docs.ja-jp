...
次の内容の *.github/workflows/main.yml* ファイルをリポジトリに作成します。 *\<your resource group name>* と *\<your service name>* を正しい値に置き換えます。
...
この例では、GitHub 上の [PiggyMetrics](https://github.com/Azure-Samples/piggymetrics) サンプルを使用します。  サンプルをフォークし、GitHub リポジトリのページを開き、 **[設定]** タブを選択します。 **[シークレット]** メニューを開き、 **[Add a new secret]\(新しいシークレットの追加\)** を選択します。
