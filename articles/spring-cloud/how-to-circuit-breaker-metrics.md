...
1. Azure Spring Cloud ポータルから **[Application Insights]** ブレードを選択し、 **[Application Insights]** を選択します。
...
4. **[resilience4j_circuitbreaker_calls]** メトリックと **[平均]** を選択します。 **[フィルターの追加]** を選択し、名前で **[createNewAccount]** を選択します。

   [ ![resilience4J 3](media/spring-cloud-resilience4j/resilience4J-3.png)](media/spring-cloud-resilience4j/resilience4J-3.PNG)

5. **[resilience4j_circuitbreaker_calls]** メトリックと **[平均]** を選択します。  次に、 **[分割の適用]** を選択して、 **[種類]** を選択します。
