...
Azure Spring Cloud では、Spring Boot ベースのマイクロサービス アプリケーションを Azure で簡単に実行できます。  この例を実行する前に、[基本的なクイックスタート](spring-cloud-quickstart.md)を試してみることができます。
...
3. 前のコマンドによって提供された URL に移動し、PiggyMetrics アプリケーションを実行します。
    ![実行中の PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. **[gateway]** を選択します
    ...
    ![PiggyMetrics ナビゲート](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. **gateway の概要**ページで、URL を見つけます![PiggyMetrics ナビゲート 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
