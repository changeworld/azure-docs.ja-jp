<properties urlDisplayName="Authorize Users in Scripts (Xamarin.Android)" pageTitle="スクリプトでのユーザーの承認 (Xamarin.Android) - Azure Mobile Services" metaKeywords="ユーザーを承認する Azure, Xamarin.Android スクリプト承認, モバイル サービスの承認" description="Learn how to authorize users with scripts in your Azure Mobile Services app for Xamarin.Android." metaCanonical="" disqusComments="1" umbracoNaviHide="1" title="Use scripts to authorize users in Mobile Services" authors="donnam" manager="dwrede" />
