...
[送信開始](https://github.com/Azure/azure-event-hubs-dotnet/tree/master/samples/SampleSender)のサンプルは、イベントを Event Hub に送信する .NET Core コンソール アプリケーションを記述する方法を示しています。
