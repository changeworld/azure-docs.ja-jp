...
> [!NOTE]
> このチュートリアルでは、Storm をローカル モードで開発目的にのみ使用します。Storm の開発とパターンの詳細については、「[HDInsight Storm の概要][HDInsight Storm の概要]」と、[Apache Storm][Apache Storm] の公式ドキュメントを参照してください。
> 
> 
