...
1. プライマリ名前空間を作成します。
1. セカンダリ名前空間を作成します。 この手順は省略可能です。 セカンダリ名前空間は、次の手順でペアリングを作成しているときに作成できます。 
...
1. **[ペアリングの開始]** ページで、既存のセカンダリ名前空間を選択するか、またはセカンダリ名前空間を作成してから **[作成]** を選択します。 次の例では、既存のセカンダリ名前空間が選択されています。 
