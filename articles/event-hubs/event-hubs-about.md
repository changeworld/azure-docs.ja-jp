...
## <a name="real-time-and-batching"></a>リアルタイムとバッチ処理
...
Event Hubs では、メガバイト単位のデータ ストリームで開始し、ギガバイトまたはテラバイトまで拡張できます。 [自動インフレ](event-hubs-auto-inflate.md)機能は、使用状況のニーズに合わせてスループット単位の数をスケーリングするために利用できる多くのオプションの 1 つです。 
...
* [Event Hubs に取り込む](event-hubs-quickstart-powershell.md)
