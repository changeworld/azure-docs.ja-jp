...
>[AZURE.NOTE] このチュートリアルが対象とするのは、Windows Phone 8.0 および Windows Phone 8.1 Silverlight のアプリケーションです。Windows Phone ストア 8.1 アプリまたはユニバーサル Windows アプリについては、[このトピックのユニバーサル Windows アプリ バージョン](/ja-jp/documentation/articles/mobile-services-dotnet-backend-windows-universal-dotnet-get-started-users/)を参照してください。
