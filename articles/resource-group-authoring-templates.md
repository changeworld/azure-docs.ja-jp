...
| 要素名					   | 必須 	  | 説明
| :----------------------: | :------: | :----------
| apiVersion 			   | あり 	  | リソースをサポートする API のバージョン。 使用可能なバージョンとリソースのスキーマについては、[Azure リソース マネージャーのスキーマ](https://github.com/Azure/azure-resource-manager-schemas)に関するページを参照してください。
...
つのテンプレートをマージしたり、親テンプレート内で子テンプレートを使用したりすることが必要な場合があります。詳細については、「[Azure リソース マネージャーでのリンクされたテンプレートの使用](resource-group-linked-templates.md)」を参照してください。
