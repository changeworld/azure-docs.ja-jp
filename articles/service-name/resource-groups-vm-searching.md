...
これで、使用するイメージを正確に選択できます。検出した URN 情報を使用して vm を素早く作成する方法や、その URN 情報のあるテンプレートを使用する方法については、「[Azure リソース 管理での Azure CLI for Mac, Linux, and Windows の使用](virtual-machines/xplat-cli-azure-resource-manager.md)」を参照してください。
