...
1.  Visual Studio 2012 Express for Windows Phone で、[認証の使用][認証の使用]に関するチュートリアルを実行したときに変更したプロジェクトを開きます。
...
<!-- URLs. -->
  ...
  [チュートリアルを見る]: http://go.microsoft.com/fwlink/?LinkId=298630
