...
---
# <a name="creating-an-azure-project-with-visual-studio"></a>Visual Studio を使用した Azure プロジェクトの作成
...
## <a name="to-create-an-azure-cloud-service-project-in-visual-studio"></a>Visual Studio で Azure クラウド サービス プロジェクトを作成するには
