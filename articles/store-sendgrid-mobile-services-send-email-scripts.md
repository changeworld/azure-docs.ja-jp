<properties urlDisplayName="Send Email Using SendGrid" pageTitle="SendGrid を使用した電子メール送信 - Azure モバイル サービス" metaKeywords="Azure SendGrid, SendGrid サービス, Azure 電子メール送信, モバイル サービスからの電子メール" description="Learn how to use the SendGrid service to send email from your Azure Mobile Services app." metaCanonical="" services="" documentationCenter="Mobile" title="Send email from Mobile Services with SendGrid" authors="elmer.thomas@sendgrid.com; erika.berkland@sendgrid.com; vibhork" solutions="" manager="wpickett" editor="" />
...
<h2><a name="insert-data"></a>テスト データを挿入して電子メールを受け取る</h2>
...
[サインアップ ページ]: https://sendgrid.com/windowsazure.html
[複数ユーザーの資格情報のページ]: https://sendgrid.com/credentials
