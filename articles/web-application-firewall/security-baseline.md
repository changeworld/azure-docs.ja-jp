...
- [Application Gateway での WAF ポリシー](https://docs.microsoft.com/cli/azure/network/application-gateway/waf-policy?view=azure-cli-latest) 

- [Front Door での WAF ポリシー](https://docs.microsoft.com/cli/azure/ext/front-door/network/front-door/waf-policy?view=azure-cli-latest)
...
- [Microsoft Web アプリケーション ファイアウォールから Azure Sentinel にデータを接続する](/azure/sentinel/connect-microsoft-waf)
...
- [Azure アクティビティ ログの診断設定を有効にする方法](/azure/azure-monitor) 
...
**ガイダンス**:Azure Active Directory (Azure AD) のロールベース アクセス制御 (Azure RBAC) を使用して、Azure リソースへのアクセスを制御します。
...
- [ユーザーが管理する暗号化キーを構成する方法](/azure/storage/common/storage-encryption-keys-portal)
