...
はい。 [Azure CSP サブスクリプションの Azure AD Domain Services ](csp.md) を有効にする方法をご覧ください。
...
はい。 [PowerShell を使って Azure AD Domain Services を有効にする方法](powershell-create-instance.md)に関する記事をご覧ください。
...
いいえ。現在のところ、テンプレートを使用して Azure AD Domain Services を有効にすることはできません。 代わりに PowerShell を使用してください ([PowerShell を使って Azure AD Domain Services を有効にする方法](powershell-create-instance.md)に関する記事をご覧ください)。
