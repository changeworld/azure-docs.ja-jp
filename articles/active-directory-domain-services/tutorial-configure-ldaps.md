...
外部 DNS プロバイダーまたはローカルの hosts ファイルで、次のように DNS エントリを指定すると、*ldaps.aaddscontoso.com* 宛てのトラフィックが *40.121.19.239* という外部 IP アドレスに解決されます。
...
1. 追加したレコードの行 (例: `40.121.19.239    ldaps.aaddscontoso.com`) を削除します。
