---
title: Azure Monitor の新しいアラート エクスペリエンスでアクティビティ ログ アラートを使用する
description: Azure Monitor の [アラート (プレビュー)] タブからアクティビティ ログ アラートを作成する方法。 この記事では、この機能の新しいユーザー エクスペリエンスについて詳しく説明します。
