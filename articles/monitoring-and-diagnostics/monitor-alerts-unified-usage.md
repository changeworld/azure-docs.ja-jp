...
4.  **[リソースの選択]** のリンクを使用してターゲットを指定し、リソースを選択することで、アラートの条件を定義します。 必要な *[サブスクリプション]* と *[リソースの種類]* を選択し、最後に必要な *[リソース]* を選択して、適切にフィルタリングします。
 ...
 Azure アラート (プレビュー) では 1 つのインターフェイスでさまざまな種類のアラートを作成できるため、必要なアラートの種類に応じて、次の手順の中から選択してください。
