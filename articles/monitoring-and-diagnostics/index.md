        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Portal での Azure サービス アラートの作成</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>クラス プラットフォーム CLI での Azure サービス アラートの作成</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>PowerShell での Azure サービス アラートの作成</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Resource Manager テンプレートでのメトリック アラートの作成</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST ()</h3>
                        <p><a href="/rest/api/monitor/">REST API リファレンス</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>監視</h3>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-supported-metrics">サポートされるメトリックスの一覧</a></p>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-data-sources">監視データのソース</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>診断</h3>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-versioning-history">Azure 診断拡張機能のバージョン履歴</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema">Azure 診断拡張機能のスキーマ</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot0">Azure 診断拡張機能のスキーマ 1.0</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot2">Azure 診断拡張機能のスキーマ 1.2</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot3-and-later">Azure 診断拡張機能のスキーマ 1.3 ～ 1.7</a></p>
                    </div>
                </div>
            </div>
        </div>
