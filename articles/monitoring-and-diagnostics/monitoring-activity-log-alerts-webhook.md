...
サービス正常性通知のアクティビティ ログ アラートの特定のスキーマ詳細については、[ここをクリックしてください](monitoring-service-notifications.md)。その他のすべてのアクティビティ ログ アラートの特定のスキーマの詳細については、[ここをクリックしてください](monitoring-overview-activity-logs.md)
...
| authorization |イベントの RBAC プロパティ。 これらのプロパティには通常、"action"、"role"、"scope" が含まれます。 |
...
| httpRequest |要求には通常、“clientRequestId”、“clientIpAddress”、および HTTP “method” (たとえば PUT) が含まれます。 |
| 最小限のレベル |"Critical"、"Error"、"Warning"、"Informational"、"Verbose" のいずれかの値。 |
