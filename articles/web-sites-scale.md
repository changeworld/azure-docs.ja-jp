...
App Service プランの詳細については、「[App Service プラン](web-sites-web-hosting-plan-overview.md)」および「[Azure App Service プランの詳細な概要](azure-web-sites-web-hosting-plans-in-depth-overview.md)」を参照してください。App Service の個々のプランの料金と機能の詳細については、「[App Service の料金の詳細](/pricing/details/web-sites/)」を参照してください。
