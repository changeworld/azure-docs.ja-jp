...
(*) 一部のリージョンは、国内のディザスター リカバリーなど、特定の顧客シナリオをサポートするためにアクセスが制限されています。 これらのリージョンは、[Azure portal で新しいサポート リクエストを作成](https://portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/newsupportrequest)することによって、リクエストがあった場合にのみ使用できます。
