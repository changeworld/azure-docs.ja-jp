---
title: ロジック アプリにおける BizTalk ルール API アプリの説明とその作成 | Microsoft Docs
...
5. 新しく開いたブレードで、次の情報を入力します。  
   1. [名前] - ルール API アプリの名前を指定します
   2. [App Service プラン] – 新しい App Service プランを選択または作成します
   3. [価格レベル] - このアプリが属する価格レベルを選択します
   4. [リソース グループ] - このアプリが属するリソース グループを選択します
   5. [サブスクリプション] - 使用するサブスクリプションを選択します
   6. [場所] - アプリをデプロイする地域を選択します
6. *[作成]* を選択します。数分以内に BizTalk ルール API アプリが作成されます。
