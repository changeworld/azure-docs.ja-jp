...
こうしたシナリオはすべてビジュアル デザイナーで、コードを 1 行も記述することなく構成できます。 [ロジック アプリの構築][作成]を今すぐ開始しましょう。  作成後のロジック アプリは、複数の環境やリージョンにわたり、 [すばやくデプロイして再構築](app-service-logic-create-deploy-template.md) できます。
...
さらに、[エンタープライズ統合アカウント][biztalk]を使用すると、[XML メッセージング][xml]や[取引先管理][tpm]などを活用して、成熟した統合シナリオに拡張することができます。
...
* **テンプレートからすばやく開始** - 作業開始に役立つように、一般的なソリューションを速やかに作成できる[テンプレート ギャラリー][テンプレート]が用意されています。 高度な B2B ソリューションから単純な SaaS 接続にまで対応し、単なる "お遊び用" のテンプレートも用意しています。Logic Apps の機能を理解するには、このギャラリーが一番の近道です。
...
* **真の統合能力** - 手軽に始めて必要に応じて拡張できます。 Logic Apps は、Microsoft の業界屈指の統合ソリューション、BizTalk の能力を統合担当者が簡単に利用して必要なソリューションを構築できるようにしています。 Enterprise Integration Pack の詳細については、[こちら](app-service-logic-enterprise-integration-overview.md)をご覧ください。
...
* Logic Apps の使用を開始するには、[ロジック アプリの作成][作成]に関するチュートリアルに従ってください。  
...
[作成]: app-service-logic-create-a-logic-app.md
[managedapis]: ../connectors/apis-list.md
[tpm]: app-service-logic-enterprise-integration-accounts.md
[xml]: app-service-logic-enterprise-integration-b2b.md
[テンプレート]: app-service-logic-use-logic-app-templates.md
