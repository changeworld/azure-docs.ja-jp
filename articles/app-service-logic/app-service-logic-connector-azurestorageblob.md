---
title: Logic Apps での Azure Storage Blob コネクタの使用 | Microsoft Docs
...
---
# Azure Storage BLOB コネクタを強化しました
...
### 次のステップ
* [この新しいコネクタに関する詳細情報](../connectors/connectors-create-api-azureblobstorage.md)
