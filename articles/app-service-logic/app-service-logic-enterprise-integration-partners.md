---
title: パートナーと Enterprise Integration Pack の詳細情報 | Microsoft Docs
...
9. [パートナー] タイルを選択すると、[パートナー] ブレードにも、新しく追加されたパートナーが表示されます。 ![](./media/app-service-logic-enterprise-integration-partners/partner-6.png)
