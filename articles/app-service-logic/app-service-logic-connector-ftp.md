---
title: Logic Apps での FTP コネクタの使用 | Microsoft Docs
...
> [!NOTE]
> 本記事は、ロジック アプリの 2014-12-01-preview スキーマ バージョンを対象としています。2015-08-01-preview スキーマ バージョンについては、こちらの [FTP API](../connectors/connectors-create-api-ftp.md) をクリックしてください。
> 
> 
