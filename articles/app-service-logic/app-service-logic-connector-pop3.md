...
POP3 コネクタを使用するには、まず POP3 コネクタ API アプリのインスタンスを作成する必要があります。これは、ロジック アプリ デザイナーから直接でも、ロジック アプリ デザイナーの外からでも実行できます。デザイナーの外からインスタンスを作成する場合の手順は次のとおりです。
...
2.	[トリガーとアクション] を選択して Logic Apps デザイナーを開き、フローを構成します。
	...
	![][3]
3.	POP3 コネクタが右側のギャラリーの [このリソース グループの API アプリ] セクションに表示されます。それを選択します。
