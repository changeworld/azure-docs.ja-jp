...
3.	次のように、Twilio コネクタを構成します。
	...
	- **パッケージ設定**
		- **アカウント SID** - アカウントの一意の ID.ユーザーのアカウントのアカウント SID は <https://www.twilio.com/user/account/settings> から取得できます
		- **認証トークン** - アカウントに関連付けられた認証トークン。ユーザーのアカウントの認証トークンは <https://www.twilio.com/user/account/settings> から取得できます
