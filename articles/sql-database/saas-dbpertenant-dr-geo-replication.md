...
### <a name="provision-a-new-tenant-in-the-recovery-region"></a>復旧リージョンで新しいテナントをプロビジョニングする
...
4. スクリプトが実行している間に、イベント ハブのページ (http://events.wingtip-dpt.&lt;ユーザー&gt;.trafficmanager.net) を更新します。
