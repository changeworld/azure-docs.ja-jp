...
提供終了になったデータベースに対して推奨されるサービス階層を見るには、[Azure プレビュー ポータル](https://portal.azure.com)または PowerShell を使用できます。詳細な手順は以下を参照してください。

- [SQL Database V12 にアップグレードする (Azure プレビュー ポータル)](sql-database-v12-upgrade.md)
...
Azure プレビュー ポータルを使用して DTU 使用割合の概要を表示し、システム ビューを使用して詳細を確認します。

また、Azure SQL Database V12 にサーバーをアップグレードする際に、Azure プレビュー ポータルを使用して、Web または Business データベースの推奨されるサービス階層を表示することもできます。

### Azure プレビュー ポータルで推奨されるサービス階層を表示する方法
...
1. [Azure プレビュー ポータル](https://portal.azure.com)にログオンし、Web または Business データベースを含むサーバーに移動します。
