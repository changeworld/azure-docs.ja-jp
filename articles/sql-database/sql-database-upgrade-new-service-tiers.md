...
たとえば、バックアップを保持する必要がある期間や、[標準またはアクティブな geo レプリケーション](sql-database-business-continuity.md)機能が必要かどうか、必要な全体の最大データベース サイズなどを考慮します。このような要件によって、最小限のサービス階層として選択する階層が決定します。
