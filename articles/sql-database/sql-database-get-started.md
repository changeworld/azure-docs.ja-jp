---
title: "SQL Database チュートリアル: SQL データベースの作成 | Microsoft Docs"
...
---
# <a name="sql-database-tutorial-create-a-sql-database-in-minutes-by-using-the-azure-portal"></a>SQL Database チュートリアル: Azure Portal を使用して数分で SQL データベースを作成する
...
## <a name="create-your-first-azure-sql-database"></a>最初の Azure SQL データベースを作成する
...
> [!IMPORTANT]
> デプロイが完了すると、Azure に新しい Azure SQL サーバーとデータベースが作成されます。 サーバーのファイアウォール規則を作成して、Azure の外部からの接続に対して SQL Database のファイアウォールを開くまで、SQL Server ツールを使用して新しいサーバーまたはデータベースに接続することはできません。
> 
> 
...
* Azure SQL Database のセキュリティについて調べる場合は、 [セキュリティの概要](sql-database-get-started-security.md)
