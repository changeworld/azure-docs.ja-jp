---
title: Azure SQL Database と SQL Server での Spark コネクタ
...
Azure Active Directory (AAD) 認証を使用して SQL Database に接続できます。 AAD 認証は、データベース ユーザーの ID を一元管理するという目的で使用でき、SQL Server 認証に代わる方法となります。
