...
| 40501 |20 |サービスは現在ビジー状態です。 10 秒後に要求を再試行してください。 インシデント ID: %ls。 コード: %d。<br/><br/>詳細については、次を参照してください。<br/>「[Azure SQL Database のリソース制限](sql-database-service-tiers.md)」を参照してください。 |
