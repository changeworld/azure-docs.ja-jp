...
どの時点でも、特定のデータベースを選択してプールに含めることができます。プールに新しいデータベースを作成するには、下の[データベースの追加および削除](sql-database-elastic-pool-portal.md#add-and-remove-databases-from-the-pool)に関するセクションを参照してください。

新しくプールを作成する場合、Azure ではプールに含めることでメリットのあるデータベースを推奨し、含めるようマークすることをお勧めしています。サーバーで使用可能なすべてのデータベースを追加したり、初期のリストで必要に応じてデータベースを選択、削除したりできます。
