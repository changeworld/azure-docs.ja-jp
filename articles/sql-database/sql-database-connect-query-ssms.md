...
[!INCLUDE [SSMS のインストール](../../includes/sql-server-management-studio-install.md)]

[!INCLUDE [SSMS 接続](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]
