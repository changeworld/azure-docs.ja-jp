...
## <a name="create-an-active-geo-replication-auto-failover-group"></a>アクティブ geo レプリケーション自動フェールオーバー グループを作成する 
...
次のチュートリアルに進み、マネージド インスタンスを作成する方法を学習してください。

> [!div class="nextstepaction"]
>[マネージド インスタンスを作成する](sql-database-managed-instance-create-tutorial-portal.md)
