...
## アプリの顧客が少数から多数に増加した場合、Azure SQL Database はアプリのダウンタイムなしで即時にスケールできます。
...
## アプリの成功が一夜で終わった場合
SQL Database は、直ちに簡単にスケールできます。そのため、アプリの成功が一夜で終わった場合、1 回のクリックだけで、新しいパフォーマンスのニーズに合わせて調整できます。さらに、ダウンタイムが発生しないので、スケールアップやスケールダウンのときにアプリが打撃を受けることを心配する必要はありません。
