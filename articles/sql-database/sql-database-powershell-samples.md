...
| [マネージド インスタンスを作成および管理する](https://blogs.msdn.microsoft.com/sqlserverstorageengine/2018/06/27/quick-start-script-create-azure-sql-managed-instance-using-powershell/) | これらの CLI スクリプトは、Azure PowerShell を使用してマネージ インスタンスを作成および管理する方法を示しています。 |
