...
- 最新のバックアップの時点に復旧された、任意のリージョンの論理サーバー上に新しいデータベースを作成する。
...
### <a name="recover-to-a-point-in-time-using-azure-portal"></a>Azure portal を使用して特定の時点に復旧する
...
### <a name="recover-a-deleted-database-using-the-azure-portal"></a>Azure portal を使用して削除されたデータベースを復旧する
