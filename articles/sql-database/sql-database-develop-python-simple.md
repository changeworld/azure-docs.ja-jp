...
# Python を使用して SQL Database に接続する
...
[pymssql Python Driver for SQL Server 使用の前提条件](https://msdn.microsoft.com/library/mt694094.aspx)
...
[Python を使用した SQL 接続の概念実証](http://msdn.microsoft.com/library/mt715796.aspx)
