...
- エラスティック データベース プールの作成と管理は、[Azure ポータル](https://portal.azure.com)、PowerShell、Azure リソース マネージャーの .NET クライアント ライブラリ (REST API のラッパー) のみでの使用に対応しています。[クラシック ポータル](https://manage.windowsazure.com/)とサービス管理コマンドはサポートされません。
...
| [Set-AzureRMSqlElasticPool](https://msdn.microsoft.com/library/azure/mt603511.aspx) | [Elastic Database プールのパフォーマンス設定を設定します](https://msdn.microsoft.com/library/mt163641.aspx) |
...
| [Get-AzureRMSqlElasticPoolActivity](https://msdn.microsoft.com/library/azure/mt603812.aspx) | [Elastic Database プールの操作の状態を取得します](https://msdn.microsoft.com/library/mt163669.aspx) |
| [Get-AzureRMSqlElasticPoolDatabase](https://msdn.microsoft.com/library/azure/mt619484.aspx) | [Elastic Database プールのデータベースを取得します](https://msdn.microsoft.com/library/mt163646.aspx) |
