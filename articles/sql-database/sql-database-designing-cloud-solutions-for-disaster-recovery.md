...
2. 指定したセカンダリ データベースを呼び出して[データベースのフェールオーバーを開始](https://msdn.microsoft.com/
3. /library/azure/dn509573.aspx)する。 
...
この設計パターンの主な**利点**は、複数のセカンダリにアプリケーション ワークロードを分散してエンド ユーザーのパフォーマンスを最適化できることです。この選択肢の**トレードオフ**は次のとおりです。
