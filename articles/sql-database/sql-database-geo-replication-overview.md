...
| [New-AzureRmSqlDatabaseFailoverGroup](https://docs.microsoft.com/powershell/module/azurerm.sql/set-azurermsqldatabasefailovergroup?view=azurermps-3.7.0) |    このコマンドはフェールオーバー グループを作成し、それをプライマリとセカンダリの両方のサーバーに登録します。|
...
| [Get Create or Update Database Status](https://docs.microsoft.com/rest/api/sql/databases#Databases) |復元操作中にステータスを返します。 |
| [Set Secondary Database as Primary (Planned Failover) (セカンダリ データベースをプライマリとして設定する (計画されたフェールオーバー))](https://docs.microsoft.com/rest/api/sql/databasereplicationlinks#Databases_FailoverReplicationLink) |geo レプリケーション パートナーシップのセカンダリ データベースを新しいプライマリ データベースに昇格させます。 |
| [Set Secondary Database as Primary (計画されていないフェールオーバー)](https://docs.microsoft.com/rest/api/sql/databasereplicationlinks#Databases_FailoverReplicationLinkAllowDataLoss) |セカンダリ データベースに強制的にフェールオーバーして、セカンダリをプライマリに設定します。 |
| [Get Replication Links](https://docs.microsoft.com/rest/api/sql/databasereplicationlinks#Databases_ListReplicationLinks) |geo レプリケーション パートナーシップで指定された SQL データベースのすべてのレプリケーション リンクを取得します。 sys.geo_replication_links カタログ ビューで表示可能な情報を取得します。 |
| [Get Replication Link](https://docs.microsoft.com/rest/api/sql/databasereplicationlinks#Databases_GetReplicationLink) |geo レプリケーション パートナーシップで指定された SQL データベースの特定のレプリケーション リンクを取得します。 sys.geo_replication_links カタログ ビューで表示可能な情報を取得します。 |
| [フェールオーバー グループの作成](https://docs.microsoft.com/rest/api/sql/databases#Databases_CreateOrUpdate) | フェールオーバー グループを作成し、それをプライマリとセカンダリの両方のサーバーに登録します。 |
| [フェールオーバー グループの削除](https://docs.microsoft.com/rest/api/sql/databases#Databases_CreateOrUpdate) | フェールオーバー グループをサーバーから削除します。 |
| [フェールオーバー グループの取得](https://docs.microsoft.com/rest/api/sql/databases#Databases) | フェールオーバー グループ構成を取得します。 |
| [フェールオーバー グループの設定](https://docs.microsoft.com/rest/api/sql/databases#Databases_CreateOrUpdate) | フェールオーバー グループの構成を変更します。 |
| [フェールオーバー](https://docs.microsoft.com/rest/api/sql/databasereplicationlinks#Databases_FailoverReplicationLinkAllowDataLoss) | フェールオーバー グループのセカンダリ サーバーに対するフェールオーバーをトリガーします。 |
|  | |
