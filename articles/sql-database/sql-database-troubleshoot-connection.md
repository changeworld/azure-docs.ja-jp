---
title: "サーバーのデータベースは現在使用できません、SQL Database に接続してください | Microsoft Docs"
...
---
# <a name="error-database-on-server-is-not-currently-available-when-connecting-to-sql-database"></a>SQL データベースに接続するときの "サーバーのデータベースは現在使用できません" というエラー
