...
| PHP | Windows、Linux、macOS| [SQL Server 用 PHP SQL ドライバー](https://msdn.microsoft.com/library/dn865013.aspx) | オペレーティング システム: <br/> \* [Windows](https://www.microsoft.com/download/details.aspx?id=55642) <br/> \* [Linux](https://github.com/Microsoft/msphpsql/tree/dev#install-unix) <br/> \* [macOS](https://github.com/Microsoft/msphpsql/tree/dev#install-unix) |  [作業開始](https://www.microsoft.com/sql-server/developer-get-started/php/ubuntu)
