...
| [New-AzureRmSqlDatabase](/powershell/module/azurerm.sql/new-azurermsqldatabase) | スタンドアロン データベースまたはプールされたデータベースとして SQL Database サーバー上にデータベースを作成します。 |
