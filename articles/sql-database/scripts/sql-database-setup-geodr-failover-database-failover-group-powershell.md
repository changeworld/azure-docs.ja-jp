...
[!code-powershell[メイン](../../../powershell_scripts/sql-database/setup-geodr-and-failover-database/setup-geodr-and-failover-database-failover-group.ps1?highlight=19-22 "単一のデータベースのフェールオーバー グループを設定する")]
