...
マネージド インスタンスのペアがあらかじめ存在すること。[Azure CLI を使用して Azure SQL Database マネージド インスタンスを作成する方法](sql-database-create-configure-managed-instance-cli.md)に関するページを参照してください。
