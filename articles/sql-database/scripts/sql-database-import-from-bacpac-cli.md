---
title: CLI の例 - BACPAC ファイルを Azure SQL データベースにインポートする
description: BACPAC ファイルを SQL データベースにインポートするための Azure CLI サンプル スクリプト
...
ms.locfileid: "80061832"
---
# <a name="use-cli-to-import-a-bacpac-file-into-an-azure-sql-database"></a>CLI を使用して BACPAC ファイルを Azure SQL データベースにインポートする

この Azure CLI サンプル スクリプトは、 *.bacpac* ファイルから Azure SQL データベースにデータベースをインポートします。  
