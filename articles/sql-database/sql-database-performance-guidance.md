...
* **Standard**。 Standard サービス レベルではパフォーマンス予測機能が向上しており、ワークグループや Web アプリケーションなど、複数の同時要求があるデータベースで高いパフォーマンスが実現します。 Standard サービス レベルのデータベースを選択すると、分単位の予測可能パフォーマンスに基づいてデータベース アプリケーションをサイズ調整できます。
