...
description: この記事では、単一データベースとエラスティック プールを使用してプールされたデータベースに関する Azure SQL Database 論理サーバーのリソース制限の概要を示します。 また、これらのリソース制限に達した場合、または制限を超えた場合の動作に関する情報も提供します。
...
ms.locfileid: "51620900"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases"></a>単一データベースとプールされたデータベースに関する SQL Database のリソース制限
