...
| [PolyBase](https://docs.microsoft.com/sql/relational-databases/polybase/polybase-guide) | No. `OPENROWSET` 関数を使用して、Azure Blob Storage に配置されているファイル内のデータのクエリを実行できます。 | No. `OPENROWSET` 関数を使用して、Azure Blob Storage に配置されているファイル内のデータのクエリを実行できます。 |
...
| [Query Performance Insights (QPI)](sql-database-query-performance.md) | はい | No. SQL Server Management Studio と Azure Data Studio で組み込みのレポートを使用します。 |
