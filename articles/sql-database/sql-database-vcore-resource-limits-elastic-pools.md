...
ms.locfileid: "57853132"
---
# <a name="resource-limits-for-elastic-pools-using-the-vcore-based-purchasing-model-limits"></a>仮想コア ベースの購入モデルを使用したエラスティック プールに対するリソース制限
...
|プールあたりの最大 DB 数|100|200|300|500|500|500|
...
|許可される最大セッション数|30000|30000|30000|30000|30000|30000|
|プールあたりの最大 DB 数|200|500|500|500|500|500|
...
|プールあたりの最大 DB 数|200|500|500|500|500|500|500|
...
|ログのレート制限 (MBps)|7.5|15|22.5|30|37.5|45|
|プールあたりの最大同時実行ワーカー (要求) 数 *|210|420|630|840|1050|1260|
...
|ログのレート制限 (MBps)|52.5|60|67.5|75|80|80|
|プールあたりの最大同時実行ワーカー (要求) 数 *|1470|1680|1890|2100|3360|5040|
|プールあたりの最大同時ログイン (要求) 数*|1470|1680|1890|2100|3360|5040|
|許可される最大セッション数|30000|30000|30000|30000|30000|30000|
...
|ログのレート制限 (MBps)|7.5|15|22.5|30|37.5|45|52.5|
|プールあたりの最大同時実行ワーカー (要求) 数 *|210|420|630|840|1050|1260|1470|
|プールあたりの最大同時ログイン (要求) 数*|210|420|630|840|1050|1260|1470|
|許可される最大セッション数|30000|30000|30000|30000|30000|30000|30000|
...
|ログのレート制限 (MBps)|60|67.5|75|90|120|120|120|
