...
## <a name="add-alerts-to-all-databases-in-a-pool"></a>プール内のすべてのデータベースへのアラートの追加
...
## <a name="example-retrieve-resource-consumption-metrics-for-a-pool-and-its-databases"></a>例: プールとそのデータベースのリソース消費メトリックを取得する
