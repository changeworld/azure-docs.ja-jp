---
title: Azure SQL Database を構成する方法 - スタンドアロン | Microsoft Docs
description: Azure SQL Database (スタンドアロン データベース) を構成して管理する方法について説明します
...
- [SQL Database への移行](sql-database-cloud-migrate.md) – マネージド インスタンスへの移行に関して推奨される移行プロセスとツールについて確認します。
