...
- キーにアクティブ化や有効期限を設定することはできません。

- キーは、キー コンテナー内で有効状態になっている必要があります。
