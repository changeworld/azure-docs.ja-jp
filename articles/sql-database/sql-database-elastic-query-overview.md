---
title: "Azure SQL Database Elastic Database クエリの概要 | Microsoft Docs"
...
---
# <a name="azure-sql-database-elastic-database-query-overview-preview"></a>Azure SQL Database エラスティック データベース クエリの概要 (プレビュー)
...
## <a name="elastic-database-query-scenarios"></a>エラスティック データベース クエリのシナリオ
...
![ スケールアウトされたデータ層で使用されるエラスティック データベース クエリ][1]
...
## <a name="implementing-elastic-database-queries"></a>エラスティック データベース クエリの実装
...
列方向のパーティション分割シナリオに必要な手順の詳細については、 [列方向のパーティション分割のためのエラスティック クエリ](sql-database-elastic-query-vertical-partitioning.md)に関するページを参照してください。  
