...
> [!IMPORTANT]
> ゾーン冗長データベースとエラスティック プールは現在、Premium および Business Critical サービス レベルのみでサポートされています。 既定では、バックアップや監査レコードは RA-GRS ストレージに格納されるため、ゾーン全体にわたる停止の場合、自動的には使用できない可能性があります。 
