<properties
	pageTitle="チュートリアル: Azure Active Directory と Trakstar の統合 | Microsoft Azure"
...
- Azure AD サブスクリプション
- Trakstar シングル サインオンが有効なサブスクリプション
...
1. アプリケーション用に構成された SSO を入手するには、[integrations@trakstar.com](mailto:integrations@trakstar.com) を使用して Trakstar サポート チームに連絡して、次の情報を提供してください。
