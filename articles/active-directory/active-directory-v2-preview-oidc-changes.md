...
> [!IMPORTANT]
> **確認事項: アプリが `profile_info` 値**の存在に依存していないことを確認してください。
> 
> 
...
> [!IMPORTANT]
> **確認事項: アプリが `id_token_expires_in` 値**の存在に依存していないことを確認してください。
> 
> 
...
> [!IMPORTANT]
> **確認事項: アプリでユーザーの情報が必要な場合、`profile` と `email` のスコープを追加します。** ADAL には、既定で要求にこれらのアクセス許可が含まれることに注意してください。
> 
> 
