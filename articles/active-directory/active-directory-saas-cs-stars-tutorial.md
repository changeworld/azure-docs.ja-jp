...
3. **[CS Stars のドメインと URL]** セクションで、次の手順を実行します。
    ...
    a.[サインオン URL] ボックスに、次のパターンを使用して、ユーザーが RightScale アプリケーションへのサインオンに使用する URL を入力します。 **[サインオン URL]** ボックスに、`https://<subdomain>.csstars.com/enterprise/default.cmdx?ssoclient=<uniqueid>` のパターンを使用して URL を入力します。
...
5. **[保存]** ボタンをクリックします。
    ...
    ![シングル サインオンを構成する](./media/active-directory-saas-cs-stars-tutorial/tutorial_general_400.png) 
<CS>
