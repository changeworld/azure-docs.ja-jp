<properties
	pageTitle="チュートリアル: Azure Active Directory と Predictix Assortment Planning の統合 | Microsoft Azure"
...
# チュートリアル: Azure Active Directory と Predictix Assortment Planning の統合
...
- ユーザーが自分の Azure AD アカウントで自動的に Predictix Assortment Planning にサインオン (シングル サインオン) できるようにすることが可能です。
...
3. **[アプリケーション設定の構成]** ダイアログ ページで、次の手順に従います。
    ...
    a.**[サインオン URL]** ボックスに、ユーザーが Predictix Assortment Planning アプリケーションへのサインオンに使用する URL を入力します。その際、**https://\<company name-pricing>.ap.predictix.com/sso/request** のパターンを使用します。
...
### Predictix Assortment Planning のテスト ユーザーの作成
