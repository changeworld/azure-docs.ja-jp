...
### <a name="to-enable-the-application-integration-for-appdynamics-perform-the-following-steps"></a>AppDynamics のアプリケーション統合を有効にするには、次の手順に従います。
...
8. **[Authentication Provider]** セクションで、次の手順を実行します。
   ...
   4. ダウンロードした証明書から **base-64 でエンコードされた** ファイルを作成します。  
      ...
      > 
      > 
   5. base-64 でエンコードされた証明書をメモ帳で開き、その内容をクリップボードにコピーして、 **[証明書]** ボックスに貼り付けます。
   6. **[Save]**をクリックします。
...
### <a name="to-assign-users-to-appdynamics-perform-the-following-steps"></a>ユーザーを AppDynamics に割り当てるには、次の手順に従います。
