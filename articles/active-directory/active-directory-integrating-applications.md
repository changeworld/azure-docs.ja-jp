...
詳細については、同意フレームワークは、次のように参照してください 「[Azure AD での OAuth 2.0](https://msdn.microsoft.com/library/azure/dn645545.aspx)」 、「[Azure AD の認証シナリオ](active-directory-authentication-scenarios.md)」, 、および Office 365 のトピック 「[認証と承認に同意するものの一般的なフレームワークを使用する](https://msdn.microsoft.com/library/office/dn605895(v=office.15).aspx)」 です。
