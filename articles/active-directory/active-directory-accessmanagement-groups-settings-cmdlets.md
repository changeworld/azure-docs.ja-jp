<properties
	pageTitle="グループの設定を構成するための Azure Active Directory コマンドレット | Microsoft Azure"
...
--------------------------------------|-----------------------------------------------
 ...
 <ul><li>EnableGroupCreation<li>型: ブール<li>既定値: True | ディレクトリで統合グループの作成を許可するかどうかを示すフラグ。                               
...
## SettingsTemplate オブジェクトリファレンス (Group.Unified SettingsTemplate オブジェクト)
