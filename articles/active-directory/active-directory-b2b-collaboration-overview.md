---
title: "Azure Active Directory の B2B コラボレーション | Microsoft Docs"
...
---
# <a name="azure-active-directory-b2b-collaboration"></a>Azure Active Directory の B2B コラボレーション
...
## <a name="b2b-collaboration-process"></a>B2B コラボレーションのプロセス
...
一般消費者向けメール アドレス (Gmail や [*comcast.net*](http://comcast.net/) など) への招待状は現在サポートされていません。
