...
## <a name="enabling-the-application-integration-for-bamboohr"></a>Bamboo HR のアプリケーション統合の有効化
...
### <a name="to-assign-users-to-bamboohr-perform-the-following-steps"></a>ユーザーを BambooHR に割り当てるには、次の手順に従います。
