---
title: Azure Active Directory アプリケーション プロキシを使用し、アプリにシングル サインオンする
...
- [シングル サインオン](../manage-apps/what-is-single-sign-on.md)を実装するための他の方法を参照します。
