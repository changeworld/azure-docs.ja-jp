...
- [条件付きアクセス ポリシーの構成](conditional-access/app-based-mfa.md)方法。

- [条件付きアクセス ポリシーの移行](conditional-access/best-practices.md#policy-migration)。
...
条件付きアクセス ポリシーの構成方法を把握するには、「[Azure Active Directory の条件付きアクセスを使用して特定のアプリケーションに対して MFA を必要にする](conditional-access/app-based-mfa.md)」を参照してください。
