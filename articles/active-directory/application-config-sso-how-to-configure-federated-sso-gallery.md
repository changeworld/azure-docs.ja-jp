...
12. **省略可能:** ユーザーがサインインするときに SAML トークンでアプリケーションに送信される属性を編集するには、**[その他のすべてのユーザー属性を表示および編集する]** をクリックします。
...
13. アプリケーションでシングル サインオンを構成する方法に関するドキュメントにアクセスするには、**[&lt;アプリケーション名&gt; の構成]** をクリックします。 アプリケーションで SSO をセットアップするために必要なメタデータの URL と証明書も用意されています。
