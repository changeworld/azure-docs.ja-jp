...
ユーザーをグループに追加する | ユーザー アカウント管理者 | 
ライセンスの割り当て | ライセンス管理者 | ユーザー アカウント管理者
ゲスト ユーザーを作成する | ゲスト招待元 | ユーザー アカウント管理者
ユーザーの作成 | ユーザー アカウント管理者 | 
ユーザーを削除する | ユーザー アカウント管理者 | 
制限付き管理者の更新トークンを無効にする (ドキュメントを参照) | ユーザー アカウント管理者 | 
非管理者の更新トークンを無効にする (ドキュメントを参照) | パスワード管理者 | ユーザー アカウント管理者
特権管理者の更新トークンを無効にする (ドキュメントを参照) | グローバル管理者 | 
基本構成を読み取る | 既定のユーザー ロール ([ドキュメントを参照](https://docs.microsoft.com/azure/active-directory/fundamentals/users-default-permissions)) | 
制限付き管理者のパスワードをリセットする (ドキュメントを参照) | ユーザー アカウント管理者 | 
非管理者のパスワードをリセットする (ドキュメントを参照) | パスワード管理者 | ユーザー アカウント管理者
特権管理者のパスワードをリセットする | グローバル管理者 | 
ライセンスを取り消す | ライセンス管理者 | ユーザー アカウント管理者
ユーザー プリンシパル名を除くすべてのプロパティを更新する | ユーザー アカウント管理者 | 
制限付き管理者のユーザー プリンシパル名を更新する (ドキュメントを参照) | ユーザー アカウント管理者 | 
