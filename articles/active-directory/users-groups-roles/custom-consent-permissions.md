...
> [!NOTE]
> 現在、この記事に記載されているアクセス許可を、Azure AD 管理ポータルからカスタム ディレクトリ ロールの定義に追加することはできません。 この記事に記載されているアクセス許可を有する[カスタム ディレクトリ ロールは、Azure AD PowerShell を使用して作成](roles-create-custom.md#create-a-role-using-powershell)する必要があります。
