...
## <a name="enabling-the-application-integration-for-bonusly"></a>Bonus.ly のアプリケーション統合の有効化
このセクションでは、Bonus.ly のアプリケーション統合を有効にする方法について説明します。

### <a name="to-enable-the-application-integration-for-bonusly-perform-the-following-steps"></a>Bonus.ly のアプリケーション統合を有効にするには、次の手順を実行します。
...
### <a name="to-assign-users-to-bonusly-perform-the-following-steps"></a>ユーザーを Bonus.ly に割り当てるには、次の手順を実行します。
