...
3. **[ユーザーの管理]\>[ユーザー]** に移動します。
   ...
   ![ユーザーの管理](./media/active-directory-saas-work-com-tutorial/IC784369.png "Manage Users")
4. **[新しいユーザー]**をクリックします。
...
> [!NOTE]
> Work.com から提供されている他の Work.com ユーザー アカウント作成ツールまたは API を使用して、AAD ユーザー アカウントをプロビジョニングできます。
> 
> 
