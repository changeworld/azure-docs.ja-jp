...
エンタイトルメント管理で有効期限の詳細設定に、オプションが追加されました。 以前の設定に加えて、数時間で期限切れになるアクセス パッケージを構成できます。 [詳細設定]../governance/entitlement-management-access-package-create.md#lifecycle).
