...
2.  左側のナビゲーション バーで **[Azure Active Directory]** を選択して､**[アプリの登録]** を選択します｡

3.  Azure AD アクティビティ ログ API を使用しているアプリを選択して **[設定]** を選択し、**[設定]** ブレードで **[必要なアクセス許可]** を選択します。

4.  **[必要なアクセス許可]** ブレードで、**[Windows Azure Active Directory]** API を選択します。

5.  **[アクセスの有効化]** ブレードの **[委任されたアクセス許可]** 領域で、**[ディレクトリ データの読み取り]** チェック ボックスをオンにして、**[保存]** を選択します。

    **[必要なアクセス許可]** ブレードに戻ります。

    ![[委任されたアクセス許可] の [ディレクトリ データの読み取り] オプション](./media/whats-new/app-registration-delegate-read-directory.png)

6.  **[アクセス許可の付与]** を選択し、**[はい]** を選択します。
...
- **Azure パブリック ピアリングの場合。** Microsoft ピアリングに移行し、**その他の Office 365 Online サービス (12076:5100)** コミュニティにサインアップする必要があります。 Azure パブリック ピアリングから Microsoft ピアリングに移行する方法について詳しくは、「[パブリック ピアリングを Microsoft ピアリングに移行する](https://docs.microsoft.com/azure/expressroute/how-to-move-peering)」をご覧ください。

- **Microsoft ピアリングの場合。** **その他の Office 365 Online サービス (12076:5100)** コミュニティにサインアップする必要があります。 ルーティングの要件について詳しくは、「ExpressRoute のルーティングの要件」の「[BGP コミュニティのサポート](https://docs.microsoft.com/azure/expressroute/expressroute-routing#bgp)」をご覧ください。
