...
* [AD FS のキャパシティ プランニングに関するドキュメント](https://docs.microsoft.com/windows-server/identity/ad-fs/design/planning-for-ad-fs-server-capacity)に従います

* [Azure IaaS での AD FS のデプロイ](https://docs.microsoft.com/windows-server/identity/ad-fs/deployment/how-to-connect-fed-azure-adfs)
