...
- [Azure Active Directory 監査 API リファレンス](/graph/api/resources/directoryaudit?view=graph-rest-beta)
- [Azure Active Directory サインイン アクティビティ レポート API リファレンス](/graph/api/resources/signin?view=graph-rest-beta)
