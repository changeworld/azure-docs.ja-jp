...
報告されたリスク イベントは、次の 2 つの場所で確認できます。
 ...
 - **Azure AD レポート** - リスク イベントは、Azure AD のセキュリティ レポートに含まれています。 詳細については、[危険な状態のユーザー セキュリティ レポート](active-directory-reporting-security-user-at-risk.md)に関する記事、および[リスクの高いサインイン セキュリティ レポート](active-directory-reporting-security-risky-sign-ins.md)に関する記事をご覧ください。
