...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|---------------|-----------------|
| 職場または学校アカウント用の Windows デバイスでのサインイン。 | あり | はい | いいえ |
| ユーザーによる Office 365 と Azure AD アプリへのシングル サインオン (SSO)。SSO は、1 回サインインするだけで組織のリソースにアクセスできる機能です。 | あり | はい | あり |
| ユーザーによる Kerberos または NTLM アプリへの SSO。 | あり | 制限あり | あり (VPN 経由の場合) |
| Microsoft Passport と Windows Hello による、職場または学校アカウント用の強力な承認と便利なサインイン。 | あり | はい | あり |
| 職場または学校アカウントを使用した、企業向けの Windows ストアへのアクセス (Microsoft アカウントは不要)。 | あり | はい | あり |
| 職場または学校アカウントを使用した、企業に準拠した、デバイス間でのユーザー設定のローミング。 | あり | はい | あり |
| 組織のアプリへのアクセスを、組織のデバイス ポリシーに準拠したデバイスに限定する機能。 | あり | はい | あり |
| "任意の場所から作業する" ためのユーザーによるデバイスのセルフサービス プロビジョニング。 | いいえ | はい | あり |
| デバイスを管理する機能。 | あり (GP/SCCM 経由の場合) | あり | あり |

## Windows 10 の Azure AD Join やドメイン参加で職場所有のデバイスを使用する
...
## どのようなときにドメイン参加を使用するか (または使用し続けるか)
...
- 組織のアプリへのアクセスを、組織のデバイス ポリシーに準拠したデバイスに限定できます。

Azure AD Join の詳細については、「[Azure Active Directory Join を使用したクラウド機能の Windows 10 デバイスへの拡張](active-directory-azureadjoin-overview.md)」を参照してください。

## 職場または学校で個人所有のデバイスの参加を有効にする
...
## ドメイン参加または Azure AD Join を有効にする
...
## BYOD と "職場または学校アカウントを追加" を使用するための要件
...
## よく寄せられる質問
### Azure AD と統合されるのはどのパートナーのモバイル デバイス管理製品ですか。
...
### ユーザーは Windows 10 のドメイン アカウントに Microsoft アカウントを関連付けることができますか。
