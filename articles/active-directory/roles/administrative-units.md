...
たとえば、リージョン サポート スペシャリストに委任すると、[ヘルプデスク管理者](permissions-reference.md#helpdesk-administrator)の役割は、そのスペシャリストがサポートするリージョン内のユーザーのみの管理に制限されます。
...
- [ロールを作成、削除、設定し、管理単位に追加する](admin-units-manage.md):詳細な操作方法に関する手順
...
- [AU の管理](admin-units-manage.md)
- [AU でのユーザーの管理](admin-units-add-manage-users.md)
- [AU でのグループの管理](admin-units-add-manage-groups.md)
- [スコープ指定されたロールの AU への割り当て](admin-units-assign-roles.md)
