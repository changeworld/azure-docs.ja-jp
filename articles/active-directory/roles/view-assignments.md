...
## <a name="list-role-assignments-using-powershell"></a>PowerShell を使用してロールの割り当てを一覧表示する
...
## <a name="list-role-assignments-using-the-microsoft-graph-api"></a>Microsoft Graph API を使用してロールの割り当てを一覧表示する
