...
管理単位の管理に PowerShell や Microsoft Graph を使用するよう準備する手順については、「[作業の開始](admin-units-manage.md#get-started)」を参照してください。
...
- ユーザー プロファイルから個別に割り当てる
   ...
   1. **[管理単位]** を選択します。 ユーザーを 1 つまたは複数の管理単位に割り当てるには、 **[管理単位に割り当てる]** を選択し、ユーザーが割り当てられる管理単位を選択します。
       ...
       ![[追加] を選択してから、管理単位の名前を入力する](./media/admin-units-add-manage-users/assign-users-individually.png)
...
- 管理単位からの個別に割り当てる
   ...
   1. **[すべてのユーザー]** を選択し、 **[メンバーの追加]** を選択し、管理単位に割り当てる 1 つまたは複数のユーザーを **[メンバーの追加]** ウィンドウから選択します。
        ...
        ![管理単位を選択して、[メンバーの追加] を選択する](./media/admin-units-add-manage-users/assign-to-admin-unit.png)
...
- 一括割り当て
   ...
   1. **[すべてのユーザー]** 、 **[.csv ファイルのメンバーの追加]** の順に開きます。 その後、コンマ区切り値 (CSV) テンプレートをダウンロードしてファイルを編集できます。 この形式は単純で、各行にユーザー プリンシパル名を 1 つ追加する必要があります。 ファイルの準備ができたら、適切な場所に保存した後、この手順の一環としてアップロードします。
    ...
    ![管理単位にユーザーを一括割り当てする](./media/admin-units-add-manage-users/bulk-assign-to-admin-unit.png)
...
1. **[管理単位]** を選択すると、ユーザーが割り当てられている管理単位が一覧表示されます。
   ...
   ![ユーザーの管理単位を一覧表示する](./media/admin-units-add-manage-users/list-user-admin-units.png)
...
![ユーザー プロファイルの管理単位からユーザーを削除する](./media/admin-units-add-manage-users/user-remove-admin-units.png)

また、 **Azure AD** >  **[管理単位]** で、ユーザーが削除される管理単位を選択して、ユーザーを削除することもできます。 ユーザーを選択し、 **[メンバーの削除]** を選択します。
  
![管理単位レベルでユーザーを削除する](./media/admin-units-add-manage-users/admin-units-remove-user.png)
...
![管理単位からユーザーを一括削除するための CSV ファイルを編集する](./media/admin-units-add-manage-users/bulk-user-entries.png)

エントリをファイルに保存したら、ファイルをアップロードして、 **[送信]** を選択します。

![一括アップロードファイルを送信する](./media/admin-units-add-manage-users/bulk-user-remove.png)
