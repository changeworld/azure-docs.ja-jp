...
## <a name="*3.-install-&-configure-adal*"></a>*3.ADAL をインストールおよび構成する*
...
## <a name="*4.-use-adal-to-get-tokens-from-aad*"></a>*4.ADAL を使用して AAD からトークンを取得する*
