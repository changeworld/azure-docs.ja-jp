...
ms.locfileid: "33931096"
---
# <a name="understand-user-tokens-in-azure-ad-b2b-collaboration"></a>Azure AD B2B コラボレーションのユーザー トークンについて

トークンが B2B コラボレーション ユーザーにどのように見えるかを知るには、以下のベアラー トークンの詳細と、リソース テナント (tenantid 04dcc6ab-388a-4559-b527-fbec656300ea) の Azure Active Directory (Azure AD) ゲストと Microsoft アカウント ゲストのトークンの内容をご覧ください。 JSON Web トークン (JWT) の内容を見るには、[https://jwt.io/](https://jwt.io/) または [https://jwt.ms/](https://jwt.ms/) を使います。

## <a name="azure-ad-guest-token"></a>Azure AD ゲストのトークン
```
...
## <a name="microsoft-account-guest-token"></a>Microsoft アカウント ゲストのトークン
```
