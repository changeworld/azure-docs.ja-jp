...
## <a name="enabling-the-application-integration-for-freshdesk"></a>Freshdesk のアプリケーション統合の有効化
このセクションでは、Freshdesk のアプリケーション統合を有効にする方法について説明します。

### <a name="to-enable-the-application-integration-for-freshdesk-perform-the-following-steps"></a>Freshdesk のアプリケーション統合を有効にするには、次の手順を実行します。
...
### <a name="to-assign-users-to-freshdesk-perform-the-following-steps"></a>ユーザーを Freshdesk に割り当てるには、次の手順を実行します。
