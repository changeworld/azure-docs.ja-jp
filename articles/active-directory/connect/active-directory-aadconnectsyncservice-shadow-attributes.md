...
![ドメイン](./media/active-directory-aadconnectsyncservice-shadow-attributes/domains.png)  
...
シャドウ属性は、属性値が重複している場合にも使用されます。 詳細については、[重複属性の回復性](active-directory-aadconnectsyncservice-duplicate-attribute-resiliency.md)に関するページを参照してください。
