...
> [!IMPORTANT]
> Multi-Geo は現在プレビュー段階です。 プレビュー プログラムへの参加を希望する場合は、Microsoft の担当者にお問い合わせください。
>
>
...
> [!IMPORTANT]
> Multi-Geo を利用するには、Office 365 サブスクリプションに少なくとも 5000 のシートを所有している必要があります。
>
>
...
![Synchronization Service Manager のスクリーンショット](./media/active-directory-aadconnectsync-feature-preferreddatalocation/preferreddatalocation-step1.png)
...
![Synchronization Service Manager とプロパティ ダイアログ ボックスのスクリーンショット](./media/active-directory-aadconnectsync-feature-preferreddatalocation/preferreddatalocation-step2.png)
...
![Synchronization Service Manager とプロパティ ダイアログ ボックスのスクリーンショット](./media/active-directory-aadconnectsync-feature-preferreddatalocation/preferreddatalocation-step3.png)
...
![受信方向の同期規則の作成のスクリーンショット](./media/active-directory-aadconnectsync-feature-preferreddatalocation/preferreddatalocation-step4.png)
...
4. **[説明]** タブで次の構成を指定します。
    ...
    | 属性 | 値 | 詳細 |
    | ----- | ------ | --- |
    | Name | *名前を入力します* | 例: "Out to Azure AD – User preferredDataLocation" |
    | [説明] | *説明を入力します* ||
...
![送信方向の同期規則の作成のスクリーンショット](./media/active-directory-aadconnectsync-feature-preferreddatalocation/preferreddatalocation-step5.png)
...
![ユーザーに追加される AD 属性のスクリーンショット](./media/active-directory-aadconnectsync-feature-preferreddatalocation/preferreddatalocation-adattribute.png)
2. 属性が Azure AD に同期されるまで待ちます。
3. Exchange Online PowerShell を使用して、メールボックスのリージョンが適切に設定されていることを確認します。  
![Exchange Online PowerShell のスクリーンショット](./media/active-directory-aadconnectsync-feature-preferreddatalocation/preferreddatalocation-mailboxregion.png)  
