...
## <a name="add-additional-sync-administrators"></a>その他の同期管理者の追加
...
同期の状態を確認する場合は、Azure Portal で確認します。
...
## <a name="starting-a-scheduled-synchronization-task"></a>スケジュールされた同期タスクの開始
