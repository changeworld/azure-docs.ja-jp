<properties
   ...
   description="シングル サインオン認証とユーザー プロビジョニングによる、Azure Active Directory での SaaS アプリケーションのアクセス管理の一元化を有効にする"
