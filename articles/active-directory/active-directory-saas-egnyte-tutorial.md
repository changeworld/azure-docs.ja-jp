...
## <a name="enabling-the-application-integration-for-egnyte"></a>Egnyte のアプリケーション統合の有効化
このセクションでは、Egnyte のアプリケーション統合を有効にする方法について説明します。

### <a name="to-enable-the-application-integration-for-egnyte-perform-the-following-steps"></a>Egnyte のアプリケーション統合を有効にするには、次の手順を実行します。
...
### <a name="to-assign-users-to-egnyte-perform-the-following-steps"></a>ユーザーを Egnyte に割り当てるには、次の手順を実行します。
