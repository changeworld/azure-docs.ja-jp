...
![アプリケーション リソース ウィンドウ](./media/active-directory-enterprise-apps-manage-provisioning/enterprise-apps-provisioning.png)
...
![アプリケーション リソース ウィンドウ](./media/active-directory-enterprise-apps-manage-provisioning/enterprise-apps-provisioning-mapping.png)
