...
2. **SP 開始モード**でテストする場合:
    ...
    a.[サインオン URL] ボックスに、次のパターンを使用して、ユーザーが RightScale アプリケーションへのサインオンに使用する URL を入力します。 アクセス パネルの **[Direct]** タイルをクリックします。アプリケーションのサインオン ページにリダイレクトされます。
