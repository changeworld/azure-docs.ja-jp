...
### <a name="to-enable-the-application-integration-for-kudos-perform-the-following-steps"></a>Kudos のアプリケーション統合を有効にするには、次の手順に従います。
...
### <a name="to-assign-users-to-kudos-perform-the-following-steps"></a>ユーザーを Kudos に割り当てるには、次の手順に従います。
