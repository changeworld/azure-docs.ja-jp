...
2. アプリケーション ギャラリーで、**独自のアプリケーションを追加する**オプションをクリックし、**[Develop an existing application]\(既存のアプリケーションをデプロイする\)** を選択します。これで、アプリケーションの追加エクスペリエンスにクイック リンクが表示されます。
...
2. 一連の新しい URL 入力ボックスが表示され、このパラメーターと、その他の SAML URL 設定を設定できます。
