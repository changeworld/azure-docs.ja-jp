...
7. ユーザーが招待をまだ承諾していない場合、 **[ID]** セクションで **[招待が受け入れられました]** が **[いいえ]** に設定されます。 招待を再送信するには、 **[管理]** を選択します。 次に、 **[招待の管理]** ページで、[招待の再送信] をクリックします。 **[はい]** を選択し、 **[完了]** を選択します。

> [!NOTE]
> もともとユーザーを特定のアプリに招待する招待を再送信した場合、新しい招待のリンクによりユーザーは最上位レベルのアクセス パネルに移動されます。
> さらに、招待を再送信できるのは、招待の権限を持つユーザーだけです。
