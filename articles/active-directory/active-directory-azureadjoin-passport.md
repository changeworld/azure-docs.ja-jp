...
1. キーが TPM によってハードウェアで、またはソフトウェアで生成されます。 多くのデバイスには、暗号化キーをデバイスに統合してハードウェアをセキュリティで保護する、組み込みの TPM チップが搭載されています。 TPM 1.2 または TPM 2.0 は、キーまたは生成されたキーから作成さる証明書を生成します。
