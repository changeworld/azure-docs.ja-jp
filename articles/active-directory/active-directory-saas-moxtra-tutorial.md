...
Moxtra アプリケーションでは、特定の形式の SAML アサーションを使用するため、カスタム属性マッピングを SAML トークン属性の構成に追加する必要があります。次のスクリーンショットにこの例を示します。
...
1. Azure AD ポータルの **Moxtra** アプリケーション統合ページで **[シングル サインオンの構成]** をクリックし、**[シングル サインオンの構成]** ダイアログを開きます。
...
1. 左のツールハーで、**[管理コンソール] > [SAML シングル サインオン]** をクリックし、**[新規]** をクリックします。
...
ユーザーの一覧で **[Britta Simon]** を選択します。<br><br>![Create Azure AD User][20]<br>
...
1. 左のツールハーで、**[管理コンソール] > [ユーザー管理]** をクリックし、**[ユーザーの追加]** をクリックします。
