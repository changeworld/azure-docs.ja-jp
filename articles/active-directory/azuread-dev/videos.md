---
title: Azure ADAL から MSAL への移行に関するビデオ | Azure
description: Azure Active Directory 開発者プラットフォームから Microsoft ID プラットフォームへの移行に役立つビデオ
...
新しい Microsoft ID プラットフォームと、Azure Active Directory (Azure AD) 開発者プラットフォームからこれに移行する方法について説明します。 通常、ビデオの長さは 1 分から 2 分です。
