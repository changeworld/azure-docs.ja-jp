...
`DirSearchClient Sample` を実行するには、*Azure AD Graph API* をクエリするための新しく作成されたアプリのアクセス許可を付与します。
...
#### Windows 10:
   ...
   **注**: 最初の実行時に、開発者ライセンスのサインインが求められることがあります。詳細については、「[開発者用ライセンスの取得 (ストア アプリ)](https://msdn.microsoft.com/library/windows/apps/hh974578.aspx)」を参照してください。
...
#### Android:
   ...
   **注**: 「*前提条件*」セクションでの説明に従って、*AVD Manager* を使用してエミュレーター インスタンスを作成したことを確認します。
