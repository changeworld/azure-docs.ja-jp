...
## <a name="enabling-the-application-integration-for-cornerstone-ondemand"></a>Cornerstone OnDemand のアプリケーション統合の有効化
このセクションでは、Cornerstone OnDemand のアプリケーション統合を有効にする方法について説明します。

### <a name="to-enable-the-application-integration-for-cornerstone-ondemand-perform-the-following-steps"></a>Cornerstone OnDemand のアプリケーション統合を有効にするには、次の手順を実行します。
...
5. 次のアイテムを Cornerstone OnDemand サポート チームに送信します。
   ...
   > [!NOTE]
   > シングル サインオンは、Cornerstone OnDemand サポート チームが構成する必要があります。
...
### <a name="to-assign-users-to-cornerstone-ondemand-perform-the-following-steps"></a>ユーザーを Cornerstone OnDemand に割り当てるには、次の手順を実行します。
