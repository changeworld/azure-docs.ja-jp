...
1. **[TargetProcess でのシングル サインオンの構成]** ページで、次の手順を実行します。
    ...
    b.**[次へ]** をクリックします。
2. 管理者として TargetProcess アプリケーションにサインオンします。
3. 上部のメニューで **[セットアップ]** をクリックします。
...
6. [Single Sign-on] の設定ダイアログで、次の手順を実行します。
