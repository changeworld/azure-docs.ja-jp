...
- [Azure Portal での仮想マシン スケール セットの作成](../virtual-machine-scale-sets/virtual-machine-scale-sets-create-portal.md)  
...
- Azure Portal を使用して、Azure 仮想マシン スケール セットの MSI に[別の Azure リソースへのアクセス](msi-howto-assign-access-portal.md)を許可します。
