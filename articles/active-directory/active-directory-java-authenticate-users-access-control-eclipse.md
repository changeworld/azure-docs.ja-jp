...
## <a name="deploy_compute_emulator"></a>コンピューティング エミュレーターへのデプロイ
...
## <a name="deploy_azure"></a>Azure へのデプロイ
...
[How to view SAML returned by the Azure Access Control Service (Azure の Access Control サービスによって返される SAML を表示する方法)]: /develop/java/how-to-guides/view-saml-returned-by-acs/
