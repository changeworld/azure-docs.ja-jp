...
B2B コラボレーション機能によって B2B ユーザーにも適用される Azure AD の有料機能は、Azure AD 有料ライセンス (使用する機能に応じて、Basic、Premium P1、または Premium P2) によって使用を許諾する必要があります。 招待元のテナントは、Azure AD 有料ライセンスごとに 5 人の B2B ユーザーの権利を取得します。 つまり、テナントの 1 人の従業員ユーザーに権利を付与する各 Azure AD 有料ライセンスには、5 人の B2B ユーザーをテナントに招待する権利も含まれます。
