...
* [監査ログ](overview-reports.md#activity-reports) に関する記事
...
この記事に掲載されているサンプルを使用するには、事前に、[Azure AD レポート API にアクセスするための前提条件](howto-configure-prerequisites-for-reporting-api.md)を完了する必要があります。  
...
* Azure Active Directory Reporting API の使用に関する網羅的な概要を参照するには、 [Azure Active Directory Reporting API の概要](concept-reporting-api.md)を参照してください。
* Azure Active Directory のレポート作成に関する詳細については、「 [Azure Active Directory レポート ガイド](overview-reports.md)」を参照してください。  
