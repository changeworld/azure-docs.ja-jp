...
3. **[追加]** をクリックします。
   ...
   ![セットアップ](./media/howto-mfaserver-adfs-2/setup1.png)</center>
...
10. すべてのユーザーがサーバーにインポート済みであるかインポート予定であり、2 段階認証の対象となる場合は、**[Require Azure Multi-Factor Authentication user match (Azure Multi-Factor Authentication のユーザー照合が必要)]** ボックスをオンにします。 多数のユーザーがまだサーバーにインポートされていない、または 2 段階認証から除外される場合、ボックスはオフのままにします。
    ...
    ![セットアップ](./media/howto-mfaserver-adfs-2/manual.png)</center>
...
2. [設定] タブで、**[特定の LDAP 構成を使用する]** ラジオ ボタンを選択します。
   ...
   ![セットアップ](./media/howto-mfaserver-adfs-2/ldap1.png)</center>
...
5. **[テスト]** ボタンをクリックして、LDAP 接続をテストします。
   ...
   ![セットアップ](./media/howto-mfaserver-adfs-2/ldap2.png)</center>
...
![セットアップ](./media/howto-mfaserver-adfs-2/reg.png)</center>
...
7. 必要な場合は、[クッキーのキャッシュ] ボックスをオンにします。
   ...
   ![セットアップ](./media/howto-mfaserver-adfs-2/noproxy.png)</center>
...
![セットアップ](./media/howto-mfaserver-adfs-2/trusted.png)</center>
