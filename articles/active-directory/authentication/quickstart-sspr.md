...
* [パスワード ライトバックを構成](howto-sspr-writeback.md#configure-password-writeback)し、パスワードを Azure AD からオンプレミス ディレクトリに書き戻します。
...
[Policy]: ./media/quickstart-sspr/password-policy.png "オンプレミスのパスワード グループ ポリシーを 0 日に設定"
