...
このチュートリアルでは、Azure Multi-Factor Authentication を有効にしました。 次のチュートリアルに進み、Azure Identity Protection をセルフサービス パスワード リセット と Multi-Factor Authentication のエクスペリエンスに統合する方法を参照してください。
