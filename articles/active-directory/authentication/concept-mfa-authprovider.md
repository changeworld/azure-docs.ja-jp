...
Azure Active Directory を持つグローバル管理者と Microsoft 365 ユーザーは、既定では 2 段階認証をお使いいただけます。 ただし、[高度な機能](howto-mfa-mfasettings.md)が必要な場合は、通常版の Multi-Factor Authentication (MFA) をご購入ください。
