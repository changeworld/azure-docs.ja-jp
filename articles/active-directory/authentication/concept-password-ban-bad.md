...
パスワードベースのセキュリティの問題に関する追加情報は、「[パスワードの問題ではない](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Your-Pa-word-doesn-t-matter/ba-p/731984)」で確認できます。
