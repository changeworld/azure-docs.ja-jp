...
1. [https://myapps.microsoft.com](https://myapps.microsoft.com) へのサインイン
...
- SMS や電話を受ける代わりに、[Microsoft Authenticator アプリ](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)の通知を使用してサインインを確認する
