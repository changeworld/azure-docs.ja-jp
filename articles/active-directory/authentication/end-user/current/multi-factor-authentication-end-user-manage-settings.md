...
デバイスからアプリをアンインストールしたり、デバイスをリセットしても、アクティブ化はバック エンドで削除されません。 詳細については、「[Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)」参照してください。
...
* 2 段階認証をサポートしていないアプリに[アプリ パスワード](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-app-passwords.md)を設定します。
