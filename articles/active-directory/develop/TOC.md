...
## [認証シナリオ](active-directory-authentication-scenarios.md)
...
## [開発者ガイド](active-directory-developers-guide.md)
## [OAuth2 の暗黙的な許可](active-directory-dev-understanding-oauth2-implicit-grant.md)
## [Azure AD のアプリケーション](active-directory-how-applications-are-added.md)
...
# 方法
## [テナントを取得する](active-directory-howto-tenant.md)
## [任意の Azure AD ユーザーをサインインさせる](active-directory-devhowto-multi-tenant-overview.md)
## [アプリを統合する](active-directory-integrating-applications.md)
## SSO を有効にする
### [Android](active-directory-sso-android.md)
### [iOS](active-directory-sso-ios.md)
## [AppSource 認定を取得する](active-directory-devhowto-appsource-certified.md)
## [ギャラリーでアプリを一覧表示する](active-directory-app-gallery-listing.md)
## [アプリ マニフェストについて](active-directory-application-manifest.md)
## [Web ユーザーを認証する](active-directory-java-authenticate-users-access-control-eclipse.md)
## SAML を処理する
### [Access Control によって返される SAML を表示する](active-directory-java-view-saml-returned-by-access-control.md)
...
## [署名キー ロールオーバーを使用する](active-directory-signing-key-rollover.md)


## V2 エンドポイントを使用する
### [概要](active-directory-appmodel-v2-overview.md)
### [V2 の変更点](active-directory-v2-compare.md)
...
### [登録ポータル](active-directory-v2-registration-portal.md)
### [トークンのリファレンス](active-directory-v2-tokens.md)
### プロトコル
#### [OAuth 2.0 クライアントの資格情報](active-directory-v2-protocols-oauth-client-creds.md)
#### [OAuth 2.0 と OpenID](active-directory-v2-protocols.md)
#### [最近の更新](active-directory-v2-preview-oidc-changes.md)
### モバイル アプリ
...
#### [Web API を呼び出す](active-directory-v2-devquickstarts-webapp-webapi-dotnet.md)
### プロトコルと直接統合する
#### [アプリを登録する](active-directory-v2-app-registration.md)
#### [OpenID Connect](active-directory-v2-protocols-oidc.md)
#### [暗黙的なフロー](active-directory-v2-protocols-implicit.md)
#### [OAuth 2.0 承認コード](active-directory-v2-protocols-oauth-code.md)
#### [OAuth 2.0 クライアント資格情報](active-directory-v2-protocols-oauth-client-creds.md)
#### [サービス間の呼び出し](active-directory-protocols-oauth-service-to-service.md)

## Visual Studio を使用する
### [.NET を使って作業を開始する](vs-active-directory-dotnet-getting-started.md)
### [MVC プロジェクトの変更点](vs-active-directory-dotnet-what-happened.md)
