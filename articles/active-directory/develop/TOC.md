...
### [Access Control によって返される SAML の表示](active-directory-java-view-saml-returned-by-access-control.md)
...
### [MVC プロジェクトの変更点](Visual Studio Azure Active Directory connected service.md)?](vs-active-directory-dotnet-what-happened
...
## [アプリとサービス プリンシパルのオブジェクト](active-directory-application-objects.md)
...
# [v2.0 エンドポイント](active-directory-appmodel-v2-overview.md)
