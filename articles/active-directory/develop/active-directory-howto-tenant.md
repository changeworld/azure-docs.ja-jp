...
> [!TIP]
> テナント ID を確認する必要がある場合、この情報を見つける方法が複数あります。 アカウント名をポイントすると、テナント ID を表示できます。また、Azure portal 上で **[Azure Active Directory] > [プロパティ] > [ディレクトリ ID]** を選択することもできます。
