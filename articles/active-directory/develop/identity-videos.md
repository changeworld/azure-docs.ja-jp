...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=uDU1QTSw7Ps" target="_blank">Microsoft ID プラットフォームとは</a> (14:54)
    :::column-end:::
    :::column:::
        > [!Video https://www.youtube.com/embed/uDU1QTSw7Ps] 
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=tkQJSHFsduY" target="_blank">先進認証の基本 - Microsoft ID プラットフォーム</a> (12:28)
    :::column-end:::
    :::column:::
...
:::row:::
  :::column:::
        <a href="https://www.youtube.com/watch?v=JpeMeTjQJ04" target="_blank">概要:モバイル アプリケーションでのシングル サインオンの実装 - Microsoft ID プラットフォーム</a> (20:30)
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/JpeMeTjQJ04]
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=7_vxnHiUA1M" target="_blank">先進認証: ここまでの軌跡 – Microsoft ID プラットフォーム</a> (15:47)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        1 - <a href="https://www.youtube.com/watch?v=zjezqZPPOfc&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=1" target="_blank">開発者向け Microsoft ID プラットフォームの概要</a> (33:55)
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/zjezqZPPOfc]
    :::column-end:::
     :::column:::
        2 - <a href="https://www.youtube.com/watch?v=Mtpx_lpfRLs&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=2" target="_blank">Microsoft ID プラットフォームを使用してアプリのユーザーを認証する方法 </a> (29:09)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        3 - <a href="https://www.youtube.com/watch?v=toAWRNqqDL4&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=3" target="_blank">Microsoft ID プラットフォームのアクセス許可と同意のフレームワーク</a> (45:08)
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/toAWRNqqDL4]
    :::column-end:::
    :::column:::
        4 - <a href="https://www.youtube.com/watch?v=IIQ7QW4bYqA&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=4" target="_blank">Microsoft ID プラットフォームを使用して API を保護する方法</a> (33:17)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        5 - <a href="https://www.youtube.com/watch?v=-BK2iBDrmNo&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=5" target="_blank">Microsoft ID プラットフォームでのアプリケーション ロールとセキュリティ グループ</a> (15:52)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        1 - <a href="https://www.youtube.com/watch?v=fbSVgC8nGz4&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=1" target="_blank">基本: 先進認証の概念</a> (4:33)
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/fbSVgC8nGz4]
    :::column-end:::
     :::column:::
        2 - <a href="https://www.youtube.com/watch?v=tCNcG1lcCHY&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=2" target="_blank">Web アプリケーションの先進認証</a> (6:02)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        3 - <a href="https://www.youtube.com/watch?v=51B-jSOBF8U&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=3" target="_blank">Web シングル サインオン</a> (4:13)
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/51B-jSOBF8U]
    :::column-end:::
    :::column:::
        4 - <a href="https://www.youtube.com/watch?v=CjarTgjKcX8&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=4" target="_blank">フェデレーション Web 認証</a> (6:19)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        5 - <a href="https://www.youtube.com/watch?v=OGMDnuDrAcQ&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=5" target="_blank">ネイティブ クライアント アプリケーション - パート 1 </a> (8:12)
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/OGMDnuDrAcQ]
    :::column-end:::
    :::column:::
        6 - <a href="https://www.youtube.com/watch?v=2RE6IhXfmHY&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=6" target="_blank">ネイティブ クライアント アプリケーション - パート 2 </a> (5:33)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=bNlcFuIo3r8" target="_blank">Microsoft ID プラットフォームの概要</a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=qpdC45tZYDg" target="_blank">ADAL から MSAL に移行する理由</a>
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/qpdC45tZYDg]
    :::column-end:::
     :::column:::
        <a href="https://www.youtube.com/watch?v=xgL_z9yCnrE" target="_blank">ADAL コードベースを MSAL に移行する</a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=q-TDszj2O-4" target="_blank">MSAL が ADAL より優れている点</a>
    :::column-end:::
    :::column:::
        >[!Video https://www.youtube.com/embed/q-TDszj2O-4]
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=aBMUxC4evhU" target="_blank">v1 認証と v2 認証の違いは何か?</a>
    :::column-end:::
    :::column:::
