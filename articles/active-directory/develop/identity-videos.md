...
:::row:::
  :::column:::
        <a href="https://www.youtube.com/watch?v=tkQJSHFsduY" target="_blank">先進認証の基本 - Microsoft ID プラットフォーム<span class="docon docon-navigate-external x-hidden-focus"></span></a> (12:28)
    :::column-end:::
    :::column:::
...
## <a name="developer-training-series"></a>開発者向けトレーニング シリーズ
...
:::row:::
    :::column:::
        1 - <a href="https://www.youtube.com/watch?v=zjezqZPPOfc&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=1" target="_blank">開発者向け Microsoft ID プラットフォームの概要 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (33:55)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
     :::column:::
        2 - <a href="https://www.youtube.com/watch?v=Mtpx_lpfRLs&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=2" target="_blank">Microsoft ID プラットフォームを使用してアプリのユーザーを認証する方法 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (29:09)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        3 - <a href="https://www.youtube.com/watch?v=toAWRNqqDL4&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=3" target="_blank">Microsoft ID プラットフォームのアクセス許可と同意のフレームワーク <span class="docon docon-navigate-external x-hidden-focus"></span></a> (45:08)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        4 - <a href="https://www.youtube.com/watch?v=IIQ7QW4bYqA&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=4" target="_blank">Microsoft ID プラットフォームを使用して API を保護する方法 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (33:17)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        5 - <a href="https://www.youtube.com/watch?v=-BK2iBDrmNo&list=PLLasX02E8BPBxGouWlJV-u-XZWOc2RkiX&index=5" target="_blank">Microsoft ID プラットフォームでのアプリケーション ロールとセキュリティ グループ <span class="docon docon-navigate-external x-hidden-focus"></span></a> (15:52)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        1 - <a href="https://www.youtube.com/watch?v=fbSVgC8nGz4&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=1" target="_blank">基本: 先進認証の概念 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (4:33)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
     :::column:::
        2 - <a href="https://www.youtube.com/watch?v=tCNcG1lcCHY&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=2" target="_blank">Web アプリケーションの先進認証 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (6:02)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        3 - <a href="https://www.youtube.com/watch?v=51B-jSOBF8U&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=3" target="_blank">Web シングル サインオン <span class="docon docon-navigate-external x-hidden-focus"></span></a> (4:13)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        4 - <a href="https://www.youtube.com/watch?v=CjarTgjKcX8&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=4" target="_blank">フェデレーション Web 認証 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (6:19)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        5 - <a href="https://www.youtube.com/watch?v=OGMDnuDrAcQ&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=5" target="_blank">ネイティブ クライアント アプリケーション - パート 1 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (8:12)
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        6 - <a href="https://www.youtube.com/watch?v=2RE6IhXfmHY&list=PLLasX02E8BPD5vC2XHS_oHaMVmaeHHPLy&index=6" target="_blank">ネイティブ クライアント アプリケーション - パート 2 <span class="docon docon-navigate-external x-hidden-focus"></span></a> (5:33)
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=bNlcFuIo3r8" target="_blank">Microsoft ID プラットフォームの概要<span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=apbbx2n4tnU" target="_blank">Microsoft Graph と Microsoft Authentication Library (MSAL) <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=yLVEBU9Z96Q" target="_blank">ライブラリの MSAL ファミリとは何ですか? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=eiPHOoLmGJs" target="_blank">範囲の説明 <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=Zd_Uubnu0U0" target="_blank">ブローカーとは <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=znSN_3JAuoU" target="_blank">リダイレクト URI の機能 <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=mDhT4Zv1fZU" target="_blank">テナントの説明 <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=zDEC7A5ZS2Q" target="_blank">Azure AD の役割 <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=HEpq_YSmuWw" target="_blank">Azure AD アプリ オブジェクトの役割 <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=E2OUluQQKSk" target="_blank">Microsoft の組織アカウントと個人アカウントの違い <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=ZJirt7eTVw8" target="_blank">SPA と Web アプリの違い <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=6R3W9T01gdE" target="_blank">アプリケーションのアクセス許可と委任されたアクセス許可の違いは何か? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=Gm6sALdXtpg" target="_blank">Microsoft ID プラットフォーム OpenID Connect 認定とは何か? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=cZKgTqF4o88" target="_blank">MSAL を使用する場合にプロトコルの本質的な概念としてどのようなことを知っておく必要があるか? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=41vmzPdbfXM" target="_blank">ID トークン、アクセス トークン、更新トークン、セッション トークンの違いは何か? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=jEEwN7XAtUo" target="_blank">承認要求とトークンの関係はどのようなものか? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=4pwuRYcZbz4" target="_blank">MSAL ライブラリによってプロトコルがどのように使いやすくなるか? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=qpdC45tZYDg" target="_blank">ADAL から MSAL に移行する理由 <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
     :::column:::
        <a href="https://www.youtube.com/watch?v=xgL_z9yCnrE" target="_blank">ADAL コードベースを MSAL に移行する <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=q-TDszj2O-4" target="_blank">MSAL が ADAL より優れている点 <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
    ...
    :::column-end:::
    :::column:::
        <a href="https://www.youtube.com/watch?v=aBMUxC4evhU" target="_blank">v1 認証と v2 認証の違いは何か? <span class="docon docon-navigate-external x-hidden-focus"></span></a>
    :::column-end:::
    :::column:::
