...
[シングル](quickstart-v1-integrate-apps-with-azure-ad.md)および[マルチテナント](active-directory-devhowto-multi-tenant-overview.md) アプリおよび[一般的な認証パターン](authentication-scenarios.md)の知識を持っているユーザーを対象とします。
