---
title: Azure AD v2.0 エンドポイントを使用して .NET MVC Web API にサインインを追加する | Microsoft Docs
...
## <a name="configure-oauth-authentication"></a>OAuth 認証を構成する
...
## <a name="configure-the-client-app"></a>クライアント アプリを構成する
