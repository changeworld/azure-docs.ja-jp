...
*   **SAML 2.0** または **WS-Fed**: アプリが SAML 2.0 をサポートしている場合、[カスタム アプリケーションを追加する手順](../manage-apps/configure-single-sign-on-non-gallery-applications.md)を使って、Azure AD テナントと直接統合できます。
