---
title: v2.0 用のアプリケーションの種類 | Azure
...
このシナリオを実際に確認するには、v2.0 の「[Getting Started](v2-overview.md#getting-started)」 (概要) セクションのいずれかのシングル ページ アプリのコード サンプルを試してください。
...
v2.0 エンドポイントで使われている各種トークンの詳細については、[アクセス トークン](access-tokens.md) リファレンスと [`id_token` リファレンス](id-tokens.md)を参照してください。
...
このシナリオを実際に確認するには、v2.0 の「[Getting Started](v2-overview.md#getting-started)」 (概要) セクションのいずれかの Web アプリ サインイン コード サンプルを試してください。
...
Web API はそのアクセス トークンを使って API の呼び出し元の ID を検証し、アクセス トークンでエンコードされている要求から呼び出し元に関する情報を抽出します。 v2.0 エンドポイントで使われている各種トークンの詳細については、[アクセス トークン](access-tokens.md) リファレンスと [`id_token` リファレンス](id-tokens.md)を参照してください。
...
OAuth2 アクセス トークンを使用して Web API をセキュリティ保護する方法については、v2.0 の「[Getting Started](v2-overview.md#getting-started)」 (概要) セクションで Web API コード サンプルを確認してください。
