...
> [!NOTE]
> Azure AD V2 のコード サンプルに関心がある場合は、「[シナリオ別の v2.0 コード サンプル](active-directory-v2-code-samples.md)」をご覧ください。

各サンプル タイプの基本的なシナリオを理解するには、「[Azure AD の認証シナリオ](active-directory-authentication-scenarios.md)」をご覧ください。
...
------------------ | -------- | ---------- | -------------------- | -------------------------
デスクトップ (WPF)           | .NET/C# | 対話 | [dotnet-native-multitarget](https://github.com/azure-samples/active-directory-dotnet-native-multitarget) | [Dotnet-native-desktop](https://github.com/Azure-Samples/active-directory-dotnet-native-desktop) </p> [dotnet-native-aspnetcore](https://azure.microsoft.com/resources/samples/active-directory-dotnet-native-aspnetcore/)</p> [dotnet-webapi-manual-jwt-validation](https://github.com/azure-samples/active-directory-dotnet-webapi-manual-jwt-validation)
モバイル (UWP)            | .NET/C#  | 対話 | [dotnet-native-uwp-wam](https://github.com/azure-samples/active-directory-dotnet-native-uwp-wam) |  [dotnet-windows-store](https://github.com/Azure-Samples/active-directory-dotnet-windows-store) (シングル テナント Web API) </p> [dotnet-webapi-multitenant-windows-store](https://github.com/Azure-Samples/active-directory-dotnet-webapi-multitenant-windows-store) (マルチテナント Web API)|
モバイル (Android、iOS、UWP)   | .NET/C# (Xamarin) | 対話 | [dotnet-native-multitarget](https://github.com/azure-samples/active-directory-dotnet-native-multitarget) |
モバイル (Android)           | Android/Java | 対話 |   [android](https://github.com/Azure-Samples/active-directory-android) |
モバイル (iOS)           | iOS/Objective C | 対話 |   [nativeClient-iOS](https://github.com/azureadquickstarts/nativeclient-ios) |
