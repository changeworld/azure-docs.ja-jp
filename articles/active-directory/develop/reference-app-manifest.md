...
1. **[Azure Active Directory]** サービスを選択し、 **[アプリの登録]** を選択します。
1. 構成するアプリを選択します。
...
| `displayName` | string | アプリの表示名。 <br><br> _注:これは、アプリの登録 (レガシ) エクスペリエンスでのみ使用できます。[アプリの登録](https://go.microsoft.com/fwlink/?linkid=2083908)エクスペリエンスでは、`name` に置き換えられます。_ | `"MyRegisteredApp"` |
...
| `homepage` | string | アプリケーションのホームページの URL です。 <br><br> _注:これは、アプリの登録 (レガシ) エクスペリエンスでのみ使用できます。[アプリの登録](https://go.microsoft.com/fwlink/?linkid=2083908)エクスペリエンスでは、`signInUrl` に置き換えられます。_ | `"https://MyRegisteredApp"` |
| `objectId` | string | ディレクトリ内のアプリの一意識別子。 <br><br> _注:これは、アプリの登録 (レガシ) エクスペリエンスでのみ使用できます。[アプリの登録](https://go.microsoft.com/fwlink/?linkid=2083908)エクスペリエンスでは、`id` に置き換えられます。_ | `"f7f9acfc-ae0c-4d6c-b489-0a81dc1652dd"` |
