...
現時点では、v2.0 エンドポイントによって発行されたアクセス トークンは、Microsoft サービスでのみ使用できます。 現在サポートされているどのシナリオにおいても、アプリでアクセス トークンの検証または検査を実行する必要はありません。 アクセス トークンは、完全に非透過的なものとして扱うことができます。 これらは、アプリが HTTP 要求で Microsoft に渡すことができる文字列にすぎません。

近い将来、v2.0 エンドポイントにはアプリが他のクライアントからアクセス トークンを受信できる機能が導入されます。 その時点で、このリファレンス トピックの情報は、アプリでアクセス トークンの検証およびその他の同様のタスクを実行するために必要な情報に更新されます。
