---
title: "Azure AD v2.0 NodeJS AngularJS シングル ページ アプリの概要 | Microsoft Docs"
...
作業を開始するには、[node.js](https://nodejs.org) をダウンロードしてインストールする必要があります。  その後は、スケルトン アプリを複製または [ダウンロード](https://github.com/AzureADQuickStarts/AppModelv2-SinglePageApp-AngularJS-NodeJS/archive/skeleton.zip) できます。
