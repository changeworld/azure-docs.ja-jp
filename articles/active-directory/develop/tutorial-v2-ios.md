---
title: Azure AD v2.0 iOS の概要 | Microsoft Docs
description: iOS (Swift) アプリケーションで、アクセス トークンを必要とする API を Azure Active Directory v2.0 エンドポイントから呼び出す方法
