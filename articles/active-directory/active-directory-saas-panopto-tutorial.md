...
### <a name="to-enable-the-application-integration-for-panopto-perform-the-following-steps"></a>Panopto のアプリケーション統合を有効にするには、次の手順に従います。
...
3. **[アプリ URL の構成]** ページで、**[Panopto サインイン URL]** ボックスに、"*https://\<tenant-name\>.Panopto.com*" のパターンで URL を入力し、**[次へ]** をクリックします。
...
### <a name="to-assign-users-to-panopto-perform-the-following-steps"></a>ユーザーを Panopto に割り当てるには、次の手順に従います。
