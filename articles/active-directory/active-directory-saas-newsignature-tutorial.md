...
3. **[Cloud Management Portal for Microsoft Azure のテスト ユーザーの作成](#creating-a-newsignature-test-user)** - Azure AD の Britta Simon にリンクさせるために、対応するユーザーを Cloud Management Portal for Microsoft Azure で作成します。
