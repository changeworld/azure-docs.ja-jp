...
### <a name="administrator-override"></a>管理者の優先
...
3. 「[グループの設定を構成するための Azure Active Directory コマンドレット](active-directory-accessmanagement-groups-settings-cmdlets.md)」の手順に従って、このテナントのグループ設定を作成します。
...
詳細については、「[グループの設定を構成するための Azure Active Directory コマンドレット](active-directory-accessmanagement-groups-settings-cmdlets.md)」をご覧ください。
...
Yammer | Yammer 接続グループでは、構成済みの名前付けポリシーは強制されません。 名前付けポリシーを有効にしている組織の場合、Yammer では、名前付けポリシーに準拠しないグループに対して、Office 365 に接続されていない従来の Yammer グループが作成されます。
...
* [Office 365 グループの有効期限ポリシー](active-directory-groups-lifecycle-azure-portal.md)
