...
3. **[アプリケーション設定の構成]** ダイアログ ページで、次の手順に従います。
   ...
   > [!NOTE]
   > アカウントのドメイン名を構成するには、Small Improvements サポート チーム ( [Support@small-improvements.com](mailto:support@small-improvements.com) ) に連絡してください。 これは、シングル サインオンが動作するために必要です。
   > 
   > 

    a. **[サインオン URL]** ボックスに、ユーザーが Small Improvements アプリケーションへのサインオンに使用する URL を入力します。  
    b. ページの下部にある [次へ]」を参照してください。


1. **[Small Improvements でのシングル サインオンの構成]** ページで、次の手順を実行します。
