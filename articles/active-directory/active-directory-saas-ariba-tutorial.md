...
4. **[Ariba テスト ユーザーの作成](#creating-a-ariba-test-user)** - Ariba で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
> [AZURE.NOTE]ユーザーを手動で作成する必要がある場合は、Ariba サポート チームにお問い合わせください。
