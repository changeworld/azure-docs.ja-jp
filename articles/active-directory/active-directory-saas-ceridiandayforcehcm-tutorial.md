...
3. **[Ceridian Dayforce HCM のテスト ユーザーの作成](#creating-a-ceridian-dayforce-hcm-test-user)** - Ceridian Dayforce HCM で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
