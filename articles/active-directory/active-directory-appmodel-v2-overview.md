...
いずれの種類のアカウントを使用しても、一連の [Office 365 の REST API](https://www.msdn.com/office/office365/howto/authenticate-Office-365-APIs-using-v2) を利用できます現在これらの API には、Outlook のメール、連絡先、および予定表の API が含まれています。その他のサービスは、今後追加される予定です。<!-- TODO: customer reference article --><!-- Several apps have already begun to bridge the gap between consumer and enterprise accounts, including: [Boomerang](), [TripIt](), & [Uber](). -->
