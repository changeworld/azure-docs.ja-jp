...
- すべての監査アクティビティの完全な一覧については、「[Azure AD audit activity reference (Azure AD 監査アクティビティのリファレンス)](active-directory-reporting-activity-audit-reference.md)」を参照してください
