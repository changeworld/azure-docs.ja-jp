...
>[AZURE.NOTE]データ セキュリティの計画を完了したら、「[多要素認証要件の決定](active-directory-hybrid-identity-design-considerations-multifactor-auth-requirements.md)」を参照して、多要素認証要件に関する選択が、このセクションで行った決定によって影響を受けていないことを確認します。
