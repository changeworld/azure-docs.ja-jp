...
* 有効な Azure サブスクリプション
* ShiftPlanning でのシングル サインオン (SSO) が有効なサブスクリプション
...
## <a name="enable-the-application-integration-for-shiftplanning"></a>ShiftPlanning のアプリケーション統合を有効にする
このセクションでは、ShiftPlanning のアプリケーション統合を有効にする方法を説明します。

**ShiftPlanning のアプリケーション統合を有効にするには、次の手順を実行します。**
...
**ユーザーを ShiftPlanning に割り当てるには、次の手順を実行します。**
