...
8. Azure クラシック ポータルで、[シングル サインオンの構成の確認] を選択し、**[完了]** をクリックして **[シングル サインオンの構成]** ダイアログを閉じます。
   ...
   ![[次へ]](./media/active-directory-saas-syncplicity-tutorial/IC769554.png "Confirmation")
...
3. **[Add a user]**をクリックします。
   ...
   ![ユーザーの管理](./media/active-directory-saas-syncplicity-tutorial/IC769764.png "Manage Users")
