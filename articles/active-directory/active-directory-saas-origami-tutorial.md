...
# チュートリアル: Azure Active Directory と Origami の統合
...
このリンク関係は、Azure AD の **[ユーザー名]** の値を、Origami の **[Username]** の値として割り当てることで確立されます。
...
1. クラシック ポータルの **Origami** アプリケーション統合ページで **[シングル サインオンの構成]** をクリックし、**[シングル サインオンの構成]** ダイアログを開きます。
	 
	![Configure Single Sign-On][6]

2. **[ユーザーの Origami へのアクセスを設定してください]** ページで、**[Microsoft Azure AD シングル サインオン]** を選択し、**[次へ]** をクリックします。
...
3. **[アプリケーション設定の構成]** ダイアログ ページで、次の手順に従います。
    ...
    a.**[サインオン URL]** ボックスに、**https://live.origamirisk.com/origami/account/login?account=\<会社名>** というパターンを使用して、ユーザーが Origami アプリケーションへのサインオンに使用する URL を入力します
...
1. [Single Sign On Setup] ダイアログ ページで、次の手順に従います。
	...
	c.Azure クラシック ポータルで、**[シングル サインオン サービス URL]** をコピーし、**[Identity Provider's Sign-out Page URL]** ボックスに貼り付けます。
...
5. [新規ユーザーの追加] ダイアログで、次の手順を実行します。
	...
	a.**[User Name]** ボックスに、Azure クラシック ポータルの Britta Simon のユーザー名を入力します。

	b.**[Password]** ボックスに、パスワードを入力します。

	c.**[Confirm Password]** ボックスに、パスワードを再度入力します。

	d.**[名]** ボックスに「**Britta**」と入力します。

    e.**[Last Name]** ボックスに「**Simon**」と入力します。
