...
## <a name="who-owns-the-data-that’s-being-roamed?"></a>ローミングされるデータはだれが所有するのですか
...
## <a name="what-is-microsoft’s-recommendation-for-enabling-roaming-in-windows-10?"></a>Windows 10 におけるローミングの実現手段としてマイクロソフトが推奨する方法は
