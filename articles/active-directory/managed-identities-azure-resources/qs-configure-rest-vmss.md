---
title: REST を使用して Azure 仮想マシン スケール セットでマネージド ID を構成する - Azure AD
description: REST API を呼び出す CURL を使用して、Azure 仮想マシン スケール セットでシステム割り当てマネージド ID とユーザー割り当てマネージド ID を構成するための詳細な手順について説明します。
