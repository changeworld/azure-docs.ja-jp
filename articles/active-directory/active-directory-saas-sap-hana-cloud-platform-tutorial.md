...
4.  **[Trust (信頼)]** タブをクリックします。
    ...
    ![[Trust (信頼)]](./media/active-directory-saas-sap-hana-cloud-platform-tutorial/IC790800.png "Trust")

5.  信頼管理セクションで、次の手順に従います。

    ![[Get Metadata (メタデータの取得)]](./media/active-directory-saas-sap-hana-cloud-platform-tutorial/IC793930.png "Get Metadata")
