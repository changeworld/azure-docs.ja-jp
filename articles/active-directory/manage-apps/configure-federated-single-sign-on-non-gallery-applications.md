---
title: ギャラリー以外のアプリケーションのフェデレーション シングル サインオンを構成する方法
...
この記事では、ギャラリー以外の (たとえばカスタム) アプリケーションの SAML 2.0 を使用するフェデレーション シングル サインオンの構成に必要な手順の概要を提供します。
