---
title: 'アプリケーション管理: ベスト プラクティスと推奨事項'
...
ms.locfileid: "129615013"
---
# <a name="application-management-best-practices-in-azure-active-directory"></a>Azure Active Directory でのアプリケーション管理のベスト プラクティス
