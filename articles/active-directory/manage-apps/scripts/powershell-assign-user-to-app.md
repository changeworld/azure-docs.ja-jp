...
| command | メモ |
|---|---|
| [New-AzureADUserAppRoleAssignment](/powershell/module/AzureAD/new-azureaduserapproleassignment?view=azureadps-2.0) | ユーザーをアプリケーション ロールに割り当てます。 |
