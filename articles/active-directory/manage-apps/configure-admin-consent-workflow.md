...
3. フィルター検索ボックスに「**Azure Active Directory**」と入力し、 **[Azure Active Directory]**   の項目を選択します。
...
2. 左側のナビゲーション メニューの上部にある **[すべてのサービス]**   を選択します。  **Azure Active Directory 拡張機能** が開きます。
3. フィルター検索ボックスに「**Azure Active Directory**」と入力し、 **[Azure Active Directory]**   の項目を選択します。
4. ナビゲーション メニューで  **[エンタープライズ アプリケーション]** をクリックします。
...
|管理者が同意要求のワークフローを無効にする       |アクセス レビュー           |UserManagement           |ガバナンス ポリシー テンプレートを削除する          |アプリのコンテキスト            |ユーザー コンテキストは、現時点では確認できません           |
|管理者が同意ワークフローの構成を更新する        |アクセス レビュー           |UserManagement           |ガバナンス ポリシー テンプレートを更新する          |アプリのコンテキスト            |ユーザー コンテキストは、現時点では確認できません           |
|エンド ユーザーがアプリについて管理者の同意要求を作成する       |アクセス レビュー           |ポリシー         |要求を作成する           |アプリのコンテキスト            |ユーザー コンテキストは、現時点では確認できません           |
|レビュー担当者が管理者の同意要求を承認する       |アクセス レビュー           |UserManagement           |ビジネス フロー内のすべての要求を承認する          |アプリのコンテキスト            |ユーザー コンテキストと管理者の同意が付与されたアプリの ID は、どちらも現時点では確認できません。           |
|レビュー担当者が管理者の同意要求を拒否する       |アクセス レビュー           |UserManagement           |ビジネス フロー内のすべての要求を承認する          |アプリのコンテキスト            | 管理者の同意要求を拒否したアクターのユーザー コンテキストは、現時点では確認できません          |
