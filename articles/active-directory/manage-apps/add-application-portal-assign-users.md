...
ms.locfileid: "129058401"
---
# <a name="quickstart-create-and-assign-a-user-account-in-azure-active-directory"></a>クイックスタート: Azure Active Directory でユーザー アカウントを作成して割り当てる
