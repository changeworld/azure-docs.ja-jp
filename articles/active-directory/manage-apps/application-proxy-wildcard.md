...
- 内部アプリケーション SPN: 
    ...
    ![SPN 構成](./media/application-proxy-wildcard/44.png)
...
- 内部アプリケーション SPN で、ワイルドカードの代わりに **finance** を設定します。
    ...
    ![SPN 構成](./media/application-proxy-wildcard/54.png)


この構成では次のシナリオが実装されます。

![シナリオ](./media/application-proxy-wildcard/09.png)
