...
| イベントの種類 | 表示の有無 |
| --- | --- |
| [アクセス パネル](http://myapps.microsoft.com/)へのサインイン |はい |
| [Microsoft Azure 管理ポータル](https://manage.windowsazure.com/)へのサインイン |はい |
| Microsoft Azure [ポータル](https://portal.azure.com/)へのサインイン |はい |
| [Office 365 ポータル](http://portal.office.com/)へのサインイン |はい |
