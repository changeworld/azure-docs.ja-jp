...
3.  新しい Access Control 名前空間を作成するには、**[新規]** をクリックします。[**App Services**] と [**Access Control**] が選択されます。**[簡易作成]** をクリックします。
...
さらに ACS の機能を調べたり、他のシナリオを試してみたりする場合は、[Access Control Service 2.0] を参照してください。
