...
## <a name="enabling-the-application-integration-for-concur"></a>Concur のアプリケーション統合の有効化
このセクションでは、Concur のアプリケーション統合を有効にする方法について説明します。

### <a name="to-enable-the-application-integration-for-concur-perform-the-following-steps"></a>Concur のアプリケーション統合を有効にするには、次の手順を実行します。
...
### <a name="to-assign-users-to-concur-perform-the-following-steps"></a>ユーザーを Concur に割り当てるには、次の手順を実行します。
