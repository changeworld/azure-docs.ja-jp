...
6. 検索ボックスに、「**Oneteam**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_001.png)

7. 結果ウィンドウで **[Oneteam]** を選び、**[完了]** をクリックしてアプリケーションを追加します。
...
1. クラシック ポータルの **Oneteam** アプリケーション統合ページで **[シングル サインオンの構成]** をクリックし、**[シングル サインオンの構成]** ダイアログを開きます。

    ![[シングル サインオンの構成]][6]

2. **[ユーザーの Oneteam へのアクセスを設定してください]** ページで、**[Azure AD のシングル サインオン]** を選択し、**[次へ]** をクリックします。
...
6. アプリケーション用に構成された SSO を入手するために、<a href="https://support.one-team.com/hc/en-us/requests/new">ここ</a>から Oneteam へのサポート チケットを上げて、ダウンロードした**メタデータ**を提供できます。
...
1. **Azure クラシック ポータル**の左側のナビゲーション ウィンドウで、**[Active Directory]** をクリックします。
    ...
    ![Azure AD のテスト ユーザーの作成](./media/active-directory-saas-oneteam-tutorial/create_aaduser_09.png) 
...
7. **[一時パスワードの取得]** ダイアログ ページで、**[作成]** をクリックします。
    ...
    ![Azure AD のテスト ユーザーの作成](./media/active-directory-saas-oneteam-tutorial/create_aaduser_07.png) 
...
2. アプリケーションの一覧で **[Oneteam]** を選択します。
    ...
    ![[シングル サインオンの構成]](./media/active-directory-saas-oneteam-tutorial/tutorial_oneteam_50.png) 
