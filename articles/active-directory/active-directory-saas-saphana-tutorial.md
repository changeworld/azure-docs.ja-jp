...
4. 検索ボックスに「**SAP HANA**」と入力します。 結果パネルから **[SAP HANA]** を選択します。 最後に **[追加]** ボタンを選択してアプリケーションを追加します。 
    ...
    ![新しいアプリケーション](./media/active-directory-saas-saphana-tutorial/tutorial_saphana_addfromgallery.png)
...
10. **[Save]\(保存\)** を選択して SAML ID プロバイダーの詳細を保存し、既知の SAML IDP の一覧に新しい SAML IDP を追加します。
    ...
    ![[保存] ボタン](./media/active-directory-saas-saphana-tutorial/sap4.png)
...
1. 管理者として [SAP HANA Studio](https://help.sap.com/viewer/a2a49126a5c546a9864aae22c05c3d0e/2.0.01/en-us) を開き、SAML SSO の DB-User を有効にします。
    ...
    ![ユーザーの作成](./media/active-directory-saas-saphana-tutorial/sap5.png)
