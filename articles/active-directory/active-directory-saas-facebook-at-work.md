---
title: 'チュートリアル: Azure Active Directory と Facebook at Work の統合 | Microsoft Docs'
...
---
# <a name="tutorial:-azure-active-directory-integration-with-facebook-at-work"></a>チュートリアル: Azure Active Directory と Facebook at Work の統合
...
## <a name="adding-facebook-at-work-from-the-gallery"></a>ギャラリーから Facebook at Work を追加する
...
4. ID プロバイダーとして Azure AD を使用するように Facebook at Work を構成するには、 [https://developers.facebook.com/docs/facebook-at-work/authentication/cloud-providers](https://developers.facebook.com/docs/facebook-at-work/authentication/cloud-providers)
5. 完了したら、Azure クラシック ポータルが表示されているブラウザー ウィンドウに戻り、手順を完了したことを確認するチェック ボックスをオンにして、**[次へ]** をクリックし、**[完了]** をクリックします。

## <a name="automatically-provisioning-users-to-facebook-at-work"></a>ユーザーを Facebook at Work に自動的にプロビジョニングする
...
## <a name="assigning-users-to-facebook-at-work"></a>ユーザーを Facebook at Work に割り当てる
