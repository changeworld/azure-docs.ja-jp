...
4. **[Tidemark テスト ユーザーの作成](#creating-a-tidemark-test-user)** - Tidemark で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
> [AZURE.NOTE]ユーザーを手動で作成する必要がある場合は、Tidemark サポート チームにお問い合わせください。
