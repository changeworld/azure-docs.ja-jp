...
次のドキュメントは、このカテゴリの一般的な問題を解決する際に役立ちます。
...
## <a name="im-having-a-connectivity-problem-my-application"></a>アプリケーションで接続上の問題が発生している
  次のドキュメントは、このカテゴリの一般的な問題を解決する際に役立ちます。
...
## <a name="im-having-a-problem-configuring-the-azure-ad-application-proxy-in-the-admin-portal"></a>管理ポータルで Azure AD アプリケーション プロキシを構成すると問題が発生する
  次のドキュメントは、このカテゴリの一般的な問題を解決する際に役立ちます。
...
## <a name="im-having-a-problem-setting-up-back-end-authentication-to-my-application"></a>アプリケーションのバックエンド認証を設定するときに問題が発生した
  次のドキュメントは、このカテゴリの一般的な問題を解決する際に役立ちます。
...
## <a name="im-having-a-problem-when-signing-in-to-my-application"></a>アプリケーションにサインインするときに問題が発生した
  次のドキュメントは、このカテゴリの一般的な問題を解決する際に役立ちます。
