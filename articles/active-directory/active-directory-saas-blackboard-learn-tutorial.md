<properties
	pageTitle="チュートリアル: Azure Active Directory と Blackboard Learn の統合 | Microsoft Azure"
...
# チュートリアル: Azure Active Directory と Blackboard Learn の統合
...
1. **[Saml トークン属性]** ダイアログで、以下の表の各行について、次の手順を実行します。ここでは、一意のユーザー属性として、Userprincipalname をマッピングしていますが、組織内のユーザーを一意に識別し、Blackboard learn ユーザー名フィールドにマッピングする適切な値にマッピングすることができます。
...
2. クラシック ポータルの **Blackboard Learn** アプリケーション統合ページで **[シングル サインオンの構成]** をクリックし、**[シングル サインオンの構成]** ダイアログを開きます。
	 
	![Configure Single Sign-On][6]

3. **[ユーザーの Blackboard Learn へのアクセスを設定してください]** ページで、**[Microsoft Azure AD シングル サインオン]** を選択し、**[次へ]** をクリックします。
...
4. **[アプリケーション設定の構成]** ダイアログ ページで、次の手順に従います。
    ...
    a.**[サインオン URL]** ボックスに、ユーザーが Blackboard Learn アプリケーションへのサインオンに使用する URL を入力します。その際、**https://\<企業名-価格>.blackboard.com/** パターンを使用します。
	
	b. **[次へ]** をクリックします。
 
5. **[Blackboard Learn でのシングル サインオンの構成]** ページで、次の手順を実行します。
...
6. アプリケーション用に構成された SSO を入手するには、Blackboard Learn サポート チームに連絡し、次のものを情報として提供してください。
