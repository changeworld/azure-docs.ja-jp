...
2. デバイスが Azure AD に参加しているか、ドメインに参加して Azure AD に登録されている。
3. Azure Active Directory ポータルの **[構成]** > **[デバイス]** > **[設定とエンタープライズ アプリ データの同期が許可されるユーザー]** で、**Enterprise State Roaming** がディレクトリで有効になっている。 すべてのユーザーが選択されているか、または選択したオプションでユーザーの同期が有効になっており、ユーザーがセキュリティ グループに含まれている。
4. Azure Active Directory Premium サブスクリプションがユーザーに割り当てられている。  
5. デバイスが再起動されており、Enterprise State Roaming が有効になってからユーザーがログインしている。
...
**推奨される操作**  
[KB3193791](https://support.microsoft.com/kb/3193791) に示された手順を実行します。 
