...
ms.locfileid: "33931399"
---
# <a name="use-a-user-assigned-identity-on-a-linux-vm-to-access-azure-resource-manager"></a>Linux VM 上でユーザー割り当て ID を使用して Azure Resource Manager にアクセスする
