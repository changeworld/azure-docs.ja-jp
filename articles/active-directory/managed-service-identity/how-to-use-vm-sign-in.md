...
1. Azure VM の MSI アクセス トークンを取得します。  
2. アクセス トークンを使用して、対応する MSI サービス プリンシパル下の Azure AD にサインインします。   
3. VM に関する情報を取得するには、Azure Resource Manager コマンドレットを呼び出します。 PowerShell が自動的にトークンの使用を管理します。  
