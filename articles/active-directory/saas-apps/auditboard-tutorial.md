...
ms.locfileid: "73157819"
---
# <a name="tutorial-azure-active-directory-integration-with-auditboard"></a>チュートリアル:Azure Active Directory と AuditBoard の統合

このチュートリアルでは、AuditBoard と Azure Active Directory (Azure AD) を統合する方法について説明します。
AuditBoard と Azure AD の統合には、次の利点があります。

* AuditBoard にアクセスするユーザーを Azure AD で管理できます。
* ユーザーが自分の Azure AD アカウントを使用して AuditBoard に自動的にサインイン (シングル サインオン) できるようにすることができます。
...
**ギャラリーから AuditBoard を追加するには、次の手順を実行します。**
...
2. **[AuditBoard シングル サインオンの構成](#configure-auditboard-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[AuditBoard のテスト ユーザーの作成](#create-auditboard-test-user)** - AuditBoard で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
AuditBoard で Azure AD シングル サインオンを構成するには、次の手順に従います。

1. [Azure portal](https://portal.azure.com/) の **AuditBoard** アプリケーション統合ページで、 **[シングル サインオン]** を選択します。
...
### <a name="configure-auditboard-single-sign-on"></a>AuditBoard のシングル サインオンを構成する
...
このセクションでは、Britta Simon に AuditBoard へのアクセスを許可することで、このユーザーが Azure シングル サインオンを使用できるようにします。

1. Azure portal 上で **[エンタープライズ アプリケーション]** を選択し、 **[すべてのアプリケーション]** を選択してから、 **[AuditBoard]** を選択します。
...
アクセス パネル上で [AuditBoard] タイルをクリックすると、SSO を設定した AuditBoard に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)に関する記事を参照してください。
