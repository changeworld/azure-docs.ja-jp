...
* ユーザーが自分の Azure AD アカウントで Certify に自動的にサインイン (シングル サインオン) するように設定できます。
...
2. **[Certify のシングル サインオンの構成](#configure-certify-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[Certify のテスト ユーザーの作成](#create-certify-test-user)** - Certify で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
4. **[基本的な SAML 構成]** セクションで、次の手順を実行します。
    ...
    ![[Certify のドメインと URL] のシングル サインオン情報](common/idp-identifier.png)
...
### <a name="configure-certify-single-sign-on"></a>Certify のシングル サインオンの構成
...
2. アプリケーションの一覧で **[Certify]** を選択します。
    ...
    ![アプリケーションの一覧の Certify のリンク](common/all-applications.png)
...
アクセス パネル上で [Certify] タイルをクリックすると、SSO を設定した Certify に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)に関する記事を参照してください。
