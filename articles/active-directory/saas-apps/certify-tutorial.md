...
4. 検索ボックスに、「 **Certify**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/certify-tutorial/tutorial_certify_search.png)

5. 結果ウィンドウで **[Certify]** を選択し、**[追加]** をクリックして、アプリケーションを追加します。
...
3. **[Certify テスト ユーザーの作成](#creating-a-certify-test-user)** - Certify で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
3. **[Certify Domain and URLs]\(Certify のドメインと URL\)** セクションで、次の手順を実行します。
...
6. **[Certify Configuration]\(Certify 構成\)** セクションで、**[Configure Certify]\(Certify を構成する\)** をクリックし、**[サインオンの構成]** ウィンドウを開きます。 **[クイック リファレンス]** セクションから、**サインアウト URL、SAML エンティティ ID、SAML シングル サインオン サービス URL** をコピーします。

    ![[Configure Single Sign-On]](./media/certify-tutorial/tutorial_certify_configure.png) 

7. **Certify** 側にシングル サインオンを構成するには、ダウンロードされた**証明書 (未加工)**、**サインアウト URL、SAML エンティティ ID、SAML シングル サインオン サービス URL** を [Certify サポート チーム](mailto:support@certify.com)に送信する必要があります。 サポート チームはこれを設定して、SAML SSO 接続が両方の側で正しく設定されるようにします。
