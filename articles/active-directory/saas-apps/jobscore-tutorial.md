...
このセクションでは、JobScore で Britta Simon というユーザーを作成します。 [JobScore サポート チーム](mailto:support@jobscore.com)と協力して、JobScore プラットフォームにユーザーを追加します。 シングル サインオンを使用する前に、ユーザーを作成し、有効化する必要があります。
