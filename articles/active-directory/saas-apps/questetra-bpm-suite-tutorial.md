...
2. 上部のメニューで **[システム設定]** をクリックします。 
    ...
    ![Questetra BPM Suite 企業サイトから [システム設定] が選択された画面のスクリーンショット。][10]

3. **[シングルサインオン (SAML)]** ページを開くには、 **[SSO (SAML)]** をクリックします。 
   
    ![[S S O (SAML)] が選択された画面のスクリーンショット。][11]
...
アクセス パネル上で [Questetra BPM Suite] タイルをクリックすると、SSO を設定した Questetra BPM Suite に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)に関する記事を参照してください。
