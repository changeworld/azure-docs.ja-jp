...
1. **[基本的な SAML 構成]** セクションで、アプリケーションを **IDP** 開始モードで構成する場合は、次のフィールドの値を入力します。
    ...
    > [!NOTE]
    > 上記の値は、実際の値ではありません。 実際の識別子と応答 URL でこれらの値を更新します。 実際の値は、チュートリアルの「**Atlassian Cloud SSO の構成**」の手順 7. で後述する **Atlassian Cloud SAML 構成**画面から取得できます。
