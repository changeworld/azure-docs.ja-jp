...
このチュートリアルでは、Explanation-Based Auditing System と Azure Active Directory (Azure AD) を統合する方法について説明します。
Explanation-Based Auditing System と Azure AD を統合すると、次の利点が得られます。

* Explanation-Based Auditing System にアクセスできるユーザーを Azure AD で制御できます。
...
Explanation-Based Auditing System と Azure AD の統合を構成するには、次のものが必要です。
...
Azure AD への Explanation-Based Auditing System の統合を構成するには、管理対象の SaaS アプリの一覧にギャラリーから Explanation-Based Auditing System を追加する必要があります。

**ギャラリーから Explanation-Based Auditing System を追加するには、次の手順を実行します。**
...
4. **[基本的な SAML 構成]** セクションで、次の手順を実行します。
    ...
    ![[Explanation-Based Auditing System のドメインと URL] のシングル サインオン情報](common/sp-signonurl.png)

    **[サインオン URL]** テキスト ボックスに URL として「`https://ebas.maizeanalytics.com`」と入力します。
...
このセクションでは、Britta Simon に Explanation-Based Auditing System へのアクセスを許可することで、このユーザーが Azure シングル サインオンを使用できるようにします。

1. Azure portal 上で **[エンタープライズ アプリケーション]** を選択し、 **[すべてのアプリケーション]** を選択してから、 **[Explanation-Based Auditing System]** を選択します。

    ![[エンタープライズ アプリケーション] ブレード](common/enterprise-applications.png)

2. アプリケーションの一覧で **[Explanation-Based Auditing System]** を選択します。

    ![アプリケーションの一覧にある Explanation-Based Auditing System のリンク](common/all-applications.png)
...
### <a name="create-explanation-based-auditing-system-test-user"></a>Explanation-Based Auditing System のテスト ユーザーの作成

このセクションでは、Britta Simon というユーザーを Explanation-Based Auditing System に作成します。 Explanation-Based Auditing System では、Just-In-Time ユーザー プロビジョニングがサポートされています。この設定は既定で有効になっています。 このセクションでは、ユーザー側で必要な操作はありません。 Explanation-Based Auditing System にユーザーがまだ存在していない場合は、認証後に新規に作成されます。
