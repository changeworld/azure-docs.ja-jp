...
アクセス パネルで [My Award Points Top Sub/Top Team] タイルをクリックすると、SSO を設定した My Award Points Top Sub/Top Team アプリケーションに自動的にサインインされます。 アクセス パネルの詳細については、[アクセス パネルの概要](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)に関する記事を参照してください。
