...
アクセス パネルで [My Award Points Top Sub/Top Team] タイルをクリックすると、SSO を設定した My Award Points Top Sub/Top Team アプリケーションに自動的にサインインされます。 アクセス パネルの詳細については、[アクセス パネルの概要](../user-help/my-apps-portal-end-user-access.md)に関する記事を参照してください。
