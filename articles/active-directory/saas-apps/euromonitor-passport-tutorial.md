...
このセクションでは、Euromonitor Passport で B.Simon というユーザーを作成します。  [Euromonitor Passport のサポート チーム](mailto:passport.support@euromonitor.com)と協力して、Euromonitor Passport プラットフォームにユーザーを追加します。 シングル サインオンを使用する前に、ユーザーを作成し、有効化する必要があります。
