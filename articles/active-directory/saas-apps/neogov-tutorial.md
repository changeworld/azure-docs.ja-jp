...
## <a name="configure-and-test-azure-ad-single-sign-on-for-neogov"></a>NEOGOV の Azure AD シングル サインオンの構成とテスト
...
1. **[NEOGOV SSO の構成](#configure-neogov-sso)** - アプリケーション側でシングル サインオン設定を構成します。
    * **[NEOGOV テスト ユーザーの作成](#create-neogov-test-user)** - NEOGOV で B.Simon に対応するユーザーを作成し、Azure AD のこのユーザーにリンクさせます。
