...
- JIRA Core と Software 6.4 から 8.16.1、または JIRA Service Desk 3.0 から 4.16.1 が、Windows 64 ビット版にインストールおよび構成されている必要があります。
...
* JIRA Core とソフトウェア: 6.4 から 8.16.1
