...
このセクションでは、mindWireless で Britta Simon というユーザーを作成します。  [mindWireless サポート チーム](mailto:sdulloor@mindwireless.com) と連携して、mindWireless プラットフォームにユーザーを追加します。 シングル サインオンを使用する前に、ユーザーを作成し、有効化する必要があります。 
