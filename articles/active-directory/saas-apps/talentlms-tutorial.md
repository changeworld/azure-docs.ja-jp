...
4. 検索ボックスに、「**TalentLMS**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/talentlms-tutorial/tutorial_talentlms_search.png)

5. 結果ウィンドウで **TalentLMS** を選択し、**[追加]** をクリックして、アプリケーションを追加します。
...
3. **[TalentLMS のテスト ユーザーの作成](#creating-a-talentlms-test-user)** - TalentLMS で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
3. **[TalentLMS のドメインと URL]** セクションで、次の手順を実行します。
...
6. **[TalentLMS 構成]** セクションで、**[TalentLMS の構成]** をクリックして、**[サインオンの構成]** ウィンドウを開きます。 **[クイック リファレンス]** セクションから、**サインアウト URL、SAML エンティティ ID、SAML シングル サインオン サービス URL** をコピーします。

    ![[Configure Single Sign-On]](./media/talentlms-tutorial/tutorial_talentlms_configure.png)  

7. 別の Web ブラウザー ウィンドウで、TalentLMS 企業サイトに管理者としてログインします。

8. **[Account & Settings]** セクションで、**[Users]** タブをクリックします。
   
    ![Account & Settings](./media/talentlms-tutorial/IC777296.png "Account & Settings")

9. **[Single Sign-On (SSO)]** をクリックします。
