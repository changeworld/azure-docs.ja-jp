...
このセクションでは、Insperity ExpensAble で Britta Simon というユーザーを作成します。 [Insperity ExpensAble サポート チーム](https://www.insperity.com/products/expense-management/support/express/)と連携して、Insperity ExpensAble プラットフォームにユーザーを追加してください。 シングル サインオンを使用する前に、ユーザーを作成し、有効化する必要があります。
