---
title: チュートリアル:Azure Active Directory と iDiD Manager の統合 | Microsoft Docs
description: Azure Active Directory と iDiD Manager の間でシングル サインオンを構成する方法について説明します。
...
ms.locfileid: "124750009"
---
# <a name="tutorial-azure-active-directory-integration-with-idid-manager"></a>チュートリアル:Azure Active Directory と iDiD Manager の統合

このチュートリアルでは、iDiD Manager と Azure Active Directory (Azure AD) を統合する方法について説明します。
iDiD Manager と Azure AD の統合には、次の利点があります。

* iDiD Manager にアクセスする Azure AD ユーザーを制御できます。
...
iDiD Manager と Azure AD の統合を構成するには、次のものが必要です。
...
Azure AD への iDiD Manager の統合を構成するには、ギャラリーからマネージド SaaS アプリの一覧に iDiD Manager を追加する必要があります。
...
5. **[iDiD Manager のテスト ユーザーの作成](#create-idid-manager-test-user)** - iDiD Manager で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
このセクションでは、Britta Simon に iDiD Manager へのアクセスを許可することで、このユーザーが Azure シングル サインオンを使用できるようにします。

1. Azure portal 上で **[エンタープライズ アプリケーション]** を選択し、 **[すべてのアプリケーション]** を選択してから、 **[iDiD Manager]** を選択します。

    ![[エンタープライズ アプリケーション] ブレード](common/enterprise-applications.png)

2. アプリケーションの一覧で **[iDiD Manager]** を選択します。

    ![アプリケーションの一覧の [iDiD Manager] リンク](common/all-applications.png)
...
アクセス パネル上で [iDiD Manager] タイルをクリックすると、SSO を設定した iDiD Manager に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)に関する記事を参照してください。
