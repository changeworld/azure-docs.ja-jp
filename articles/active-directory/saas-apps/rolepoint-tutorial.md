...
1. 検索ボックスに、「**RolePoint**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/rolepoint-tutorial/tutorial_rolepoint_search.png)

1. 結果ウィンドウで **[RolePoint]** を選択し、**[追加]** をクリックして、アプリケーションを追加します。

    ![Azure AD のテスト ユーザーの作成](./media/rolepoint-tutorial/tutorial_rolepoint_addfromgallery.png)
...
1. **[RolePoint のテスト ユーザーの作成](#creating-a-rolepoint-test-user)** - RolePoint で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
1. **[RolePoint のドメインと URL]** セクションで、次の手順に従います。

    ![[シングル サインオンの構成]](./media/rolepoint-tutorial/tutorial_rolepoint_url.png)
...
1. **RolePoint** 側にシングル サインオンを構成するには、ダウンロードした**メタデータ XML** を [RolePoint サポート チーム](mailto:info@rolepoint.com)に送信する必要があります。
...
1. **Azure Portal** の左側のナビゲーション ウィンドウで、**[Azure Active Directory]** アイコンをクリックします。
    ...
    ![Azure AD のテスト ユーザーの作成](./media/rolepoint-tutorial/create_aaduser_01.png) 

1. **[ユーザーとグループ]** に移動し、**[すべてのユーザー]** をクリックして、ユーザーの一覧を表示します。
    
    ![Azure AD のテスト ユーザーの作成](./media/rolepoint-tutorial/create_aaduser_02.png) 

1. ダイアログの上部にある **[追加]** をクリックして、**[ユーザー]** ダイアログを開きます。
 
    ![Azure AD のテスト ユーザーの作成](./media/rolepoint-tutorial/create_aaduser_03.png) 

1. **[ユーザー]** ダイアログ ページで、次の手順を実行します。
 
    ![Azure AD のテスト ユーザーの作成](./media/rolepoint-tutorial/create_aaduser_04.png) 
...
1. アプリケーションの一覧で **[RolePoint]** を選択します。
