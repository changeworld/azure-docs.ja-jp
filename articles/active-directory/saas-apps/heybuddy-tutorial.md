...
## <a name="configure-and-test-azure-ad-single-sign-on-for-heybuddy"></a>HeyBuddy の Azure AD シングル サインオンの構成とテスト
...
HeyBuddy に対する Azure AD SSO を構成してテストするには、次の構成要素を完了します。
...
1. [Azure portal](https://portal.azure.com/) の **HeyBuddy** アプリケーション統合ページで、 **[管理]** セクションを見つけて、 **[シングル サインオン]** を選択します。
