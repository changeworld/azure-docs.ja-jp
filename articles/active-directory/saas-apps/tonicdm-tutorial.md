...
* ユーザーが自分の Azure AD アカウントを使用して TonicDM に自動的にサインイン (シングル サインオン) するように設定できます。
...
2. **[TonicDM シングル サインオンの構成](#configure-tonicdm-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[TonicDM のテスト ユーザーの作成](#create-tonicdm-test-user)** - TonicDM で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
6. **[TonicDM のセットアップ]** セクションで、要件に従って適切な URL をコピーします。
...
### <a name="configure-tonicdm-single-sign-on"></a>TonicDM シングル サインオンの構成

**TonicDM** 側でシングル サインオンを構成するには、ダウンロードした **証明書 (Base64)** と Azure portal からコピーした適切な URL を [TonicDM サポート チーム](mailto:support@tonicdm.com)に送信する必要があります。 サポート チームはこれを設定して、SAML SSO 接続が両方の側で正しく設定されるようにします。
...
2. アプリケーションの一覧で **[TonicDM]** を選択します。

    ![アプリケーションの一覧の [TonicDM] リンク](common/all-applications.png)
...
### <a name="create-tonicdm-test-user"></a>TonicDM のテスト ユーザーの作成
...
アクセス パネル上で [TonicDM] タイルをクリックすると、SSO を設定した TonicDM に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)に関する記事を参照してください。
