...
* ユーザーが自分の Azure AD アカウントを使用して ChronicX® に自動的にサインイン (シングル サインオン) できるようにすることが可能です。
...
2. **[ChronicX® シングル サインオンの構成](#configure-chronicx-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[ChronicX® テスト ユーザーの作成](#create-chronicx-test-user)** - Azure AD のユーザー表現にリンクされる Britta Simon に対応するユーザーを ChronicX® 内に用意します。
...
ChronicX® を利用して Azure AD シングル サインオンを構成するには、次の手順を実行します。

1. [Azure portal](https://portal.azure.com/) 内の **[ChronicX®]** アプリケーション統合ページで、**[シングル サインオン]** を選択します。
...
6. **[ChronicX® のセットアップ]** セクションで、要件に従って適切な URL をコピーします。
...
### <a name="configure-chronicx-single-sign-on"></a>ChronicX シングル サインオンの構成

**ChronicX®** 側でシングル サインオンを構成するには、ダウンロードした **フェデレーション メタデータ XML** と Azure portal からコピーした適切な URL を [ChronicX® サポート チーム](https://www.casebank.com/contact-us/)に送信する必要があります。 サポート チームはこれを設定して、SAML SSO 接続が両方の側で正しく設定されるようにします。
...
1. Azure portal 上で **[エンタープライズ アプリケーション]** を選択し、**[すべてのアプリケーション]** を選択してから、**[ChronicX®]** を選択します。

    ![[エンタープライズ アプリケーション] ブレード](common/enterprise-applications.png)

2. アプリケーションの一覧で **[ChronicX®]** を選択します。

    ![アプリケーションの一覧の [ChronicX®] リンク](common/all-applications.png)
...
### <a name="create-chronicx-test-user"></a>ChronicX テスト ユーザーの作成

このセクションでは、Britta Simon というユーザーを ChronicX® 内に作成します。 ChronicX® では、Just-In-Time ユーザー プロビジョニングがサポートされており、既定で有効になっています。 このセクションでは、ユーザー側で必要な操作はありません。 ChronicX® にユーザーがまだ存在していない場合は、認証後に新しく作成されます。
...
アクセス パネル上で [ChronicX®] タイルをクリックすると、SSO を設定した ChronicX® に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)に関する記事を参照してください。
