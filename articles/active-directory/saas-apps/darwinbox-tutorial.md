...
## <a name="adding-darwinbox-from-the-gallery"></a>ギャラリーからの Darwinbox の追加
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-darwinbox"></a>Darwinbox の Azure AD シングル サインオンの構成とテスト
...
Darwinbox に対する Azure AD SSO を構成してテストするには、次の構成要素を完了します。
