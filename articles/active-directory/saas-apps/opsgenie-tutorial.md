...
**ギャラリーから OpsGenie を追加するには、次の手順を実行します。**
...
5. **[OpsGenie テスト ユーザーの作成](#create-opsgenie-test-user)** - OpsGenie で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
