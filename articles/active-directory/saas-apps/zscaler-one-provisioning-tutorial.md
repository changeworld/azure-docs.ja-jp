...
3. Zscaler One を追加するには、ダイアログの上部にある **[新しいアプリケーション]** をクリックします。

    ![[新しいアプリケーション] ボタン][3]

4. 検索ボックスに、「**Zscaler One**」と入力します。

    ![Zscaler One プロビジョニング](./media/zscaler-one-provisioning-tutorial/app-search.png)

5. 結果パネルで **[Zscaler One]** を選択し、**[追加]** ボタンをクリックして Zscaler One を SaaS アプリケーションの一覧に追加します。

    ![Zscaler One プロビジョニング](./media/zscaler-one-provisioning-tutorial/app-search-results.png)

    ![Zscaler One プロビジョニング](./media/zscaler-one-provisioning-tutorial/app-creation.png)
...
2. SaaS アプリケーションの一覧から Zscaler One を選択します。

    ![Zscaler One プロビジョニング](./media/zscaler-one-provisioning-tutorial/app-instance-search.png)
