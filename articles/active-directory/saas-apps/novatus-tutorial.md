...
4. 検索ボックスに、「 **Novatus**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/novatus-tutorial/tutorial_novatus_search.png)

5. 結果ウィンドウで **[Novatus]** を選択し、**[追加]** をクリックして、アプリケーションを追加します。
...
3. **[Novatus のテスト ユーザーの作成](#creating-a-novatus-test-user)** - Novatus で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
