...
アクセス パネルで [ProMaster (by Inlogik)] タイルをクリックすると、SSO を設定した ProMaster (by Inlogik) アプリケーションに自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)に関する記事を参照してください。
...
- [高度な可視性と制御によって ProMaster (by Inlogik) を保護する方法](/cloud-app-security/proxy-intro-aad)