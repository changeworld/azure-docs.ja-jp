...
4. **[Expiration Reminder のテスト ユーザーの作成](#create-expiration-reminder-test-user)** - Expiration Reminder で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
