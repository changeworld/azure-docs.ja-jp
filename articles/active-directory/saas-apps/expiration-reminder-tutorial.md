...
このチュートリアルでは、Expiration Reminder と Azure Active Directory (Azure AD) を統合する方法について説明します。
Expiration Reminder と Azure AD の統合には、次の利点があります。

* Expiration Reminder にアクセスする Azure AD ユーザーを制御できます。
...
Azure AD と Expiration Reminder の統合を構成するには、次のものが必要です。

* Azure AD サブスクリプション。 Azure AD の環境がない場合は、[こちら](https://azure.microsoft.com/pricing/free-trial/)から 1 か月の評価版を入手できます
* Expiration Reminder でのシングル サインオンが有効なサブスクリプション
...
**ギャラリーから Expiration Reminder を追加するには、次の手順を実行します。**
...
2. **[Expiration Reminder シングル サインオンの構成](#configure-expiration-reminder-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[Expiration Reminder のテスト ユーザーの作成](#create-expiration-reminder-test-user)** - Expiration Reminder で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
Expiration Reminder で Azure AD シングル サインオンを構成するには、次の手順に従います。

1. [Azure Portal](https://portal.azure.com/) の **[Expiration Reminder]** アプリケーション統合ページで、 **[シングル サインオン]** を選択します。
...
4. **[基本的な SAML 構成]** セクションで、次の手順を実行します。
    ...
    ![[Expiration Reminder のドメインと URL] のシングル サインオン情報](common/sp-signonurl.png)
...
このセクションでは、Britta Simon に Expiration Reminder へのアクセスを許可することで、このユーザーが Azure シングル サインオンを使用できるようにします。

1. Azure portal 上で **[エンタープライズ アプリケーション]** を選択し、 **[すべてのアプリケーション]** を選択してから、 **[Expiration Reminder]** を選択します。

    ![[エンタープライズ アプリケーション] ブレード](common/enterprise-applications.png)

2. アプリケーションの一覧で、 **[Expiration Reminder]** を入力および選択します。

    ![アプリケーションの一覧の [Expiration Reminder] リンク](common/all-applications.png)
