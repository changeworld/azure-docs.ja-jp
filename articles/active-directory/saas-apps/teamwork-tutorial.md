...
このセクションでは、Teamwork.com で Britta Simon というユーザーを作成します。  [Teamwork.com サポート チーム](mailto:support@teamwork.com) と協力して、Teamwork.com プラットフォームにユーザーを追加してください。 シングル サインオンを使用する前に、ユーザーを作成し、有効化する必要があります。
