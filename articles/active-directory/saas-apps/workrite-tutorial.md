---
title: 'チュートリアル: Azure AD SSO と Workrite の統合'
...
## <a name="add-workrite-from-the-gallery"></a>ギャラリーからの Workrite の追加
...
## <a name="configure-and-test-azure-ad-sso-for-workrite"></a>Workrite の Azure AD SSO の構成とテスト
...
## <a name="configure-workrite-sso"></a>Workrite の SSO の構成
...
2. ナビゲーション ウィンドウで **[Admin]** をクリックします。
    ...
    ![管理者の制御](./media/workrite-tutorial/menu.png)
...
4. [**ユーザーの作成**] ダイアログ ボックスで、次の手順を実行します。
    ...
    ![ユーザー ダイアログの作成](./media/workrite-tutorial/roles.png)
