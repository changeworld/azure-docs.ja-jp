...
CBRE ServiceInsight で Azure AD SSO を構成してテストするには、次の構成要素を完了します。
...
アクセス パネルで [CBRE ServiceInsight] タイルをクリックすると、SSO を設定した CBRE ServiceInsight に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)に関する記事を参照してください。
...
- [Azure AD で CBRE ServiceInsight を試す](https://aad.portal.azure.com/)