...
4. **[基本的な SAML 構成]** セクションで、次の手順を実行します。
    ...
    a. **[サインオン URL]** ボックスに、`https://<companyname>.imagerelay.com/` の形式で URL を入力します。

    b. **[識別子 (エンティティ ID)]** ボックスに、`https://<companyname>.imagerelay.com/sso/metadata` の形式で URL を入力します。
