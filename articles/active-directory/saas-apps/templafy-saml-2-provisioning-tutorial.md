...
3. [Azure AD と Templafy SAML2 の間でマップする](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)データを決定します。 

## <a name="assigning-users-to-templafy-saml2"></a>Templafy SAML2 へのユーザーの割り当て
