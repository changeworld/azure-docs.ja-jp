...
## <a name="configure-and-test-azure-ad-single-sign-on-for-adp"></a>ADP の Azure AD シングル サインオンの構成とテスト
...
アクセス パネル上で [ADP] タイルをクリックすると、SSO を設定した ADP に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](../user-help/my-apps-portal-end-user-access.md)に関する記事を参照してください。
