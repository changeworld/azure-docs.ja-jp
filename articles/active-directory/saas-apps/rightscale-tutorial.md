...
アクセス パネルで [Rightscale] タイルをクリックすると、SSO を設定した Rightscale に自動的にサインインされます。 アクセス パネルの詳細については、[アクセス パネルの概要](../user-help/my-apps-portal-end-user-access.md)に関する記事を参照してください。
