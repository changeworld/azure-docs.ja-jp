...
1. 検索ボックスに、「**SimpleNexus**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/simplenexus-tutorial/tutorial_simplenexus_search.png)

1. 結果ウィンドウで **[SimpleNexus]** を選択し、**[追加]** をクリックして、アプリケーションを追加します。

    ![Azure AD のテスト ユーザーの作成](./media/simplenexus-tutorial/tutorial_simplenexus_addfromgallery.png)
...
1. **[SimpleNexus テスト ユーザーの作成](#creating-a-simplenexus-test-user)** - SimpleNexus で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
1. **[SimpleNexus のドメインと URL]** セクションで、次の手順を実行します。
...
1. **SimpleNexus** 側にシングル サインオンを構成するには、ダウンロードした**メタデータ XML** を [SimpleNexus サポート チーム](https://simplenexus.com/sn/contact-us/)に送信する必要があります。 サポート チームはこれを設定して、SAML SSO 接続が両方の側で正しく設定されるようにします。
...
1. **Azure Portal** の左側のナビゲーション ウィンドウで、**[Azure Active Directory]** アイコンをクリックします。
    ...
    ![Azure AD のテスト ユーザーの作成](./media/simplenexus-tutorial/create_aaduser_01.png) 

1. **[ユーザーとグループ]** に移動し、**[すべてのユーザー]** をクリックして、ユーザーの一覧を表示します。
    
    ![Azure AD のテスト ユーザーの作成](./media/simplenexus-tutorial/create_aaduser_02.png) 

1. ダイアログの上部にある **[追加]** をクリックして、**[ユーザー]** ダイアログを開きます。
 
    ![Azure AD のテスト ユーザーの作成](./media/simplenexus-tutorial/create_aaduser_03.png) 
