...
* IamIP Patent Platform でのシングル サインオン (SSO) が有効なサブスクリプション。
...
## <a name="adding-iamip-patent-platform-from-the-gallery"></a>ギャラリーからの IamIP Patent Platform の追加
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-iamip-patent-platform"></a>IamIP Patent Platform の Azure AD シングル サインオンの構成とテスト

**B.Simon** というテスト ユーザーを使用して、IamIP Patent Platform に対する Azure AD SSO を構成してテストします。 SSO を機能させるために、Azure AD ユーザーと IamIP Patent Platform の関連ユーザーとの間にリンク関係を確立する必要があります。

IamIP Patent Platform で Azure AD SSO を構成してテストするには、次の構成要素を完了します。

1. **[Azure AD SSO の構成](#configure-azure-ad-sso)** - ユーザーがこの機能を使用できるようにします。
    * **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - B.Simon で Azure AD のシングル サインオンをテストします。
    * **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - B.Simon が Azure AD シングル サインオンを使用できるようにします。
1. **[IamIP Patent Platform SSO の構成](#configure-iamip-patent-platform-sso)** - アプリケーション側でシングル サインオン設定を構成します。
    * **[IamIP Patent Platform のテスト ユーザーの作成](#create-iamip-patent-platform-test-user)** - IamIP Patent Platform で B.Simon に対応するユーザーを作成し、Azure AD の B.Simon にリンクさせます。
...
1. [Azure portal](https://portal.azure.com/) の **IamIP Patent Platform** アプリケーション統合ページで、 **[管理]** セクションを見つけて、 **[シングル サインオン]** を選択します。
...
1. アプリケーションを **SP** 開始モードで構成する場合は、 **[追加の URL を設定します]** をクリックして次の手順を実行します。
    ...
    **[サインオン URL]** テキスト ボックスに、URL として「`https://patents.iamip.com/login-user`」と入力します。
...
**IamIP Patent Platform** 側でシングル サインオンを構成するには、ダウンロードした**証明書 (未加工)** と Azure portal からコピーした適切な URL を [ サポート チーム](mailto:info@iamip.com)に送信する必要があります。 サポート チームはこれを設定して、SAML SSO 接続が両方の側で正しく設定されるようにします。

### <a name="create-iamip-patent-platform-test-user"></a>IamIP Patent Platform のテスト ユーザーの作成

このセクションでは、IamIP Patent Platform で B.Simon というユーザーを作成します。  [IamIP Patent Platform サポート チーム](mailto:info@iamip.com)と連携し、IamIP Patent Platform プラットフォームにユーザーを追加してください。 シングル サインオンを使用する前に、ユーザーを作成し、有効化する必要があります。

## <a name="test-sso"></a>SSO のテスト 

このセクションでは、アクセス パネルを使用して Azure AD のシングル サインオン構成をテストします。

アクセス パネルで [IamIP Patent Platform] タイルをクリックすると、SSO を設定した IamIP Patent Platform に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)に関する記事を参照してください。
