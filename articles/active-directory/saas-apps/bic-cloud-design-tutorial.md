...
## <a name="configure-and-test-azure-ad-single-sign-on-for-bic-cloud-design"></a>BIC Cloud Design の Azure AD シングル サインオンの構成とテスト
...
BIC Cloud Design に対する Azure AD SSO を構成してテストするには、次の構成要素を完了します。
...
1. [Azure portal](https://portal.azure.com/) の **BIC Cloud Design** アプリケーション統合ページで、 **[管理]** セクションを探して、 **[シングル サインオン]** を選択します。
