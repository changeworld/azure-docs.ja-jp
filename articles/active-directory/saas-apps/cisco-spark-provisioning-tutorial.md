...
3. Cisco Spark を追加するには、ダイアログの上部にある **[新しいアプリケーション]** ボタンをクリックします。

    ![[新しいアプリケーション] ボタン][3]

4. 検索ボックスに、「**Cisco Spark**」と入力します。

    ![Cisco Spark プロビジョニング](./media/cisco-spark-provisioning-tutorial/AppSearch.png)

5. 結果パネルで **[Cisco Spark]** を選択し、**[追加]** ボタンをクリックして Cisco Spark を SaaS アプリケーションの一覧に追加します。

    ![Cisco Spark プロビジョニング](./media/cisco-spark-provisioning-tutorial/AppSearchResults.png)

    ![Cisco Spark プロビジョニング](./media/cisco-spark-provisioning-tutorial/AppCreation.png)
...
2. SaaS アプリケーションの一覧から Cisco Spark を選択します。

    ![Cisco Spark プロビジョニング](./media/cisco-spark-provisioning-tutorial/Successcenter2.png)
