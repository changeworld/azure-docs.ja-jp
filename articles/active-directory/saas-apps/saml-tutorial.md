...
* ユーザーが自分の Azure AD アカウントで SAML 1.1 Token enabled LOB App に自動的にサインイン (シングル サインオン) するように設定できます。
...
2. **[SAML 1.1 Token enabled LOB App のシングル サインオンの構成](#configure-saml-11-token-enabled-lob-app-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[SAML 1.1 Token enabled LOB App テスト ユーザーの作成](#create-saml-11-token-enabled-lob-app-test-user)** - SAML 1.1 Token enabled LOB App で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
1. [Azure portal](https://portal.azure.com/) の **SAML 1.1 Token enabled LOB App** アプリケーション統合ページで、 **[シングル サインオン]** を選択します。
...
4. **[基本的な SAML 構成]** セクションで、次の手順を実行します。
    ...
    ![[SAML 1.1 Token enabled LOB App のドメインと URL] のシングル サインオン情報](common/sp-identifier.png)
...
### <a name="configure-saml-11-token-enabled-lob-app-single-sign-on"></a>SAML 1.1 Token enabled LOB App のシングル サインオンの構成
...
1. Azure portal 上で **[エンタープライズ アプリケーション]** を選択し、 **[すべてのアプリケーション]** を選択してから、 **[SAML 1.1 Token enabled LOB App]** を選択します。
...
アクセス パネルで [SAML 1.1 Token enabled LOB App] タイルをクリックすると、SSO を設定した SAML 1.1 Token enabled LOB App に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)に関する記事を参照してください。
