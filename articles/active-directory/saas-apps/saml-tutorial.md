...
アクセス パネルで [SAML 1.1 Token enabled LOB App] タイルをクリックすると、SSO を設定した SAML 1.1 Token enabled LOB App に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](../user-help/my-apps-portal-end-user-access.md)に関する記事を参照してください。
