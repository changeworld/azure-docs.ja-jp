...
2. ブラウザーに拡張機能を追加した後、 **[Teamphoria のセットアップ]** をクリックすると、Teamphoria アプリケーションに移動します。 そこから、管理者の資格情報を入力して Teamphoria にサインインします。 ブラウザー拡張機能によりアプリケーションが自動的に構成され、手順 3 から 6 が自動化されます。
