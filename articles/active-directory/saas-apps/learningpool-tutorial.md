...
4. **[基本的な SAML 構成]** セクションで、次の手順を実行します。
    ...
    b. **[識別子 (エンティティ ID)]** ボックスに、次の形式で URL を入力します。
    | |
    |--|
...
アクセス パネル上で [Learningpool Act] タイルをクリックすると、SSO を設定した Learningpool Act に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)に関する記事を参照してください。
