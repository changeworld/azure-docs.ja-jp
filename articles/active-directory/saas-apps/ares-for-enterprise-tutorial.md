...
* ARES for Enterprise にアクセスできる Azure AD ユーザーを制御できます。
* ユーザーが自分の Azure AD アカウントを使用して ARES for Enterprise に自動的にサインオン (シングル サインオン) するように設定できます。
...
ARES for Enterprise と Azure AD の統合を構成するには、次のものが必要です。

* Azure AD サブスクリプション。 Azure AD の環境がない場合は、[こちら](https://azure.microsoft.com/pricing/free-trial/)から 1 か月の評価版を入手できます
* ARES for Enterprise でのシングル サインオンが有効なサブスクリプション
...
**ギャラリーから ARES for Enterprise を追加するには、次の手順に従います。**
...
2. **[ARES for Enterprise シングル サインオンの構成](#configure-ares-for-enterprise-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。 
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[ARES for Enterprise のテスト ユーザーの作成](#create-ares-for-enterprise-test-user)** - ARES for Enterprise で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
4. **[基本的な SAML 構成]** セクションで、次の手順を実行します。
    ...
    ![ARES for Enterprise のドメインと URL のシングル サインオン情報](common/sp-intiated.png)

    **[サインオン URL]** ボックスに URL として「`https://login.graebert.com`」と入力します。
...
2. アプリケーションの一覧で **[ARES for Enterprise]** を選択します。

    ![アプリケーションの一覧の ARES for Enterprise のリンク](common/all-applications.png)
...
アクセス パネルで [ARES for Enterprise] タイルをクリックすると、SSO を設定した ARES for Enterprise に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)に関する記事を参照してください。
