...
* Clarizen にアクセスするユーザーを Azure AD で管理できます。
* ユーザーが自分の Azure AD アカウントで自動的に Clarizen にサインイン (シングル サインオン) するように設定できます。
...
* Clarizen では、**IDP** Initiated SSO がサポートされます
...
シングル サインオンを機能させるには、Azure AD ユーザーと Clarizen 内の関連ユーザー間にリンク関係が確立されている必要があります。

Clarizen で Azure AD のシングル サインオンを構成してテストするには、次の要素を完了する必要があります。

1. **[Azure AD シングル サインオンの構成](#configure-azure-ad-single-sign-on)** - ユーザーがこの機能を使用できるようにします。
2. **[Clarizen のシングル サインオンの構成](#configure-clarizen-single-sign-on)** - アプリケーション側でシングル サインオン設定を構成します。
3. **[Azure AD のテスト ユーザーの作成](#create-an-azure-ad-test-user)** - Britta Simon で Azure AD のシングル サインオンをテストします。
4. **[Azure AD テスト ユーザーの割り当て](#assign-the-azure-ad-test-user)** - Britta Simon が Azure AD シングル サインオンを使用できるようにします。
5. **[Clarizen のテスト ユーザーの作成](#create-clarizen-test-user)** - Clarizen で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
4. **[SAML でシングル サインオンをセットアップします]** ページで、次の手順を実行します。
    ...
    ![[Clarizen のドメインと URL] のシングル サインオン情報](common/idp-intiated.png)

    a. **[識別子]** ボックスに、値として「`Clarizen`」を入力します。

    b. **[応答 URL]** ボックスに、`https://.clarizen.com/Clarizen/Pages/Integrations/SAML/SamlResponse.aspx` のパターンを使用して URL を入力します
...
6. **[Set up Clarizen]\(Clarizen の設定\)** セクションで、要件に従って適切な URL をコピーします。
...
### <a name="configure-clarizen-single-sign-on"></a>Clarizen のシングル サインオンの構成
...
2. アプリケーションの一覧で **[Clarizen]** を選択します。
    ...
    ![アプリケーションの一覧の [Clarizen] リンク](common/all-applications.png)
...
### <a name="create-clarizen-test-user"></a>Clarizen のテスト ユーザーの作成
...
アクセス パネル上で [Clarizen] タイルをクリックすると、SSO を設定した Clarizen に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)に関する記事を参照してください。
