...
4. 検索ボックスに、「**NetDocuments**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/netdocuments-tutorial/tutorial_netdocuments_search.png)

5. 結果ウィンドウで **[NetDocuments]** を選択し、**[追加]** をクリックしてアプリケーションを追加します。
...
3. **[NetDocuments テスト ユーザーの作成](#creating-a-netdocuments-test-user)** - NetDocuments で Britta Simon に対応するユーザーを作成し、Azure AD の Britta Simon にリンクさせます。
...
3. **[NetDocuments Domain and URLs]\(NetDocuments のドメインと URL\)** セクションで、次の手順に従います。
...
6. 別の Web ブラウザーのウィンドウで、管理者として NetDocuments 企業サイトにログインします。

7. **[Admin]** に移動します。

8. **[ユーザーとグループの追加と削除]** をクリックします。
   
    ![リポジトリ](./media/netdocuments-tutorial/ic795047.png "リポジトリ")

9. **[認証オプションの詳細な構成]** をクリックします。
    
    ![認証オプションの詳細な構成](./media/netdocuments-tutorial/ic795048.png "認証オプションの詳細な構成")

10. **[フェデレーション ID]** ダイアログで、次の手順に従います。
...
2. アプリケーションの一覧で **[NetDocuments]\(NetDocuments\)** を選択します。
