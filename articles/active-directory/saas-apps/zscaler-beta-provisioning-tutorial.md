...
3. Zscaler Beta を追加するには、ダイアログの上部にある **[新しいアプリケーション]** をクリックします。

    ![[新しいアプリケーション] ボタン][3]

4. 検索ボックスに、「**Zscaler Beta**」と入力します。

    ![Zscaler Beta のプロビジョニング](./media/zscaler-beta-provisioning-tutorial/app-search.png)

5. 結果パネルで **[Zscaler Beta]** を選択し、**[追加]** ボタンをクリックして Zscaler Beta を SaaS アプリケーションの一覧に追加します。

    ![Zscaler Beta のプロビジョニング](./media/zscaler-beta-provisioning-tutorial/app-search-results.png)

    ![Zscaler Beta のプロビジョニング](./media/zscaler-beta-provisioning-tutorial/app-creation.png)
...
2. SaaS アプリケーションの一覧から Zscaler Beta を選択します。

    ![Zscaler Beta のプロビジョニング](./media/zscaler-beta-provisioning-tutorial/app-instance-search.png)
