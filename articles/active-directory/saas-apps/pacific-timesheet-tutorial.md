...
1. 検索ボックスに、「**Pacific Timesheet**」と入力します。

    ![Azure AD のテスト ユーザーの作成](./media/pacific-timesheet-tutorial/tutorial_pacifictimesheet_search.png)

1. 結果パネルで **[Pacific Timesheet]** を選択し、**[追加]** ボタンをクリックして、アプリケーションを追加します。
...
1. **[Pacific Timesheet のドメインと URL]** セクションで、次の手順を実行します。
...
1. **[Pacific Timesheet 構成]** セクションで、**[Pacific Timesheet の構成]** をクリックして、**[サインオンの構成]** ウィンドウを開きます。 **[クイック リファレンス]** セクションから **SAML エンティティ ID と SAML シングル サインオン サービス URL** をコピーします。
...
1. アプリケーションの一覧で **[Pacific Timesheet]** を選択します。
