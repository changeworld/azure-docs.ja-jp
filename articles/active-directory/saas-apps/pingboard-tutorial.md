...
4. **[基本的な SAML 構成]** セクションで、アプリケーションを **IDP** 開始モードで構成する場合は、次の手順を実行します。
    ...
    ![[基本的な SAML 構成] のスクリーンショット。テキスト ボックスの [識別子] と [応答 URL] が強調表示され、[保存] ボタンが選択されています。](common/idp-intiated.png)
...
アクセス パネルで [Pingboard] タイルをクリックすると、SSO を設定した Pingboard に自動的にサインインします。 アクセス パネルの詳細については、[アクセス パネルの概要](../user-help/my-apps-portal-end-user-access.md)に関する記事を参照してください。
