...
3. Zscaler を追加するには、ダイアログの上部にある **[新しいアプリケーション]** をクリックします。

    ![[新しいアプリケーション] ボタン][3]

4. 検索ボックスに、「**Zscaler**」と入力します。

    ![Zscaler プロビジョニング](./media/zscaler-provisioning-tutorial/app-search.png)

5. 結果パネルで **[Zscaler]** を選択し、**[追加]** ボタンをクリックして Zscaler を SaaS アプリケーションの一覧に追加します。

    ![Zscaler プロビジョニング](./media/zscaler-provisioning-tutorial/app-search-results.png)

    ![Zscaler プロビジョニング](./media/zscaler-provisioning-tutorial/app-creation.png)
...
2. SaaS アプリケーションの一覧から Zscaler を選択します。

    ![Zscaler プロビジョニング](./media/zscaler-provisioning-tutorial/app-instance-search.png)
