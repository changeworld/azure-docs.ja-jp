...
次の表に、簡単設定で収集される資格情報の概要とその用途を示します。
...
<br> <br> 次の表に、簡単設定で収集される資格情報の概要とその用途を示します。
...
<br> <br> 次の表に、特定のシナリオに必要なアクセス許可の概要を示します。
...
<br> <br> 次の表に、Azure AD Connect で作成されるアカウントの概要を示します。
