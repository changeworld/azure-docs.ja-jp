...
>[!NOTE] 
> この記事には、Azure AD - 1.5.42.0 以前のすべてのアーカイブ済みバージョンに関するバージョンリファレンス情報が含まれている。  現在のリリースについては、「[Azure AD Connect: バージョンのリリース履歴](reference-connect-version-history.md)」をご覧ください
...
- Azure AD Connectウィザード: パスワード ハッシュ同期の [オプション機能] ページのポップアップ ヘルプ テキストを修正します
