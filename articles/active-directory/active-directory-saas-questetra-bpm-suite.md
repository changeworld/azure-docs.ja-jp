...
4. 上部のメニューで **[システム設定]** をクリックします。<br><br> ![Azure AD のシングル サインオン][10]
...
8. **Questetra BPM Suite** 企業サイトで、次の手順を実行します。<br><br>![シングル サインオンの構成][15]
...
5. **[このユーザーに関する情報の入力]** ダイアログ ページで、次の手順を実行します。<br><br>![Azure AD のテスト ユーザーの作成][103]
    ...
    c.[次へ] をクリックします。
6.  **[ユーザー プロファイル]** ダイアログ ページで、次の手順を実行します。<br><br>![Azure AD のテスト ユーザーの作成][104] 
...
3.	[新規ユーザー] ダイアログで、次の手順を実行します。<br><br>![テスト ユーザーの作成][300] 
