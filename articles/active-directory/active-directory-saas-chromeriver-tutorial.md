...
## <a name="enabling-the-application-integration-for-chromeriver"></a>Chromeriver のアプリケーション統合の有効化
このセクションでは、Chromeriver のアプリケーション統合を有効にする方法を説明します。

### <a name="to-enable-the-application-integration-for-chromeriver-perform-the-following-steps"></a>Chromeriver のアプリケーション統合を有効にするには、次の手順を実行します。
...
3. **[アプリケーション設定の構成]** ページで、次の手順を実行します。
   ...
   ![[アプリケーション設定の構成]](./media/active-directory-saas-chromeriver-tutorial/IC802759.png "Configure App Settings")
...
5. ダウンロードしたメタデータ ファイルを Chromeriver サポート チームに送信します。
   ...
   > [!NOTE]
   > Chromeriver サポート チームが、実際に SSO を構成する必要があります。  
...
### <a name="to-assign-users-to-chromeriver-perform-the-following-steps"></a>ユーザーを Chromeriver に割り当てるには、次の手順を実行します。
