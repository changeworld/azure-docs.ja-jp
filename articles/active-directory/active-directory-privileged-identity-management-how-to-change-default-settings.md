...
* Microsoft アカウントの電子メール アドレスを持つユーザー (通常@outlook.com、常にではなく) Azure MFA に登録できません。 Microsoft アカウントを持つユーザーにロールを割り当てるには、ユーザーを永続的な管理者にするか、そのロールの MFA を無効化する必要があります。
