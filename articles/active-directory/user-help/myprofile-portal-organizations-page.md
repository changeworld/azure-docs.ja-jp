---
title: マイ プロファイル (プレビュー) ポータルから自分の組織を管理する - Azure Active Directory | Microsoft Docs
description: マイ プロファイル ポータルの [組織] ページの概要。
...
>[!Important]
>組織を誤って脱退した場合、元に戻す方法はありません。 組織をもう一度追加する必要があります。
