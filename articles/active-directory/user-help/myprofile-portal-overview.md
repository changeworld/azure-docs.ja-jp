---
title: マイ プロファイル (プレビュー) ポータルの概要 - Azure Active Directory | Microsoft Docs
description: マイ プロファイル ポータルとその機能の概要と詳細情報へのリンク。
...
![マイ プロファイル ポータル、概要ページ](media/myprofile-portal/myprofile-portal-overview.png)
...
## <a name="my-profile-portal-articles"></a>マイ プロファイル ポータルに関する記事
