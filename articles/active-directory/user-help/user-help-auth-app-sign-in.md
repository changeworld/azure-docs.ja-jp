...
標準の 2 要素認証方法では、サインインするデバイスにご自分のユーザー名とパスワードを入力し、Microsoft Authenticator アプリが通知を受信するかどうか、または Authenticator アプリから確認コードをコピーするかを選択します。 Android デバイスでは、 **[アカウント]** 画面で確認コードを確認できます。 iOS デバイスでは、これらの確認コードは、アカウントの種類に応じて、 **[アカウント]** 画面またはアカウントの全画面ビューで確認できます。 Microsoft Authenticator アプリにアカウントを追加するときに、アカウントの 2 要素認証を有効にします。
