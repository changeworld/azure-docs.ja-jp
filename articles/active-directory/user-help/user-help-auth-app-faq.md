...
### <a name="notification-blocks-sign-in"></a>サインインが通知によってブロックされる

**Q**: サインイン試行中に、サインイン画面に表示されているアプリの番号を選択する必要があります。 しかし、Authenticator の通知プロンプトがサインイン画面をブロックしています。 どうすればよいですか。  

**A**: 通知の [非表示] オプションを選択して、サインイン画面や、選択する必要がある番号が見えるようにします。 5 秒後にプロンプトが再表示され、正しい番号を選択できます。
...
- アカウントを追加したときに入力したアカウント情報。 アカウントを追加した後、アカウントで有効にする一部の機能によって、アカウントのデータがアプリに同期される場合があります。 このデータは、アカウントを削除することで削除できます。
