---
title: Azure Active Directory で「ここからアクセスすることはできません」というエラー メッセージを受け取る場合の考えられる理由 | Microsoft Docs
...
- [パスワードではなく携帯電話でサインインする](microsoft-authenticator-app-phone-signin-faq.md)