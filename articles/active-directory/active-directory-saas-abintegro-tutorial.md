...
## <a name="enabling-the-application-integration-for-abintegro"></a>Abintegro のアプリケーション統合の有効化
...
### <a name="to-assign-users-to-abintegro-perform-the-following-steps"></a>ユーザーを Abintegro に割り当てるには、次の手順に従います。
