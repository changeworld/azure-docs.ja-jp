...
これまで、さまざまなアプリケーションのアカウント管理は、組織内の IT 部門かサポート担当者による手作業で行われてきました。 Azure AD では、サービス プロバイダーによって統合されたアプリケーションと Microsoft によって事前に統合されたアプリケーションのすべてを対象に、アカウント管理が完全に自動化されており、自動化されたユーザー プロビジョニングまたは SAML Just-In-Time プロビジョニングがサポートされています。
