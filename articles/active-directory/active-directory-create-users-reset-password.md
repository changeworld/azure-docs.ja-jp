<properties
    pageTitle="Azure Active Directory におけるユーザー パスワードのリセット | Microsoft Azure"
    description="Azure Active Directory で管理者がユーザーのパスワードをリセットする方法について説明します。"
