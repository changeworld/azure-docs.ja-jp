...
**例:** <br> `RemoveDuplicates([proxyAddresses])` <br> 重複する値がすべて削除された後の、校正済み proxyAddress 属性を返します。
...
`ReplaceChars(“O’Neil”,%ReplaceString%)` <br> "ONeil" を返します。1 文字の ” ’ ” を削除するように定義されています。
