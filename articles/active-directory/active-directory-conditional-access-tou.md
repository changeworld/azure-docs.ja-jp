...
![ポリシーの作成](./media/active-directory-conditional-access-tou/5555.png)
...
5. **[Azure Active Directory]** ページの **[管理]** セクションで、**[条件付きアクセス]** をクリックします。
    ...
    ![条件付きアクセス](./media/active-directory-conditional-access-tou/03.png) 

6. **[管理]** セクションで、**[使用条件]** をクリックします。

    ![使用条件](./media/active-directory-conditional-access-tou/04.png) 

7. 上部のメニューで **[新しい条件]** をクリックします。

    ![使用条件](./media/active-directory-conditional-access-tou/05.png) 

8. **[新しい利用規約]** ページで、次の操作を行います。

    ![使用条件](./media/active-directory-conditional-access-tou/112.png) 
...
![ポリシーの作成](./media/active-directory-conditional-access-tou/1234.png)
...
2. **[割り当て]** セクションで **[ユーザーとグループ]** をクリックします。
    ...
    ![[概要]](./media/active-directory-conditional-access-tou/06.png)

3. **[ユーザーとグループ]** ページで、次の手順に従います。

    ![[概要]](./media/active-directory-conditional-access-tou/24.png)
...
4. **[クラウド アプリ]** をクリックします。
    ...
    ![クラウド アプリ](./media/active-directory-conditional-access-tou/08.png)

5. **[クラウド アプリ]** ページで、次の手順に従います。

    ![クラウド アプリを選択](./media/active-directory-conditional-access-tou/26.png)
...
6. **[アクセス制御]** セクションで、**[許可]** をクリックします。
    ...
    ![アクセス制御](./media/active-directory-conditional-access-tou/10.png)

7. **[許可]** ページで、次の手順に従います。

    ![許可](./media/active-directory-conditional-access-tou/111.png)
...
8. **[ポリシーを有効にする]** セクションで **[オン]** をクリックします。
    ...
    ![ポリシーを有効にする](./media/active-directory-conditional-access-tou/18.png)
...
![What If ポリシー ツール](./media/active-directory-conditional-access-tou/79.png)
...
2. クラウド アプリを選択するには:
    ...
    ![クラウド アプリ](./media/active-directory-conditional-access-tou/16.png)
...
![使用条件](./media/active-directory-conditional-access-tou/57.png)
...
- ポリシーを削除するには、ポリシーを選択し、クイック アクセス ツール バーの **[削除]** をクリックします。
    ...
    ![多要素認証](./media/active-directory-conditional-access-tou/33.png)

- 使用条件を削除するには、使用条件を選択し、上部のツール バーの **[条件の削除]** をクリックします。 

    ![多要素認証](./media/active-directory-conditional-access-tou/29.png)

## <a name="next-steps"></a>次の手順

> [!div class="nextstepaction"]
> [特定のアプリに対して MFA を必要にする](./active-directory-conditional-access-app-based-mfa.md)
