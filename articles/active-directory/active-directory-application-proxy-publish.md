...
2. アプリの追加ウィザードを終了すると、[アプリケーション プロキシのクイック スタート] ページが表示されます。ユーザーを割り当てるには、**[ユーザーの割り当て]** をクリックします。![アプリケーション プロキシのクイック スタート画面](./media/active-directory-application-proxy-publish/quickstart.png)
