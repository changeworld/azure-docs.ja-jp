...
一時的な問題、ネットワークの問題、または、バグによって、アプリケーションの追加に失敗することがあります。 このような状況が発生すると、Azure Portal の右上隅にある **[通知]** アイコン (ベル) をクリックしたときに、**[アプリケーションの作成]** 通知の横に赤い (!) アイコンが表示されます。 これは、アプリケーションを作成するときにエラーが発生したことを示します。
