...
ms.locfileid: "66730434"
---
# <a name="manage-device-identity-using-the-azure-portal"></a>Azure portal を使用してデバイス ID を管理する
...
- **[ユーザーはデバイスを Azure AD に参加させることができます]** - この設定を使用すると、[Azure AD 参加デバイス](overview.md#azure-ad-joined-devices)としてデバイスを登録できるユーザーを選択できます。 既定値は **[すべて]** です。
...
- **[ユーザーはデバイスを Azure AD に登録できます]** - Windows 10 ユーザー、iOS、Android、および macOS デバイスを Azure AD に[登録](overview.md#azure-ad-registered-devices)できるようにするには、この設定を構成する必要があります。 **[なし]** を選択した場合、デバイスは Azure AD に登録できません。 Microsoft Intune または Mobile Device Management (MDM) for Office 365 への登録には、この登録が必要です。 これらのサービスのいずれかを構成した場合は、 **[すべて]** が選択され、 **[なし]** は選択できなくなります。
