...
## <a name="integrating-windows-10-devices-with-azure-active-directory--a-content-map"></a>Windows 10 デバイスの Azure Active Directory との統合 - コンテンツ マップ
次のトピックで、組織で利用できる Windows 10 デバイスのさまざまな機能について知ることができます。

|  | トピック |
| --- | --- |
| 使用の開始 |[職場での Windows 10 デバイスの使用](active-directory-azureadjoin-windows10-devices.md) <br> <br> [Azure Active Directory 参加を使用したクラウド機能の Windows 10 デバイスへの拡張](active-directory-azureadjoin-overview.md) <br> <br> [Microsoft Passport 経由でのパスワードを使用しない ID の認証](active-directory-azureadjoin-passport.md) |
