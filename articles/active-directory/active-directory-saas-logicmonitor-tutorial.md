...
### <a name="to-enable-the-application-integration-for-logicmonitor-perform-the-following-steps"></a>LogicMonitor のアプリケーション統合を有効にするには、次の手順に従います。
...
2. 上部のメニューで、**[設定]**、**[Roles and Users (ロールとユーザー)]** の順にクリックします。
   ...
   ![[Roles and Users (ロールとユーザー)]](./media/active-directory-saas-logicmonitor-tutorial/IC790056.png "Roles and Users")
3. **[追加]**をクリックします。
...
### <a name="to-assign-users-to-logicmonitor-perform-the-following-steps"></a>ユーザーを LogicMonitor に割り当てるには、次の手順に従います。
