...
7. 結果ウィンドウで **[LearnUpon]** を選択し、**[完了]** をクリックしてアプリケーションを追加します。<br><br> ![Azure AD のテスト ユーザーの作成](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_02.png)<br>
...
1. Azure AD ポータルの **LearnUpon** アプリケーション統合ページで **[シングル サインオンの構成]** をクリックし、**[シングル サインオンの構成]** ダイアログを開きます。<br><br> ![Configure Single Sign-On][6] <br>

2. **[ユーザーの LearnUpon へのアクセスを設定してください]** ページで、**[Microsoft Azure AD シングル サインオン]** を選択し、**[次へ]** をクリックします。<br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_03.png) <br>

3. **[アプリケーション設定の構成]** ダイアログ ページで、次の手順に従います。<br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_04.png) <br>


    a.[応答 URL] ボックスに、Assertion Consumer Service URL を入力します。その際、**"https://<companyname>.learnupon.com/saml/consumer"** パターンを使用します。


4. **[LearnUpon でのシングル サインオンの構成]** ページで、次の手順を実行します。<br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_05.png) <br>
...
5. LearnUpon 側で **SAML SSO** を設定するために、別のブラウザー インスタンスを開き、LearnUpon インスタンスに管理ユーザーでログインします。LearnUpon にログインすると、次のような画面が表示されます。<br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_06.png) <br>

	a.**[settings]** タブをクリックして、設定ウィンドウを開きます。<br> b.**[Single Sign On - SAML]** をクリックします。<br> c.**[General Settings]** をクリックして SAML 設定を構成します。 <br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_07.png) <br> d.**[General Settings]** フォームを次のように設定します。<br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_08.png) <br> d1.**[Enabled]** チェックボックスをオンにして、このポータルでの SAML を有効にします。<br> d2.**[version 2.0]** を選択します。<br> d3.**[No Skip conditions]** を選択します。<br> d4.**[SAML Token POST param name]** は、前述の SAML コンシューマー URL に対する POST 要求パラメーターの名前であり、確認と認証の対象である SAML アサーションを含みます。例: **SAMLResponse** <br> d5.**[Name Identifier Format]** は、SAML アサーション内のユーザー ID (電子メール アドレス) の場所を示します。例: **urn:oasis:names:tc:SAML:1.1:nameid- format:emailAddress**<br> d6.**[Identify Provider Location]** は、ユーザーがポータルのログイン画面でアップロード アイコンをクリックした場合の送信先になります。<br> d7.Azure 構成画面の **[シングル サインアウト サービス URL]** を **[Sign out URL]** にコピーします。 <br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_09.png) <br> d8.[Certificate Finger Print] の **[Manage finger prints]** をクリックして、証明書のフィンガー プリントをアップロードします。 <br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_10.png) <br> d9.[Save] ボタンをクリックします。 e.**[User Settings]** をクリックして、SAML ユーザー設定を構成します。<br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_11.png) <br> e1.**[First Name Identifier Format]** は、SAML アサーション内のユーザーの名の場所を示します。例: **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/ givenname** e2.**[Last Name Identifier Format]** は、SAML アサーション内のユーザーの姓の場所を示します。例: **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/ surname**
...
このセクションの目的は、Britta Simon に LearnUpon へのアクセスを許可することによって、このユーザーが Azure のシングル サインオンを使用できるようにすることです。<br><br>![ユーザーの割り当て][200] <br>
...
2. アプリケーションの一覧で **[LearnUpon]** を選択します。<br><br>![Configure Single Sign-On](./media/active-directory-saas-learnupon-tutorial/tutorial_learnupon_50.png) <br>
