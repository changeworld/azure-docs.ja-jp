...
|50012|多要素認証中にユーザーが不正行為をレポートしました。|
...
|50097|デバイスが認証されていません。|
|50105|サインインしているユーザーは、このアプリケーションのロールに割り当てられていません。|
...
|50140|ユーザーはデバイスへのサインインを維持することの同意を求められました|
|50144|ユーザーの Active Directory パスワードの有効期限が切れています。|
|53000|条件付きアクセス ポリシーでは準拠デバイスが必要ですが、デバイスが準拠していません。|
...
|80001|認証エージェントが Active Directory に接続できません。|
