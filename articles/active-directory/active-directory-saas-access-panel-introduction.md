...
- グループを自己管理する。具体的には、セキュリティ グループを作成および管理し、Azure AD のセキュリティ グループのメンバーシップを要求することができます。詳細については、「[Azure AD でのユーザーのセルフ サービス グループ管理](active-directory-accessmanagement-self-service-group-management.md)」と「[グループの管理](active-directory-manage-groups.md)」を参照してください。
