...
![リスク イベント](./media/active-directory-identity-protection-risk-events/91.png)
...
![リスク レベル](./media/active-directory-identity-protection-risk-events/01.png)
...
Azure クラシック ポータルでは、リスク イベントの一部を、Azure AD 異常アクティビティ レポートで既に利用することができます。 

次の表では、さまざまなリスク イベントの種類と、対応する **Azure AD 異常なアクティビティ** レポートの一覧を示します。 
