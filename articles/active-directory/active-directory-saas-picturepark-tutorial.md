...
## <a name="enable-the-application-integration-for-picturepark"></a>Picturepark のアプリケーション統合の有効化
...
Picturepark の SSO を構成するには、証明書からサムプリント値を取得する必要があります。  
...
10. **[Claim]** ボックスに **Emailaddress** 属性を設定するには、「**http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**」と入力し、**[保存]** をクリックします。
