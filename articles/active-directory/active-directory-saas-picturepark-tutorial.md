...
### <a name="to-enable-the-application-integration-for-picturepark,-perform-the-following-steps:"></a>Picturepark のアプリケーション統合を有効にするには、次の手順に従います。
...
8. **[Identity provider configuration]** セクションで、次の手順に従います。
   ...
   7. **[Claim]** ボックスに **Emailaddress** 属性を設定するには、「**http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**」と入力します。
...
4. **[Create User]** ダイアログで、次の手順に従います。
   ...
   1. プロビジョニングする有効な Azure Active Directory ユーザーの情報を、**[Email Address]**、**[Password]**、**[Confirm Password]**、**[First Name]**、**[Last Name]**、**[Company]**、**[Country]**、**[ZIP]**、**[City]** の各ボックスに入力します。
   2. **[Language]**を選択します。
   3. **[作成]**をクリックします。
...
### <a name="to-assign-users-to-picturepark,-perform-the-following-steps:"></a>ユーザーを Picturepark に割り当てるには、次の手順に従います。
