...
3.  **[Configure App URL]** (アプリケーション URL の構成) ページの **[Picturepark サインオン URL]** テキストボックスに、"*http://company.picturepark.com*"* というパターンの URL を入力して、*[次へ]* をクリックします。

    ![Configure App URL](./media/active-directory-saas-picturepark-tutorial/IC795060.png "アプリケーション URL の構成")
...
8.  **[Identity provider configuration]** セクションで、次の手順に従います。
    ...
    4.  Azure クラシック ポータルの **[Picturepark でのシングル サインオンの構成]** ダイアログ ページで、**[SAML SSO URL]** の値をコピーし、**[Issuer URI]** テキストボックスに貼り付けます。
