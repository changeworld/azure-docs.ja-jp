...
グループを作成し、メンバーシップに VM MSI を追加したので、次の手順に従って [SQL サーバー用の Azure AD 認証を構成する](~/articles/sql-database/sql-database-aad-authentication-configure.md#provision-an-azure-active-directory-administrator-for-your-azure-sql-server)ことができます。
