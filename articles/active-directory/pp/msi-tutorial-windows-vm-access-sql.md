...
VM に Azure SQL サーバー内のデータベースへのアクセス権を付与できます。  この手順では、既存の SQL サーバーを使用するか、新しいサーバーを作成できます。  Azure ポータルを使用して新しいサーバーとデータベースを作成するには、[Azure SQL のクイック スタート](~/articles/sql-database/sql-database-get-started-portal.md)に従います。 [Azure SQL のドキュメント](~/articles/sql-database/index.yml)に、Azure CLI と Azure PowerShell を使用するクイックスタートも用意されています。
...
グループを作成し、メンバーシップに VM MSI を追加したので、次の手順に従って [SQL サーバー用の Azure AD 認証を構成する](~/articles/sql-database/sql-database-aad-authentication-configure.md#provision-an-azure-active-directory-administrator-for-your-managed-instance)ことができます。
...
- [SQL Database と SQL Data Warehouse でのユニバーサル認証 (MFA 対応の SSMS サポート)](~/articles/sql-database/sql-database-ssms-mfa-authentication.md)
- [SQL Database または SQL Data Warehouse で Azure Active Directory 認証を構成して管理する](~/articles/sql-database/sql-database-aad-authentication-configure.md)
...
- [Azure AD 認証に対する Azure SQL のサポート](~/articles/sql-database/sql-database-aad-authentication.md)に関する記事で詳細を確認します。
- [Azure AD 認証に対する Azure SQL のサポートの構成](~/articles/sql-database/sql-database-aad-authentication-configure.md)に関する記事で詳細を確認します。
