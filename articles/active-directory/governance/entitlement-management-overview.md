...
- Azure portal を使用してリソースへのアクセスを管理する方法に興味がある方は、[Azure portal でリソースへのアクセスを管理するチュートリアル](entitlement-management-access-package-first.md)を参照してください。
- Microsoft Graph を使用してリソースへのアクセスを管理する方法に興味がある方は、[Microsoft Graph でリソースへのアクセスを管理するチュートリアル](/graph/tutorial-access-package-api?toc=/azure/active-directory/governance/toc.json&bc=/azure/active-directory/governance/breadcrumb/toc.json)を参照してください。
