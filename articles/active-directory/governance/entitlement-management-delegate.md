...
> [!NOTE]
> ユーザーがセキュリティ グループまたは Microsoft 365 グループを追加する場合、そのグループをロール割り当て可能にすることはできません。 ユーザーがアクセス パッケージを作成するときにロール割り当て可能なグループを追加する場合、そのユーザーは、ロール割り当て可能なそのグループの所有者でもある必要があります。 詳細については、「[Azure Active Directory でロールを割り当て可能なグループを作成する](../users-groups-roles/roles-groups-create-eligible.md)」を参照してください。
