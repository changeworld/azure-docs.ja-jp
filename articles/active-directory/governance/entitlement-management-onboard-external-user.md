...
アプリケーションやサイトなど、他の種類のリソースへのアクセスを管理するためのアクセス パッケージの作成について学びます。 [チュートリアル:Azure AD エンタイトルメント管理でリソースへのアクセスを管理する](/active-directory/governance/entitlement-management-access-package-first.md)
