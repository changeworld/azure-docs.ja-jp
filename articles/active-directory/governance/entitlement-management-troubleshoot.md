...
* ユーザーがアクセス パッケージへのアクセスを要求する必要がある場合は、アクセス パッケージの**マイ アクセス ポータル リンク**をユーザーが使用していることを確認します。 詳細については、「[Copy My Access portal link (マイ アクセス ポータル リンクのコピー)](entitlement-management-access-package-edit.md#copy-my-access-portal-link)」を参照してください。  外部ユーザーが **myaccess.microsoft.com** にアクセスする場合、自分の組織内で使用可能なアクセス パッケージが表示されます。
