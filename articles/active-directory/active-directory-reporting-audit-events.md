...
ユーザー ライセンスの変更 | ディレクトリでユーザーに割り当てられたライセンスが変更されました。
ユーザーの更新 | ディレクトリでユーザーが更新されました。
ユーザー パスワードの強制変更の設定 | ログイン時にパスワードの変更をユーザーに強制するプロパティが設定されました。
**グループ イベント** |
グループの作成 | ディレクトリにグループが作成されました。
グループの更新 | ディレクトリでグループが更新されました。
...
委任エントリの追加 | ディレクトリに委任エントリが追加されました。
委任エントリの設定 | ディレクトリの委任エントリが更新されました。
委任エントリの削除 | ディレクトリから委任エントリが削除されました。
**ロール イベント** |
