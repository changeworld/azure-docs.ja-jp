<properties
	...
	description="Azure AD では、クラウド内に自分の ID ランドス ケープが作成されます。これは、オンプレミスの ID システムに接続するか、または単独で使用することができます。"
...
Azure AD では、クラウド内に自分の ID ランドス ケープが作成されます。これは、オンプレミスの ID システムに接続するか、または単独で使用することができます。
