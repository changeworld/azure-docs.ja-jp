<properties
	pageTitle="チュートリアル: Azure Active Directory と Predictix Ordering の統合 | Microsoft Azure"
...
# チュートリアル: Azure Active Directory と Predictix Ordering の統合
...
## ギャラリーからの Predictix Ordering の追加
...
このリンクの関係を確立するには、Azure AD の **[ユーザー名]** の値を、Predictix Ordering の **[ユーザー名 (Username)]** の値として割り当てます。
...
5. **[このユーザーに関する情報の入力]** ダイアログ ページで、次の手順を実行します。![Azure AD のテスト ユーザーの作成](./media/active-directory-saas-predictix-ordering-tutorial/create_aaduser_05.png)
...
### Predictix Ordering のテスト ユーザーの作成
