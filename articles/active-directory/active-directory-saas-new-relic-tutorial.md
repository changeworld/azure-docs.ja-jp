...
### <a name="to-enable-the-application-integration-for-new-relic-perform-the-following-steps"></a>New Relic のアプリケーション統合を有効にするには、次の手順に従います。
...
### <a name="to-provision-a-user-account-to-new-relic-perform-the-following-steps"></a>ユーザー アカウントを New Relic にプロビジョニングするには、次の手順に従います。
...
### <a name="to-assign-users-to-new-relic-perform-the-following-steps"></a>ユーザーを New Relic に割り当てるには、次の手順に従います。
