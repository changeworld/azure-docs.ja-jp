...
6. 検索ボックスに、「**GaggleAMP**」と入力します。![Azure AD のテスト ユーザーの作成](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_01.png)
...
1. Azure クラシック ポータルの **GaggleAMP** アプリケーション統合ページで **[シングル サインオンの構成]** をクリックし、**[シングル サインオンの構成]** ダイアログ ボックスを開きます。

	![Configure Single Sign-On][6]

2. **[ユーザーの GaggleAMP へのアクセスを設定してください]** ページで、**[Microsoft Azure AD シングル サインオン]** を選択し、**[次へ]** をクリックします。
...
2. アプリケーションの一覧で **[GaggleAMP]** を選択します。![Azure 一覧](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_50.png)
