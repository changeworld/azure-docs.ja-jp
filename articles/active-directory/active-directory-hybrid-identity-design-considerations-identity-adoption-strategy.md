...
>[AZURE.NOTE]同期オプションの詳細については、「[オンプレミス ID と Azure Active Directory の統合](https://azure.microsoft.com/zh-CN/documentation/articles/active-directory-aadconnect/)」をお読みください。
