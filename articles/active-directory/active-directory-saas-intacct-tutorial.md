...
## <a name="enabling-the-application-integration-for-intacct"></a>Intacct のアプリケーション統合の有効化
このセクションでは、Intacct のアプリケーション統合を有効にする方法について説明します。

### <a name="to-enable-the-application-integration-for-intacct-perform-the-following-steps"></a>Intacct のアプリケーション統合を有効にするには、次の手順を実行します。
...
3. **[追加]** タブをクリックします。
   ...
   ![[追加]](./media/active-directory-saas-intacct-tutorial/IC790042.png "Add")
...
### <a name="to-assign-users-to-intacct-perform-the-following-steps"></a>ユーザーを Intacct に割り当てるには、次の手順を実行します。
