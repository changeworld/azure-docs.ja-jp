...
![MFA ユーザー ポータル](./media/multi-factor-authentication-get-started-portal/portal.png)
...
![MFA Server 構成セットアップ Web サービス SDK](./media/multi-factor-authentication-get-started-portal/sdk.png)
...
![MFA Server ユーザー ポータルの構成](./media/multi-factor-authentication-get-started-portal/config.png)
...
![代表電話番号と予備の電話番号の登録](./media/multi-factor-authentication-get-started-portal/backupphone.png)
