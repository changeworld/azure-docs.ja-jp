...
---
# <a name="choose-the-azure-multifactor-authentication-solution-for-you"></a>ニーズに応じた Azure Multi-Factor Authentication ソリューションを選択する
...
| ユーザーの位置 | クラウドでの Multi-Factor Authentication | Multi-Factor Authentication Server |
| --- |:---:|:---:|
