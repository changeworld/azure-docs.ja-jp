...
>[!NOTE]
>これらの設定は、Azure Portal でパブリック プレビュー中です。 プレビューで Azure Multi-Factor Authentication の設定を管理する方法に関するドキュメントについては、「[Azure Multi-Factor Authentication の設定を構成する](multi-factor-authentication-whats-next.md)」 (パブリック プレビュー) をご覧ください。
