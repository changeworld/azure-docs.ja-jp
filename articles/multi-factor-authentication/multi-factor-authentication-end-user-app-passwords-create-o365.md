...
# Azure Multi-Factor Authentication のアプリ パスワードを Office 365 ポータルで作成する

Office 365 で多要素認証を使用している場合は、Office 365 ポータルでアプリ パスワードを作成します。
...
<li>左側の [追加のセキュリティ確認] をクリックします</li>
