...
## [セキュリティ ガイダンス](../active-directory/authentication/multi-factor-authentication-security-best-practices.md)
...
## Azure MFA
### [クラウドベースの MFA をデプロイする](../active-directory/authentication/howto-mfa-getstarted.md)
...
### ディレクトリ フェデレーション
#### [Windows Server 2016 AD FS アダプター](https://docs.microsoft.com/windows-server/identity/ad-fs/operations/configure-ad-fs-and-azure-mfa)
...
## MFA サーバー
### [オンプレミスでの MFA のデプロイ](../active-directory/authentication/howto-mfaserver-deploy.md)
...
## [MFA ユーザー ガイド](../active-directory/authentication/end-user/current/multi-factor-authentication-end-user.md)
