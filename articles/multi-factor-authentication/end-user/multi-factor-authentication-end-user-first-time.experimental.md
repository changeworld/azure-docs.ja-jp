...
社内のサポートが 2 段階認証の使用を開始するように要求する場合、**管理者がこのアカウントに追加のセキュリティ認証を設定するよう要求している**ことを伝える画面が表示されます。
...
10. この時点で、Outlook 2010 以降や Apple デバイスのネイティブのメール アプリなどの非ブラウザー アプリのアプリ パスワードの設定が求められます。 この動作は、一部のアプリで 2 段階認証がサポートされていないためです。 これらのアプリを使用しない場合は、**[完了]** をクリックして残りの手順をスキップします。
...
5. この時点で、Outlook 2010 以降や Apple デバイスのネイティブのメール アプリなどの非ブラウザー アプリのアプリ パスワードの設定が求められます。 この動作は、一部のアプリで 2 段階認証がサポートされていないためです。 これらのアプリを使用しない場合は、**[完了]** をクリックして残りの手順をスキップします。
...
4. この時点で、Outlook 2010 以降や Apple デバイスのネイティブのメール アプリなどの非ブラウザー アプリのアプリ パスワードの設定が求められます。 この動作は、一部のアプリで 2 段階認証がサポートされていないためです。 これらのアプリを使用しない場合は、**[完了]** をクリックして残りの手順をスキップします。
