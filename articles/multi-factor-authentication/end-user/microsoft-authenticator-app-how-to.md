...
3. Microsoft Authenticator アプリを開きます。 **[アカウント]** 画面で、**+** を選択し、職場または学校のアカウントの追加を指定します。
    ...
    ![アカウント画面と正符号](./media/authenticator-app-how-to/addaccount3.png)

    ![会社または学校のアカウントを指定する画面](./media/authenticator-app-how-to/scan.png)
...
5. アカウントがアクティブ化されるまで待ちます。 アクティブ化が完了したら、 **[連絡してください]**を選択します。  これによって、通知コードまたは認証コードが電話に送信されます。  **[認証]**を選択します。
    ...
    ![[認証] を選択してサインインする画面](./media/authenticator-app-how-to/verify.png)
...
5. アプリの適切なボックスにコードと URL を入力します。
    ...
    ![コードと URL を入力する画面](./media/authenticator-app-how-to/addaccount2.png)
...
![[削除] ボタン](./media/authenticator-app-how-to/remove.png)
