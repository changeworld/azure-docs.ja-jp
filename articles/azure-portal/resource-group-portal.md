...
このトピックでは、Azure ポータル内でリソース グループを使用する方法を概説します。現時点では、すべてのサービスでポータルまたはリソース マネージャーがサポートされているわけではありません。それらがサポートされていないサービスの場合、[クラシック ポータル](https://manage.windowsazure.com)を使用する必要があります。各サービスの状態については、「[Azure ポータルで利用できるサービスの表](https://azure.microsoft.com/features/azure-portal/availability/)」を参照してください。
...
ポータルを使用してカスタマイズされたテンプレートをデプロイするには、**[新規]**、**[Marketplace]**、**[すべて]** の順に選択します。
