<properties 
	pageTitle="Azure プレビュー ポータルを使用した Azure リソースの管理 | Microsoft Azure" 
...
従来、Microsoft Azure 内のリソース (データベース サーバー、データベース、または Web アプリ) を管理するには、一度に 1 つのリソースに対してのみ操作を実行する必要がありました。複数のリソースで構成されている複雑なアプリケーションの場合、アプリケーション インフラストラクチャへの変更を手動で調整する必要がありました。Azure プレビュー ポータルを使用すると、Azure リソース マネージャーを使用してリソース グループを作成し、アプリケーション内のすべてのリソースをまとめてデプロイして管理することができます。
...
**[すべて参照]** と **[リソース グループ]** をクリックして、すべてのリソース グループを参照できます。
...
リソース グループやリソースにタグを適用して、アセットを論理的に整理できます。プレビュー ポータルを使用してタグを処理する方法の詳細については、「[タグを使用した Azure リソースの整理](../resource-group-using-tags.md)」をご覧ください。
...
プレビュー ポータルを使用してカスタマイズされたテンプレートをデプロイするには、**[新規]**、**[Marketplace]**、**[すべて]** の順に選択します。

![テンプレートのデプロイの検出](./media/resource-group-portal/launch-template.png)

**[テンプレートのデプロイ]** を検索し、返されたリストからそれを選択します。
