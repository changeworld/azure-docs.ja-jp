...
Azure PowerShell の最新バージョンをまだインストールしていない場合は、「[Azure PowerShell のインストールおよび構成](../powershell-install-configure.md)」を参照してください。Azure PowerShell コンソールを開きます。
...
- [Microsoft Azure ポータルでのロールベースのアクセス制御](../role-based-access-control-configure.md)
