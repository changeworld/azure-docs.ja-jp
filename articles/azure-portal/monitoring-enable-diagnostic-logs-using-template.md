...
> [!WARNING]
> この最後の手順は理解するのが難しい場合があります。診断構成スキーマを、正しくエスケープされ、書式設定された変数に分割する例については、[こちらの記事](../virtual-machines/virtual-machines-windows-extensions-diagnostics-template.md#diagnostics-configuration-variables)をご覧ください。
> 
> 
