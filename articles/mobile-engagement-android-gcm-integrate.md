...
#GCM を Engagement に統合する方法

> [AZURE.IMPORTANT] このガイドに従う前に、Android で Engagement を統合する方法に関するドキュメントに記載されている統合手順に従う必要があります。
>
...
なお、Engagement では、[Send-to-Sync] メッセージのみを  `engagement.tickle` 短縮キーと共に使います。
...
このドキュメントの作成時点 (2014 年 2 月 5 日) では、次の手順に従うことができます。[<http://developer.android.com/guide/google/gcm/gs.html>].
...
ここで、Android での Engagement の統合をテストする方法に関する記事を読んで、統合を確認してください。
