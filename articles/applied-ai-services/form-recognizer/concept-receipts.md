...
Azure Form Recognizer を使用すると、事前構築済みのレシート モデルを使用して、販売レシートから情報を分析して抽出できます。 強力な[光学式文字認識 (OCR)](../../cognitive-services/computer-vision/overview-ocr.md) 機能とディープ ラーニング モデルを組み合わせて、英語で書かれたレシートから、マーチャント名、マーチャントの電話番号、取引日、取引合計などの重要な情報を抽出します。
...
> [レシート モデルを試す](https://aka.ms/fott-2.1-ga "レシートからデータを抽出するための事前構築済みモデルを使用して開始します。")
...
* **事前構築済みレシート v2.1** では、**en-au**、**en-ca**、**en-gb**、**en-in**、および **en-us** の英語ロケールのレシートがサポートされています
...
## <a name="analyze-receipt"></a>レシートの分析
