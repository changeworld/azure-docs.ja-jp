...
> [身分証明書モデルを試す](https://aka.ms/fott-2.1-ga "事前構築済みモデルから始めて身分証明書からデータを抽出します。")
...
## <a name="get-analyze-id-document-result"></a>身分証明書の分析結果の取得
