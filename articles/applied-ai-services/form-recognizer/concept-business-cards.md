...
> [ビジネス カード モデルを試す](https://aka.ms/fott-2.1-ga "事前構築済みモデルから始めて名刺からデータを抽出する")
...
![サンプル ラベル付けツールからの Contoso 項目別画像と JSON 出力](./media/business-card-example.jpg)
...
## <a name="analyze-business-card"></a>名刺を分析する
