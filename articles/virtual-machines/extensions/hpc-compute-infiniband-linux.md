...
OFED ドライバーの手動インストール手順については、[こちら](https://docs.microsoft.com/azure/virtual-machines/workloads/hpc/enable-infiniband#manually-install-mellanox-ofed)をご覧ください。
