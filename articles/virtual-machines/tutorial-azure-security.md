---
title: チュートリアル - Azure で VM に Azure Security Center を使用する
description: このチュートリアルでは、Azure 内の仮想マシンをセキュリティで保護する際に役立つ Azure Security Center の機能について説明します。
author: cynthn
manager: gwallace
...
ms.locfileid: "94594826"
---
# <a name="tutorial-use-azure-security-center-to-monitor-virtual-machines"></a>チュートリアル:Azure Security Center を使用して仮想マシンを監視する
