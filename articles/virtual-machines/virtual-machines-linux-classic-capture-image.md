...
[Resource Manager モデルを使用してこれらの手順を実行する](virtual-machines-linux-capture-image.md)方法について説明します。
...
Azure では、イメージは **[イメージ]** に格納されます。アップロードしたすべてのイメージがこの場所に格納されます。イメージの詳細については、「[Azure の仮想マシン イメージについて][Azure の仮想マシン イメージについて]」を参照してください。
