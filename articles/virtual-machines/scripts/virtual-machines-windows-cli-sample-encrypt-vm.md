---
title: "Azure CLI のサンプル スクリプト - Windows VM の暗号化 | Microsoft Docs"
...
[!code-azurecli-interactive[メイン](../../../cli_scripts/virtual-machine/encrypt-disks/encrypt_windows_vm.sh "VM ディスクの暗号化")]
