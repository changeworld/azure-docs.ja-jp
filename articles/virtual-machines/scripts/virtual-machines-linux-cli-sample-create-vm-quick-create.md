---
title: "Azure CLI のサンプル スクリプト - Linux VM の簡易作成 | Microsoft Docs"
...
[!code-azurecli-interactive[main](../../../cli_scripts/virtual-machine/create-vm-quick/create-vm-quick.sh "VM の簡易作成")]
