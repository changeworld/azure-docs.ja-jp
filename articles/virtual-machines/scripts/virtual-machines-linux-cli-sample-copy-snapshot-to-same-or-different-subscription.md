...
[!code-azurecli[メイン](../../../cli_scripts/virtual-machine/copy-snapshot-to-same-or-different-subscription/copy-snapshot-to-same-or-different-subscription.sh "スナップショットのコピー")]
