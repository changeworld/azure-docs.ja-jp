---
title: マネージド ディスクを OS ディスクとして接続して VM を作成する (Linux) - PowerShell
...
ms.locfileid: "89077523"
---
# <a name="create-a-virtual-machine-using-an-existing-managed-os-disk-with-powershell-linux"></a>PowerShell で既存のマネージド OS ディスクを使用して仮想マシンを作成する (Linux)
