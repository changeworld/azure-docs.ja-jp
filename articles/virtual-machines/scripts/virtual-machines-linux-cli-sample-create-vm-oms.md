...
| [azure vm extension set](/cli/azure/vm/extension) | 仮想マシンに対して VM 拡張機能を実行します。 このサンプルでは、Azure Monitor エージェント拡張機能を使用して、Log Analytics エージェントをインストールし Log Analytics ワークスペースに VM を登録します。 |
