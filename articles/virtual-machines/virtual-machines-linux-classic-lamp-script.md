...
Resource Manager モデルを使用した LAMP スタックのデプロイ方法については、[こちら](virtual-machines-linux-create-lamp-stack.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)をご覧ください。
...
Azure での Linux VM の作成については、「[Linux を実行する仮想マシンの作成](virtual-machines-linux-classic-createportal.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)」をご覧ください。
