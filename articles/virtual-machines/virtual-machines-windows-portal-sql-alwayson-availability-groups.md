...
1.   **[ad-primary-dc]** click **[接続]**してください。 リモート接続オブジェクトを開くか保存するか、ブラウザーによって求められます。 **[開く]**をクリックします。
