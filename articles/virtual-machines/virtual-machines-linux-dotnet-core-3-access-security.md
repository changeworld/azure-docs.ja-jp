<properties
   pageTitle="Azure Resource Manager テンプレートでのアクセスとセキュリティ | Microsoft Azure" 
...
# Azure Resource Manager テンプレートでのアクセスとセキュリティ
...
ネットワーク セキュリティ グループについて詳しくは、[ネットワーク セキュリティ グループ](https://azure.microsoft.com/documentation/articles/virtual-networks-nsg/)に関するページをご覧ください。
