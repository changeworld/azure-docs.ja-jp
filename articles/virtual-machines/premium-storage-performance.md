...
>
> * Linux の場合:[Azure Disk Storage 上のアプリケーションのベンチマーク](./disks-benchmarks.md)
> * Windows の場合:[ディスクのベンチマーク](./disks-benchmarks.md)
>
...
VM のサイズと、各種 VM で利用できる IOPS、スループット、待機時間に関する詳細については、「[Azure の仮想マシンのサイズ](sizes.md)」を参照してください。
