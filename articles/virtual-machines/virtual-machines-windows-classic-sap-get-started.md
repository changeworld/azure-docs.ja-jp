<properties
   pageTitle="Windows 仮想マシンにおける SAP の使用 | Microsoft Azure"
...
# Azure での Windows 仮想マシンにおける SAP の使用
