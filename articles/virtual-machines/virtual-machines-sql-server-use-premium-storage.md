<properties
	pageTitle="SQL Server で Azure Premium Storage を使用する | Microsoft Azure"
...
### カスタム イメージで Premium Storage を使用する新しい VM の作成
...
- Virtual Network 名 (VNN) – これは、AlwaysOn 経由で SQL Server に接続するときにクライアントが接続する DNS 名です。
...
- [仮想マシン](https://azure.microsoft.com/services/virtual-machines/)
