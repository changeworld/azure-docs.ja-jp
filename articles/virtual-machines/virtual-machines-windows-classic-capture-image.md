...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)]リソース マネージャー モデルについては、「[Create a copy Windows VM running in Azure](virtual-machines-windows-vhd-copy.md)」 (Azure で実行されている Windows VM のコピーを作成する) を参照してください。
