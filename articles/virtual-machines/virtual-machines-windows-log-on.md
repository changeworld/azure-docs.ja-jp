<properties
	...
	description="Azure ポータルを使用し、リソース マネージャー デプロイ モデルで作成された Windows 仮想マシンにログオンします。"
...
接続時に問題が発生した場合、[Windows ベースの Azure Virtual Machine へのリモート デスクトップ接続に関するトラブルシューティング](virtual-machines-windows-troubleshoot-rdp-connection.md)に関するページを参照してください。
