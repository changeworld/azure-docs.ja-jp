...
> [!IMPORTANT]
> Azure には、リソースの作成と操作に関して、[Azure Resource Manager](../azure-resource-manager/resource-manager-deployment-model.md) とクラシックの&2; 種類のデプロイメント モデルがあります。 この記事では、クラシック デプロイ モデルの使用方法について説明します。 最新のデプロイでは、リソース マネージャー モデルを使用することをお勧めします。 Resource Manager モデルを使用した Linux VM の最適化については、「[Azure での Linux VM の最適化](virtual-machines-linux-optimization.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)」を参照してください。
...
### <a name="a-nameappendixaaappendix-a"></a><a name="AppendixA"></a>付録 A  
...
### <a name="a-nameappendixbaappendix-b"></a><a name="AppendixB"></a>付録 B  
...
### <a name="a-nameappendixcaappendix-c"></a><a name="AppendixC"></a>付録 C   
...
### <a name="a-nameappendixdaappendix-d"></a><a name="AppendixD"></a>付録 D  
