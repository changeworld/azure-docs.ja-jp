...
リソース マネージャーのデプロイ モデルを使用して作成される仮想マシンについては、Azure プレビュー ポータルの Azure Marketplace の「[SharePoint 2013 non-HA Farm (SharePoint 2013 の非高可用性ファーム)](https://azure.microsoft.com/marketplace/partners/sharepoint2013/sharepoint2013farmsharepoint2013-nonha/)」項目を参照してください。これは、インターネットに接続された SharePoint Web サイトの基本的な開発/テスト ファームを作成します。
...
クラシック デプロイメント モデルで同様の構成を作成するには、Azure プレビュー ポータルの Azure Marketplace の「[SharePoint Server Farm (SharePoint サーバー ファーム)](virtual-machines-sharepoint-farm-azure-preview.md)」項目を使用します。


## 高可用性 SharePoint 開発/テスト ファーム

リソース マネージャーのデプロイ モデルを使用して作成される仮想マシンについては、Azure プレビュー ポータルの Azure Marketplace の「[SharePoint 2013 HA Farm (SharePoint 2013 の高可用性ファーム)](https://azure.microsoft.com/marketplace/partners/sharepoint2013/sharepoint2013farmsharepoint2013-ha/)」項目を参照してください。これは、インターネットに接続された SharePoint Web サイトの高可用性ファームを作成します。
