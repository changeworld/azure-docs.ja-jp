<properties
	pageTitle="Azure プレビュー ポータルでデータ ディスクを接続する方法"
	description="Azure プレビュー ポータルで新規および既存のデータ ディスクを接続する方法 | Microsoft Azure"
...
6.	Azure で仮想マシンにディスクが接続されると、**[データ ディスク]** に仮想マシンのディスク設定に表示されます。
