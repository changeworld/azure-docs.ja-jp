...
Azure 内の SQL Server データベースの障害回復ソリューションを実現するには、AlwaysOn 可用性グループ、データベース ミラーリング、またはストレージ BLOB によるバックアップと復元を使用します。
...
ハイブリッド IT 環境内の SQL Server データベースの障害回復ソリューションを実現するには、AlwaysOn 可用性グループ、データベース ミラーリング、ログ配布、および Azure BLOB ストレージによるバックアップと復元を使用します。
