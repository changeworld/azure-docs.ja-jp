<properties
    pageTitle="Windows VM の可用性管理 | Microsoft Azure"
...
クラシック デプロイメント モデルを使用しているときに、可用性セットを作成および使用する方法については、 [可用性セットの構成方法](virtual-machines-windows-classic-configure-availability.md)に関するページをご覧ください。
