...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>Azure Virtual Machines 上の SAP NetWeaver – DBMS デプロイ ガイド
...
* Azure でのバックアップと SAP に関するサード パーティ ツールの詳細については、[SAP のバックアップに関するガイド](sap-hana-backup-guide.md)をご覧ください。
...
このドキュメントの「[ソフトウェア RAID][dbms-guide-2.2]」で説明した LVM (論理ボリューム マネージャー) または MDADM を使用して、マウントされた複数の VHD ディスク上で 1 つの大きな論理デバイスを作成することもできます。
