...
> [!IMPORTANT]
>SAP HANA ファイルシステムの /data、/log、および /shared の 3 つを既定またはルート ボリューム グループに配置することはできません。  通常は、/data、/log、および /shared 用に個々のボリューム グループを作成するという Linux ベンダーのガイダンスに従うことを強くお勧めします。
