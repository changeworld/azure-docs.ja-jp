...
2.  ネットワークの種類に基づいて設定を選択します。 詳細については、次のリソースを参照してください。
    ...
    * [クラウドのみのデプロイ][planning-guide-2.1]:DNS サーバーとして機能する別の仮想マシンを同じ Virtual Network インスタンスにデプロイします。 DNS サービスを実行するように設定した Azure Virtual Machines の IP アドレスを追加します。
