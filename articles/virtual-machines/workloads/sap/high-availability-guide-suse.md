---
title: SLES 上の SAP NetWeaver に対する Azure VM の高可用性 | Microsoft Docs
...
1. ロード バランサー (内部、標準) を作成します。  
   ...
   1. 負荷分散規則
      1. ASCS の負荷分散規則
         ...
         1. 前の手順で作成したフロントエンド IP アドレス、バックエンド プール、正常性プローブを選択します (例: **nw1-ascs-frontend**、**nw1-ascs-backend**、および **nw1-ascs-hp**)
         1. **[HA ポート]** を選択します
