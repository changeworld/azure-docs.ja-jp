...
## <a name="viewing-images-available-in-azure"></a>Azure で使用できるイメージの表示
...
### <a name="update-services-for-sap-e4s"></a>SAP 用更新サービス (E4S)
...
* RHEL-SAP-HA (HA および更新サービスを備えた RHEL for SAP)
