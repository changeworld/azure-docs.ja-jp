---
title: Azure ソリューションでの Oracle WebLogic Server
...
ms.locfileid: "90069725"
---
# <a name="solutions-for-running-oracle-weblogic-server-on-azure"></a>Azure で Oracle WebLogic Server を実行するためのソリューション
