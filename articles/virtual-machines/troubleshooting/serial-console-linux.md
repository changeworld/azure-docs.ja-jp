...
* Linux ディストリビューションに固有の設定については、「[Linux 用シリアル コンソールへのアクセス](#Serial-Console-Linux-distro-availability)」を参照してください。
...
A. シリアル コンソールのアクセスに関して、おそらく、イメージが間違って構成されています。 シリアル コンソールを有効にするようにイメージを構成する方法については、[Linux 用シリアル コンソールへのアクセス](#Access-Serial-Console-for-Linux)に関するセクションを参照してください。
