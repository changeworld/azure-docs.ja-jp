...
1. [ここ](https://go.microsoft.comfwlink/?linkid=394789&clcid=0x409)からエージェント インストール パッケージの最新バーションをダウンロードしてインストールします。 インストールを実行するには、管理者権限が必要です。
