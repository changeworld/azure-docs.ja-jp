...
[Win32_TSGeneralSetting クラスの SetEncryptionLevel メソッド](/windows/desktop/termserv/win32-tsgeneralsetting-setencryptionlevel)

[サーバー認証と暗号化レベルの構成](/previous-versions/windows/it-pro/windows-server-2008-r2-and-2008/cc770833(v=ws.11))

[Win32_TSGeneralSetting クラス](/windows/desktop/termserv/win32-tsgeneralsetting)
