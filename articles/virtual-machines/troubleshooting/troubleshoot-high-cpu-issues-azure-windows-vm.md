...
Azure Monitor を使用して Azure VM を管理する方法の詳細については、「[Azure Monitor を使用して Azure 仮想マシンを監視する](../../azure-monitor/vm/monitor-vm-azure.md)」を参照してください。
