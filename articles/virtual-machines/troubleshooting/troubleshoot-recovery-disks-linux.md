...
手順 1、2、3、4、6、7 は、VM 修復コマンドを使用して自動化できます。 その他のドキュメントと手順については、「[Azure 仮想マシンの修復コマンドを使用して Linux VM を修復する](repair-linux-vm-using-azure-virtual-machine-repair-commands.md)」を参照してください。
