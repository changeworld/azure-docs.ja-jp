...
1. PowerShell インスタンスで、[NETSTAT](/windows-server/administration/windows-commands/netstat) を使用してポート 8080 が他のアプリケーションによって使用されているかどうかを確認します。
