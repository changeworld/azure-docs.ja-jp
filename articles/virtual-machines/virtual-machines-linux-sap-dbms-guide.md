...
#### 高可用性
[コメント]: <> (リンクは ASM を参照) 高可用性と障害復旧を目的として Oracle Data Guard がサポートされています。詳しくは、[この][virtual-machines-configuring-oracle-data-guard]ドキュメントをご覧ください。
