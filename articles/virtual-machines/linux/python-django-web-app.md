...
![Azure で Hello World ページを表示するブラウザー ウィンドウ](./media/python-django-web-app/mac-linux-django-helloworld-browser.png)
...
1. [ここ](quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) に記載されている手順に従って、*Ubuntu Server 14.04 LTS* ディストリビューションの Azure 仮想マシンを作成します。  必要に応じて、SSH 公開キーではなくパスワード認証を選択できます。
...
3. 既定では、新しい仮想マシンに完全修飾ドメイン名 (FQDN) は含まれていません。  [ここ](../windows/portal-create-fqdn.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)にある手順に従って、作成することができます。  この手順を省略しても、このチュートリアルを完了できます。
