---
title: Azure Linux VM のコンピューティング ベンチマーク スコア | Microsoft Docs
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - メモリ最適化 + Premium Storage (分離)
