...
## <a name="a0-7-standard-general-compute"></a>A0-7 標準一般コンピューティング
...
## <a name="d---general-compute"></a>D - 一般コンピューティング
...
## <a name="ds---storage-optimized"></a>DS - ストレージ最適化
