...
![パブリック IP アドレス](./media/dotnet-core-3-access-security/pubip.png)
...
![ネットワーク セキュリティ グループ](./media/dotnet-core-3-access-security/nsg.png)
...
[手順 3 - Azure Resource Manager テンプレートでの可用性とスケール](dotnet-core-4-availability-scale.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
