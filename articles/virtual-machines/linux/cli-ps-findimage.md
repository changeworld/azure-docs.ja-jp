...
これで、使用するイメージを正確に選択できます。 検索した URN 情報を使って仮想マシンをすぐに作成する、または URN 情報のテンプレートを使用するには、[Azure CLI を使用した Linux VM の作成](quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)に関するページをご覧ください。
