...
* [開発用とテスト用の Linux VM を Azure CLI から作成する](quick-create-cli-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [Azure テンプレートを使用して安全な Linux VM を作成する](create-ssh-secured-vm-from-template.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
  ...
  * 次の例では、GitHub に格納されているテンプレートを使用して VM を作成します。
    ...
    ```
* [Azure CLI を使用して、完全な Linux 環境を作成する](create-cli-complete-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [カスタム ディスク イメージをアップロードして Linux VM を作成する](upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
