...
![仮想マシン](./media/dotnet-core-2-architecture/vm.png)
...
![ストレージ アカウント](./media/dotnet-core-2-architecture/storacct.png)
...
![仮想ネットワーク](./media/dotnet-core-2-architecture/vnet.png)
...
![ネットワーク インターフェイス](./media/dotnet-core-2-architecture/nic.png)
...
[手順 2 - Azure Resource Manager テンプレートでのアクセスとセキュリティ](dotnet-core-3-access-security.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
