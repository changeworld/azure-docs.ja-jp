...
![可用性セット](./media/dotnet-core-4-availability-scale/aset.png)

可用性セットについて詳しくは、「 [仮想マシンの可用性管理](manage-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)」をご覧ください。 
...
![ネットワーク ロード バランサー](./media/dotnet-core-4-availability-scale/nlb.png)
...
[手順 4 - Azure Resource Manager テンプレートを使ったアプリケーションのデプロイ](dotnet-core-5-app-deployment.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
