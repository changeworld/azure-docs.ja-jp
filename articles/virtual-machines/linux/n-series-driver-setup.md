...
N シリーズ Linux VM は、Azure Marketplace からの次のディストリビューションとリストされている NVIDIA ドライバーをサポートします。


| VM シリーズ | サポートされているディストリビューション | サポートされているドライバー |
| --- | --- | --- |
| **NC** (Tesla K80 カード) | Ubuntu 16.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3<br/><br/> CentOS-based 7.3 | NVIDIA CUDA 8.0、ドライバー ブランチ R375<br/>[インストール手順](#install-cuda-drivers-for-nc-vms) |
| **NV** (Tesla M60 カード)| Ubuntu 16.04 LTS<br/><br/>Red Hat Enterprise Linux 7.3<br/><br/>CentOS-based 7.3 | NVIDIA GRID 4.2、ドライバー ブランチ R367<br/>[インストール手順](#install-grid-drivers-for-nv-vms) |
