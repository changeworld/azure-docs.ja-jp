...
- [Azure CLI 2.0](create-lamp-stack.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) - Resource Manager デプロイ モデル用の次世代 CLI
...
Linux VM の作成についてサポートが必要な場合は、Linux VM を作成する方法を[こちら](quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)に移動して確認します。 次に、Linux VM に SSH 接続する必要があります。 SSH キーの作成についてサポートが必要な場合は、Linux または Mac で SSH キーを作成する方法を[こちら](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)で確認します。
