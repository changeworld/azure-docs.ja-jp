---
title: Azure Linux 仮想マシンでの接続された VHD のトラブルシューティング | Microsoft Docs
description: Linux VM が予期せず再起動する、接続された VHD を含むストレージ アカウントの削除でエラーが発生する、などの問題のトラブルシューティングを行う方法。
...
ms.locfileid: "30289754"
---
# <a name="troubleshoot-attached-vhds-on-azure-linux-virtual-machines"></a>Azure Linux 仮想マシンでの接続された VHD のトラブルシューティング
