...
監視メトリックの構成の詳細とサンプルについては、「[Linux の診断拡張機能を使用した Linux VM のパフォーマンスと診断データの監視](classic/diagnostic-extension.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)」を参照してください。
