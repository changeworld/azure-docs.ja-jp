...
これらの手順は、[Azure CLI 1.0](deploy-linux-vm-into-existing-vnet-using-cli-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) を使用して実行することもできます。
...
[az vm create](/cli/azure/vm#create) を使用して VM を作成します。 完全な VM をデプロイするために Azure CLI 2.0 で使用するフラグの詳細については、「[Azure CLI を使用して、完全な Linux 環境を作成する](create-cli-complete.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)」をご覧ください。
