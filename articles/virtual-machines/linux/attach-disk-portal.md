...
ディスクを追加した後、使用できるように準備する必要があります。 詳細については、「[方法: Linux での新しいデータ ディスクの初期化](add-disk.md)」を参照してください。
