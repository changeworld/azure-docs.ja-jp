...
![仮想マシン](./media/virtual-machines-windows-dotnet-core/vm-win.png)
...
![ストレージ アカウント](./media/virtual-machines-windows-dotnet-core/storacct-win.png)
...
![仮想ネットワーク](./media/virtual-machines-windows-dotnet-core/vnet-win.png)
...
![ネットワーク インターフェイス](./media/virtual-machines-windows-dotnet-core/nic-win.png)
