...
Azure Marketplace で既に提供されていたさまざまな種類に加え、[Azure PowerShell](../powershell-install-configure.md) または [Azure CLI](../xplat-cli.md) を通してデプロイされた Azure リソース マネージャー テンプレートを使用して、Ubuntu VM 上に新しい MongoDB クラスターを簡単にデプロイすることも可能になりました。
