...
移行プロセスの完了後、新しいリソース グループに新しいリソースが作成されたことが次のスクリーン ショットで示されています。 ![準備後の Resource Manager](./media/virtual-machines-windows-migration-classic-resource-manager/resourcemanager-migration-prepare-portal.png)
