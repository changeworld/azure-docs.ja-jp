<properties 
	pageTitle="Azure リソース マネージャーのテンプレートを使用した可用性の高い Active Directory ドメインのデプロイ" 
	description="リソース マネージャー テンプレート、Azure プレビュー ポータル、Azure PowerShell、または Azure CLI を使用して Active Directory ドメイン コントローラーとして機能する 2 つのサーバーをすばやくデプロイする" 
...
# Azure リソース マネージャーのテンプレートを使用した可用性の高い Active Directory ドメインのデプロイ
