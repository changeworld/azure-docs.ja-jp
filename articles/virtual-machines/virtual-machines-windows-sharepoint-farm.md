...
これらのファームのサーバーはリモート デスクトップ接続を通じて管理できます。 詳細については、「[仮想マシンへのログオン](virtual-machines-windows-hero-tutorial.md#connect-to-the-virtual-machine-and-sign-on)」をご覧ください。
