<properties
   pageTitle="Azure VM 拡張機能のエラーのトラブルシューティング"
...
拡張機能を使用するためのテンプレートの作成の詳細については、記事「[Authoring Extension Templates (拡張機能テンプレートの作)](virtual-machines-extensions-authoring-templates.md)」を参照してください。
