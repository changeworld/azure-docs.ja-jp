---
title: "cloud-init を利用し、作成時に Linux VM をカスタマイズする | Microsoft Docs"
...
---
# <a name="using-cloud-init-to-customize-a-linux-vm-during-creation"></a>cloud-init を利用し、作成時に Linux VM をカスタマイズする
