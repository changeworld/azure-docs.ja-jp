...
>[AZURE.NOTE]関連する Azure の制限については、「[Azure サブスクリプションとサービスの制限、クォータ、制約](../azure-subscription-service-limits.md)」を参照してください。
...
*   オリジナルの D シリーズに続く Dv2 シリーズには、より強力な CPU が備わっています。Dv2 シリーズの CPU は D シリーズの CPU よりも、およそ 35% 高速です。これは最新世代の 2.4 GHz Intel Xeon® E5-2673 v3 (Haswell) プロセッサに基づいており、Intel Turbo Boost Technology 2.0 を使用することで、最大 3.2 GHz まで実現できます。Dv2 シリーズのメモリ構成とディスク構成は D シリーズと同じです。
    ...
    Dv2 シリーズのリージョン別の提供状況は、2015 年 10 月に米国東部 2、米国中部、米国中北部、米国西部、2015 年 11 月に米国東部、北ヨーロッパ、西ヨーロッパ、2016 年 1 月に米国中南部、アジア太平洋東部、アジア太平洋南東部、西日本、東日本、オーストラリア東部、オーストラリア南東部、ブラジル南部というスケジュールに基づいています。
...
|サイズ - Azure クラシック ポータル\\コマンドレットと API|CPU コア数|メモリ|NIC (最大)|最大ディスク サイズ – 仮想マシン|最大データ ディスク数 (各ディスク 1,023 GB)|最大IOPS (各ディスク 300)|
|---|---|---|---|---|---|---|
|A0\\Basic\_A0|1|768 MB|1|<p>OS = 1,023 GB</p><p>一時ディスク = 20 GB</p>|1|1 x 300|
|A1\\Basic\_A1|1|1\.75 GB|1|<p>OS = 1,023 GB</p><p>一時ディスク = 40 GB</p>|2|2 x 300|
|A2\\Basic\_A2|2|3\.5 GB|1|<p>OS = 1,023 GB</p><p>一時ディスク = 60 GB</p>|4|4 x 300|
...
|サイズ - Azure クラシック ポータル\\コマンドレットと API|CPU コア数|メモリ|NIC (最大)|最大ディスク サイズ – 仮想マシン|最大データ ディスク数 (各ディスク 1,023 GB)|最大IOPS (各ディスク 500)|
|---|---|---|---|---|---|---|
|A0\\ExtraSmall|1|768 MB|1|<p>OS = 1,023 GB</p><p>一時ディスク = 20 GB</p>|1|1 x 500|
|A1\\小|1|1\.75 GB|1|<p>OS = 1,023 GB</p><p>一時ディスク = 70 GB</p>|2|2 x 500|
|A2\\中|2|3\.5 GB|1|<p>OS = 1,023 GB</p><p>一時ディスク = 135 GB</p>|4|4 x 500|
|A3\\大|4|7 GB|2|<p>OS = 1,023 GB</p><p>一時ディスク = 285 GB</p>|8|8 x 500|
|A4\\極大|8|14 GB|4|<p>OS = 1,023 GB</p><p>一時ディスク = 605 GB</p>|16|16 x 500|
|A5\\同|2|14 GB|1|<p>OS = 1,023 GB</p><p>一時ディスク = 135 GB</p>|4|4 x 500|
|A6\\同|4|28 GB|2|<p>OS = 1,023 GB</p><p>一時ディスク = 285 GB</p>|8|8 x 500|
|A7\\同|8|56 GB|4|<p>OS = 1,023 GB</p><p>一時ディスク = 605 GB</p>|16|16 x 500|
|A8\\同|8|56 GB|2|<p><p>OS = 1,023 GB</p><p>一時ディスク = 382 GB</p><blockquote><p>注: このサイズの使用に関する情報と考慮事項については、「<a href="http://go.microsoft.com/fwlink/p/?linkid=328042">A8、A9、A10、A11 コンピューティング集中型インスタンスについて</a>」を参照してください。</p></blockquote>|16|16 x 500|
|A9\\同|16|112 GB|4|<p><p>OS = 1,023 GB</p><p>一時ディスク = 382 GB</p><blockquote><p>注: このサイズの使用に関する情報と考慮事項については、「<a href="http://go.microsoft.com/fwlink/p/?linkid=328042">A8、A9、A10、A11 コンピューティング集中型インスタンスについて</a>」を参照してください。</p></blockquote>|16|16 x 500|
...
|サイズ - Azure クラシック ポータル\\コマンドレットと API|CPU コア数|メモリ|NIC (最大)|最大ディスク サイズ – 仮想マシン|最大データ ディスク数 (各ディスク 1,023 GB)|最大IOPS (各ディスク 500)|
|---|---|---|---|---|---|---|
|Standard\_D1\\同|1|3\.5 GB|1|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 50 GB</p>|2|2 x 500|
|Standard\_D2\\同|2|7 GB|2|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 100 GB</p>|4|4 x 500|
|Standard\_D3\\同|4|14 GB|4|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 200 GB</p>|8|8 x 500|
|Standard\_D4\\同|8|28 GB|8|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 400 GB</p>|16|16 x 500|
|Standard\_D11\\同|2|14 GB|2|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 100 GB</p>|4|4 x 500|
|Standard\_D12\\同|4|28 GB|4|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 200 GB</p>|8|8 x 500|
|Standard\_D13\\同|8|56 GB|8|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 400 GB</p>|16|16 x 500|
|Standard\_D14\\同|16|112 GB|8|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 800 GB</p>|32|32 x 500|

## Standard レベル: Dv2 シリーズ

|サイズ - Azure クラシック ポータル\\コマンドレットと API|CPU コア数|メモリ|NIC (最大)|最大ディスク サイズ – 仮想マシン|最大データ ディスク数 (各ディスク 1,023 GB)|最大IOPS (各ディスク 500)|
|---|---|---|---|---|---|---|
|Standard\_D1\_v2\\同|1|3\.5 GB|1|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 50 GB</p>|2|2 x 500|
|Standard\_D2\_v2\\同|2|7 GB|2|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 100 GB</p>|4|4 x 500|
|Standard\_D3\_v2\\同|4|14 GB|4|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 200 GB</p>|8|8 x 500|
|Standard\_D4\_v2\\同|8|28 GB|8|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 400 GB</p>|16|16 x 500|
|Standard\_D5\_v2\\同|16|56 GB|8|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 800 GB</p>|32|32 x 500|
|Standard\_D11\_v2\\同|2|14 GB|2|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 100 GB</p>|4|4 x 500|
|Standard\_D12\_v2\\同|4|28 GB|4|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 200 GB</p>|8|8 x 500|
|Standard\_D13\_v2\\同|8|56 GB|8|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 400 GB</p>|16|16 x 500|
|Standard\_D14\_v2\\同|16|112 GB|8|<p>OS = 1,023 GB</p><p>一時的 (SSD) = 800 GB</p>|32|32 x 500|

## Standard レベル: DS シリーズ*

|サイズ - Azure クラシック ポータル\\コマンドレットと API|CPU コア数|メモリ|NIC (最大)|最大ディスク サイズ – 仮想マシン|最大データ ディスク数 (各ディスク 1,023 GB)|キャッシュ サイズ (GB)|最大ディスク IOPS および帯域幅|
|---|---|---|---|---|---|---|---|
|Standard\_DS1\\同|1|3\.5|1|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 7 GB</p>|2|43|<p>3,200</p><p>32 MB/秒</p>|
|Standard\_DS2\\同|2|7|2|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 14 GB</p>|4|86|<p>6,400</p><p>64 MB/秒</p>|
|Standard\_DS3\\同|4|14|4|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 28 GB</p>|8|172|<p>12,800</p><p>128 MB/秒</p>|
|Standard\_DS4\\同|8|28|8|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 56 GB</p>|16|344|<p>25,600</p><p>256 MB/秒</p>|
|Standard\_DS11\\同|2|14|2|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 28 GB</p>|4|72|<p>6,400</p><p>64 MB/秒</p>|
|Standard\_DS12\\同|4|28|4|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 56 GB</p>|8|144|<p>12,800</p><p>128 MB/秒</p>|
|Standard\_DS13\\同|8|56|8|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 112 GB</p>|16|288|<p>25,600</p><p>256 MB/秒</p>|
|Standard\_DS14\\同|16|112|8|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 224 GB</p>|32|576|<p>50,000</p><p>512 MB/秒</p>|
...
|サイズ – Azure クラシック ポータル\\コマンドレットと API|CPU コア数|メモリ|NIC (最大)|最大ディスク サイズ – 仮想マシン|最大データ ディスク数 (各ディスク 1,023 GB)|最大IOPS (各ディスク 500)|
|---|---|---|---|---|---|---|
|Standard\_G1\\同|2|28 GB|1|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 384 GB</p>|4|4 x 500|
|Standard\_G2\\同|4|56 GB|2|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 768 GB</p>|8|8 x 500|
|Standard\_G3\\同|8|112 GB|4|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 1,536 GB</p>|16|16 x 500|
|Standard\_G4\\同|16|224 GB|8|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 3,072 GB</p>|32|32 x 500|
|Standard\_G5\\同|32|448 GB|8|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 6,144 GB</p>|64|<p>64 x 500</p>|

## Standard シリーズ: GS シリーズ

|サイズ - Azure クラシック ポータル\\コマンドレットと API|CPU コア数|メモリ|NIC (最大)|最大ディスク サイズ – 仮想マシン|最大データ ディスク数 (各ディスク 1,023 GB)|キャッシュ サイズ (GB)|最大ディスク IOPS および帯域幅|
|---|---|---|---|---|---|---|---|
|Standard\_GS1|2|28|1|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 56 GB</p>|4|264|<p>5,000</p><p>125 MB/秒</p>|
|Standard\_GS2|4|56|2|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 112 GB</p>|8|528|<p>10,000</p><p>250 MB/秒</p>|
|Standard\_GS3|8|112|4|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 224 GB</p>|16|1056|<p>20,000</p><p>500 MB/秒</p>|
|Standard\_GS4|16|224|8|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 448 GB</p>|32|2112|<p>40,000</p><p>1,000 MB/秒</p>|
|Standard\_GS5|32|448|8|<p>OS = 1,023 GB</p><p>ローカル SSD ディスク = 896 GB</p>|64|4224|<p>80,000</p><p>2,000 MB/秒</p>|
