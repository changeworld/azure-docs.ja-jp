...
Azure VM 拡張機能には次のものがあります (サポートする機能別の拡張機能の完全な一覧については、「[Azure VM 拡張機能とその機能](virtual-machines-extensions-features.md)」を参照してください)。 以下を使用して、拡張機能とその詳細情報を見つけることができます。
