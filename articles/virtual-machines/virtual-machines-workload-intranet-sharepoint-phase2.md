...
V、S、ST、Aの各表は、「[フェーズ 1: Azure を構成する](virtual-machines-workload-intranet-sharepoint-phase1.md)」で定義したものです。
...
- [フェーズ 3](virtual-machines-workload-intranet-sharepoint-phase3.md) を使用して、このワークロードを引き続き構成します。
