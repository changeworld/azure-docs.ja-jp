...
仮想マシンは、テンプレートを使ってすばやく作成できます。これらのテンプレートだけでなく、[Azure クイック スタート テンプレート](https://azure.microsoft.com/documentation/templates/)全体を検索できます。
