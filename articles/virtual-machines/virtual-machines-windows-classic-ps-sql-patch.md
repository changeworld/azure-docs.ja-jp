...
![Azure ポータルの SQL 自動修正](./media/virtual-machines-windows-classic-ps-sql-patch/IC778484.jpg)
...
![Azure ポータルの自動修正構成](./media/virtual-machines-windows-classic-ps-sql-patch/IC792132.jpg)
...
Azure の SQL Server VM の関連機能については、「[Azure Virtual Machines での SQL Server の自動バックアップ](virtual-machines-windows-classic-ps-sql-backup.md)」をご覧ください。
