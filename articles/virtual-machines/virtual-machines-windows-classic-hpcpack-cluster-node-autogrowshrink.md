...
>[AZURE.TIP] HPC Pack 2012 R2 更新プログラム 2 より、HPC Pack には Azure バースト ノードまたは Azure VM コンピューティング ノードを自動的に拡大縮小するためのサービスが内蔵されています。[HPC Pack IaaS デプロイ スクリプト](virtual-machines-windows-classic-hpcpack-cluster-powershell-script.md)の設定でサービスを構成するか、**AutoGrowShrink** クラスター プロパティを手動で設定します。「[Microsoft HPC Pack 2012 R2 更新プログラム 2 の新機能](https://technet.microsoft.com/library/mt269417.aspx)」を参照してください。
