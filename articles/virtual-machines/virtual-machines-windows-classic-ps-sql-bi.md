...
1. VM 上の http://localhost/reports を参照します。
...
>[AZURE.NOTE] [Microsoft SQL Server Connect を使用してフィードバックや連絡先情報を送信してください。](https://connect.microsoft.com/SQLServer/Feedback)
