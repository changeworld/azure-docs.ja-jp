---
title: "初めての Windows VM の作成 | Microsoft Docs"
...
---
# <a name="create-your-first-windows-virtual-machine-in-the-azure-portal"></a>Azure ポータルで初めての Windows 仮想マシンを作成する
...
5. [Windows セキュリティ] ウィンドウで、VM の作成時に作成したローカル アカウントのユーザー名とパスワードを入力します。 ユーザー名を *vmname*&#92;*username* の形式で入力し、**[OK]** をクリックします。
...
## <a name="optional-stop-the-vm"></a>省略可能: VM の停止
