...
![Azure ポータルからのプラン ID の詳細](./media/client-images/offer_id_azure_portal.png) 

また、Azure アカウント ポータルの ['サブスクリプション' タブ](http://account.windowsazure.com/Subscriptions) からプラン ID を表示することもできます。

![Azure アカウント ポータルからのプラン ID の詳細](./media/client-images/offer_id_azure_account_portal.png) 
