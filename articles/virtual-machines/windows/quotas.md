...
> [!NOTE]
> クォータは、使用されているコアの合計数に基づいて、割り当て済みと割り当て解除済みの両方で計算されます。 追加のコアが必要な場合は、[クォータの増加を要求する](https://docs.microsoft.com/azure/azure-portal/supportability/resource-manager-core-quotas-request)か、または不要になった VM を削除します。 
