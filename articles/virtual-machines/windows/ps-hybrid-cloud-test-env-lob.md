...
[シミュレートされたハイブリッド クラウド テスト環境](ps-hybrid-cloud-test-env-sim.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)を作成します。 このテスト環境では Corpnet サブネット上に APP1 サーバーを配置する必要がないため、シャットダウンできます。
