---
title: "Azure での Windows VM の計画メンテナンス | Microsoft Docs"
...
---
# <a name="planned-maintenance-for-windows-virtual-machines"></a>Windows 仮想マシンの計画メンテナンス 
...
このページでは、Microsoft Azure による計画メンテナンスの実行について説明しています。 計画外イベント (停止) の詳細については、「[Azure での Windows 仮想マシンの可用性の管理](manage-availability.md)」を参照してください。
