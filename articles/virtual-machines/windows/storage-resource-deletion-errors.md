---
title: Windows VM 上の Azure Resource Manager デプロイのストレージ リソースの削除エラーのトラブルシューティング | Microsoft Docs
...
Azure VM で使用される VHD は .vhd ファイルです。Azure では Standard または Premium Storage アカウントでページ BLOB としてこれらを格納します。 Azure ディスクの詳細については、[Microsoft Azure Windows VM 用のアンマネージドおよびマネージド ディスク ストレージ](about-disks-and-vhds.md)に関する記事を参照してください。 
