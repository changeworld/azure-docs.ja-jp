...
## <a name="a-namecreateclusteracreate-the-cluster"></a><a name="CreateCluster"></a>クラスターを作成する
...
1. 仮想マシンでは、両方の SQL Server を含めます。 ファイル共有監視サーバーは含めないでください。 選択は次の図のようになります。

   ![リソース グループでのロード バランサーの検索](./media/virtual-machines-windows-portal-sql-availability-group-tutorial/88-configurebepool.png)
