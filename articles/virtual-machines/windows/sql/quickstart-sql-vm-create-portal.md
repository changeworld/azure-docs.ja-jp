...
1. **[インスタンスの詳細]** で、以下の操作を行います。
    ...
    1. **[リージョン]** で場所を選択します。 
    1. このクイック スタートでは、**[可用性オプション]** の設定を _[インフラストラクチャ冗長は必要ありません]_ のままにしておきます。 可用性オプションの詳細については、[Azure のリージョンと可用性](../../windows/regions-and-availability.md)に関するページを参照してください。 
