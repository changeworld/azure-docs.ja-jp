...
| [Azure PowerShell](../virtual-machines-windows-ps-create.md) | [Add-AzureRmVMNetworkInterface](https://docs.microsoft.com/powershell/resourcemanager/azurerm.compute/v1.3.4/Add-AzureRmVMNetworkInterface) を使用して、以前作成した NIC を VM 構成に追加します。 |
