# 概要
## [Azure VM 上の SQL Server とは](../sql/virtual-machines-windows-sql-server-iaas-overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fsqlclassic%2ftoc.json) 
...
## [Azure PowerShell を使用して VM をプロビジョニングする](../classic/ps-sql-create.md)
## [VM に接続する](../classic/sql-connect.md)
...
### [クラシック ポータルでの AlwaysOn 可用性グループの構成](../classic/portal-sql-alwayson-availability-groups.md)
### [PowerShell を使用した AlwaysOn 可用性グループの構成](../classic/ps-sql-alwayson-availability-groups.md)
### [可用性グループ向けの内部リスナーの構成](../classic/ps-sql-int-listener.md)
### [可用性グループ向けの外部リスナーの構成](../classic/ps-sql-ext-listener.md)
### [オンプレミスの可用性グループの Azure への拡張](../classic/sql-onprem-availability.md)
## 管理
### [SQL Server IaaS Agent 拡張機能の使用](../classic/sql-server-agent-extension.md)
### [自動修正](../classic/sql-automated-patching.md)
### [Azure Key Vault 統合の構成](../classic/ps-sql-keyvault.md)
### [Premium Storage の使用](../classic/sql-server-premium-storage.md)
...
### [自動化されたバックアップ](../classic/sql-automated-backup.md)
...
## ビジネス インテリジェンス
### [Azure VM での SQL Server Business Intelligence](../classic/ps-sql-bi.md)
### [Azure でホストされた Web サイトでの ReportViewer の使用](../classic/sql-server-reportviewer.md)
### [レポート サーバーを実行する Azure VM を PowerShell を使用して作成する](../classic/ps-sql-report.md)
