...
# 作業開始
## [Azure Portal を使用して VM を作成する](tutorial-classic.md)
## [VM へのログオン](connect-logon-classic.md)

# 方法
## ストレージの使用
### [データ ディスクの接続](attach-disk-classic.md)
### [データ ディスクの切断](detach-disk-classic.md)

## ネットワーク
### [エンドポイントを設定する方法](setup-endpoints.md)
### [VM を VNet またはクラウド サービスに接続する](connect-vms-classic.md)

## デプロイ
### [カスタム VM の作成](createportal-classic.md)
### [Windows VM をキャプチャする](capture-image-classic.md)
