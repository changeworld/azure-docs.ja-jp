---
title: Azure の Windows VM のサイズ - 汎用 | Microsoft Docs
description: Azure の Windows 仮想マシンで使用できるさまざまな汎用サイズを一覧表示します。 このシリーズのストレージのスループットとネットワーク帯域幅に加え、vCPU、データ ディスク、NIC の数に関する情報を一覧表示します。
