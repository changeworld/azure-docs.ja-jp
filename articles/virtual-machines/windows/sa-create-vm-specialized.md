...
2 つのオプションがあります。
* [VHD をアップロードする](create-vm-specialized.md#option-1-upload-a-specialized-vhd)
* [既存の Azure VM の VHD をコピーする](create-vm-specialized.md#option-2-copy-an-existing-azure-vm)
