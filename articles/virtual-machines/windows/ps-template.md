...
- 「[Resource Manager と PowerShell を使用した Azure Virtual Machines の管理](ps-manage.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)」で、作成した仮想マシンを管理する方法を確認します。
