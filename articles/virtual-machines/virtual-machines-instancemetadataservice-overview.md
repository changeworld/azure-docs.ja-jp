...
リージョン                                        | 可用性
-----------------------------------------------|-----------------------------------------------
[一般公開されている全世界のすべての Azure リージョン](https://azure.microsoft.com/en-us/regions/)     | 一般公開 
[Azure Government](https://azure.microsoft.com/en-us/overview/clouds/government/)              | プレビュー段階 
[Azure China](https://www.azure.cn/)                                                           | プレビュー段階
[Azure Germany](https://azure.microsoft.com/en-us/overview/clouds/germany/)                    | プレビュー段階
...
Instance Metadata Service はバージョン管理されています。 バージョンは必須であり、最新のバージョンは `2017-04-02` です。
...
platformUpdateDomain |  VM を実行中の[更新ドメイン](virtual-machines-windows-manage-availability.md)
platformFaultDomain | VM を実行中の[障害ドメイン](virtual-machines-windows-manage-availability.md)
...
scheduledevents | 現在パブリック プレビュー段階です。[スケジュールされたイベント](virtual-machines-scheduled-events.md)に関するページを参照してください。
...
6. このサービスのサポートを受けるにはどうすればよいですか。
   * サービスのサポートを受けるには、時間がかかる再試行の後もメタデータの応答を取得できない VM を管理する Azure ポータルでサポート問題を作成します。 
   ...
   ![Instance Metadata のサポート](./media/virtual-machines-instancemetadataservice-overview/InstanceMetadata-support.png)
    
## <a name="next-steps"></a>次のステップ

- Instance Metadata Service によって提供される [scheduledevents](virtual-machines-scheduled-events.md) API **(パブリック プレビュー段階)** を参照します。
