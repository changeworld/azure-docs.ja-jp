...
詳細については、「[Azure PowerShell 1.0](https://azure.microsoft.com/ja-JP/blog/azps-1-0/)」を参照してください。

## 手順2. サブスクリプションを設定する

まず PowerShell プロンプトを開始します。
...
[Azure リソース マネージャーにおける Azure Compute、Network、ストレージ プロバイダー](virtual-machines-windows-compare-deployment-models.md)

[Azure リソース マネージャーの概要](../resource-group-overview.md)

[リソース マネージャー テンプレートと PowerShell を使用した Azure Virtual Machines のデプロイと管理](virtual-machines-windows-ps-manage.md)
