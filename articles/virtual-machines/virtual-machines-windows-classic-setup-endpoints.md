...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)]**Resource Manager** デプロイメント モデルでは、エンドポイントは **ネットワーク セキュリティ グループ (NSG)** を使用して構成します。 詳細については、「Azure Portal を使用して VM への外部アクセスを許可する」 (virtual-machines-windows-nsg-quickstart-portal.md) を参照してください。
