...
* 「[Oracle 仮想マシンのイメージに関するその他の考慮事項](virtual-machines-windows-classic-oracle-considerations.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)」の「高可用性と障害復旧に関する考慮」を既に確認していること。 Azure では、スタンドアロンの Oracle Database インスタンスをサポートしていますが、Oracle Real Application Cluster (Oracle RAC) をサポートしていません。
...
[Azure の Oracle 仮想マシン イメージ](virtual-machines-windows-classic-oracle-images.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)
