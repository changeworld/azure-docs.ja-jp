...
オンデマンドのバーストのコマンドレットは、バージョン 2.19.0 以降の [Azure CLI モジュール](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest)で使用できます。 別の方法として、[Azure Cloud Shell](https://shell.azure.com/) を使用することもできます。
