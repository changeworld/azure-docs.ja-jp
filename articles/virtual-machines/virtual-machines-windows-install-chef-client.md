...
- Azure 管理ポータルを使用して、Windows Server 2012 または Windows Server 2012 R2 を実行する仮想マシンを作成する際に Chef クライアントをインストールする。手順については、「[Microsoft Azure Portal (Microsoft Azure ポータル)](https://docs.chef.io/azure_portal.html)」を参照してください。
