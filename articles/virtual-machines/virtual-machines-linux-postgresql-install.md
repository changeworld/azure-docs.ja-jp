...
## PostgreSQL のインストール
> [!NOTE]
> このチュートリアルを実行するには、Linux を実行する Azure Virtual Machines が既に存在している必要があります。続行する前に、[Azure Linux VM チュートリアル](virtual-machines-linux-quick-create-cli.md)を見て Linux VM を作成およびセットアップしてください。
> 
> 
