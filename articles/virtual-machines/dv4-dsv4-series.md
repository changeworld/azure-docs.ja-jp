...
| サイズ | vCPU | メモリ:GiB | 一時ストレージ (SSD) GiB | 最大データ ディスク数 | 最大 NIC 数|想定のネットワーク帯域幅 (Mbps) |
|---|---|---|---|---|---|---|
...
| サイズ | vCPU | メモリ:GiB | 一時ストレージ (SSD) GiB | 最大データ ディスク数 | キャッシュが無効な場合の最大ディスク スループット: IOPS/MBps | 最大 NIC 数|想定のネットワーク帯域幅 (Mbps) |
|---|---|---|---|---|---|---|---|
