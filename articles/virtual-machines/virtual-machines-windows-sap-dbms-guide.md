<properties
   pageTitle="Windows 仮想マシン (VM) 上の SAP NetWeaver – DBMS デプロイメント ガイド | Microsoft Azure"
   description="Windows 仮想マシン (VM) 上の SAP NetWeaver – DBMS デプロイメント ガイド"
...
# Windows 仮想マシン (VM) 上の SAP NetWeaver – DBMS デプロイメント ガイド
...
* [Windows 仮想マシン (VM) 上の SAP NetWeaver – DBMS デプロイメント ガイド (本書)][dbms-guide]
* [Windows 仮想マシン (VM) 上の SAP NetWeaver - 高可用性ガイド][ha-guide]
