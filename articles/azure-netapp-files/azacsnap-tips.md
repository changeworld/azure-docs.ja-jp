...
AzAcSnap サービス プリンシパルのスコープを制限する必要がある場合があります。  Azure リソースのきめ細かなアクセス管理の詳細については、[Azure RBAC のドキュメント](https://docs.microsoft.com/azure/role-based-access-control/)を参照してください。  
