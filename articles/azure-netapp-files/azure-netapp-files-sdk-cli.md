...
|------------------|--------------------------------------------|
|    .NET   |    [.NETCore 用の Azure NetApp Files SDK サンプル](https://docs.microsoft.com/en-us/samples/azure-samples/netappfiles-dotnetcore-sdk-sample/azure-netappfiles-sdk-sample-for-net-core/) |    
