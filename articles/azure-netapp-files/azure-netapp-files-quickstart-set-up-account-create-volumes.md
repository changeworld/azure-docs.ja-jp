...
1. 他の例でも参照できるように、いくつかの変数を定義します。
    ...
    > [!NOTE]
    > サポートされているリージョンの一覧については、「[リージョン別の利用可能な製品](https://azure.microsoft.com/en-us/global-infrastructure/services/?products=netapp&regions=all)」を参照してください。
