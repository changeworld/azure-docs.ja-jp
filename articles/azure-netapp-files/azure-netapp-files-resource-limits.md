...
4. [詳細] タブで次の操作を実行します。
    1. [説明] ボックスで、対応するリソースの種類に対して、次の情報を指定します。
        ...
        |  リージョン間レプリケーション データ保護ボリューム  |  *サブスクリプション ID、コピー先の NetApp アカウントの URI、コピー先の容量プールの URI、ソースの NetApp アカウントの URI、ソースの容量プールの URI、ソース ボリュームの URI*   |  リージョン間レプリケーション データ保護ボリュームの*要求された新しい最大数 **(コピー先ボリューム)***     |  *どのシナリオやユース ケースが要求を求めたか?*  |    
