...
1. ボリューム レプリケーションを削除する前に、レプリケーション ピアリングが中断されていることを確認してください。 レプリケーション ピアリングを中断するには: 
    ...
    2.  続行する前に、次のフィールドを確認してください。  
        * ミラーの状態に、 **[ミラー化済み]** と表示されていることを確認します。   
            ミラーの状態が [未初期化] と表示されている場合は、レプリケーションのピアリングを中断しようとしないでください。
        * リレーションシップの状態に **[アイドル]** と表示されていることを確認します。   
            リレーションシップの状態が [転送中] と表示されている場合は、レプリケーションのピアリングを中断しようとしないでください。   
