---
title: Blockchain Data Manager を使用して Azure Cosmos DB を更新する
description: Blockchain Data Manager を使用して Azure Cosmos DB にブロックチェーン データを送信する
