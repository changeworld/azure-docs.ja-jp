---
title: Azure HPC Cache プレビューのデータ取り込み - 並列コピー スクリプト
...
ms.locfileid: "72254520"
---
# <a name="azure-hpc-cache-preview-data-ingest---parallel-copy-script-method"></a>Azure HPC Cache (プレビュー) のデータ取り込み - 並列コピー スクリプトを使用した方法
