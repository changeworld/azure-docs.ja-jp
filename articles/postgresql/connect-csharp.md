...
5. サーバーのログイン情報を忘れた場合は、**[概要]** ページに移動して**サーバー管理者ログイン名**を確認し、必要に応じてパスワードをリセットします。
