...
## <a name="postgresql-version-956"></a>PostgreSQL バージョン 9.5.6
PostgreSQL 9.5.6 の機能強化と修正については、[PostgreSQL のドキュメント](https://www.postgresql.org/docs/9.6/static/release-9-5-6.html)を参照してください。
