...
ms.locfileid: "65067222"
---
# <a name="azure-database-for-postgresql---single-server-use-python-to-connect-and-query-data"></a>Azure Database for PostgreSQL - Single Server: Python を使った接続とデータの照会
