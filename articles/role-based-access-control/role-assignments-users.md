...
> * [ユーザーまたはグループによるアクセスの管理](role-assignments-users.md)
> * [リソースによるアクセスの管理](role-assignments-portal.md)
...
[Azure サブスクリプション リソースへのアクセスをロールの割り当てによって管理する](role-assignments-portal.md)方法について参照してください。
...
2. **[削除]** を選択し、**[はい]** を選択して確定します。
    ![アクセス権の割り当ての削除 - スクリーンショット](./media/role-assignments-users/delete_assignment.png)

## <a name="next-steps"></a>次の手順

* ロールベースのアクセス制御を開始して、 [Azure サブスクリプション リソースへのアクセスをロールの割り当てによって管理する](role-assignments-portal.md)
