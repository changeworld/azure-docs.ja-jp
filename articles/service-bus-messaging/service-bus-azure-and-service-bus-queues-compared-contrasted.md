...
> [!NOTE]
> すべてのコストは、変更されることがあります。 上記の表は、現在の価格を反映しています。ここには、現在利用できるキャンペーン プランは含まれていません。 Azure の最新の料金情報については、「[Azure の料金](https://azure.microsoft.com/pricing/)」ページをご覧ください。 Service Bus の料金の詳細については、「[Service Bus 料金](https://azure.microsoft.com/pricing/details/service-bus/)」を参照してください。
> 
> 
