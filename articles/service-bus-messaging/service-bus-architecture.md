...
この記事では、[Azure Service Bus](https://azure.microsoft.com/services/service-bus/) のメッセージ処理アーキテクチャについて説明します。
