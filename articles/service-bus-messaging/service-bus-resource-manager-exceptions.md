...
| 権限がありません | なし | MissingToken: Authorization ヘッダーが見つかりません。 | このエラーは、承認に null または正しくない値が含まれているときに発生します。 | Authorization ヘッダーに記載されているトークン値が正しく、null でないことを確認します。 |