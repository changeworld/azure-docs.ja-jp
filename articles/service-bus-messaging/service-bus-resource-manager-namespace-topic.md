---
title: Azure Resource Manager テンプレートを使用したトピックとサブスクリプションを含んだ Service Bus 名前空間の作成 | Microsoft Docs
...
完全なテンプレートについては、 [Service Bus の名前空間にトピックとサブスクリプションを追加する][Service Bus の名前空間にトピックとサブスクリプションを追加する] テンプレートを参照してください。
