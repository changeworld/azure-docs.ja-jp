...
[Service Bus の障害および災害に対するアプリケーションの保護のベスト プラクティス]: ../service-bus/service-bus-outages-disasters.md
[Pricing overview]: https://azure.microsoft.com/pricing/details/service-bus/
[クォータの概要]: ../service-bus/service-bus-quotas.md
[このページ]: ../service-bus/service-bus-powershell-how-to-provision.md#migrate-a-namespace-to-another-azure-subscription
[Exceptions overview]: ../service-bus/service-bus-messaging-exceptions.md
[例外の概要]: ../service-bus/service-bus-messaging-exceptions.md
[Shared Access Signature]: ../service-bus/service-bus-sas-overview.md
