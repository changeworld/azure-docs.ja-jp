...
この記事では、Service Bus キューの使用方法について説明します。サンプルは Python で記述され、[Python AzureService Bus パッケージ][]を使用しています。紹介するシナリオは、**キューの作成、メッセージの送受信**、**キューの削除**です。
...
[Python Azure Service Bus パッケージ]: https://pypi.python.org/pypi/azure-servicebus
[Python AzureService Bus パッケージ]: https://pypi.python.org/pypi/azure-servicebus
