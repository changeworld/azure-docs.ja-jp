...
また、名前空間経由でメトリックに直接アクセスすることもできます。 それを行うには、名前空間を選択してから、 **[メトリック]** を選択します。 エンティティのスコープにフィルター処理されたメトリックを表示するには、エンティティを選択し、 **[メトリック]** を選択します。
...
| 完了したメッセージ| キュー/トピック内の完了したメッセージの数。 <br/><br/> 単位:Count <br/> 集計の種類:Average <br/> ディメンション:エンティティ名 |
| 破棄されたメッセージ| キュー/トピック内の破棄されたメッセージの数。 <br/><br/> 単位:Count <br/> 集計の種類:Average <br/> ディメンション:エンティティ名 |
