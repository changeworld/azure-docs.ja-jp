...
Service Bus からライブラリを取得して使用する方法の詳細については、「[Service Bus AMQP: 開発者ガイド][Service Bus AMQP: 開発者ガイド]」をご覧ください。 詳細情報へのリンクについては、「[次のステップ](service-bus-java-amqp-overview.md#next-steps)」のセクションを参照してください。
