---
title: "Java とともに使用する Service Bus AMQP の概要 | Microsoft Docs"
...
Service Bus からライブラリを取得して使用する方法の詳細については、[「Service Bus AMQP: 開発者ガイド」][Service Bus AMQP: 開発者ガイド]を参照してください。 詳細情報へのリンクについては、「[次のステップ](service-bus-java-amqp-overview.md#next-steps)」のセクションを参照してください。
...
* [Service Bus AMQP: 開発者ガイド][Service Bus AMQP: 開発者ガイド]
