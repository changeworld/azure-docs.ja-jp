...
* 今後は、[Batch Send](/dotnet/api/microsoft.servicebus.messaging.queueclient.sendbatch)、[Batch Receive](/dotnet/api/microsoft.servicebus.messaging.queueclient.receivebatch)、[Receive by Sequence Number](/dotnet/api/microsoft.servicebus.messaging.queueclient.receive)、[Peek](/dotnet/api/microsoft.servicebus.messaging.queueclient.peek)、[Renew Lock](/dotnet/api/microsoft.servicebus.messaging.queueclient.renewmessagelock)、[Schedule Message](/dotnet/api/microsoft.servicebus.messaging.queueclient.schedulemessageasync)、[Cancel Scheduled Message](/dotnet/api/microsoft.servicebus.messaging.queueclient.cancelscheduledmessageasync)、[Add Rule](/dotnet/api/microsoft.servicebus.messaging.ruledescription)、[Remove Rule](/dotnet/api/microsoft.servicebus.messaging.ruledescription)、[Session Renew Lock](/dotnet/api/microsoft.servicebus.messaging.messagesession.renewlock)、[Set Session State](/dotnet/api/microsoft.servicebus.messaging.messagesession.setstate)、[Get Session State](/dotnet/api/microsoft.servicebus.messaging.messagesession.getstate)、[Enumerate Sessions](/dotnet/api/microsoft.servicebus.messaging.queueclient.getmessagesessions) の各操作で AMQP がサポートされます。
