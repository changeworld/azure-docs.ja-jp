---
title: クイック スタート:Java で Azure Service Bus キューを使用する
description: クイック スタート:Azure での Service Bus キューの使用方法を学習します。 コード サンプルは Java で記述されています。
