---
title: "Service Fabric の概要 | Microsoft Docs"
...
* Service Fabric プログラミング モデルを使って、マイクロサービスで構成されたアプリケーションを開発します。 もしくは、単純に、ゲスト実行可能ファイル、およびユーザーが選択したその他のアプリケーション フレームワーク (ASP.NET Core 1 や Node.js) をホストすることができます。
