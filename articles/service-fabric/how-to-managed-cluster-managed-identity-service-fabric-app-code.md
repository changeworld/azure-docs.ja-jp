---
title: Service Fabric マネージド クラスター上のアプリケーションでマネージド ID を使用する
description: Azure Service Fabric アプリケーション コードでマネージド ID を使用して、Service Fabric マネージド クラスター上の Azure サービスにアクセスする方法。
ms.topic: article
ms.date: 5/10/2021
...
ms.locfileid: "109689383"
---
# <a name="how-to-leverage-a-service-fabric-applications-managed-identity-to-access-azure-services-on-a-service-fabric-managed-cluster"></a>Service Fabric アプリケーションのマネージド ID を活用して、Service Fabric マネージド クラスター上の Azure サービスにアクセスする方法
...
* [Azure Service Fabric アプリケーションに他の Azure リソースへのアクセス権を付与する](./how-to-managed-cluster-grant-access-other-resources.md)
