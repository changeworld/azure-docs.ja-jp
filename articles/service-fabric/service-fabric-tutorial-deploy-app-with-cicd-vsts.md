...
![[電子メール]、[アカウント]、[リポジトリ名]、[リポジトリの発行] ボタンが強調表示されている [Azure DevOps へプッシュ] の設定のスクリーンショット。][publish-code]
...
![ブラウザー ウィンドウで実行されている Service Fabric Explorer の投票アプリのスクリーンショット。 アプリ バージョン "1.0.0.20170815.3" が強調表示されています。][sfx1]
...
![Service Fabric Explorer の投票アプリのスクリーンショット。 ステータス メッセージ [アップグレード中] とメッセージ [アップグレードが進行中] が強調表示されています。][sfx2]

アプリケーションのアップグレードには数分かかる場合があります。 アップグレードが完了すると、アプリケーションは次のバージョンで実行されます。  この例では "1.0.0.20170815.4" です。

![ブラウザー ウィンドウで実行されている Service Fabric Explorer の投票アプリのスクリーンショット。 更新されたアプリ バージョン "1.0.0.20170815.4" が強調表示されています。][sfx3]
