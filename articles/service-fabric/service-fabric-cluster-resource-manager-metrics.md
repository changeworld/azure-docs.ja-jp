<properties
   pageTitle="Azure Service Fabric クラスター リソース マネージャーでメトリックを管理する"
...
## 次のステップ
- [サービスの構成について学習する](service-fabric-cluster-resource-manager-configure-services.md)
- [最適化メトリックについて学習する](service-fabric-cluster-resource-manager-defragmentation-metrics.md)
- [クラスター リソース マネージャーがクラスター内の負荷を分散させる方法について学習する](service-fabric-cluster-resource-manager-balancing.md)
- [Service Fabric クラスター リソース マネージャーの概要を確認する](service-fabric-cluster-resource-manager-introduction.md)
- [サービスの移動コストについて学習する](service-fabric-cluster-resource-manager-movement-cost.md)
