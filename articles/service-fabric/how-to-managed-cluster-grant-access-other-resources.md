---
title: Service Fabric マネージド クラスター上の他の Azure リソースへのアクセスをアプリケーションに許可
...
* [マネージド ID を使用してアプリケーションを Microsoft Azure Service Fabric マネージド クラスターにデプロイする](how-to-managed-cluster-application-managed-identity.md)