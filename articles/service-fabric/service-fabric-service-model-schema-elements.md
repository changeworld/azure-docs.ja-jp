...
|名前|AddRemoveIncrementalNamedPartitionScalingMechanism|
|minOccurs|0|
|maxOccurs|1|
...
|名前|AveragePartitionLoadScalingTrigger|
|minOccurs|0|
|maxOccurs|1|
...
|定義済み|[ScalingPolicyTriggerGroup グループ](service-fabric-service-model-schema-element-groups.md#scalingpolicytriggergroup-group)内でローカルに|
|名前|AverageServiceLoadScalingTrigger|
|minOccurs|0|
|maxOccurs|1|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|BackupRestoreServiceReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|CentralSecretServiceReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|ClusterConnectionEndpoint 要素|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|ClusterManagerReplicatorEndpoint|
|minOccurs|0|
...
|名前|DefaultServiceTypeHealthPolicy|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|EventStoreServiceReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|FailoverManagerReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|FaultAnalysisServiceReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|GatewayResourceManagerReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|HttpApplicationGatewayEndpoint|
|minOccurs|0|
...
[https://hub.docker.com](https://hub.docker.com ) または Azure Container Registry のリポジトリおよびイメージ。
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|ImageStoreServiceReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、3 個の属性|
|定義済み|[ScalingPolicyMechanismGroup グループ](service-fabric-service-model-schema-element-groups.md#scalingpolicymechanismgroup-group)内でローカルに|
|名前|InstanceCountScalingMechanism|
|minOccurs|0|
|maxOccurs|1|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|RepairManagerReplicatorEndpoint|
|minOccurs|0|
...
|Attribute|値|
|---|---|
|名前|ServicePackageActivationMode|
|type|xs:string|
|use|省略可能|
...
|content|0 個の要素、0 個の属性|
|定義済み|[ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)、[ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype) 内でローカルに|
|名前|ServiceFabricRuntimeAccessPolicy|
|minOccurs|0|
|maxOccurs|1|
...
|content|0 個の要素、0 個の属性|
|定義済み|[ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)、[ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype) 内でローカルに|
|名前|ServicePackageContainerPolicy|
|minOccurs|0|
|maxOccurs|1|
...
|content|0 個の要素、0 個の属性|
|定義済み|[ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)、[ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype) 内でローカルに|
|名前|ServicePackageResourceGovernancePolicy|
|minOccurs|0|
|maxOccurs|1|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|UpgradeOrchestrationServiceReplicatorEndpoint|
|minOccurs|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|[FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 内でローカルに|
|名前|UpgradeServiceReplicatorEndpoint|
|minOccurs|0|
