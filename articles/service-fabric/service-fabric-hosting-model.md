...
>
>- **専有プロセス** ホスティング モデルは、**ExclusiveProcess** と等しい **ServicePackageActivationMode** に対応しています。サービス作成時にはこの ServicePackageAtivationMode を専有として指定する必要があります。 
>
