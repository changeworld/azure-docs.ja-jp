...
ms.locfileid: "34363072"
---
<!-- This article was generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>サービス モデルの XML スキーマのドキュメント
この記事では、Service Fabric SDK でインストールされる ServiceFabricServiceModel.xsd スキーマ ファイルについて説明します。  既定では、スキーマ ファイルは *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd* にインストールされます。

## <a name="namespace-bindings"></a>名前空間バインド
|Prefix (プレフィックス)|名前空間 URI|
|---|---|
|xs|http://www.w3.org/2001/XMLSchema|
|なし|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>コンポーネントの概要 
ServiceFabricServiceModel.xsd の http://schemas.microsoft.com/2011/01/fabric 名前空間では、次のコンポーネントが定義されています。
- [293 個の要素](service-fabric-service-model-schema-elements.md)
- [103 個の複合型](service-fabric-service-model-schema-complex-types.md)
- [1 個の単純型](service-fabric-service-model-schema-simple-types.md)
- [3 個の要素グループ](service-fabric-service-model-schema-element-groups.md)
- [16 個の属性グループ](service-fabric-service-model-schema-attribute-groups.md)
