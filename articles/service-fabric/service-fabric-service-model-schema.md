...
ServiceFabricServiceModel.xsd では、次のコンポーネントが定義されています。
- [257 個の要素](service-fabric-service-model-schema-elements.md)
- [112 個の複合型](service-fabric-service-model-schema-complex-types.md)
