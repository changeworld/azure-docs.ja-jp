...
1.  Eclipse Neon 以降を入手したことと、Buildship の最新バージョン (1.0.17 以降のバージョン) がインストールされていることを確認します。
    -   インストールされているコンポーネントのバージョンを確認するには、Eclipse で **[Help]\(ヘルプ\)** > **[Installation Details]\(インストールの詳細\)** の順に移動します。
...
2.  Service Fabric プラグインをインストールするには、Eclipse で **[Help]\(ヘルプ\)** > **[Install New Software]\(新しいソフトウェアのインストール\)** の順に移動します。
