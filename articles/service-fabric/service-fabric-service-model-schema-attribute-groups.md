...
サービス マニフェストの名前。 この名前は、サービス マニフェストの ServiceManifest 要素で宣言されている Name と一致する必要があります。
|Attribute|値|
|---|---|
...
サービス マニフェストのバージョン。 このバージョンは、サービス マニフェストで宣言されているバージョンと一致する必要があります。
|Attribute|値|
|---|---|
