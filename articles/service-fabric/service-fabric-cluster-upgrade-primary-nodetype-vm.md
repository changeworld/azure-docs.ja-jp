---
title: Azure Service Fabric クラスター VM の SKU または OS をアップグレードする | Microsoft Docs
description: Service Fabric クラスターのプライマリ ノード タイプの仮想マシンをアップグレードする方法について説明します。
