...
![[Azure DevOps へプッシュ] ウィンドウのスクリーンショット。 [電子メール]、[アカウント]、[リポジトリ名]、[リポジトリの発行] ボタンの設定が強調表示されています。][publish-code]
...
![Service Fabric Explorer の投票アプリのスクリーンショット。 [要点] タブで、アプリ バージョン "1.0.0.20170815.3" が強調表示されています。][sfx1]
...
![Service Fabric Explorer の投票アプリのスクリーンショット。 メッセージ [アップグレードが進行中] が強調表示され、アプリの状態が [アップグレード中] になっています。][sfx2]

アプリケーションのアップグレードには数分かかる場合があります。 アップグレードが完了すると、アプリケーションは次のバージョンで実行されます。  この例では "1.0.0.20170815.4" です。

![Service Fabric Explorer の投票アプリのスクリーンショット。 [要点] タブで、更新されたアプリ バージョン "1.0.0.20170815.4" が強調表示されています。][sfx3]
