...
|定義済み|グローバル|
|名前|ApplicationHealthPolicyType|
...
|Attribute|値|
|---|---|
|名前|MaxPercentUnhealthyDeployedApplications|
|type|xs:string|
|use|省略可能|
|default|0|
...
|Attribute|値|
|---|---|
|名前|ConnectionStringIsEncrypted|
|type|xs:string|
|use|必須|
...
|content|0 個の要素、4 個の属性|
|定義済み|グローバル|
|名前|ConfigPackageDescriptionType|
...
|Attribute|値|
|---|---|
|名前|IncludeDockerHealthStatusInSystemHealthReport|
|type|xs:boolean|
|use|省略可能|
|default|true|
...
|Attribute|値|
|---|---|
|名前|RestartContainerOnUnhealthyDockerHealthStatus|
|type|xs:boolean|
|use|省略可能|
|default|false|
...
|content|4 個の要素、0 個の属性|
|定義済み|グローバル|
|名前|ContainerHostEntryPointType|
...
ApplicationManifest.xml 内で "RepositoryCredentials" タグで指定された資格情報の代わりに、clusterManifest.xml で指定された既定のリポジトリ資格情報を使用します。
        

|Attribute|値|
|---|---|
|名前|UseDefaultRepositoryCredentials|
|type|xs:string|
|use|省略可能|
|default|false|

#### <a name="usetokenauthenticationcredentials"></a>UseTokenAuthenticationCredentials
認証に使用されるトークンを取得するために、MSI トークン認証 (またはカスタム指定エンドポイント) を使用します。
        

|Attribute|値|
|---|---|
|名前|UseTokenAuthenticationCredentials|
|type|xs:string|
|use|省略可能|
|default|false|

#### <a name="isolation"></a>分離:
コンテナーの分離モード。 有効な値は、default、process、hyperv (Windows コンテナーでサポートされている場合のみ) です。
...
|Attribute|値|
|---|---|
|名前|ContainersRetentionCount|
|use|省略可能|
|type|xs:string|
|default|0|

#### <a name="autoremove"></a>AutoRemove
コンテナーが強制終了された場合にコンテナーの削除が自動的に発生する (true) か、発生しない (false) かを示すフラグ。  false の場合、SF はコンテナーを手動で削除します。
...
|content|0 個の要素、1 個の属性|
|定義済み|グローバル|
|名前|ContainerNetworkPolicyEndpointBindingType|
...
|content|0 個の要素、3 個の属性|
|定義済み|グローバル|
|名前|EnvironmentVariableOverrideType|
...
|content|3 個の要素、0 個の属性|
|定義済み|グローバル|
|名前|FabricKtlLoggerSettingsType|
...
|content|1 個の要素、0 個の属性|
|定義済み|グローバル|
|名前|InfrastructureInformationType|
...
|定義済み|グローバル|
|名前|ResourceGovernancePolicyType|
...
|content|4 個の要素、0 個の属性|
|定義済み|グローバル|
|名前|ServiceAndServiceGroupTypesType|
...
|content|0 個の要素、2 個の属性|
|定義済み|グローバル|
|名前|ServiceFabricRuntimeAccessPolicyType|
...
|Attribute|値|
|---|---|
|名前|RemoveServiceFabricRuntimeAccess|
|type|xs:boolean|
|default|false|
...
|Attribute|値|
|---|---|
|名前|UseServiceFabricReplicatedStore|
|type|xs:boolean|
|default|false|
...
|定義済み|グローバル|
|名前|ServiceManifestImportPoliciesType|
...
|content|1 個の要素、2 個の属性|
|定義済み|グローバル|
|名前|ServicePackageContainerPolicyType|
...
|content|0 個の要素、2 個の属性|
|定義済み|グローバル|
|名前|ServicePackageResourceGovernancePolicyType|
...
|content|1 個の要素、0 個の属性|
|定義済み|グローバル|
|名前|ServiceTypeExtensionPolicyPropertiesType|
...
|content|0 個の要素、3 個の属性|
|定義済み|グローバル|
|名前|ServiceTypeHealthPolicyType|
...
|Attribute|値|
|---|---|
|名前|MaxPercentUnhealthyServices|
|type|xs:string|
|use|省略可能|
|default|0|
...
|Attribute|値|
|---|---|
|名前|MaxPercentUnhealthyPartitionsPerService|
|type|xs:string|
|use|省略可能|
|default|0|
...
|Attribute|値|
|---|---|
|名前|MaxPercentUnhealthyReplicasPerPartition|
|type|xs:string|
|use|省略可能|
|default|0|
...
|content|0 個の要素、0 個の属性|
|定義済み|グローバル|
|名前|StatefulServiceGroupTypeType|
...
|content|0 個の要素、0 個の属性|
|定義済み|グローバル|
|名前|StatelessServiceGroupTypeType|
...
|定義済み|グローバル|
|名前|WindowsFabricDeploymentInformation|
...
|Attribute|値|
|---|---|
|名前|InfrastructureManifestLocation|
|type|xs:string|
|use|省略可能|
...
|Attribute|値|
|---|---|
|名前|UpgradeEntryPointExeParameters|
|type|xs:string|
|use|省略可能|
...
|Attribute|値|
|---|---|
|名前|UndoUpgradeEntryPointExeParameters|
|type|xs:string|
|use|省略可能|
