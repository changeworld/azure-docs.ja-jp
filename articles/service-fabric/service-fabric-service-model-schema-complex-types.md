...
#### <a name="os"></a>Os
OS のビルド バージョン。 たとえば、RS1 の場合は 1809 となります
|Attribute|値|
|---|---|
|型|xs:string|
|name|Os|
...
MB 単位のメモリ ソフトの制限。 正の整数にする必要があります。
|Attribute|値|
|---|---|
|型|xs:string|
...
利用可能な CPU の使用可能な割合 (Windows のみ)。 正の整数にする必要があります。
|Attribute|値|
|---|---|
|型|xs:string|
|name|CpuPercent|
...
IOPS 単位の最大 IO 量。 正の整数にする必要があります。
|Attribute|値|
|---|---|
|型|xs:string|
|name|MaximumIOps|
...
ブロック IO の相対的な重み。 10 から 1000 までの正の整数である必要があります。
|Attribute|値|
|---|---|
|型|xs:string|
|name|BlockIOWeight|
