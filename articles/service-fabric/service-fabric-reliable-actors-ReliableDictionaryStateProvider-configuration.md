<properties
   pageTitle="Azure Service Fabric の信頼性の高いアクター 'ReliableDictionaryActorStateProvider' の構成の概要 | Microsoft Azure"
   description="Azure Service Fabric の 'ReliableDictionaryActorStateProvider' という型のステートフル アクターの構成について"
