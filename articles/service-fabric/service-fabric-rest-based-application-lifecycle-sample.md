...
---
# <a name="rest-based-application-lifecycle-sample"></a>REST ベース アプリケーション ライフサイクルのサンプル
...
* WordCount サンプルの 1.1.0 バージョンをプロビジョニング解除します。
* アプリケーションの種類の一覧を表示します。一覧に WordCount 1.0.0 は含まれていますが、WordCount 1.1.0 は含まれていません。
