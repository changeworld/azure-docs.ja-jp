<properties urlDisplayName="HTML Client" pageTitle="HTML クライアントの使用方法 - Azure Mobile Services" metaKeywords="Azure Mobile Services, Mobile Service HTML client, HTML client" description="Azure Mobile Services 向け HTML クライアントを使用する方法について説明します。" metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="How to use an HTML/JavaScript client for Azure Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
