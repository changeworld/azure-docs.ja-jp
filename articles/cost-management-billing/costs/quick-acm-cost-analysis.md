...
コスト分析には、多くのグループ化とフィルター処理のオプションがあります。 グループ化とフィルター処理のオプションについての動画を視聴するには、[Cost Management のディメンションとタグによるレポート](https://www.youtube.com/watch?v=2Vx7V17zbmk)に関する動画をご覧ください。 他の動画を視聴するには、[Cost Management の YouTube チャンネル](https://www.youtube.com/c/AzureCostManagement)にアクセスしてください。
