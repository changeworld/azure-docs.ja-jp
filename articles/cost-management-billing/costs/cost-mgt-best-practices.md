...
スケーラブルなリソースへのタグ付けを組織内で遵守させるために利用できるツールについては、ビデオ「[Azure Cost Management でタグのポリシーを確認する方法](https://www.youtube.com/watch?v=nHQYcYGKuyw)」をご覧ください。
