...
無料のサービスおよび数量の有効期限が切れると、使用中のすべてのサービスの料金が従量課金制で課金されます。 使用しないサービスのリソースは、Azure ポータルを使用して削除できます。 どの Azure サービスも使用する予定がない場合は、[サブスクリプションを取り消す](cancel-azure-subscription.md)ことができます。
