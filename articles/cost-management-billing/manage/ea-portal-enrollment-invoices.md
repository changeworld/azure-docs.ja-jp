...
リソース タグは Azure portal で管理されます。 [https://portal.azure.com](https://portal.azure.com)で Azure サブスクリプション チームに問い合わせることができます。 サポート リクエストを要求する方法については、[このリンク](https://docs.microsoft.com/azure/azure-portal/supportability/how-to-create-azure-support-request)の手順に従ってください。
