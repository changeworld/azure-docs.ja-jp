...
- アプリケーションの開発とテストを行う。
- [ハイブリッド クラウド環境をシミュレーション](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md)する。
...
Azure の基本構成の準備が整いました。アプリケーションの開発やテスト、さらに、[ハイブリッド クラウド環境のシミュレーション](virtual-networks-setup-simulated-hybrid-cloud-environment-testing.md)など、各種テスト環境に使用することができます。

## その他のリソース

[ハイブリッド クラウド テスト環境](virtual-networks-setup-hybrid-cloud-environment-testing.md)
