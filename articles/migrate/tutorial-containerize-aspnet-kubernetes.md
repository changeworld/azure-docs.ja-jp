---
title: ASP.NET アプリケーションをコンテナー化し、Azure Kubernetes Service に移行する
description: ASP.NET アプリケーションをコンテナー化し、Azure Kubernetes Service に移行する方法について説明します。
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
