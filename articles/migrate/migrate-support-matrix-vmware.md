...
**アクセス許可 (依存関係の視覚化)** | 読み取り専用アクセス権を持つ vCenter Server アカウントと、 **[仮想マシン]**  >  の **[ゲスト操作]** の権限が有効。
...
**Windows アカウント** |  依存関係の分析の場合、Windows VM にアクセスするには、Azure Migrate アプライアンスで使用できるドメイン管理者アカウントまたはローカル管理者アカウントが必要です。
