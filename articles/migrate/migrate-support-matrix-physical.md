...
| **アクセス許可**           | **Windows:** 検出するすべての Windows サーバーでドメイン管理者である必要があります。 次のグループにユーザー アカウントを追加する必要があります:リモート管理ユーザー、パフォーマンス モニター ユーザー、パフォーマンス ログ ユーザー。 <br/><br/> **Linux:** 検出する Linux サーバーのルート アカウントが必要です。 |
