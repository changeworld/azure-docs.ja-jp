...
1つのアプライアンスで最大 10,000 までの VMware VM と最大 5,000 までのHyper-V VM を検出できます。 オンプレミス環境にさらに多くのマシンがある場合は、[Hyper-V](scale-hyper-v-assessment.md) のスケーリングと [VMware](scale-vmware-assessment.md) の評価を参照してください。
