...
**コンポーネント** | **必要条件** | **詳細**
--- | --- | ---
ゲスト オペレーティング システム | 移行でサポートされている VMware VM オペレーティン グシステムを検証します。<br/> サポートされているオペレーティング システム上で実行されているすべてのワークロードを移行できます。 | サポートされていない場合、確認は失敗します。
