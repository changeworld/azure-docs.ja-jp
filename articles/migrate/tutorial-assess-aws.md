...
description: Azure Migrate Server Assessment を使用して、Azure への移行のために AWS インスタンスにアクセスする方法について説明します。
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
1. **[グループを選択または作成します]** で **[新規作成]** を選択し、グループ名を指定します。 
    ...
    :::image type="content" source="./media/tutorial-assess-physical/assess-group.png" alt-text="VM をグループに追加する":::
