...
## <a name="whats-the-difference-between-azure-migrate-discovery-and-assessment-and-the-map-toolkit"></a>Azure Migrate の Discovery and Assessment と MAP Toolkit の違いは何ですか。
