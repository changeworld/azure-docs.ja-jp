...
ms.locfileid: "47046605"
---
# New-AzureRmFrontDoorFrontendEndpointObject

Front Door を作成するために PSFrontendEndpoint オブジェクトを作成します
...
### -CertificateType
frontendEndpoint への接続をセキュリティで保護するために使用される証明書の種類
...
### -ProtocolType
セキュリティで保護された配信で使用される TLS 拡張機能のプロトコル
...
セッション アフィニティで使用する TTL (秒) (該当する場合)。 既定値は 0 です
...
### -WebApplicationFirewallPolicyLink
各ホストの Web アプリケーション ファイアウォール ポリシーのリソース ID (該当する場合)
