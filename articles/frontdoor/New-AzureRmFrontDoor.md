...
ms.locfileid: "47047028"
---
# New-AzureRmFrontDoor

新しい Azure Front Door のロード バランサーを作成します。
...
## Description
**New-AzureRmFrontDoor** コマンドレットでは、現在のサブスクリプションの下で指定されたリソース グループに新しい Azure Front Door ロード バランサーを作成します。

## 例

### 例 1: 特定のパラメーターに基づいて Front Door を作成する。
```powershell
...
特定のパラメーターに基づいて Front Door を作成します。
