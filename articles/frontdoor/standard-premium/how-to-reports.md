...
| 場所ごとのトラフィック | - 上位の国/地域ごとの要求と使用状況のマップ ビューを表示します<br/>- 上位の国/地域の傾向ビュー |
...
| ディメンションごとのメトリック | - アクション別の一致する WAF ルールの内訳<br/>- ルール セットの種類別のイベントおよびルール グループ別のイベントのドーナツ グラフ<br/>- ルール ID、国/地域、IP アドレス、URL、ユーザー エージェント別の上位イベントの内訳リスト  |
