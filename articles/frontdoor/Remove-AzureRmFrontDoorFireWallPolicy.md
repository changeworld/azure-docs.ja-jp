...
## Description
**Remove-AzureRmFrontDoor** コマンドレットでは、現在のサブスクリプションの WAF ポリシーが削除されます
...
$resourceGroup の $name という WAF ポリシーを削除します。
...
$resourceGroup のすべての WAF ポリシーを削除します。
