...
このチュートリアルは、モバイル サービスのクイック スタートに基づいています。このチュートリアルを開始する前に、[Mobile Services の使用]に関するチュートリアルを完了している必要があります。このチュートリアルには、[Mobile Services iOS SDK](https://go.microsoft.com/fwLink/p/?LinkID=266533) と [XCode 4.5](https://go.microsoft.com/fwLink/p/?LinkID=266532) および iOS 5.0 以降のバージョンが必要です。
