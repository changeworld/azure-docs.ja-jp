<properties 
	pageTitle="Azure Web ジョブの推奨リソース" 
...
Web ジョブの作成、展開、管理は、Visual Studio の統合ツールでシームレスに行うことができます。テンプレートから Web ジョブを作成し、発行、および管理 (実行、停止、監視、デバッグ) できます。 
...
* [Web ジョブ SDK で Azure Service Bus を使用する方法](../websites-dotnet-webjobs-sdk-service-bus)
* [Azure Web ジョブ SDK クイック リファレンス (PDF をダウンロード)](http://go.microsoft.com/fwlink/?LinkID=524028&clcid=0x409)
* ビデオ
...
[Web ジョブの展開] (#deploy) と [Web ジョブのテストとデバッグ] については、次のセクションもご覧ください(#debug)。

##<a name="deploy"></a>Web ジョブの展開

* [How to Deploy Azure WebJobs to Azure Websites (Azure Web ジョブを Azure Web サイトに展開する方法)](../websites-dotnet-deploy-webjobs/)
* [Azure の管理ポータルを使用して Web ジョブを展開する方法](../web-sites-create-web-jobs/)
...
* [Git deploying a .NET console app to Azure using WebJobs (Git で Web ジョブを使用して Azure に .NET コンソール アプリケーションを展開)](http://blog.amitapple.com/post/73574681678/git-deploy-console-app/)
* ビデオ
	* [Visual Studio 向けの Web ジョブ ツールの概要](http://channel9.msdn.com/Shows/Web+Camps+TV/Introducing-WebJobs-Tooling-for-Visual-Studio-with-Brady-Gaster) 
	* [Web ジョブ ツールとリモート デバッグ](http://channel9.msdn.com/Shows/Web+Camps+TV/WebJobs-GA-Series-Episode-1-WebJobs-Tooling-with-Brady-Gaster) 
...
* [New Developer and Debugging Features for Azure WebJobs in Visual Studio (Visual Studio における Azure Web ジョブ向けの新しい開発者機能とデバック機能)](http://blogs.msdn.com/b/webdev/archive/2014/11/12/new-developer-and-debugging-features-for-azure-webjobs-in-visual-studio.aspx)
...
* [Azure Web サイト: Architecting Massive-Scale Ready-For-Business Web Apps (大規模なビジネス向け Web アプリケーションの設計)](https://channel9.msdn.com/Events/Build/2014/3-626)Web ジョブ SDK など、Web ジョブを使用した Azure Web サイトのスケール方法について説明します。
...
* [SiteMonitR](http://code.msdn.microsoft.com/SiteMonitR-dd4fcf77)スケジュールされたイベント ドリブンの Web ジョブの使用方法を示します。ブログ記事 [Rebuilding the SiteMonitR using Azure WebJobs SDK (Azure Web ジョブ SDK を使用した SiteMonitR の再構築)](http://www.bradygaster.com/post/rebuilding-the-sitemonitr-using-windows-azure-webjobs) をご覧ください。
