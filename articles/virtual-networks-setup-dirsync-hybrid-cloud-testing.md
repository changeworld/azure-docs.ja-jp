...
次に、新しい Microsoft アカウントにサインアップします。**http://outlook.com** にアクセスし、user123@outlook.com などの電子メール アドレスを使用してアカウントを作成します。このアカウントで Office 365 FastTrack 試用版にサインアップすることになります。
...
6.	Internet Explorer を実行して、**http://portal.microsoftonline.com** にアクセスします。 
7.	Lynda Meyer の Office 365 の資格情報を使用してログオンします。彼女のユーザー名は lyndam@<*Your Fictional Name*>.onmicrosoft.com になります。パスワードは、Lynda Meyer の Active Directory ユーザー アカウントのパスワードです。
