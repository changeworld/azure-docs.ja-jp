---
title: Azure ポータルを使用する Azure Data Lake Analytics の管理 | Microsoft Docs
...
Analytics アカウントを削除しても、従属する Data Lake Store アカウントは削除されません。Data Lake ストレージ アカウントを削除する手順については、[Data Lake Store アカウントの削除](../data-lake-store/data-lake-store-get-started-portal.md#delete-azure-data-lake-store-account)に関する記述を参照してください。
