...
# <span id="howtodeploySQLdb"></span></a>データベースを Azure にデプロイする方法
...
-   [方法: 内部設置型サーバーに school データベースを作成する][方法: 内部設置型サーバーに school データベースを作成する]
-   [方法: SQL データベースにデプロイする][方法: SQL データベースにデプロイする]
-   [方法: データベース デプロイを確認する][方法: データベース デプロイを確認する]

## <span id="schooldb"></span></a>方法: 内部設置型サーバーに school データベースを作成する
...
## <span id="deploydb"></span></a>方法: SQL データベースにデプロイする
...
## <span id="verify"></span></a>方法: データベース デプロイを確認する
