...
[サンプル スクリプト](https://raw.githubusercontent.com/microsoft/azure_arc/master/arc_data_services/deploy/scripts/pull-and-push-arc-data-services-images-to-private-registry.py)が Azure Arc GitHub リポジトリにあります。
...
|ターゲット コンテナー レジストリの DNS 名または IP アドレスを指定してください。|TARGET_DOCKER_REGISTRY|ターゲット レジストリの DNS 名または IP アドレス。  これは、イメージのプッシュ_先_のレジストリです。|
