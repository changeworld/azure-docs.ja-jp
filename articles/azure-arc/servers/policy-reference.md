...
ms.locfileid: "89300788"
---
# <a name="azure-policy-built-in-definitions-for-azure-arc-enabled-servers-preview"></a>Azure Arc 対応サーバー (プレビュー) の Azure Policy 組み込み定義

このページは、Azure Arc 対応サーバー (プレビュー) の [Azure Policy](../../governance/policy/overview.md) 組み込みポリシー定義のインデックスです。 他のサービス用の Azure Policy 組み込みについては、[Azure Policy 組み込み定義](../../governance/policy/samples/built-in-policies.md)に関するページをご覧ください。
...
## <a name="azure-arc-enabled-servers-preview"></a>Azure Arc 対応サーバー (プレビュー)
