...
とはいえ、離反で最も重要なメトリックは、誤分類率です。つまり、分類器によって予測された上位の離反者のうち、実際には離反しておらず、特別な扱いを受けている人々です。次の図では、すべてのモデルでこの誤分類を比較しています。
...
[こちらからフィードバックをお送りください][こちらからフィードバックをお送りください]。
 

# 参照

[1][1] 「Predictive analytics: beyond the predictions」W. McKnight、Information Management、2011 年 7 月/8 月、p.18 ～ 20
