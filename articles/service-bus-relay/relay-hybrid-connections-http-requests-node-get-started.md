...
このチュートリアルでは、[Azure Relay ハイブリッド接続](relay-what-is-it.md#hybrid-connections) HTTP 要求の概要について説明します。また、Node.js を使用して、対応するリスナー アプリケーションにメッセージを送信するクライアント アプリケーションを作成する方法を紹介します。
