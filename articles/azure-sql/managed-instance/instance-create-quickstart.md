...
> [!IMPORTANT]
> - SQL Managed Instance の作成は実行時間の長い操作であり、特定の状況によっては、一度に数時間かかることがあります。 一般的な作成時間については、「[管理操作の所要時間](management-operations-overview.md#duration)」を参照してください。
