...
* [UltraSSD を使用して VM を作成する](https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.sqlvirtualmachine/sql-vm-new-storage-ultrassd)
...
# <a name="windows-server-2016-"></a>[Windows Server 2016 以降](#tab/windows2016)
...
Windows Server 2008 から 2012 R2 では、`-StorageSubsystemFriendlyName` の既定値は `Storage Spaces on <VMName>` です。 
