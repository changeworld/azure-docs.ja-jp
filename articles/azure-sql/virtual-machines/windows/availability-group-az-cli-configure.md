---
title: Azure CLI を使用して可用性グループを構成する
...
- [SQL VM リソースプロバイダーに登録されている](sql-vm-resource-provider-register.md) "*同じ可用性セットまたは別の可用性ゾーン*" にある、1 つ以上のドメイン参加済みの、[SQL Server 2016 (以降の) Enterprise Edition を実行している Azure の VM](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-portal-sql-server-provision)。  
