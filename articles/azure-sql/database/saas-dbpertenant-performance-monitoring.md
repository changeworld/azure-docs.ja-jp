...
description: マルチテナント SaaS アプリの Azure SQL Database およびプールのパフォーマンスを監視および管理する
...
ms.locfileid: "84027973"
---
# <a name="monitor-and-manage-performance-of-azure-sql-database-and-pools-in-a-multi-tenant-saas-app"></a>マルチテナント SaaS アプリの Azure SQL Database およびプールのパフォーマンスを監視および管理する
...
* Wingtip Tickets SaaS Database Per Tenant アプリをデプロイします。 5 分未満でデプロイするには、「[Deploy and explore the Wingtip Tickets SaaS Multi-tenant Database application (Wingtip Tickets SaaS Database Per Tenant アプリケーションのデプロイと探索)](../../sql-database/saas-dbpertenant-get-started-deploy.md)」を参照してください
...
多くのリソースを処理する大規模なシナリオの場合は、[Azure Monitor ログ](../../sql-database/saas-dbpertenant-log-analytics.md)を使用できます。 これは、Log Analytics ワークスペースで収集されたログに対する分析を提供する別の Azure サービスです。 Azure Monitor ログは、多くのサービスからテレメトリを収集できます。また、このサービスを使用して、クエリを実行し、アラートを設定することもできます。
...
* [Azure Monitor ログ](../../sql-database/saas-dbpertenant-log-analytics.md) - Azure Monitor ログ チュートリアルの設定と使用
