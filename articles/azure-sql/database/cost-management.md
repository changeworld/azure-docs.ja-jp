...
ここでは、コストを自分で調べることができます。 さまざまなコスト分析設定の詳細については、「[コストの分析を開始する](../../cost-management/cost-mgt-alerts-monitor-usage-spending.md?WT.mc_id=costmanagementcontent_docsacmhorizontal_-inproduct-learn)」を参照してください。
