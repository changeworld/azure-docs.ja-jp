...
[パート 2](predictive-model-build-compare-tutorial.md) では、R で複数の機械学習モデルを作成してトレーニングしてから、最も正確なものを選ぶ方法を学習しました。

## <a name="prerequisites"></a>前提条件

* このチュートリアル シリーズのパート 3 では、[**パート 1**](predictive-model-prepare-data-tutorial.md) と[**パート 2**](predictive-model-build-compare-tutorial.md) が完了していることを前提とします。
