...
![トレーニング済みのモデルと追加の出力](./media/r-train-score-model-create-quickstart/r-train-model-with-additional-output.png)
...
2. これらの新しい速度値から停止距離を予測します。
   ...
   **結果**
   ...
   ![停止距離を予測するための結果セット](./media/r-train-score-model-create-quickstart/r-predict-stopping-distance-resultset.png)
