...
* 最新バージョンの SQL Server Management Studio (SSMS) のインストール。 [SSMS をダウンロードしてインストールします](/sql/ssms/download-sql-server-management-studio-ssms)。
...
詳細については、[Elastic Database ジョブ](./elastic-jobs-overview.md)に関する記事を参照してください。
