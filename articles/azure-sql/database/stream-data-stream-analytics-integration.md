...
ms.locfileid: "84030553"
---
# <a name="stream-data-into-azure-sql-database-using-stream-analytics-integration-preview"></a>Stream Analytics 統合を使用して Azure SQL Database にデータをストリーム配信する (プレビュー)
...
> [!IMPORTANT]
> Azure Stream Analytics ジョブは、Azure SQL Database、Azure SQL Managed Instance、または Azure Synapse (以前の Azure SQL Data Warehouse) に出力できます。 詳細については、「[出力](../../stream-analytics/stream-analytics-define-outputs.md#sql-database)」を参照してください。
