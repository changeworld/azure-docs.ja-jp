...
![データ同期の監視ダッシュボード](./media/sql-data-sync-monitor-sync/sync-monitoring-dashboard.png)
...
![データ同期の電子メール通知](./media/sql-data-sync-monitor-sync/sync-email-notifications.png)
...
-   Data Sync Agent - [Azure の SQL データ同期の Data Sync Agent](sql-data-sync-agent-overview.md)
...
-   同期スキーマの更新
    -   Transact-SQL の場合 - [Azure の SQL データ同期でスキーマ変更のレプリケーションを自動化する](sql-data-sync-update-sync-schema.md)
...
-   [SQL Database の概要](../../sql-database/sql-database-technical-overview.md)
