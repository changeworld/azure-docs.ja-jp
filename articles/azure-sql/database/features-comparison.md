...
| [透過的なデータ暗号化 (TDE)](/sql/relational-databases/security/encryption/transparent-data-encryption-tde) | はい - General Purpose、Business Critical、Hyperscale (プレビュー) サービス レベルのみ| [はい](transparent-data-encryption-tde-overview.md) |
| Windows 認証 | いいえ | いいえ |
