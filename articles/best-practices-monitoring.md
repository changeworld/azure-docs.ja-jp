...
#### <a name="_pulling-and-pushing-instrumentation-data_"></a>*インストルメンテーション データのプルとプッシュ*
...
#### <a name="_consolidating-instrumentation-data_"></a>*インストルメンテーション データの統合*
...
#### <a name="_log-rotation-and-data-retention_"></a>*ログのローテーションとデータの保持*
...
#### <a name="_down-sampling_"></a>*ダウン サンプリング*
