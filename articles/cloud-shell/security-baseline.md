...
**ガイダンス** :Azure Cloud Shell は、Azure portal へのアクセスに使用されるときと同じ認可を使用するブラウザー ベースのコマンドライン エクスペリエンスです。この場合、Azure portal に接続するために必要な MFA が Cloud Shell でも必要になります。 
