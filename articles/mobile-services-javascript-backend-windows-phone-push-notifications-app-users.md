...
このチュートリアルが対象とするのは、Windows Phone 8.0 および Windows Phone 8.1 ("Silverlight") のアプリケーションです。Windows Phone 8.1 ストア アプリについては、[このトピックの Windows ストア バージョン] (mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users.md) を参照してください。
