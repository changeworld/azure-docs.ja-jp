---
title: "Azure CLI のサンプル スクリプト - テンプレートのデプロイ | Microsoft Docs"
...
---
# <a name="azure-resource-manager-template-deployment---azure-cli-script"></a>Azure Resource Manager テンプレートのデプロイ - Azure CLI スクリプト
