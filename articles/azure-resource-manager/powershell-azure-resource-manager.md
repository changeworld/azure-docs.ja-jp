...
## <a name="move-a-resource"></a>リソースの移動
...
### <a name="download-template-from-deployment"></a>デプロイからテンプレートをダウンロードする
