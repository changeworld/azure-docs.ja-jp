...
| Microsoft.Billing | [Cost Management と Billing](/azure/billing/) |
...
| Microsoft.SerialConsole | [Windows 用 Azure シリアル コンソール](../../virtual-machines/troubleshooting/serial-console-windows.md) |
...
リソース プロバイダーの詳細については、「[Azure リソース プロバイダーと種類](resource-providers-and-types.md)」を参照してください
