...
クラシック リソースを同じサブスクリプション内の新しリソース グループに移動するには、ポータル、Azure PowerShell、Azure CLI、または REST API による[標準の移動操作](../move-resource-group-and-subscription.md)を使用します。 Resource Manager のリソースの移動に使用した方法と同じ操作を使用します。
