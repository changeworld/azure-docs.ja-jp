...
## <a name="linking-in-templates"></a>テンプレートでのリンク
...
## <a name="linking-with-rest-api"></a>REST API を使用したリンク
...
リンクに関する情報の取得方法など、その他の例については、[リンクされたリソース](https://docs.microsoft.com/rest/api/resources/resourcelinks)に関するページを参照してください。
