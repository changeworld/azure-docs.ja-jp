...
# クイック スタート
## [テンプレートの作成 - ポータル](resource-manager-quickstart-create-templates-use-the-portal.md)
## [テンプレートの作成 - VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [テンプレートの作成 - Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
