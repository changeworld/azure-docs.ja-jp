...
---
# <a name="audit-operations-with-resource-manager"></a>リソース マネージャーの監査操作
...
## <a name="portal-to-view-activity-logs"></a>アクティビティ ログを表示するポータル
...
## <a name="powershell-to-view-activity-logs"></a>アクティビティ ログを表示する PowerShell
...
## <a name="azure-cli-to-view-activity-logs"></a>アクティビティ ログを表示する Azure CLI
...
## <a name="rest-api-to-view-audit-logs"></a>監査ログを表示する REST API
