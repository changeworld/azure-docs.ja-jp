...
リンター ルールの適用方法をカスタマイズできます。 既定の設定を上書きするには、**bicepconfig.json** ファイルを追加し、カスタム設定を適用します。 これらの設定の適用方法の詳細については、「[Bicep 構成ファイルにカスタム設定を追加する](bicep-config.md)」を参照してください。
...
* リンター ルールのカスタマイズ方法の詳細については、「[Bicep 構成ファイルにカスタム設定を追加する](bicep-config.md)」を参照してください。
