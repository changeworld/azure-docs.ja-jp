...
1. Azure Deployment Manager ロールアウトの一環として 1 つまたは複数の healthCheck 手順を作成します。 healthCheck 手順に次の情報を入力します。
    ...
    次の JSON は、その他すべての正常性監視プロバイダーの例です。
