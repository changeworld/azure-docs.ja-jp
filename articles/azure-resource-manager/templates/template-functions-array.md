...
| Name | 種類 | 値 |
| ---- | ---- | ----- |
| stringOutput | String | 既定値 (default) |
| intOutput | int | 1 |
...
この関数を配列と共に使用する方法の詳細については、「 [Azure リソース マネージャーでリソースの複数のインスタンスを作成する](create-multiple-instances.md)」をご覧ください。
