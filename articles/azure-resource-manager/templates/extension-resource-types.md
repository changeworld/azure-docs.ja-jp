...
- Azure Resource Manager テンプレートで拡張リソースのリソース ID を取得するには、[extensionResourceId](template-functions-resource.md#extensionresourceid) を使用します。
