...
マネージド アプリケーションを Azure Marketplace に発行する方法については、[Marketplace アプリケーションの作成](../../marketplace/partner-center-portal/create-new-azure-apps-offer.md)に関する記事をご覧ください。
