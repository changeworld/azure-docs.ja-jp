<properties pageTitle="データへのページングの追加 (JavaScript) - Azure Mobile Services" metaKeywords="" description="ページングを使用して、Mobile Services から Windows ストア JavaScript アプリに返されるデータの量を管理する方法について説明します。" metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Refine Mobile Services queries with paging" authors="glenga" solutions="" manager="dwrede" editor="" />
