<properties pageTitle="データへのページングの追加 (JavaScript) - Azure Mobile Services" description="ページングを使用してデータの量を管理する方法について説明します。ata returned to your Windows Store JavaScript app from Mobile Services." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
