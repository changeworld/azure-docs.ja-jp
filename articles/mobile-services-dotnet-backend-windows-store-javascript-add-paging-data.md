<properties pageTitle="データへのページングの追加 (JavaScript) | Azure のモバイル サービス" metaKeywords="" description="ページングを使用して、モバイル サービスから Windows ストア JavaScript アプリケーションに返されるデータの量を管理する方法について説明します。" metaCanonical="http://www.windowsazure.com/ja-jp/develop/mobile/tutorials/add-paging-to-data-dotnet/" services="" documentationCenter="Mobile" title="ページングを使用したモバイル サービス クエリの改善" authors="" solutions="" manager="" editor="" />
