...
1. **[チャネルの作成]** をクリックします。![wirecast](./media/media-services-wirecast-live-encoder/media-services-wirecast2.png)
...
> [!IMPORTANT]
> **[ストリーム]** をクリックする前に、チャネルの準備が整っていることを確認する**必要**があります。また、15 分を超える入力投稿フィードがある場合を除き、チャネルを準備可能のままにしないでください。
> 
> 
