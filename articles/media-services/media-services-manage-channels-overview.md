...
---
# <a name="overview-of-live-steaming-using-azure-media-services"></a>Azure Media Services を使用したライブ ストリーミングの概要
...
| 料金 |[価格に関するページ](/pricing/details/media-services/) を参照し、[ライブ ビデオ] タブをクリックしてください。 | [価格に関するページ](/pricing/details/media-services/) |
