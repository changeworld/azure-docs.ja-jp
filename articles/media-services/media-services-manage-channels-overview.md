...
1. ビデオ カメラをコンピューターに接続します。複数ビットレ0ートの RTMP や Fragmented MP4 (スムーズ ストリーミング) ストリームを出力する内部設置型のライブ エンコーダーを起動して構成します。詳しくは、「[Azure Media Services RTMP サポートおよびライブ エンコーダー](http://go.microsoft.com/fwlink/?LinkId=532824)」をご覧ください。
