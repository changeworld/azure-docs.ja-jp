...
---
<a id="protecting-content-overview" class="xliff"></a>
# コンテンツ保護の概要
...
<a id="dynamic-encryption" class="xliff"></a>
## 動的な暗号化
...
<a id="storage-encryption" class="xliff"></a>
## ストレージ暗号化
...
<a id="token-restriction" class="xliff"></a>
## トークン制限
...
<a id="streaming-urls" class="xliff"></a>
## ストリーミング URL
...
<a id="additional-scenarios" class="xliff"></a>
### その他のシナリオ
