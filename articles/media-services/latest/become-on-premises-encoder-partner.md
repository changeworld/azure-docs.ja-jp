...
description: Azure Media Services でオンプレミス エンコーダー パートナーになります。
...
ms.locfileid: "78253148"
---
# <a name="become-an-on-premises-encoder-partner"></a>オンプレミス エンコーダー パートナーになる
...
[推奨のオンプレミス ライブ エンコーダー](recommended-on-premises-live-encoders.md)
