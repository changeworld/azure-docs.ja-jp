...
1. Media Services アカウントで、**ストリーミング エンドポイント** が実行されていることを確認します。 
2. **ライブ エンコード** Live Event を作成し、起動します。 <br/> 詳細については、[ライブ イベントの状態と課金](live-event-states-billing-concept.md)に関するページを参照してください。
...
[テスト済みのオンプレミス エンコーダー](encode-recommended-on-premises-live-encoders.md)
