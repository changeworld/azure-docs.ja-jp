---
title: カスタマー マネージド キーまたは BYOK を使用する
...
ms.locfileid: "92740479"
---
# <a name="tutorial-use-customer-managed-keys-or-byok-with-media-services"></a>チュートリアル:Media Services でカスタマー マネージド キーまたは BYOK を使用する
