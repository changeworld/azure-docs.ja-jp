...
* 1 つの資産で、ダイナミック パッケージと動的暗号化の設定が異なる複数の[ストリーミング ロケーター](streaming-locators-concept.md)を持つことができます。
...
* ライブ イベント プレビューは、ダイナミック パッケージと動的暗号化をサポートしています。 そのため、プレビューだけでなく、DASH および HLS パッケージに対するコンテンツ保護が可能です。
