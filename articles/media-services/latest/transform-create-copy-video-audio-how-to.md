---
title: CopyVideo CopyAudio 変換を作成する
description: Media Services API を使用して CopyVideo CopyAudio 変換を作成します。
...
ms.locfileid: "106281535"
---
# <a name="create-a-copyvideo-copyaudio-transform"></a>CopyVideo CopyAudio 変換を作成する

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

この記事では、`CopyVideo/CopyAudio` 変換を作成する方法を示します。
