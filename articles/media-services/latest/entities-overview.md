...
ms.locfileid: "54912648"
---
# <a name="azure-media-services-entities-overview"></a>Azure Media Services エンティティの概要

この記事では、Azure Media Services エンティティの概要を説明し、Media Services ワークフローでの各エンティティの使用方法に関する詳細な記事を紹介します。 
...
| [ライブ イベントとライブ出力](live-events-outputs-concept.md)|Media Services では、Azure クラウドで顧客にライブ イベントを配信することができます。 Media Services v3 でライブ ストリーミング イベントを構成するには、[ライブ イベント](https://docs.microsoft.com/rest/api/media/liveevents)と[ライブ出力](https://docs.microsoft.com/rest/api/media/liveoutputs)について理解する必要があります。|
