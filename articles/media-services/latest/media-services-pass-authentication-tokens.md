...
## <a name="pass-a-token-via-the-addition-of-a-url-query-parameter-with-tokentokenvalue"></a>"token=tokenvalue" で URL クエリ パラメーターを追加することでトークンを渡す
