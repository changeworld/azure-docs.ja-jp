...
[.NET SDK](https://aka.ms/ams-v3-dotnet-sdk) を使用します。

Media Services の [.NET リファレンス](https://aka.ms/ams-v3-dotnet-ref) ドキュメントを参照してください。

### <a name="java"></a>Java

[Java SDK](https://aka.ms/ams-v3-java-sdk) を使用します。

Media Services の [Java リファレンス](https://aka.ms/ams-v3-java-ref) ドキュメントを確認してください。

### <a name="nodejs"></a>Node.js

[Node.js SDK](https://aka.ms/ams-v3-nodejs-sdk) を使用します。
