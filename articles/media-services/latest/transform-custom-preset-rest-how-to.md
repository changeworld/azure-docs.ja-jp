...
- [Azure Media Services REST API を呼び出すように Postman を構成します](setup-postman-rest-how-to.md)。<br/>トピック「[Azure AD トークンを取得する](setup-postman-rest-how-to.md#get-azure-ad-token)」の最後の手順を必ず実行してください。 
