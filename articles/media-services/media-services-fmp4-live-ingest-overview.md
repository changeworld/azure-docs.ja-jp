<properties 
	pageTitle="Azure Media Services の Fragmented MP4 ライブ インジェスト仕様 | Microsoft Azure" 
...
##手順 3.ビットストリーム形式 – ISO 14496-12 Fragmented MP4
...
8. MP4 フラグメントのタイムスタンプとインデックス (TrackFragmentExtendedHeaderBox fragment _absolute_ time と fragment\_index) は昇順で配信される必要があります。Azure Media Services は、重複フラグメントに対する回復力はありますが、メディア タイムラインに従ってフラグメントの順序を変更するには機能が非常に限定されています。
