...
#<a name="using-playready-and/or-widevine-dynamic-common-encryption"></a>Using PlayReady and/or Widevine dynamic common encryption
...
##<a name="configuring-dynamic-common-encryption-and-drm-license-delivery-services"></a>Configuring Dynamic Common Encryption and DRM License Delivery Services
...
##<a name="create-an-asset-and-upload-files-into-the-asset"></a>Create an asset and upload files into the asset
...
##<a name="encode-the-asset-containing-the-file-to-the-adaptive-bitrate-mp4-set"></a>Encode the asset containing the file to the adaptive bitrate MP4 set
...
##<a name="<a-id="create_contentkey"></a>create-a-content-key-and-associate-it-with-the-encoded-asset"></a><a id="create_contentkey"></a>Create a content key and associate it with the encoded asset
...
##<a name="<a-id="configure_key_auth_policy"></a>configure-the-content-key’s-authorization-policy"></a><a id="configure_key_auth_policy"></a>Configure the content key’s authorization policy
...
##<a name="<a-id="configure_asset_delivery_policy"></a>configure-asset-delivery-policy"></a><a id="configure_asset_delivery_policy"></a>Configure asset delivery policy 
...
##<a name="<a-id="create_locator"></a>create-an-ondemand-streaming-locator-in-order-to-get-a-streaming-url"></a><a id="create_locator"></a>Create an OnDemand streaming locator in order to get a streaming URL
...
##<a name="get-a-test-token"></a>Get a test token
...
##<a name="<a-id="example"></a>example"></a><a id="example"></a>Example
