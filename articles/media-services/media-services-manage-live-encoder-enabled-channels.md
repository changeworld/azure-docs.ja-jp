...
*  [一般的なライブ ストリーミング シナリオ](media-services-manage-live-encoder-enabled-channels.md#scenario)
...
## <a name="a-idchannelachannels-input-ingest-configurations"></a><a id="channel"></a>チャネル入力 (取り込み) の構成
### <a name="a-idingestprotocolsaingest-streaming-protocol"></a><a id="Ingest_Protocols"></a>取り込みストリーミング プロトコル
...
#### <a name="a-idsinglebitratertmpasingle-bitrate-rtmp"></a><a id="single_bitrate_RTMP"></a>シングル ビットレート RTMP
考慮事項:
...
### <a name="a-idpresetasystem-preset"></a><a id="preset"></a>システム プリセット
...
### <a name="a-iddefaultslateadefault-slate-asset-id"></a><a id="default_slate"></a>既定のスレート アセット ID
...
## <a name="a-idstatesachannel-states-and-how-states-map-to-the-billing-mode"></a><a id="states"></a>チャネルの状態と課金モードとの対応
現在のチャネルの状態。 指定できる値は、次のとおりです。
...
### <a name="how-to-create-channels-that-perform-live-encoding-from-a-singe-bitrate-to-adaptive-bitrate-stream"></a>シングル ビットレートからアダプティブ ビットレート ストリームへのライブ エンコードを実行するチャネルを作成する方法
**ポータル**、**.NET**、**REST API** のいずれかを選択して、チャネルとプログラムの作成および管理方法を確認してください。
