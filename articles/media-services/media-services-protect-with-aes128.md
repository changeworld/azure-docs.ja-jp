...
##<a name="<a-id="create_asset"></a>create-an-asset-and-upload-files-into-the-asset"></a><a id="create_asset"></a>Create an asset and upload files into the asset
...
##<a name="<a-id="encode_asset"></a>encode-the-asset-containing-the-file-to-the-adaptive-bitrate-mp4-set"></a><a id="encode_asset"></a>Encode the asset containing the file to the adaptive bitrate MP4 set
...
##<a name="<a-id="client_request"></a>how-can-your-client-request-a-key-from-the-key-delivery-service?"></a><a id="client_request"></a>How can your client request a key from the key delivery service?
