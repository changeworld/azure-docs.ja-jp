...
[Azure メディア エンコーダーのインポート形式](#import_formats)

[Azure メディア エンコーダーのエクスポート形式](#export_formats)


##<a id="import_formats"></a>Azure メディア エンコーダーのインポート形式 
...
##<a id="export_formats"></a>Azure メディア エンコーダーのエクスポート形式
