...
* ユーザーが Web アプリケーションで Azure AD にサインインします。 詳しくは、「[Web ブラウザー対 Web アプリケーション](../../active-directory/develop/active-directory-authentication-scenarios.md#web-browser-to-web-application)」をご覧ください。
