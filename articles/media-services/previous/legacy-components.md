...
|---|---|
|Azure Media Indexer 2|2020 年 1 月 1 日|このメディア プロセッサは、[Azure Media Services Video Indexer](../video-indexer/index.yml) に置き換えられます。 詳細については、「[Media Indexer と Media Indexer 2 から Video Indexer に移行する](migrate-indexer-v1-v2.md)」をご覧ください。|
|[Azure Media Indexer](media-services-index-content.md)|2023 年 3 月 1 日|このメディア プロセッサは、[Azure Media Services Video Indexer](../video-indexer/index.yml) に置き換えられます。 詳細については、[Azure Media Indexer から Azure Media Services Video Indexer に移行する](migrate-indexer-v1-v2.md)方法に関するページをご覧ください。|
