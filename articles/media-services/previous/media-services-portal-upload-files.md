...
ms.locfileid: "55976794"
---
# <a name="upload-files-to-a-media-services-account-in-the-azure-portal-legacy"></a>Azure portal での Media Services アカウントへのファイルのアップロード (レガシ)
