...
ms.locfileid: "55979668"
---
# <a name="media-services-documentation-legacy"></a>Media Services のドキュメント (レガシ)
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://docs.microsoft.com/powershell/azure/servicemanagement/install-azure-ps?view=azuresmps-4.0.0">PowerShell (サービス管理)</a></p>
                    </div>
                </div>
            </div>
        </div>
