...
---
# <a name="dynamic-encryption-configure-a-content-key-authorization-policy"></a>Dynamic encryption: Configure a content key authorization policy
...
## <a name="aes-128-dynamic-encryption"></a>AES-128 dynamic encryption
