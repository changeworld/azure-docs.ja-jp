...
---
# <a name="smooth-streaming-protocol-ms-sstr-ammendment-for-hevc"></a>HEVC のための Smooth Streaming Protocol (MS-SSTR) の変更
...
>   **デコード時間:** [クライアントでサンプルをデコードすのに要する時間。[ISO/IEChttp://go.microsoft.com/fwlink/?LinkId=18369514496-12]](http://go.microsoft.com/fwlink/?LinkId=183695) で定義。
