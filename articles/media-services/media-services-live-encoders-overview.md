<properties 
    pageTitle="Azure Media Services を使用してマルチビットレートのストリームを作成するときにオンプレミス エンコーダーを構成する方法 | Microsoft Azure" 
...
#<a name="how-to-configure-on-premise-encoders-when-using-azure-media-services-to-create-multi-bitrate-streams"></a>Azure Media Services を使用してマルチビットレートのストリームを作成するときにオンプレミス エンコーダーを構成する方法
...
単一ビットレート ライブ ストリームが AMS チャネルに送信されるように [Elemental Live](http://www.elementaltechnologies.com/products/elemental-live) エンコーダーを構成する方法については、[Elemental Live の構成](media-services-configure-elemental-live-encoder.md)に関するページをご覧ください。
