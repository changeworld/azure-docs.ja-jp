---
title: HTTP 拡張機能のデータ コントラクト - Azure
description: この記事では、HTTP プロトコルを使用して、Live Video Analytics モジュールと AI または CV モジュールの間でメッセージを送信する方法について説明します。
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88701958"
---
# <a name="http-extension-data-contract"></a>HTTP 拡張機能のデータ コントラクト

この記事では、HTTP プロトコルを使用して、Live Video Analytics モジュールと AI または CV モジュールの間でメッセージを送信する方法について説明します。
...
![クラス階層](./media/http-data-contract/class-hierarchy.png)
