...
Docker を使用して簡単にカスタム構成で Telegraf イメージを作成できます。 この詳細については、[監視とログ記録](monitoring-logging.md#azure-monitor-collection-using-telegraf)に関するページをご覧ください。
