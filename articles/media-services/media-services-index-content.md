...
このトピックでは、ジョブのインデックスを作成して、**資産のインデックス**と**複数のファイルのインデックス**を作成する方法について説明します。
