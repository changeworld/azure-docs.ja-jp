...
動的パッケージや動的暗号化の使用をお勧めします。 これらの機能を使用するには、ストリーミング元となるエンドポイントに、少なくとも&1; つのストリーミング ユニットが必要です。 詳細については、[ストリーミング ユニットの拡張](media-services-portal-manage-streaming-endpoints.md)に関するページをご覧ください。
