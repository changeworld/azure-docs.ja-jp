...
2. [Linux](../iot-edge/how-to-install-iot-edge.md) または [Windows](../iot-edge/how-to-install-iot-edge.md) IoT Edge ゲートウェイを登録して起動し、その `device id` をメモします。
