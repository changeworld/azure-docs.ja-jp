...
1. リモート監視ソリューション アクセラレータ Web UI の **[デバイス]** ページで IoT Edge デバイスを追加します。
...
リモート監視ソリューション アクセラレータの IoT ハブにデバイスを直接登録すると、それが Web UI の **[デバイス]** ページに表示されます。
