---
title: Azure にクラウドベースの IoT 予測メンテナンス ソリューションをデプロイする | Microsoft Docs
...
ms.locfileid: "38972915"
---
# <a name="quickstart-deploy-a-cloud-based-solution-to-run-a-predictive-maintenance-analysis-on-my-connected-devices"></a>クイック スタート: クラウドベースのソリューションをデプロイして、接続されたデバイスの予測メンテナンス分析を実行する

このクイック スタートでは、Azure IoT 予測メンテナンス ソリューション アクセラレータをデプロイして、IoT デバイス用のクラウドベースの予測メンテナンス ソリューションとして使用する方法を説明します。 ソリューション アクセラレータをデプロイしたら、ソリューションの **[ダッシュボード]** ページで、航空機エンジン データを使用してシミュレーションを実行します。
...
**[Create Predictive Maintenance solution]\(予測メンテナンス ソリューションの作成\)** ページで予測メンテナンス ソリューション アクセラレータの一意の**ソリューション名**を入力します。
...
Azure サブスクリプションへのデプロイが完了すると、予測メンテナンス ソリューション アクセラレータ ダッシュボードにサインインできます。
...
ソリューション アクセラレータの詳細については、次の記事を参照してください。
