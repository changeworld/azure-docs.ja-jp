...
デバイス状態オブジェクトを更新する JavaScript ファイルの詳細については、[デバイスモデルの動作の概要](iot-accelerators-remote-monitoring-device-behavior.md)に関する記事を参照してください。
...
デバイスの動作を実装する JavaScript ファイルの詳細については、[デバイス モデルの動作の概要](iot-accelerators-remote-monitoring-device-behavior.md)に関する記事を参照してください。
