...
2. ディレクトリを、"..azure-iot-pcs-remote-monitoring-dotnet/iothub-manager/WebService/v1/Controllers" に変更します。
...
5. ターミナルに戻り、今度は "...azure-iot-pcs-remote-monitoring-dotnet/iothub-manager/scripts/docker" ディレクトリに変更します。
