<properties urlDisplayName="Migrate from IIS to Azure Websites with Migration Assistant" pageTitle="Migration Assistant を使用して IIS の Web サイトを Azure Websites に移行する"metakeywords ="Azure Websites,移行,移行する,IIS" description="Shows how to use Azure Websites Migration Assistant to quickly migrate existing IIS websites to Azure Websites" metaCanonical="" services="web-sites" documentationCenter="" title="Migrate your IIS Websites to Azure Websites using the Migration Assistant" authors="cephalin,anwestg"  solutions="" writer="cephalin" manager="wpickett" editor=""  />
