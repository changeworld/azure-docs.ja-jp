...
* 復旧サイトのネットワーク用に異なる IP アドレス範囲を使用する。 このシナリオでは、フェールオーバー後の仮想マシンに、新しい IP アドレスが割り当てられます。この場合 DNS の更新は管理者が行う必要があります。 DNS の更新方法については、[こちら](site-recovery-vmm-to-vmm.md#step-7-test-your-deployment)をご覧ください。 
...
[こちらの記事](site-recovery-network-mapping.md) を参照してください。
