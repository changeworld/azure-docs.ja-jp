...
8. **ターゲットの場所**を選択します。
9. **[Disk encryption key vaults]\(ディスク暗号化キー コンテナー)**: 既定では、Azure Site Recovery によって、ソース VM ディスク暗号化キーに基づく "asr" というサフィックスが付いた名前の新しいキー コンテナーが、ターゲット リージョン内に作成されます。 Azure Site Recovery によって作成されたキー コンテナーが既に存在する場合は、それが再利用されます。 必要な場合は一覧から別のキー コンテナーを選択できます。
10. **[Key encryption key vaults]\(キー暗号化キー コンテナー)**: 既定では、Azure Site Recovery によって、ソース VM キー暗号化キーに基づく "asr" というサフィックスが付いた名前の新しいキー コンテナーが、ターゲット リージョン内に作成されます。 Azure Site Recovery によって作成されたキー コンテナーが既に存在する場合は、それが再利用されます。 必要な場合は一覧から別のキー コンテナーを選択できます。
