...
> [!NOTE]
> [Migration of storage accounts](../resource-group-move-resources.md)を同じサブスクリプション内のリソース グループ間、またはサブスクリプション間で行うことは、Site Recovery のデプロイ用のストレージ アカウントではサポートされていません。
> 
> 
...
> [!NOTE]
> [Migration of networks](../resource-group-move-resources.md)を同じサブスクリプション内のリソース グループ間、またはサブスクリプション間で行うことは、Site Recovery のデプロイ用のネットワークではサポートされていません。
> 
> 
