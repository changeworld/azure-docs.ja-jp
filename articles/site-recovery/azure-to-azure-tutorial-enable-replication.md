...
1. 暗号化の設定を確認します。
    - **[Disk encryption key vaults]\(ディスク暗号化キー コンテナー)**: 既定では、Azure Site Recovery によって、ソース VM ディスク暗号化キーに基づく "asr" というサフィックスが付いた名前の新しいキー コンテナーが、ターゲット リージョン内に作成されます。 Azure Site Recovery によって作成されたキー コンテナーが既に存在する場合は、それが再利用されます。
    - **[Key encryption key vaults]\(キー暗号化キー コンテナー)**: 既定では、Azure Site Recovery によって、ソース VM キー暗号化キーに基づく "asr" というサフィックスが付いた名前の新しいキー コンテナーが、ターゲット リージョン内に作成されます。 Azure Site Recovery によって作成されたキー コンテナーが既に存在する場合は、それが再利用されます。
