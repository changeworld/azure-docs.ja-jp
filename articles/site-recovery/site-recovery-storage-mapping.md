---
title: "オンプレミス データセンター間で Hyper-V 仮想マシンをレプリケーションするために、Azure Site Recovery の記憶域をマップする | Microsoft Docs"
...
---
# <a name="prepare-storage-mapping-for-hyper-v-virtual-machine-replication-between-two-on-premises-datacenters-with-azure-site-recovery"></a>Azure Site Recovery を使用して 2 つのオンプレミス データセンター間で Hyper-V 仮想マシンをレプリケーションするために、記憶域マッピングを準備する
...
## <a name="set-up-storage-classifications-for-hyper-v-replication"></a>Hyper-V レプリケーション用に記憶域分類を設定する
