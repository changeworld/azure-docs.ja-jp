...
> * セカンダリ サイトからプライマリ サイトにレプリケートし、フェールバックする
...
## <a name="reprotect-and-fail-back-from-secondary-to-primary"></a>セカンダリからプライマリへのレプリケートとフェールバック
...
### <a name="reprotect-and-fail-back"></a>レプリケートとフェールバック
