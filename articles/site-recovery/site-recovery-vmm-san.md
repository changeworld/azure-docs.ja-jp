...
5. **[リージョン]** ボックスで、コンテナーのリージョンを選択します。サポートされているリージョンを確認するには、「[Azure Site Recovery Pricing Details (Azure Site Recovery の価格の詳細)](href="http://go.microsoft.com/fwlink/?LinkId=389880)」で利用可能地域を参照してください。
