...
**ルール** |  **詳細** | **サービス タグ**
--- | --- | --- 
HTTPS の送信を許可する: ポート 443 | ソース リージョンのストレージ アカウントに対応する範囲を許可します | Storage.<リージョン名>.
...
**ルール** |  **詳細** | **サービス タグ**
--- | --- | --- 
HTTPS の送信を許可する: ポート 443 | ターゲット リージョンのストレージ アカウントに対応する範囲を許可します。 | Storage.<リージョン名>.
