...
VMware サイトから Azure | サポートされている (拡張のシナリオ)<br/><br/>サポートされていません (従来のシナリオ) |このシナリオでは連続レプリケーションを使用するため、計画されたフェールオーバーと計画されていないフェールオーバーの間に違いはありません。**[フェールオーバー]** を選択します。 | 該当なし
