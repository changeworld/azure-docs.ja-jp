---
title: "Azure Site Recovery を使用した Azure への Hyper-V レプリケーションのアーキテクチャを確認する | Microsoft Docs"
...
![アーキテクチャ](./media/concepts-hyper-v-to-azure-architecture/arch-onprem-azure-hypervsite.png)
...
![コンポーネント](./media/concepts-hyper-v-to-azure-architecture/arch-onprem-onprem-azure-vmm.png)



## <a name="replication-process"></a>レプリケーション プロセス

![Hyper-V から Azure へのレプリケーション](./media/concepts-hyper-v-to-azure-architecture/arch-hyperv-azure-workflow.png)
...
4. ジョブは **[ジョブ]** タブで監視できます。    ![ジョブ一覧](media/concepts-hyper-v-to-azure-architecture/image1.png) ![[保護を有効にする] の詳細](media/concepts-hyper-v-to-azure-architecture/image2.png)
...
サポート マトリックスを確認します。Hyper-V から Azure へのレプリケーションを有効にするチュートリアルに従ってください。
