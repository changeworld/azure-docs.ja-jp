...
2. オンプレミスの [VMware](tutorial-prepare-on-premises-vmware.md) または Hyper-V サーバーの準備。

開始する前に、ディザスター リカバリーのために [VMware](concepts-vmware-to-azure-architecture.md) または [Hyper-V](concepts-hyper-v-to-azure-architecture.md) アーキテクチャを確認しておくと役立ちます。
...
6. ダッシュボードからコンテナーにすばやくアクセスするには、**[ダッシュボードにピン留めする]**、**[作成]** の順にクリックします。
   ...
   ![新しいコンテナー](./media/tutorial-migrate-on-premises-to-azure/onprem-to-azure-vault.png)
...
> Azure VM の[ディザスター リカバリーの設定](site-recovery-azure-to-azure-after-migration.md) (オンプレミス サイトからの移行後)
