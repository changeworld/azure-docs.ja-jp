...
![専用ホスティング ソリューションのアーキテクチャの違いは、各テナントのインフラストラクチャがそのテナントに対してのみ設定されている点であることを示す図。](./media/vmware-azure-multi-tenant-overview/dedicated-hosting-scenario.png)  
