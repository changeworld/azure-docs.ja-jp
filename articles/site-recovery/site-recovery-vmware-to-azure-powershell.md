---
title: "Azure Site Recovery PowerShell を使用して VMware の仮想マシンを Azure にフェールオーバーおよびレプリケートする | Microsoft Docs"
description: "Azure Site Recovery PowerShell を使用して VMware の仮想マシンを Azure にフェールオーバーおよびレプリケートする"
...
---
# <a name="replicate-and-failover-vmware-virtual-machines-to-azure-using-azure-site-recovery-powershell"></a>Azure Site Recovery PowerShell を使用して VMware の仮想マシンを Azure にフェールオーバーおよびレプリケートする
...
開始する前に次の操作を実行してください。
- [シナリオのアーキテクチャとコンポーネント](concepts-vmware-to-azure-architecture.md)を理解している。
...
* [保護の目標を選択する](site-recovery-set-up-vmware-to-azure.md#choose-your-protection-goals)
* [ソース環境をセットアップする](site-recovery-set-up-vmware-to-azure.md#set-up-the-source-environment) 
...
## <a name="add-a-vcenter-server-and-discover-vmware-virtual-machines"></a>vCenter サーバーを追加して、VMware 仮想マシンを検出する
