...
ゲスト/サーバー VMDK | [はい] 
ゲスト/サーバー EFI/UEFI| 一部 (Windows Server 2012 以降の Azure への移行のみ) </br></br> ** この表の下部の注意事項をご覧ください。
...
ストライピングされたディスクのゲスト/サーバー ボリューム > 1 TB<br/><br/> LVM 論理ボリューム管理ゲスト/サーバー - 記憶領域 |いいえ ゲスト/サーバー ホット アド/ディスク削除 | いいえ ゲスト/サーバー - ディスクの除外 | はい ゲスト/サーバー マルチ パス (MPIO) | 該当なし
