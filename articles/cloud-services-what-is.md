<properties urlDisplayName="What is a Cloud Service" pageTitle="クラウド サービスとは - Azure のサービス管理" metaKeywords="Azure cloud services intro, cloud services overview, cloud services basics" description="Azure のクラウド サービスの紹介です。" metaCanonical="" services="cloud-services" documentationCenter="" title="クラウド サービスとは" authors="ryanwi" solutions="" manager="timlt" editor="" />
