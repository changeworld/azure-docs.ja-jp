...
監視と推奨事項は、[クラシック デプロイ モデルと Resource Manager デプロイ モデル](/azure/security-center/./azure-resource-manager/management/deployment-models)のどちらで作成された仮想マシン (VM) でも利用できます。
