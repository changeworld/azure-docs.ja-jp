...
## <a name="recs-network"></a>ネットワークの推奨事項
...
## <a name="recs-containers"></a>コンテナーの推奨事項
...
## <a name="recs-appservice"></a>App Service の推奨事項
...
## <a name="recs-computeapp"></a>コンピューティングとアプリの推奨事項
...
## <a name="recs-vmscalesets"></a>仮想マシン スケール セットに関する推奨事項
...
## <a name="recs-datastorage"></a>データとストレージの推奨事項
...
## <a name="recs-identity"></a>ID とアクセスの推奨事項
