...
このチュートリアルで説明されている機能を実行するには、Azure Defender が有効になっている必要があります。 Azure Defender は無料でお試しいただけます。 詳細については、[Azure Defender の試用](security-center-pricing.md)に関するページを参照してください。
