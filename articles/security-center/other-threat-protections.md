...
組み込みの [Microsoft Defender の高度な保護計画](defender-for-cloud-introduction.md)と同様に、Microsoft Defender for Cloud には、次の脅威の防止機能も用意されています。
...
## <a name="display-defender-for-cloud-recommendations-in-microsoft-defender-for-cloud-apps"></a>Microsoft Defender for Cloud Apps で Defender for Cloud の推奨事項を表示する <a name="azure-mcas"></a>
...
Microsoft Defender for Cloud Apps を有効にし、Defender for Cloud の設定内から統合を選択した場合は、Defender for Cloud からのセキュリティ強化に関する推奨事項が Microsoft Defender for Cloud Apps に表示されます。追加の構成は必要はありません。
