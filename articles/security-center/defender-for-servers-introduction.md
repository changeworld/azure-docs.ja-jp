...
- **Microsoft Defender for Endpoint の統合ライセンス (Windows のみ)** - Azure Defender for servers には、[Microsoft Defender for Endpoint](https://www.microsoft.com/microsoft-365/security/endpoint-defender) が含まれています。 同時に、包括的なエンドポイントの検出と対応 (EDR) 機能が提供されます。 [詳細については、こちらを参照してください](security-center-wdatp.md)。
