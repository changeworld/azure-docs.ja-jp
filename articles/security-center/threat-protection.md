...
* **Azure データ リソースの脅威の防止**: SQL Database と Azure Synapse Analytics (旧称 SQL Data Warehouse)、Azure Storage、Azure Cosmos DB
...
## <a name="threat-protection-for-sql-database-and-azure-synapse-analytics-formerly-sql-data-warehouse"></a>SQL Database および Microsoft Azure Synapse Analytics (旧称 SQL Data Warehouse) の脅威の防止 <a name="data-sql"></a>
...
* [SQL Database および Microsoft Azure Synapse Analytics (旧称 SQL Data Warehouse) の脅威の防止アラートの一覧](alerts-reference.md#alerts-sql-db-and-warehouse)
