...
> [!TIP]
> より高度で多彩な調査環境を確立したければ、「[Azure アクティビティ ログからデータを接続する](../sentinel/data-connectors-reference.md#azure-activity)」の説明に従って、Azure のアクティビティ ログを Azure Sentinel にストリーム配信してください。
