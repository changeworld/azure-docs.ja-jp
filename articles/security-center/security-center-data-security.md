...
**Azure Security Center Storage**: パートナーの警告を含めたセキュリティの警告に関する情報は、関連する Azure リソースの場所に応じたリージョンに格納されます。一方、セキュリティの正常性状態と推奨事項に関する情報については、お客様の場所に応じて米国またはヨーロッパのいずれかに一元的に格納されます。
