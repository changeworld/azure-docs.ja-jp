...
- **(推奨)** Defender for Cloud の [価格と設定] ページから
...
### <a name="access-the-policy-from-defender-for-clouds-pricing-and-settings-page"></a>Defender for Cloud の [価格と設定] ページからポリシーにアクセスする <a name="sqlip-tenant"></a>

Defender for Cloud の **[価格と設定]** ページで、 **[SQL Information Protection]** を選びます。
...
:::image type="content" source="./media/sql-information-protection-policy/pricing-settings-link-to-information-protection.png" alt-text="Microsoft Defender for Cloud の [価格と設定] ページから SQL 情報保護ポリシーへのアクセス。":::
