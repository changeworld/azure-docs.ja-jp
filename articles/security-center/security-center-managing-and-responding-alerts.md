...
## セキュリティの警告とは何か
セキュリティ センターは、真の脅威を検出し、偽陽性の検出を減らすために、Azure リソース、ネットワーク、統合されたマルウェア対策とファイアウォールからログ データを自動的に収集、分析、統合します。セキュリティ センターには、統合されたパートナー ソリューションからの警告など、優先順位の付いたセキュリティの警告の一覧が表示されます。また、すぐに調査する必要がある情報や、攻撃を受けたものを修復する方法についての推奨事項も表示されます。
