...
1. **[推奨事項]** ブレードで、**[SQL Database の監査を有効にする]** を選択します。**[SQL Database の監査を有効にする]** ブレードが開きます。![][1]

2. 監査を有効にする SQL Database を選択します。**[監査と脅威検出]** ブレードが開きます。![][2]
3. **[監査と脅威検出]** ブレードで、**[監査]** の **[オン]** を選択します。![][3]
