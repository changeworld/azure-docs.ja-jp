...
2. 表示された推奨事項を、状態と重要度によってフィルター処理することができます。**[推奨事項]** ブレードで **[フィルター]** をクリックします。[フィルター] ブレードが開き、確認したい重要度と状態の値を選択します。 ![][3]

3. 推奨事項が適用できないと判断した場合、その推奨事項を無視し、ビューから除外することができます。推奨事項を無視するには 2 つの方法があります。項目を右クリックして **[無視]** を選択するか、項目の上にマウスを合わせ、右側に表示されている 3 つの点をクリックして、**[無視]** を選択します。**[フィルター]** をクリックして **[無視]** をクリックすると、無視した推奨事項を表示できます。 ![][4]
