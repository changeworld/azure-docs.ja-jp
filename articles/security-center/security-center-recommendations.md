...
次の表を参考にすると、使用可能な推奨事項と、それを適用した場合のそれぞれの結果を理解できます。
...
|マルウェア対策の有効化|マルウェア対策プログラムを VM (Windows VM のみ) にプロビジョニングすることをお勧めします。|
...
### 推奨事項の適用
すべての推奨事項を確認したら、最初に適用する推奨事項を決めます。重要度の評価をメイン パラメーターとして使用して、最初に適用する必要がある推奨事項を評価することをお勧めします。**[マルウェア対策の有効化]** 推奨事項を使用して、推奨事項の適用方法の例を紹介しましょう。
...
Microsoft パートナーからの統合セキュリティ ソリューションをデプロイすることが推奨される場合があります。この方法の例を紹介しましょう。
...
8. **[推奨事項]** ブレードに戻ります。WAF の作成後に、新しいエントリ **[Web アプリケーション ファイアウォールのセットアップの完了]** が生成されました。このエントリにより、Azure Virtual Network でアプリケーションを保護できるようにするには、その Virtual Network 内で実際に WAF に接続するプロセスを完了する必要があることがわかります。![][9]

9. **[Web アプリケーション ファイアウォールのセットアップの完了]** を選択します。新しいブレードが開きます。トラフィックを再ルーティングする必要がある Web アプリケーションがあることが確認できます。
10. 対象の Web アプリケーションを選択します。Web アプリケーション ファイアウォールのセットアップを完了するための手順が表示されたブレードが開きます。手順を完了した後、**[トラフィックを制限]** をクリックします。セキュリティ センターによって WAF が接続されます。![][10]
