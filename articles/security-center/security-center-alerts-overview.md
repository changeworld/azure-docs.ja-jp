...
- **中:** これは、リソースが侵害されたことを示す可能性がある不審なアクティビティです。
...
- **低:** 良性の陽性またはブロックされた攻撃の可能性があります。
   * Security Center は、その意図に悪意があるかどうか、アクティビティが無害かどうかを確信していません。 たとえば、ログのクリアは、攻撃者が痕跡を隠そうとしたときに発生することがあるアクションですが、多くの場合、管理者が実行する日常的な操作です。
