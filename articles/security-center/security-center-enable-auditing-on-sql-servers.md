...
1. **[推奨事項]** ブレードで、**[Enable Auditing on SQL servers (SQL Server の監査の有効化)]** を選択します。**[Enable Auditing on SQL servers (SQL Server の監査の有効化)]** ブレードが開きます。![][1]

2. 監査を有効にする SQL Server を選択します。**[監査設定]** ブレードが開きます。![][2]
3. **[監査設定]** ブレードで、**[監査]** の **[オン]** を選択します。![][3]
