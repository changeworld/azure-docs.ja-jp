...
|----|----|----|----|
|サブスクリプション|50|サブスクリプションで所有者アクセス許可を持つ Azure Management アプリ アカウントに対して MFA を有効にする|アカウントまたはリソースの侵害を防止するために、管理者特権を持つすべてのサブスクリプション アカウントに対して Multi-Factor Authentication (MFA) を有効にします。|
|サブスクリプション|50|サブスクリプションで Security Center を有効にする |高度な脅威検出、JIT、アプリケーションのホワイトリスト登録、および高度な推奨事項のために、すべてのサブスクリプションで Security Center を有効にする |
|サブスクリプション|50|サブスクリプションで Security Center Standard レベルを有効にする |高度な脅威検出、JIT、アプリケーションのホワイトリスト登録、および高度な推奨事項のために、すべてのサブスクリプションで Security Center Standard レベルを有効にします。|
|サブスクリプション|40|サブスクリプションで書き込みアクセス許可を持つ Azure Management アプリ アカウントに対して MFA を有効にする|アカウントまたはリソースの侵害を防止するために、書き込み特権を持つすべてのサブスクリプション アカウントに対して Multi-Factor Authentication (MFA) を有効にします。|
|サブスクリプション|30|所有者アクセス許可を持つ外部アカウントをサブスクリプションから削除する|監視されていないアクセスを防止するために、所有者アクセス許可を持つ外部アカウントをサブスクリプションから削除します。 |
|サブスクリプション|30|サブスクリプションで読み取りアクセス許可を持つ Azure Management アプリ アカウントに対して MFA を有効にする|アカウントまたはリソースの侵害を防止するために、読み取り特権を持つすべてのサブスクリプション アカウントに対して Multi-Factor Authentication (MFA) を有効にします。|
|サブスクリプション|25|書き込みアクセス許可を持つ外部アカウントをサブスクリプションから削除する|監視されていないアクセスを防止するために、書き込みアクセス許可を持つ外部アカウントをサブスクリプションから削除します。 |
|サブスクリプション|20|所有者アクセス許可を持つ非推奨のアカウントをサブスクリプションから削除する|所有者アクセス許可を持つ非推奨のアカウントをサブスクリプションから削除します。|
|サブスクリプション|5|非推奨のアカウントをサブスクリプションから削除する|現在のユーザーのみへのアクセスを有効にするために、非推奨のアカウントをサブスクリプションから削除します。 |
|サブスクリプション|5|サブスクリプションに複数の所有者を指定する|管理者アクセスの冗長性を確保するために、複数のサブスクリプション所有者を指定します。|
|サブスクリプション|5|サブスクリプションに最大 3 人までの所有者を指定する|セキュリティ侵害を受けた所有者による侵害の可能性を軽減するために、3 名未満のサブスクリプション所有者を指定します。|
|Key Vault|5|Key Vault で診断ログを有効にする|ログを有効にし、それらを最大 1 年間保持します。 これにより、セキュリティ インシデントが発生した場合やネットワークが侵害された場合に、調査目的でアクティビティ証跡を再作成できます。 |
|サブスクリプション|15|読み取りアクセス許可を持つ外部アカウントをサブスクリプションから削除する|監視されていないアクセスを防止するために、読み取り特権を持つ外部アカウントをサブスクリプションから削除します。|
|サブスクリプション|1|セキュリティの連絡先詳細の提供|各サブスクリプションのセキュリティ連絡先情報を指定します。 連絡先情報は、電子メール アドレスと電話番号です。 当社のセキュリティ チームがリソースの侵害を見つけた場合は、この情報を使用して連絡を差し上げます。|

> [注] MFA を必要とするが、除外が設定された条件付きアクセス ポリシーが作成されている場合は、一部のユーザーが MFA なしで Azure にサインインできるようになるため、Security Center MFA の推奨事項の評価ではそのポリシーを非準拠と見なします。
>
