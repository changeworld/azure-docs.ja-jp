<properties
   pageTitle="Azure Security Center を活用したインシデント対応 | Microsoft Azure"
...
1. **[セキュリティ警告]** タイルをクリックして、**[セキュリティ警告]** ブレードにアクセスします。 ![Security Alert blade](./media/security-center-incident-response/security-center-incident-response-fig4.png)
	...
	> [AZURE.NOTE] 上の図からわかるように、このシナリオでは、Judy は [Malicious SQL activity (悪意のある SQL アクティビティ)] の警告に関する評価を行います。
