...
# <a name="configure-round-robin-routing-method"></a>ラウンド ロビンによるトラフィック ルーティング方法の構成
...
## <a name="routing-traffic-equally-round-robin-across-a-set-of-endpoints"></a>一連のエンドポイントにトラフィックをルーティングする (ラウンド ロビン方式)
