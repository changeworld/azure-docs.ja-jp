...
3. 関数アプリで、**[+ 新しい関数]** > **[GitHub Webhook - Node (GitHub Webhook - Node)]** > **[作成]** をクリックします。 これにより、指定したテンプレートに基づく既定の名前の関数が作成されます。 
...
1. **[関数の URL]** と **[GitHub シークレット]** の値をコピーします。 これらの値は GitHub で webhook を作成する場合に必要になります。 
