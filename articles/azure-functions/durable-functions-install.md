...
* 「[Azure Functions をローカルでコーディングしてテストする](https://docs.microsoft.com/en-us/azure/azure-functions/functions-run-local)」の「Azure Functions Core Tools のインストール」の手順に従います
