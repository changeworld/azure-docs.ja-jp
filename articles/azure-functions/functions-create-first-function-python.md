...
また、この記事の [Visual Studio Code ベースのバージョン](/azure/azure-functions/functions-create-first-function-vs-code?pivots=programming-language-python)も存在します。
