...
1. Azure Portal で、「[Azure Portal で初めての関数を作成する](functions-create-first-azure-function.md)」で作成した Function App の Function App ページを開きます。 これを行うには、**[その他のサービス] > [Function App]** の順に選択して、Function App を選択します。
