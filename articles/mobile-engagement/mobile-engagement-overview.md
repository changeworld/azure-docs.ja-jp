...
## <a name="realtime-actionable-analytics-to-maximize-return-on-investment"></a>意思決定の基になるリアルタイムの分析データで投資収益率を最大化
...
## <a name="valueadded-push-and-communications-platform"></a>付加価値の付いたプッシュと通信プラットフォーム
