...
*"ご利用ありがとうございます。 最初の 1 か月間、無料でご利用いただくためにログインをお願いいたします"*
...
アクティビティとは、セッションの期間中にアプリが実行する一連の処理を論理的にまとめたものです。通常は、アプリ内の特定の画面を指しますが、アプリケーションのロジックによって定義されたものすべてがアクティビティになりえます。最低でもアプリの画面 (アクティビティ) にはすべてタグ付けするようにしてください。そうすることで、ユーザー パスを把握することができます。
