...
##統合手順
1. ここから開始します: [Mobile Engagement を Android アプリに統合する方法](mobile-engagement-android-integrate-engagement.md)
...
SDK の旧バージョンをアプリケーションに既に統合している場合は、[アップグレード手順](mobile-engagement-android-upgrade-procedure.md)を参照してください。
