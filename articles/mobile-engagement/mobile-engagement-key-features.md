---
title: Azure Mobile Engagement - 主要な機能
...
---
# <a name="azure-mobile-engagement---key-features"></a>Azure Mobile Engagement - 主要な機能
> [!IMPORTANT]
...
## <a name="general"></a>**全般**
* **主要なプラットフォーム用の SDK**。主要なプラットフォーム (iOS、Android、ユニバーサル Windows、Windows Phone Silverlight、Kindle、Cordova) で使用可能な SDK をご用意しています。 
  SDK は容易に統合することができます。任意のプラットフォームで使用を開始できるようにドキュメントを提供しています。 
...
* **Power BI コネクタが使用可能**。主な分析グラフを取り出して Power BI ダッシュボードに取り込むこともできます。 この[ガイド](https://powerbi.microsoft.com/en-us/documentation/powerbi-content-pack-azure-mobile/)を参照してください。
* **セキュリティおよびプライバシーの保証**。Azure ファミリに属する Azure Mobile Engagement は、クラウド サービスで想定されるセキュリティおよびプライバシーにまつわるすべての標準的なベスト プラクティスに従います。

## <a name="actionable-analytics"></a>**意思決定の基になる分析データ**
...
## <a name="targeted--personalized-push-notifications"></a>**対象設定済みの、およびパーソナライズされたプッシュ通知**
...
* **クイック ポーリング/アンケートとして表示されるように簡単にアプリ内通知を設定できる**  
    ...
    ![][24]
* **プッシュ キャンペーン統計情報を取得** して、通知がどの程度効果を上げているかを確認できる。
