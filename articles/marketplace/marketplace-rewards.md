...
description: Marketplace Rewards は、Azure Marketplace での成長の特定の段階でお客様をサポートするように設計されています。
...
ms.locfileid: "129458569"
---
# <a name="marketplace-rewards"></a>Marketplace 報酬

Marketplace 報酬によって、認識アクティビティから始めて最初の顧客の獲得まで、成長の特定の段階でパートナーにサポートが提供されます。 Microsoft コマーシャル マーケットプレースで成長するにつれて、顧客の変換と取引の成立に役立つように設計された新しいベネフィットを利用できるようになります。 プログラムと利点の詳細については、「[Marketplace Rewards](https://aka.ms/marketplacerewards) (Marketplace の特典)」 (PPT) を参照してください。 
...
Marketplace Rewards プログラムの資格を確認するには、パートナー センターで「[Marketplace Rewards](https://partner.microsoft.com/dashboard/mpn/program/commercialmarketplace) (Marketplace の特典)」ページをご覧ください。
