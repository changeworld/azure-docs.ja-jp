...
プライベート プランは、Azure Global と Azure Government の両方で使用できます。
...
>[!NOTE]
>Azure Gov の適用範囲:プライベート オファー (より正確には、プライベート プラン) は、他のオファーと同様に Gov クラウドで利用できます。 プランは、状態をプライベートからパブリックに、またはその逆にすることもできます。 オファーをどのクラウドで利用可能にするかはパートナー側で制御し、パートナー センターを使用して構成できます。 
