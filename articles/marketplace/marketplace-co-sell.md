...
- ビジネス アプリケーション ISV コネクト Standard
...
"_Azure IP 共同販売インセンティブ対象_" または "_ビジネス アプリケーション ISV コネクト Standard または Premium インセンティブ_" ステータスには、次のようなコマーシャル マーケットプレースの恩恵があります。
...
- "_Azure IP 共同販売インセンティブ対象_" または "_ビジネス アプリケーション ISV コネクト Standard または Premium インセンティブ_" ステータスを取得したプランには、オンライン ストアのプラン登録情報ページで **Microsoft 推奨ソリューション** バッジが付きます。 このバッジは、特定の業界またはソリューション分野で、オファーの品質、パフォーマンス、顧客ニーズへの対応能力の向上を促進します。
