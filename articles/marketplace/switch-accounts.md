...
複数のアカウントに所属することができます。 次のスクリーンショットに示すように、複数のアカウントに属しているかどうかは、左のナビゲーション メニューに "*アカウント ピッカー*" が表示されているかどうかで確認できます。
...
"*アカウント ピッカー*" が表示されない場合、属しているアカウントは 1 つだけです。 このアカウントの詳細については、パートナー センターの **[アカウント設定]**  >  **[組織プロファイル]**  >  **[リーガル]的** >  **[開発者]** タブで確認できます。
