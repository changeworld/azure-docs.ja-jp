...
- ここで入力した **[名前](https://aka.ms/PBIvisualreservename)** は、オファーのタイトルとして顧客に表示されます。 このフィールドには、オファーの作成時に入力した名前が事前に設定されていますが、これは変更できます。 さらに多くの名前を (たとえば別の言語で) 予約したい場合は、[[その他の名前を予約]](power-bi-visual-manage-names.md) を選択します。
...
オファーの掲載を可能な限り有効にするためのヒントについては、[効果的な掲載を作成するためのヒント](https://aka.ms/PBIvisualeffectivelisting)に関する記事を参照してください。
