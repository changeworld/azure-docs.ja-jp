...
| 15 分 |  
マーケットプレースの公開元になるには、以下に説明する簡単な[登録フォーム](https://azuremarketplace.microsoft.com/sell/signup)に記入します。 このフォームで送信された情報を使用して、マーケットプレースのオファーを作成、公開、および管理できるパブリッシャー アカウントが、Cloud Partner Portal に作成されます。
