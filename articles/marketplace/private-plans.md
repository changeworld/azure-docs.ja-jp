...
1. 左側のナビゲーションで **Private Plans\(プライベート プラン\)** を選択します。

> [!NOTE]
> プライベート プランは [Azure portal](https://azure.microsoft.com/features/azure-portal/) でのみ検出できます。 これらは [Microsoft AppSource](https://appsource.microsoft.com/) や [Azure Marketplace](https://azuremarketplace.microsoft.com) には表示されません。 さまざまな商業マーケットプレースのオンライン ストアへの公開に関する詳細については、「[登録情報オプションの概要](./determine-your-listing-type.md)」を参照してください。
