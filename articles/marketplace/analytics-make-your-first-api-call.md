...
アプリケーションの Azure AD トークンを取得する方法の詳細については、[Store サービスを使用した分析データへのアクセス](/windows/uwp/monetize/access-analytics-data-using-windows-store-services#step-2-obtain-an-azure-ad-access-token)に関するページを参照してください。
