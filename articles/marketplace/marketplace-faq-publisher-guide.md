...
コマーシャル マーケットプレース発行元としてサインアップするには、[パートナー センター](https://go.microsoft.com/fwlink/?linkid=2165614)にアクセスします。
...
パートナー センター内から[サポート チケットを送信](https://go.microsoft.com/fwlink/?linkid=2165533)して、Microsoft のマーケットプレース発行元サポート チームに問い合わせることができます。
...
> [!NOTE]
> Virtual Machines の従量制課金使用量、SaaS および Azure アプリの従量制課金、またはその他の製品消費量 (従量課金制など) では、返金は行われません。  ベンダーが返金を受け取ると、パートナー センターの[支払いレポート](/partner-center/payout-statement?context=/azure/marketplace/context/context)に反映されます。
...
Microsoft 管理センターの詳細については、「[組織のサードパーティ製アプリのサブスクリプションを管理する](/microsoft-365/commerce/manage-saas-apps)」を参照してください。
