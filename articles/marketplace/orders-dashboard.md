...
| 課金アカウント ID | 課金アカウント ID | 請求書が生成されるアカウントの識別子。 <bpt id="p1">**</bpt>課金アカウント ID<ept id="p1">**</ept> を <bpt id="p2">**</bpt>customerID<ept id="p2">**</ept> にマップして、支払い取引レポートを、顧客、注文、使用状況のレポートに関連付けます。 | BillingAccountId |
