...
| <center>**6. 契約終了**<br><img src="media/api-guide/icon-contract-end.png" alt="The icon for contract end"> | 更新または<br>Terminate |更新または<br>Terminate <br>[SaaS Fulfillment API v.2](partner-center-portal/pc-saas-fulfillment-api-v2.md)<br>AMA/VM: auto-renew | 更新または<br>Terminate<br>PC Marketplace 分析 |
|
