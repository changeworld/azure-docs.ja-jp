...
| 廃止を保留中 | パブリッシャーがオファーまたはプランで [deprecate]\(廃止\) (以前の販売停止) を選択しましたが、アクションはまだ完了していません。 |
...
|プランの廃止を開始した: "*プラン名*"    |ユーザーが **[ブランの概要]** ページで **[deprecate]\(廃止\)** を選択して、プランの廃止 (以前の販売停止) を開始しました。</br>"*このイベントは、プランをサポートしているオファーの種類にのみ適用されます*。"    |
|プランの廃止を元に戻した: "*プラン名*"    |ユーザーが **[プランの概要]** ページで **[Undo deprecate]\(廃止を元に戻す\) (以前の販売停止)** を選択して、プランの廃止 (以前の販売停止) を取り消しました。</br>"*このイベントは、プランをサポートしているオファーの種類にのみ適用されます*。"    |
...
|オファーを廃止 (以前の販売停止)    |ユーザーが **[オファーの概要]** ページで **[deprecate]\(廃止\)** を選択して、オファーの販売を停止しました。    |
