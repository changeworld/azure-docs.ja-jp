...
ms.locfileid: "88142300"
---
# <a name="review-and-publish-an-offer-to-the-commercial-marketplace"></a>オファーのレビューとコマーシャル マーケットプレースへの公開

この記事では、パートナー センターを使用して自分のオファーをプレビューに送信し、自分のオファーをプレビューして、それを Microsoft コマーシャル マーケットプレースに公開する方法について説明します。 また、公開手順を実行しながら、公開状態を確認する方法についても説明します。 公開するプランを既に作成しておく必要があります。

## <a name="go-to-your-offer-in-the-commercial-marketplace"></a>コマーシャル マーケットプレースで自分のオファーに移動する

1. [パートナー センター](https://partner.microsoft.com/dashboard/home)にサインインします。
2. 左側のナビゲーション メニューで、 **[商業マーケットプレース]**  >  **[概要]** の順に選択します。
3. **[概要]** タブの **[プラン]** では、次のいずれかの状態インジケーターが各プランの **[状態]** 列に表示されます。
...
### <a name="to-preview-your-offer-and-sign-off"></a>自分のオファーをプレビューしてサインオフするには
...
### <a name="reporting-usage-of-preview-and-other-internal-usage"></a>プレビューの使用とその他の内部使用のレポート
