---
title: Dynamics 365 for Customer Engagement & Power Apps オファーをレビューして、Microsoft AppSource (Azure Marketplace) に公開します。
description: Dynamics 365 for Customer Engagement & Power Apps オファーをレビューして、Microsoft AppSource (Azure Marketplace) に公開します。
ms.reviewer: emuench
...
ms.locfileid: "108320783"
---
# <a name="review-and-publish-a-dynamics-365-cepa-offer"></a>Dynamics 365 CE&PA オファーのレビューと公開

この記事では、パートナー センターを使用して下書きの Dynamics 365 for Customer Engagement and Power Apps オファーをプレビューし、それをコマーシャル マーケットプレースに公開する方法について説明します。 また、公開手順を実行しながら、公開状態を確認する方法についても説明します。
...
すべてのページが完了し、該当するテスト ノートを入力したら、 **[公開]** を選択してオファーを送信します。 オファーのプレビュー バージョンの承認が可能になったら、メールが送信されます。 その時に、次を実行します。
