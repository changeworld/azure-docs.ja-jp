...
1. 職場アカウントを使用して[パートナー センターのコマーシャル マーケットプレース プログラム](https://partner.microsoft.com/dashboard/commercial-marketplace/overview)にサインインします (まだ行っていない場合は、[パートナー センター アカウントを作成](partner-center-portal/create-account.md)する必要があります)。
...
**[推奨ソリューション]** に回答が見つからない場合は、 **[問題の詳細を指定]** を選択します。 解決プロセスを高速化するためにすべての必須フィールドに入力して、 **[送信]** を選択します。
