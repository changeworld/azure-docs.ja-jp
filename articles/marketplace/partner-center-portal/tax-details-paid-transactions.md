...
| オーストラリア                        | 選択される価格は、適用される税金を含みません。*        | 価格から Microsoft Store の手数料を差し引いた金額*        | Microsoft          |
...
| 北マケドニア                | 選択される価格は、最終的な販売価格であり、適用される税金を含みます。                                                                   | 価格から Microsoft Store の手数料を差し引いた金額                 | Publisher          |
...
\* Enterprise Agreement を除くすべての顧客購入シナリオでの購入の場合。
