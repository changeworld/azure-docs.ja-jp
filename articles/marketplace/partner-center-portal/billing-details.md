---
title: Azure Marketplace でのコマーシャル マーケットプレースの課金
description: マーケットプレースの公開オプションと、コマーシャル マーケットプレース向けの販売の課金モデルについて説明します。
author: dsindona
ms.author: dsindona
...
ms.locfileid: "82744964"
---
# <a name="commercial-marketplace-billing-with-transact-billing-models"></a>販売の課金モデルを使用したコマーシャル マーケットプレースの課金
