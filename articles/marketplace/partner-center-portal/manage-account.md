...
### <a name="open-account-settings"></a>アカウント設定を開く

パートナー センターの [商業マーケットプレース ダッシュボード](https://partner.microsoft.com/dashboard/commercial-marketplace)で、右上隅にある **[設定]** \(歯車アイコン\) を選択し、 **[アカウント設定]** を選択します。
...
3. ユーザーの選択が完了したら、 **[選択項目の追加]** を選択します。
...
3. グループの選択が完了したら、 **[選択項目の追加]** を選択します。
...
6. ユーザーの選択が完了したら、 **[選択項目の追加]** を選択して新しいグループに追加します。
7. **[保存]** を選択します。
...
3. Azure AD アプリケーションの選択が完了したら、 **[選択項目の追加]** を選択します。
...
パートナー センターの **[契約]** セクション ( **[アカウント設定]** ) では、自分が承認した発行契約を一覧表示できます。 これらの契約は、名前とバージョン番号 (契約に同意したユーザーの名前、同意の日付を含む) に従って一覧表示されます。
