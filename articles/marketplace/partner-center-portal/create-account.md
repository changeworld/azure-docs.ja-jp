...
1. コマーシャル マーケットプレース アカウントが登録済みとして表示されることを確認するには、右上隅の **[設定]** (歯車アイコン) > **[開発者向け設定]**  >  **[プログラム]** を選択します。
...
1. コマーシャル マーケットプレース アカウントが登録済みとして表示されることを確認するには、 **[設定]**  >  **[開発者向け設定]**  >  **[プログラム]** を選択します。
...
1. **[設定]**  >  **[開発者向け設定]**  >  **[プログラム]**  >  **[はじめに]** を選択して、職場のメール アドレスを入力します。
...
組織は、1 つのコマーシャル マーケットプレース アカウントに複数の発行元を関連付けることができます。 既存のユーザーは、パートナー センターにサインインした後、 **[設定]**  >  **[開発者向け設定]**  >  **[発行元]**  >  **[パブリッシャーの追加]** を選択することで、発行元をさらに追加できます。
