---
title: Azure Marketplace でサポートされているマーケットプレース測定サービスの認証方法
...
SaaS オファーの場合は、これが唯一使用可能なオプションです。 これは、「[SaaS アプリケーションを登録する](partner-center-portal/pc-saas-registration.md)」で説明されているように、SaaS オファーを発行するための必須の手順です。
