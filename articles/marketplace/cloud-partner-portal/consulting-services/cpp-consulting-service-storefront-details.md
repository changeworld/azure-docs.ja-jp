...
>[!Note]
>AppSource コンサルティング サービスは、現在、米国、英国、およびカナダで提供されています。 まだ未提供の国に向けてオファーを送信できます。オファーは、レビューされ、提供のために準備が行われます。 新しい国に参入するには、提供準備ができているオファーの最小数を満たす必要があります。このため、未提供の国に向けたオファーが推奨されています。
