---
title: SaaS アプリケーションを登録する - Azure Marketplace | Microsoft Docs
...
Azure AD で保護されたアプリで、[SaaS Fulfillment API バージョン 2](./cpp-saas-fulfillment-api-v2.md) を使用できるようになりました。
