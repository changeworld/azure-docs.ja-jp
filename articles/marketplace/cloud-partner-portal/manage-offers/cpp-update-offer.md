...
2. **[SKU]** タブを選択します。変更する SKU を選択します。
3. **[提供先の国/地域]** フィールドの下の **[国/地域の選択]** ボタンをクリックします。
4. [提供先の国/地域] ダイアログで、この SKU に対するリージョンを追加または削除します。

AppSource オファーの場合:

2. **[Storefront Details]\(ネットショップの詳細\)** タブを選択します。
3. **[サポートされる国/地域]** ラベルの横で **[サポートされる国/地域]** をクリックします。 
4. [サポートされる国/地域] ダイアログで、このオファーのリージョンを追加または削除します。
