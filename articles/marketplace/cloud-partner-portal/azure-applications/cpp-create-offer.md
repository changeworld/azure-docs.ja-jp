---
title: Azure アプリケーション オファーを作成する | Microsoft Docs
...
この記事では、Azure Marketplace 用の Azure アプリケーション オファー エントリを作成して発行する方法について説明します。 すべてのオファーは、Azure Marketplace で独自のエンティティとして表示され、資産とサポートしているオファーのグループから構成されます。オファーの詳細、SKU、マーケティングの成果物、サポート情報といったグループです。
