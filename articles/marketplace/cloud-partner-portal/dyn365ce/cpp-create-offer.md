---
title: Dynamics 365 for Customer Engagement アプリケーション オファーを作成する | Azure Marketplace
description: PC 記事を指定されている、非推奨の CPP 記事。以前の記述:「AppSource Marketplace で新しい Dynamics 365 for Customer Engagement アプリケーション オファーを作成する方法です。」
author: dsindona
