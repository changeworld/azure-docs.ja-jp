...
1. [クラウド パートナー ポータル](https://cloudpartner.azure.com/)に移動し、職場または学校のアカウントを使用してサインインします。
...
3. **[インシデントの作成]** で **[問題の種類]** と **[カテゴリ]** を特定します。
...
5. 連絡先情報を提供し、問題について説明します。 問題はできるだけ完全に説明してください。 問題解決に役立つようなファイルがあれば、それを提供してください (画面のキャプチャ、エラーの説明、ネットワーク トレースなど)。

![support3](./media/cloud-partner-portal-support-for-cloud-partner-portal/support3.png)

6. **[送信]** を選択してチケットを作成します。
