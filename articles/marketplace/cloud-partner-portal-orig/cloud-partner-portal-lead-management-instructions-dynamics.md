...
Azure Active Directory を使用したくない場合は、Office 365 管理ポータルで新しいユーザーを登録できます。 潜在顧客を取得し続けるには、90 日ごとにユーザー名/パスワードを更新する必要があります。
...
2. **[管理者]** タイルを選択します。![Office Online 管理](./media/cloud-partner-portal-lead-management-instructions-dynamics/crmonline3.png)
