...
1.  <http://azure.microsoft.com> に移動し、無料試用版または課金アカウントを作成します。

2.  [Azure Portal](http://portal.azure.com/) にサインインします。
...
6.  まだインストールしていない場合は、Microsoft [Azure ストレージ エクスプローラー](http://storageexplorer.com/)をダウンロードしてインストールします。
