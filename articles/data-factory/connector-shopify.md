---
title: Azure Data Factory を使用して Shopify からデータをコピーする | Microsoft Docs
...
ms.locfileid: "37045186"
---
# <a name="copy-data-from-shopify-using-azure-data-factory"></a>Azure Data Factory を使用して Shopify からデータをコピーする
