---
title: Oracle Responsys からデータをコピーする (プレビュー)
...
この Oracle Responsys コネクタは、以下のアクティビティでサポートされています。
...
## <a name="create-a-linked-service-to-oracle-responsys-using-ui"></a>UI を使用して Oracle Responsys のリンク サービスを作成する

次の手順を使用して、Azure portal UI で Oracle Responsys のリンク サービスを作成します。
...
2. Oracle を検索し、Oracle Responsys コネクタを選択します。

   :::image type="content" source="media/connector-oracle-responsys/oracle-responsys-connector.png" alt-text="Oracle Responsys コネクタのスクリーンショット。":::    


1. サービスの詳細を構成し、接続をテストして、新しいリンク サービスを作成します。

   :::image type="content" source="media/connector-oracle-responsys/configure-oracle-responsys-linked-service.png" alt-text="Oracle Responsys のリンク サービスの構成のスクリーンショット。":::
