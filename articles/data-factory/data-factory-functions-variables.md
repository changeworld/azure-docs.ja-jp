...
Date | AddDays(X,Y) | X: DateTime<br/><br/>Y: int | X に Y 日を追加します。<br/><br/>例: 9/15/2013 12:00:00 PM + 2 days = 9/17/2013 12:00:00 PM
...
Date | DaysInMonth(X) | X: DateTime | パラメーター X の月コンポーネントで表される、その月の日数を取得します。<br/><br/>例: 9 月は 30 日間なので、9/15/2013 の DaysInMonth は 30 です。
Date | EndOfDay(X) | X: DateTime | X の日 (日コンポーネント) の終了を表す日時を取得します。<br/><br/>例: 9/15/2013 05:10:23 PM の EndOfDay は 9/15/2013 11:59:59 PM です。
Date | EndOfMonth(X) | X: DateTime | パラメーター X の月コンポーネントで表される月の終了を取得します。<br/><br/>例: 9/15/2013 05:10:23 PM の EndOfMonth は 9/30/2013 11:59:59 PM です (9 月の終了を表す日時)。
Date | StartOfDay(X) | X: DateTime | パラメーター X の日コンポーネントで表される日の開始を取得します。<br/><br/>例: 9/15/2013 05:10:23 PM の StartOfDay は 9/15/2013 12:00:00 AM です。
