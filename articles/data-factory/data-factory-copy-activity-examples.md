...
- **type** は **OnPremisesSqlServer** に設定されています。
...
SQL Server テーブルを参照する Data Factory テーブルを定義するための JSON 要素の詳細については、[オンプレミスの SQL 型のプロパティ](https://msdn.microsoft.com/library/mt185722.aspx#OnPremSQL)に関するセクションを参照してください。
...
Azure BLOB を参照する Data Factory テーブルを定義するための JSON 要素の詳細については、[Azure BLOB の型のプロパティ](https://msdn.microsoft.com/library/mt185722.aspx#AzureBlob)に関するセクションを参照してください。
...
Data Factory パイプラインを定義するための JSON 要素の詳細については、[パイプライン JSON リファレンス](https://msdn.microsoft.com/library/dn834988.aspx)に関するページを参照してください。SqlSource (たとえば、例の中の **sqlReaderQuery**) と BlobSink のプロパティについては、「[サポートされているソースとシンク](https://msdn.microsoft.com/library/dn894007.aspx)」を参照してください。
...
次のサンプル JSON を使用すると、**OnPremisesFileServer** 型の **FolderDataStore** という名前のリンクされたサービスを作成できます。
...
オンプレミスのファイル システムを参照する Data Factory テーブルを定義するための JSON 要素の詳細については、[オンプレミスのファイル システムの型のプロパティ](https://msdn.microsoft.com/library/mt185722.aspx#OnPremFileSystem)に関するセクションを参照してください。
...
次の JSON を使用すると、オンプレミスの Oracle データベースを示すリンクされたサービスを作成できます。**type** が **OnPremisesOracle** に設定されている点に注目してください。
...
### コピー先 Azure BLOB のリンクされたサービスの作成
次のサンプル JSON を使用すると、**AzureStorage** 型の **MyAzureStorage** という名前のリンクされたサービスを作成できます。
...
### 入力テーブルの作成
次のサンプル JSON を使用すると、オンプレミスの Oracle データベースのテーブルを参照する Azure Data Factory テーブルを作成できます。**type** が **OracleTable** に設定されている点に注目してください。
...
オンプレミスの Oracle データベースのテーブルを参照する Data Factory テーブルを定義するための JSON 要素の詳細については、[オンプレミスの Oracle 型のプロパティ](https://msdn.microsoft.com/library/mt185722.aspx#Oracle)に関するセクションを参照してください。
