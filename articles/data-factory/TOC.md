...
### [データ移動アクティビティ](data-factory-data-movement-activities.md)
### [データ変換アクティビティ](data-factory-data-transformation-activities.md)
...
## [チュートリアル: オンプレミスからクラウドにデータを移動する](data-factory-move-data-between-onprem-and-cloud.md)
## [チュートリアル: パイプラインでカスタム アクティビティを作成して使用する](data-factory-use-custom-activities.md)

# 方法
## データを移動する
### [Data Factory コピー ウィザード](data-factory-copy-wizard.md)
### [コピー ウィザードを使用して 15 分で 1 TB を読み込む](data-factory-load-sql-data-warehouse.md)
### [コピー アクティビティ](data-factory-data-movement-activities.md)
### [ハイブリッド データ移動](data-factory-move-data-between-onprem-and-cloud.md)
### [Data Management Gateway](data-factory-data-management-gateway.md)
### [コピー アクティビティのパフォーマンスとチューニングに関するガイド](data-factory-copy-activity-performance.md)
...
## 開発
### [Azure Portal の使用](data-factory-copy-activity-tutorial-using-azure-portal.md)
...
### [Azure Resource Manager テンプレートの使用](data-factory-how-to-use-resource-manager-templates.md)
...
## 監視と管理
### [Azure Portal の使用](data-factory-api-change-log.md)
...
### [Azure Resource Manager テンプレートを使用してデプロイする](data-factory-how-to-use-resource-manager-templates.md)
...
## [よく寄せられる質問](data-factory-faq.md)
## [MSDN フォーラム](https://social.msdn.microsoft.com/Forums/en-US/home?forum=AzureDataFactory)
