...
### [入力データセット列と出力データセット列のマッピング](data-factory-map-columns.md)
### [サポートされているファイル形式と圧縮形式](data-factory-supported-file-and-compression-formats.md)
...
## [サービスの更新情報](https://azure.microsoft.com/en-us/updates/?product=data-factory)
