...
2. [Azure Storage Explorer](https://storageexplorer.com/) などのツールを使用して **adfv2tutorial** コンテナーを作成し、このコンテナーに **inputEmp.txt** ファイルをアップロードします。
...
- コンテンツの解析方法を示す BLOB 形式:**TextFormat** とその設定 (たとえば、列区切り記号)。
