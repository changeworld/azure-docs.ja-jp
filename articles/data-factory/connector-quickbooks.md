---
title: Azure Data Factory を使用して QuickBooks からデータをコピーする (プレビュー) | Microsoft Docs
...
ms.locfileid: "46127145"
---
# <a name="copy-data-from-quickbooks-using-azure-data-factory-preview"></a>Azure Data Factory を使用して QuickBooks からデータをコピーする (プレビュー)
...
| query | カスタム SQL クエリを使用してデータを読み取ります。 たとえば、「 `"SELECT * FROM "Bill" WHERE Id = '123'"`」のように入力します。 | [はい] |
