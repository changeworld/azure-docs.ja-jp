...
| プロパティ | 説明 | 必須 |
|:--- |:--- |:--- |
| type | type プロパティは **AzureMySql** に設定する必要があります | [はい] |
...
| プロパティ | 説明 | 必須 |
|:--- |:--- |:--- |
| type | データセットの type プロパティは **AzureMySqlTable** に設定する必要があります | [はい] |
...
| プロパティ | 説明 | 必須 |
|:--- |:--- |:--- |
| type | コピー アクティビティのソースの type プロパティは **AzureMySqlSource** に設定する必要があります | [はい] |
