...
| [ML Studio (クラシック)](#ml-studio-classic-linked-service) | [ML Studio (クラシック) のアクティビティ: Batch Execution と更新リソース](transform-data-using-machine-learning.md) |
...
Machine Learning (ML) Studio (クラシック) のリンクされたサービスを作成し、ML Studio (クラシック) のバッチ スコアリング エンドポイントをデータ ファクトリに登録します。
