...
### <a name="what-is-the-data-factory’s-region-availability?"></a>Data Factory を利用可能なリージョンはどこですか。
...
### <a name="what-are-the-limits-on-number-of-data-factories/pipelines/activities/datasets?"></a>Data Factory/パイプライン/アクティビティ/データセットの数の制限値はいくつですか。
...
### <a name="what-is-the-authoring/developer-experience-with-azure-data-factory-service?"></a>Azure Data Factory サービスではどのような作成エクスペリエンスまたは開発者エクスペリエンスが提供されますか。
