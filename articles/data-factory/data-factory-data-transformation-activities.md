...
この記事では、Azure Data Factory でのデータ変換アクティビティについて説明します。生データが Azure Data Factory によってどのように変換、処理され、予測や洞察に利用されるかを学ぶことができます。変換アクティビティは、Azure HDInsight クラスターや Azure Batch などのコンピューティング環境で実行されます。特定の変換アクティビティの使用方法を示すいくつかの記事へのリンクも含まれています。
