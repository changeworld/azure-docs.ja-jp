...
## <a name="create-a-linked-service-to-oracle-eloqua-using-ui"></a>UI を使用して Oracle Eloqua のリンク サービスを作成する
...
2. Oracle を検索し、Oracle Eloqua コネクタを選択します。

   :::image type="content" source="media/connector-oracle-eloqua/oracle-eloqua-connector.png" alt-text="Oracle Eloqua コネクタのスクリーンショット。":::    


1. サービスの詳細を構成し、接続をテストして、新しいリンク サービスを作成します。

   :::image type="content" source="media/connector-oracle-eloqua/configure-oracle-eloqua-linked-service.png" alt-text="Oracle Eloqua のリンク サービスの構成のスクリーンショット。":::
