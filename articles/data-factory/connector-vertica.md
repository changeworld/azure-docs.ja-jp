...
| プロパティ | 説明 | 必須 |
|:--- |:--- |:--- |
| 型 | type プロパティを **Vertica** に設定する必要があります | [はい] |
...
Vertica からデータをコピーするには、データセットの type プロパティを **VerticaTable** に設定します。 この種類のデータセットに追加の種類固有のプロパティはありません。
...
| プロパティ | 説明 | 必須 |
|:--- |:--- |:--- |
| 型 | コピー アクティビティのソースの type プロパティを **VerticaSource** に設定する必要があります。 | [はい] |
