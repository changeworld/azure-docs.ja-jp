...
![[マッピングの追加] から選択されたルールベースのマッピングが、スクリーンショットに示されています。](media/data-flow/rule2.png "ルールベースのマッピング")
...
![スクリーンショットは、マッピングを示しています。](media/data-flow/rule-based-mapping.png "ルールベースのマッピング")
...
![スクリーンショットに、regex マッピング条件が、階層レベルと名前の照合とともに示されています。](media/data-flow/regex-matching.png "ルールベースのマッピング")
...
![スクリーンショットは、階層を使用するルールベースのマッピングを示しています。](media/data-flow/rule-based-hierarchy.png "ルールベースのマッピング")
