...
Azure-SSIS 統合ランタイムがない場合は、[SSIS パッケージのデプロイに関するチュートリアル](../tutorial-deploy-ssis-packages-azure.md)の手順に従って作成します。 Azure-SSIS 統合ランタイムを作成するには、バージョン 2 のデータ ファクトリを作成する必要があります。 
