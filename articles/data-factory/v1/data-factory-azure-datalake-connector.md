...
| プロパティ | 説明 | 必須 |
|:--- |:--- |:--- |
| **folderPath** |Data Lake Store のコンテナーとフォルダーのパスです。 |あり |
