...
> [!NOTE]
> この記事は、Data Factory のバージョン 1 に適用されます。 最新バージョンの Data Factory サービスを使用している場合は、[Data Factory を使用して Azure Synapse Analytics (旧称 SQL Data Warehouse) との間でデータをコピーする方法](../connector-azure-sql-data-warehouse.md)に関するページを参照してください。
