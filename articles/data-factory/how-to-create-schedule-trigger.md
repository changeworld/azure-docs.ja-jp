...
1. **[新しいトリガー]** ページで、次の手順を行います。 
    ...
    1. トリガーが作成されるタイム ゾーンを指定します。 タイム ゾーンの設定は、高度な繰り返しオプションの **[開始日]** 、 **[終了日]** 、 **[スケジュール実行回数]** に適用されます。 タイム ゾーンの設定を変更することで、開始日が自動的に変更されることはありません。 指定したタイム ゾーンにおいて、開始日が正しいことを確認してください
