...
> [AZURE.NOTE] オンプレミス/Azure IaaS データ ストアと Azure DocumentDB 間でのデータのコピーは、Data Management Gateway バージョン 2.1 以降でサポートされています。
...
## <a name="azure-documentdb-dataset-type-properties"></a>Azure DocumentDB データベースの type プロパティ
