...
-   コピー テンプレート:
    ...
    -   \<source\> から \<destination\> へのコピー
        ...
        -   オンプレミスの SQL Server から Azure Synapse Analytics (旧称 SQL Data Warehouse) へ

        -   オンプレミスの Oracle から Azure Synapse Analytics (旧称 SQL Data Warehouse) へ
