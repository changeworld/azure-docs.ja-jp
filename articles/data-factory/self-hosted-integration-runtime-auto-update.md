...
セルフホステッド統合ランタイムの安定を確保するため、2 つのバージョンをリリースしますが、毎月 1 つのバージョンのみをプッシュします。 そのため、自動更新バージョンが、実際の最新バージョンの前のバージョンである場合があります。 最新バージョンを取得する場合は、[ダウンロード センター](https://www.microsoft.com/download/details.aspx?id=39717)に移動できます。
