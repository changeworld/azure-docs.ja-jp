...
:::image type="content" source="media/continuous-integration-deployment-improvements/current-ci-cd-flow.png" alt-text="現在の CI/CD フローを示す図。":::
...
:::image type="content" source="media/continuous-integration-deployment-improvements/new-ci-cd-flow.png" alt-text="新しい CI/CD フローを示す図。":::
...
1. Azure DevOps プロジェクトを開き、 **[パイプライン]** に移動します。 **[新しいパイプライン]** を選択します。
   ...
   :::image type="content" source="media/continuous-integration-deployment-improvements/new-pipeline.png" alt-text="[新しいパイプライン] ボタンを示すスクリーンショット。":::
...
3. **[スタート パイプライン]** を選択します。 次の例で示すように、YAML ファイルをアップロードまたはマージした場合は、それを直接ポイントして編集することもできます。
   ...
   :::image type="content" source="media/continuous-integration-deployment-improvements/starter-pipeline.png" alt-text="スタート パイプラインを示すスクリーンショット。":::
...
Data Factory での継続的インテグレーションとデリバリーの詳細については、「[Azure Data Factory における継続的インテグレーションとデリバリー](continuous-integration-deployment.md)」を参照してください。
