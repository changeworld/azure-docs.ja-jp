---
title: Azure portal を使用して統合ランタイムを作成する
description: Azure 内で SSIS パッケージをデプロイして実行できるように、Azure portal を使用して、Azure-SSIS 統合ランタイムを Azure Data Factory 内に作成する方法について説明します。
...
- [Azure Resource Manager テンプレート を使用して Azure-SSIS IR をプロビジョニングする方法を学習する](create-azure-ssis-integration-runtime-resource-manager-template.md)。
