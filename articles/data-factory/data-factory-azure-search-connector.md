...
Azure Data Factory で現在サポートされているのは、[サポートされているオンプレミスのソース データ ストア](data-factory-data-movement-activities.md#supported-data-stores-and-formats)から Azure Search へのデータ移動のみです。 Azure Search から他のデータ ストアへのデータ移動はサポートされていません。
