---
title: PowerApps と Logic Flows の Swagger 定義をカスタマイズする方法 | Microsoft Docs
...
> [!IMPORTANT]
> このトピックは、powerapps.microsoft.com の [PowerApps と Flows の Swagger 定義のカスタマイズ](https://powerapps.microsoft.com/tutorials/customapi-how-to-swagger/)に関するページに移動しました。最新版については PowerApps をご覧ください。この Azure のリンクはアーカイブされます。
> 
> 
