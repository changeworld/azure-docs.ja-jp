<properties
	pageTitle="チュートリアル: PowerApps と Logic Flows で Azure Resource Manager を使用してカスタム API を作成する | Microsoft Azure"
...
7. **[キー]** で期間を選択します。**キーをコピーして安全な場所に保存します。**このキーは後で必要になります。__クライアント ID__ もメモしておきます。![](./media/powerapps-azure-resource-manager-tutorial/configurekeys.png "キーの構成")
