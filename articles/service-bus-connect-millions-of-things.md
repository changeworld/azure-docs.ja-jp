...
最新技術のエコシステムでは、接続されたスマートな "モノ" が大幅に増えています。車、住宅、インフラストラクチャ、電化製品に取り付けられたセンサーによって、製品の品質改善、サービスの拡張、顧客との新しいつながりモデルなど新しいチャンスが生まれています。Microsoft Azure Service Bus は、この急増する "モノのインターネット" の接続を容易にします。
...
## 基本
- [接続されたデバイスに対するサービスが支援する通信 (ブログの投稿)](http://blogs.msdn.com/b/clemensv/archive/2014/02/10/service-assisted-communication-for-connected-devices.aspx)
