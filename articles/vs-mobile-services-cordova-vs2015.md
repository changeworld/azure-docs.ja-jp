<properties 
	pageTitle="" 
	description="Cordova プロジェクトでの Mobile Services の使用" 
...
1. Visual Studio 2015 Preview の Cordova プロジェクトで、Config.xml を開き、**[プラグイン]** タブで、**Azure Mobile Services** プラグインを有効にします。<br/> ![][1]
