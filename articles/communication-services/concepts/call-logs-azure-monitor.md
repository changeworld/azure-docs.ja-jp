---
title: Azure Communication Services - 通話概要と通話診断のログ
...
:::image type="content" source="media\call-logs-images\call-logs-concepts-p2p.png" alt-text="P2P 通話":::
...
:::image type="content" source="media\call-logs-images\call-logs-concepts-group.png" alt-text="グループ通話":::
...
:::image type="content" source="media\call-logs-images\call-logs-p2p-streams.png" alt-text="P2P 通話ストリーム":::
...
:::image type="content" source="media\call-logs-images\call-logs-concepts-group-call-endpoint-detail.png" alt-text="グループ通話の詳細":::
...
|     identifier                |     これはユーザーの一意の ID で、認証サービス (MRI) によって割り当てられた ID と一致します。                                                                                                                                                                                                                                                                                                                                                              |
...
:::image type="content" source="media\call-logs-images\call-logs-concepts-p2p-sample.png" alt-text="P2P サンプル ログの例":::
...
:::image type="content" source="media\call-logs-images\call-logs-concepts-group-sample.png" alt-text="グループ通話のサンプル ログの例":::
