...
description: Azure Event Grid を使用して、Communication Service で発生したアクションに基づいてプロセスをトリガーします。
author: mikben
manager: jken
...
| タイトル | 説明 |
| --- | --- |
| [Communication Services での SMS イベントの処理方法](../quickstarts/telephony-sms/handle-sms-events.md) | Webhook を使用して Communication Service によって受信されたすべての SMS イベントを処理します。 |
