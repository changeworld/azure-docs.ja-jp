...
| [Web 呼び出しのサンプル](./web-calling-sample.md)                                                        | Web 内の ACS 呼び出し機能 (PSTN を含む) に関するステップ バイ ステップのチュートリアルです。 | [Web](https://github.com/Azure-Samples/communication-services-web-calling-tutorial/)                                |
