...
[!code-azurecli-interactive[メイン](../../../cli_scripts/virtual-network/virtual-network-multi-tier-application/virtual-network-multi-tier-application.sh  "多層アプリケーション用の仮想ネットワーク")]
