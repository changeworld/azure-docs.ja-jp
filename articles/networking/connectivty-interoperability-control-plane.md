...
<!--Image References-->
[1]: ./media/backend-interoperability/HubView.png "ハブ アンド スポーク VNet の視点から見たトポロジ"
[2]: ./media/backend-interoperability/Loc1ExRView.png "ExpressRoute 1 を経由する場所 1 とリモート VNET の視点から見たトポロジ"
[3]: ./media/backend-interoperability/Loc1VPNView.png "サイト間 VPN を経由する場所 1 とブランチ VNet からのトポロジの見え方"
