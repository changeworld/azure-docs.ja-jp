...
ms.locfileid: "71098991"
---
# <a name="about-azure-networking-msp-partners"></a>Azure ネットワーク MSP パートナーについて

ネットワーク サービスに重点を置く MSP、電気通信会社、システム インテグレーター (SI) は、Azure ネットワーク マネージド サービス プロバイダー (MSP) パートナー プログラムを通じて、Azure のネットワーク製品とサービスのポートフォリオに関連したクラウドおよびハイブリッド ネットワーク サービスを提供できます。
