...
description: Azure のネットワーク サービスとその機能 (接続サービス、アプリケーション保護サービス、アプリケーション配信サービス、ネットワーク監視) について説明します。
services: networking
...
![Azure Load Balancer の例](./media/networking-overview/load-balancer.png)
