...
IoT Edge for Linux on Windows は現在パブリックプレビュー段階ですが、Windows デバイスで IoT Edge を実行する場合に推奨される方法です。
...
<sup>1</sup> バージョン 1.0.10 以降、Windows 10 IoT Core はサポートされません
