...
1. ストレージ アカウント ナビゲーターから、 **[Storage Explorer (preview)] (Storage Explorer (プレビュー))** を選択します。

1. Storage Explorer で、 **[BLOB コンテナー]** 、[`devicedata`] の順に選択します。
