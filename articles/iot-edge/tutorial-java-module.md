...
* [Maven](https://maven.apache.org/)
   ...
   >[!TIP]
   >Java および Maven の環境変数は、インストール プロセス中に追加されます。 これらの環境変数を追加するときに開いていた Visual Studio Code ターミナル、PowerShell、またはコマンド プロンプト インスタンスは再起動する必要があります。 これにより、以降は Java および Maven コマンドがこれらのユーティリティによって認識されるようになります。
