...
description: Visual Studio 2019 を使用して Azure IoT Edge 用のモジュールを開発してデバッグする
services: iot-edge
author: shizn
manager: philmea
ms.author: xshi
...
1. Visual Studio の新しいプロジェクト ダイアログで、 **[Azure IoT Edge]** を検索して選択し、自分のプロジェクトの名前を入力して場所を指定し、 **[OK]** を選択します。 既定のプロジェクト名は **AzureIoTEdgeApp1** です。
