...
ロールのプロパティ ページから **[構成の管理]** ダイアログ ボックスを開くこともできます。Azure プロジェクトのロールのプロパティを開くには、ロールのショートカット メニューを開き、**[プロパティ]** をクリックします。**[設定]** タブで、**[サービス構成]** ボックスの一覧を展開し、**[管理]** をクリックして **[構成の管理]** ダイアログ ボックスを開きます。

### サービス構成を追加するには

1. ソリューション エクスプローラーで、Azure プロジェクトのショートカット メニューを開き、**[構成の管理]** をクリックします。

    **[サービス構成の管理]** ダイアログ ボックスが表示されます。

1. サービス構成を追加するには、既存の構成のコピーを作成する必要があります。これを行うには、[名前] ボックスの一覧で、コピーする構成を選択し、**[コピーの作成]** をクリックします。
...
1. サービス構成を削除するには、**[名前]** ボックスの一覧から削除する構成を選択し、**[削除]** をクリックします。この構成を削除することを確認するダイアログ ボックスが表示されます。
...
1. サービス構成の名前を変更するには、**[名前]** ボックスの一覧から新しいサービス構成を選択し、**[名前の変更]** をクリックします。**[名前]** ボックスに、このサービス構成に使用する名前を入力し、**[OK]** をクリックします。

    ソリューション エクスプローラーの Azure プロジェクトでサービス構成ファイルの名前が変更されます。

### サービス構成を変更するには

- サービス構成を変更する場合は、Azure プロジェクトで変更するロールのショートカット メニューを開き、[プロパティ] をクリックします。詳細については、「[方法: Visual Studio を使用した Azure クラウド サービスのロールの構成](https://msdn.microsoft.com/library/azure/hh369931.aspx)」を参照してください。
...
1. 次の図に示すように、**[ターゲット プロファイル]** ボックスの横にある **[プロファイルの保存]** ボタンをクリックします。プロファイルが自動的に作成されます。

    ![Create an new profile](./media/vs-azure-tools-service-configurations-and-profiles-how-to-manage/create-new-profile.png)

1. プロファイルが作成されたら、**[ターゲット プロファイル]** ボックスの一覧の **[<管理>]** をクリックします。
...
1. **[名前]** ボックスの一覧で、プロファイルを選択し、**[コピーの作成]** をクリックします。

1. **[閉じる]** をクリックします。

    新しいプロファイルが [ターゲット プロファイル] ボックスの一覧に表示されます。

1. **[ターゲット プロファイル]** ボックスの一覧で、先ほど作成したプロファイルをクリックします。選択したプロファイルで選択されている内容が、発行ウィザードの設定項目に入力されます。

1. **[前へ]** と **[次へ]** をクリックして発行ウィザードの各ページを表示し、このプロファイルの設定をカスタマイズします。詳細については、[Azure アプリケーションの公開ウィザード](http://go.microsoft.com/fwlink/p/?LinkID=623085)に関するページを参照してください。

1. 設定のカスタマイズが完了したら、**[次へ]** をクリックして [設定] ページに戻ります。プロファイルが保存されるのは、これらの設定を使用してサービスを発行したときか、プロファイルの一覧の横にある **[保存]** をクリックしたときです。

### プロファイルを削除するには

1. Azure プロジェクトのショートカット メニューを開き、**[発行]** をクリックします。

1. **[ターゲット プロファイル]** ボックスの一覧の **[管理]** をクリックします。

1. **[プロファイルの管理]** ダイアログ ボックスで、削除するプロファイルをクリックし、**[削除]** をクリックします。
...
1. **[ターゲット プロファイル]** ボックスの一覧で、変更するプロファイルをクリックします。

1. **[前へ]** と **[次へ]** をクリックして発行ウィザードの各ページを表示し、目的の設定を変更します。詳細については、[Azure アプリケーションの公開ウィザード](http://go.microsoft.com/fwlink/p/?LinkID=623085)に関するページを参照してください。

1. 設定の変更が完了したら、**[次へ]** をクリックして **[設定]** ページに戻ります。

1. (省略可能) **[発行]** をクリックし、新しい設定を使用してクラウド サービスを発行します。この時点でクラウド サービスを発行せずに発行ウィザードを閉じると、変更をプロファイルに保存するかどうかをたずねるメッセージが表示されます。
