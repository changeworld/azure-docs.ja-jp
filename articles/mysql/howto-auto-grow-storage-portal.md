---
title: Azure portal を使用した Azure Database for MySQL のストレージの自動拡張
...
1. [Azure portal](https://portal.azure.com/) で、ご利用の Azure Database for MySQL サーバーを選択します。
