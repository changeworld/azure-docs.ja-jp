...
| 一般公開 | 2018 年以降 GA | パブリック プレビュー | GA |
...
| 受信データのレプリケーションでの GTID のサポート | サポートされています | サポートされていません | ユーザー管理 |
...
| Terraform のサポート | サポートされています | サポートされていません | サポートされています |
