...
### <a name="major-version-upgrades"></a>メジャー バージョンのアップグレード
- [メジャー バージョンのアップグレードは、v5.6 から v5.7 へのアップグレードでのみサポートされています](how-to-major-version-upgrade.md)。 v8.0 へのアップグレードはまだサポートされていません。
...
- 価格レベルごとのストレージ サイズの上限については、[価格レベル](concepts-pricing-tiers.md#storage)に関するページを参照してください。
