...
独自のサーバーに PHP をインストールするか、PHP が含まれた Azure [Web アプリ](https://docs.microsoft.com/azure/app-service/overview)を作成します。  ファイアウォール規則の作成方法については、「[ファイアウォール規則の作成および管理](./how-to-manage-firewall-portal.md)」を参照してください。
