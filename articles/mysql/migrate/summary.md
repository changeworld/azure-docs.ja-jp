...
### <a name="find-a-partner-to-help-migrating"></a>移行の手助けをしてくれるパートナーを見つける
...
エンドツーエンドの MySQL 移行ガイドを使用してサンプル アプリケーションをデプロイするには、[付録 A](appendix-a-environment-setup.md) と[付録 B](appendix-b-arm-templates.md) を参照してください。

使用可能なサーバー パラメーターを確認するには、[付録 C](appendix-c-default-server-parameters-mysql-55-and-azure-database-for-mysql.md) を参照してください。