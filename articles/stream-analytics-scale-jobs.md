<properties title="Scale Azure Stream Analytics jobs" pageTitle="Stream Analytics ジョブのスケーリング | Azure" description="Learn how to scale Stream Analytics jobs" metaKeywords="" services="stream-analytics" solutions="" documentationCenter="" authors="jgao" videoId="" scriptId="" manager="paulettm" editor="cgronlun"/>
