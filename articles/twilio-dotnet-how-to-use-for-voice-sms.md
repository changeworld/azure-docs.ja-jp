...
アプリケーションで既存の番号を使用する代わりに、Twilio 電話番号を購入することができます。Twilio 電話番号の購入については、Twilio 電話番号のヘルプに関するページ,[Twilio Phone Numbers Help](https://www.twilio.com/help/faq/phone-numbers)を参照してください。
