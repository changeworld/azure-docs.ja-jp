 ...
 * 各サブスクリプションは Azure Active Directory (または既定のディレクトリ) と関連付けられます。サブスクリプションが関連付けられた既定のディレクトリを探すには、[Azure クラシック ポータル](https://manage.windowsazure.com/)に移動し、**[設定]**、**[サブスクリプション]** の順に選択し、サブスクリプション ID を確認し、サブスクリプションが関連付けられた既定のディレクトリを見つけます。
...
| ログイン方法| Microsoft アカウントまたは既定のディレクトリ内のユーザーを共同管理者またはサービス管理者として追加できる |同じ組織内の組織アカウントを共同管理者またはサービス管理者として追加できる |異なる組織の組織アカウントを共同管理者またはサービス管理者として追加できる
| ------------- | ------------- |---------------|---------------|
