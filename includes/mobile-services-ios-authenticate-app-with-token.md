...
4. ユーザーのトークンと ID をキャッシュする方法を説明したので、次に、アプリの起動時にそれを読み込む方法について説明します。**self.todoService** が初期化されたら、**QSTodoListViewController.m** 内の **viewDidLoad** メソッドに loadAuthInfo の呼び出しを追加します。 
