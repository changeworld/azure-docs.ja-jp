...
Azure Cloud Shell を使用しない場合は、代わりにローカルに Azure PowerShell をインストールします。 最新の機能を使用するには、必ず Azure PowerShell Az モジュールの最新バージョンをインストールします。 詳しくは、[Azure PowerShell のインストール](/powershell/azure/overview)に関する記事をご覧ください。
