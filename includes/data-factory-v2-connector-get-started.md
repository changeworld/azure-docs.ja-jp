...
-->
次のいずれかのツールまたは SDK を使用して、パイプラインでコピー アクティビティを使用できます。 詳細な手順については、以下のリンクを選択してください。

- [データ コピー ツール](../articles/data-factory/quickstart-create-data-factory-copy-data-tool.md)
