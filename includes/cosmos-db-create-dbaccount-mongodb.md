...
3. **[Azure Cosmos DB アカウントの作成]** ページで、新しい Azure Cosmos DB アカウントの設定を入力します。 
   ...
   | バージョン | 必要なサーバー バージョンを選択する | Azure Cosmos DB の MongoDB 用 API は、サーバー バージョン 4.0、3.6、3.2 と互換性があります。 アカウントは、作成した後に[アップグレードまたはダウングレード](../articles/cosmos-db/mongodb-version-upgrade.md)できます。 |
...
1. **[グローバル分散]** タブで、次の詳細を構成します。 このクイックスタートの目的上、既定値のままにすることができます。
