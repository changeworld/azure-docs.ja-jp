Azure ユーザーは 1 か月あたり 25,000 通の電子メールを無料で利用できます。毎月 25,000 通の無料電子メールにより、高度なレポートおよび分析とすべての API (Web、SMTP、イベント、解析、サブユーザー) を利用できるようになります。SendGrid の提供するその他のサービスについては、[SendGrid の特徴][SendGrid の特徴]に関するページを参照してください。
