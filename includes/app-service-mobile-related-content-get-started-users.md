モバイル アプリへの認証の追加: [iOS][ios-get-started-users]、[Xamarin.iOS][xamarin-ios-get-started-users]、[Xamarin.Android][xamarin-android-get-started-users]、[Windows Universal][windows-get-started-users]。
