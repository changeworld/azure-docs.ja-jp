...
ms.locfileid: "85806017"
---
## <a name="create-an-azure-resource"></a>Azure リソースを作成する

次のいずれかの Azure リソースを作成して、Bing Entity Search API の使用を開始します。

### <a name="bing-entity-search-resource"></a>[Bing Entity Search のリソース](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingEntitySearch)
