...
| OS | ドライバー |
| -------- |------------- |
| Windows Server 2019<br/><br/>Windows Server 2016<br/><br/>Windows 10 (バージョン 1809 まで。 パッチ未適用/1809 のパッチ レベル 0 はサポートされていません。) | [GRID 8.0 (425.31)](https://go.microsoft.com/fwlink/?linkid=874181) (.exe) |
