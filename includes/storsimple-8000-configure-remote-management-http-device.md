...
4. **[リモート管理]** ブレードで、次の操作を行います。
    ...
    3. ブレードの上部にあるコマンド バーで **[詳細]** をクリックした後、 **[証明書のダウンロード]** をクリックしてリモート管理証明書をダウンロードします。 このファイルを保存する場所を指定できます。 この証明書は、さらに、クラウド アプライアンスへの接続に使用するクライアントまたはホスト コンピューターにインストールする必要があります。
