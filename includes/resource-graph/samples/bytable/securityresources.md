...
### <a name="get-specific-iot-alert"></a>特定の IoT アラートを取得する

指定されたシステム警告 ID に基づき特定の IoT アラートを返します (プレースホルダー `{system_Alert_Id}` を置き換えてください)。
...
### <a name="list-container-registry-vulnerability-assessment-results"></a>Container Registry の脆弱性評価結果を一覧表示する
