...
予約を管理する方法については、[Azure Reserved VM Instances の管理](https://go.microsoft.com/fwlink/?linkid=861613)に関するページを参照してください。
