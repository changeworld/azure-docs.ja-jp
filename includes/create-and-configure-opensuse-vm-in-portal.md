...
**重要**: 仮想マシンが仮想ネットワークを使用する場合、仮想マシンの作成時に仮想ネットワークを指定する必要があります。仮想マシンが仮想ネットワークに接続するように設定できるのは、仮想マシンの作成時に限られています。仮想ネットワークの詳細については、「[仮想ネットワークの概要][仮想ネットワークの概要]」を参照してください。
...
Windows コンピューターを使用している場合、PuTTY を使用して VM に接続します。PuTTY は、[PuTTY のダウンロード ページ][PuTTY のダウンロード ページ]からダウンロードできます。
