> [WACOM.NOTE] **この記事は Azure Websites について記載されています**。Cloud Services については、「<a href="/ja-jp/develop/net/common-tasks/custom-dns/">Azure クラウド サービスのカスタム ドメイン名の構成</a>」を参照してください。
>
