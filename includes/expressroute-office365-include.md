ExpressRoute は、Microsoft クラウド サービスへのプライベート ネットワーク接続を提供します。 多くの場合、ネットワーク アーキテクチャとパフォーマンスに関する考慮事項に対処すれば、Azure で実行されているインフラストラクチャとプラットフォームのサービスに良い影響があります。 このため、大規模な企業では Azure に ExpressRoute を使用することをお勧めします。
