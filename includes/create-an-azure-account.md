...
アプリケーションを Azure にデプロイするには、アカウントが必要です。ここでは、無料の試用アカウントを作成する方法と、BizTalk サービス、HDInsight、Azure Back を含む Azure プレビュー機能をアカウントに対して有効にする方法について説明します。
...
1.  [https://account.windowsazure.com/](https://account.windowsazure.com/) にアクセスし、Azure アカウントを使用してサインインします。
