...
ms.locfileid: "110720051"
---
NFS は、Premium Files Storage が使用可能な 30 以上の **すべての** リージョンでサポートされています。

リージョンは継続的に追加されています。 最新の一覧については、以下のサンプルを使用して、NFS がサポートされているリージョンの一覧のクエリを実行してください。 また、**Premium Files Storage** にある「[リージョン別の利用可能な製品](https://azure.microsoft.com/global-infrastructure/services/?products=storage&regions=all)」ページで、リージョンのサポートを確認することもできます。
