...
- VPN デバイス構成の概要については、次を参照してください。[サード パーティの VPN デバイス構成の概要](../articles/vpn-gateway/vpn-gateway-3rdparty-device-config-overview.md)です。
...
- 複数のポリシー ベースの VPN デバイスを接続するを参照してください。[複数内部設置型ポリシーに基づく VPN デバイスに PowerShell を使用して接続 Azure VPN ゲートウェイ](../articles/vpn-gateway/vpn-gateway-connect-multiple-policybased-rm-ps.md)です。