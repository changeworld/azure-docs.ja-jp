...
このチュートリアルは、Visual Studio で ASP.NET [Web API 2](http://www.asp.net/web-api/overview/getting-started-with-aspnet-web-api/tutorial-your-first-web-api) と [MVC 5](http://www.asp.net/mvc/overview/getting-started/introduction/getting-started) を操作する基本的な方法を理解していることを前提としています。
