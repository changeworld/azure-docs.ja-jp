...
1. そのような操作をまだ実行していない場合には、トピック「[モバイル サービスでの Twitter ログイン用のアプリケーションの登録](../articles/mobile-services/mobile-services-how-to-register-twitter-authentication.md)」の手順を実行します。 
