...
1. 次の内容を含む **ClientManager.swift** ファイルを追加します。_%AppUrl%_ を Azure Mobile App バックエンドの URL に置き換えます。
...
2. **AppDelegate.swift** で、次のハンドラー メソッドを追加します。これで、アプリケーションがプッシュ通知をサポートするように更新されました。
