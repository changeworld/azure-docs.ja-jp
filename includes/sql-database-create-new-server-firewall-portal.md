...
3. ID アドレスが一致したと仮定し、ツール バーの **[クライアント IP の追加]** をクリックします。
    ...
    ![クライアント IP の追加](../articles/sql-data-warehouse/media/sql-data-warehouse-get-started-provision/add-client-ip.png)
...
4. ツール バーの **[保存]** をクリックしてこのサーバーレベルのファイアウォール規則を保存し、**[OK]** をクリックします。
    ...
    ![クライアント IP の追加](../articles/sql-database/media/sql-database-get-started-portal/server-firewall-rule.png)
