...
<p>Facebook 以外の ID プロバイダーを使用している場合は、上の <strong>loginWithProvider</strong> に渡される値を <em>microsoftaccount</em>、<em>facebook</em>、<em>twitter</em>、<em>google</em>、<em>windowsazureactivedirectory</em> のいずれかに変更します。</p>
</div>
