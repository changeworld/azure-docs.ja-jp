...
1. **[基本]** タブで、次のように各フィールドに入力します。
   ...
   ![Azure portal でハブを作成する](media/iot-hub-tutorials-create-free-hub/hub-definition-basics.png)
...
1. **Next:Networking\(次へ: ネットワーク\)** を選択して、ハブの作成を続けます。
   ...
   ![接続できるエンドポイントを選択する](media/iot-hub-tutorials-create-free-hub/hub-definition-networking.png)

1. **Next:Management\(次へ: 管理\)** を選択して、ハブの作成を続けます。

    ![Azure portal を使用して新しいハブのサイズとスケールを設定する](media/iot-hub-tutorials-create-free-hub/hub-definition-management.png)
...
1.  **次へ:[Next]\(次へ\)** を選択して、次の画面に進みます。
    ...
    ![Azure portal を使用してハブにタグを割り当てる](media/iot-hub-tutorials-create-free-hub/hub-definition-tags.png)

1.  **次へ:次へ: レビューと作成** をクリックして、選択内容を確認します。 次の画面のようになります。ただし、表示されるのはハブの作成時に選択した値です。

    ![新しいハブを作成するための情報を確認する](media/iot-hub-tutorials-create-free-hub/hub-definition-create.png)
