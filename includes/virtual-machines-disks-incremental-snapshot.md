...
- 米国中西部、カナダ東部、カナダ中部リージョンで GA オファリングとしてご利用いただけます。
- 米国東部、米国東部 2、米国中部、北ヨーロッパ、東南アジアリージョンでパブリック プレビューとしてご利用いただけます。

## <a name="restrictions"></a>制限
- 増分スナップショットは、現時点ではディスクのサイズを変更した後に作成することはできません (プレビュー期間中のみ)。
