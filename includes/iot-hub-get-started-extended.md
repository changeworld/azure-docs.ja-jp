...
| [IoT デバイスの管理](../articles/iot-hub/iot-hub-device-management-iot-toolkit.md)                | VS Code Azure IoT Hub 拡張機能|
| [Azure Storage への IoT Hub メッセージの保存](../articles/iot-hub/tutorial-routing.md#route-to-a-storage-account)  | Azure Table Storage                |
