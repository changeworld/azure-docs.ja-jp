...
ms.locfileid: "112060807"
---
Event Hubs では、次のカテゴリの診断ログをキャプチャします。

| カテゴリ | 説明 | 
| -------- | ----------- | 
| アーカイブ ログ | [Event Hubs Capture](../articles/event-hubs/event-hubs-capture-overview.md) 操作、特にログ関連のキャプチャ エラーに関する情報をキャプチャします。 |
