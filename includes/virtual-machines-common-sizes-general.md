...
| サイズ | vCPU | メモリ: GiB | 一時ストレージ (SSD) GiB | 最大データ ディスク数 | 一時ストレージの最大スループット: IOPS/読み取り MBps/書き込み MBps | 最大データ ディスク数/スループット: IOPS | 最大 NIC 数/想定ネットワーク帯域幅 (Mbps) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_D1_v2 |1 |3.5 |4 |50 |3000/46/23 |4 / 4x500 |2/750 |
| Standard_D2_v2 |2 |7 |8 |100 |6000/93/46 |8 / 8x500 |2/1,500 |
| Standard_D3_v2 |4 |14 |16 |200 |12000/187/93 |16 / 16x500 |4/3,000 |
| Standard_D4_v2 |8 |28 |32 |400 |24000/375/187  |32 / 32x500 |8/6,000 |
...
クラシック VM 用のデータ ディスクの数は、Azure Resource Manager VM 用のデータ ディスクの数より少ない場合があります。
