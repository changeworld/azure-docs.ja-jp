...
> [AZURE.IMPORTANT] 認証、IP アドレス バインドなどの MongoDB セキュリティ機能は既定では有効になっていません。MongoDB を運用環境に展開する前に、セキュリティ機能を有効にすることをお勧めします。詳細については、[セキュリティと認証に関するページ](http://www.mongodb.org/display/DOCS/Security+and+Authentication)を参照してください。
