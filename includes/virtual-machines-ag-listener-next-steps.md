...
> [!NOTE]
> Azure リスナーのトラブルシューティングに関するヒントについては、[Azure での可用性グループ リスナーのトラブルシューティング](https://blogs.msdn.microsoft.com/alwaysonpro/2017/02/22/troubleshooting-internal-load-balancer-listener-connectivity-in-azure)に関する記事を AlwaysOn サポート チームの[ブログ](https://blogs.msdn.com/b/alwaysonpro/)で参照してください。
> 
> 
