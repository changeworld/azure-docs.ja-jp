...
1. LUIS サブスクリプション キーと[リージョン](~/articles/cognitive-services/speech-service/regions.md#regions-for-intent-recognition)をパラメーターとして使用して、音声構成を作成します。 LUIS サブスクリプション キーは、サービス ドキュメント内で**エンドポイント キー**と呼ばれます。 LUIS 作成キーは使用できません  (このセクションの後の方の注を参照してください)。
