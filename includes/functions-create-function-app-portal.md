...
2. **[Compute]** > **[Function App]** をクリックし、**[サブスクリプション]** を選択します。Function App を識別する一意の**アプリ名**を入力し、次の設定を指定します。
   ...
   * **[[ホスティング プラン](../articles/app-service/azure-web-sites-web-hosting-plans-in-depth-overview.md)]**: 次のいずれかになります。 
     * **従量課金プラン**: Azure Functions の既定のプランの種類です。 従量課金プランを選択した場合は、**[場所]** の選択も行う必要があります。  
