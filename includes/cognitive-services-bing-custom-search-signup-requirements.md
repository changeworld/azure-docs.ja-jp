...
ms.locfileid: "74972704"
---
## <a name="create-an-azure-resource"></a>Azure リソースを作成する

次のいずれかの Azure リソースを作成して、Bing Custom Search API の使用を開始します。

* [試用版のリソースを作成する](https://azure.microsoft.com/try/cognitive-services/?api=bing-custom-search-api):
...
* [Bing Custom Search のリソースを作成する](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingCustomSearch):
