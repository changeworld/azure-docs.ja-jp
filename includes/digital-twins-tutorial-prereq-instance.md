...
* それ以外の場合は、"[*インスタンスと認証を設定する方法*](../articles/digital-twins/how-to-set-up-instance-portal.md)" に関するページの説明に従って、**インスタンスと認証を設定**します。 説明には、各手順が正常に完了し、新しいインスタンスを使用する準備ができていることを確認するための手順も含まれています。
