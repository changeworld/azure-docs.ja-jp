...
| セキュリティ規則で送信元または送信先に指定された IP アドレスおよび IP アドレス範囲 |2000 |4000 |
...
| ロード バランサー (内部およびインターネット接続、Basic および Standard) |100 |1,000 |
| ロード バランサーあたりのロード バランサー (Basic) の規則数 |150 |250 |
| ロード バランサーあたりのロード バランサー (Standard) の規則数 | 1250 | 1500|
| IP 構成あたりのロード バランサー (Basic) の規則数 |250 |250 |
| ロード バランサー (Basic) あたりのパブリック フロント エンド IP |10 |30 |
| ロード バランサー (Standard) あたりのパブリック フロント エンド IP | 10 | 600 |
| ロード バランサー (Basic) あたりのプライベート フロント エンド IP |10 |サポートにお問い合わせください |
| ロード バランサー (Standard) あたりのプライベート フロント エンド IP | 10 | 600 |
