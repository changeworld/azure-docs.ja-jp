...
| --- | --- | --- |
| 同時ジョブの最大数 |20 | |
| アカウントあたりの Analytics ユニット (AU) の最大数 |250 | 20 個のジョブ全体で 250 AU を最大とする任意の組み合わせを使用します。  この制限を引き上げる場合は、Microsoft サポートにご連絡ください。 |
| ジョブ送信の最大スクリプト サイズ | 3 MB | |
| サブスクリプションあたりのリージョンごとの ADLA アカウントの最大数 | 5 | この制限を引き上げる場合は、Microsoft サポートにご連絡ください。 |
