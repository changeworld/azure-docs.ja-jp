...
### <a name="to-verify-your-connection-by-using-the-azure-portal"></a>Azure Portal を使用して接続を確認するには

接続の状態は、Azure Portal で目的の接続に移動して確認できます。 これには複数の方法があります。 以下に示した手順は、目的の接続に移動して接続を確認する方法の一例です。
