...
ms.locfileid: "67181078"
---
1. [仮想 WAN] ページに移動します。 このページに移動する 1 つの方法は、 **[すべてのサービス]** に移動し、"仮想 WAN" を検索することです。
1. **[+ 追加]** をクリックして **[WAN の作成]** ページを開きます。
1. **[WAN の作成]** ページで、次のフィールドに入力します。
