...
> [!NOTE]
> 4 月 15 日から、Azure 仮想マシンのすべてのサイズで、少なくとも 2 つのネットワーク インターフェイス (NIC) がサポートされます。 特定の領域の情報については、引き続き[サービスの更新情報](https://azure.microsoft.com/en-us/updates/)をご確認ください。以下の表では、該当するサイズに "^" が付いています。
