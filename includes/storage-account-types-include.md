...
データの使用パターンが変化した場合は、いつでもこれらのアクセス層を切り替えることができます。 アクセス層を変更すると、追加料金が発生することがあります。 詳細については、 [BLOB ストレージ アカウントの価格と課金](../articles/storage/blobs/storage-account-options.md#pricing-and-billing) に関するセクションを参照してください。
