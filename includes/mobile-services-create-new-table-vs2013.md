...
新しいモバイル サービスにデータを格納できるようにするには、サービスに新しいストレージ テーブルを作成する必要があります。以下の手順は、Visual Studio 2013 を使用してモバイル サービスに新しいテーブルを作成する方法を示しています。テーブルを作成した後で、モバイル サービスを使用してローカル コレクションの代わりに Azure に項目を格納するようにアプリケーションを更新します。
