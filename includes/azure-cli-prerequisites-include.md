...
この記事の手順を実行するには、[Mac、Linux、Windows 用の Azure コマンド ライン インターフェイス (Azure CLI) をインストール](../articles/xplat-cli-install.md)し、[Azure にログオン](../articles/xplat-cli-connect.md)する必要があります。 
