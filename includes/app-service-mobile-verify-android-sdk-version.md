...
2. [Project Explorer (プロジェクト エクスプローラー)] タブの **[Gradle Scripts]** で、**build.gradle (modeule: app)**ファイルを開きます。 **[compileSdkVersion]** と **[buildToolsVersion]** が、インストールされた最新の SDK バージョンに設定されていることを確認します。 タグは、次のようになります。
