...
Cognitive Services Speech SDK の最新バージョンは 1.11.0 です。
...
1. 表示されたウィンドウで、Android 用 Speech SDK の名前とバージョンを入力します (*com.microsoft.cognitiveservices.speech:client-sdk:1.11.0*)。 **[OK]** をクリックします。
