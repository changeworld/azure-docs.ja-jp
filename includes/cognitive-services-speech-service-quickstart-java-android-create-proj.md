...
Cognitive Services Speech SDK の現在のバージョンは `1.7.0` です。
...
1. 表示されたウィンドウで、Android 用 Speech SDK の名前とバージョン (`com.microsoft.cognitiveservices.speech:client-sdk:1.7.0`) を入力します。 **[OK]** をクリックします。
