...
> [!NOTE]
> この記事の手順では、すべての IP 構成を 1 つの NIC に割り当てていますが、複数の IP 構成を複数の NIC を持つ VM の任意の NIC に割り当てることもできます。 複数の NIC を持つ VM の作成方法については、[複数の NIC を持つ VM の作成](../articles/virtual-machines/windows/multiple-nics.md)に関する記事を参照してください。