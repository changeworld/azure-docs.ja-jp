...
|:---|---:|---:|---:| ---: | ---: |
| プールあたりの最大ストレージ容量* | 1.2 TB | 1.6 TB | 2 TB | 2.4 TB | 2.9 TB | 
...
|:---|---:|---:|---:| ---: | ---: | 
| プールあたりの最大ストレージ容量* | 750 GB | 750 GB | 750 GB | 750 GB | 750 GB |
...
\* プールされたデータベースではプール ストレージが共有されるため、データベース ストレージ容量は、残りのプール ストレージ容量とデータベースあたりの最大ストレージ容量のどちらか小さい方に制限されます。 プールあたりの最大ストレージ容量とは、プール内のデータ ファイルの最大ストレージ容量のことであり、ログ ファイルによって使用される領域は含みません。
