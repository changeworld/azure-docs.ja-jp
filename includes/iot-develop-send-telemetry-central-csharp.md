...
このセクションでは、ローカル環境を構成し、Azure IoT C# のサンプルをインストールし、シミュレートされた温度コントローラーを作成するサンプルを実行します。
...
1. コンソールで、コード サンプルを実行します。 このサンプルは、サーモスタット センサーを備えたシミュレートされた温度コントローラーを作成します。
