...
5. 上の表で示されている他の修正プログラム (**3103616**、**3146621**) を検索し、バスケットに追加します。
6. **[バスケットの表示]**をクリックします。
...
1. ソフトウェアの更新が完了したら、システムのソフトウェア バージョンを確認します。 次のコマンドを入力します。
   ...
   * `MdsAgentVersion: 30.0.4698.16` 
     ...
     > 
     > 
2. 手順 3 ～ 5 を繰り返して、残りの通常モード修正プログラムをインストールします。
   
   * iSCSI 更新プログラム KB3146621
   * WMI 更新プログラム KB3103616
3. Update 2 から更新する場合は、この手順をスキップします。 Update 2 より前のバージョンから更新する場合は、以下のプログラムもダウンロードする必要があります。
