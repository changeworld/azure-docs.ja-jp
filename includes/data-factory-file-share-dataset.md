...
データセットの定義に利用できるセクションとプロパティの完全な一覧については、「[データセットの作成](../articles/data-factory/v1/data-factory-create-datasets.md)」という記事を参照してください。 データセット JSON の構造、可用性、ポリシーなどのセクションは、データセットのすべての型でほぼ同じです。
...
時系列データセット、スケジュール作成、スライスの詳細については、[データセットの作成](../articles/data-factory/v1/data-factory-create-datasets.md)、[スケジュール設定と実行](../articles/data-factory/v1/data-factory-scheduling-and-execution.md)、および[パイプラインの作成](../articles/data-factory/v1/data-factory-create-pipelines.md)に関する記事を参照してください。
