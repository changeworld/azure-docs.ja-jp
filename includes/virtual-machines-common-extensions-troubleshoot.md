...
拡張機能を使用するためのテンプレートの作成の詳細については、[拡張機能テンプレートの作成](../articles/virtual-machines/windows/template-description.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)に関するページを参照してください。
