...
> [!NOTE]
> このガイドでは、Visual Studio 2015 Update 3 または Visual Studio 2019 が必要です。 どちらのバージョンもお持ちでない場合は、 [Visual Studio 2019 を無料でダウンロードできます](https://www.visualstudio.com/downloads/)。
