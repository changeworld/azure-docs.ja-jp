...
* [エンタープライズクラスの WordPress Web アプリのセットアップ方法](web-sites-php-enterprise-wordpress.md)
...
* [Web アプリのバックアップ方法](web-sites-backup.md)と[Web アプリの復元方法](web-sites-restore.md)
...
* [Redis Cache プラグイン](https://wordpress.org/plugins/wp-redis/)を使用して [Redis Cache を有効にする方法](../redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md)
* [Memcached プラグイン](https://wordpress.org/plugins/memcached/)を使用して、[WordPress 用の Memcached オブジェクト キャッシュを有効にする方法](web-sites-connect-to-redis-using-memcache-protocol.md)
