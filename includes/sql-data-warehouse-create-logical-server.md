...
3. **[作成]** をクリックして、新しい [SQL サーバー (論理サーバー)] ブレードを開きます。
   ...
   <kbd> ![論理サーバー ブレードを開く](./media/sql-data-warehouse-create-logical-server/open-logical-server-blade.png) </kbd> <kbd>![論理サーバー ブレード](./media/sql-data-warehouse-create-logical-server/logical-server-blade.png) </kbd>
