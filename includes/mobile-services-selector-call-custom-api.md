...
- [(Windows ストア C# | .NET)](mobile-services-dotnet-backend-windows-store-dotnet-call-custom-api.md)
- [(Windows ストア C# | Javascript)](mobile-services-windows-store-dotnet-call-custom-api.md)
- [(Windows ストア JavaScript | Javascript)](mobile-services-windows-store-javascript-call-custom-api.md)
