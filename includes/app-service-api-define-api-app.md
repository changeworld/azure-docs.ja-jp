...
2. ベース URL の末尾に `/swagger` を追加して Swagger ページに移動します。
   
   ![](./media/app-service-api-define-api-app/swaggerhome.png)
3. **[Contacts]、[Get]、[Try it out]** の順にクリックすると、API が機能しており、予期される結果を返すことを確認できます。
   
    ![](./media/app-service-api-define-api-app/swaggertry.png)
4. Visual Studio で、**[デバッグ]、[デバッグの停止]** の順にクリックします。
