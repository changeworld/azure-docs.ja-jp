1.  [Azure の管理ポータル][Azure の管理ポータル]でディレクトリ ページの **[アプリケーション]** タブをクリックします。
...
7.  [Azure の管理ポータル][Azure の管理ポータル]で、モバイル サービスに戻り、**[構成]** タブをクリックします。**[アプリケーション設定]** セクションまで下にスクロールし、次のアプリケーション設定を追加して、**[保存]** をクリックします。
