...
|[Java](../articles/azure-functions/functions-reference-java.md)|該当なし|GA (Java 8)| GA (Java 11<sup>1</sup>、8)|
...
<sup>1</sup> 言語バージョンのサポートは現在、プレビュー段階です。  
