...
5. **Package Explorer** でプロジェクトを右クリックし、*[Properties]* をクリックします。
...
7. **[Project Build Target]** の下で、適切な SDK レベルとして `Google APIs x86` (または、開発プラットフォームによっては `Google APIs`) が選択されていることを確認します。
