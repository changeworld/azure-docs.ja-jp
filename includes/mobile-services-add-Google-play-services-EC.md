...
7. **[プロジェクトのビルド ターゲット]** で、適切な SDK レベルとして `Google APIs x86` (開発プラットフォームによっては `Google APIs`) が選択されていることを確認します。

 
8. **[ライブラリ]** セクションで **[追加]** をクリックし、[Google Play Services] プロジェクト (*google-play-services-lib*) をオンにして **[OK]** をクリックします。
