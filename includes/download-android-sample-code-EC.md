...
1. gitHub から `mobile-services-samples` リポジトリをダウンロードするために <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures" target="blank">ここ</a> をクリックした後、**[ZIP のダウンロード]** をクリックします。
...
>[AZURE.NOTE] モバイル サービス Android SDK の前のバージョンで使用されていたサンプル ファイルを入手する場合は、[ここ][GitHub]から入手できます。
