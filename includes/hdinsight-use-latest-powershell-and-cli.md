> [!IMPORTANT]
> Azure PowerShell および Azure CLI から Azure サービス マネージャー (ASM) を使用した HDInsight リソースの管理のサポートは、2017 年 1 月 1 日までに__廃止__される予定です。このドキュメントの手順では、Azure Resource Manager (ARM) で機能する新しい Azure PowerShell コマンドレットと Azure CLI コマンドを使用します。
> 
