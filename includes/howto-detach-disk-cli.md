...
> [!NOTE]
> Azure の仮想マシンでは、オペレーティング システム ディスク、ローカル一時ディスク、オプションのデータ ディスクなど、さまざまな種類のディスクが使用されます。仮想マシンのデータを格納するうえで、データ ディスクはお勧めの手段です。ディスクの詳細については、「[Azure とは](http://go.microsoft.com/fwlink/p/?LinkId=263439)」を参照してください。現在、オペレーティング システム ディスクを切断することはできません。
> 
> 
