> [!IMPORTANT]
> Azure Service Manager (ASM) を使用した HDInsight リソースの管理に関する Azure CLI のサポートは**廃止**され、2017 年 1 月 1 日に削除されました。 このドキュメントの手順では、Azure Resource Manager で機能する新しい Azure CLI コマンドを使用します。
> 
