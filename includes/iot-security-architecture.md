...
### <a name="who-performs-threat-modeling"></a>誰が脅威のモデル化を行うか
...
**特権の昇格 (E)**:特定の機能を実行するデバイスが、他の目的に利用される可能性があります。 たとえば半開状態となるようにプログラムされているバルブが、意図的に全開にされる可能性があります。
