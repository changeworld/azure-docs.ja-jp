...
---
1. [Azure portal](https://portal.azure.com) で、 **[Search resources, services, and docs]\(ソース、サービス、ドキュメントの検索\) (G+/)** に、「 **ローカル ネットワーク ゲートウェイ** 」と入力します。 検索結果の **[Marketplace]** の下にある **[ローカル ネットワーク ゲートウェイ]** を見つけて、それを選択します。 これで、 **[ローカル ネットワーク ゲートウェイの作成]** ページが開きます。
