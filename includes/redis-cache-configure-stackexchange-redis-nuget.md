...
> [!NOTE]
> 詳細については、GitHub の [StackExchange.Redis に関するページ](http://github.com/StackExchange/StackExchange.Redis)と [StackExchange.Redis キャッシュ クライアントのドキュメント](http://github.com/StackExchange/StackExchange.Redis#documentation)を参照してください。
> 
> 
