...
<ul> 
 <ul>
    <li>非構造化データの格納には、<a href="https://azure.microsoft.com/ja-jp/documentation/articles/storage-dotnet-how-to-use-blobs/">BLOB ストレージ</a>を使用します。</li>
    <li>構造化データの格納には、<a href="https://azure.microsoft.com/ja-jp/documentation/articles/storage-dotnet-how-to-use-blobs/">テーブル ストレージ</a>を使用します。</li>
    <li>構造化データの格納には、<a href="https://azure.microsoft.com/documentation/articles/storage-dotnet-how-to-use-queues/">キュー ストレージ</a>を使用します。</li>
