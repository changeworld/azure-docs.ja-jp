...
[![テレメトリを一時停止する](./media/iot-accelerators-tutorial-cleanup/togglesimulation-inline.png)](./media/iot-accelerators-tutorial-cleanup/togglesimulation-expanded.png#lightbox)
...
![ソリューションを削除する 2](media/iot-accelerators-tutorial-cleanup/deletesolution-provision.png)
