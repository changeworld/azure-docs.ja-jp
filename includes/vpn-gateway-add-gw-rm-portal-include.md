1. ポータルで **[新規]** に移動します。 検索キーワードとして「仮想ネットワーク ゲートウェイ」と入力します。 検索結果で "**仮想ネットワーク ゲートウェイ**" を探してその項目をクリックします。 **[仮想ネットワーク ゲートウェイの作成]** ブレードが開きます。
2. **[仮想ネットワーク ゲートウェイ]** ブレードの下部にある **[作成]** をクリックします。 **[仮想ネットワーク ゲートウェイの作成]** ブレードが開きます。 実際の仮想ネットワーク ゲートウェイの値を入力します。
