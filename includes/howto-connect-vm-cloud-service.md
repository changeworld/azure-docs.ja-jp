...
1. [Azure ポータル](http://manage.windowsazure.com)で仮想ネットワークを作成します。詳細については、「[Virtual Network の構成タスク](../documentation/services/virtual-machines.md)」を参照してください。
...
[Virtual Network の構成タスク](../documentation/services/virtual-machines.md)
