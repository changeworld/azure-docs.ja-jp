...
共有イメージ ギャラリーのリージョン サポートは限定されていますが、随時、拡大される予定です。 プレビューの場合に、ギャラリーを作成できる場所とギャラリーをレプリケートできるリージョンの一覧を次に示します。 
...
**Q.** AD のテナント間でイメージ バージョンを共有できますか。 

 A. いいえ、現在、共有イメージ ギャラリーでは、AD テナント間でのイメージ バージョンの共有はサポートされていません。 ただし、Azure Marketplace でプライベート プラン機能を使用して、これを実現できます。
