...
いいえ、別のサブスクリプションに共有イメージ ギャラリー リソースを移動することはできません。 [Azure CLI](../articles/virtual-machines/image-version-another-gallery-cli.md) または [PowerShell](../articles/virtual-machines/image-version-another-gallery-powershell.md) を使用して、ギャラリー内のイメージ バージョンを他のリージョンにレプリケートしたり、別のギャラリーからイメージをコピーしたりすることはできます。
