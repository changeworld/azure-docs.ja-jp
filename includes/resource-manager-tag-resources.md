...
---
タグを適用するために必要なアクセス権がユーザーに与えられていない場合は、 **[タグ共同作成者]** ロールをユーザーに割り当てることができます。 詳細については、[RBAC と Azure portal を使用して Azure リソースへのアクセス権をユーザーに付与する方法に関するチュートリアル](../articles/role-based-access-control/quickstart-assign-role-user-portal.md)を参照してください。
