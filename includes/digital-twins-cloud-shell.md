...
次に、[**Azure CLI 用の Microsoft Azure IoT 拡張機能**](/cli/azure/ext/azure-iot/iot?preserve-view=true&view=azure-cli-latest)を Cloud Shell に追加し、Azure Digital Twins およびその他の IoT サービスと対話するためのコマンドを有効にします。 
