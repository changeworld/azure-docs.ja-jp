...
### <a name="a-namegwipnoconnectionahow-to-modify-the-gateway-ip-address-no-gateway-connection"></a><a name="gwipnoconnection"></a>ゲートウェイ IP アドレスを変更する方法 (ゲートウェイ接続がない場合)
...
### <a name="a-namegwipwithconnectionahow-to-modify-the-gateway-ip-address-existing-gateway-connection"></a><a name="gwipwithconnection"></a>ゲートウェイ IP アドレスを変更する方法 (ゲートウェイ接続が既にある場合)
