...
2.	**[Mobile Services の作成]** ダイアログで、**[無料の 20 MB SQL データベースの作成]** を選択し、**[JavaScript]** ランタイムを選択してから、**[URL]** テキストボックスに新しい Mobile Services のサブドメイン名を入力します。右矢印ボタンをクリックして、次のページに進みます。
