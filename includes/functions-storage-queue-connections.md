...
|---------------------------|-----------------------------------------------------|--------------------------------------------|---------|
| Queue サービス URI | `<CONNECTION_NAME_PREFIX>__queueServiceUri`<sup>1</sup>  | 接続先 Queue サービスのデータ プレーン URI。 | <storage_account_name>.queue.core.windows.net |
