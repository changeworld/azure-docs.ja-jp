...
[[チュートリアル: Windows 上で実行されている IoT プラグ アンド プレイのサンプル デバイス アプリケーションを IoT Hub に接続する (C#)]](../articles/iot-develop/tutorial-connect-device.md) を完了している場合、リポジトリは既にクローンされています。
