...
Managed Disks は、ユーザーに代わってストレージ アカウントの管理を行うことで Azure IaaS VM のディスク管理を簡略化する機能です。 詳細については、[Managed Disks の概要](../articles/virtual-machines/managed-disks-overview.md)に関する記事を参照してください。
...
リージョンごとの情報については、[概念に関する記事](../articles/virtual-machines/linux/disks-shared.md)を参照してください。
...
サポートされているサイズについては、[概念に関する記事](../articles/virtual-machines/linux/disks-shared.md)を参照してください。
...
現在の VM を、Ultra ディスクをサポートするリージョンと可用性ゾーンのペアに配置しなければならなくなる可能性があります。 詳細については、[Ultra ディスクの使用開始](../articles/virtual-machines/disks-enable-ultra-ssd.md)に関するページを参照してください。
...
バースティング機能は、現在、Azure パブリック クラウドのすべてのリージョンでサポートされており、ソブリン クラウドのサポートは近日対応予定です。 
