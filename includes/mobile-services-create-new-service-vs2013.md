...
4. **[モバイル サービスの作成]** ダイアログに戻り、**[サブスクリプション]**、**[ランタイム]** の **[JavaScript]** バックエンド、モバイル サービスの **[地域]** を選択してから、モバイル サービスの **[名前]** を入力します。
...
1. モバイル サービスが作成されたら、サービス マネージャーのリストから新規作成されたモバイル サービスを選択し、**[OK]** をクリックします。
