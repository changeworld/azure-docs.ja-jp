...
1. [Azure portal](https://portal.azure.com) で、 **[Search resources, services, and docs]\(ソース、サービス、ドキュメントの検索\) (G+/)** に、「**仮想ネットワーク ゲートウェイ**」と入力します。 検索結果で **仮想ネットワーク ゲートウェイ** を見つけて、それを選択します。
   ...
   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/search.png" alt-text="検索フィールド" lightbox="./media/vpn-gateway-add-gw-rm-portal-empty/search-expand.png":::

1. **[仮想ネットワーク ゲートウェイ]** ページで、 **[+ 追加]** を選択します。 **[仮想ネットワーク ゲートウェイの作成]** ページが開きます。

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/add.png" alt-text="[仮想ネットワーク ゲートウェイ] ページ":::
1. **[基本]** タブで、仮想ネットワーク ゲートウェイの値を入力します。

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway.png" alt-text="ゲートウェイ フィールド":::

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway-vnet.png" alt-text="追加のゲートウェイ フィールド":::
