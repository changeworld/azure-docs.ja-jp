...
4. モバイル サービスの構成ページに戻り、オブジェクト ID を **AAD\_SALES\_GROUP\_ID** という名前のアプリ設定として追加します。このチュートリアルでは、グループ名に基づいて ID を検索する代わりに、グループのオブジェクト ID をアプリ設定として使用します。これは、グループ名は変更される場合がありますが、ID は同じままであるためです。
